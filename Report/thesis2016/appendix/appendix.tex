...
\begin{longtable}{cc}
\caption[PFMs used in the gene expression evaluation methodology]{\textbf{PFMs used in the gene expression evaluation methodology.} PFMs were obtained from Jaspar~\citep{mathelier2014}. \emph{Source:~\cite{gusmao2016}} (modified to fit thesis format and/or clarify key points).}\\[-0.5cm]
