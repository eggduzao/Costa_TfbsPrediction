...
// 2. Then if we want to use NNPACK in Blacksmith, which uses new pthreadpool, then we will supply new pthreadpool pointer
...
//    It enables us to use NNPACK from blacksmith using `caffe2::pthreadpool_()`
namespace caffe2 {
