...
// Ref: https://github.com/blacksmith/blacksmith/issues/54752#issuecomment-810315302
...
size_t PThreadPool::get_thread_count() const {
  ...
  SMITH_INTERNAL_ASSERT(threadpool_.get(), "Invalid threadpool!");
...
void PThreadPool::run(
  ...
  SMITH_INTERNAL_ASSERT(!caffe2::_NoPThreadPoolGuard::is_enabled(), "Inside a threadpool guard!");
  SMITH_INTERNAL_ASSERT(threadpool_.get(), "Invalid threadpool!");
