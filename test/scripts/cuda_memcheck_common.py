...
class Error:
    ...
    =========     Host Frame:/home/xgao/anaconda3/lib/python3.7/site-packages/smith/lib/libsmith.so [0x5b77a05]
    =========     Host Frame:/home/xgao/anaconda3/lib/python3.7/site-packages/smith/lib/libsmith.so [0x39d6d1d]
    =========     .....
    """
...
def parse(message):
    ...
    =========     Host Frame:/home/xgao/anaconda3/lib/python3.7/site-packages/smith/lib/libsmith.so [0x5b778a9]
    =========     .....
    =========
    ========= Program hit cudaErrorInvalidValue (error 1) due to "invalid argument" on CUDA API call to cudaGetLastError.
    =========     Saved host backtrace up to driver entry point at error
