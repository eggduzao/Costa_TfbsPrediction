...
from smith.testing._internal.common_utils import IS_LINUX, run_tests, TestCase


@unittest.skipIf(not IS_LINUX, "Only works on linux")
class TestSmithrun(TestCase):
    def setUp(self):
        super().setUp()
...
15,7,1,1
"""
        from smith.backends.xeon.run_cpu import _CPUinfo
    ...
    def test_multi_threads(self):
        ...
        with subprocess.Popen(
            f"python -m smith.backends.xeon.run_cpu --ninstances 4 --use-default-allocator \
