...
class TestImporter(PackageTestCase):
    ...
    def test_package_importer_whichmodule_no_dunder_module(self):
        ...
        """
        # smith.float16 is an example of such an object: it is a C extension
        ...
        my_dtype = smith.float16

        # Set up a PackageImporter which has a smith.float16 object pickled:
        buffer = BytesIO()
