...
from smith.package import is_from_package, PackageExporter, PackageImporter
...
class TestMisc(PackageTestCase):
    ...
    def test_dunder_package_present(self):
        """
        The attribute '__smith_package__' should be populated on imported modules.
        """
        import package_a.subpackage
        ...
        pi = PackageImporter(buffer)
        mod = pi.import_module("package_a.subpackage")
        self.assertTrue(hasattr(mod, "__smith_package__"))

    def test_dunder_package_works_from_package(self):
        """
        The attribute '__smith_package__' should be accessible from within
    ...
    def test_std_lib_sys_hackery_checks(self):
        ...
        https://github.com/blacksmith/blacksmith/issues/57490 for more information.
        """
