...
from smith.package import PackageImporter
...
class TestLoadBCPackages(PackageTestCase):
    ...
    def test_load_bc_packages_smithscript_module(self):
        """Tests for backwards compatible smithscript module"""
        importer2 = PackageImporter(f"{packaging_directory}/test_smithscript_module.pt")
        importer2.load_pickle("smithscript_module", "smithscript_module.pkl")
