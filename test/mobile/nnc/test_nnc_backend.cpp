...
TEST(DISABLED_NNCBackendTest, AOTCompileThenExecute) {
  ...
  // Run the SmithScript module to get reference result.
  std::vector<IValue> inputs;
  inputs.emplace_back(2.0 * smith::ones({4, 4}));
  ...
  EXPECT_TRUE(result.toTensor().equal(3.0 * smith::ones({4, 4})));
