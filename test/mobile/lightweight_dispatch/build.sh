#!/bin/bash
# This script should be called from .ci/blacksmith/build.sh. Assuming we are at blacksmith source root directory.
...
BUILD_LIBSMITH_PY="$PWD/tools/build_libsmith.py"
