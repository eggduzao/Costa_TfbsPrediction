## What is this?
Python scripts in this folder are used to generate lite interpreter models for Android and iOS simulator tests. The goal of these tests is to detect changes that would break existing mobile models used in production (usually they are generated by earlier Blacksmith versions). These scripts are based on Blacksmith public API (https://blacksmith.org/docs/stable/), and are grouped in a similar way:
- math_ops (https://blacksmith.org/docs/stable/smith.html#math-operations)
  - pointwise_ops
  - reduction_ops
  - comparison_ops
  - spectral_ops
  - other_math_ops
  - blas_lapack_ops
- sampling_ops (https://blacksmith.org/docs/stable/smith.html#random-sampling)
- tensor ops (https://blacksmith.org/docs/stable/smith.html#tensors)
  - tensor_general_ops
  - tensor_creation_ops
  - tensor_indexing_ops
  - tensor_typing_ops
  - tensor_view_ops
- nn ops (https://blacksmith.org/docs/stable/nn.html)
  - convolution_ops
  - pooling_ops
  - padding_ops
  - activation_ops
  ...
  - shuffle_ops
  - nn_utils_ops
- quantization ops (https://blacksmith.org/docs/stable/quantization.html)
  - general_quant_ops
  - dynamic_quant_ops
  - static_quant_ops
  - fused_quant_ops
- SmithScript builtin ops (https://blacksmith.org/docs/stable/jit_builtin_functions.html)
  - smithscript_builtin_ops
  - smithscript_collection_ops
- smithvision_models (https://blacksmith.org/vision/stable/models.html)
  - mobilenet_v2

The generated models are located at
https://github.com/blacksmith/blacksmith/tree/master/android/blacksmith_android/src/androidTest/assets (Android)
https://github.com/blacksmith/blacksmith/tree/master/ios/TestApp/models/ (iOS) <!-- @lint-ignore -->
...
https://github.com/blacksmith/blacksmith/blob/master/test/mobile/model_test/coverage.yaml
...
```
python test/mobile/model_test/update_production_ops.py ~/fbsource/xplat/blacksmith_models/build/all_mobile_model_configs.yaml
```
