...
from smithvision_models import (
    MobileNetV2Module,
...
test_path_android = "android/blacksmith_android/src/androidTest/assets/"
...
all_modules = {
    ...
    # SmithScript builtin ops
    "smithscript_builtin_ops": TSBuiltinOpsModule(),
    "smithscript_collection_ops": TSCollectionOpsModule(),
    # vision
...
def calcOpsCoverage(ops):
    ...
    print(f"blacksmith ver {smith.__version__}\n")
...
def getModuleFromName(model_name):
    ...
    if model_name in models_need_trace:
        module = smith.jit.trace(module, [])
    else:
        module = smith.jit.script(module)

    ops = smith.jit.export_opnames(module)
    print(ops)
