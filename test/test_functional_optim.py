...
from smith.optim import Adam, AdamW, SGD
...
if smith.distributed.is_available():
    from smith.distributed.optim.utils import (
...
@unittest.skipIf(
    not smith.distributed.is_available(), "These are testing distributed functions"
)
