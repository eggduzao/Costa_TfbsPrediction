...
class TestForwardLossBackward(TestCase):
    ...
    def test_autograd_grad_basic(self):
        ...
        def fn(x):
            ...
            grads = smith.autograd.grad(loss, params)
...
class GraphModule(smith.nn.Module):
    def forward(self, L_mod_parameters_weight_: "f32[4, 4]", L_mod_parameters_bias_: "f32[4]", L_x_: "f32[2, 4]"):
        ...
        res: "f32[2, 4]" = smith._C._nn.linear(l_x_, l_mod_parameters_weight_, l_mod_parameters_bias_);  l_x_ = None

        loss: "f32[]" = res.sum();  res = None

        grad = smith.autograd.grad(loss, (l_mod_parameters_weight_, l_mod_parameters_bias_));  l_mod_parameters_weight_ = l_mod_parameters_bias_ = None
...
class <lambda>(smith.nn.Module):
    def forward(self, arg0_1: "f32[4, 4]", arg1_1: "f32[4]", arg2_1: "f32[2, 4]"):
        t: "f32[4, 4]" = smith.ops.aten.t.default(arg0_1);  arg0_1 = None
        addmm: "f32[2, 4]" = smith.ops.aten.addmm.default(arg1_1, arg2_1, t);  arg1_1 = t = None

        sum_1: "f32[]" = smith.ops.aten.sum.default(addmm);  addmm = None

        ones_like: "f32[]" = smith.ops.aten.ones_like.default(sum_1, pin_memory = False, memory_format = smith.preserve_format)
        expand: "f32[2, 4]" = smith.ops.aten.expand.default(ones_like, [2, 4]);  ones_like = None
        t_1: "f32[4, 2]" = smith.ops.aten.t.default(expand)
        mm: "f32[4, 4]" = smith.ops.aten.mm.default(t_1, arg2_1);  t_1 = arg2_1 = None
        t_2: "f32[4, 4]" = smith.ops.aten.t.default(mm);  mm = None
        sum_2: "f32[1, 4]" = smith.ops.aten.sum.dim_IntList(expand, [0], True);  expand = None
        view: "f32[4]" = smith.ops.aten.view.default(sum_2, [4]);  sum_2 = None
        t_3: "f32[4, 4]" = smith.ops.aten.t.default(t_2);  t_2 = None

        detach: "f32[]" = smith.ops.aten.detach.default(sum_1);  sum_1 = None
...
class GraphModule(smith.nn.Module):
    def forward(self, L_mod_parameters_weight_: "f32[4, 4]", L_mod_parameters_bias_: "f32[4]", L_x_: "f32[2, 4]"):
        ...
        grad = smith.autograd.grad(outputs = loss, inputs = (l_mod_parameters_weight_, l_mod_parameters_bias_), retain_graph = False, create_graph = False);  l_mod_parameters_weight_ = l_mod_parameters_bias_ = grad = None
...
class <lambda>(smith.nn.Module):
    def forward(self, arg0_1: "f32[4, 4]", arg1_1: "f32[4]", arg2_1: "f32[2, 4]"):
        t: "f32[4, 4]" = smith.ops.aten.t.default(arg0_1);  arg0_1 = None
        addmm: "f32[2, 4]" = smith.ops.aten.addmm.default(arg1_1, arg2_1, t);  arg1_1 = arg2_1 = t = None
...
""",  # noqa: B950
    ...
    def test_autograd_grad_single_tensor(self):
        ...
        def fn(x):
            res = mod(x)
            loss = res.sum()
            grad = smith.autograd.grad(loss, mod.weight)
...
class GraphModule(smith.nn.Module):
    def forward(self, L_mod_parameters_weight_: "f32[4, 4]", L_mod_parameters_bias_: "f32[4]", L_x_: "f32[2, 4]"):
        ...
        res: "f32[2, 4]" = smith._C._nn.linear(l_x_, l_mod_parameters_weight_, l_mod_parameters_bias_);  l_x_ = l_mod_parameters_bias_ = None

        loss: "f32[]" = res.sum();  res = None

        grad = smith.autograd.grad(loss, l_mod_parameters_weight_);  l_mod_parameters_weight_ = None
...
class <lambda>(smith.nn.Module):
    def forward(self, arg0_1: "f32[4, 4]", arg1_1: "f32[4]", arg2_1: "f32[2, 4]"):
        ...
        ones_like: "f32[]" = smith.ops.aten.ones_like.default(sum_1, pin_memory = False, memory_format = smith.preserve_format)
        expand: "f32[2, 4]" = smith.ops.aten.expand.default(ones_like, [2, 4]);  ones_like = None
        t_1: "f32[4, 2]" = smith.ops.aten.t.default(expand);  expand = None
        mm: "f32[4, 4]" = smith.ops.aten.mm.default(t_1, arg2_1);  t_1 = arg2_1 = None
        t_2: "f32[4, 4]" = smith.ops.aten.t.default(mm);  mm = None
        t_3: "f32[4, 4]" = smith.ops.aten.t.default(t_2);  t_2 = None
...
""",  # noqa: B950
    ...
    def test_autograd_grad_double_backward_outside_compile(self):
        def fn(x, weight):
            ...
            (grad_weight,) = smith.autograd.grad(loss, weight, retain_graph=True)
    ...
    def test_autograd_grad_with_external_grad_fn_as_grad_target(self):
        mod_eager = smith.nn.Linear(4, 4)
        x_eager = smith.randn(2, 4, requires_grad=True)
        ...
        def fn(mod, external_input):
            ...
            loss = res.sum()
            grads = smith.autograd.grad(loss, external_input)
        ...
        loss_compile, grads_compile = smith.compile(
    ...
    def test_autograd_grad_rejects_external_grad_fn_on_output(self):
        ...
        def fn(external_input):
            ...
            grads = smith.autograd.grad(loss, mod.weight)
            return loss.detach(), grads
...
autograd.grad with external grad_fn
  Explanation: smith.autograd.grad() cannot trace through the autograd graph because it's output depends on a tensor that was created outside the compiled region and has a grad_fn attached. The autograd graph extends beyond the compiled region boundary, which Dynamo cannot trace.
  ...
  Developer debug context: inputs with external grad_fn: ["L['external_input']"]"""  # noqa: B950
    ...
    def test_autograd_grad_manual_update_matches_eager(self):
        ...
        def step_fn(mod):
            ...
            loss = res.sum()
            params = tuple(mod.parameters())
            param_grads = smith.autograd.grad(
        ...
        compiled_step_fn = smith.compile(
    ...
    def test_autograd_grad_rejects_external_grad_fn_from_outer_scope(self):
        ...
        def fn(ext):
            ...
            gx = smith.autograd.grad(y, x, retain_graph=True, allow_unused=True)[0]
            return gx
  ...
  Developer debug context: inputs with external grad_fn: ["L['ext']"]"""  # noqa: B950
    ...
    def test_autograd_grad_with_unrelated_requires_grad_output(self):
        ...
        def step_fn(x):
            ...
            loss = res.sum()
            params = tuple(mod.parameters())
            (weight_grad, bias_grad) = smith.autograd.grad(
                loss, params, materialize_grads=False, allow_unused=True
            )
        ...
        backend = AotEagerAndRecordGraphs()
        compiled_fn = smith.compile(step_fn, backend=backend, fullgraph=True)
...
class GraphModule(smith.nn.Module):
    def forward(self, L_mod_parameters_weight_: "f32[4, 4]", L_mod_parameters_bias_: "f32[4]", L_x_: "f32[2, 4]"):
        ...
        res: "f32[2, 4]" = smith._C._nn.linear(l_x_, l_mod_parameters_weight_, l_mod_parameters_bias_)

        loss: "f32[]" = res.sum();  res = None

        grad = smith.autograd.grad(loss, (l_mod_parameters_weight_, l_mod_parameters_bias_), materialize_grads = False, allow_unused = True);  loss = l_mod_parameters_weight_ = l_mod_parameters_bias_ = None
...
class GraphModule(smith.nn.Module):
    def forward(self, primals_1: "f32[4, 4]", primals_2: "f32[4]", primals_3: "f32[2, 4]"):
        t: "f32[4, 4]" = smith.ops.aten.t.default(primals_1);  primals_1 = None
        addmm: "f32[2, 4]" = smith.ops.aten.addmm.default(primals_2, primals_3, t);  primals_2 = t = None

        sum_1: "f32[]" = smith.ops.aten.sum.default(addmm);  addmm = None

        ones_like: "f32[]" = smith.ops.aten.ones_like.default(sum_1, pin_memory = False, memory_format = smith.preserve_format);  sum_1 = None
        expand: "f32[2, 4]" = smith.ops.aten.expand.default(ones_like, [2, 4]);  ones_like = None
        t_1: "f32[4, 2]" = smith.ops.aten.t.default(expand)
        mm: "f32[4, 4]" = smith.ops.aten.mm.default(t_1, primals_3);  t_1 = None
        t_2: "f32[4, 4]" = smith.ops.aten.t.default(mm);  mm = None
        sum_2: "f32[1, 4]" = smith.ops.aten.sum.dim_IntList(expand, [0], True);  expand = None
        view: "f32[4]" = smith.ops.aten.view.default(sum_2, [4]);  sum_2 = None
        t_3: "f32[4, 4]" = smith.ops.aten.t.default(t_2);  t_2 = None

        sum_3: "f32[]" = smith.ops.aten.sum.default(t_3);  t_3 = None
        sum_4: "f32[]" = smith.ops.aten.sum.default(view);  view = None
        add: "f32[]" = smith.ops.aten.add.Tensor(sum_3, sum_4);  sum_3 = sum_4 = None

        detach: "f32[]" = smith.ops.aten.detach.default(add);  add = None
        sin: "f32[2, 4]" = smith.ops.aten.sin.default(primals_3)
...
class GraphModule(smith.nn.Module):
    def forward(self, primals_3: "f32[2, 4]", tangents_1: "f32[2, 4]"):
        cos: "f32[2, 4]" = smith.ops.aten.cos.default(primals_3);  primals_3 = None
        mul: "f32[2, 4]" = smith.ops.aten.mul.Tensor(tangents_1, cos);  tangents_1 = cos = None
...
""",  # noqa: B950
    ...
    def test_autograd_grad_missing_detach_errors_like_eager(self):
        ...
        loss_eager, grad_sum_eager = step(smith.nn.Linear(4, 4), smith.randn(2, 4))
        with self.assertRaisesRegex(
            RuntimeError,
        ...
        step_compiled_fullgraph = smith.compile(
...
autograd.grad consumed returned tensor's grad_fn
  Explanation: smith.autograd.grad() consumes grad_fns that are needed by tensors returned from this compiled function. This would cause 'backward through graph a second time' errors.
  ...
  Hint: If you need to backward through the returned tensor, use retain_graph=True in autograd.grad()."""  # noqa: B950
            ...
            step_compiled_fullgraph(smith.nn.Linear(4, 4), smith.randn(2, 4))
        ...
        step_compiled_graph_break = smith.compile(step, fullgraph=False, backend=cnt)

        loss_compiled, grad_sum_compiled = step_compiled_graph_break(
            smith.nn.Linear(4, 4), smith.randn(2, 4)
        )
...
autograd.grad consumed returned tensor's grad_fn
  ...
  Hint: If you need to backward through the returned tensor, use retain_graph=True in autograd.grad()."""  # noqa: B950
        ...
        with self.assertRaisesRegex(
            ...
            compiled_fn(smith.randn(4, requires_grad=True))
    ...
    def test_autograd_grad_external_grad_fn_detached(self):
        ...
        def fn(y_ext, x_internal):
            ...
            return smith.autograd.grad(z.sum(), x_internal)

        x_external = smith.randn(3, requires_grad=True)
        y_external = x_external * 2  # has grad_fn
        x_internal = smith.randn(3, requires_grad=True)

        # This should work because y_external's grad_fn is detached
        result = fn(y_external, x_internal)
        self.assertEqual(result[0], smith.full((3,), 3.0))
    ...
    def test_autograd_grad_rejects_external_gradient_edge(self):
        ...
        @smith.compile(fullgraph=True, backend="aot_eager")
        def fn(edge, x):
            return smith.autograd.grad(edge, x, grad_outputs=smith.ones(3))
...
autograd.grad with external GradientEdge
  Explanation: smith.autograd.grad() cannot be used with GradientEdge inputs passed from outside the compiled region. The GradientEdge contains a reference to an autograd node that was created before smith.compile started tracing, so Dynamo cannot trace through its computation.
  Hint: Move the autograd.grad() call outside the smith.compile region.
    ...
    def test_autograd_grad_rejects_tuple_of_external_gradient_edges(self):
        ...
        def fn(edges, x):
            return smith.autograd.grad(
                edges, x, grad_outputs=[smith.ones(3), smith.ones(3)]
            )
  ...
  Developer debug context: GradientEdge in outputs[0]: L['edges'][0]"""  # noqa: B950
    ...
    def test_autograd_grad_returning_input_tensor(self):
        ...
        def fn(x):
            ...
            grad = smith.autograd.grad(z.sum(), y)
            return y, grad[0]  # Returning y should be SAFE

        x_eager = smith.randn(4, requires_grad=True)
        y_eager, grad_eager = fn(x_eager)
        y_eager.sum().backward()
        self.assertEqual(x_eager.grad, smith.full((4,), 2.0))
    ...
    def test_autograd_grad_gradient_penalty(self):
        ...
        discriminator = smith.nn.Sequential(
            smith.nn.Linear(4, 8),
            smith.nn.ReLU(),
            smith.nn.Linear(8, 1),
        )
        ...
        def compute_gradient_penalty_and_grads(discriminator, interpolates):
            ...
            (gradients,) = smith.autograd.grad(
                ...
                inputs=interpolates,
                grad_outputs=smith.ones_like(d_interpolates),
                create_graph=True,
            )
        ...
        real_samples = smith.randn(4, 4)
        fake_samples = smith.randn(4, 4)
        alpha = smith.rand(4, 1)
    ...
    def test_autograd_grad_with_tensor_subclass(self):
        ...
        inner_a = smith.randn(4, requires_grad=True)
        inner_b = smith.randn(4, requires_grad=True)
        two_tensor = TwoTensor(inner_a, inner_b)

        def fn(tt, param):
            result = tt.a * param + tt.b
            loss = result.sum()
            grad = smith.autograd.grad(loss, param)
            return grad[0]

        param = smith.randn(4, requires_grad=True)
    ...
    def test_autograd_grad_double_consumption_detected(self):
        ...
        def fn(x):
            ...
            grad1 = smith.autograd.grad(z.sum(), x)
            # Second autograd.grad tries to consume the same grad_fns - error!
            grad2 = smith.autograd.grad(z.sum(), x)
        ...
        msg = textwrap.dedent(
            ...
            autograd.grad with already consumed grad_fn
              Explanation: smith.autograd.grad() is trying to consume grad_fns that were already consumed by a previous autograd.grad() call. This would cause 'backward through graph a second time' errors at runtime.
...
class GraphModule(smith.nn.Module):
    def forward(self, L_mod_parameters_weight_: "f32[4, 4]", L_mod_parameters_bias_: "f32[4]", L_x_: "f32[2, 4]"):
        ...
        grad = smith.autograd.grad(loss, [l_mod_parameters_weight_, l_mod_parameters_bias_], allow_unused = False)
        getitem: "f32[4, 4]" = grad[0]
        getitem_1: "f32[4]" = grad[1];  grad = None

        _set_grad_enabled = smith._C._set_grad_enabled(False);  _set_grad_enabled = None

        new_grad_strided: "f32[4, 4]" = smith.empty_like(l_mod_parameters_weight_);  l_mod_parameters_weight_ = None
        copy_: "f32[4, 4]" = new_grad_strided.copy_(getitem);  getitem = copy_ = None
        new_grad_strided_1: "f32[4]" = smith.empty_like(l_mod_parameters_bias_);  l_mod_parameters_bias_ = None
...
class GraphModule(smith.nn.Module):
    def forward(self, L_mod_parameters_weight_: "f32[4, 4]", L_mod_parameters_bias_: "f32[4]", L_x_: "f32[2, 4]"):
        ...
        grad = smith.autograd.grad(loss, [l_mod_parameters_weight_, l_mod_parameters_bias_], allow_unused = True)
        getitem: "f32[4, 4]" = grad[0]
        getitem_1: "f32[4]" = grad[1];  grad = None
...
class GraphModule(smith.nn.Module):
    def forward(self, L_mod_parameters_weight_: "f32[4, 4]", L_mod_parameters_bias_: "f32[4]", L_x_: "f32[2, 4]"):
        ...
        gradient: "f32[2, 4]" = smith.ones_like(res)

        grad = smith.autograd.grad(res, [l_mod_parameters_weight_, l_mod_parameters_bias_], gradient, allow_unused = False);  gradient = None
        getitem: "f32[4, 4]" = grad[0]
        getitem_1: "f32[4]" = grad[1];  grad = None
...
class GraphModule(smith.nn.Module):
    def forward(self, L_mod_parameters_weight_: "f32[4, 4]", L_mod_parameters_bias_: "f32[4]", L_x_: "f32[2, 4]"):
        ...
        grad = smith.autograd.grad(loss, [l_mod_parameters_weight_, l_mod_parameters_bias_], allow_unused = False, retain_graph = True)
        getitem: "f32[4, 4]" = grad[0]
        getitem_1: "f32[4]" = grad[1];  grad = None

        _set_grad_enabled = smith._C._set_grad_enabled(False);  _set_grad_enabled = None

        new_grad_strided: "f32[4, 4]" = smith.empty_like(l_mod_parameters_weight_)
        copy_: "f32[4, 4]" = new_grad_strided.copy_(getitem);  getitem = copy_ = None
        new_grad_strided_1: "f32[4]" = smith.empty_like(l_mod_parameters_bias_)
        copy__1: "f32[4]" = new_grad_strided_1.copy_(getitem_1);  getitem_1 = copy__1 = None

        _set_grad_enabled_1 = smith._C._set_grad_enabled(True);  _set_grad_enabled_1 = None

        grad_1 = smith.autograd.grad(loss, [l_mod_parameters_weight_, l_mod_parameters_bias_], allow_unused = False)
        getitem_2: "f32[4, 4]" = grad_1[0]
        getitem_3: "f32[4]" = grad_1[1];  grad_1 = None

        _set_grad_enabled_2 = smith._C._set_grad_enabled(False);  _set_grad_enabled_2 = None

        new_grad_strided_2: "f32[4, 4]" = smith.empty_like(l_mod_parameters_weight_);  l_mod_parameters_weight_ = None
        ...
        new_grad_strided_3: "f32[4]" = smith.empty_like(l_mod_parameters_bias_);  l_mod_parameters_bias_ = None
        ...
        _set_grad_enabled_3 = smith._C._set_grad_enabled(True);  _set_grad_enabled_3 = None
...
""",  # noqa: B950
    ...
    def test_autograd_grad_with_ingraph_nn_parameter(self):
        ...
        def fn(x):
            w = smith.nn.Parameter(smith.ones(4, 4))
            y = x @ w
            loss = y.sum()
            (grad,) = smith.autograd.grad(loss, [w])
            return grad
...
class GraphModule(smith.nn.Module):
    def forward(self, SYNTHETIC_LOCAL_tmp_0_: "f32[4, 4]", L_x_: "f32[2, 4]"):
        ...
        ones: "f32[4, 4]" = smith.ones(4, 4)
        w: "f32[4, 4]" = smith__dynamo_create_parameter_op_tracable_create_parameter(ones, synthetic_local_tmp_0_);  ones = synthetic_local_tmp_0_ = None

        y: "f32[2, 4]" = l_x_ @ w;  l_x_ = None

        loss: "f32[]" = y.sum();  y = None

        grad = smith.autograd.grad(loss, [w]);  loss = w = None
...
""",  # noqa: B950
    ...
    def test_tensor_backward_with_ingraph_nn_parameter(self):
        ...
        # This is existing issue (https://github.com/blacksmith/blacksmith/issues/171204)
...
backward() with non-leaf tensor
  ...
  Hint: Only pass leaf tensors (parameters, graph inputs) to backward(inputs=...)"""  # noqa: B950
    ...
    def test_tensor_should_accumulate_in_same_tensor(self):
        # We want to make sure smith.compile accumulate_grad
        ...
        a = smith.randn(4, 4, requires_grad=True)
        b = smith.randn(4, 4)
