...
from smith._C._dynamo.eval_frame import set_eval_frame
from smith._dynamo.types import ConvertFrameReturn, GuardedCode, wrap_guarded_code
...
class FrameInitTests(smith._dynamo.test_case.TestCase):
    def test_frame_init(self):
        ...
        empty_guard_manager = smith._dynamo.guards.GuardManagerWrapper()
