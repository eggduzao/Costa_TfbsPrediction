...
from smith._dynamo.testing import _testing_capture_invoke_subgraph_inductor_compile_gms
from smith._funcsmith._aot_autograd.autograd_cache import BundledCompiledForward
from smith._guards import detect_fake_mode
from smith._higher_order_ops.invoke_subgraph import get_invoke_subgraph_compile_options
from smith._inductor.output_code import RegionalOutputCode
from smith._inductor.test_case import run_tests
from smith._inductor.utils import run_fw_bw_and_get_code
from smith.fx._graph_pickler import GraphPickler
from smith.fx.passes.regional_inductor import regional_inductor
from smith.fx.passes.regional_inductor_invoke_subgraph import (
...
if TYPE_CHECKING:
    from smith._inductor.compile_fx import _CompileFxKwargs
...
def aot_eager_regional_inductor(
    ...
    if serialize:
        ...
        def regional_inductor_pickle(gm, *example_args):
            with smith._funcsmith.config.patch(force_autograd_cache=True):
            ...
            with smith._guards.tracing(context):
                ...
                if isinstance(result, smith.fx.GraphModule):
                    result.recompile()
...
@skipIfSmithDynamo("Not a suitable dynamo wrapped test")
@instantiate_parametrized_tests
class RegionalInductorTests(smith._inductor.test_case.TestCase):
    ...
    def test_max_autotune_no_cudagraphs(self, serialize):
        ...
        original_compile = smith._inductor.standalone_compile
        captured_options = []
        ...
        smith._inductor.standalone_compile = verify_options
        ...
        try:
            ...
            smith._inductor.standalone_compile = original_compile
    ...
    def test_annotation_inductor_configs(self):
        ...
        smith._inductor.standalone_compile = capture_config
        ...
        try:
            ...
            x = smith.randn(32, 32, requires_grad=True)
            y = smith.randn(32, 32, requires_grad=True)
    ...
    def test_selective_ac_flex(self, serialize):
        class FlexAttentionModule(smith.nn.Module):
            def __init__(self, hidden_size, num_heads):
                ...
                self.q_proj = smith.nn.Linear(hidden_size, hidden_size)
                self.k_proj = smith.nn.Linear(hidden_size, hidden_size)
                self.v_proj = smith.nn.Linear(hidden_size, hidden_size)

                # Out-projection
                self.out_proj = smith.nn.Linear(hidden_size, hidden_size)
            ...
            def forward(self, x):
                ...
                with smith.fx.traceback.annotate({"compile_with_inductor": 0}):
        ...
        class SacModule(smith.nn.Module):
        ...
        flex_module = SacModule(hidden_size=512, num_heads=8, context_fn=context_fn).to(
            "cuda", dtype=smith.bfloat16
        )
        x = smith.ones(8, 1024, 512, device="cuda", dtype=smith.bfloat16)
        compiled_module = smith.compile(
...
@skipIfSmithDynamo("Not a suitable dynamo wrapped test")
@smith._dynamo.config.patch("enable_invoke_subgraph_regional_compile", True)
@instantiate_parametrized_tests
class RegionalInductorInvokeSubgraphTests(smith._inductor.test_case.TestCase):
    def test_custom_decomposition(self):
        ...
        nested_config = get_invoke_subgraph_compile_options(
            decompositions={
                smith.ops.aten.add.Tensor: my_add_decomp,
                smith.ops.aten.add.default: my_add_decomp,
            }
        )

        @smith.compiler.nested_compile_region(options=nested_config)
        def g(y):
            return y + 1
...
def forward(self, primals_0):
    sin = smith.ops.aten.sin.default(primals_0);  primals_0 = None
    return (sin,)""",
...
def forward(self, tangents_0):
    clone = smith.ops.aten.clone.default(tangents_0);  tangents_0 = None
    return (clone,)""",
                ignore_comments=True,
                ignore_empty_lines=True,
            )
    ...
    def test_unbacked_expr_input(self, serialize):
        # https://github.com/blacksmith/blacksmith/issues/167012
        ...
        c = smith.randn((64, 32), requires_grad=True)
...
def forward(self, primals_0, primals_1):
    mul = smith.ops.aten.mul.Tensor(primals_0, primals_1)
...
def forward(self, primals_0, primals_1, tangents_0):
    mul_1 = smith.ops.aten.mul.Tensor(tangents_0, primals_0);  primals_0 = None
    mul_2 = smith.ops.aten.mul.Tensor(tangents_0, primals_1);  tangents_0 = primals_1 = None
    return (mul_2, mul_1)""",
                ignore_comments=True,
                ignore_empty_lines=True,
            )
...
def forward(self, primals_1, primals_2):
    ...
    invoke_subgraph_4 = smith.ops.higher_order.invoke_subgraph(partitioned_fw_subgraph_0_0, 'partitioned_fw_subgraph_0_0', sin, primals_2);  partitioned_fw_subgraph_0_0 = sin = None
    getitem_9 = invoke_subgraph_4[2]
    getitem_8 = invoke_subgraph_4[1]
    getitem = invoke_subgraph_4[0];  invoke_subgraph_4 = None
    sin_1 = smith.ops.aten.sin.default(getitem)
    sin_2 = smith.ops.aten.sin.default(sin_1)
    partitioned_fw_subgraph_0_1 = self.partitioned_fw_subgraph_0_0
    invoke_subgraph_6 = smith.ops.higher_order.invoke_subgraph(partitioned_fw_subgraph_0_1, 'partitioned_fw_subgraph_0_0', sin_2, primals_2);  partitioned_fw_subgraph_0_1 = sin_2 = primals_2 = None
    getitem_11 = invoke_subgraph_6[2]
    getitem_10 = invoke_subgraph_6[1]
    getitem_1 = invoke_subgraph_6[0];  invoke_subgraph_6 = None
    sin_3 = smith.ops.aten.sin.default(getitem_1)
...
def forward(self, primals_1, getitem_9, getitem_8, getitem, sin_1, getitem_11, getitem_10, getitem_1, tangents_1):
    cos = smith.ops.aten.cos.default(getitem_1);  getitem_1 = None
    mul = smith.ops.aten.mul.Tensor(tangents_1, cos);  tangents_1 = cos = None
    partitioned_bw_subgraph_0_1 = self.partitioned_bw_subgraph_0_0
    invoke_subgraph_7 = smith.ops.higher_order.invoke_subgraph(partitioned_bw_subgraph_0_1, 'partitioned_bw_subgraph_0_0', getitem_10, getitem_11, mul);  partitioned_bw_subgraph_0_1 = getitem_10 = getitem_11 = mul = None
    getitem_2 = invoke_subgraph_7[0]
    getitem_3 = invoke_subgraph_7[1];  invoke_subgraph_7 = None
    cos_1 = smith.ops.aten.cos.default(sin_1);  sin_1 = None
    mul_1 = smith.ops.aten.mul.Tensor(getitem_2, cos_1);  getitem_2 = cos_1 = None
    cos_2 = smith.ops.aten.cos.default(getitem);  getitem = None
    mul_2 = smith.ops.aten.mul.Tensor(mul_1, cos_2);  mul_1 = cos_2 = None
    partitioned_bw_subgraph_0_0 = self.partitioned_bw_subgraph_0_0
    invoke_subgraph_5 = smith.ops.higher_order.invoke_subgraph(partitioned_bw_subgraph_0_0, 'partitioned_bw_subgraph_0_0', getitem_8, getitem_9, mul_2);  partitioned_bw_subgraph_0_0 = getitem_8 = getitem_9 = mul_2 = None
    getitem_5 = invoke_subgraph_5[0]
    getitem_6 = invoke_subgraph_5[1];  invoke_subgraph_5 = None
    add = smith.ops.aten.add.Tensor(getitem_3, getitem_6);  getitem_3 = getitem_6 = None
    cos_3 = smith.ops.aten.cos.default(primals_1);  primals_1 = None
    mul_3 = smith.ops.aten.mul.Tensor(getitem_5, cos_3);  getitem_5 = cos_3 = None
...
def forward(self, arg0_1):
    mul = smith.ops.aten.mul.Tensor(arg0_1, 2);  arg0_1 = None
    return (mul,)""",
                ignore_comments=True,
                ignore_empty_lines=True,
            )
...
def forward(self, arg0_1, arg1_1):
    ...
    def test_flex_attention(self, serialize):
        ...
        nested_config = get_invoke_subgraph_compile_options(
            decompositions=smith._decomp.core_aten_decompositions()
        )
...
def forward(self, primals_0, primals_1, primals_2, primals_3, primals_4, primals_5, primals_6, primals_7, primals_8):
    ...
    flex_attention = smith.ops.higher_order.flex_attention(primals_0, primals_0, primals_0, sdpa_score0, (768, 768, primals_1, primals_2, primals_3, primals_4, primals_5, primals_6, primals_7, primals_8, 128, 128, sdpa_mask0), 0.125, {'BACKEND': 'AUTO', 'PRESCALE_QK': False, 'ROWS_GUARANTEED_SAFE': False, 'BLOCKS_ARE_CONTIGUOUS': False, 'WRITE_DQ': True, 'OUTPUT_LOGSUMEXP': True, 'OUTPUT_MAX': False}, (), ());  sdpa_score0 = sdpa_mask0 = None
    getitem = flex_attention[0]
    getitem_1 = flex_attention[1];  flex_attention = None
    alias = smith.ops.aten.alias.default(getitem)
    alias_1 = smith.ops.aten.alias.default(getitem_1);  getitem_1 = None
    alias_2 = smith.ops.aten.alias.default(alias);  alias = None
    alias_3 = smith.ops.aten.alias.default(alias_1);  alias_1 = None
...
def forward(self, primals_0, primals_1, primals_2, primals_3, primals_4, primals_5, primals_6, primals_7, primals_8, alias_2, alias_3, tangents_0):
    ...
    add = smith.ops.aten.add.Tensor(getitem_3, getitem_4);  getitem_3 = getitem_4 = None
    add_1 = smith.ops.aten.add.Tensor(add, getitem_5);  add = getitem_5 = None
    ...
    def test_max_autotune_no_cudagraphs(self, serialize):
        ...
        # Hook to verify options
        original_compile = smith._inductor.compile_fx._compile_fx_inner
        captured_options = []
        ...
        def verify_options(*args, **kwargs):
            ...
            # Verify config is set as expected from explicit options
            assert smith._inductor.config.max_autotune, "max_autotune should be True"
            assert not inductor_config.triton.cudagraphs, (
                "triton.cudagraphs should be False"
            )
        ...
        smith._inductor.compile_fx._compile_fx_inner = verify_options
        ...
        try:
            ...
            smith._inductor.compile_fx._compile_fx_inner = original_compile
    ...
    def test_selective_ac_flex(self, serialize):
        ...
        decomp_table = smith._decomp.core_aten_decompositions()
        decomp_table.update(
            smith._decomp.get_decompositions(
                {
                    smith.ops.aten.arange.start_step,
    ...
    def test_invoke_subgraph_regional_compile_decomposition(self, serialize):
        ...
        decompositions = {smith.ops.aten.sin.default: my_sin_decomp}
        nested_config = get_invoke_subgraph_compile_options(
        ...
        res, codes = run_fw_bw_and_get_code(lambda: opt_fn(x))
        self.assertEqual(len(codes), 2)
        true_res = smith.sin(x) + smith.cos(x)
        self.assertEqual(res, true_res)
    ...
    def test_invoke_subgraph_regional_compile(self, serialize):
        ...
        original_mincut_partitioner = (
            smith._funcsmith.partitioners.min_cut_rematerialization_partition
        )
        ...
        if serialize:
            ...
            smith._funcsmith.partitioners.default_partition = test_partitioner
...
@skipIfSmithDynamo("Not a suitable dynamo wrapped test")
class TestRegionalOutputCode(smith._inductor.test_case.TestCase):
    ...
    def test_regional_output_code_serialization(self):
        ...
        with (
            smith.fx.traceback.preserve_node_meta(enable=False),
            smith._funcsmith.config.patch(force_autograd_cache=True),
        ):
        ...
        from smith._inductor.output_code import CompiledFxGraphConstants
        ...
        self.assertIsNotNone(output_code._graph_module)
        self.assertIsInstance(output_code._graph_module, smith.fx.GraphModule)
