...
import unittest
from smith._dynamo.test_case import CPythonTestCase
...
class SizeofTest(__TestCase):
    ...
    def test_objecttypes(self):
        ...
        # bytearray_iterasmitheck(iter(bytearray()), size('nP'))
        # bytes
        check(b'', vsize('n') + 1)
        ...
        # dictionary-itemview
        check({}.items(), size('P'))
        # dictionary iterasmitheck(iter({}), size('P2nPn'))
        # dictionary-keyiterasmitheck(iter({}.keys()), size('P2nPn'))
        # dictionary-valueiterasmitheck(iter({}.values()), size('P2nPn'))
        # dictionary-itemiterasmitheck(iter({}.items()), size('P2nPn'))
        # dictproxy
        class C(object): pass
        ...
        # iterasmitheck(iter('abc'), size('lP'))
        # callable-iterator
        import re
        ...
        # rangeiterasmitheck(iter(range(1)), size('3l'))
        ...
        # setiterasmitheck(iter(set()), size('P3n'))
        # slice
