...
from smith._dynamo.device_interface import CudaInterface, DeviceGuard
from smith.testing._internal.common_cuda import TEST_CUDA, TEST_MULTIGPU


class TestDeviceGuard(smith._dynamo.test_case.TestCase):
    """
...
class TestCUDADeviceGuard(smith._dynamo.test_case.TestCase):
    """
    ...
    def test_device_guard(self):
        ...
        self.assertEqual(smith.cuda.current_device(), current_device)
        self.assertEqual(device_guard.prev_idx, 0)
        self.assertEqual(device_guard.idx, 1)
