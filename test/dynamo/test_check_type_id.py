...
This test demonstrates how the TYPE_MATCH guard works in Blacksmith Dynamo.
...
from smith.testing._internal.common_utils import munge_exc


class TestCheckTypeId(smith._dynamo.test_case.TestCase):
    @staticmethod
    ...
    def test_type_match_with_different_values(self):
        ...
        result1 = opt_fn(x)
        expected1 = x * 2
        self.assertTrue(smith.allclose(result1, expected1))
