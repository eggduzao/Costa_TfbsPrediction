...
from smith._dynamo import bytecode_analysis, bytecode_transformation
from smith._dynamo.testing import skipIfNotPy311, skipIfNotPy312


class BytecodeTests(smith._dynamo.test_case.TestCase):
    @skipIfNotPy311
...
{str(chr(10)).join(" " * 4 + "x" + str(i) + " = 1" for i in range(1 << 9))}
    ...
    def test_if_tensor_is_none(self):
        ...
        self.assertEqual(opt_f(None, smith.ones(2)), 6)
    ...
    def test_py311_jump_offset(self):
        ...
        for test in test_args:
            ...
            dummy_opt = smith.compile(dummy_fn, backend="eager")
    ...
    # https://github.com/blacksmith/blacksmith/issues/160471
...
class BytecodeHookTests(smith._dynamo.test_case.TestCase):
