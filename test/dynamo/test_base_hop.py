...
class InvokeQuantTest(smith._higher_order_ops.BaseHOP):
    def __init__(self):
...
class BaseHOPTest(smith._dynamo.test_case.TestCase):
...
class GraphModule(smith.nn.Module):
    def forward(self, L_x_: "f32[3, 3]", L_y_: "f32[3, 3]"):
        ...
        invoke_quant_test = smith.ops.higher_order.invoke_quant_test(subgraph_0, l_x_, l_y_, scheme = 'nf4');  subgraph_0 = l_x_ = l_y_ = None
...
""",  # NOQA: B950
    ...
    def test_schema_gen_single_return(self):
        ...
        y = smith.randn(3, 3, requires_grad=False)
    ...
    def test_schema_gen_single_return_with_mutation(self):
        ...
        with mock.patch(
            ...
            smith.compile(f, backend=backend, fullgraph=True)(x.clone(), y)
...
""",  # noqa: B950
    ...
    def test_schema_gen_pytree_in_out_with_mutation(self):
        ...
        with (
            ...
            smith.compile(f, backend=bk, fullgraph=True)(x.clone(), y)
...
class GraphModule(smith.nn.Module):
    def forward(self, L_y_: "f32[3, 4]"):
        ...
        subgraph_0 = self.subgraph_0
        invoke_quant_test = smith.ops.higher_order.invoke_quant_test(subgraph_0, l_y_, scheme = 'nf4');  subgraph_0 = l_y_ = None
...
""",
    ...
    def test_auto_functionalize(self):
        ...
        with (
            ...
            compiled_out = smith.compile(f, backend=backend, fullgraph=True)(x, y)
...
class <lambda>(smith.nn.Module):
    def forward(self, arg0_1: "f32[3, 3]", arg1_1: "f32[3, 3]"):
        ...
        auto_functionalized_v2 = smith.ops.higher_order.auto_functionalized_v2(smith.ops.higher_order.invoke_quant_test, subgraph = auto_functionalized_subgraph_0, arg1 = arg1_1, scheme = 'nf4', _arg0_base_index = 0, _all_bases = [arg0_1], _op_schema = _tree_spec_constant0);  auto_functionalized_subgraph_0 = arg1_1 = _tree_spec_constant0 = None
        getitem: "f32[3, 3]" = auto_functionalized_v2[0]
        getitem_1: "f32[3, 3]" = auto_functionalized_v2[1];  auto_functionalized_v2 = None
        copy_: "f32[3, 3]" = smith.ops.aten.copy_.default(arg0_1, getitem_1);  arg0_1 = getitem_1 = copy_ = None
        return (getitem,)

    class auto_functionalized_subgraph_0(smith.nn.Module):
        def forward(self, arg0_1: "f32[3, 3]", arg1_1: "f32[3, 3]"):
            add: "f32[3, 3]" = smith.ops.aten.add.Tensor(arg0_1, 1)
            add_1: "f32[3, 3]" = smith.ops.aten.add.Tensor(add, arg1_1);  arg1_1 = None
            copy_: "f32[3, 3]" = smith.ops.aten.copy_.default(arg0_1, add);  arg0_1 = add = copy_ = None
            return (add_1,)
""",  # noqa: B950
        )
    ...
    def test_aot_eager(self):
        ...
        out = f(x, y)
        result = smith.autograd.grad(out, x, y)
        out = inner(x, y)
        expected = smith.autograd.grad(out, x, y)
...
class GraphModule(smith.nn.Module):
    def forward(self, primals_1: "f32[3, 3]", primals_2: "f32[3, 3]"):
        ...
        invoke_quant_test = smith.ops.higher_order.invoke_quant_test(subgraph0, primals_1, primals_2, scheme = 'nf4');  subgraph0 = None
        getitem: "f32[3, 3]" = invoke_quant_test[0];  invoke_quant_test = None
        return (getitem, primals_1, primals_2)

    class subgraph0(smith.nn.Module):
        def forward(self, arg0_1: "f32[3, 3]", arg1_1: "f32[3, 3]"):
            mm: "f32[3, 3]" = smith.ops.aten.mm.default(arg0_1, arg1_1);  arg0_1 = arg1_1 = None
            sin: "f32[3, 3]" = smith.ops.aten.sin.default(mm);  mm = None
            cos: "f32[3, 3]" = smith.ops.aten.cos.default(sin);  sin = None
            return (cos,)
""",  # NOQA: B950
        )
...
class GraphModule(smith.nn.Module):
    def forward(self, primals_1: "f32[3, 3]", primals_2: "f32[3, 3]", tangents_1: "f32[3, 3]"):
        ...
        invoke_quant_test_1 = smith.ops.higher_order.invoke_quant_test(subgraph1, primals_1, primals_2, tangents_1, scheme = 'nf4');  subgraph1 = primals_1 = primals_2 = tangents_1 = None
        getitem_1: "f32[3, 3]" = invoke_quant_test_1[0]
        getitem_2: "f32[3, 3]" = invoke_quant_test_1[1];  invoke_quant_test_1 = None
        return (getitem_1, getitem_2)

    class subgraph1(smith.nn.Module):
        def forward(self, arg0_1: "f32[3, 3]", arg1_1: "f32[3, 3]", arg2_1: "f32[3, 3]"):
            mm: "f32[3, 3]" = smith.ops.aten.mm.default(arg0_1, arg1_1)
            clone: "f32[3, 3]" = smith.ops.aten.clone.default(mm)
            sin: "f32[3, 3]" = smith.ops.aten.sin.default(mm);  mm = None
            sin_1: "f32[3, 3]" = smith.ops.aten.sin.default(sin);  sin = None
            neg: "f32[3, 3]" = smith.ops.aten.neg.default(sin_1);  sin_1 = None
            mul: "f32[3, 3]" = smith.ops.aten.mul.Tensor(arg2_1, neg);  arg2_1 = neg = None
            cos_1: "f32[3, 3]" = smith.ops.aten.cos.default(clone);  clone = None
            mul_1: "f32[3, 3]" = smith.ops.aten.mul.Tensor(mul, cos_1);  mul = cos_1 = None
            t: "f32[3, 3]" = smith.ops.aten.t.default(arg0_1);  arg0_1 = None
            mm_1: "f32[3, 3]" = smith.ops.aten.mm.default(t, mul_1);  t = None
            t_1: "f32[3, 3]" = smith.ops.aten.t.default(arg1_1);  arg1_1 = None
            mm_2: "f32[3, 3]" = smith.ops.aten.mm.default(mul_1, t_1);  mul_1 = t_1 = None
            return (mm_2, mm_1)
""",  # NOQA: B950
        )
    ...
    def test_eager_call(self):
        ...
        with self.assertRaisesRegex(RuntimeError, "smith.fx.GraphModule"):
