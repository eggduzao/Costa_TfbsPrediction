...
from smith._dynamo.testing import skipIfNotPy312
...
class ComprehensionTests(smith._inductor.test_case.TestCase):
    ...
    def test_dict_comprehension_graph_break(self):
        ...
        def fn(x):
            y = x + 1
            result = {i: smith._dynamo.graph_break() or i**2 for i in range(3)}
            z = x + 2
            return y, result, z
    ...
    def test_multiple_comprehensions_one_break(self):
        ...
        def fn(x):
            ...
            list2 = [smith._dynamo.graph_break() or i for i in range(2)]
            b = x + 2
    ...
    def test_nested_comprehension_inner_break(self):
        ...
        def fn(x):
            a = x + 1
            result = [
                [smith._dynamo.graph_break() or i * j for j in range(2)]
                for i in range(2)
            ]
            b = x + 2
            return a, result, b
    ...
    def test_multi_iterator_comprehension_break(self):
        ...
        def fn(x):
            a = x + 1
            result = [
                (smith._dynamo.graph_break() or i, j)
                for i in range(2)
                for j in range(2)
            ]
            b = x + 2
    ...
    def test_discarded_comprehension_graph_break(self):
        ...
        def fn(x):
            a = x + 1
            [smith._dynamo.graph_break() or i for i in range(3)]
            b = x + 2
            return a, b
    ...
    def test_comprehension_in_expression_graph_break(self):
        ...
        def fn(x):
            a = x + 1
            total = sum([smith._dynamo.graph_break() or i for i in range(3)])
            b = x + 2
            return a, total, b
    ...
    def test_comprehension_return_directly(self):
        ...
        def fn(x):
            a = x + 1  # noqa: F841
            return [smith._dynamo.graph_break() or i for i in range(3)]
    ...
    def test_walrus_operator_in_comprehension(self):
        ...
        def fn(x):
            a = x + 1
            result = [(y := (smith._dynamo.graph_break() or i * 2)) for i in range(3)]
            b = x + 2
            return a, result, y, b
    ...
    def test_walrus_operator_in_if_in_comprehension(self):
        ...
        def fn(x):
            a = x + 1
            result = [
                (smith._dynamo.graph_break() or y) for i in range(5) if (y := i * 2) > 2
            ]
            b = x + 2
            return a, result, y, b
    ...
    def test_walrus_operator_in_comprehension_with_tensor(self):
        ...
        def fn(x):
            a = x + 1
            result = [
                (smith._dynamo.graph_break() or y + x.numel())
                for i in range(5)
                if (y := i * 2) > 2
            ]
            b = x + 2
    ...
    def test_multiple_walrus_operators_in_comprehension(self):
        ...
        def fn(x):
            a = x + 1
            result = [
                ((y := (smith._dynamo.graph_break() or i * 2)), (z := i * 3))
                for i in range(3)
            ]
            b = x + 2
        ...
        def fn(x):
            ...
            result = [
                (
                    outer := i * 10,
                    [
                        (inner := (smith._dynamo.graph_break() or j * 2))
                        for j in range(2)
                    ],
                )
                for i in range(3)
    ...
    def test_nested_comprehension_with_captured_outer_variable(self):
        ...
        def fn(x):
            ...
            a = x + 1
            result = [
                [outer_val + j for j in range(2) if smith._dynamo.graph_break() or True]
                for i in range(2)
            ]
            b = x + 2
            return a, result, b
            ...
            result = [
                [
                    [
                        (w := i + j + k)
                        for k in range(2)
                        if smith._dynamo.graph_break() or True
                    ]
                    for j in range(2)
                ]
                for i in range(2)
    ...
    def test_comprehension_with_outer_variable_read(self):
        ...
        def fn(x):
            ...
            a = x + 1
            result = [
                i + outer_val for i in range(3) if smith._dynamo.graph_break() or True
            ]
            b = x + 2
            return a, result, b
    ...
    def test_nested_multi_for_comprehension_graph_break(self):
        ...
        def fn(x):
            a = x + 1
            result = [
                [(smith._dynamo.graph_break() or i + j + k) for k in range(2)]
                for i in range(2)
                for j in range(2)
            ]
            b = x + 2
    ...
    def test_multiple_comprehension_graph_breaks(self):
        ...
        def fn(x):
            a = x + 1
            list1 = [smith._dynamo.graph_break() or i for i in range(2)]
            b = x + 2
            list2 = [smith._dynamo.graph_break() or i * 2 for i in range(2)]
            c = x + 3
    ...
    def test_comprehension_modifying_global_variable(self):
        ...
        def fn(x):
            ...
            result = [
                smith._dynamo.graph_break() or _GLOBAL_VALUE_FOR_COMPREHENSION_TEST + i
                for i in range(3)
            ]
            b = x + 2
            return a, result, b
    ...
    def test_comprehension_modifying_closure_variable(self):
        ...
        def make_fn():
            ...
            def fn(x):
                ...
                closure_val[0] += 1
                result = [
                    smith._dynamo.graph_break() or closure_val[0] + i for i in range(3)
                ]
                b = x + 2
    ...
    def test_list_and_dict_comprehension_graph_breaks(self):
        ...
        def fn(x):
            ...
            list1 = [smith._dynamo.graph_break() or i for i in range(2)]
            b = x + 2
            dict1 = {i: smith._dynamo.graph_break() or i * 10 for i in range(2)}
            c = x + 3
    ...
    def test_nested_dict_in_list_comprehension_graph_break(self):
        ...
        def fn(x):
            a = x + 1
            result = [
                {j: smith._dynamo.graph_break() or i * j for j in range(2)}
                for i in range(2)
            ]
            b = x + 2
            return a, result, b
    ...
    @smith._dynamo.config.patch(nested_graph_breaks=False)
    def test_nested_function_calls_with_comprehension_graph_break(self):
        ...
        backend = smith._dynamo.testing.EagerAndRecordGraphs()
        compiled = smith.compile(f, backend=backend)
        x = smith.randn(4)
