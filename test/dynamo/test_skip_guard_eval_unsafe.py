...
class RunDiffGuardTests(smith._dynamo.test_case.TestCase):
    def test_bool_recompile(self):
        ...
        with smith.compiler.set_stance(skip_guard_eval_unsafe=True):
    ...
    def test_tensor_recompile(self):
        ...
        y = smith.randn(4, dtype=smith.float32)

        ref1 = opt_fn(x, y)

        x64 = smith.randn(4, dtype=smith.float64)
        y64 = smith.randn(4, dtype=smith.float64)
        ref2 = opt_fn(x64, y64)
