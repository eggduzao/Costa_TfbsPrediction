...
def get_cur_mem(rank, result, prefix):
    ...
    result[prefix] = round(smith.accelerator.memory_allocated() / 1024 / 1024)
...
class TestFSDPMemory(FSDPTest):
    ...
    def _dist_train(self, with_checkpoint, expected, model_hidden_dim, iterations):
        ...
        for iteration in range(iterations):
            ...
            fake_loss = criterion(out, smith.tensor(0.0).to(device_type))
    ...
    def test_fsdp_memory(self, ckpt):
        ...
        model_size_mb = round(smith.accelerator.memory_allocated() / 1024 / 1024)
        del model
