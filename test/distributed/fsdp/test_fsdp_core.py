...
class TestParityWithDDP(FSDPTest):
    ...
    Blacksmith DDP vs. FullyShardedDataParallel.
    """
...
class TestHooks(FSDPTest):
    ...
    def _test_pre_backward_hook_registration(self, model):
        optim = smith.optim.SGD(model.parameters(), lr=0.01, momentum=0.9)
        optim.zero_grad()
    ...
    def test_register_functions_called(self, cuda_first: bool, mixed_precision: bool):
        ...
        orig_register_pre_backward_hooks = (
            smith.distributed.fsdp._runtime_utils._register_pre_backward_hooks
        )
        ...
        with (
            ...
            mock.patch(
                "smith.distributed.fsdp._runtime_utils._register_post_backward_hook"
