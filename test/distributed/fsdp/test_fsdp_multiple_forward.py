...
from smith.nn import Linear, Module
...
from smith.testing._internal.common_fsdp import FSDPTest, get_devtype, get_full_params
...
class TestMultiForward(FSDPTest):
    def _dist_train(self, wrap_fsdp):
        ...
        in_data = smith.rand(64, 4).to(device_type.type)
