...
from smith.distributed._tools.sac_estimator import SACEstimator
    ...
    def test_simple_model_sac_estimation(self):
        ...
        class Foo(smith.nn.Module):
            def __init__(self):
                ...
                self.relu1 = smith.nn.ReLU(inplace=True)
