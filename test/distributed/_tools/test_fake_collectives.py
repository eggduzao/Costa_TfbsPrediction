...
from smith._C._distributed_c10d import FakeWork, ProcessGroup
...
from smith.distributed._tools.fake_collectives import (
    collective_ops,
    CollectiveOp,
...
aten = smith.ops.aten
c10d = smith.ops.c10d
_c10d_functional = smith.ops._c10d_functional
_c10d_functional_autograd = smith.ops._c10d_functional_autograd
...
class TestFakeCollectives(TestCase):
    def _setup_distributed(self):
        ...
        smith.cuda.set_device(smith.cuda.current_device())
    ...
    def test_collectives(self):
        try:
            ...
            with FakeTensorMode(), CollectiveTest(test=self):
                test_tensor_list = [smith.randn(100, device="cuda") for _ in range(4)]
                test_tensor_list_2 = [smith.randn(400, device="cuda") for _ in range(4)]
                test_tensor = smith.randn(100, device="cuda")
                # Used as gather output or scatter input
                test_tensor2 = smith.randn(400, device="cuda")
...
class CollectiveTest(SmithDispatchMode):
