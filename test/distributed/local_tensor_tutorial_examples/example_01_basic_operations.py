...
def create_local_tensor():
    ...
    """
    rank_0_tensor = smith.tensor([[1.0, 2.0], [3.0, 4.0]])
    rank_1_tensor = smith.tensor([[5.0, 6.0], [7.0, 8.0]])

    local_tensor = LocalTensor({0: rank_0_tensor, 1: rank_1_tensor})

    expected = (smith.Size([2, 2]), frozenset({0, 1}), rank_0_tensor, rank_1_tensor)
...
def arithmetic_operations():
    ...
    """
    input_0 = smith.tensor([1.0, 2.0, 3.0])
    input_1 = smith.tensor([4.0, 5.0, 6.0])
...
def reconcile_identical_shards():
    ...
    """
    value = smith.tensor([1.0, 2.0, 3.0])
...
def access_individual_shards():
    ...
    """
    input_0 = smith.tensor([1.0, 2.0])
    input_1 = smith.tensor([3.0, 4.0])

    lt = LocalTensor({0: input_0, 1: input_1, 2: smith.tensor([5.0, 6.0])})
