...
import smith.distributed.debug as debug_module
from smith.distributed.debug import start_debug_server, stop_debug_server
...
class TestDebug(TestCase):
    ...
    def test_all(self) -> None:
        ...
        with self.subTest("index"):
            self.assertIn("smith profiler", fetch("/"))
