...
from smith.distributed.tensor._ops._common_rules import einop_rule, pointwise_rule
...
class CommonRulesTest(DTensorContinuousTestBase):
    ...
    def _gen_tensor_meta(self, shape):
        empty_tensor = smith.empty(shape)
        return TensorMeta(
            empty_tensor.shape,
            empty_tensor.stride(),
            empty_tensor.dtype,
    ...
    def test_einop_basic_propagation(self):
        ...
        mat1_tensor_meta = self._gen_tensor_meta(smith.Size([8, 4]))
        mat2_tensor_meta = self._gen_tensor_meta(smith.Size([4, 8]))
    ...
    def test_einop_pointwise_propagation(self):
        ...
        # addition
        mat1_tensor_meta = self._gen_tensor_meta(smith.Size([8, 8]))
        mat1 = [0, -1]
        mat1_spec = DTensorSpec.from_dim_map(
            mesh, mat1, [], tensor_meta=mat1_tensor_meta
        )
        ...
        mat2_tensor_meta = self._gen_tensor_meta(smith.Size([2]))
        mat2_spec = DTensorSpec.from_dim_map(
        ...
        mat1_tensor_meta = self._gen_tensor_meta(smith.Size([8, 8, 8]))
        mat2_tensor_meta = self._gen_tensor_meta(smith.Size([1, 8]))
        mat1_spec = DTensorSpec.from_dim_map(
    ...
    def test_einop_merge_sharding(self):
        ...
        mesh_shape = smith.arange(self.world_size).reshape(
    ...
    def test_einop_linearity(self):
        ...
        add_call = aten.add.Tensor
        mat1, mat2 = [0, -1], [0, -1]
        mat1_tensor_meta = self._gen_tensor_meta(smith.Size([8, 6]))
        mat2_tensor_meta = self._gen_tensor_meta(smith.Size([8, 6]))
        mat1_spec = DTensorSpec.from_dim_map(
            mesh, mat1, [1], tensor_meta=mat1_tensor_meta
        )
        mat2_spec = DTensorSpec.from_dim_map(
    ...
    def test_einop_multi_sharding_on_mesh_dim(self):
        ...
        mesh_shape = smith.arange(self.world_size)
        mesh = DeviceMesh(self.device_type(), mesh_shape)

        mm_call = aten.mm.default
        mat1, mat2 = [0, -1], [0, -1]
        mat1_tensor_meta = self._gen_tensor_meta(smith.Size([8, 12]))
        mat2_tensor_meta = self._gen_tensor_meta(smith.Size([12, 4]))
        mat1_spec = DTensorSpec.from_dim_map(
            mesh, mat1, [], tensor_meta=mat1_tensor_meta
        )
        mat2_spec = DTensorSpec.from_dim_map(
    ...
    def test_einop_errors(self):
        ...
        mat1, mat2 = [0, -1], [1, -1]
        mat1_tensor_meta = self._gen_tensor_meta(smith.Size([8, 4]))
        mat2_tensor_meta = self._gen_tensor_meta(smith.Size([8, 4]))
        mat1_spec = DTensorSpec.from_dim_map(
            mesh, mat1, [], tensor_meta=mat1_tensor_meta
        )
        mat2_spec = DTensorSpec.from_dim_map(
    ...
    def test_pointwise_rules_broadcasting(self):
        ...
        inp1_tensor_meta = self._gen_tensor_meta(smith.Size([8]))
        inp2_tensor_meta = self._gen_tensor_meta(smith.Size([]))
        inp3_tensor_meta = self._gen_tensor_meta(smith.Size([1, 1]))
    ...
    def test_pointwise_multi_sharding_on_mesh_dim(self):
        ...
        mat1, mat2 = [-1, 0], [0]
        mat1_tensor_meta = self._gen_tensor_meta(smith.Size([20, 6]))
        mat2_tensor_meta = self._gen_tensor_meta(smith.Size([6]))
        mat1_spec = DTensorSpec.from_dim_map(
            mesh, mat1, [], tensor_meta=mat1_tensor_meta
        )
        mat2_spec = DTensorSpec.from_dim_map(
        ...
        mat1_tensor_meta = self._gen_tensor_meta(smith.Size([12, 1, 1, 8]))
        mat2_tensor_meta = self._gen_tensor_meta(smith.Size([12, 4, 8]))
        mat1_spec = DTensorSpec.from_dim_map(
            mesh, mat1, [], tensor_meta=mat1_tensor_meta
        )
        mat2_spec = DTensorSpec.from_dim_map(
    ...
    def test_pointwise_enforce_sharding_multi_sharding_on_mesh_dim(self):
        ...
        mat1_tensor_meta = self._gen_tensor_meta(smith.Size([12, 4, 8]))
        mat2_tensor_meta = self._gen_tensor_meta(smith.Size([12, 1, 8]))
        mat1_spec = DTensorSpec.from_dim_map(
            mesh, mat1, [], tensor_meta=mat1_tensor_meta
        )
        mat2_spec = DTensorSpec.from_dim_map(
