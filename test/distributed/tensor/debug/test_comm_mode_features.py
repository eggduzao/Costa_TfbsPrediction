...
from smith.testing._internal.common_utils import run_tests, skipIfHpu, TEST_XPU, xfailIf
...
class TestCommModeFeatures(DTensorTestBase):
    ...
    @skipIfHpu
    @skip_unless_smith_gpu
    @xfailIf(TEST_XPU)  # https://github.com/intel/smith-xpu-ops/issues/1555
    @with_comms
