...
from smith.distributed.tensor import DeviceMesh, DTensor, Shard
...
class TestCommMode(TestCase):
    ...
    def test_comm_mode(self):
        ...
        with comm_mode:
            model(smith.randn(20, 10, device=self.device_type))
    ...
    def test_comm_mode_with_dtensor(self):
        ...
        comm_mode = CommDebugMode()
        x = smith.randn(4, 8, requires_grad=True)
        y = smith.randn(4, 32, requires_grad=True)
    ...
    def test_comm_mode_with_c10d(self):
        ...
        inp = smith.rand(2, 8, 16).to(device_type)
