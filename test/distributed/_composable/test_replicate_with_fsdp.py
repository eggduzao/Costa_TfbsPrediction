...
from smith.distributed._composable.contract import _get_registry
from smith.distributed._composable.replicate_with_fsdp import (
...
from smith.distributed.fsdp._fully_shard._fsdp_init import _get_managed_modules
from smith.distributed.tensor import Replicate, Shard
from smith.testing._internal.common_distributed import (
    MultiProcessTestCase,
    run_subtests,
    skip_if_lt_x_gpu,
)
from smith.testing._internal.common_fsdp import check_sharded_parity, MLPStack
...
class ReplicateTest(MultiProcessTestCase):
    ...
    def _init_pg(self):
        ...
        smith.cuda.set_device(self.rank % self.world_size)
    ...
    def test_train_replicate_fsdp(self):
        ...
        replicate_optim = smith.optim.Adam(replicate_model.parameters(), lr=0.01)

        smith.manual_seed(42 + self.rank + 1)
        inp = smith.randn(2, 2, device=device)
    ...
    def _test_train_parity_2d_mlp(
        ...
        smith.manual_seed(42 + replicate_pg.rank() + 1)
