...
from smith.distributed.checkpoint.default_planner import _create_default_local_metadata
...
class TestModule(smith.nn.Module):
    def __init__(self) -> None:
        ...
        self.regular = smith.nn.Parameter(smith.ones(4, 4))
        self.extra_sharded: Optional[ShardedTensor] = None
        self.extra_param: Optional[smith.nn.Parameter] = None
...
class TestDistributedCheckpointing(ShardedTensorTestBase):
    ...
    def test_tensor_metadata_with_missing_rank_spec(self) -> None:
        ...
        st = sharded_tensor.zeros(spec, 4, 4, dtype=smith.float64)
    ...
    def test_default_metadata(self) -> None:
        ...
        state_dict = {
            ...
            "replicated": smith.rand(4, device=device),
            "bytes": [1, 2, 3, 4],
        }
        ...
        self.assertEqual(md.properties.dtype, smith.float32)
...
class TestDistributedFailure(ShardedTensorTestBase):
    ...
    def test_save_error_handling_no_dist(self) -> None:
        state_dict = {"replicated": smith.rand(10, 10), "bytes": [1, 2, 3, 4]}
