...
from smith.testing._internal.common_distributed import skip_if_win32
...
class TestAsyncProcessExecutor(DTensorTestBase):
    ...
    def test_checkpoint_save_failure_continues_serving(self) -> None:
        ...
        test_state_dict = {
            "model": {"weight": smith.randn(4, 4), "bias": smith.randn(4)},
        ...
        with patch.dict(os.environ, {}, clear=False):
            ...
            with patch(
                "smith.distributed.checkpoint._async_process_executor.get_free_port",
                return_value=-1,
            ):
