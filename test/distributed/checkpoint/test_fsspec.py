...
from smith.distributed.checkpoint._fsspec_filesystem import (
    FileSystem,
    FsspecReader,
    FsspecWriter,
)
from smith.distributed.checkpoint.optimizer import load_sharded_optimizer_state_dict
...
class TestFSSpec(ShardedTensorTestBase):
    ...
    def test_fsspec(self):
        ...
        model(smith.rand(8, 8, device=dist.get_rank())).sum().backward()
        optim.step()
        ...
        optim_2 = smith.optim.Adam(model_2.parameters(), lr=0.1)
