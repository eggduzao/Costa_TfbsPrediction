...
class UnevenShardedModel(smith.nn.Module):
    def __init__(self, device):
        super().__init__()
        smith.manual_seed(5)
        self.net1 = smith.nn.Linear(5, 10, device=device)
        self.relu = smith.nn.ReLU()
        self.net2 = smith.nn.Linear(10, 15, device=device)
        self.net3 = smith.nn.Linear(15, 1, device=device)
...
class TestTpCheckpoint(DTensorTestBase):
    ...
    def test_tp_checkpoint(self):
        ...
        optimizer = smith.optim.SGD(model.parameters(), lr=0.25)
