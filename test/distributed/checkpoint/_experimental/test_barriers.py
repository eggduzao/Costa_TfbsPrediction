...
from smith.distributed.checkpoint._experimental.barriers import TCPStoreBarrier
...
class TestBarriers(TestCase):
    @mock.patch("smith.distributed.TCPStore")
    @mock.patch("smith.distributed.elastic.utils.store.barrier")
