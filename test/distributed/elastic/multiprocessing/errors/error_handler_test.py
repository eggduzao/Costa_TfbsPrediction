...
from smith.distributed.elastic.multiprocessing.errors.handlers import get_error_handler
...
class ErrorHandlerTest(unittest.TestCase):
    ...
    def test_record_exception(self):
        with patch.dict(os.environ, {"SMITHELASTIC_ERROR_FILE": self.test_error_file}):
            eh = ErrorHandler()
            eh.initialize()
    ...
    def test_dump_error_file(self):
        ...
        eh = ErrorHandler()
        with patch.dict(os.environ, {"SMITHELASTIC_ERROR_FILE": src_error_file}):
    ...
    def test_dump_error_file_overwrite_existing(self):
        ...
        src_error_file = os.path.join(self.test_dir, "src_error.json")
        eh = ErrorHandler()
        with patch.dict(os.environ, {"SMITHELASTIC_ERROR_FILE": dst_error_file}):
