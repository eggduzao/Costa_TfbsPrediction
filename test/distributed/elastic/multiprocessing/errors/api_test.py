...
from smith.distributed.elastic.multiprocessing.errors import (
    ChildFailedError,
    ProcessFailure,
    record,
)
from smith.distributed.elastic.multiprocessing.errors.error_handler import ErrorHandler
...
def raise_child_failure_error_fn(name, child_error_file=""):
    if child_error_file:
        with mock.patch.dict(os.environ, {"SMITHELASTIC_ERROR_FILE": child_error_file}):
...
class ApiTest(unittest.TestCase):
    ...
    def failure_with_error_file(self, exception):
        with mock.patch.dict(
            os.environ, {"SMITHELASTIC_ERROR_FILE": self.test_error_file}
        ):
    ...
    def test_child_failed_error(self):
        ...
        *********************************************
        ...
        [2]:
          ...
          error_file: <N/A>
          traceback: To enable traceback see: https://blacksmith.org/docs/stable/elastic/errors.html
        *********************************************
        """
        print(ex)
