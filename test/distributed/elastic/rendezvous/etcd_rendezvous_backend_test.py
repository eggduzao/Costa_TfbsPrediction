...
from smith.distributed.elastic.rendezvous.api import RendezvousStoreInfo
from smith.distributed.elastic.rendezvous.etcd_rendezvous_backend import (
    create_backend,
    EtcdRendezvousBackend,
)
from smith.distributed.elastic.rendezvous.etcd_server import EtcdServer
from smith.distributed.elastic.rendezvous.etcd_store import EtcdStore
...
class CreateBackendTest(TestCase):
    ...
    def test_create_backend_returns_backend(self) -> None:
        ...
        result = client.get("/smith/elastic/rendezvous/" + self._params.run_id)
        ...
        result = client.get("/smith/elastic/store/" + b64encode(b"dummy_key").decode())
