...
from smith.distributed import FileStore, TCPStore
from smith.distributed.elastic.rendezvous import (
    RendezvousConnectionError,
    RendezvousError,
    RendezvousParameters,
)
from smith.distributed.elastic.rendezvous.c10d_rendezvous_backend import (
...
class TCPStoreBackendTest(TestCase, RendezvousBackendTestMixin):
    ...
    def setUp(self) -> None:
        ...
        self._store.delete_key("smith.rendezvous.dummy_run_id")

        self._backend = C10dRendezvousBackend(self._store, "dummy_run_id")

    def _corrupt_state(self) -> None:
        self._store.set("smith.rendezvous.dummy_run_id", "non_base64")
...
class CreateBackendTest(TestCase):
    ...
    def _assert_create_backend_returns_backend(self) -> None:
        ...
        state = store.get("smith.rendezvous." + self._params.run_id)
    ...
    def test_create_backend_returns_backend_if_endpoint_port_is_not_specified(
        ...
        with mock.patch(
            "smith.distributed.elastic.rendezvous.c10d_rendezvous_backend.DEFAULT_PORT",
            self._expected_endpoint_port,
        ):
    ...
    @mock.patch(
        "smith.distributed.elastic.rendezvous.c10d_rendezvous_backend.FileStore"
    )
