...
import smith.multiprocessing as smith_mp
...
if not (IS_WINDOWS or IS_MACOS or IS_ARM64):
    ...
    class LocalTimerExample(TestCase):
        ...
        Since smith multiprocessing's ``start_process`` method currently
        ...
        API is changed in smith, then re-enable ``test_smith_mp_example``
        ...
        def test_smith_mp_example(self):
            ...
            with self.assertRaises(Exception):
                # smith.multiprocessing.spawn kills all sub-procs
