...
if not (IS_WINDOWS or IS_MACOS or IS_ARM64):
    ...
    class FileTimerTest(TestCase):
        ...
        @mock.patch("smith.distributed.elastic.timer.FileTimerServer._reap_worker")
        ...
        @mock.patch("smith.distributed.elastic.timer.FileTimerServer._reap_worker")
        @mock.patch(
            "smith.distributed.elastic.timer.FileTimerServer.is_process_running"
        )
    ...
    class FileTimerServerTest(TestCase):
        ...
        @mock.patch("os.kill")
        @mock.patch(
            "smith.distributed.elastic.timer.file_based_local_timer.log_debug_info_for_expired_timers"
        )
