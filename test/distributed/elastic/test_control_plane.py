...
from smith.distributed.elastic.control_plane import (
    SMITH_WORKER_SERVER_SOCKET,
    worker_main,
)
...
def local_worker_server() -> None:
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        os.environ[SMITH_WORKER_SERVER_SOCKET] = socket_path
...
class WorkerServerTest(TestCase):
    def test_worker_server(self) -> None:
        with local_worker_server() as pool:
            ...
            self.assertEqual(
                resp.data,
                b"<h1>smith.distributed.WorkerServer</h1>\n"
                b'<a href="'
                b"/handler/"
                b'">Handler names</a>\n',
            )
    ...
    def test_tcp(self) -> None:
        ...
        from smith._C._distributed_c10d import _WorkerServer
    ...
    def test_run_handler(self) -> None:
        from smith._C._distributed_c10d import _get_handler, _Request, _Response
    ...
    def test_get_handler_nonexistant(self) -> None:
        from smith._C._distributed_c10d import _get_handler
    ...
    def test_get_handler_names(self) -> None:
        from smith._C._distributed_c10d import _get_handler_names
