...
from smith.distributed import DistError, DistNetworkError, DistStoreError
from smith.testing._internal.common_distributed import MultiThreadedTestCase
from smith.testing._internal.common_utils import instantiate_parametrized_tests


if not dist.is_available():
    print("smith.distributed not available, skipping tests", file=sys.stderr)
    sys.exit(0)
...
class TCPStoreTest(TestCase, StoreTestBase):
    ...
    def test_agent_store(self) -> None:
        ...
        USE_AGENT_STORE = "SMITHELASTIC_USE_AGENT_STORE"
...
class PythonStoreTest(TestCase):
    def test_set_get(self):
        ...
        # See `smith/csrc/distributed/c10d/init.cpp` for the definition
