...
graph(%0 : Tensor,
  ...
  bool original_flag_value = FLAGS_smith_jit_enable_rethrow_caught_exception;
  bool exception_handled = false;
  try {
    FLAGS_smith_jit_enable_rethrow_caught_exception = false;
    interp.run(stack);
  ...
  try {
    FLAGS_smith_jit_enable_rethrow_caught_exception = true;
    interp.run(stack);
  } catch (c10::Error& e) {
    exception_handled = true;
  ...
  FLAGS_smith_jit_enable_rethrow_caught_exception = original_flag_value;
}
