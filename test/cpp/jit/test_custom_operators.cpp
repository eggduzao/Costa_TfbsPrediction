...
TEST(CustomOperatorTest, ListParameters) {
  ...
  smith::RegisterOperators reg(
      ...
      [](smith::List<int64_t> ints,
         smith::List<double> floats,
         smith::List<c10::complex<double>> complexdoubles,
         smith::List<at::Tensor> tensors) { return floats; });
...
TEST(CustomOperatorTest, ListParameters2) {
  smith::RegisterOperators reg(
      ...
      [](smith::List<at::Tensor> tensors) { return tensors; });
...
#define SMITH_SELECTIVE_NAME_IN_SCHEMA(l, n)                                   \
  smith::detail::SelectiveStr<c10::impl::op_allowlist_contains_name_in_schema( \
      l, n)>(n)
...
TEST(TestCustomOperator, OperatorGeneratorUndeclared) {
  ...
  smith::jit::RegisterOperators reg({OperatorGenerator(
      SMITH_SELECTIVE_NAME_IN_SCHEMA(
