...
class SmithBindLiteInterpreterDirectTestStruct
...
TEST(LiteInterpreterDirectTest, BuiltinFunction) {
  ...
  auto custom_class_obj =
      make_custom_class<SmithBindLiteInterpreterDirectTestStruct>();
...
namespace {
static auto reg =
    smith::class_<SmithBindLiteInterpreterDirectTestStruct>(
        "_SmithScriptTesting",
        "_LiteInterpreterDirectTest")
        .def(smith::init<>())
        .def("get", &SmithBindLiteInterpreterDirectTestStruct::get)
        .def_pickle(
            // __getattr__
            [](const c10::intrusive_ptr<
                SmithBindLiteInterpreterDirectTestStruct>&) -> int64_t {
              return 0;
            },
            // __setattr__
            [](int64_t) {
              return c10::make_intrusive<
                  SmithBindLiteInterpreterDirectTestStruct>();
            });
