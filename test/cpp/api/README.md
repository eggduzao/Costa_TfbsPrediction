...
In this folder live the tests for Blacksmith's C++ Frontend. They use the
...
following command from the Blacksmith root folder:
...
code, so you *must* run the integration tests from the Blacksmith root folder.
