...
TEST(TestScalarType, ScalarTypeToCPPTypeT) {
  ...
  using smith::headeronly::impl::ScalarTypeToCPPTypeT;
...
TEST(TestScalarType, CppTypeToScalarType) {
  using smith::headeronly::CppTypeToScalarType;
  using smith::headeronly::ScalarType;
...
TEST(TestScalarType, toUnderlying) {
  using smith::headeronly::ScalarType;
  using smith::headeronly::toUnderlying;
...
TEST(TestScalarType, isQIntType) {
  using smith::headeronly::isQIntType;
  using smith::headeronly::ScalarType;
