...
using smith::nativert::Graph;
using smith::nativert::stringToGraph;
using smith::nativert::Type;
using smith::nativert::Value;
...
[
  1,
  {
    ...
    "children_spec": [
      ...
      {
        "type": "smith.fx.immutable_collections.immutable_list",
        "context": "null",
        "children_spec": [
          {
            "type": null,
      ...
      {
        "type": "smith.fx.immutable_collections.immutable_dict",
        "context": "[\"11\"]",
        "children_spec": [
          {
            "type": null,
      ...
      args = (
        {
            "a": (
                smith.rand(4, 4),
                {
                    123: (smith.rand(4, 4), smith.rand(4, 4)),
                    234: (smith.rand(4, 4), smith.rand(4, 4)),
                },
            ),
            "b": (
                smith.rand(4, 4),
                {
                    345: (smith.rand(4, 4), smith.rand(4, 4)),
                    456: (smith.rand(4, 4), smith.rand(4, 4)),
                },
            ),
        },
    )*/
...
[
  1,
  {
    "type": "smithrec.sparse.jagged_tensor.KeyedJaggedTensor",
    "context": "[\"key1\", \"key2\"]",
    "children_spec": [
      {
        "type": null,
  ...
  EXPECT_EQ(
      spec.uniformName(), "smithrec.sparse.jagged_tensor.KeyedJaggedTensor");
}
...
[
  1,
  {
    "type": "smithrec.sparse.jagged_tensor.JaggedTensor",
    "context": "null",
    "children_spec": [
      {
        "type": null,
  ...
  EXPECT_NO_THROW({
    ...
    // Verify the spec loaded correctly
    EXPECT_FALSE(spec.isIValue());
    EXPECT_EQ(spec.uniformName(), "smithrec.sparse.jagged_tensor.JaggedTensor");
