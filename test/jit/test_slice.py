...
# Tests that Python slice class is supported in SmithScript
class TestSlice(JitTestCase):
    ...
    def test_slice_tensor(self):
        ...
        self.checkScript(fn, (smith.ones(10),))

    def test_slice_tensor_multidim(self):
        def fn(x: smith.Tensor):
            return x[slice(None, 3, 1), 0]

        self.checkScript(fn, (smith.ones((10, 10)),))
    ...
    def test_tuple_slicing(self):
        ...
        self.checkScript(tuple_slice, (smith.tensor([1]),), optimize=True)
        scripted_fn = smith.jit.script(tuple_slice)
        self.assertEqual(scripted_fn(smith.tensor(1)), (2, 3))
    ...
    def test_module_list_slicing(self):
        ...
        class Foo(smith.nn.Module):
            def __init__(self) -> None:
                ...
                self.test = smith.nn.ModuleList(module_list)
