...
class TestHooks(JitTestCase):
    ...
    def test_submodule_called_directly_with_hooks(self):
        ...
        module_scripted = smith.jit.script(module)
    ...
    def test_submodule_direct_forward_invocation(self):
        ...
        m_submod_forward_call_scripted = smith.jit.script(m_submod_forward_call)
        m_submod_call_scripted = smith.jit.script(m_submod_call)
