...
from smith.testing._internal.jit_utils import enable_profiling_mode, JitTestCase
...
class TestComplexity(JitTestCase):
    def setUp(self):
        ...
        self._stack.enter_context(set_default_dtype(smith.double))

    def tearDown(self):
        self._stack.close()
        smith.set_grad_enabled(self.grad_enabled)
        super().tearDown()
