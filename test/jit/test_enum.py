...
class TestEnum(JitTestCase):
    def test_enum_value_types(self):
        ...
        with self.assertRaisesRegexWithHighlight(
            ...
            smith.jit.script(unsupported_enum_types)
    ...
    def test_enum_as_const(self):
        ...
        FileCheck().check(
            "prim::Constant[value=__smith__.jit.test_enum.Color.RED]"
    ...
    def test_enum_ivalue_type(self):
        ...
        FileCheck().check(
            "prim::isinstance[types=[Enum<__smith__.jit.test_enum.Color>]]"
    ...
    def test_enum_iterate(self):
        ...
        make_global(Color)
        scripted = smith.jit.script(iterate_enum)

        FileCheck().check("Enum<__smith__.jit.test_enum.Color>[]").check_same(
            "Color.RED"
    ...
    def test_enum_explicit_script(self):
        ...
        smith.jit.script(Color)

    # Regression test for https://github.com/blacksmith/blacksmith/issues/108933
