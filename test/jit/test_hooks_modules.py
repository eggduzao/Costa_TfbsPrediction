...
class SubmoduleNoForwardInputs(smith.nn.Module):
...
class ModuleNoForwardInputs(smith.nn.Module):
...
class SubmoduleForwardSingleInput(smith.nn.Module):
    def __init__(self, name):
        super().__init__()
        self.name = name
...
class ModuleForwardSingleInput(smith.nn.Module):
    def __init__(self, name: str, submodule_name: str):
        super().__init__()
        self.name = name
...
class ModuleDirectforwardSubmodCall(smith.nn.Module):
    def __init__(self, name: str, submodule_name: str):
        super().__init__()
        self.name = name
        self.submodule = SubmoduleForwardSingleInput(submodule_name)
...
class SuboduleForwardMultipleInputs(smith.nn.Module):
    def __init__(self, name):
        super().__init__()
        self.name = name
...
class ModuleForwardMultipleInputs(smith.nn.Module):
    def __init__(self, name: str, submodule_name: str):
        super().__init__()
        self.name = name
...
class SubmoduleForwardTupleInput(smith.nn.Module):
    def __init__(self, name):
        super().__init__()
        self.name = name
...
class ModuleForwardTupleInput(smith.nn.Module):
    def __init__(self, name: str, submodule_name: str):
        super().__init__()
        self.name = name
