...
class TestJitUtils(JitTestCase):
    ...
    def test_get_callable_argument_names_positional_or_keyword(self):
        ...
        self.assertEqual(
            ["x", "y"],
            smith._jit_internal.get_callable_argument_names(
    ...
    def test_get_callable_argument_names_positional_only(self):
        ...
        self.assertEqual(
            ["y"],
            smith._jit_internal.get_callable_argument_names(fn_positional_only_arg),
        )
    ...
    def test_get_callable_argument_names_var_positional(self):
        ...
        self.assertEqual(
            ["x"],
            smith._jit_internal.get_callable_argument_names(fn_var_positional_arg),
        )
    ...
    def test_get_callable_argument_names_keyword_only(self):
        ...
        self.assertEqual(
            ["x"], smith._jit_internal.get_callable_argument_names(fn_keyword_only_arg)
        )
    ...
    def test_get_callable_argument_names_var_keyword(self):
        ...
        self.assertEqual(
            [], smith._jit_internal.get_callable_argument_names(fn_var_keyword_arg)
        )
    ...
    def test_get_callable_argument_names_hybrid(self):
        ...
        self.assertEqual(
            ["y"], smith._jit_internal.get_callable_argument_names(fn_hybrid_args)
        )
    ...
    def test_no_tracer_warn_context_manager(self):
        smith._C._jit_set_tracer_state_warn(True)
        with jit_utils.NoTracerWarnContextManager():
            self.assertEqual(False, smith._C._jit_get_tracer_state_warn())
        self.assertEqual(True, smith._C._jit_get_tracer_state_warn())
