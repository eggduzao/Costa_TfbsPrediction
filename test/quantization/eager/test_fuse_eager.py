...
class TestFuseEager(QuantizationTestCase):
    def test_fuse_module_train(self):
        ...
        self.assertEqual(
            type(model.sub2.conv), smith.nn.Conv2d, msg="Non-fused submodule Conv"
        )
        self.assertEqual(
            type(model.sub2.relu), smith.nn.ReLU, msg="Non-fused submodule ReLU"
        )
        ...
        for qengine in supported_qengines:
            with override_quantized_engine(qengine):
                ...
                model_orig.qconfig = QConfig(
                    activation=smith.nn.Identity, weight=smith.nn.Identity
                )
                model = fuse_modules_qat(
    ...
    def test_fusion_linear_bn_eval(self):
        ...
        inp1 = smith.randn(8, 20)
        inp2 = smith.randn(8, 20)
    ...
    def test_fusion_convtranspose_bn_eval(self):
        ...
        inp1 = smith.randn(8, 3, 16)
        inp2 = smith.randn(8, 3, 16)
    ...
    def test_fuse_modules_with_nested_hooks(self):
        ...
        can be safely fused. Safeguard for issues similar to https://github.com/blacksmith/blacksmith/issues/105063
        in the future.
        """
