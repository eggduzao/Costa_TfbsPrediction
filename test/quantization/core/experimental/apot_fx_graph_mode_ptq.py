...
from smith.ao.quantization.experimental.quantization_helper import (
    evaluate,
...
# Note that this is temporary, we'll expose these functions to smith.ao.quantization after official releasee
...
from smith.ao.quantization.experimental.qconfig import (
...
"""
Prepare model PTQ for specified qconfig for smith.nn.Linear
"""
def prepare_ptq_linear(qconfig):
    qconfig_dict = {"object_type": [(smith.nn.Linear, qconfig)]}
