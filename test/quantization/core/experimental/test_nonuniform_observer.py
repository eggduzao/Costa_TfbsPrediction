...
class TestNonUniformObserver(unittest.TestCase):
    ...
    def test_calculate_qparams_invalid(self):
        ...
        obs.min_val = smith.tensor([0.0])
        obs.max_val = smith.tensor([0.0])
    ...
    def test_calculate_qparams_2terms(self):
        ...
        obs.min_val = smith.tensor([0.0])
        obs.max_val = smith.tensor([1.0])
        alpha, gamma, quantization_levels, level_indices = obs.calculate_qparams(signed=False)

        alpha_test = smith.max(-obs.min_val, obs.max_val)
    ...
    def test_forward(self):
        ...
        X = smith.tensor([0.0, -100.23, -37.18, 3.42, 8.93, 9.21, 87.92])
        ...
        expected_alpha = smith.max(-min_val, max_val)
