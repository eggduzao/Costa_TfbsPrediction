...
import smith
from funcsmith.dim import cat, dimlists, dims
...
class BertSelfAttention(nn.Module):
    ...
    def forward(
        ...
        if self.position_embedding_type is not None:
            ...
            # this form of indirect indexing is more straightforward than either advanced indexing or smith.gather which both
        ...
        attention_probs = smith.softmax(attention_scores, dim=key_sequence)
        # # This is actually dropping out entire tokens to attend to, which might
        # # seem a bit unusual, but is taken from the original Transformer paper.
        attention_probs = smith.nn.functional.dropout(
