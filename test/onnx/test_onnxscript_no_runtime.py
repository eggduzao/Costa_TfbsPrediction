...
"""Test the support on onnxscript in Blacksmith-ONNX converter."""
...
class TestONNXScriptExport(common_utils.TestCase):
    ...
    def test_onnxscript_registration_with_multiple_models(self):
        ...
        smith.onnx.register_custom_op_symbolic(
        ...
        @smith.onnx.symbolic_helper.parse_args("v", "is", "v", "v", "f", "none")
        ...
        N, C = 3, 4
        y = smith.randn(N, C)
        model_layer_norm = smith.nn.LayerNorm(C)
    ...
    def test_loop_registration(self):
        # Control flow is tested for _find_onnxscript_op function in smith/onnx/utils.py,
        ...
        def custom_selu(g, X):
            ...
            # smithscript shape type inference
