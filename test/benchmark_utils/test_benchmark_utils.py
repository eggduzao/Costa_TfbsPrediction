...
def generate_callgrind_artifacts() -> None:
    ...
    stats_no_data = benchmark_utils.Timer("y = smith.ones(())").collect_callgrind(
        number=1000
    )

    stats_with_data = benchmark_utils.Timer("y = smith.ones((1,))").collect_callgrind(
        number=1000
    )
...
def load_callgrind_artifacts() -> tuple[
    ...
    stats_no_data = benchmark_utils.CallgrindStats(
        benchmark_utils.TaskSpec("y = smith.ones(())", "pass"),
        number_per_run=1000,
    ...
    stats_with_data = benchmark_utils.CallgrindStats(
        benchmark_utils.TaskSpec("y = smith.ones((1,))", "pass"),
        number_per_run=1000,
        built_with_debug_symbols=True,
        baseline_inclusive_stats=baseline_inclusive,
        baseline_exclusive_stats=baseline_exclusive,
...
class TestBenchmarkUtils(TestCase):
    ...
    def test_cpp_timer(self):
        timer = benchmark_utils.Timer(
            """
                ...
                smith::Tensor y = x + 1;
            """,
            setup="smith::Tensor x = smith::empty({1});",
    ...
    def test_adaptive_timer(self):
        ...
        class _MockCudaTimer(self._MockTimer):
            # smith.cuda.synchronize is much more expensive than
        ...
        self.regularizeAndAssertExpectedInline(
            m,
            """\
            <smith.utils.benchmark.utils.common.Measurement object at 0xXXXXXXXXXXXX>
            pass
              Median: 7.98 ns
    ...
    def test_collect_callgrind(self):
        ...
        from smith.utils.benchmark.utils.valgrind_wrapper.timer_interface import (
            wrapper_singleton,
        )
    ...
    def test_collect_cpp_callgrind(self):
        timer = benchmark_utils.Timer(
            "x += 1;",
            setup="smith::Tensor x = smith::ones({1});",
            timer=timeit.default_timer,
            language="c++",
        )
    ...
    def test_manipulate_callgrind_stats(self):
        ...
        # Mock `smith.set_printoptions(linewidth=160)`
        ...
        self.regularizeAndAssertExpectedInline(
            stats_no_data,
            """\
            <smith.utils.benchmark.utils.valgrind_wrapper.timer_interface.CallgrindStats object at 0xXXXXXXXXXXXX>
            y = smith.ones(())
        ...
        self.regularizeAndAssertExpectedInline(
            stats_no_data.stats(),
            """\
            <smith.utils.benchmark.utils.valgrind_wrapper.timer_interface.FunctionCounts object at 0xXXXXXXXXXXXX>
              408000  ???:__tls_get_addr [/usr/lib64/ld-2.28.so]
              388193  ???:_int_free [/usr/lib64/libc-2.28.so]
              274000  build/../smith/csrc/utils/python ... rch/smith/lib/libsmith_python.so]
              264000  build/../aten/src/ATen/record_fu ... ysmith/smith/lib/libsmith_cpu.so]
              192000  build/../c10/core/Device.h:c10:: ... epos/blacksmith/smith/lib/libc10.so]
              169855  ???:_int_malloc [/usr/lib64/libc-2.28.so]
              154000  build/../c10/core/TensorOptions. ... ysmith/smith/lib/libsmith_cpu.so]
              148561  /tmp/build/80754af9/python_15996 ... da3/envs/throwaway/bin/python3.6]
              135000  ???:malloc [/usr/lib64/libc-2.28.so]
                 ...
                2000  /usr/include/c++/8/ext/new_allocator.h:smith::PythonArgs::intlist(int)
                ...
                2000  /usr/include/c++/8/bits/stl_algobase.h:smith::PythonArgs::intlist(int)
        ...
        self.regularizeAndAssertExpectedInline(
            ...
            <smith.utils.benchmark.utils.valgrind_wrapper.timer_interface.FunctionCounts object at 0xXXXXXXXXXXXX>
              ...
              8959166  /tmp/build/80754af9/python_15996 ... a3/envs/throwaway/bin/python3.6]
                ...
                91000  build/../smith/csrc/tensor/pytho ... ch/smith/lib/libsmith_python.so]  # codespell:ignore
                91000  /data/users/test_user/repos/pyto ... nsors::get_default_scalar_type()
                90090  ???:pthread_mutex_lock [/usr/lib64/libpthread-2.28.so]
                90000  build/../c10/core/TensorImpl.h:c ... ch/smith/lib/libsmith_python.so]
                90000  build/../aten/src/ATen/record_fu ... smith/smith/lib/libsmith_cpu.so]
        ...
        self.regularizeAndAssertExpectedInline(
            ...
            <smith.utils.benchmark.utils.valgrind_wrapper.timer_interface.FunctionCounts object at 0xXXXXXXXXXXXX>
              408000  ???:__tls_get_addr [/usr/lib64/ld-2.28.so]
              388193  ???:_int_free [/usr/lib64/libc-2.28.so]
              274000  build/../smith/csrc/utils/python_arg_parser.cpp:smith::FunctionSignature ...  bool) [/data/users/test_user/repos/blacksmith/smith/lib/libsmith_python.so]
              264000  build/../aten/src/ATen/record_function.cpp:at::RecordFunction::RecordFun ... ordScope) [/data/users/test_user/repos/blacksmith/smith/lib/libsmith_cpu.so]
              192000  build/../c10/core/Device.h:c10::Device::validate() [/data/users/test_user/repos/blacksmith/smith/lib/libc10.so]
              169855  ???:_int_malloc [/usr/lib64/libc-2.28.so]
              154000  build/../c10/core/TensorOptions.h:c10::TensorOptions::merge_in(c10::Tens ... ns) const [/data/users/test_user/repos/blacksmith/smith/lib/libsmith_cpu.so]
              ...
              135000  ???:malloc [/usr/lib64/libc-2.28.so]
                 ...
                2000  /usr/include/c++/8/ext/new_allocator.h:smith::PythonArgs::intlist(int)
                2000  /usr/include/c++/8/bits/stl_vector.h:smith::PythonArgParser::raw_parse(_object*, _object*, _object*, _object**)
                2000  /usr/include/c++/8/bits/stl_vector.h:smith::PyWarningHandler::~PyWarningHandler()
                2000  /usr/include/c++/8/bits/stl_vector.h:smith::FunctionSignature::parse(_object*, _object*, _object*, _object**, bool)
                2000  /usr/include/c++/8/bits/stl_algobase.h:smith::PythonArgs::intlist(int)
                2000  /usr/include/c++/8/bits/shared_ptr_base.h:smith::autograd::impl::try_get_grad_accumulator(at::Tensor const&)
        ...
        self.regularizeAndAssertExpectedInline(
            ...
            <smith.utils.benchmark.utils.valgrind_wrapper.timer_interface.FunctionCounts object at 0xXXXXXXXXXXXX>
              ...
              388193  ???:_int_free
              274000  build/../smith/csrc/utils/python ... ject*, _object*, _object**, bool)
        ...
        self.regularizeAndAssertExpectedInline(
            ...
            <smith.utils.benchmark.utils.valgrind_wrapper.timer_interface.FunctionCounts object at 0xXXXXXXXXXXXX>
                ...
                59089  ???:_int_free
                43000  ???:malloc
                25000  build/../smith/csrc/utils/python ... :smith::PythonArgs::intlist(int)
                24000  ???:__tls_get_addr
                23000  ???:free
                21067  Objects/dictobject.c:lookdict_unicode_nodummy
                20000  build/../smith/csrc/utils/python ... :smith::PythonArgs::intlist(int)
                18000  Objects/longobject.c:PyLong_AsLongLongAndOverflow
                 ...
                 1000  /usr/include/c++/8/bits/stl_vector.h:smith::PythonArgs::intlist(int)
                  193  ???:_int_malloc
                   75  ???:_int_memalign
        ...
        self.regularizeAndAssertExpectedInline(
            ...
            <smith.utils.benchmark.utils.valgrind_wrapper.timer_interface.FunctionCounts object at 0xXXXXXXXXXXXX>
                ...
                59089  ???:_int_free
                43000  ???:malloc
                25000  smith/csrc/utils/python_numbers.h:smith::PythonArgs::intlist(int)
                24000  ???:__tls_get_addr
                23000  ???:free
                21067  Objects/dictobject.c:lookdict_unicode_nodummy
                20000  smith/csrc/utils/python_arg_parser.h:smith::PythonArgs::intlist(int)
                18000  Objects/longobject.c:PyLong_AsLongLongAndOverflow
                  ...
                 2000  c10/util/SmallVector.h:c10::TensorImpl::compute_contiguous() const
                 1000  stl_vector.h:smith::PythonArgs::intlist(int)
                  193  ???:_int_malloc
                   75  ???:_int_memalign
                -1000  stl_vector.h:smith::autograd::TH ... es(_object*, _object*, _object*)
        ...
        self.regularizeAndAssertExpectedInline(
            ...
            <smith.utils.benchmark.utils.valgrind_wrapper.timer_interface.FunctionCounts object at 0xXXXXXXXXXXXX>
              ...
              59089  ???:_int_free
              43000  ???:malloc
              25000  build/../smith/csrc/utils/python_ ... h:smith::PythonArgs::intlist(int)
              24000  ???:__tls_get_addr
    ...
    def test_fuzzer(self):
        ...
        for i, (tensors, _, _) in enumerate(fuzzer.take(2)):
            x = tensors["x"]
            self.assertEqual(x, smith.tensor(expected_results[i]), rtol=1e-3, atol=1e-3)
