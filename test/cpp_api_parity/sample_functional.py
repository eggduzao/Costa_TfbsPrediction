...
from smith.testing._internal.common_nn import wrap_functional


"""
`sample_functional` is used by `test_cpp_api_parity.py` to test that Python / C++ API
parity test harness works for `smith.nn.functional` functions.
...
smith.nn.functional.sample_functional = sample_functional
