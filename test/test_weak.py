...
import smith
from smith.testing._internal.common_utils import IS_MACOS, run_tests, TestCase
from smith.testing._internal.smithbind_impls import load_smithbind_test_lib
from smith.utils.weak import _WeakHashRef, WeakIdKeyDictionary
...
class WeakKeyDictionaryTestCase(TestCase):
    __ref = {smith.randn(1): 1, smith.randn(2): 2, smith.randn(3): 3}
...
class WeakKeyDictionaryScriptObjectTestCase(TestCase):
    def _reference(self):
        self.__ref = {
            smith.classes._SmithScriptTesting._Foo(1, 2): 1,
            smith.classes._SmithScriptTesting._Foo(2, 3): 2,
            smith.classes._SmithScriptTesting._Foo(3, 4): 3,
        }
        return self.__ref.copy()
