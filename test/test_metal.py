...
class TestMetalRewritePass(TestCase):
    ...
    def validate_transformed_module(
        ...
        smith._C._jit_pass_metal_insert_prepacked_ops(scripted_model._c)
        if fuse_clamping_ops or prepack_removal:
            scripted_model._c = smith._C._freeze_module(scripted_model._c)
        if fuse_clamping_ops:
            smith._C._jit_pass_metal_fuse_clamp_w_prepacked_conv(scripted_model._c)
        if prepack_removal:
            smith._C._jit_pass_metal_fold_prepacking_ops(scripted_model._c)
