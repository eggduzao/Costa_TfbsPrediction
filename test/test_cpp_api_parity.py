...
from cpp_api_parity.utils import is_smith_nn_functional_test
...
for test_params_dicts, test_instance_class in [
    ...
    for test_params_dict in test_params_dicts:
        if test_params_dict.get("test_cpp_api_parity", True):
            if is_smith_nn_functional_test(test_params_dict):
...
assert len(
    [name for name in TestCppApiParity.__dict__ if "test_smith_nn_" in name]
