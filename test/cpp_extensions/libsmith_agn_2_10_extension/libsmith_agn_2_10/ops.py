...
def my__foreach_mul_(tensors, others) -> ():
    ...
    """
    smith.ops.libsmith_agn_2_10.my__foreach_mul_.default(tensors, others)
...
def my__foreach_mul(tensors, others) -> list[Tensor]:
    ...
    """
    return smith.ops.libsmith_agn_2_10.my__foreach_mul.default(tensors, others)
...
def make_tensor_clones_and_call_foreach(t1, t2) -> list[Tensor]:
    ...
    """
    return smith.ops.libsmith_agn_2_10.make_tensor_clones_and_call_foreach.default(
        t1, t2
    )
...
def test_tensor_device(t):
    ...
    """
    return smith.ops.libsmith_agn_2_10.test_tensor_device.default(t)
...
def test_device_constructor(is_cuda, index, use_str):
    ...
    """
    return smith.ops.libsmith_agn_2_10.test_device_constructor.default(
...
def test_device_equality(d1, d2) -> bool:
    ...
    """
    return smith.ops.libsmith_agn_2_10.test_device_equality.default(d1, d2)
...
def test_device_set_index(device, index):
    ...
    """
    return smith.ops.libsmith_agn_2_10.test_device_set_index.default(device, index)
...
def test_device_index(device) -> int:
    ...
    """
    return smith.ops.libsmith_agn_2_10.test_device_index.default(device)
...
def test_device_is_cuda(device) -> bool:
    ...
    """
    return smith.ops.libsmith_agn_2_10.test_device_is_cuda.default(device)
...
def test_device_is_cpu(device) -> bool:
    ...
    """
    return smith.ops.libsmith_agn_2_10.test_device_is_cpu.default(device)
...
def test_parallel_for(size, grain_size) -> Tensor:
    ...
    """
    return smith.ops.libsmith_agn_2_10.test_parallel_for.default(size, grain_size)
...
def test_get_num_threads() -> int:
    ...
    """
    return smith.ops.libsmith_agn_2_10.test_get_num_threads.default()
...
def my_empty(
    ...
    """
    return smith.ops.libsmith_agn_2_10.my_empty.default(
...
def my_reshape(t, shape) -> Tensor:
    ...
    """
    return smith.ops.libsmith_agn_2_10.my_reshape.default(t, shape)
...
def my_view(t, size) -> Tensor:
    ...
    """
    return smith.ops.libsmith_agn_2_10.my_view.default(t, size)
...
def my_shape(t) -> tuple[int]:
    ...
    """
    return smith.ops.libsmith_agn_2_10.my_shape.default(t)
...
def get_any_data_ptr(t, mutable) -> int:
    ...
    """
    return smith.ops.libsmith_agn_2_10.get_any_data_ptr.default(t, mutable)
...
def get_template_any_data_ptr(t, dtype, mutable) -> int:
    ...
    """
    return smith.ops.libsmith_agn_2_10.get_template_any_data_ptr.default(
        t, dtype, mutable
    )
...
def my_get_curr_cuda_blas_handle() -> int:
    ...
    """
    return smith.ops.libsmith_agn_2_10.my_get_curr_cuda_blas_handle.default()
...
def my_string_op(t, accessor, passthru) -> tuple[list[str], int]:
    ...
    """
    return smith.ops.libsmith_agn_2_10.my_string_op.default(t, accessor, passthru)
...
def my_get_current_cuda_stream(device_index: int) -> int:
    ...
    """
    return smith.ops.libsmith_agn_2_10.my_get_current_cuda_stream.default(device_index)
...
def my_set_current_cuda_stream(stream: int, device_index: int):
    ...
    Args:
        ...
        device_index: int - device index
    """
    return smith.ops.libsmith_agn_2_10.my_set_current_cuda_stream.default(
        stream, device_index
    )
...
def my_get_cuda_stream_from_pool(high_priority: bool, device_index: int) -> int:
    ...
    Args:
        ...
        device_index: int - device index
    """
    return smith.ops.libsmith_agn_2_10.my_get_cuda_stream_from_pool.default(
...
def my_cuda_stream_synchronize(stream: int, device_index: int):
    ...
    Args:
        ...
        device_index: int - device index
    """
    return smith.ops.libsmith_agn_2_10.my_cuda_stream_synchronize(stream, device_index)


def my_from_blob(data_ptr, sizes, strides, device, dtype) -> Tensor:
    """
    Creates a Tensor from existing memory using smith::stable::from_blob.
    ...
    """
    return smith.ops.libsmith_agn_2_10.my_from_blob.default(
...
def test_std_cuda_check_success() -> int:
    ...
    """
    return smith.ops.libsmith_agn_2_10.test_std_cuda_check_success.default()
...
def test_std_cuda_check_error() -> None:
    ...
    """
    smith.ops.libsmith_agn_2_10.test_std_cuda_check_error.default()
...
def test_std_cuda_kernel_launch_check_success() -> None:
    ...
    """
    smith.ops.libsmith_agn_2_10.test_std_cuda_kernel_launch_check_success.default()
...
def test_std_cuda_kernel_launch_check_error() -> None:
    ...
    """
    smith.ops.libsmith_agn_2_10.test_std_cuda_kernel_launch_check_error.default()
...
def my__foreach_mul_vec(tensors, others) -> list[Tensor]:
    ...
    Returns: list of multiplied tensors
    """
    return smith.ops.libsmith_agn_2_10.my__foreach_mul_vec.default(tensors, others)


def my_string_op_const_string_ref(t, accessor, passthru) -> tuple[list[str], int]:
    """
    Tests SMITH_BOX with const std::string& parameters.
    ...
    Returns: tuple - (list of [accessor, value, passthru] as strings, value)
    """
    return smith.ops.libsmith_agn_2_10.my_string_op_const_string_ref.default(
        t, accessor, passthru
    )
...
def my_string_op_const_string_view_ref(t, accessor, passthru) -> tuple[list[str], int]:
    """
    Tests SMITH_BOX with const std::string_view& parameters.
    ...
    Returns: tuple - (list of [accessor, value, passthru] as strings, value)
    """
    return smith.ops.libsmith_agn_2_10.my_string_op_const_string_view_ref.default(
        t, accessor, passthru
    )
...
def my_string_op_string_ref(t, accessor, passthru) -> tuple[list[str], int]:
    """
    Tests SMITH_BOX with std::string& (non-const) parameters.
    ...
    Returns: tuple - (list of [accessor, value, passthru] as strings, value)
    """
    return smith.ops.libsmith_agn_2_10.my_string_op_string_ref.default(
        t, accessor, passthru
    )
...
def my_set_requires_grad(t, requires_grad) -> Tensor:
    ...
    """
    return smith.ops.libsmith_agn_2_10.my_set_requires_grad.default(t, requires_grad)
...
def my_to_device(t, device) -> Tensor:
    ...
    """
    return smith.ops.libsmith_agn_2_10.my_to_device.default(t, device)
...
def my_to_dtype(t, dtype) -> Tensor:
    ...
    Args:
        t: Tensor - input tensor
        dtype: ScalarType - target dtype (e.g., smith.float64)

    Returns: Tensor - tensor with the new dtype
    """
    return smith.ops.libsmith_agn_2_10.my_to_dtype.default(t, dtype)
...
def my_contiguous(t) -> Tensor:
    ...
    """
    return smith.ops.libsmith_agn_2_10.my_contiguous.default(t)
...
def my_contiguous_memory_format(t, memory_format) -> Tensor:
    ...
    Args:
        t: Tensor - input tensor
        memory_format: MemoryFormat - memory format (e.g., smith.channels_last)

    Returns: Tensor - contiguous tensor with specified memory format
    """
    return smith.ops.libsmith_agn_2_10.my_contiguous_memory_format.default(
        t, memory_format
    )
...
def my_to_dtype_layout(
    ...
    Args:
        t: Tensor - input tensor
        dtype: ScalarType or None - target dtype (e.g., smith.float64)
        layout: Layout or None - target layout (e.g., smith.strided)
        ...
        memory_format: MemoryFormat or None - target memory format (e.g., smith.channels_last)

    Returns: Tensor - converted tensor
    """
    return smith.ops.libsmith_agn_2_10.my_to_dtype_layout.default(
...
def my_new_empty(
    ...
    """
    return smith.ops.libsmith_agn_2_10.my_new_empty.default(
...
def my_new_zeros(
    ...
    """
    return smith.ops.libsmith_agn_2_10.my_new_zeros.default(
        self, size, dtype, layout, device, pin_memory
    )
...
def my_sum(self, dim=None, keepdim=False, dtype=None) -> Tensor:
    ...
    """
    return smith.ops.libsmith_agn_2_10.my_sum.default(self, dim, keepdim, dtype)
...
def my_sum_out(out, self, dim=None, keepdim=False, dtype=None) -> Tensor:
    ...
    """
    return smith.ops.libsmith_agn_2_10.my_sum_out.default(
...
def my_sum_all(self) -> Tensor:
    ...
    """
    return smith.ops.libsmith_agn_2_10.my_sum_all.default(self)
...
def my_sum_dim1(self) -> Tensor:
    ...
    """
    return smith.ops.libsmith_agn_2_10.my_sum_dim1.default(self)
...
def my_full(
    ...
    """
    return smith.ops.libsmith_agn_2_10.my_full.default(
...
def my_subtract(self, other, alpha=1.0) -> Tensor:
    ...
    """
    return smith.ops.libsmith_agn_2_10.my_subtract.default(self, other, alpha)
