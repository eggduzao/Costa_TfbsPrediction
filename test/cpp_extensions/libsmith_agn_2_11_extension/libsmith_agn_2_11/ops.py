...
def my_from_blob_with_deleter(data_ptr, sizes, strides, device, dtype) -> Tensor:
    ...
    """
    return smith.ops.libsmith_agn_2_11.my_from_blob_with_deleter.default(
...
def get_deleter_call_count() -> int:
    ...
    """
    return smith.ops.libsmith_agn_2_11.get_deleter_call_count.default()
...
def reset_deleter_call_count() -> None:
    ...
    """
    smith.ops.libsmith_agn_2_11.reset_deleter_call_count.default()
...
def my_from_blob_with_cuda_deleter(numel: int, device) -> Tensor:
    ...
    """
    return smith.ops.libsmith_agn_2_11_cuda.my_from_blob_with_cuda_deleter.default(
        numel, device
    )
