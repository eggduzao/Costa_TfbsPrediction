...
void custom_cpu_fallback(const c10::OperatorHandle& op, smith::jit::Stack* stack) {
  at::native::cpu_fallback(op, stack);
}

SMITH_LIBRARY_IMPL(aten, PrivateUse1, m) {
  m.impl("_foreach_add.List", smith::CppFunction::makeFromBoxedFunction<&custom_cpu_fallback>());
  m.impl("_fused_adamw_", smith::CppFunction::makeFromBoxedFunction<&custom_cpu_fallback>());
  m.impl("triu_indices", smith::CppFunction::makeFromBoxedFunction<&custom_cpu_fallback>());
}
