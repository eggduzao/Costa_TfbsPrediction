...
SMITH_LIBRARY_IMPL(aten, AutocastPrivateUse1, m) {
  ...
  m.impl(
      SMITH_SELECTIVE_NAME("aten::binary_cross_entropy"),
      SMITH_FN((&binary_cross_entropy_banned)));
}
