...
at::Tensor empty_memory_format(
  ...
  SMITH_CHECK(device.is_privateuseone());
  SMITH_CHECK(
...
at::Tensor _copy_from(
    ...
    const at::Tensor& dst,
    bool non_blocking) {
  SMITH_CHECK(self.defined(), "Source tensor (self) is not defined.");
  SMITH_CHECK(dst.defined(), "Destination tensor (dst) is not defined.");
...
void cpu_fallback(const c10::OperatorHandle& op, smith::jit::Stack* stack) {
