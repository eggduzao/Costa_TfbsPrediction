...
struct CustomAutogradFnReturnsSelf
    : public smith::autograd::Function<CustomAutogradFnReturnsSelf> {
...
struct CustomAutogradFnAliasing
    : public smith::autograd::Function<CustomAutogradFnAliasing> {
  static at::Tensor forward(
      smith::autograd::AutogradContext* ctx,
      at::Tensor self) {
...
void abs_kernel(at::TensorIteratorBase& iter) {
  SMITH_CHECK(iter.ntensors() == 2, "Abs kernel expects 2 tensors");
  SMITH_CHECK(
