...
// LITERALINCLUDE START: SMITH_LIBRARY_IMPL DEFAULT
...
// LITERALINCLUDE END: SMITH_LIBRARY_IMPL DEFAULT

// LITERALINCLUDE START: FALLBACK GLOBAL
SMITH_LIBRARY_IMPL(_, PrivateUse1, m) {
  m.fallback(
      smith::CppFunction::makeFromBoxedFunction<&wrapper_cpu_fallback>());
}
