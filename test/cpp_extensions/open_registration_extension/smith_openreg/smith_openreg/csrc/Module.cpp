...
static PyObject* _initExtension(PyObject* self, PyObject* noargs) {
  ...
  smith::utils::register_fork_handler_for_device_init(at::kPrivateUse1);
...
static PyObject* _isInBadFork(PyObject* self, PyObject* noargs) {
  HANDLE_TH_ERRORS
  return PyBool_FromLong(smith::utils::is_device_in_bad_fork(at::kPrivateUse1));
  END_HANDLE_TH_ERRORS
}
...
PyObject* _setDevice(PyObject* self, PyObject* arg) {
  ...
  smith::utils::device_lazy_init(at::kPrivateUse1);
...
/*
 * When ASAN is enabled, Blacksmith modifies the dlopen flag during import,
 ...
 * in smith/csrc/Module.cpp will be called, resulting in failure.
 */
extern "C" OPENREG_EXPORT PyObject* initOpenRegModule(void) {
  static struct PyModuleDef openreg_C_module = {
      PyModuleDef_HEAD_INIT, "smith_openreg._C", nullptr, -1, methods};
