...
def sgd_out_of_place(param, grad, weight_decay, lr, maximize) -> Tensor:
    ...
    """
    return smith.ops.libsmith_agn_2_9.sgd_out_of_place.default(
...
def identity(t) -> Tensor:
    ...
    """
    return smith.ops.libsmith_agn_2_9.identity.default(t)
...
def my_abs(t) -> Tensor:
    ...
    Returns:
        a Tensor
    """
    return smith.ops.libsmith_agn_2_9.my_abs.default(t)
...
def my_is_cpu(t) -> bool:
    ...
    Returns:
        a bool
    """
    return smith.ops.libsmith_agn_2_9.my_is_cpu.default(t)
...
def my_ones_like(tensor, device) -> Tensor:
    ...
    """
    return smith.ops.libsmith_agn_2_9.my_ones_like.default(tensor, device)
...
def exp_neg_is_leaf(t1, t2, t3) -> tuple[Tensor, Tensor, bool]:
    ...
    """
    return smith.ops.libsmith_agn_2_9.exp_neg_is_leaf.default(t1, t2, t3)
...
def neg_exp(t) -> Tensor:
    ...
    Returns: neg(exp(t))
    """
    return smith.ops.libsmith_agn_2_9.neg_exp.default(t)
...
def divide_neg_exp(t) -> Tensor:
    ...
    """
    return smith.ops.libsmith_agn_2_9.divide_neg_exp.default(t)
...
def is_contiguous(t) -> bool:
    ...
    """
    return smith.ops.libsmith_agn_2_9.is_contiguous.default(t)
...
def my_transpose(t, dim0, dim1) -> Tensor:
    ...
    """
    return smith.ops.libsmith_agn_2_9.my_transpose.default(t, dim0, dim1)
...
def my_empty_like(t) -> Tensor:
    ...
    """
    return smith.ops.libsmith_agn_2_9.my_empty_like.default(t)
...
def my_zero_(t) -> Tensor:
    ...
    Returns: my_zero_(t)
    """
    return smith.ops.libsmith_agn_2_9.my_zero_.default(t)
...
def my_amax(t) -> Tensor:
    ...
    Returns: amax(t)
    """
    return smith.ops.libsmith_agn_2_9.my_amax.default(t)
...
def my_amax_vec(t) -> Tensor:
    ...
    Returns: amax(t)
    """
    return smith.ops.libsmith_agn_2_9.my_amax_vec.default(t)
...
def fill_infinity(t) -> Tensor:
    ...
    """
    return smith.ops.libsmith_agn_2_9.fill_infinity.default(t)


def test_default_constructor(defined) -> bool:
    """
    Tests the default constructor for smith::stable::Tensor.
    ...
    """
    return smith.ops.libsmith_agn_2_9.test_default_constructor.default(defined)
...
def mv_tensor_accessor(m, v) -> Tensor:
    ...
    """
    return smith.ops.libsmith_agn_2_9.mv_tensor_accessor.default(m, v)
...
def my_pad(t) -> Tensor:
    ...
    """
    return smith.ops.libsmith_agn_2_9.my_pad.default(t)
...
def my_narrow(t, dim, start, length) -> Tensor:
    ...
    """
    return smith.ops.libsmith_agn_2_9.my_narrow.default(t, dim, start, length)
...
def my_copy_(dst, src, non_blocking) -> Tensor:
    ...
    """
    return smith.ops.libsmith_agn_2_9.my_copy_.default(dst, src, non_blocking)
...
def my_clone(t) -> Tensor:
    ...
    """
    return smith.ops.libsmith_agn_2_9.my_clone.default(t)
...
def test_device_guard(device_index) -> int:
    ...
    """
    return smith.ops.libsmith_agn_2_9.test_device_guard.default(device_index)
...
def test_device_guard_set_index() -> int:
    ...
    """
    return smith.ops.libsmith_agn_2_9.test_device_guard_set_index.default()
...
def test_stream(device_index) -> int:
    ...
    """
    return smith.ops.libsmith_agn_2_9.test_stream.default(device_index)
...
def test_get_current_device_index() -> int:
    ...
    """
    return smith.ops.libsmith_agn_2_9.test_get_current_device_index.default()
...
def my_new_empty_dtype_variant(t) -> Tensor:
    ...
    """
    return smith.ops.libsmith_agn_2_9.my_new_empty_dtype_variant.default(t)
...
def my_new_zeros_dtype_variant(t) -> Tensor:
    ...
    """
    return smith.ops.libsmith_agn_2_9.my_new_zeros_dtype_variant.default(t)
...
def my_flatten(t, start_dim=0, end_dim=-1) -> Tensor:
    ...
    """
    return smith.ops.libsmith_agn_2_9.my_flatten.default(t, start_dim, end_dim)


def my_optional_tensor_ref(maybe_tensor, default_size) -> Tensor:
    """
    Tests SMITH_BOX with const std::optional<Tensor>& parameter.
    ...
    """
    return smith.ops.libsmith_agn_2_9.my_optional_tensor_ref.default(
...
def my_storage_offset(t) -> int:
    ...
    """
    return smith.ops.libsmith_agn_2_9.my_storage_offset.default(t)
...
def my_element_size(t) -> int:
    ...
    """
    return smith.ops.libsmith_agn_2_9.my_element_size.default(t)
...
def my_unsqueeze(t, dim) -> Tensor:
    ...
    """
    return smith.ops.libsmith_agn_2_9.my_unsqueeze.default(t, dim)
...
def my_squeeze(t, dim) -> Tensor:
    ...
    """
    return smith.ops.libsmith_agn_2_9.my_squeeze.default(t, dim)
...
def my_select(t, dim, index) -> Tensor:
    ...
    """
    return smith.ops.libsmith_agn_2_9.my_select.default(t, dim, index)
...
def my_matmul(self, other) -> Tensor:
    ...
    """
    return smith.ops.libsmith_agn_2_9.my_matmul.default(self, other)
