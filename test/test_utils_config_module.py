...
from smith.utils._config_module import _ConfigEntry, _UNSET_SENTINEL, Config
...
class TestConfigModule(TestCase):
    ...
    def test_codegen_config(self):
        ...
        self.assertEqual(
            code,
            """smith.testing._internal.fake_config_module.e_bool = False
smith.testing._internal.fake_config_module.e_env_default = True
smith.testing._internal.fake_config_module.e_env_default_FALSE = False
smith.testing._internal.fake_config_module.e_env_default_str = '1234'
smith.testing._internal.fake_config_module.e_env_default_str_empty = ''
smith.testing._internal.fake_config_module.e_env_force = True""",
        )
    ...
    def test_codegen_config_function(self):
        ...
        self.assertIn(
            """smith.testing._internal.fake_config_module3.e_list = ['print', '_warnings.warn', 'logging.warn']
smith.testing._internal.fake_config_module3.e_set = { print }
smith.testing._internal.fake_config_module3.e_func = _warnings.warn""",
            code,
        )
    ...
    def test_unittest_patch(self):
        with patch("smith.testing._internal.fake_config_module.e_bool", False):
            with patch("smith.testing._internal.fake_config_module.e_bool", False):
                self.assertFalse(config.e_bool)
