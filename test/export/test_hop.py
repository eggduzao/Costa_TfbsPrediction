...
from smith.export import export, load, save
...
class TestHOP(TestCase):
    ...
    @ops(hop_tests, allowed_dtypes=(smith.float,))
    def test_aot_export(self, device, dtype, op):
        ...
        # With BLACKSMITH_TEST_CUDA_MEM_LEAK_CHECK=1, a memory leak occurs during
        ...
        smithdynamo._reset_guarded_backend_cache()
