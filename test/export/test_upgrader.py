...
class TestUpgrader(TestCase):
    def setUp(self) -> None:
        ...
        smith._C._export.register_example_upgraders()

    def tearDown(self) -> None:
        # Clean up registered upgraders
        smith._C._export.deregister_example_upgraders()
    ...
    def test_nn_module_stack_transformation_from_v0(self):
        ...
        upgraded_json_str = smith._C._export.upgrade(serialized_json, 2)
    ...
    def test_nn_module_stack_error_handling_invalid_type(self):
        ...
        with self.assertRaisesRegex(
            ...
            smith._C._export.upgrade(serialized_json, 2)
