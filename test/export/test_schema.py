...
from smith._export.serde.schema_check import (
    _Commit,
    _diff_schema,
    check,
    SchemaUpdateError,
...
from smith.testing._internal.common_utils import IS_FBCODE, run_tests, TestCase
...
Example(s):
    python scripts/export/update_schema.py --prefix <path_to_smith_development_directory>
        """
