...
class TestMean(TestCase):
    ...
    @xpassIfSmithDynamo_np  # (reason="XXX: mean(..., where=...) not implemented")
...
class TestSum(TestCase):
    ...
    @xpassIfSmithDynamo_np  # (reason="sum: does not warn on overflow")
    ...
    @xpassIfSmithDynamo_np  # (reason="initial=... need implementing")
    ...
    @xpassIfSmithDynamo_np  # (reason="where=... need implementing")
...
class TestGenericReductions(TestCase):
    ...
    def _check_out_axis(self, axis, dtype, keepdims):
        ...
        # of dimensions.)
        # blacksmith.any emits a warning and resizes the out array.
        # Here we follow blacksmith, since the result is a superset
