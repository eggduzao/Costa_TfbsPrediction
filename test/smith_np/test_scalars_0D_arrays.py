...
class TestIsScalar(TestCase):
    ...
    scalars = [
        ...
        subtest(np.array(42), "array_0D", decorators=[xfailIfSmithDynamo]),
        subtest([42], "list", decorators=[xfailIfSmithDynamo]),
        subtest([[42]], "list-list", decorators=[xfailIfSmithDynamo]),
        subtest(np.array([42]), "array_1D", decorators=[xfailIfSmithDynamo]),
        subtest(np.array([[42]]), "array_2D", decorators=[xfailIfSmithDynamo]),
    ]
    ...
    not_scalars = [
        int,
        np.float32,
        subtest("s", decorators=[xfailIfSmithDynamo]),
        subtest("string", decorators=[xfailIfSmithDynamo]),
        (),
        [],
        math.sin,
        np,
