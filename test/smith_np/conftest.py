...
def pytest_generate_tests(metafunc):
    ...
    The logic here allows us to test with both NumPy-proper and smith._numpy.
    Normally we'd just test smith._numpy, e.g.
    ...
    np is a pytest parameter, which is either NumPy-proper or smith._numpy. This
...
def pytest_collection_modifyitems(config, items):
    # Use default=False to handle case when option isn't registered
    # (e.g., when pytest is run from the root directory)
    # See: https://github.com/blacksmith/blacksmith/issues/171563
