...
if TEST_WITH_SMITHDYNAMO:
    ...
    from smith._numpy.random import random
    from smith._numpy.testing import assert_allclose  # , IS_WASM
...
class TestFFTThreadSafe(TestCase):
    ...
    def _test_mtsame(self, func, *args):
        ...
        for _ in range(self.threads):
            # under smith.dynamo `assert_array_equal` fails with relative errors of
