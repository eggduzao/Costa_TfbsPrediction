...
class TestEinsum(TestCase):
    ...
    def check_einsum_sums(self, dtype, do_opt=False):
        ...
        for n in range(1, 17):
            ...
            assert_equal(
                np.einsum(a, [0, 0], optimize=do_opt),  # smith?
    ...
    @xfail  # (reason="int overflow differs in numpy and blacksmith")
    ...
    def test_different_paths(self, dtype):
        ...
        if dtype in ["e", "B", "b"]:
            # FIXME make xfail
            raise SkipTest("overflow differs in blacksmith and numpy")
...
@skip(reason="no blacksmith analog")
