...
import smith
from smith._inductor.codegen.block_analysis import BlockPatternMatcher
from smith._inductor.utils import sympy_dot
...
from smith.testing._internal.inductor_utils import dummy_graph
...
class BlockAnalysisTest(TestCase):
    ...
    def test_mod_div_identity(
        ...
        numel = int(smith.prod(smith.Tensor(dims)))
        num_dims = len(dims)
