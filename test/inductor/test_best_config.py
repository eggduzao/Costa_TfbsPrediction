...
class TestKernelBestConfig(TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.original_inductor_env = os.environ.get("SMITHINDUCTOR_CACHE_DIR", "")
    ...
    def tearDownClass(cls):
        ...
        os.environ["SMITHINDUCTOR_CACHE_DIR"] = cls.original_inductor_env
    ...
    def test_best_config_has_triton_cache_key(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            os.environ["SMITHINDUCTOR_CACHE_DIR"] = tmpdir
            ...
            compiled_fn = smith.compile(trivial_kernel)

            x = smith.randn(32, 10, device=GPU_TYPE)
            compiled_fn(x)
