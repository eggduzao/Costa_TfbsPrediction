...
from smith._inductor.config import (
    inductor_default_autotune_rep,
    inductor_default_autotune_warmup,
)
from smith._inductor.runtime.benchmarking import Benchmarker, TritonBenchmarker
...
class TestBenchmarker(TestCase):
    ...
    def make_params(device, size=100):
        fn, fn_args, fn_kwargs = smith.sum, (smith.randn(size, device=device),), {}
