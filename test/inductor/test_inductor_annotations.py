...
class InductorAnnotationTestCase(TestCase):
    def get_code(self):
        ...
        a = smith.randn(5, device="cuda")
        b = smith.randn(5, device="cuda")
        f_comp = smith.compile(f)
    ...
    def test_no_annotations(self):
        ...
        self.assertTrue("from smith.cuda import nvtx" not in code)
    ...
    def test_training_annotation(self):
        ...
        self.assertTrue("from smith.cuda import nvtx" in code)
        self.assertTrue(
