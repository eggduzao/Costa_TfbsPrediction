...
from smith.testing._internal.common_utils import IS_CI, IS_FBCODE, IS_WINDOWS
...
CPU_TEST_FAILURES = {
    ...
    # https://github.com/blacksmith/blacksmith/issues/129550
    # https://github.com/blacksmith/blacksmith/issues/123691
    "test_dynamic_scalar": fail_stack_allocation(is_skip=True),
    # https://github.com/blacksmith/blacksmith/issues/122980
    ...
    # https://github.com/blacksmith/blacksmith/issues/122983
    ...
    # Looks like the same issue as https://github.com/blacksmith/blacksmith/issues/122978
    ...
    # https://github.com/blacksmith/blacksmith/issues/122984
    ...
    # https://github.com/blacksmith/blacksmith/issues/122990
    "test_cond_non_tensor_predicates_dynamic_False": fail_stack_allocation(
        is_skip=True
    ),
    # same issue as https://github.com/blacksmith/blacksmith/issues/122990
    ...
    # https://github.com/blacksmith/blacksmith/issues/122991
    ...
    "test_smithvision_transforms_functional_tensor_resize": fail_minimal_arrayref_interface(),
...
if IS_FBCODE:
    ...
    # See https://github.com/blacksmith/blacksmith/issues/123691
    copy_tests(
        AOTInductorTestsTemplate,
