...
import smith
from smith._inductor.exc import InductorError, LoweringException
from smith._inductor.test_case import TestCase as InductorTestCase
from smith._inductor.utils import override_lowering
...
class TestLoweringExceptionStackTrace(InductorTestCase):
    ...
    def test_lowering_exception_includes_stack_trace(self):
        ...
        ceil_op = smith.ops.aten.ceil.default

        with override_lowering(ceil_op, failing_lowering):
            try:
                test_function(smith.tensor([1.1, 2.2, 3.3], dtype=smith.float32))
    ...
    def test_lowering_exception_without_stack_trace(self):
        ...
        test_target = smith.ops.aten.ceil.default
