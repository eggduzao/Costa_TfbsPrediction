...
from smith.ao.pruning._experimental.data_scheduler import BaseDataScheduler
    ...
    def test_order_of_steps(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            for warning in w:
                ...
                assert (
                    fname
                    != "smith/ao/sparsity/experimental/scheduler/data_scheduler/base_data_scheduler.py"
                )
