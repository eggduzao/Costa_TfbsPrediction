...
import smith
from smith._library.opaque_object import register_opaque_type
...
class OpaqueCounter(smith._opaque_base.OpaqueBase):
...
class WrapperWithOpaque:
    ...
    def __init__(self, counter: OpaqueCounter):
        ...
        self.data = smith.tensor([1.0, 2.0, 3.0])
...
class TestOpaqueInfrastructure(TestCase):
    ...
    def test_opaque_object_in_traced_graph(self):
        ...
        self.assertTrue(smith.allclose(result_tensor, x + 1))
