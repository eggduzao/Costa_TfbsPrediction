...
legendYPosDict = dict([("H1hesc","0.496"),("HeLaS3","0.22"),("HepG2","0.22"),("Huvec","0.22"),("K562","0.496"),
   ("Mcf7","0.22"),("Saos2","0.22"),("LnCaP","0.22"),("m3134_with_DEX","0.22"),("m3134_wo_DEX","0.22")])
textYPosDict = dict([("H1hesc","0.465"),("HeLaS3","0.19"),("HepG2","0.19"),("Huvec","0.19"),("K562","0.465"),
   ("Mcf7","0.19"),("Saos2","0.19"),("LnCaP","0.19"),("m3134_with_DEX","0.19"),("m3134_wo_DEX","0.19")])
textYPosDictA = dict([("H1hesc","0.463"),("HeLaS3","0.188"),("HepG2","0.188"),("Huvec","0.188"),("K562","0.463"),
   ("Mcf7","0.188"),("Saos2","0.188"),("LnCaP","0.188"),("m3134_with_DEX","0.188"),("m3134_wo_DEX","0.188")])
textXPosDict = dict([("H1hesc","0.235"),("HeLaS3","0.235"),("HepG2","0.235"),("Huvec","0.235"),("K562","0.235"),
   ("Mcf7","0.235"),("Saos2","0.235"),("LnCaP","0.235"),("m3134_with_DEX","0.235"),("m3134_wo_DEX","0.235")])
...
"""
pointStyVecDict = dict([("H1hesc",["21","21","21","21","21","21","21","21","21","21","21","21","21","21","21"]),
                   ("HeLaS3",["21","21","21","21","21","21"]),
                   ("HepG2",["21","21","21","21","21","21"]),
                   ("Huvec",["21","21","21","21","21","21"]),
                   ("K562",["21","21","21","21","21","21","21","21","21","21","21","21","21","21","21"]),
                   ("Mcf7",["21","21","21","21","21","21"]),
                   ("Saos2",["21","21","21","21","21","21"]),
                   ("LnCaP",["21","21","21","21","21","21"]),
                   ("m3134_with_DEX",["21","21","21","21","21","21"]),
                   ("m3134_wo_DEX",["21","21","21","21","21","21"]),
])
"""
...
myLegendDict = dict([
    ("H1hesc","/work/eg474423/eg474423_Projects/trunk/TfbsPrediction/Results/LabelTranslation/myLegend5.R"),
    ("HeLaS3","/work/eg474423/eg474423_Projects/trunk/TfbsPrediction/Results/LabelTranslation/myLegend6.R"),
    ("HepG2","/work/eg474423/eg474423_Projects/trunk/TfbsPrediction/Results/LabelTranslation/myLegend6.R"),
    ("Huvec","/work/eg474423/eg474423_Projects/trunk/TfbsPrediction/Results/LabelTranslation/myLegend6.R"),
    ("K562","/work/eg474423/eg474423_Projects/trunk/TfbsPrediction/Results/LabelTranslation/myLegend9.R"),
    ("Mcf7","/work/eg474423/eg474423_Projects/trunk/TfbsPrediction/Results/LabelTranslation/myLegend6.R"),
    ("Saos2","/work/eg474423/eg474423_Projects/trunk/TfbsPrediction/Results/LabelTranslation/myLegend6.R"),
    ("LnCaP","/work/eg474423/eg474423_Projects/trunk/TfbsPrediction/Results/LabelTranslation/myLegend6.R"),
    ("m3134_with_DEX","/work/eg474423/eg474423_Projects/trunk/TfbsPrediction/Results/LabelTranslation/myLegend6.R"),
    ("m3134_wo_DEX","/work/eg474423/eg474423_Projects/trunk/TfbsPrediction/Results/LabelTranslation/myLegend6.R")])
...
for rocFileName in glob.glob(rocFolder+cell+"/*_roc.txt"):
    ...
    outputFile.write("myLegend(-0.035,"+legendYPosDict[cell]+",c("+",".join(["'"+e+"'" for e in newFencyLabelList])+","+",".join(["'"+str(round(float(e)*100,2))+"'" for e in aucList])+"),lty=legendStyVec,col=legendCol,lwd=2.0,title='',cex=0.8,ncol=2,seg.len=segLen)\n")
    outputFile.write("text(x=0.115,y="+textYPosDict[cell]+",'METHOD',font=2,cex=0.8)\n")
    outputFile.write("text(x="+textXPosDict[cell]+",y="+textYPosDictA[cell]+",'AUC(%)',font=2,cex=0.8)\n")
