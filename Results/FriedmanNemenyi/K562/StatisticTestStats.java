...
public class StatisticTestStats {

	public static void main(String []args){


		String []arquivos = {
                    "/work/eg474423/eg474423_Projects/trunk/TfbsPrediction/data/Results_Bioinformatics2014/FriedmanNemenyi/K562/Input/ac.txt",
                    "/work/eg474423/eg474423_Projects/trunk/TfbsPrediction/data/Results_Bioinformatics2014/FriedmanNemenyi/K562/Input/ba.txt",
                    "/work/eg474423/eg474423_Projects/trunk/TfbsPrediction/data/Results_Bioinformatics2014/FriedmanNemenyi/K562/Input/sn.txt",
                    "/work/eg474423/eg474423_Projects/trunk/TfbsPrediction/data/Results_Bioinformatics2014/FriedmanNemenyi/K562/Input/sp.txt",
                    "/work/eg474423/eg474423_Projects/trunk/TfbsPrediction/data/Results_Bioinformatics2014/FriedmanNemenyi/K562/Input/pp.txt",
                    "/work/eg474423/eg474423_Projects/trunk/TfbsPrediction/data/Results_Bioinformatics2014/FriedmanNemenyi/K562/Input/np.txt"
		};
		...
		for(String arq : arquivos ){
			try {
				...
				System.out.println( "Estatisticas -- "+arq+"("+asc+")\n" + StatisticTestStats.estatisticas(data, asc) );

				System.out.println( "Win/Tie/Loss -- "+arq+"\n" + StatisticTestStats.tabelaDesempenho(data, asc) );
