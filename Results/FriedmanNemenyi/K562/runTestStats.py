...
# Input
inLoc = "/work/eg474423/eg474423_Projects/trunk/TfbsPrediction/data/Results_Bioinformatics2014/FriedmanNemenyi/K562/"
javaFileName = "StatisticTestStats"
wekaFileName = "/work/eg474423/eg474423_Projects/trunk/TfbsPrediction/data/Results_Bioinformatics2014/FriedmanNemenyi/K562/weka.jar"
outputFileName = "/work/eg474423/eg474423_Projects/trunk/TfbsPrediction/data/Results_Bioinformatics2014/FriedmanNemenyi/K562/resultsStats.txt"
texFileName = "resultsStats"
headerFileName = "/work/eg474423/eg474423_Projects/trunk/TfbsPrediction/data/Results_Bioinformatics2014/FriedmanNemenyi/K562/Input/headerStats.txt"
...
for i in range(0,len(tableList)):
    ...
    texFile.write("    \\multirow{7}{*}{\\begin{sideways}"+fencyVec[i]+"\\end{sideways}}\n")
    for m in range(0,len(tableList[i])):
