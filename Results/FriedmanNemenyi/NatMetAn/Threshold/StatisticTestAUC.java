...
public class StatisticTestAUC {

	public static void main(String []args){


		String []arquivos = {
		    "/work/eg474423/eg474423_Projects/trunk/TfbsPrediction/Results/FriedmanNemenyi/NatMetAn/Threshold/Input/sb.txt"
		};
		...
		for(String arq : arquivos ){
			try {
				...
				System.out.println( "Estatisticas -- "+arq+"("+asc+")\n" + StatisticTestAUC.estatisticas(data, asc) );

				System.out.println( "Win/Tie/Loss -- "+arq+"\n" + StatisticTestAUC.tabelaDesempenho(data, asc) );
	...
	public static String estatisticas(double [][]matriz, boolean asc){
		...
		//double []qAlpha5pct = {1.960, 2.343, 2.569, 2.728, 2.850, 2.949, 3.031, 3.102, 3.164};
		//double []qAlpha10pct = {1.645, 2.052, 2.291, 2.459, 2.589, 2.693, 2.780, 2.855, 2.920};
        double []qAlpha5pct = {1.960, 2.344, 2.569, 2.728, 2.850, 2.948, 3.031, 3.102, 3.164, 3.219, 3.268, 3.313, 3.354, 3.391, 3.426, 3.458, 3.489, 3.517, 3.544, 3.569, 3.593, 3.616, 3.637, 3.658, 3.678, 3.696, 3.714, 3.732, 3.749, 3.765, 3.780, 3.795, 3.810, 3.824, 3.837, 3.850, 3.863, 3.876, 3.888, 3.899, 3.911, 3.922, 3.933, 3.943, 3.954, 3.964, 3.973, 3.983, 3.992, 4.001, 4.009, 4.017, 4.025, 4.032, 4.040, 4.046};
        double []qAlpha10pct = {1.645, 2.052, 2.291, 2.460, 2.589, 2.693, 2.780, 2.855, 2.920, 2.978, 3.030, 3.077, 3.120, 3.159, 3.196, 3.230, 3.261, 3.291, 3.319, 3.346, 3.371, 3.394, 3.417, 3.439, 3.459, 3.479, 3.498, 3.516, 3.544, 3.569, 3.593, 3.616, 3.637, 3.658, 3.678, 3.696, 3.714, 3.732, 3.749, 3.765, 3.780, 3.795, 3.810, 3.824, 3.837, 3.850, 3.863, 3.876, 3.888, 3.899, 3.911, 3.922, 3.933, 3.943, 3.954, 3.964, 3.973, 3.983, 3.992, 4.001, 4.009, 4.017, 4.025, 4.032, 4.040, 4.046};
		double critDiff = Math.sqrt((nc*(nc+1.0))/(6.0*nl));
		...
		//monta "tabela" de comparacao par a par
		statsResults.append("\n\nTabela de Comparacao (+ significa diferenca estatistica 90% e * 95%)\n,");
