...
# Input
inLoc = "/work/eg474423/eg474423_Projects/trunk/TfbsPrediction/Results/FriedmanNemenyi/NatMetAn/Threshold/"
javaFileName = "StatisticTestAUC"
wekaFileName = inLoc+"weka.jar"
outputFileName = inLoc+"results_"+outname+".txt"
texFileName = "results_"+outname
headerFileName = inLoc+"Input/"+outname+"_header.txt"
