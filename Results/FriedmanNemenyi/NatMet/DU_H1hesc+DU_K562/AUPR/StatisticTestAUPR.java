...
public class StatisticTestAUPR {

	public static void main(String []args){


		String []arquivos = {
		    "/work/eg474423/eg474423_Projects/trunk/TfbsPrediction/Results/FriedmanNemenyi/NatMet/DU_H1hesc+DU_K562/AUPR/Input/ALLAUPR.txt"
		};
		...
		for(String arq : arquivos ){
			try {
				...
				System.out.println( "Estatisticas -- "+arq+"("+asc+")\n" + StatisticTestAUPR.estatisticas(data, asc) );

				System.out.println( "Win/Tie/Loss -- "+arq+"\n" + StatisticTestAUPR.tabelaDesempenho(data, asc) );
