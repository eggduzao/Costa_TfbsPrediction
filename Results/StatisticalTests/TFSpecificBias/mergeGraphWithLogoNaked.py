...
# Input
lineLoc = "/work/eg474423/eg474423_Projects/trunk/TfbsPrediction/Results/StatisticalTests/TFSpecificBias/LineGraphsNaked/"
pwmLoc = "/work/eg474423/eg474423_Projects/trunk/TfbsPrediction/Results/StatisticalTests/TFSpecificBias/PearsonNaked/"
...
inList = ["DU_H1hesc", "DU_HeLaS3", "DU_HepG2", "DU_Huvec", "DU_K562", "DU_Mcf7", "DU_Saos2", "UW_LnCaP"]
...
for inFolder in inList:
  ...
  for lineFileName in glob(lineLoc+inFolder+"/*.eps"):
    ...
    c.insert(epsfile.epsfile(3.05, 2.55, pwmFileName, width=13.9,height=2.75, bbox=b))
