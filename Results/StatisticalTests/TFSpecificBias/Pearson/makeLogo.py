...
# Reading input
inputLoc = "/work/eg474423/eg474423_Projects/trunk/TfbsPrediction/Results/StatisticalTests/TFSpecificBias/Pearson/"
inList = [ "DU_H1hesc", "DU_HeLaS3", "DU_HepG2", "DU_Huvec", "DU_K562", "UW_HepG2", "UW_Huvec", "UW_K562", "DU_Mcf7", "DU_Saos2", "UW_denovo", "UW_LnCaP", "UW_m3134_with_DEX", "UW_m3134_wo_DEX", "UW_H7hesc" ]
inList = [ "DU_H1hesc" ]

# Execution
for inName in inList:
  for inFileName in glob(inputLoc+inName+"/PWM/*_align.pwm"):
    if("JUN" not in inFileName): continue
