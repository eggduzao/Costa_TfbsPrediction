...
do
  ...
  do
    ...
    outputLocation=$p"/TfbsPrediction/Results/StatisticalTests/TFSpecificBias/PearsonRatio/"$labLabel"_"$cell"/"
    pwmLocation=$p"/TfbsPrediction/Results/StatisticalTests/TFSpecificBias/PearsonRatio/"$labLabel"_"$cell"/PWM/"

    mkdir -p $outputLocation
    mkdir -p $pwmLocation

    # Execution
    #bsub -J "EP" -o "EP_out.txt" -e "EP_err.txt" -W 24:00 -M 12000 -S 100 -P izkf -R "select[hpcwork]" ./evaluatePearsonRatio_pipeline.zsh $fBiasFileName $rBiasFileName $bamFileName $fastaFileName $csFileName $tfbsLocation $outputLocation $pwmLocation
...
outputLocation=$p"/TfbsPrediction/Results/StatisticalTests/TFSpecificBias/PearsonRatio/UW_denovo/"
pwmLocation=$p"/TfbsPrediction/Results/StatisticalTests/TFSpecificBias/PearsonRatio/UW_denovo/PWM/"
mkdir -p $outputLocation
mkdir -p $pwmLocation

# Execution
bsub -J "EPU" -o "EPU_out.txt" -e "EPU_err.txt" -W 24:00 -M 12000 -S 100 -P izkf -R "select[hpcwork]" ./evaluatePearsonRatio_pipeline.zsh $fBiasFileName $rBiasFileName $bamFileName $fastaFileName $csFileName $tfbsLocation $outputLocation $pwmLocation
...
outputLocation=$p"/TfbsPrediction/Results/StatisticalTests/TFSpecificBias/PearsonRatio/DU_Saos2/"
pwmLocation=$p"/TfbsPrediction/Results/StatisticalTests/TFSpecificBias/PearsonRatio/DU_Saos2/PWM/"
mkdir -p $outputLocation
mkdir -p $pwmLocation

# Execution
#bsub -J "EPS" -o "EPS_out.txt" -e "EPS_err.txt" -W 24:00 -M 12000 -S 100 -P izkf -R "select[hpcwork]" ./evaluatePearsonRatio_pipeline.zsh $fBiasFileName $rBiasFileName $bamFileName $fastaFileName $csFileName $tfbsLocation $outputLocation $pwmLocation
