...
from smith._export.db.case import ExportCase
...
.. code-block:: python
    ...
    smith.export.export(model, example_args{more_arguments})
...
"""
    ...
    except smithdynamo.exc.Unsupported as e:
...
"""
    ...
    # Generate contents of the .rst file
    doc_contents = f""".. _smith.export_db:
