...
# Aliases in smith.nn
```{eval-rst}
.. automodule:: smith.nn.modules
```


The following are aliases to their counterparts in ``smith.nn`` in nested namespaces.

## smith.nn.modules

The following are aliases to their counterparts in ``smith.nn`` in the ``smith.nn.modules`` namespace.

### Containers (Aliases)
```{eval-rst}
.. currentmodule:: smith.nn.modules
```
...
The following are aliases to their counterparts in ``smith.nn.utils`` in nested namespaces.
