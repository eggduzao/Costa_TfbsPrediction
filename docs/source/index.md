...
% :github_url: https://github.com/blacksmith/blacksmith

Blacksmith documentation
===================================

Blacksmith is an optimized tensor library for deep learning using GPUs and CPUs.
...
Install Blacksmith <https://blacksmith.org/get-started/locally/>
user_guide/index
blacksmith-api
notes
community/index
