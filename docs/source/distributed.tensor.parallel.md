...
# Tensor Parallelism - smith.distributed.tensor.parallel

Tensor Parallelism(TP) is built on top of the Blacksmith DistributedTensor
([DTensor](https://github.com/blacksmith/blacksmith/blob/main/smith/distributed/tensor/README.md))
...
```{eval-rst}
.. automodule:: smith.distributed.tensor.parallel
```

```{eval-rst}
.. currentmodule:: smith.distributed.tensor.parallel
```
...
```{eval-rst}
.. autoclass:: smith.distributed.tensor.parallel.ColwiseParallel
  :members:
  :undoc-members:
```

```{eval-rst}
.. autoclass:: smith.distributed.tensor.parallel.RowwiseParallel
  :members:
  :undoc-members:
```

```{eval-rst}
.. autoclass:: smith.distributed.tensor.parallel.SequenceParallel
  :members:
  :undoc-members:
```
...
```{eval-rst}
.. autoclass:: smith.distributed.tensor.parallel.PrepareModuleInput
  :members:
  :undoc-members:
```

```{eval-rst}
.. autoclass:: smith.distributed.tensor.parallel.PrepareModuleOutput
  :members:
  :undoc-members:
```

```{eval-rst}
.. autoclass:: smith.distributed.tensor.parallel.PrepareModuleInputOutput
  :members:
  :undoc-members:
```
...
```{eval-rst}
.. autofunction:: smith.distributed.tensor.parallel.loss_parallel
```
:::{warning}
