smith.utils.tensorboard
===================================
.. automodule:: smith.utils.tensorboard

Before going further, more details on TensorBoard can be found at
https://www.tensorflow.org/tensorboard/

Once you've installed TensorBoard, these utilities let you log Blacksmith models
...
supported for Blacksmith models and tensors as well as Caffe2 nets and blobs.
...
.. code:: python
    ...
    trainloader = smith.utils.data.DataLoader(trainset, batch_size=64, shuffle=True)
    model = smithvision.models.resnet50(False)
    # Have ResNet model take in grayscale rather than RGB
    model.conv1 = smith.nn.Conv2d(1, 64, kernel_size=7, stride=2, padding=3, bias=False)
    images, labels = next(iter(trainloader))

    grid = smithvision.utils.make_grid(images)
...
.. currentmodule:: smith.utils.tensorboard.writer
