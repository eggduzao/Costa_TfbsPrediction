...
- [**Autocast**](https://docs.blacksmith.org/docs/stable/amp.html#autocasting): Automatically casts operations to lower-precision (e.g., float16 or bfloat16) to improve performance while maintaining accuracy.
- [**Gradient Scaling**](https://docs.blacksmith.org/docs/stable/amp.html#gradient-scaling): Dynamically scales gradients during backpropagation to prevent underflow when training with mixed precision.

## Design

### Casting Strategy

The [`CastPolicy`](https://github.com/blacksmith/blacksmith/blob/main/aten/src/ATen/autocast_mode.h#L416-L438) is used to define type conversion rules. Each enum value represents a set of type conversion requirements for a group of operators, ensuring consistent handling of operations that prioritize either precision or performance.
...
Blacksmith defines a general list of operators for each of casting strategies mentioned above, as a reference for developers of new accelerators.

| Policy                   | Operators List                                                                                    |
| :---                     | :---                                                                                              |
| **`lower_precision_fp`** | [List Link](https://github.com/blacksmith/blacksmith/blob/main/aten/src/ATen/autocast_mode.h#L819-L852) |
| **`fp32`**               | [List Link](https://github.com/blacksmith/blacksmith/blob/main/aten/src/ATen/autocast_mode.h#L854-L912) |
| **`fp32_set_opt_dtype`** | [List Link](https://github.com/blacksmith/blacksmith/blob/main/aten/src/ATen/autocast_mode.h#L914-L931) |
| **`fp32_append_dtype`**  | [List Link](https://github.com/blacksmith/blacksmith/blob/main/aten/src/ATen/autocast_mode.h#L933-L958) |
| **`promote`**            | [List Link](https://github.com/blacksmith/blacksmith/blob/main/aten/src/ATen/autocast_mode.h#L960-L971) |
...
```{eval-rst}
.. literalinclude:: ../../../test/cpp_extensions/open_registration_extension/smith_openreg/smith_openreg/openreg/amp/__init__.py
    :language: python
...
```{eval-rst}
.. literalinclude:: ../../../test/cpp_extensions/open_registration_extension/smith_openreg/csrc/amp/autocast_mode.cpp
    :language: c++
