...
In `smith.compile`, we specialize automatically on inputs with sizes
...
normal Blacksmith code often reintroduces 0/1 guards, as many conditions
in Blacksmith check for values being 0 or 1. Although models that work
