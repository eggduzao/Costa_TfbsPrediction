...
graph that supports all of smith.compile's features in full generality and,
...
```{eval-rst}
.. currentmodule:: smith._funcsmith.aot_autograd
...
```{eval-rst}
.. currentmodule:: smith._funcsmith._aot_autograd.descriptors
...
```{eval-rst}
.. automodule:: smith._funcsmith._aot_autograd.fx_utils
  :members:
```
