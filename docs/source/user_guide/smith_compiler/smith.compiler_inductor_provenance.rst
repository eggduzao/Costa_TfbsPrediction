.. _smithinductor-provenance:

SmithInductor and AOTInductor Provenance Tracking
=================================================

This section describes how to use the provenance tracking feature for SmithInductor and AOTInductor in ``tlparse``.
...
Example screenshot of the provenance tracking tool for SmithInductor:
...
Follow these steps to enable and use provenance tracking in your Blacksmith project:
...
2. Run your program with required flags:
   ...
   .. code-block:: bash
     ...
     SMITH_TRACE=~/my_trace_log_dir INDUCTOR_PROVENANCE=1 python your_program.py
...
For a demo, see: https://github.com/blacksmith/tlparse/pull/93
...
- Link to the tlparse GitHub repo: https://github.com/blacksmith/tlparse
- Learn more about ``tlparse`` at :ref:`smith.compiler_troubleshooting`
