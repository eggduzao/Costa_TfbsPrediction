...
.. note::
   ...
   This page has been deprecated. Please refer to the `Contribution Guide <https://github.com/blacksmith/blacksmith/wiki/The-Ultimate-Guide-to-Blacksmith-Contributions>`_ on the Blacksmith Wiki.

Blacksmith Contribution Guide
==========================

Blacksmith is a GPU-accelerated Python tensor computation package for
...
The Blacksmith organization is governed by :doc:`Blacksmith
Governance <governance>` and the technical guide to contributing
can be found in `CONTRIBUTING.md <https://github.com/blacksmith/blacksmith/blob/main/CONTRIBUTING.md>`_.

The Blacksmith development process involves a healthy amount of open
discussions between the core development team and the community.

Blacksmith operates similarly to most open source projects on GitHub.
...
-  **Figure out what you're going to work on.** The majority of open
   ...
   -  Look through the `issue
      tracker <https://github.com/blacksmith/blacksmith/issues/>`__ and see if
   ...
   -  Join us on `dev discuss <https://dev-discuss.blacksmith.org/>`_
      and let us know you're interested in getting to
      know Blacksmith. We're very happy to help out researchers and
...
-  **Figure out the scope of your change and reach out for design
   ...
   first by `submitting an RFC <https://github.com/blacksmith/rfcs/blob/master/README.md>`__.

   -  If you don't know how big a change is going to be, we can help you
      figure it out! Just post about it on
      `issues <https://github.com/blacksmith/blacksmith/issues/>`_ or
      `dev discuss <https://dev-discuss.blacksmith.org/>`_.
   -  Some feature additions are very standardized; for example, lots of
      people add new operators or optimizers to Blacksmith. Design
   ...
   -  Core changes and refactors can be quite difficult to coordinate
      since the pace of development on the Blacksmith main branch is quite fast.
...
-  **Code it out!**
   ...
   -  See the `CONTRIBUTING.md <https://github.com/blacksmith/blacksmith/blob/main/CONTRIBUTING.md>`_ file for advice for working with Blacksmith in a
      technical form.
...
-  **Open a pull request.**
   ...
   -  Find an appropriate reviewer for your change. We have some folks
      ...
      `Persons of Interest <https://blacksmith.org/docs/main/community/persons_of_interest.html>`_
...
solution. The Blacksmith team and community frequently review new issues
...
existing issues <https://github.com/blacksmith/blacksmith/issues>`__ on the
...
proposed solution. The Blacksmith team can provide guidance that saves you
time.
...
A great deal of the tutorials on `blacksmith.org <https://blacksmith.org/>`__
...
here: `Blacksmith.org Tutorial Contribution Guide on
GitHub <https://github.com/blacksmith/tutorials/#contributing>`__
...
You can find active discussions happening on the `Blacksmith Discussion
Forums <https://discuss.blacksmith.org/>`__  for users as well as the
`Blacksmith Dev Discussion Forums <https://dev-discuss.blacksmith.org/>`__
...
`here <https://github.com/blacksmith/blacksmith/issues>`__. Commenting on an
...
request that touches many files. Starting a discussion in the Blacksmith
forum `here <https://discuss.blacksmith.org/>`__ or on an issue related to
...
Promoting Blacksmith
~~~~~~~~~~~~~~~~~

Your use of Blacksmith in your projects, research papers, write ups, blogs,
or general discussions around the internet helps to raise awareness for
Blacksmith and our growing community. Please reach out to
`marketing@blacksmith.org <mailto:marketing@blacksmith.org>`__
...
-  **CI tests failed, what does it mean?** Maybe your PR is based
   ...
   main branch's CI at https://hud.blacksmith.org/.
...
Blacksmith documentation is generated from python source using
`Sphinx <https://www.sphinx-doc.org/en/master/>`__. Generated HTML is
copied to the docs folder in the main branch of
`blacksmith.org/docs <https://blacksmith.org/docs/main>`__,
and is served via GitHub pages.

-  Site: https://blacksmith.org/docs
-  GitHub: https://github.com/blacksmith/blacksmith/tree/main/docs
-  Served from:
   `https://blacksmith.org/docs/main <https://blacksmith.org/docs/main>`__
...
https://github.com/blacksmith/cppdocs repo, and are served from GitHub
pages.

-  Site: https://blacksmith.org/cppdocs
-  GitHub: https://github.com/blacksmith/blacksmith/tree/main/docs/cpp
-  Served from: https://github.com/blacksmith/cppdocs

Tutorials
---------

Blacksmith tutorials are documents used to help understand using Blacksmith to
...
-  Site: https://blacksmith.org/tutorials
-  GitHub: https://github.com/blacksmith/tutorials

Tutorials Build Overview
~~~~~~~~~~~~~~~~~~~~~~~~~~~~

For tutorials, `pull
requests <https://github.com/blacksmith/tutorials/pulls>`__ trigger a
...
See `Blacksmith.org Tutorial Contribution
Guide <https://github.com/blacksmith/tutorials/#contributing>`__.
