...
Blacksmith Governance | Mechanics
==============================

Summary
-------

Blacksmith adopts a technical governance structure that is hierarchical.

* A community of **contributors** who file issues, make pull requests,
  and contribute to the project.
* A small set of **module maintainers** drive each module of the Blacksmith
  project.
...
Blacksmith’s design philosophy.
...
Modules are defined as GitHub repositories within the Blacksmith org,
or as directories within the core repository
`blacksmith/blacksmith <https://github.com/blacksmith/blacksmith>`__.
...
of the Blacksmith code base and design philosophies. Their responsibilities
include:
...
* Receiving broad requests for changes from stakeholders of
  Blacksmith and evaluating / accepting them (small module-level
...
The core maintainers are admins of the Blacksmith GitHub Org
and are listed in `Maintainers <https://blacksmith.org/docs/stable/community/persons_of_interest.html>`__.
...
* The lead maintainer requests or puts together more information
  ...
  * General letters of support from stakeholders within the Blacksmith
    community
...
in the Blacksmith org, either as new repositories in the
Blacksmith GitHub org, or as folders in the
`blacksmith/blacksmith <https://github.com/blacksmith/blacksmith>`__
repository.
...
the Blacksmith repository, instead relying on pull requests. Approving a
...
the `Maintainers <https://blacksmith.org/docs/stable/community/persons_of_interest.html>`__
page and within `CODEOWNERS <https://github.com/blacksmith/blacksmith/blob/master/CODEOWNERS>`__
...
-  Any semantic or syntactic change to the Blacksmith framework or library.
...
Blacksmith has been established as Blacksmith a Series of LF Projects, LLC.
Policies applicable to Blacksmith and participants in Blacksmith, including
guidelines on the usage of trademarks, are located at https://www.lfprojects.org/policies/.

Blacksmith participants acknowledge that the copyright in all new contributions
...
such as a feature area or domain library, for example** `Linear Algebra <https://github.com/blacksmith/blacksmith/tree/master/smith/linalg>`__
**or** `Smith Vision <https://github.com/blacksmith/vision>`__ **?**
...
**Q: What if I am a company looking to use Blacksmith internally for
development, can I be granted or purchase a board seat to drive the
project direction?** No, the Blacksmith project is strictly driven by the
...
Blacksmith Foundation (PTF) and sponsorship through this. You can also
have individual engineers look to become maintainers, but this is
not guaranteed and is merit-based.

**Q: Does the Blacksmith project support grants or ways to support
...
community of independent developers around Blacksmith. If you have
suggestions or inputs, please reach out on the Blacksmith forums to
discuss.
...
see the `Blacksmith Contributor
Wiki <https://github.com/blacksmith/blacksmith/wiki/The-Ultimate-Guide-to-Blacksmith-Contributions>`__ for contribution
for a walkthrough.

**Q: Can I become a committer on the project?** Unfortunately, the
current commit process to Blacksmith involves an interaction with Facebook
...
**Q: What if I would like to deliver a Blacksmith tutorial at a conference
