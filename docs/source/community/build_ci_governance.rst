...
Blacksmith Governance | Build + CI
===============================
...
* Land at least six commits to the related part of the Blacksmith repository
...
a PR that adds a person to the `persons of interests <https://blacksmith.org/docs/main/community/persons_of_interest.html>`__ page and
`merge_rules <https://github.com/blacksmith/blacksmith/blob/main/.github/merge_rules.yaml>`__ files. Current maintainers will cast their votes of
