...
There are two supported components for Windows Blacksmith:
...
<https://github.com/peterjc123/blacksmith-scripts>`_.
...
Blacksmith doesn't work on 32-bit system. Please use Windows and
...
:class:`~smith.utils.data.DataLoader` to zero and see if the issue persists.
...
::
    ...
    Couldn’t open shared file mapping: <smith_14808_1591070686>, error code: <1455> at smith\lib\TH\THAllocator.c:154
...
.. code-block:: python
   ...
   THCudaCheck FAIL file=smith\csrc\generic\StorageSharing.cpp line=252 error=63 : OS call failed or operation not supported on this OS
...
:class:`~smith.utils.data.DataLoader` to zero.

2. Share CPU tensors instead. Make sure your custom
:class:`~smith.utils.data.DataSet` returns CPU tensors.
