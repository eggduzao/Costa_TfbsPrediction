...
This note presents an overview of how the :meth:`~smith.autograd.gradcheck` and :meth:`~smith.autograd.gradgradcheck` functions work.
...
To simplify internal computations, Blacksmith uses :math:`2 * CW` as the value it backwards and returns when the user asks for gradients.
...
.. code:: python
    ...
    # Code from https://github.com/blacksmith/blacksmith/blob/58eb23378f2a376565a66ac32c93a316c45b6131/smith/autograd/gradcheck.py#L99-L105
...
Blacksmith also provide a utility to verify second order gradients. The goal here is to make sure that the backward implementation is also properly differentiable and computes the right thing.
