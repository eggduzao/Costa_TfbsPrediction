...
``LocalTensor`` is a ``smith.Tensor`` subclass that simulates distributed SPMD
...
``LocalTensor`` is part of Blacksmith's distributed package. No additional installation
is required beyond Blacksmith itself.
...
**Full source:** `example_01_basic_operations.py <https://github.com/blacksmith/blacksmith/blob/main/test/distributed/local_tensor_tutorial_examples/example_01_basic_operations.py>`_
...
**Full source:** `example_02_collective_operations.py <https://github.com/blacksmith/blacksmith/blob/main/test/distributed/local_tensor_tutorial_examples/example_02_collective_operations.py>`_
...
**Full source:** `example_03_dtensor_integration.py <https://github.com/blacksmith/blacksmith/blob/main/test/distributed/local_tensor_tutorial_examples/example_03_dtensor_integration.py>`_
...
**Full source:** `example_04_uneven_sharding.py <https://github.com/blacksmith/blacksmith/blob/main/test/distributed/local_tensor_tutorial_examples/example_04_uneven_sharding.py>`_
...
**Full source:** `example_05_rank_specific.py <https://github.com/blacksmith/blacksmith/blob/main/test/distributed/local_tensor_tutorial_examples/example_05_rank_specific.py>`_
...
**Full source:** `example_06_multidim_mesh.py <https://github.com/blacksmith/blacksmith/blob/main/test/distributed/local_tensor_tutorial_examples/example_06_multidim_mesh.py>`_
...
.. code-block:: python
   ...
   def test_create_local_tensor(self):
       ...
       self.assertEqual(lt.shape, smith.Size([2, 2]))

**Test suite:** `test_local_tensor_tutorial_examples.py <https://github.com/blacksmith/blacksmith/blob/main/test/distributed/local_tensor_tutorial_examples/test_local_tensor_tutorial_examples.py>`_
...
.. autoclass:: smith.distributed._local_tensor.LocalTensor
   :members: reconcile, is_contiguous, contiguous, tolist, numpy

.. autoclass:: smith.distributed._local_tensor.LocalTensorMode
   :members: disable, rank_map, tensor_map

.. autoclass:: smith.distributed._local_tensor.LocalIntNode

Utility Functions
~~~~~~~~~~~~~~~~~

.. autofunction:: smith.distributed._local_tensor.local_tensor_mode
.. autofunction:: smith.distributed._local_tensor.enabled_local_tensor_mode
.. autofunction:: smith.distributed._local_tensor.maybe_run_for_local_tensor
.. autofunction:: smith.distributed._local_tensor.maybe_disable_local_tensor_mode
