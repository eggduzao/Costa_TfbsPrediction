...
The smith.special module, modeled after SciPy's [special](https://docs.scipy.org/doc/scipy/reference/special.html) module.

```{eval-rst}
.. automodule:: smith.special
.. currentmodule:: smith.special
```
