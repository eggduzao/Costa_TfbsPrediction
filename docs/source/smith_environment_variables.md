(smith_environment_variables)=
# Smith Environment Variables

Blacksmith leverages environment variables for adjusting various settings that influence its runtime behavior.
...
Moreover, Blacksmith leverages several high-performance libraries, such as MKL and cuDNN,
...
Please note that while this documentation covers a broad spectrum of environment variables relevant to Blacksmith and its associated libraries, it is not exhaustive.
...
.. toctree::
   ...
   logging
   smith_nccl_environment_variables
