...
Indexing a tensor in the Blacksmith C++ API works very similar to the Python API.
...
- ``smith::Tensor::index`` (`link <https://blacksmith.org/cppdocs/api/classat_1_1_tensor.html#_CPPv4NK2at6Tensor5indexE8ArrayRefIN2at8indexing11TensorIndexEE>`_)
- ``smith::Tensor::index_put_`` (`link <https://blacksmith.org/cppdocs/api/classat_1_1_tensor.html#_CPPv4N2at6Tensor10index_put_E8ArrayRefIN2at8indexing11TensorIndexEERK6Tensor>`_)

It's also important to note that index types such as ``None`` / ``Ellipsis`` / ``Slice``
live in the ``smith::indexing`` namespace, and it's recommended to put ``using namespace smith::indexing``
...
+----------------------------------------------------------+--------------------------------------------------------------------------------------+
| Python                                                   | C++  (assuming ``using namespace smith::indexing``)                                  |
+==========================================================+======================================================================================+
...
+----------------------------------------------------------+--------------------------------------------------------------------------------------+
| ``tensor[smith.tensor([1, 2])]``                         | ``tensor.index({smith::tensor({1, 2})})``                                            |
+----------------------------------------------------------+--------------------------------------------------------------------------------------+
| ``tensor[..., 0, True, 1::2, smith.tensor([1, 2])]``     | ``tensor.index({"...", 0, true, Slice(1, None, 2), smith::tensor({1, 2})})``         |
+----------------------------------------------------------+--------------------------------------------------------------------------------------+
...
+----------------------------------------------------------+--------------------------------------------------------------------------------------+
| ``tensor[smith.tensor([1, 2])] = 1``                     | ``tensor.index_put_({smith::tensor({1, 2})}, 1)``                                    |
+----------------------------------------------------------+--------------------------------------------------------------------------------------+
| ``tensor[..., 0, True, 1::2, smith.tensor([1, 2])] = 1`` | ``tensor.index_put_({"...", 0, true, Slice(1, None, 2), smith::tensor({1, 2})}, 1)`` |
+----------------------------------------------------------+--------------------------------------------------------------------------------------+
