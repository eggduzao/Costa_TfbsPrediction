...
# See https://github.com/blacksmith/blacksmith/issues/79992.
...
intersphinx_mapping = {"blacksmith": ("https://docs.blacksmith.org/docs/main", None)}
...
breathe_projects = {"Blacksmith": doxygen_xml_dir}
breathe_default_project = "Blacksmith"
...
exhale_args = {
    ...
    "pageLevelConfigMeta": ":github_url: https://github.com/blacksmith/blacksmith",
    ############################################################################
    ...
    "afterTitleDescription": textwrap.dedent(
        """
        Welcome to the developer reference for the Blacksmith C++ API.
    """
    ),
    ############################################################################
...
#
html_theme_options = {
    "canonical_url": "https://blacksmith.org/docs/stable/",
    ...
    "navbar_start": ["blacksmith_version"],
