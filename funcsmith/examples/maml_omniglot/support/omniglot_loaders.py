...
# These Omniglot loaders are from Jackie Loong's Blacksmith MAML implementation:
#     https://github.com/dragen1860/MAML-Blacksmith
#     https://github.com/dragen1860/MAML-Blacksmith/blob/master/omniglot.py
#     https://github.com/dragen1860/MAML-Blacksmith/blob/master/omniglotNShot.py
...
import smith
import smith.utils.data as data
...
class OmniglotNShot:
    ...
    def load_data_cache(self, data_pack):
        ...
        for sample in range(10):  # num of episodes
            ...
            x_spts, y_spts, x_qrys, y_qrys = (
                smith.from_numpy(z).to(self.device)
