...
Utilities for working with smith.nn.Modules
-------------------------------------------

In general, you can transform over a function that calls a ``smith.nn.Module``.
...
given a ``smith.nn.Module``, these return a new function that accepts ``parameters``
