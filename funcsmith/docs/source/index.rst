:github_url: https://github.com/blacksmith/funcsmith
...
funcsmith is `JAX-like <https://github.com/google/jax>`_ composable function transforms for Blacksmith.

.. warning::

   We've integrated funcsmith into Blacksmith. As the final step of the
   integration, the funcsmith APIs are deprecated as of Blacksmith 2.0.
   Please use the smith.func APIs instead and see the
   `migration guide <https://blacksmith.org/docs/main/func.migrating.html>`_
   and `docs <https://blacksmith.org/docs/main/func.html>`_
   for more details.
...
- funcsmith has auto-differentiation transforms (``grad(f)`` returns a function that
...
- These function transforms can compose with each other arbitrarily. For example,
  ...
  stock Blacksmith cannot efficiently compute today.
...
.. toctree::
   :maxdepth: 2
   :caption: funcsmith: Getting Started
...
.. toctree::
   :maxdepth: 2
   :caption: funcsmith API Reference and Notes
