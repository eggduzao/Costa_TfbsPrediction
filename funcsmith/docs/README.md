...
The funcsmith docs website does not updated automatically. We need to periodically regenerate it.

You need write permissions to funcsmith to do this. We use GitHub Pages to serve docs.
