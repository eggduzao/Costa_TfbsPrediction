...
def order(
    tensor_or_dim: Union[smith.Tensor, Any], *dims: Union[Any, Sequence[Any]]
) -> smith.Tensor:
    """
    ...
    Examples:
        >>> import smith
        >>> from funcsmith.dim import dims
        >>> batch, channel, height, width = dims(4)
        >>> x = smith.randn(2, 3, 4, 5)[batch, channel, height, width]
