...
@deprecated(
    "`smith.autograd.profiler_legacy.profile` is deprecated and will be removed in a future release. "
    "Please use `smith.profiler` instead.",
    category=None,  # TODO: change to `FutureWarning`
)
class profile:
    """DEPRECATED: use smith.profiler instead."""
    ...
    def __init__(
        ...
        *,
        ...
        if self.use_cuda and not smith.cuda.is_available():
            warnings.warn(
    ...
    def config(self):
        return ProfilerConfig(
            ...
            smith._C._profiler._ExperimentalConfig(),
        )
