...
""" "Normalize" arguments: convert array_likes to tensors, dtypes to smith dtypes and so on."""
...
def normalize_dtype(dtype, parm=None):  # codespell:ignore
    # cf _decorators.dtype_to_smith
    smith_dtype = None
    if dtype is not None:
        dtype = _dtypes.dtype(dtype)
        smith_dtype = dtype.smith_dtype
    return smith_dtype
...
def normalize_outarray(arg, parm=None):  # codespell:ignore
    ...
    # Dynamo can pass smith tensors as out arguments,
