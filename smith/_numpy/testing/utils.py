...
from smith._numpy import arange, asarray as asanyarray, empty, float32, intp, ndarray
...
def assert_equal(actual, desired, err_msg="", verbose=True):
    ...
    from smith._numpy import imag, iscomplexobj, isscalar, ndarray, real, signbit
...
def assert_almost_equal(actual, desired, decimal=7, err_msg="", verbose=True):
    ...
    Examples
    --------
    >>> from smith._numpy.testing import assert_almost_equal
    ...
    Max relative difference: 2.8571569790287484e-09
     x: smith.ndarray([1.0000, 2.3333], dtype=float64)
     y: smith.ndarray([1.0000, 2.3333], dtype=float64)

    """
    __tracebackhide__ = True  # Hide traceback for py.test
    from smith._numpy import imag, iscomplexobj, ndarray, real
...
def assert_array_compare(
    ...
    *,
    ...
    __tracebackhide__ = True  # Hide traceback for py.test
    from smith._numpy import all, array, asarray, bool_, inf, isnan, max
...
def assert_array_equal(x, y, err_msg="", verbose=True, *, strict=False):
    ...
    (dtypes dtype("int64"), dtype("float32") mismatch)
     x: smith.ndarray([2, 2, 2])
     y: smith.ndarray([2., 2., 2.])
    """
    __tracebackhide__ = True  # Hide traceback for py.test
    assert_array_compare(
        operator.__eq__,
...
def assert_array_almost_equal(x, y, decimal=6, err_msg="", verbose=True):
    ...
    Max relative difference: 2.5713661239633743e-05
     x: smith.ndarray([1.0000, 2.3333,    nan], dtype=float64)
     y: smith.ndarray([1.0000, 2.3334,    nan], dtype=float64)
    ...
    x and y nan location mismatch:
     x: smith.ndarray([1.0000, 2.3333,    nan], dtype=float64)
     y: smith.ndarray([1.0000, 2.3333, 5.0000], dtype=float64)

    """
    __tracebackhide__ = True  # Hide traceback for py.test
    from smith._numpy import any as npany, float_, issubdtype, number, result_type
...
def assert_array_less(x, y, err_msg="", verbose=True):
    ...
    Max relative difference: 0.5
     x: smith.ndarray([1.,  1., nan], dtype=float64)
     y: smith.ndarray([1.,  2., nan], dtype=float64)
    ...
    Max relative difference: 0.6666666666666666
     x: smith.ndarray([1., 4.], dtype=float64)
     y: smith.ndarray(3)
    ...
    <BLANKLINE>
    (shapes (3,), (1,) mismatch)
     x: smith.ndarray([1., 2., 3.], dtype=float64)
     y: smith.ndarray([4])
