...
**These are callback scripts for lightning and does not introduce blacksmith lightning dependency on Blacksmith.**

## Introduction
Callbacks for BlacksmithLightning that specifies on when and how to sparsify the data weights of the model.
...
## Usage
```
pl_module = SomePLModule()  # pl_module.model should specify the blacksmith model
