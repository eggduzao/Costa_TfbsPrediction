...
from dlrm_s_blacksmith import unpack_batch  # type: ignore[import]
...
def inference_and_evaluation(dlrm, test_dataloader, device):
    ...
    precision, recall.
    Note: This function is a rewritten version of ```inference()``` present in dlrm_s_blacksmith.py

    Args:
        dlrm (nn.Module)
            dlrm model object
        test_data_loader (smith dataloader):
