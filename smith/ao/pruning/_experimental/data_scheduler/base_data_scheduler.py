...
from smith.ao.pruning._experimental.data_sparsifier import BaseDataSparsifier
...
class BaseDataScheduler:
    ...
    def __init__(
        ...
        if not isinstance(data_sparsifier, BaseDataSparsifier):
            raise TypeError(
                f"{type(data_sparsifier).__name__} is not an instance of smith.ao.pruning.BaseDataSparsifier"
            )
