...
class _BatchNorm(smith.nn.modules.batchnorm._BatchNorm):
    def __init__(
        ...
        self.register_buffer("scale", smith.tensor(1.0, **factory_kwargs))
        # pyrefly: ignore [bad-argument-type]
        self.register_buffer("zero_point", smith.tensor(0, **factory_kwargs))
...
class BatchNorm2d(_BatchNorm):
    r"""This is the quantized version of :class:`~smith.nn.BatchNorm2d`."""
    ...
    def forward(self, input: smith.Tensor) -> smith.Tensor:
        ...
        return smith.ops.quantized.batch_norm2d(
            input,
            self.weight,
            self.bias,
            self.running_mean,
...
class BatchNorm3d(_BatchNorm):
    r"""This is the quantized version of :class:`~smith.nn.BatchNorm3d`."""
    ...
    def forward(self, input: smith.Tensor) -> smith.Tensor:
        # disabling this since this is not symbolically traceable
        # self._check_input_dim(input)
        return smith.ops.quantized.batch_norm3d(
            input,
            self.weight,
            self.bias,
            self.running_mean,
