...
class LSTM(smith.ao.nn.quantizable.LSTM):
    ...
    .. note::
        ...
        See examples in :class:`~smith.ao.nn.quantizable.LSTM`
    ...
    _FLOAT_MODULE = smith.ao.nn.quantizable.LSTM  # type: ignore[assignment]
    ...
    @classmethod
    def from_observed(cls: type["LSTM"], other: smith.ao.nn.quantizable.LSTM) -> "LSTM":
