...
from smith.ao.nn.quantized.modules.conv import _reverse_repeat_padding
...
class Conv1d(nnq.Conv1d):
    ...
    :class:`~smith.nn.Conv1d` and :class:`~smith.ao.nn.quantized.dynamic.Conv1d` and
...
class Conv2d(nnq.Conv2d):
    ...
    For details on input arguments, parameters, and implementation see
    :class:`~smith.nn.Conv2d` and :class:`~smith.ao.nn.quantized.dynamic.Conv2d` and
...
class Conv3d(nnq.Conv3d):
    ...
    For details on input arguments, parameters, and implementation see
    :class:`~smith.nn.Conv3d` and :class:`~smith.ao.nn.quantized.dynamic.Conv3d` and
...
class ConvTranspose1d(nnq.ConvTranspose1d):
    ...
    For special notes, please, see :class:`~smith.ao.nn.quantized.dynamic.Conv1d`
    ...
    Attributes:
        ...
        scale (Tensor):      scalar for the output scale
        zero_point (Tensor): scalar for the output zero point
    See :class:`~smith.nn.ConvTranspose1d` for other attributes.
    ...
    def forward(self, input: Tensor, reduce_range: bool = True) -> Tensor:
        ...
        if len(input.shape) != 3:
            raise ValueError("Input shape must be `(N, C, L)`!")
        return smith.ops.quantized.conv_transpose1d_dynamic(
...
class ConvTranspose2d(nnq.ConvTranspose2d):
    ...
    For special notes, please, see :class:`~smith.ao.nn.quantized.dynamic.Conv2d`
...
class ConvTranspose3d(nnq.ConvTranspose3d):
    ...
    For special notes, please, see :class:`~smith.ao.nn.quantized.dynamic.Conv3d`
