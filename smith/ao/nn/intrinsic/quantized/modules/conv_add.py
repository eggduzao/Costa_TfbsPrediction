...
class ConvAdd2d(nnq.Conv2d):
    ...
    _FLOAT_MODULE = smith.ao.nn.intrinsic.ConvAdd2d  # type: ignore[assignment]
    ...
    def forward(self, input, extra_input):  # type: ignore[override]
        ...
        return smith.ops.quantized.conv2d_add(
...
class ConvAddReLU2d(nnq.Conv2d):
    ...
    _FLOAT_MODULE = smith.ao.nn.intrinsic.ConvAddReLU2d  # type: ignore[assignment]
    ...
    def forward(self, input, extra_input):  # type: ignore[override]
        ...
        return smith.ops.quantized.conv2d_add_relu(
            input, extra_input, self._packed_params, self.scale, self.zero_point
        )
