...
class BNReLU2d(nnq.BatchNorm2d):
    ...
    We adopt the same interface as :class:`smith.ao.nn.quantized.BatchNorm2d`.

    Attributes:
        Same as smith.ao.nn.quantized.BatchNorm2d

    """

    _FLOAT_MODULE = smith.ao.nn.intrinsic.BNReLU2d
    ...
    def forward(self, input):
        ...
        return smith.ops.quantized.batch_norm2d_relu(
            input,
            self.weight,
            self.bias,
            self.running_mean,
...
class BNReLU3d(nnq.BatchNorm3d):
    ...
    We adopt the same interface as :class:`smith.ao.nn.quantized.BatchNorm3d`.

    Attributes:
        Same as smith.ao.nn.quantized.BatchNorm3d

    """

    _FLOAT_MODULE = smith.ao.nn.intrinsic.BNReLU3d
    ...
    def forward(self, input):
        ...
        return smith.ops.quantized.batch_norm3d_relu(
            input,
            self.weight,
            self.bias,
            self.running_mean,
