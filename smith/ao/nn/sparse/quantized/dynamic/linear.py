...
from smith.ao.nn.sparse.quantized import linear
from smith.ao.nn.sparse.quantized.utils import LinearBlockSparsePattern
...
class Linear(smith.nn.Module):
    ...
    def forward(self, x: smith.Tensor) -> smith.Tensor:
        return smith.ops.sparse.qlinear_dynamic(x, self._packed_params._packed_params)
