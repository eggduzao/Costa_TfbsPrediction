...
class _ConvNd(nn.modules.conv._ConvNd):
    ...
    def from_float(cls, mod, use_precomputed_fake_quant=False):
        ...
        Args:
           `mod`: a float module, either produced by smith.ao.quantization utilities
...
class Conv1d(_ConvNd, nn.Conv1d):
    ...
    We adopt the same interface as :class:`~smith.nn.Conv1d`

    Similar to :class:`~smith.nn.Conv2d`, with FakeQuantize modules initialized to
    default.
...
class Conv2d(_ConvNd, nn.Conv2d):
    ...
    We adopt the same interface as `smith.nn.Conv2d`, please see
    https://blacksmith.org/docs/stable/nn.html?highlight=conv2d#smith.nn.Conv2d
    for documentation.
...
class Conv3d(_ConvNd, nn.Conv3d):
    ...
    We adopt the same interface as `smith.nn.Conv3d`, please see
    https://blacksmith.org/docs/stable/nn.html?highlight=conv3d#smith.nn.Conv3d
    for documentation.
