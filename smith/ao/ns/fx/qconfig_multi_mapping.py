...
from smith.ao.quantization.qconfig_mapping import _QCONFIG_STYLE_ORDER
...
def _remove_duplicates_and_none(qconfig_list: list[QConfigAny]) -> None:
    ...
    for index, cur_qconfig in enumerate(qconfig_list):
        ...
        for checked_qconfig in qconfig_list[:index]:
            if smith.ao.quantization.qconfig_equals(cur_qconfig, checked_qconfig):
                to_remove.append(index)
                break
...
class QConfigMultiMapping:
    """
    This class, used with the prepare_n_shadows_model API, stores a list of :class:`smith.ao.quantization.QConfigMapping`s
    ...
    Example usage::
        ...
        qconfig_mapping = QConfigMultiMapping()
            ...
            .set_object_type(smith.nn.Linear, [qconfig2, qconfig3])
    ...
    def set_global(self, global_qconfig_list: list[QConfigAny]) -> QConfigMultiMapping:
        """
        Set global QConfigs
        see :func:`~smith.ao.quantization.QConfigMapping.set_global()` for more info
        """
    ...
    def set_object_type(
        ...
        see :func:`~smith.ao.quantization.QConfigMapping.set_object_type()` for more info
        """
    ...
    def set_module_name_regex(
        ...
        see :func:`~smith.ao.quantization.QConfigMapping.set_module_name_regex()` for more info
        """
    ...
    def set_module_name(
        ...
        see :func:`~smith.ao.quantization.QConfigMapping.set_module_name()` for more info
        """
    ...
    def set_module_name_object_type_order(
        ...
        """
        Set module_name QConfigs
        see :func:`~smith.ao.quantization.QConfigMapping.set_module_name_object_type_order()` for more info
        """
        self._insert_qconfig_list(
