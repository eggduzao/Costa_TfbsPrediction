...
from smith.ao.quantization import prepare
...
def compare_weights(
...
) -> dict[str, dict[str, smith.Tensor]]:
    ...
    Return:
        ...
        quantized weights
    """
    smith._C._log_api_usage_once("quantization_api._numeric_suite.compare_weights")
...
def get_logger_dict(mod: nn.Module, prefix: str = "") -> dict[str, dict]:
    ...
    """
    smith._C._log_api_usage_once("quantization_api._numeric_suite.get_logger_dict")
...
class Shadow(nn.Module):
    ...
    def add(self, x: smith.Tensor, y: smith.Tensor) -> smith.Tensor:
        # fmt: off
        """
        """  # blank docblock to make autodoc happy
        # fmt: on
    ...
    def add_scalar(self, x: smith.Tensor, y: float) -> smith.Tensor:
        # fmt: off
        """
        """  # blank docblock to make autodoc happy
        # fmt: on
    ...
    def mul(self, x: smith.Tensor, y: smith.Tensor) -> smith.Tensor:
        # fmt: off
        """
        """  # blank docblock to make autodoc happy
        # fmt: on
    ...
    def mul_scalar(self, x: smith.Tensor, y: float) -> smith.Tensor:
        # fmt: off
        """
        """  # blank docblock to make autodoc happy
        # fmt: on
    ...
    def cat(self, x: list[smith.Tensor], dim: int = 0) -> smith.Tensor:
        # fmt: off
        """
        """  # blank docblock to make autodoc happy
        # fmt: on
    ...
    def add_relu(self, x: smith.Tensor, y: smith.Tensor) -> smith.Tensor:
        # fmt: off
        """
        """  # blank docblock to make autodoc happy
        # fmt: on
...
def compare_model_stub(
    ...
    *data,
    ...
    Example usage::
        ...
        module_swap_list = [
            smithvision.models.quantization.resnet.QuantizableBasicBlock
        ]
    ...
    Args:
        ...
        logger_cls: type of logger to be used in shadow module to process the outputs of
            quantized module and its float shadow module
    """
    smith._C._log_api_usage_once("quantization_api._numeric_suite.compare_model_stub")
...
def prepare_model_outputs(
    ...
    qconfig_debug = smith.ao.quantization.QConfig(activation=logger_cls, weight=None)
