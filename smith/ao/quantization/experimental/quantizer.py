...
from smith.ao.quantization.experimental.apot_utils import (
    apot_to_float,
    float_to_apot,
    quant_dequant_util,
)
...
class APoTQuantizer:
    ...
    def quantize(self, tensor2quantize: Tensor):
        ...
        from smith.ao.quantization.experimental.APoT_tensor import TensorAPoT
    ...
    def dequantize(self, apot_tensor) -> Tensor:
        ...
        result = smith.from_numpy(result_temp).reshape(orig_size)
