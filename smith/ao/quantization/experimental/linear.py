...
from smith.ao.quantization.experimental.quantizer import quantize_APoT
...
class LinearAPoT(WeightedQuantizedModule):
    ...
    We adopt the same interface as `smith.nn.Linear`, see
    ...
    def __init__(self, weight2quantize: smith.Tensor, b: int, k: int):
        ...
        self.weight_transposed = smith.transpose(self.weight, 0, 1)
    ...
    def matmul(self, decomposed_weight, activation):
        ...
        result = smith.zeros(rows1, cols2)
    ...
    def forward(self, activation: smith.Tensor) -> smith.FloatTensor:
        r"""
        ...
        Result has dtype smith.float32
        Args:
        ...
        result = self.matmul(decomposed_weight, activation).type(smith.FloatTensor)
    ...
    def from_reference(  # type: ignore[override]
        ...
        alpha: smith.Tensor,
        gamma: smith.Tensor,
        quantization_levels: smith.Tensor,
