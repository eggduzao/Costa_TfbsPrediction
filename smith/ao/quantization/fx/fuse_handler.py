...
from smith.ao.quantization.fuser_method_mappings import get_fuser_method_new
from smith.ao.quantization.utils import _parent_name, NodePattern, Pattern
...
class FuseHandler(ABC):
    ...
    def fuse(
        ...
        fuser_method_mapping: dict[Pattern, smith.nn.Sequential | Callable],
        is_qat: bool,
    ) -> Node:
        pass
    ...
    def fuse(
        ...
        def get_modules(pattern):
            ...
            if isinstance(pattern, (tuple, list)):
                ...
                elif n.op == "call_function" and n.target is smith.nn.functional.relu:
                    relu = smith.nn.ReLU()
