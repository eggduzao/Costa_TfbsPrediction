...
from smith.ao.quantization.fake_quantize import FixedQParamsFakeQuantize
...
# e.g. smith.sigmoid -> default_affine_fixed_qparam_fake_quant
...
# @_register_fusion_pattern(smith.nn.ReLU, (smith.nn.BatchNorm2d, smith.nn.Conv2d)))
