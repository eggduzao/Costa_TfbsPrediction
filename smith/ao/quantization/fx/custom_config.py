...
from smith.ao.quantization.quant_type import (
...
class PrepareCustomConfig:
    """
    Custom configuration for :func:`~smith.ao.quantization.quantize_fx.prepare_fx` and
    :func:`~smith.ao.quantization.quantize_fx.prepare_qat_fx`.
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        :func:`~smith.ao.quantization.fx.custom_config.PrepareCustomConfig.from_dict`.
        """
...
class ConvertCustomConfig:
    """
    Custom configuration for :func:`~smith.ao.quantization.quantize_fx.convert_fx`.
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        :func:`~smith.ao.quantization.fx.custom_config.ConvertCustomConfig.from_dict`.
        """
        d: dict[str, Any] = {}
        for (
            quant_type,
...
class FuseCustomConfig:
    """
    Custom configuration for :func:`~smith.ao.quantization.quantize_fx.fuse_fx`.
