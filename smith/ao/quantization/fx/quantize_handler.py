...
from smith.ao.quantization.utils import NodePattern, Pattern, QuantizerCls
...
# TODO: remove this class, this is still exposed in smith.ao.quantization
...
# TODO: not used, can be removed after smith.ao.quantization namespace is deprecated
