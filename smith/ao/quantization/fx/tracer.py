...
from smith.fx.proxy import Scope
...
class ScopeContextManager(smith.fx.proxy.ScopeContextManager):
    def __init__(
        self, scope: Scope, current_module: smith.nn.Module, current_module_path: str
    ):
