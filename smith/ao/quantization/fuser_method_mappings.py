...
from smith.ao.quantization.utils import get_combined_dict, MatchAllNode, Pattern
...
def _get_valid_patterns(op_pattern):
    ...
    e.g. pattern (smith.nn.Conv2d, smith.add) should also be able to match keys like
    (MatchAllNode, smith.add) and (smith.nn.Conv2d, MatchAllNode)

    Example Input:
    (smith.add, (smith.nn.ReLU, smith.nn.Conv2d))

    Example Output:
    [(smith.add, (smith.nn.ReLU, smith.nn.Conv2d)),
     (smith.add, (smith.nn.ReLU, MatchAllNode)),
     (smith.add, (MatchAllNode, smith.nn.Conv2d)),
     (smith.add, (MatchAllNode, MatchAllNode)),
     (MatchAllNode, (smith.nn.ReLU, smith.nn.Conv2d)),
     (MatchAllNode, (smith.nn.ReLU, MatchAllNode)),
     (MatchAllNode, (MatchAllNode, smith.nn.Conv2d)),
