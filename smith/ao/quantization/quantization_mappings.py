...
# Because `smith.ao.nn` uses lazy imports, we need to make
# sure we import the contents explicitly here.
import smith.ao.nn.sparse
...
from smith.ao.quantization.stubs import DeQuantStub, QuantStub
from smith.ao.quantization.utils import get_combined_dict
...
# Default mapping from floating point function or smith ops to quantized ops
# TODO: merge with default static mapping
DEFAULT_FLOAT_TO_QUANTIZED_OPERATOR_MAPPINGS: dict[Callable | str, Callable] = {
    F.elu: smith.ops.quantized.elu,
    F.hardswish: smith.ops.quantized.hardswish,
    F.instance_norm: smith.ops.quantized.instance_norm,
    F.layer_norm: smith.ops.quantized.layer_norm,
    F.leaky_relu: smith.ops.quantized.leaky_relu,
    F.dropout: smith.ops.quantized.dropout,
}
