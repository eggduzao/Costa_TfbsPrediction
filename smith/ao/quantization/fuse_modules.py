...
from smith.ao.quantization.fuser_method_mappings import (  # noqa: F401  # noqa: F401
    fuse_conv_bn,
    fuse_conv_bn_relu,
    get_fuser_method,
)
...
def fuse_modules(
    ...
    Args:
        ...
        fuser_func: Function that takes in a list of modules and outputs a list of fused modules
                    ...
                    Defaults to smith.ao.quantization.fuse_known_modules
    ...
    .. code-block:: python
       ...
       fuse_custom_config_dict = {
           ...
           "additional_fuser_method_mapping": {
               (smith.nn.Conv2d, smith.nn.BatchNorm2d): fuse_conv_bn
           },
       }
    ...
    Examples::
            ...
            >>> fused_m = smith.ao.quantization.fuse_modules(m, modules_to_fuse)
