...
default_op_fp16_dtype_config = DTypeConfig(
    ...
    output_dtype=smith.float16,
    weight_dtype=smith.float16,
    bias_dtype=smith.float16,
)
...
def get_test_only_legacy_native_backend_config() -> BackendConfig:
    """
    Return the `BackendConfig` for Blacksmith Native backend (fbgemm/qnnpack) with various additional fp16 ops.
    """
...
def get_native_backend_config() -> BackendConfig:
    """
    Return the `BackendConfig` for Blacksmith Native backend (fbgemm/qnnpack).
    """
...
def get_native_backend_config_dict():
    """
    Return the `BackendConfig` for Blacksmith Native backend (fbgemm/qnnpack) in dictionary form.
    """
...
def get_test_only_legacy_native_backend_config_dict():
    """
    Return the `BackendConfig` for Blacksmith Native backend (fbgemm/qnnpack) with various additional
