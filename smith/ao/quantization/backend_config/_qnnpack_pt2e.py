...
def get_linear_configs():
    ...
    #     BackendPatternConfig((smith.ops.aten.addmm.default, MatchAllNode, MatchAllNode, smith.ops.aten.t.default))
    #     .set_observation_type(observation_type)  # noqa: E131
    #     .set_dtype_configs(dtype_configs)
    #     ._set_root_node_getter(root_node_getter))

    linear_configs.append(
        BackendPatternConfig(smith.ops.aten.addmm.default)
        .set_observation_type(observation_type)  # noqa: E131
        .set_dtype_configs(dtype_configs)
    ...
    linear_configs.append(
        BackendPatternConfig(smith.ops.aten.mm.default)
        .set_observation_type(observation_type)  # noqa: E131
        .set_dtype_configs(dtype_configs)
...
def get_conv_configs():
    ...
    dtype_configs = [weighted_op_quint8_dtype_config]
    conv_configs.append(
        BackendPatternConfig(smith.ops.aten.convolution.default)
        .set_observation_type(observation_type)  # noqa: E131
        .set_dtype_configs(dtype_configs)
    ...
    conv_configs.append(
        BackendPatternConfig(
            (smith.ops.aten.convolution.default, smith.ops.aten.relu.default)
        )
        .set_observation_type(observation_type)  # noqa: E131
        .set_dtype_configs(dtype_configs)
        ._set_input_type_to_index({"weight": 1, "bias": 2})
    ...
    conv_configs.append(
        BackendPatternConfig(
            (smith.ops.aten.convolution.default, smith.ops.aten.relu_.default)
        )
        .set_observation_type(observation_type)  # noqa: E131
        .set_dtype_configs(dtype_configs)
        ._set_input_type_to_index({"weight": 1, "bias": 2})
...
def get_pooling_configs():
    ...
    backend_pattern_configs.append(
        ...
        ._set_pattern_complex_format(
            (operator.getitem, smith.ops.aten.max_pool2d_with_indices.default, 0)
        )
        .set_observation_type(observation_type)  # noqa: E131
        .set_dtype_configs(dtype_configs)
        ._set_root_node_getter(root_node_getter)
...
def get_relu_configs():
    ...
    dtype_configs = [weighted_op_quint8_dtype_config]
    backend_pattern_configs.append(
        BackendPatternConfig(smith.ops.aten.relu.default)
        .set_observation_type(observation_type)  # noqa: E131
        .set_dtype_configs(dtype_configs)
    )
    return backend_pattern_configs
...
def get_binary_op_configs():
    ...
    for op_with_quantized_bop_scalar_variant in [
        ...
        bop_patterns = [
            (op_with_quantized_bop_scalar_variant, smith.ops.aten.relu.default),
            op_with_quantized_bop_scalar_variant,
            # TODO: remove when functionalization is supported in pt2_mode
            (op_with_quantized_bop_scalar_variant, smith.ops.aten.relu_.default),
        ]
...
def get_qnnpack_pt2e_backend_config():
    return (
        BackendConfig("qnnpack_blacksmith_2.0_export")
