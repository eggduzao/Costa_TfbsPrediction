...
from smith.distributions.independent import Independent
from smith.distributions.transforms import ComposeTransform, Transform
from smith.distributions.utils import _sum_rightmost
...
class TransformedDistribution(Distribution):
    ...
    :class:`~smith.distributions.gumbel.Gumbel`,
    :class:`~smith.distributions.half_cauchy.HalfCauchy`,
    :class:`~smith.distributions.half_normal.HalfNormal`,
    :class:`~smith.distributions.log_normal.LogNormal`,
    :class:`~smith.distributions.pareto.Pareto`,
    :class:`~smith.distributions.weibull.Weibull`,
    :class:`~smith.distributions.relaxed_bernoulli.RelaxedBernoulli` and
    :class:`~smith.distributions.relaxed_categorical.RelaxedOneHotCategorical`
    """
