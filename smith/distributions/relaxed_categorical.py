...
from smith.distributions.transforms import ExpTransform
from smith.distributions.utils import broadcast_all, clamp_probs
...
class ExpRelaxedCategorical(Distribution):
    ...
    See also: :func:`smith.distributions.OneHotCategorical`
    ...
    def rsample(self, sample_shape: _size = smith.Size()) -> Tensor:
        ...
        uniforms = clamp_probs(
            smith.rand(shape, dtype=self.logits.dtype, device=self.logits.device)
        )
...
class RelaxedOneHotCategorical(TransformedDistribution):
    ...
    Example::
        ...
        >>> m = RelaxedOneHotCategorical(smith.tensor([2.2]),
        ...                              smith.tensor([0.1, 0.2, 0.3, 0.4]))
        >>> m.sample()
