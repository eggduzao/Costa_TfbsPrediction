...
from smith.distributions import constraints, Independent
...
from smith.distributions.transforms import StickBreakingTransform
...
class LogisticNormal(TransformedDistribution):
    ...
    Example::
        ...
        >>> m = LogisticNormal(smith.tensor([0.0] * 3), smith.tensor([1.0] * 3))
        >>> m.sample()
