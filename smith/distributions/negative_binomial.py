...
class NegativeBinomial(Distribution):
    ...
    def mean(self) -> Tensor:
        return self.total_count * smith.exp(self.logits)
    ...
    def variance(self) -> Tensor:
        return self.mean / smith.sigmoid(-self.logits)
    ...
    def log_prob(self, value):
        ...
        log_normalization = (
            -smith.lgamma(self.total_count + value)
            + smith.lgamma(1.0 + value)
            + smith.lgamma(self.total_count)
        )
