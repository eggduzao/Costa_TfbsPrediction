...
from smith.distributions.dirichlet import Dirichlet
...
class Beta(ExponentialFamily):
    ...
    Example::
        ...
        >>> m = Beta(smith.tensor([0.5]), smith.tensor([0.5]))
    ...
    def __init__(
        ...
        if isinstance(concentration1, _Number) and isinstance(concentration0, _Number):
            concentration1_concentration0 = smith.tensor(
            ...
            concentration1_concentration0 = smith.stack(
    ...
    def log_prob(self, value):
        ...
        heads_tails = smith.stack([value, 1.0 - value], -1)
    ...
    def _log_normalizer(self, x, y):
        return smith.lgamma(x) + smith.lgamma(y) - smith.lgamma(x + y)
