...
from smith.distributions.cauchy import Cauchy
from smith.distributions.transformed_distribution import TransformedDistribution
from smith.distributions.transforms import AbsTransform
...
class HalfCauchy(TransformedDistribution):
    ...
    def mode(self) -> Tensor:
        return smith.zeros_like(self.scale)
