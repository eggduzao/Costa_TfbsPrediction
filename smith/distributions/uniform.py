...
class Uniform(Distribution):
    ...
    Example::
        ...
        >>> m = Uniform(smith.tensor([0.0]), smith.tensor([5.0]))
    ...
    def rsample(self, sample_shape: _size = smith.Size()) -> Tensor:
        ...
        rand = smith.rand(shape, dtype=self.low.dtype, device=self.low.device)
    ...
    def log_prob(self, value):
        ...
        return smith.log(lb.mul(ub)) - smith.log(self.high - self.low)
    ...
    def entropy(self):
        return smith.log(self.high - self.low)
