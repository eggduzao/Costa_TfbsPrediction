...
parameters, we only need :meth:`~smith.distributions.Distribution.sample` and
:meth:`~smith.distributions.Distribution.log_prob` to implement REINFORCE:
...
:meth:`~smith.distributions.Distribution.rsample` method, where the
