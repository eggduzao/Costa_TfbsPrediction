...
class Distribution:
    ...
    Args:
        batch_shape (smith.Size): The shape over which parameters are batched.
        event_shape (smith.Size): The shape of a single sample (without batching).
    ...
    def __init__(
        self,
        batch_shape: smith.Size = smith.Size(),
        event_shape: smith.Size = smith.Size(),
        ...
        if self._validate_args:
            ...
            for param, constraint in arg_constraints.items():
                ...
                if not smith._is_all_true(valid):
                    raise ValueError(
    ...
    def expand(self, batch_shape: _size, _instance=None):
        ...
        `batch_shape`. This method calls :class:`~smith.Tensor.expand` on
        ...
        Args:
            batch_shape (smith.Size): the desired expanded size.
    ...
    @property
    def batch_shape(self) -> smith.Size:
        """
    ...
    @property
    def event_shape(self) -> smith.Size:
        """
    ...
    def arg_constraints(self) -> dict[str, constraints.Constraint]:
        ...
        :class:`~smith.distributions.constraints.Constraint` objects that
    ...
    def support(self) -> constraints.Constraint | None:
        """
        Returns a :class:`~smith.distributions.constraints.Constraint` object
    ...
    def sample(self, sample_shape: _size = smith.Size()) -> Tensor:
        """
    ...
    def sample_n(self, n: int) -> Tensor:
        ...
        """
        return self.sample(smith.Size((n,)))
    ...
    def perplexity(self) -> Tensor:
        ...
        Returns:
            Tensor of shape batch_shape.
        """
        return smith.exp(self.entropy())

    def _extended_shape(self, sample_shape: _size = smith.Size()) -> smith.Size:
        """
        ...
        Args:
            sample_shape (smith.Size): the size of the sample to be drawn.
        """
        if not isinstance(sample_shape, smith.Size):
            sample_shape = smith.Size(sample_shape)
        return smith.Size(sample_shape + self._batch_shape + self._event_shape)
