...
def annotate(val, type):
    ...
    This function annotates a val with a given type if a type of the val is a smith.fx.Proxy object
    Args:
        val (object): An object to be annotated if its type is smith.fx.Proxy.
