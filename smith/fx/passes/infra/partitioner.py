...
from smith.fx.node import _get_qualified_name, Node
from smith.fx.passes.operator_support import OperatorSupportBase
...
class CapabilityBasedPartitioner:
    ...
    def propose_partitions(self) -> list[Partition]:
        ...
        if not self.allows_single_node_partition:
            ...
            default_non_compute_ops = {"smith.ops.aten.view", "_operator.getitem"}
