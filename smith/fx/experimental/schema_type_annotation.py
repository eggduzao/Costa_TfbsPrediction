...
from smith.fx import Transformer
from smith.fx.node import Argument, Target
from smith.fx.operator_schemas import _smithscript_type_to_python_type
...
class AnnotateTypesWithSchema(Transformer):
    ...
    This pulls out Python function signatures for:
        ...
        1. Standard `smith.nn` Module calls
        2. `smith.nn.functional` calls
    ...
    def call_function(
        ...
        if self.annotate_functionals and target.__module__ == "smith.nn.functional":
            ...
            if target in boolean_dispatched:
                ...
                # TODO: can we emit the union of these? What are the implications on SmithScript
                # compilation?
                if (
    ...
    def get_attr(
        ...
        if self.annotate_get_attrs:
            ...
            maybe_inferred_ts_type = smith._C._jit_try_infer_type(module_itr)
            if maybe_inferred_ts_type.success():
                python_type = _smithscript_type_to_python_type(
