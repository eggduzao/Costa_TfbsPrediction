...
from smith.fx.node import map_arg, Node
from smith.fx.passes.graph_manipulation import get_size_of_all_nodes
...
class Partitioner:
    ...
    def partition_graph(
        ...
        smith_module: smith.nn.Module,
        partitioner_config: PartitionerConfig,
    ) -> PartitionResult:
        """Given the fx module, smith module and partitioner_config,
        ...
        self.smith_module = smith_module
