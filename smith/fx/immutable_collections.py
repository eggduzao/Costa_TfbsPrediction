...
_help_mutation = """
If you are attempting to modify the kwargs or args of a smith.fx.Node object,
...
register_pytree_node(
    ...
    serialized_type_name="smith.fx.immutable_collections.immutable_list",
...
register_pytree_node(
    ...
    serialized_type_name="smith.fx.immutable_collections.immutable_dict",
