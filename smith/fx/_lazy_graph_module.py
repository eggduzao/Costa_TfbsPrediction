...
from smith.fx.graph_module import (
    _format_import_block,
    GraphModule,
    reduce_graph_module,
    reduce_package_graph_module,
)
from smith.package import PackageExporter, sys_importer
...
def _force_skip_lazy_graph_module():
    ...
    Use to skip _LazyGraphModule when testing inductor smithscript related backend.

    smith.jit.script a _LazyGraphModule results in following error:
