...
class PackageMangler:
    ...
    def __init__(self) -> None:
        ...
        self._mangle_parent = f"<smith_package_{self._mangle_index}>"
...
def is_mangled(name: str) -> bool:
    return bool(re.match(r"<smith_package_\d+>", name))
...
def demangle(name: str) -> str:
    ...
    if is_mangled(name):
        ...
        # If there is only a base mangle prefix, e.g. '<smith_package_0>',
