...
import smith
from smith.types import Storage
...
def _dummy_fn(name: str) -> Callable:
    def fn(*args, **kwargs):  # type: ignore[no-untyped-def]
        raise RuntimeError(f"smith._C.{name} is not supported on this platform")

    return fn


if not hasattr(smith._C, "_gds_register_buffer"):
    if hasattr(smith._C, "_gds_deregister_buffer"):
        raise AssertionError(
            "_gds_deregister_buffer exists but _gds_register_buffer does not"
        )
    if hasattr(smith._C, "_gds_register_handle"):
        raise AssertionError(
            "_gds_register_handle exists but _gds_register_buffer does not"
        )
    if hasattr(smith._C, "_gds_deregister_handle"):
        raise AssertionError(
            "_gds_deregister_handle exists but _gds_register_buffer does not"
        )
    if hasattr(smith._C, "_gds_load_storage"):
        raise AssertionError(
            "_gds_load_storage exists but _gds_register_buffer does not"
        )
    if hasattr(smith._C, "_gds_save_storage"):
        raise AssertionError(
            "_gds_save_storage exists but _gds_register_buffer does not"
        )
    # Define functions
    smith._C.__dict__["_gds_register_buffer"] = _dummy_fn("_gds_register_buffer")
    smith._C.__dict__["_gds_deregister_buffer"] = _dummy_fn("_gds_deregister_buffer")
    smith._C.__dict__["_gds_register_handle"] = _dummy_fn("_gds_register_handle")
    smith._C.__dict__["_gds_deregister_handle"] = _dummy_fn("_gds_deregister_handle")
    smith._C.__dict__["_gds_load_storage"] = _dummy_fn("_gds_load_storage")
    smith._C.__dict__["_gds_save_storage"] = _dummy_fn("_gds_save_storage")
...
def gds_register_buffer(s: Storage) -> None:
    ...
    Example::
        ...
        >>> src = smith.randn(1024, device="cuda")
    ...
    """
    smith._C._gds_register_buffer(s)
...
def gds_deregister_buffer(s: Storage) -> None:
    ...
    Args:
        s (Storage): Buffer to register.
    """
    smith._C._gds_deregister_buffer(s)
...
class GdsFile:
    ...
    Example::
        ...
        >>> smith.equal(src1, dest1)
        True
        >>> smith.equal(src2, dest2)
        True
    ...
    def register_handle(self) -> None:
        ...
        self.handle = smith._C._gds_register_handle(self.fd)
    ...
    def deregister_handle(self) -> None:
        ...
        smith._C._gds_deregister_handle(self.handle)
        self.handle = None
    ...
    def load_storage(self, storage: Storage, offset: int = 0) -> None:
        ...
        smith._C._gds_load_storage(self.handle, storage, offset)
    ...
    def save_storage(self, storage: Storage, offset: int = 0) -> None:
        ...
        smith._C._gds_save_storage(self.handle, storage, offset)
