...
@deprecated(
    "`smith.cpu.amp.autocast(args...)` is deprecated. "
    "Please use `smith.amp.autocast('cpu', args...)` instead.",
    category=FutureWarning,
)
class autocast(smith.amp.autocast_mode.autocast):
    r"""
    See :class:`smith.autocast`.
    ``smith.cpu.amp.autocast(args...)`` is deprecated. Please use ``smith.amp.autocast("cpu", args...)`` instead.
    """
