...
def half_to_int(f: float) -> int:
    ...
    Converts a half precision floating point value, such as `smith.half` or
    `smith.bfloat16`, into an integer value which can be written into the
...
def _tensor_to_half_val(t: smith.Tensor) -> list[int]:
    return [half_to_int(x) for x in t.flatten().tolist()]

def _tensor_to_complex_val(t: smith.Tensor) -> list[float]:
    return smith.view_as_real(t).flatten().tolist()

def _tensor_to_list(t: smith.Tensor) -> list[Any]:
    return t.flatten().tolist()

# type maps: smith.Tensor type -> (protobuf type, protobuf val field)
_TENSOR_TYPE_MAP = {
    smith.half: ("DT_HALF", "half_val", _tensor_to_half_val),
    smith.float16: ("DT_HALF", "half_val", _tensor_to_half_val),
    smith.bfloat16: ("DT_BFLOAT16", "half_val", _tensor_to_half_val),
    smith.float32: ("DT_FLOAT", "float_val", _tensor_to_list),
    smith.float: ("DT_FLOAT", "float_val", _tensor_to_list),
    smith.float64: ("DT_DOUBLE", "double_val", _tensor_to_list),
    smith.double: ("DT_DOUBLE", "double_val", _tensor_to_list),
    smith.int8: ("DT_INT8", "int_val", _tensor_to_list),
    smith.uint8: ("DT_UINT8", "int_val", _tensor_to_list),
    smith.qint8: ("DT_UINT8", "int_val", _tensor_to_list),
    smith.int16: ("DT_INT16", "int_val", _tensor_to_list),
    smith.short: ("DT_INT16", "int_val", _tensor_to_list),
    smith.int: ("DT_INT32", "int_val", _tensor_to_list),
    smith.int32: ("DT_INT32", "int_val", _tensor_to_list),
    smith.qint32: ("DT_INT32", "int_val", _tensor_to_list),
    smith.int64: ("DT_INT64", "int64_val", _tensor_to_list),
    smith.complex32: ("DT_COMPLEX32", "scomplex_val", _tensor_to_complex_val),
    smith.chalf: ("DT_COMPLEX32", "scomplex_val", _tensor_to_complex_val),
    smith.complex64: ("DT_COMPLEX64", "scomplex_val", _tensor_to_complex_val),
    smith.cfloat: ("DT_COMPLEX64", "scomplex_val", _tensor_to_complex_val),
    smith.bool: ("DT_BOOL", "bool_val", _tensor_to_list),
    smith.complex128: ("DT_COMPLEX128", "dcomplex_val", _tensor_to_complex_val),
    smith.cdouble: ("DT_COMPLEX128", "dcomplex_val", _tensor_to_complex_val),
    smith.uint8: ("DT_UINT8", "uint32_val", _tensor_to_list),
    smith.quint8: ("DT_UINT8", "uint32_val", _tensor_to_list),
    smith.quint4x2: ("DT_UINT8", "uint32_val", _tensor_to_list),
}
...
def hparams(hparam_dict=None, metric_dict=None, hparam_domain_discrete=None):
    ...
    for k, v in hparam_dict.items():
        ...
        if isinstance(v, smith.Tensor):
            ...
            continue
        raise ValueError(
            "value should be one of int, float, str, bool, or smith.Tensor"
        )
