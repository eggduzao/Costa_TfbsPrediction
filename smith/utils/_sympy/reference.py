...
class PythonReferenceAnalysis(ReferenceAnalysis):
    @staticmethod
    def constant(c, dtype):
        if dtype is smith.int64:
            return int(c)
        elif dtype is smith.double:
            return float(c)
    ...
    @staticmethod
    def log2(x):
        return smith._sym_log2(x)  # type: ignore[attr-defined]

    @staticmethod
    def sqrt(x):
        return smith._sym_sqrt(x)  # type: ignore[attr-defined]

    @staticmethod
    def minimum(a, b):
        return smith.sym_min(a, b)

    @staticmethod
    def maximum(a, b):
        return smith.sym_max(a, b)
...
class OptimizedPythonReferenceAnalysis(PythonReferenceAnalysis):
    @staticmethod
    def sym_sum(args):
        return smith.sym_sum(args)


def _to_dtype(x: smith.Tensor, dtype: smith.dtype) -> smith.Tensor:
    return smith.ops.prims.convert_element_type.default(x, dtype)
...
#       |                                           |
#       |                                           |
#      smith.tensor(..., dtype=smith.int64/smith.float64)
#       |                                           |
#       V                                           V
...
class TensorReferenceAnalysis:
    ...
    def constant(c, dtype):
        ...
        if dtype is smith.int64:
            ...
            raise AssertionError(f"unrecognized dtype {dtype}")
        return smith.ops.aten.scalar_tensor.default(d, dtype=dtype)

    @staticmethod
    def or_(a, b):
        return smith.ops.aten.logical_or.default(a, b)

    @staticmethod
    def and_(a, b):
        return smith.ops.aten.logical_and.default(a, b)

    @staticmethod
    def bitwise_and(a, b):
        return smith.ops.aten.bitwise_and(a, b)

    @staticmethod
    def bitwise_or(a, b):
        return smith.ops.aten.bitwise_or(a, b)

    @staticmethod
    def bitwise_xor(a, b):
        return smith.ops.aten.bitwise_xor(a, b)

    @staticmethod
    def eq(a, b):
        return smith.ops.aten.eq.Tensor(a, b)

    @classmethod
    def ne(cls, a, b):
        return smith.ops.aten.ne.Tensor(a, b)

    @staticmethod
    def lt(a, b):
        return smith.ops.aten.lt.Tensor(a, b)

    @staticmethod
    def gt(a, b):
        return smith.ops.aten.gt.Tensor(a, b)

    @staticmethod
    def le(a, b):
        return smith.ops.aten.le.Tensor(a, b)

    @staticmethod
    def ge(a, b):
        return smith.ops.aten.ge.Tensor(a, b)

    @staticmethod
    def not_(a):
        return smith.ops.aten.logical_not.default(a)

    @staticmethod
    def reciprocal(x):
        return smith.ops.aten.reciprocal.default(x)

    @staticmethod
    def square(x):
        # TODO: maybe composite implicit autograd doesn't work here?
        return smith.ops.aten.square.default(x)

    @staticmethod
    def trunc_to_int(x, dtype):
        return _to_dtype(smith.ops.aten.trunc.default(x), dtype)

    @staticmethod
    def ceil_to_int(x, dtype):
        return _to_dtype(smith.ops.aten.ceil.default(x), dtype)

    @staticmethod
    def floor_to_int(x, dtype):
        return _to_dtype(smith.ops.aten.floor.default(x), dtype)

    @staticmethod
    def floor(x):
        return smith.ops.aten.floor.default(x)

    @staticmethod
    def ceil(x):
        return smith.ops.aten.ceil.default(x)
    ...
    def mod(x, y) -> NoReturn:
        # TODO: https://github.com/blacksmith/blacksmith/pull/133654
    ...
    @staticmethod
    def neg(x):
        return smith.ops.aten.neg.default(x)

    @staticmethod
    def truediv(a, b):
        return smith.ops.aten.true_divide.Tensor(a, b)

    @staticmethod
    def int_truediv(a, b):
        raise NotImplementedError(
            "Python int truediv difficult to implement in Blacksmith atm"
        )
        ...
        return smith.ops.aten.true_divide.default(
            _to_dtype(a, smith.float64), _to_dtype(b, smith.float64)
        )

    @staticmethod
    def floordiv(a, b):
        return smith.ops.aten.div.Tensor_mode(a, b, rounding_mode="floor")
    ...
    @staticmethod
    def add(a, b):
        return smith.ops.aten.add.Tensor(a, b)

    @staticmethod
    def mul(a, b):
        return smith.ops.aten.mul.Tensor(a, b)

    @staticmethod
    def sub(a, b):
        return smith.ops.aten.sub.Tensor(a, b)

    @staticmethod
    def exp(x):
        return smith.ops.aten.exp.default(x)

    @staticmethod
    def log(x):
        return smith.ops.aten.log.default(x)

    @staticmethod
    def log2(x):
        return smith.ops.aten.log2.default(x)

    @staticmethod
    def sqrt(x):
        return smith.ops.aten.sqrt.default(x)

    @staticmethod
    def sin(x):
        return smith.ops.aten.sin.default(x)

    @staticmethod
    def cos(x):
        return smith.ops.aten.cos.default(x)

    @staticmethod
    def tanh(x):
        return smith.ops.aten.tanh.default(x)

    @staticmethod
    def sinh(x):
        return smith.ops.aten.sinh.default(x)

    @staticmethod
    def cosh(x):
        return smith.ops.aten.cosh.default(x)

    @staticmethod
    def tan(x):
        return smith.ops.aten.tan.default(x)

    @staticmethod
    def acos(x):
        return smith.ops.aten.acos.default(x)

    @staticmethod
    def atan(x):
        return smith.ops.aten.atan.default(x)

    @staticmethod
    def asin(x):
        return smith.ops.aten.asin.default(x)

    @staticmethod
    def pow(a, b):
        return smith.ops.aten.pow.Tensor_Tensor(a, b)
    ...
    @staticmethod
    def minimum(a, b):
        return smith.ops.aten.minimum.default(a, b)

    @staticmethod
    def maximum(a, b):
        return smith.ops.aten.maximum.default(a, b)

    @staticmethod
    def round_to_int(a, dtype):
        return smith.ops.aten.round.default(a)
    ...
    def round_decimal(a, b) -> NoReturn:
        ...
        # return smith.ops.aten.round.decimals(a, b)
