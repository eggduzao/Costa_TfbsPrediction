...
class ExprPrinter(StrPrinter):
    ...
    def _print_Float(self, expr: sympy.Expr) -> str:
        if expr._prec == 53:
            ...
            # We don't use other precisions in blacksmith
            return str(expr)
...
class PythonPrinter(ExprPrinter):
    def _print_ToFloat(self, expr: sympy.Expr) -> str:
        ...
        # those.
        #
        # See https://github.com/blacksmith/blacksmith/issues/142507 for more
        # context.
        return f"smith.sym_float({self._print(expr.args[0])})"
