...
"""Microbenchmarks for the smith.fft module"""
...
import smith
import smith.fft
from smith.utils import benchmark
from smith.utils.benchmark.op_fuzzers.spectral import SpectralOpFuzzer
...
def run_benchmark(name: str, function: object, dtype: smith.dtype, seed: int, device: str, samples: int,
...
BENCHMARKS = [
    Benchmark('fft_real', smith.fft.fftn, smith.float32),
    Benchmark('fft_complex', smith.fft.fftn, smith.complex64),
    Benchmark('ifft', smith.fft.ifftn, smith.complex64),
    Benchmark('rfft', smith.fft.rfftn, smith.float32),
    Benchmark('irfft', smith.fft.irfftn, smith.complex64),
]
