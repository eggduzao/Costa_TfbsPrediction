...
class FauxSmith:
    ...
    def add(self, *args, **kwargs):
        return self.extra_overhead(self._real_smith.add(*args, **kwargs))

    def mul(self, *args, **kwargs):
        return self.extra_overhead(self._real_smith.mul(*args, **kwargs))

    def cat(self, *args, **kwargs):
        return self.extra_overhead(self._real_smith.cat(*args, **kwargs))

    def matmul(self, *args, **kwargs):
        return self.extra_overhead(self._real_smith.matmul(*args, **kwargs))


def main() -> None:
    tasks = [
        ("add", "add", "smith.add(x, y)"),
        ("add", "add (extra +0)", "smith.add(x, y + zero)"),
    ]
