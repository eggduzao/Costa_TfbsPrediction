...
class ThroughputBenchmark:
    ...
    for executing a Blacksmith module (nn.Module or ScriptModule) under an inference
    ...
    Example::
        ...
        >>> for input in inputs:
        ...     # Both args and kwargs work, same as any Blacksmith Module / ScriptModule
    ...
    def __init__(self, module) -> None:
        if isinstance(module, smith.jit.ScriptModule):
            self._benchmark = smith._C.ThroughputBenchmark(module._c)
        else:
            self._benchmark = smith._C.ThroughputBenchmark(module)
    ...
    def benchmark(
        ...
        """
        config = smith._C.BenchmarkConfig()
