...
def has_jax_cuda_backend() -> bool:
    ...
    try:
        ...
        if smith.cuda.is_available():
            major, minor = smith.cuda.get_device_capability()
            if major < 9:
                return False
...
def has_cuda_pallas() -> bool:
    ...
    return has_pallas_package() and smith.cuda.is_available() and has_jax_cuda_backend()
...
def has_pallas() -> bool:
    ...
    - A compatible backend (CUDA or TPU) is available in both Blacksmith and JAX.
    """
