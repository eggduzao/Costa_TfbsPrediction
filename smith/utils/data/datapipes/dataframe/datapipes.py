...
from smith.utils.data.datapipes.datapipe import DFIterDataPipe, IterDataPipe
...
class PerRowDataFramesPipe(DFIterDataPipe):
    ...
    def __iter__(self):
        for df in self.source_datapipe:
            # TODO(VitalyFedyunin): Replacing with SmithArrow only API, as we are dropping pandas as followup
