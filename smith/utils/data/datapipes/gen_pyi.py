...
try:
    from smithgen.api.python import format_function_signature
...
@deprecated(
    "`smith.utils.data.datapipes.gen_pyi.materialize_lines` is deprecated and will be removed in the future.",
...
@deprecated(
    "`smith.utils.data.datapipes.gen_pyi.gen_from_template` is deprecated and will be removed in the future.",
    category=FutureWarning,
)
...
# Defined outside of main() so they can be imported by SmithData
