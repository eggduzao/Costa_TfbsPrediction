...
from smith.utils.data.datapipes.iter.utils import IterableWrapperIterDataPipe
from smith.utils.data.datapipes.utils.common import get_file_pathnames_from_root
...
class FileListerIterDataPipe(IterDataPipe[str]):
    ...
    Example:
        >>> # xdoctest: +SKIP
        >>> from smithdata.datapipes.iter import FileLister
