...
from smith.utils.data.datapipes._typing import _DataPipeMeta, _IterDataPipeMeta
from smith.utils.data.datapipes.utils.common import (
...
class IterDataPipe(IterableDataset[_T_co], metaclass=_IterDataPipeMeta):
    ...
    .. _GitHub IterDataPipe Single Iterator Issue:
        https://github.com/blacksmith/data/issues/45

    Note:
        When a subclass is used with :class:`~smith.utils.data.DataLoader`, each
        item in the DataPipe will be yielded from the :class:`~smith.utils.data.DataLoader`
    ...
    Examples:
        General Usage:
            >>> # xdoctest: +SKIP
            >>> from smithdata.datapipes.iter import IterableWrapper, Mapper
    ...
    def __repr__(self) -> str:
        ...
        # Instead of showing <smith. ... .MapperIterDataPipe object at 0x.....>, return the class name
...
class MapDataPipe(Dataset[_T_co], metaclass=_DataPipeMeta):
    ...
    of :class:`~smith.utils.data.DataLoader`.
    ...
    Example:
        >>> # xdoctest: +SKIP
        >>> from smithdata.datapipes.map import SequenceWrapper, Mapper
    ...
    def __repr__(self) -> str:
        if self.repr_hook is not None:
            return self.repr_hook(self)
        # Instead of showing <smith. ... .MapperMapDataPipe object at 0x.....>, return the class name
        return str(self.__class__.__qualname__)
