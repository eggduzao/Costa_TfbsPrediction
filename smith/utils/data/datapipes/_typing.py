...
from smith.utils.data.datapipes._hook_iterator import _SnapshotState, hook_iterator
...
# TODO: When Blacksmith drops the support for Python 3.6, it can be converted
