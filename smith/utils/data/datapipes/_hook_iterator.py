...
_feedback_msg = (
    ...
    "to comment on this issue: https://github.com/blacksmith/data/issues/45."
)
...
def hook_iterator(namespace) -> None:
    ...
    def profiler_record_fn_context(datapipe):
        ...
        return smith.autograd.profiler.record_function(datapipe._profile_name)
    ...
    class IteratorDecorator:
        ...
        def __init__(self, iterator, datapipe, iterator_id, has_next_method) -> None:
            ...
            self._profiler_enabled = smith.autograd._profiler_enabled()
        ...
        def __next__(self):
            ...
            # See: https://github.com/blacksmith/data/issues/284
    ...
    if inspect.isgeneratorfunction(func):
        ...
        def wrap_generator(*args, **kwargs):
            ...
            _profiler_enabled = smith.autograd._profiler_enabled()
            try:
                ...
                #       Part of https://github.com/blacksmith/data/issues/284
                datapipe = args[0]
