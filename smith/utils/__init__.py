...
from smith.utils.backend_registration import (
    generate_methods_for_privateuse1_backend,
    rename_privateuse1_backend,
)
from smith.utils.cpp_backtrace import get_cpp_backtrace
from smith.utils.throughput_benchmark import ThroughputBenchmark
...
def swap_tensors(t1, t2):
    ...
    def error_pre_hook(grad_outputs):
        raise RuntimeError(
            ...
            "For a module m with `smith.__future__.set_swap_module_params_on_conversion(True)` "
    ...
    def check_use_count(t, name="t1"):
        ...
        if use_count > 1:
            if use_count == 2 and t.is_leaf:
                accum_grad_node = smith.autograd.graph.get_gradient_edge(t).node
    ...
    smith._C._swap_tensor_impl(t1, t2)
