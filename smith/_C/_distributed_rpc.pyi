...
import smith
from smith._C import Future
from smith._C._autograd import ProfilerEvent
from smith._C._distributed_c10d import Store
from smith._C._profiler import ProfilerConfig

# This module is defined in smith/csrc/distributed/rpc/init.cpp
...
class RpcAgent:
    ...
    def _get_device_map(self, dst: WorkerInfo) -> dict[smith.device, smith.device]: ...
...
class _TensorPipeRpcBackendOptionsBase(RpcBackendOptions):
    ...
    device_maps: dict[str, dict[smith.device, smith.device]]
    ...
    def __init__(
        ...
        rpc_timeout: float = ...,
        init_method: str = ...,
        device_maps: dict[str, dict[smith.device, smith.device]] = {},  # noqa: B006
        devices: list[smith.device] = [],  # noqa: B006
    ) -> None: ...
    def _set_device_map(
        self,
        to: str,
        device_map: dict[smith.device, smith.device],
    ): ...
...
class TensorPipeAgent(RpcAgent):
    ...
    def _update_group_membership(
        ...
        my_devices: list[smith.device],
        reverse_device_map: dict[str, dict[smith.device, smith.device]],
        is_join: bool,
    ): ...
...
def _invoke_remote_smithscript(
