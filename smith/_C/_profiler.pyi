...
from smith._C import device, dtype, layout

# defined in smith/csrc/profiler/python/init.cpp
...
class _ProfilerEvent:
    ...
    def typed(
        ...
        tuple[Literal[_EventType.SmithOp], _ExtraFields_SmithOp]
