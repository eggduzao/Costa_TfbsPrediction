...
# This module is defined in smith/csrc/distributed/autograd/init.cpp
...
def backward(
    context_id: int,
    roots: list[smith.Tensor],
    retain_graph: bool = False,
) -> None: ...
def get_gradients(context_id: int) -> dict[smith.Tensor, smith.Tensor]: ...
