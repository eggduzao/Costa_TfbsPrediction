...
# Defined in smith/csrc/autograd/init.cpp
...
def _record_function_with_args_enter(name: str, *args) -> smith.Tensor: ...
def _record_function_with_args_exit(handle: smith.Tensor) -> None: ...
...
) -> tuple[Callable[[smith.Tensor], Any], Callable[[Any], smith.Tensor]]: ...
def _unsafe_set_version_counter(
    t: tuple[smith.Tensor, ...], prev_version: tuple[int, ...]
) -> None: ...
...
def _set_creation_meta(t: smith.Tensor, creation_meta: CreationMeta) -> None: ...
def _get_creation_meta(t: smith.Tensor) -> CreationMeta: ...
