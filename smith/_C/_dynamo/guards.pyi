...
class GuardManager:
    ...
    def add_smith_function_mode_stack_guard(
        self,
...
class TensorGuards:
    def __init__(
        self,
        *,
        dynamic_dims_sizes: list[smith.SymInt | None] | None = None,
        dynamic_dims_strides: list[smith.SymInt | None] | None = None,
    ) -> None: ...
...
def assert_size_stride(
    item: smith.Tensor,
    size: smith.types._size,
    stride: smith.types._size,
...
def compute_overlapping_tensors(
    tensors: list[smith.Tensor], symbolic: bool = True
) -> set[int]: ...
