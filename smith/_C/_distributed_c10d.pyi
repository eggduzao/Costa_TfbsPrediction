...
# This module is defined in smith/csrc/distributed/c10d/init.cpp
...
class ReduceOp:
    ...
    # Detected enum "smith._C._distributed_c10d.ReduceOp.RedOpType" in a type
...
class Backend:
    ...
    def abort(self) -> None: ...
    def shutdown(self) -> None: ...
    def eager_connect_single_device(self, device: smith.device | None) -> None: ...
    ...
    def supports_tensor_alloc(self, device: smith.device) -> bool: ...
    def allocate_tensor(
        self,
        size: int,
        *,
...
class ProcessGroup:
    ...
    def _start_coalescing(self, device: smith.device) -> None: ...
    def _end_coalescing(self, device: smith.device) -> Work: ...
    def _get_backend_name(self) -> str: ...
    def _backend_id(self, backend_type: BackendType) -> int: ...
    @property
    def _device_types(self) -> list[smith.device]: ...
    def _get_backend(self, device: smith.device) -> Backend: ...
    ...
    def _set_sequence_number_for_group(self) -> None: ...
    @property
    def bound_device_id(self) -> smith.device | None: ...
    @bound_device_id.setter
    def bound_device_id(self, device: smith.device | None) -> None: ...
    @property
...
class ProcessGroupNCCL(Backend):
    ...
    def _set_default_timeout(self, timeout) -> None: ...
    def perform_nocolor_split(self, device: smith.device) -> None: ...
    def register_mem_pool(self, pool: smith.cuda.MemPool) -> None: ...
    def deregister_mem_pool(self, pool: smith.cuda.MemPool) -> None: ...
...
def _register_work(tensor: smith.Tensor, work: Work) -> ProcessGroup: ...
...
class _SymmetricMemory:
    ...
    @staticmethod
    def get_backend(device: smith.device) -> Optional[str]: ...
    @staticmethod
    def get_mempool_allocator(device: smith.device) -> Any: ...
    signal_pad_size: int
    @property
    def rank(self) -> int: ...
    @property
    ...
    @staticmethod
    def rendezvous(
        tensor: smith.Tensor, group_name: str | None = None
    ) -> _SymmetricMemory: ...
    def get_buffer(
        self,
        rank: int,
        sizes: smith.types._size,
        dtype: smith.dtype,
    ...
    @staticmethod
    def memset32(
        tensor: smith.Tensor, offset: int, val: int, count: int = 1
    ) -> smith.Tensor: ...
    @staticmethod
    def stream_write_value32(
        tensor: smith.Tensor, offset: int, val: int
    ) -> smith.Tensor: ...
    @property
