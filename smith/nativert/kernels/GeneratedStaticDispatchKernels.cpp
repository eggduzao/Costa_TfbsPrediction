...
REGISTER_CPU_KERNEL("smith.ops.aten.absolute.default", aten_absolute_default, {
...
REGISTER_CPU_KERNEL("smith.ops.aten.angle.default", aten_angle_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.sgn.default", aten_sgn_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.acos.default", aten_acos_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.arccos.default", aten_arccos_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.add.Tensor", aten_add_Tensor, {
  const auto& self = KernelInput(0).toTensor();
...
REGISTER_CPU_KERNEL("smith.ops.aten.add.Scalar", aten_add_Scalar, {
  const auto& self = KernelInput(0).toTensor();
...
REGISTER_CPU_KERNEL("smith.ops.aten._add_relu.Tensor", aten__add_relu_Tensor, {
  const auto& self = KernelInput(0).toTensor();
  const auto& other = KernelInput(1).toTensor();
  const auto alpha = KernelInput(2).toScalar();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.addmv.default", aten_addmv_default, {
  const auto& self = KernelInput(0).toTensor();
...
REGISTER_CPU_KERNEL("smith.ops.aten.addr.default", aten_addr_default, {
  const auto& self = KernelInput(0).toTensor();
...
REGISTER_CPU_KERNEL("smith.ops.aten.all.dim", aten_all_dim, {
  const auto& self = KernelInput(0).toTensor();
...
REGISTER_CPU_KERNEL("smith.ops.aten.any.dim", aten_any_dim, {
  const auto& self = KernelInput(0).toTensor();
  const auto dim = KernelInput(1).toInt();
  const auto keepdim = KernelInput(2).toBool();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.argmax.default", aten_argmax_default, {
  const auto& self = KernelInput(0).toTensor();
...
REGISTER_CPU_KERNEL("smith.ops.aten.acosh.default", aten_acosh_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.asinh.default", aten_asinh_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.arcsinh.default", aten_arcsinh_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.atanh.default", aten_atanh_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.arctanh.default", aten_arctanh_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.asin.default", aten_asin_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.arcsin.default", aten_arcsin_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.atan.default", aten_atan_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.arctan.default", aten_arctan_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.baddbmm.default", aten_baddbmm_default, {
  const auto& self = KernelInput(0).toTensor();
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.bitwise_not.default",
...
REGISTER_CPU_KERNEL("smith.ops.aten.copysign.Tensor", aten_copysign_Tensor, {
  const auto& self = KernelInput(0).toTensor();
  const auto& other = KernelInput(1).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.logical_not.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.logical_xor.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.logical_and.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.logical_or.default",
...
REGISTER_CPU_KERNEL("smith.ops.aten.ceil.default", aten_ceil_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.clamp.default", aten_clamp_default, {
  const auto& self = KernelInput(0).toTensor();
...
REGISTER_CPU_KERNEL("smith.ops.aten.clamp.Tensor", aten_clamp_Tensor, {
  const auto& self = KernelInput(0).toTensor();
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.clamp_max.default",
...
REGISTER_CPU_KERNEL("smith.ops.aten.clamp_max.Tensor", aten_clamp_max_Tensor, {
  const auto& self = KernelInput(0).toTensor();
...
REGISTER_CPU_KERNEL("smith.ops.aten.clip.default", aten_clip_default, {
  const auto& self = KernelInput(0).toTensor();
  const auto min = KernelInput(1).toOptional<at::Scalar>();
  const auto max = KernelInput(2).toOptional<at::Scalar>();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.complex.default", aten_complex_default, {
...
REGISTER_CPU_KERNEL("smith.ops.aten.polar.default", aten_polar_default, {
...
REGISTER_CPU_KERNEL("smith.ops.aten.cos.default", aten_cos_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.cosh.default", aten_cosh_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.cumprod.default", aten_cumprod_default, {
  const auto& self = KernelInput(0).toTensor();
  const auto dim = KernelInput(1).toInt();
...
REGISTER_CPU_KERNEL("smith.ops.aten.diff.default", aten_diff_default, {
  const auto& self = KernelInput(0).toTensor();
...
REGISTER_CPU_KERNEL("smith.ops.aten.div.Tensor", aten_div_Tensor, {
  const auto& self = KernelInput(0).toTensor();
  const auto& other = KernelInput(1).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.div.Tensor_mode", aten_div_Tensor_mode, {
  const auto& self = KernelInput(0).toTensor();
  const auto& other = KernelInput(1).toTensor();
...
REGISTER_CPU_KERNEL("smith.ops.aten.divide.Tensor", aten_divide_Tensor, {
  const auto& self = KernelInput(0).toTensor();
  const auto& other = KernelInput(1).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.true_divide.Tensor",
...
REGISTER_CPU_KERNEL("smith.ops.aten.dot.default", aten_dot_default, {
  const auto& self = KernelInput(0).toTensor();
...
REGISTER_CPU_KERNEL("smith.ops.aten.vdot.default", aten_vdot_default, {
  const auto& self = KernelInput(0).toTensor();
  const auto& other = KernelInput(1).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.erf.default", aten_erf_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.erfc.default", aten_erfc_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.exp.default", aten_exp_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.exp2.default", aten_exp2_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.expm1.default", aten_expm1_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.floor.default", aten_floor_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.frac.default", aten_frac_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.gcd.default", aten_gcd_default, {
  const auto& self = KernelInput(0).toTensor();
  const auto& other = KernelInput(1).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.lcm.default", aten_lcm_default, {
  const auto& self = KernelInput(0).toTensor();
  const auto& other = KernelInput(1).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.index_copy.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.isin.Tensor_Tensor",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.isin.Tensor_Scalar",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.isin.Scalar_Tensor",
...
REGISTER_CPU_KERNEL("smith.ops.aten.kron.default", aten_kron_default, {
  const auto& self = KernelInput(0).toTensor();
  const auto& other = KernelInput(1).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.ldexp.Tensor", aten_ldexp_Tensor, {
  const auto& self = KernelInput(0).toTensor();
  const auto& other = KernelInput(1).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.log10.default", aten_log10_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.log1p.default", aten_log1p_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.log2.default", aten_log2_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.logaddexp.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.logaddexp2.default",
...
REGISTER_CPU_KERNEL("smith.ops.aten.xlogy.Tensor", aten_xlogy_Tensor, {
  const auto& self = KernelInput(0).toTensor();
  const auto& other = KernelInput(1).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten._log_softmax.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten._logcumsumexp.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.logcumsumexp.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.matrix_power.default",
...
REGISTER_CPU_KERNEL("smith.ops.aten.mm.default", aten_mm_default, {
  const auto& self = KernelInput(0).toTensor();
...
REGISTER_CPU_KERNEL("smith.ops.aten.multiply.Tensor", aten_multiply_Tensor, {
  const auto& self = KernelInput(0).toTensor();
  const auto& other = KernelInput(1).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.mv.default", aten_mv_default, {
  const auto& self = KernelInput(0).toTensor();
...
REGISTER_CPU_KERNEL("smith.ops.aten.mvlgamma.default", aten_mvlgamma_default, {
  const auto& self = KernelInput(0).toTensor();
...
REGISTER_CPU_KERNEL("smith.ops.aten.rad2deg.default", aten_rad2deg_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.deg2rad.default", aten_deg2rad_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.reciprocal.default",
...
REGISTER_CPU_KERNEL("smith.ops.aten.neg.default", aten_neg_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.negative.default", aten_negative_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.round.default", aten_round_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.round.decimals", aten_round_decimals, {
  const auto& self = KernelInput(0).toTensor();
...
REGISTER_CPU_KERNEL("smith.ops.aten.gelu.default", aten_gelu_default, {
  const auto& self = KernelInput(0).toTensor();
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.hardshrink.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.hardshrink_backward.default",
...
REGISTER_CPU_KERNEL("smith.ops.aten.rsqrt.default", aten_rsqrt_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.silu.default", aten_silu_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.silu_backward.default",
...
REGISTER_CPU_KERNEL("smith.ops.aten.mish.default", aten_mish_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.sigmoid.default", aten_sigmoid_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.sin.default", aten_sin_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.sinc.default", aten_sinc_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.sinh.default", aten_sinh_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten._softmax.default", aten__softmax_default, {
  const auto& self = KernelInput(0).toTensor();
  const auto dim = KernelInput(1).toInt();
  const auto half_to_float = KernelInput(2).toBool();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.sqrt.default", aten_sqrt_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.square.default", aten_square_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.prod.default", aten_prod_default, {
  const auto& self = KernelInput(0).toTensor();
...
REGISTER_CPU_KERNEL("smith.ops.aten.prod.dim_int", aten_prod_dim_int, {
  const auto& self = KernelInput(0).toTensor();
  const auto dim = KernelInput(1).toInt();
  const auto keepdim = KernelInput(2).toBool();
...
REGISTER_CPU_KERNEL("smith.ops.aten.tan.default", aten_tan_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.tanh.default", aten_tanh_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.threshold.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.threshold_backward.default",
...
REGISTER_CPU_KERNEL("smith.ops.aten.trunc.default", aten_trunc_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.fix.default", aten_fix_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.nuclear_norm.default",
...
REGISTER_CPU_KERNEL("smith.ops.aten.subtract.Tensor", aten_subtract_Tensor, {
  const auto& self = KernelInput(0).toTensor();
  const auto& other = KernelInput(1).toTensor();
  const auto alpha = KernelInput(2).toScalar();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.heaviside.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten._addmm_activation.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.index_add.default",
...
REGISTER_CPU_KERNEL("smith.ops.aten.scatter.src", aten_scatter_src, {
  const auto& self = KernelInput(0).toTensor();
  const auto dim = KernelInput(1).toInt();
  const auto& index = KernelInput(2).toTensor();
...
REGISTER_CPU_KERNEL("smith.ops.aten.scatter.value", aten_scatter_value, {
  const auto& self = KernelInput(0).toTensor();
  const auto dim = KernelInput(1).toInt();
  const auto& index = KernelInput(2).toTensor();
...
REGISTER_CPU_KERNEL("smith.ops.aten.scatter.reduce", aten_scatter_reduce, {
  const auto& self = KernelInput(0).toTensor();
  const auto dim = KernelInput(1).toInt();
  const auto& index = KernelInput(2).toTensor();
  const auto& src = KernelInput(3).toTensor();
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.scatter.value_reduce",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.scatter_add.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.scatter_reduce.two",
...
REGISTER_CPU_KERNEL("smith.ops.aten.eq.Scalar", aten_eq_Scalar, {
  const auto& self = KernelInput(0).toTensor();
  const auto other = KernelInput(1).toScalar();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.eq.Tensor", aten_eq_Tensor, {
  const auto& self = KernelInput(0).toTensor();
  const auto& other = KernelInput(1).toTensor();
  if (KernelOutput(0).isNone()) {
    KernelOutput(0) = at::cpu::eq(self, other);
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.bitwise_and.Tensor",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.bitwise_or.Tensor",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.bitwise_xor.Tensor",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.bitwise_left_shift.Tensor",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.bitwise_right_shift.Tensor",
...
REGISTER_CPU_KERNEL("smith.ops.aten.tril.default", aten_tril_default, {
  const auto& self = KernelInput(0).toTensor();
...
REGISTER_CPU_KERNEL("smith.ops.aten.triu.default", aten_triu_default, {
  const auto& self = KernelInput(0).toTensor();
  const auto diagonal = KernelInput(1).toInt();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.digamma.default", aten_digamma_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.lerp.Scalar", aten_lerp_Scalar, {
  const auto& self = KernelInput(0).toTensor();
...
REGISTER_CPU_KERNEL("smith.ops.aten.lerp.Tensor", aten_lerp_Tensor, {
  const auto& self = KernelInput(0).toTensor();
  const auto& end = KernelInput(1).toTensor();
...
REGISTER_CPU_KERNEL("smith.ops.aten.addbmm.default", aten_addbmm_default, {
  const auto& self = KernelInput(0).toTensor();
  const auto& batch1 = KernelInput(1).toTensor();
  const auto& batch2 = KernelInput(2).toTensor();
  const auto beta = KernelInput(3).toScalar();
...
REGISTER_CPU_KERNEL("smith.ops.aten.cross.default", aten_cross_default, {
  const auto& self = KernelInput(0).toTensor();
  const auto& other = KernelInput(1).toTensor();
...
REGISTER_CPU_KERNEL("smith.ops.aten.ne.Scalar", aten_ne_Scalar, {
  const auto& self = KernelInput(0).toTensor();
  const auto other = KernelInput(1).toScalar();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.ne.Tensor", aten_ne_Tensor, {
  const auto& self = KernelInput(0).toTensor();
  const auto& other = KernelInput(1).toTensor();
  if (KernelOutput(0).isNone()) {
    KernelOutput(0) = at::cpu::ne(self, other);
...
REGISTER_CPU_KERNEL("smith.ops.aten.ge.Scalar", aten_ge_Scalar, {
  const auto& self = KernelInput(0).toTensor();
  const auto other = KernelInput(1).toScalar();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.ge.Tensor", aten_ge_Tensor, {
  const auto& self = KernelInput(0).toTensor();
  const auto& other = KernelInput(1).toTensor();
  if (KernelOutput(0).isNone()) {
    KernelOutput(0) = at::cpu::ge(self, other);
...
REGISTER_CPU_KERNEL("smith.ops.aten.le.Scalar", aten_le_Scalar, {
  const auto& self = KernelInput(0).toTensor();
  const auto other = KernelInput(1).toScalar();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.le.Tensor", aten_le_Tensor, {
  const auto& self = KernelInput(0).toTensor();
  const auto& other = KernelInput(1).toTensor();
  if (KernelOutput(0).isNone()) {
    KernelOutput(0) = at::cpu::le(self, other);
...
REGISTER_CPU_KERNEL("smith.ops.aten.gt.Scalar", aten_gt_Scalar, {
  const auto& self = KernelInput(0).toTensor();
  const auto other = KernelInput(1).toScalar();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.gt.Tensor", aten_gt_Tensor, {
  const auto& self = KernelInput(0).toTensor();
  const auto& other = KernelInput(1).toTensor();
  if (KernelOutput(0).isNone()) {
    KernelOutput(0) = at::cpu::gt(self, other);
...
REGISTER_CPU_KERNEL("smith.ops.aten.lt.Scalar", aten_lt_Scalar, {
  const auto& self = KernelInput(0).toTensor();
  const auto other = KernelInput(1).toScalar();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.lt.Tensor", aten_lt_Tensor, {
  const auto& self = KernelInput(0).toTensor();
  const auto& other = KernelInput(1).toTensor();
  if (KernelOutput(0).isNone()) {
    KernelOutput(0) = at::cpu::lt(self, other);
...
REGISTER_CPU_KERNEL("smith.ops.aten.take.default", aten_take_default, {
  const auto& self = KernelInput(0).toTensor();
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.take_along_dim.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.masked_select.default",
...
REGISTER_CPU_KERNEL("smith.ops.aten.gather.default", aten_gather_default, {
  const auto& self = KernelInput(0).toTensor();
  const auto dim = KernelInput(1).toInt();
  const auto& index = KernelInput(2).toTensor();
...
REGISTER_CPU_KERNEL("smith.ops.aten.addcmul.default", aten_addcmul_default, {
  const auto& self = KernelInput(0).toTensor();
...
REGISTER_CPU_KERNEL("smith.ops.aten.addcdiv.default", aten_addcdiv_default, {
  const auto& self = KernelInput(0).toTensor();
  const auto& tensor1 = KernelInput(1).toTensor();
  const auto& tensor2 = KernelInput(2).toTensor();
  const auto value = KernelInput(3).toScalar();
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.linalg_solve_triangular.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.cholesky_solve.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.cholesky_inverse.default",
...
REGISTER_CPU_KERNEL("smith.ops.aten.orgqr.default", aten_orgqr_default, {
  const auto& self = KernelInput(0).toTensor();
  const auto& input2 = KernelInput(1).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.ormqr.default", aten_ormqr_default, {
  const auto& self = KernelInput(0).toTensor();
  const auto& input2 = KernelInput(1).toTensor();
...
REGISTER_CPU_KERNEL("smith.ops.aten.lgamma.default", aten_lgamma_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.polygamma.default",
...
REGISTER_CPU_KERNEL("smith.ops.aten.erfinv.default", aten_erfinv_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.i0.default", aten_i0_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.signbit.default", aten_signbit_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.atan2.default", aten_atan2_default, {
  const auto& self = KernelInput(0).toTensor();
  const auto& other = KernelInput(1).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.arctan2.default", aten_arctan2_default, {
  const auto& self = KernelInput(0).toTensor();
  const auto& other = KernelInput(1).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.histc.default", aten_histc_default, {
  const auto& self = KernelInput(0).toTensor();
...
REGISTER_CPU_KERNEL("smith.ops.aten.fmod.Tensor", aten_fmod_Tensor, {
  const auto& self = KernelInput(0).toTensor();
  const auto& other = KernelInput(1).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.hypot.default", aten_hypot_default, {
  const auto& self = KernelInput(0).toTensor();
  const auto& other = KernelInput(1).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.igamma.default", aten_igamma_default, {
  const auto& self = KernelInput(0).toTensor();
  const auto& other = KernelInput(1).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.igammac.default", aten_igammac_default, {
  const auto& self = KernelInput(0).toTensor();
  const auto& other = KernelInput(1).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.nextafter.default",
...
REGISTER_CPU_KERNEL("smith.ops.aten.fmin.default", aten_fmin_default, {
  const auto& self = KernelInput(0).toTensor();
  const auto& other = KernelInput(1).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.fmax.default", aten_fmax_default, {
  const auto& self = KernelInput(0).toTensor();
  const auto& other = KernelInput(1).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.maximum.default", aten_maximum_default, {
  const auto& self = KernelInput(0).toTensor();
  const auto& other = KernelInput(1).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.minimum.default", aten_minimum_default, {
  const auto& self = KernelInput(0).toTensor();
  const auto& other = KernelInput(1).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.min.other", aten_min_other, {
  const auto& self = KernelInput(0).toTensor();
  const auto& other = KernelInput(1).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.quantile.default", aten_quantile_default, {
  const auto& self = KernelInput(0).toTensor();
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.nanquantile.default",
...
REGISTER_CPU_KERNEL("smith.ops.aten.msort.default", aten_msort_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.all.default", aten_all_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.any.default", aten_any_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.renorm.default", aten_renorm_default, {
  const auto& self = KernelInput(0).toTensor();
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten._convert_indices_from_coo_to_csr.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten._convert_indices_from_csr_to_coo.default",
...
REGISTER_CPU_KERNEL("smith.ops.aten.mse_loss.default", aten_mse_loss_default, {
  const auto& self = KernelInput(0).toTensor();
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.multi_margin_loss.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.multilabel_margin_loss.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.soft_margin_loss.default",
...
REGISTER_CPU_KERNEL("smith.ops.aten.elu.default", aten_elu_default, {
  const auto& self = KernelInput(0).toTensor();
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.elu_backward.default",
...
REGISTER_CPU_KERNEL("smith.ops.aten.glu.default", aten_glu_default, {
  const auto& self = KernelInput(0).toTensor();
  const auto dim = KernelInput(1).toInt();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.hardsigmoid.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.hardsigmoid_backward.default",
...
REGISTER_CPU_KERNEL("smith.ops.aten.hardtanh.default", aten_hardtanh_default, {
  const auto& self = KernelInput(0).toTensor();
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.hardswish.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.leaky_relu_backward.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.log_sigmoid.default",
...
REGISTER_CPU_KERNEL("smith.ops.aten.softplus.default", aten_softplus_default, {
  const auto& self = KernelInput(0).toTensor();
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.softplus_backward.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.softshrink.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.softshrink_backward.default",
...
REGISTER_CPU_KERNEL("smith.ops.aten.isposinf.default", aten_isposinf_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.isneginf.default", aten_isneginf_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.special_entr.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.special_ndtri.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.special_log_ndtr.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.special_expm1.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.special_exp2.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.special_psi.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.special_digamma.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.special_gammaln.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.special_erf.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.special_erfc.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.special_erfcx.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.special_erfinv.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.special_ndtr.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.special_xlog1py.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.special_xlogy.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.special_zeta.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.special_i0.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.special_i0e.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.special_i1.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.special_i1e.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.special_polygamma.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.special_expit.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.special_sinc.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.special_round.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.special_log1p.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.special_gammainc.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.special_gammaincc.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.special_multigammaln.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.linalg_cross.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.linalg_det.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.linalg_matmul.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.linalg_eigvals.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.linalg_inv.default",
...
REGISTER_CPU_KERNEL("smith.ops.aten.inverse.default", aten_inverse_default, {
  const auto& self = KernelInput(0).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.inner.default", aten_inner_default, {
  const auto& self = KernelInput(0).toTensor();
  const auto& other = KernelInput(1).toTensor();
  if (KernelOutput(0).isNone()) {
...
REGISTER_CPU_KERNEL("smith.ops.aten.outer.default", aten_outer_default, {
  const auto& self = KernelInput(0).toTensor();
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.linalg_cond.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.linalg_solve.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.linalg_tensorinv.default",
...
REGISTER_CPU_KERNEL(
    "smith.ops.aten.linalg_matrix_power.default",
