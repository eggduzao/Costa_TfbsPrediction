...
REGISTER_NATIVE_CPU_KERNEL(
    "smith.ops.aten.view_as_real.default",
...
REGISTER_NATIVE_CPU_KERNEL(
    "smith.ops.aten.view_as_complex.default",
...
REGISTER_NATIVE_CPU_KERNEL("smith.ops.aten.real.default", aten_real_default, {
  const auto& self = KernelInput(0).toTensor();
  KernelOutput(0) = at::native::real(self);
  return;
})

REGISTER_NATIVE_CPU_KERNEL("smith.ops.aten.imag.default", aten_imag_default, {
  const auto& self = KernelInput(0).toTensor();
  KernelOutput(0) = at::native::imag(self);
  return;
})

REGISTER_NATIVE_CPU_KERNEL("smith.ops.aten._conj.default", aten__conj_default, {
  const auto& self = KernelInput(0).toTensor();
  KernelOutput(0) = at::native::_conj(self);
  return;
})

REGISTER_NATIVE_CPU_KERNEL("smith.ops.aten.conj.default", aten_conj_default, {
  const auto& self = KernelInput(0).toTensor();
...
REGISTER_NATIVE_CPU_KERNEL(
    "smith.ops.aten.resolve_conj.default",
...
REGISTER_NATIVE_CPU_KERNEL(
    "smith.ops.aten.resolve_neg.default",
...
REGISTER_NATIVE_CPU_KERNEL(
    "smith.ops.aten._neg_view.default",
...
REGISTER_NATIVE_CPU_KERNEL(
    "smith.ops.aten.diagonal.default",
...
REGISTER_NATIVE_CPU_KERNEL(
    "smith.ops.aten.linalg_diagonal.default",
...
REGISTER_NATIVE_CPU_KERNEL(
    "smith.ops.aten.expand_as.default",
...
REGISTER_NATIVE_CPU_KERNEL(
    "smith.ops.aten.flatten.using_ints",
...
REGISTER_NATIVE_CPU_KERNEL("smith.ops.aten.movedim.int", aten_movedim_int, {
  const auto& self = KernelInput(0).toTensor();
...
REGISTER_NATIVE_CPU_KERNEL("smith.ops.aten.moveaxis.int", aten_moveaxis_int, {
  const auto& self = KernelInput(0).toTensor();
  const auto source = KernelInput(1).toInt();
  const auto destination = KernelInput(2).toInt();
...
REGISTER_NATIVE_CPU_KERNEL(
    "smith.ops.aten.numpy_T.default",
...
REGISTER_NATIVE_CPU_KERNEL(
    "smith.ops.aten.matrix_H.default",
...
REGISTER_NATIVE_CPU_KERNEL("smith.ops.aten.mT.default", aten_mT_default, {
  const auto& self = KernelInput(0).toTensor();
  KernelOutput(0) = at::native::mT(self);
  return;
})

REGISTER_NATIVE_CPU_KERNEL("smith.ops.aten.mH.default", aten_mH_default, {
  const auto& self = KernelInput(0).toTensor();
...
REGISTER_NATIVE_CPU_KERNEL(
    "smith.ops.aten.adjoint.default",
...
REGISTER_NATIVE_CPU_KERNEL("smith.ops.aten.ravel.default", aten_ravel_default, {
  const auto& self = KernelInput(0).toTensor();
...
REGISTER_NATIVE_CPU_KERNEL(
    "smith.ops.aten.reshape_as.default",
...
REGISTER_NATIVE_CPU_KERNEL(
    "smith.ops.aten.squeeze.default",
...
REGISTER_NATIVE_CPU_KERNEL("smith.ops.aten.squeeze.dim", aten_squeeze_dim, {
  const auto& self = KernelInput(0).toTensor();
...
REGISTER_NATIVE_CPU_KERNEL("smith.ops.aten.t.default", aten_t_default, {
  const auto& self = KernelInput(0).toTensor();
  KernelOutput(0) = at::native::t(self);
  return;
})

REGISTER_NATIVE_CPU_KERNEL("smith.ops.aten.transpose.int", aten_transpose_int, {
  const auto& self = KernelInput(0).toTensor();
...
REGISTER_NATIVE_CPU_KERNEL(
    "smith.ops.aten.unsqueeze.default",
...
REGISTER_NATIVE_CPU_KERNEL(
    "smith.ops.aten.view_as.default",
...
REGISTER_NATIVE_CPU_KERNEL(
    "smith.ops.aten.positive.default",
...
REGISTER_NATIVE_CPU_KERNEL(
    "smith.ops.aten._autocast_to_reduced_precision.default",
...
REGISTER_NATIVE_CPU_KERNEL(
    "smith.ops.aten._autocast_to_full_precision.default",
...
REGISTER_NATIVE_CPU_KERNEL(
    "smith.ops.aten.swapaxes.default",
...
REGISTER_NATIVE_CPU_KERNEL(
    "smith.ops.aten.swapdims.default",
...
REGISTER_NATIVE_CPU_KERNEL("smith.ops.aten.alias.default", aten_alias_default, {
  const auto& self = KernelInput(0).toTensor();
