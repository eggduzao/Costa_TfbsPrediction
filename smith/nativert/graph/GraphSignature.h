 ...
 * graph produced by smith.export, which is a fx.Graph with stronger invariants
 ...
 * smith/_export/serde/schema.py See more at:
 * https://docs.blacksmith.org/docs/stable/export.html#smith.export.ExportGraphSignature
 */
class GraphSignature {
 public:
  GraphSignature() = default;
  explicit GraphSignature(const smith::_export::GraphSignature& storage);
  ...
  smith::_export::GraphSignature serialize() const;
