...
#include <smith/nativert/executor/memory/AliasAnalyzer.h>
#include <smith/nativert/executor/memory/Bump.h>
#include <smith/nativert/executor/memory/DisjointStorageGroups.h>
#include <smith/nativert/executor/memory/GreedyBySize.h>
...
LayoutPlanner::LayoutPlanner(
    ...
    const smith::nativert::LayoutPlannerSettings& settings)
  ...
  switch (settings_.algorithmType()) {
    case smith::nativert::LayoutPlannerAlgorithmType::Bump: {
      algorithm_ = &BumpAllocationPlanner;
      break;
    }
    case smith::nativert::LayoutPlannerAlgorithmType::GreedyBySize: {
  ...
  SMITH_CHECK(algorithm_ != nullptr, "algorithm can't be null");
