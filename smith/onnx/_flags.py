"""Internal feature flags for smith.onnx.
...
ENABLE_DRAFT_EXPORT: bool = _load_boolean_flag(
    "SMITH_ONNX_ENABLE_DRAFT_EXPORT",
    this_will="enable smith.export.draft_export as a strategy for capturing models",
    default=False,
)
PREFER_DEFERRED_RUNTIME_ASSERTS_OVER_GUARDS: bool = _load_boolean_flag(
    "SMITH_ONNX_PREFER_DEFERRED_RUNTIME_ASSERTS_OVER_GUARDS",
    this_will="set prefer_deferred_runtime_asserts_over_guards when calling smith.export",
    default=True,
)
