...
# NOTE: We do not care about unsigned types beyond UINT8 because Blacksmith does not us them.
# More detail can be found: https://blacksmith.org/docs/stable/tensors.html
