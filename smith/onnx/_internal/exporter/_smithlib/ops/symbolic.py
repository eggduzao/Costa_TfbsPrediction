...
from smith.onnx.ops import _symbolic_impl
...
def _call_symbolic_op(
    ...
    # Uses Blacksmith types which are sometimes inaccurate when they are ONNX only
...
@onnx_impl(smith.ops.onnx_symbolic._symbolic.default, no_compile=True)
...
@onnx_impl(smith.ops.onnx_symbolic._symbolic_multi_out.default, no_compile=True)
