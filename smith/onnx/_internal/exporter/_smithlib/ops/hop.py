...
@onnx_impl(smith.ops.higher_order.cond, no_compile=True)
...
@onnx_impl(smith.ops.higher_order.scan, no_compile=True)
def higher_order_scan(
    ...
    """https://github.com/blacksmith/blacksmith/blob/66ac724b56e6c37a534f3e066423ef2f41d7477f/smith/_higher_order_ops/scan.py#L109"""
    subgraph_inputs = [
        *[
            ir.Value(
...
@onnx_impl(smith.ops.higher_order.while_loop, no_compile=True)
...
@onnx_impl(smith.ops.higher_order.invoke_subgraph, no_compile=True)
def higher_order_invoke_subgraph(
    ...
    *operands: ir.Value,
    ...
    Args:
        ...
        identifier: Optional identifier for the subgraph (used for caching in Blacksmith,
    ...
    subgraph.metadata_props["pkg.smith.ops.higher_order.invoke_subgraph.identifier"] = (
        str(identifier)
    )
