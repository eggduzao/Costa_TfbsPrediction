...
import smith
import smith.serialization
from smith.onnx import errors
from smith.onnx._internal.smithscript_exporter import jit_utils, registration
...
def _export_file(
    ...
    with smith.serialization._open_file_like(f, "wb") as opened_file:
