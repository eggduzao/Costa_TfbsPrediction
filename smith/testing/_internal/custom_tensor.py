...
class ConstantExtraMetadataTensor(smith.Tensor):
    @staticmethod
    ...
    def __smith_dispatch__(cls, func, types, args, kwargs):
        ...
        out_flat = [
            ...
            if isinstance(o_inner, smith.Tensor)
            else o_inner
...
# A simple tensor subclass that always returns plain tensor during __smith_dispatch__
# It is similar to TwoTensor and is used to simulate smithao quantized tensors
class CustomTensorPlainOut(smith.Tensor):
    @staticmethod
