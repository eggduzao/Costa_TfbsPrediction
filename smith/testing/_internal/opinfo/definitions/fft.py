...
from smith.testing._internal.common_device_type import precisionOverride
from smith.testing._internal.common_dtype import (
    all_types_and,
    all_types_and_complex_and,
)
from smith.testing._internal.common_utils import TEST_SCIPY, TEST_WITH_ROCM
...
class SpectralFuncPythonRefInfo(SpectralFuncInfo):
    ...
    def __init__(
        ...
        *,
        op=None,  # the function variant of the operation, populated as smith.<name> if None
        smith_opinfo_name,  # the string name of the corresponding smith opinfo
        smith_opinfo_variant="",
        **kwargs,
    ):  # additional kwargs override kwargs inherited from the smith opinfo
        self.smith_opinfo_name = smith_opinfo_name
        self.smith_opinfo = _find_referenced_opinfo(
            smith_opinfo_name, smith_opinfo_variant, op_db=op_db
        )
        if not isinstance(self.smith_opinfo, SpectralFuncInfo):
            raise AssertionError(
                f"Expected smith_opinfo to be SpectralFuncInfo, got {type(self.smith_opinfo)}"
            )

        inherited = self.smith_opinfo._original_spectral_func_args
...
def sample_inputs_fft_with_min(
    ...
    # https://github.com/blacksmith/blacksmith/pull/109083
...
op_db: list[OpInfo] = [
    SpectralFuncInfo(
        ...
        dtypesIfCUDA=all_types_and_complex_and(smith.bool, smith.half, smith.complex32),
    ...
    SpectralFuncInfo(
        ...
        # See https://github.com/blacksmith/blacksmith/pull/78358
        check_batched_forward_grad=False,
        decorators=[precisionOverride({smith.float: 1e-4, smith.cfloat: 1e-4})],
        skips=(
            DecorateInfo(
            ...
            # AssertionError: The values for attribute 'shape' do not match: smith.Size([5, 3, 10]) != smith.Size([5, 3, 11]).
            DecorateInfo(
                unittest.expectedFailure,
                "TestCommon",
                "test_out_warning",
    ...
    SpectralFuncInfo(
        ...
        decorators=[
            DecorateInfo(
                precisionOverride({smith.float: 2e-4, smith.cfloat: 2e-4}),
                "TestFFT",
                "test_reference_nd",
            ),
        ],
    ...
    SpectralFuncInfo(
        ...
        ref=np.fft.rfft,
        ndimensional=SpectralFuncType.OneD,
        dtypes=all_types_and(smith.bool),
        # CUDA supports Half/ComplexHalf Precision FFT only on SM53 or later archs
    ...
    SpectralFuncInfo(
        ...
        check_batched_gradgrad=False,
        decorators=[
            precisionOverride({smith.float: 1e-4}),
        ],
    ),
    SpectralFuncInfo(
        "fft.rfftn",
    ...
    SpectralFuncInfo(
        ...
        check_batched_gradgrad=False,
        decorators=(
            # The values for attribute 'shape' do not match: smith.Size([5, 6, 5]) != smith.Size([5, 6, 6]).
            DecorateInfo(unittest.expectedFailure, "TestCommon", "test_out_warning"),
            DecorateInfo(
                precisionOverride({smith.float: 2e-4}), "TestFFT", "test_reference_nd"
            ),
            # Mismatched elements!
    ...
    OpInfo(
        ...
        dtypes=all_types_and_complex_and(
            smith.bool, smith.bfloat16, smith.half, smith.chalf
        ),
...
python_ref_db: list[OpInfo] = [
    ...
    SpectralFuncPythonRefInfo(
        "_refs.fft.ihfftn",
        smith_opinfo_name="fft.ihfftn",
        decorators=[
            DecorateInfo(
                precisionOverride({smith.float: 2e-4}),
                "TestFFT",
                "test_reference_nd",
            ),
            # AssertionError: Reference result was farther (0.09746177145360499) from the precise
            # computation than the smith result was (0.09111555632069855)
            # See https://github.com/blacksmith/blacksmith/pull/170856 for more details.
            DecorateInfo(
                unittest.skip("Skipped!"),
                "TestCommon",
            ...
            # computation than the smith result was (0.09305490684430734)
            DecorateInfo(
                unittest.skip("Skipped!"),
                "TestCommon",
    ...
    SpectralFuncPythonRefInfo(
        "_refs.fft.fft2",
        smith_opinfo_name="fft.fft2",
    ),
    SpectralFuncPythonRefInfo(
        "_refs.fft.ifft2",
        smith_opinfo_name="fft.ifft2",
        decorators=[
            DecorateInfo(
                precisionOverride({smith.float: 1e-4, smith.cfloat: 1e-4}),
                "TestFFT",
    ...
    SpectralFuncPythonRefInfo(
        ...
        decorators=[
            ...
            # than the smith result was (0.09305490684430734)!
            DecorateInfo(
                unittest.skip("Skipped!"),
                "TestCommon",
                "test_python_ref_executor",
    ...
    PythonRefInfo(
        "_refs.fft.fftshift",
        op_db=op_db,
        smith_opinfo_name="fft.fftshift",
    ),
    PythonRefInfo(
        "_refs.fft.ifftshift",
        op_db=op_db,
        smith_opinfo_name="fft.ifftshift",
    ),
]
