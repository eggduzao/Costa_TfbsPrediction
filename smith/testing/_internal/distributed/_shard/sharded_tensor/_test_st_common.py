...
class MyShardedModel2(smith.nn.Module):
    def __init__(self, spec=None, group=None, init_rrefs=True) -> None:
        ...
        self.random_tensor2 = smith.nn.Parameter(smith.rand(2, 2))


class MyShardedModel1(smith.nn.Module):
    def __init__(self, spec=None, group=None, init_rrefs=True) -> None:
        super().__init__()
        if spec is not None:
        ...
        self.random_tensor1 = smith.nn.Parameter(smith.rand(2, 2))
