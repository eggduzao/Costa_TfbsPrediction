...
from smith.distributed.rpc import _rref_context_get_debug_info
from smith.testing._internal.common_utils import FILE_SCHEMA, TEST_WITH_TSAN
...
def get_function_event(function_events, partial_event_name):
    ...
    smith.autograd.profiler.function_events().
