...
/* Main entry for smith/headeronly/macros (used to be c10/macros).
 *
 * In your code, include smith/headeronly/macros/Macros.h directly, instead of
...
// smith/headeronly and smith/csrc/stable under the namespaces
// smith::headeronly and smith::stable respectively. We enforce
// hidden visibility for these APIs because we want to enable
// loading custom extensions compiled against different libsmith
