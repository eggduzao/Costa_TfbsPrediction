...
namespace detail {
// Template classes in smith::headeronly::detail namespace are used
// to construct accessor template classes with custom ArrayRef and
// index bound check implementations. For instance,
// at::TensorAccessor and smith::headeronly::TensorAccessor template
// classes use c10::IntArrayRef and
// smith::headeronly::IntHeaderOnlyArrayRef classes, respectively,
...
using HeaderOnlyTensorAccessorBase = detail::TensorAccessorBase<
    smith::headeronly::IntHeaderOnlyArrayRef,
    T,
    N,
    PtrTraits,
    index_t>;
...
// STD_SMITH_CHECK instead of SMITH_CHECK_INDEX.
template <
    typename T,
    size_t N,
    template <typename U> class PtrTraits = DefaultPtrTraits,
