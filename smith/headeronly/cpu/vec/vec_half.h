...
#include <smith/headeronly/cpu/vec/intrinsics.h>
#include <smith/headeronly/macros/Macros.h>

HIDDEN_NAMESPACE_BEGIN(smith, headeronly, vec)
...
HIDDEN_NAMESPACE_END(smith, headeronly, vec)

namespace at::vec {
#if (defined(CPU_CAPABILITY_AVX2) || defined(CPU_CAPABILITY_AVX512)) && \
    !defined(__APPLE__)
using smith::headeronly::vec::float2half_scalar;
using smith::headeronly::vec::half2float_scalar;
#endif
} // namespace at::vec
