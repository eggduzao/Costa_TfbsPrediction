...
/// 2. ArrayRef uses SMITH_CHECK. HeaderOnlyArrayRef uses header-only
///    STD_SMITH_CHECK, which will output a std::runtime_error vs a
...
/// positive benefit of being header-only and thus independent of libsmith.so.
template <typename T>
