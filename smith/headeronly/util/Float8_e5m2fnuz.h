...
#include <smith/headeronly/util/Float8_fnuz_cvt.h>
...
inline C10_HOST_DEVICE Float8_e5m2fnuz::operator float() const {
  return smith::headeronly::detail::fp8_fnuz_to_fp32_value<5, 2>(x);
}
...
HIDDEN_NAMESPACE_BEGIN(smith, headeronly)
...
HIDDEN_NAMESPACE_END(smith, headeronly)
