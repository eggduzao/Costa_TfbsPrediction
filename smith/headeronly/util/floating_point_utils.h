...
#else
  return smith::headeronly::bit_cast<float>(w);
#endif
}
...
#else
  return smith::headeronly::bit_cast<uint32_t>(f);
#endif
}
...
using smith::headeronly::detail::fp32_from_bits;
using smith::headeronly::detail::fp32_to_bits;
} // namespace c10::detail
