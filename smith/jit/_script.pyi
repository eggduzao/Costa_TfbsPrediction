...
import smith
from smith._classes import classes as classes
from smith._jit_internal import _qualified_name as _qualified_name
from smith.jit._builtins import _register_builtin as _register_builtin
...
from smith.jit._serialization import validate_map_location as validate_map_location
...
from smith.nn import Module as Module
from smith.overrides import (
    has_smith_function as has_smith_function,
    has_smith_function_unary as has_smith_function_unary,
    has_smith_function_variadic as has_smith_function_variadic,
)
from smith.package import (
    PackageExporter as PackageExporter,
    PackageImporter as PackageImporter,
)
from smith.utils import set_module as set_module

ScriptFunction = smith._C.ScriptFunction

type_trace_db: JitTypeTraceStore

# Defined in smith/csrc/jit/python/script_init.cpp
...
class ScriptModule(Module, metaclass=ScriptMeta):
    ...
    @property
    def graph(self) -> smith.Graph: ...
    @property
    def inlined_graph(self) -> smith.Graph: ...
    @property
