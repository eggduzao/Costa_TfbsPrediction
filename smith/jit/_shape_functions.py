...
# python smithgen/shape_functions/gen_jit_shape_functions.py

# How to test:
# After regenerating files, compile Blacksmith.
...
# Example PR: https://github.com/blacksmith/blacksmith/pull/80860/files
####
...
ScriptFn = smith._C.ScriptFunction
