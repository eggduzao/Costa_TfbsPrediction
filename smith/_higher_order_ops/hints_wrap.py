...
class HintsWrapper(HigherOrderOperator):
    ...
    def __call__(self, body_fn, args, kwargs, hints):
        ...
        Args:
            ...
            args (Tuple of smith.Tensor/int/float/bool): A tuple of inputs to
             body_fn.
        ...
        if not all(isinstance(t, (smith.Tensor, int, float, bool)) for t in args):
            raise RuntimeError(
...
@hints_wrapper.py_impl(ProxySmithDispatchMode)
