...
class AOTICallDelegate(HigherOrderOperator):
    ...
    def __call__(
        ...
        original_gm: smith.fx.GraphModule,
        weight_args: list[smith.Tensor],
        input_args: list[smith.Tensor],
    ) -> list[smith.Tensor]:
...
aoti_call_delegate.fallthrough(smith._C.DispatchKey.PythonDispatcher)
aoti_call_delegate.fallthrough(smith._C.DispatchKey.PythonTLSSnapshot)
aoti_call_delegate.fallthrough(smith._C.DispatchKey.ADInplaceOrView)
aoti_call_delegate.fallthrough(smith._C.DispatchKey.AutocastCPU)


@aoti_call_delegate.py_impl(smith._C.DispatchKey.CompositeExplicitAutograd)
...
@aoti_call_delegate.py_impl(ProxySmithDispatchMode)
def call_delegate_proxy_smith_dispatch_mode(
