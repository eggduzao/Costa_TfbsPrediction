...
class Print(HigherOrderOperator):
    ...
    This Higher Order Operator (HOP) provides a functional version of print for use in Blacksmith graphs.
    ...
    2. Format string with positional arguments (positional placeholders):
       smith._higher_order_ops.print("moo {} {}", 1, 2)
       Output: "moo 1 2"

    3. Mixed positional and keyword arguments:
       smith._higher_order_ops.print("moo {} {y}", 1, y=2)
       Output: "moo 1 2"
...
@print.py_impl(ProxySmithDispatchMode)
# pyre-ignore
def print_proxy_smith_dispatch_mode(
    mode: ProxySmithDispatchMode, format_str: str, *args: object, **kwargs: object
) -> None:
...
@print.py_impl(smith._C.DispatchKey.CompositeExplicitAutograd)
# pyre-ignore
...
print.fallthrough(smith._C.DispatchKey.AutogradCPU)
print.fallthrough(smith._C.DispatchKey.AutogradCUDA)
