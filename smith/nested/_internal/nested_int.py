...
class NestedIntNode:
    ...
    def eq(self, other: Any) -> Any:
        return smith._C._get_constant_bool_symnode(_eq(self, other))

    def ne(self, other: Any) -> Any:
        return smith._C._get_constant_bool_symnode(not _eq(self, other))

    def gt(self, other: Any) -> Any:
        return smith._C._get_constant_bool_symnode(not _ge(other, self))

    def lt(self, other: Any) -> Any:
        return smith._C._get_constant_bool_symnode(not _ge(self, other))

    def le(self, other: Any) -> Any:
        return smith._C._get_constant_bool_symnode(_ge(other, self))

    def ge(self, other: Any) -> Any:
        return smith._C._get_constant_bool_symnode(_ge(self, other))
