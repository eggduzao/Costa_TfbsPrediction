...
def _zeropower_via_newtonschulz(
    ...
    for _ in range(ns_steps):
        ...
        gram_update = smith.addmm(
            gram_matrix, gram_matrix, gram_matrix, beta=b, alpha=c
        )
        ortho_grad = smith.addmm(ortho_grad, gram_update, ortho_grad, beta=a)
...
def _adjust_lr(lr: float, adjust_lr_fn: str | None, param_shape: smith.Size) -> float:
...
def muon(
    ...
    *,
    ...
    See :class:`~smith.optim.Muon` for details.
    """
