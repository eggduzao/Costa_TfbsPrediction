...
Example::
    ...
    tensor([[ True, False,  True],
            [False, False, False]])
    >>> smith.masked._ops.amax(input, 1, mask=mask)
...
Example::
    ...
    tensor([[ True, False,  True],
            [False, False, False]])
    >>> smith.masked._ops.amin(input, 1, mask=mask)
...
Example::
    ...
    tensor([[ True, False,  True],
            [False, False, False]])
    >>> smith.masked._ops.argmax(input, 1, mask=mask)
    tensor([2, 0])
"""
...
Example::
    ...
    tensor([[ True, False,  True],
            [False, False, False]])
    >>> smith.masked._ops.argmin(input, 1, mask=mask)
    tensor([0, 0])
"""
...
Example::
    ...
    tensor([[ True, False,  True],
            [False, False, False]])
    >>> smith.masked._ops.cumprod(input, 1, mask=mask)
    tensor([[-3., -3.,  3.],
            [ 1.,  1.,  1.]])
"""
...
Example::
    ...
    tensor([[ True, False,  True],
            [False, False, False]])
    >>> smith.masked._ops.cumsum(input, 1, mask=mask)
    tensor([[-3., -3., -4.],
            [ 0.,  0.,  0.]])
"""
...
Example::
    ...
    tensor([[ True, False,  True],
            [False, False, False]])
    >>> smith.masked._ops.log_softmax(input, 1, mask=mask)
...
Example::
    ...
    tensor([[ True, False,  True],
            [False, False, False]])
    >>> smith.masked._ops.logsumexp(input, 1, mask=mask)
...
Example::
    ...
    tensor([[ True, False,  True],
            [False, False, False]])
    >>> smith.masked._ops.mean(input, 1, mask=mask)
    tensor([-2., nan])
"""
...
Example::
    ...
    tensor([[ True, False,  True],
            [False, False, False]])
    >>> smith.masked._ops.median(input, 1, mask=mask)
    tensor([-3., nan])
"""
...
Example::
    ...
    tensor([[ True, False,  True],
            [False, False, False]])
    >>> smith.masked._ops.norm(input, 2.0, 1, mask=mask)
...
Example::
    ...
    tensor([[ True, False,  True],
            [False, False, False]])
    >>> smith.masked._ops.normalize(input, 2.0, 1, mask=mask)
...
Example::
    ...
    tensor([[ True, False,  True],
            [False, False, False]])
    >>> smith.masked._ops.prod(input, 1, mask=mask)
    tensor([3, 1])
"""
...
Example::
    ...
    tensor([[ True, False,  True],
            [False, False, False]])
    >>> smith.masked._ops.softmax(input, 1, mask=mask)
...
Example::
    ...
    tensor([[ True, False,  True],
            [False, False, False]])
    >>> smith.masked._ops.softmin(input, 1, mask=mask)
...
Example::
    ...
    tensor([[ True, False,  True],
            [False, False, False]])
    >>> smith.masked._ops.std(input, 1, False, mask=mask)
    tensor([1., nan])
"""
...
Example::
    ...
    tensor([[ True, False,  True],
            [False, False, False]])
    >>> smith.masked._ops.sum(input, 1, mask=mask)
    tensor([-4,  0])
"""
...
Example::
    ...
    tensor([[ True, False,  True],
            [False, False, False]])
    >>> smith.masked._ops.var(input, 1, False, mask=mask)
    tensor([1., nan])
"""
