...
from smith._C import ErrorReport
from smith._C._jit_tree_views import SourceRangeFactory
...
def get_source_lines_and_file(
    ...
    try:
        ...
        msg = (
            f"Can't get source for {obj}. SmithScript requires source access in "
