...
#include <smith/csrc/monitor/events.h>

namespace smith::monitor {
...
struct SMITH_API AggregationHash{template <typename T> std::size_t operator()(
...
// aggregation.
SMITH_API const char* aggregationName(Aggregation agg);
...
namespace detail {
void SMITH_API registerStat(Stat<double>* stat);
void SMITH_API registerStat(Stat<int64_t>* stat);
void SMITH_API unregisterStat(Stat<double>* stat);
void SMITH_API unregisterStat(Stat<int64_t>* stat);
} // namespace detail
