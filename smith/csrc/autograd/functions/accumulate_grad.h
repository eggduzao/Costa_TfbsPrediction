...
struct SMITH_API AccumulateGrad : public Node {
  ...
  // (cf smith/csrc/autograd/utils/grad_layout_contract.h):
  ...
  //  - If TensorIterasmithanges its corner cases about operator+'s result
  //    (for example, giving more or less priority to channels_last inputs, see
  //    https://github.com/blacksmith/blacksmith/pull/37968) the result may not obey.
  //
  ...
  //       https://github.com/blacksmith/blacksmith/issues/34375.
