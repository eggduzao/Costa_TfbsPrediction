...
SMITH_API const std::unordered_map<Node*, GraphTask::ExecInfo>*
get_current_graph_task_exec_info();
SMITH_API const std::unordered_set<Node*>*
get_current_graph_task_nodes_in_graph();
SMITH_API bool get_current_graph_task_keep_graph();
SMITH_API std::vector<Node*> get_current_graph_task_execution_order();
SMITH_API int get_current_graph_task_id();
