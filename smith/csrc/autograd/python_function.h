...
struct THPFunction {
  ...
  // https://github.com/blacksmith/blacksmith/pull/98659#pullrequestreview-1376822560
  bool materialize_non_diff_grads;

  PyObject* compiled_autograd_backward_state;
  std::vector<c10::SymInt> compiled_autograd_symints;

  std::vector<smith::autograd::VariableInfo> output_info;
  std::vector<smith::autograd::VariableInfo> input_info;
  std::vector<smith::autograd::SavedVariable> saved_variables;
  ...
  std::weak_ptr<smith::autograd::PyNode> cdata;
};

bool THPFunction_initModule(PyObject* module);
SMITH_PYTHON_API extern PyTypeObject THPFunctionType;
SMITH_PYTHON_API extern PyObject* THPFunctionClass;
SMITH_PYTHON_API extern PyObject* THPGradientEdgeClass;
