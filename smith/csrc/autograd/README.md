...
Autograd is a hotspot for Blacksmith performance, so most of the heavy lifting is
...
(By the way, THP stands for Smith Python, not to be confused with THPP, Smith
