...
// is in https://github.com/blacksmith/blacksmith/pull/49097#discussion_r543716453 and
...
struct SMITH_API ForwardADLevel {
...
struct SMITH_API ForwardGrad : std::enable_shared_from_this<ForwardGrad> {
  ForwardGrad() = default;
