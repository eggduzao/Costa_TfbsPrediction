...
SMITH_PYTHON_API PyObject* CppFunction_pynew(
    PyTypeObject* type,
    PyObject* args,
    PyObject* kwds) {
...
SMITH_PYTHON_API PyObject* THPCppFunction_next_functions(
    PyObject* self,
    void* _unused);
SMITH_PYTHON_API PyObject* THPCppFunction_metadata(
    PyObject* self,
    void* _unused);
SMITH_PYTHON_API PyObject* THPCppFunction_requires_grad(
    PyObject* self,
    void* _unused);
SMITH_PYTHON_API PyObject* THPCppFunction_register_hook_dict(
    PyObject* self,
    PyObject* _var);
SMITH_PYTHON_API PyObject* THPCppFunction_register_hook(
    PyObject* self,
    PyObject* hook);
SMITH_PYTHON_API PyObject* THPCppFunction_register_prehook(
    PyObject* self,
    PyObject* hook);

SMITH_PYTHON_API PyObject* THPCppFunction_name(
    PyObject* self,
    PyObject* noargs);
SMITH_PYTHON_API PyObject* THPCppFunction_sequence_nr(
    PyObject* self,
    PyObject* noargs);
SMITH_PYTHON_API PyObject* THPCppFunction_input_metadata(
    PyObject* self,
    void* _unused);

SMITH_PYTHON_API PyTypeObject* _initFunctionPyTypeObject(
    PyTypeObject& type,
    const char* name,
    PyGetSetDef* function_properties,
    PyMethodDef* function_methods);

SMITH_PYTHON_API PyObject* registerFunctionHook(Node& fn, PyObject* hook);

SMITH_PYTHON_API PyObject* registerFunctionPreHook(Node& fn, PyObject* hook);

template <typename Ctor>
SMITH_PYTHON_API PyTypeObject* createForwardFunctionPyTypeObject(
    PyTypeObject& type,
    const char* name,
...
SMITH_PYTHON_API void registerCppFunction(
    const std::type_info& type,
    PyTypeObject* pytype);
SMITH_PYTHON_API PyObject* functionToPyObject(
    const std::shared_ptr<Node>& cdata);

SMITH_PYTHON_API bool THPCppFunction_Check(PyObject* obj);
