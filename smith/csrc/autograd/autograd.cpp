...
// NB: This code duplicates existing logic at smith/autograd/__init__.py and
// smith._C._EngineBase.run_backward in smith/csrc/autograd/python_engine.cpp
// This is a purely C++ API for Autograd without any dependencies on python
// it can be exposed in Blacksmith C++ API and SmithScript. We will need to
