...
using smith::dynamo::autograd::CompiledNodeArgs;
using smith::dynamo::autograd::PackedArgs;
using smith::dynamo::autograd::SwapSavedVariables;

// Custom deleter to prevent stack overflows.
SMITH_API void deleteNode(Node* function);
...
// executed.
SMITH_API std::shared_ptr<Node> get_current_node();
...
// functions in Blacksmith's autograd machinery derive from this class and
...
// integration with the JIT and other parts of Blacksmith. Every `Node` has a
...
// number.
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
struct SMITH_API Node : std::enable_shared_from_this<Node> {
 public:
  ...
  bool should_compute_output(size_t output_edge_index) const {
    SMITH_CHECK(output_edge_index < num_outputs(), "Index out of range");
  ...
  // If this node is the AOTBackward node produced by smith.compile.
