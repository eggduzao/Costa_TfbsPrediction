 ...
 * of our tracing system, as `sizes` returns a smith.Size or an int. To
...
class SMITH_API SizeNode : public TsNode, public DimensionNode {
 public:
...
class SMITH_API SizeAdd : public TsNode, public DimensionNode {
 public:
...
class SMITH_API SizeMul : public TsNode, public DimensionNode {
 public:
...
class SMITH_API SizeDiv : public TsNode, public DimensionNode {
 public:
