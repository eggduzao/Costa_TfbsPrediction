...
class ToCopy : public smith::lazy::TsNode {
 public:
  ...
  smith::lazy::TSOpVector Lower(
    ...
    smith::lazy::TSOpVector _to_copy_out =
        smith::lazy::LowerTSBuiltin(function, op().op, arguments, kwarguments);
    SMITH_CHECK_EQ(_to_copy_out.size(), 1);
