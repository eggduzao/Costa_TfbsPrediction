...
SMITH_API std::vector<int64_t> ComputeArrayStrides(
    c10::ArrayRef<int64_t> sizes);

SMITH_API std::vector<at::Tensor> DataHandlesToTensors(
    c10::ArrayRef<BackendDataPtr> data_handles,
    at::ScalarType dest_element_type);

// Uploads an ATEN tensor data to the device and fetches the corresponding
// device data handle.
SMITH_API BackendDataPtr
...
SMITH_API std::vector<BackendDataPtr> CreateTensorsData(
...
// API returns true.
SMITH_API bool IsSpecialScalar(const at::Scalar& value);
