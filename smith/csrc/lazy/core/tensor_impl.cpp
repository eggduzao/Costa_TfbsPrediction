...
struct LTCGuardImpl : public c10::impl::DeviceGuardImplInterface {
  ...
  c10::Device exchangeDevice(c10::Device device) const override {
    SMITH_INTERNAL_ASSERT(device.type() == c10::DeviceType::Lazy);
...
void LTCTensorImpl::shallow_copy_from(
  ...
  SMITH_INTERNAL_ASSERT(ltc_impl);
  copy_tensor_metadata(
      /*src_impl=*/ltc_impl,
      /*dest_impl=*/this,
      /*version_counter=*/version_counter(),
...
bool LTCTensorImpl::is_strides_like_custom(
  ...
  SMITH_INTERNAL_ASSERT(memory_format != at::MemoryFormat::Contiguous);
  return false;
}

c10::SymBool LTCTensorImpl::sym_is_non_overlapping_and_dense_custom() const {
  // This should be true, but false as a temporary fix for a Blacksmith core issue,
  // according to https://github.com/blacksmith/xla/pull/2682.
  return false;
}
...
c10::SymBool LTCTensorImpl::sym_is_contiguous_custom(
  ...
  SMITH_CHECK(is_contiguous_, "Non-contiguous storage for lazy tensor");
