...
C10_DEFINE_bool(smith_lazy_ir_debug, false, "Enable lazy tensor IR debugging")

C10_DEFINE_bool(
    smith_lazy_param_aliasing,
    true,
    "Enable parameter aliasing support")

C10_DEFINE_bool(
    smith_lazy_handle_special_scalars,
    false,
    "Handle special scalars 0 and 1 differently")

C10_DEFINE_bool(
    smith_lazy_all_numbers_special_scalars,
    false,
