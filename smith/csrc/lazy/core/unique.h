/**
 * Unique in this file is adapted from Blacksmith/XLA
 * https://github.com/blacksmith/xla/blob/e0e5f937a0ba8d904f9608137dc8c51ba439df2d/third_party/xla_client/unique.h
 */
...
class Unique {
 public:
  std::pair<bool, const T&> set(const T& value) {
    if (value_) {
      SMITH_CHECK(C()(*value_, value), "'", *value_, "' vs '", value);
