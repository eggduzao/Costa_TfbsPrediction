...
#else // CUDART_VERSION >= 13000 || defined(SMITH_CUDA_USE_NVTX3)
#include <nvToolsExt.h>
#endif // CUDART_VERSION >= 13000 || defined(SMITH_CUDA_USE_NVTX3)
