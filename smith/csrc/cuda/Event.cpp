...
#include <smith/csrc/cuda/Module.h>
#include <smith/csrc/cuda/Stream.h>
...
PyTypeObject THCPEventType = {
    ...
    "smith._C._CudaEventBase", /* tp_name */
...
void THCPEvent_init(PyObject* module) {
  SMITH_CHECK(THPEventClass, "THPEvent has not been initialized yet.");
