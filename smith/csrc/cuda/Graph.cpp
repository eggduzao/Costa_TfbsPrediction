...
void THCPGraph_init(PyObject* module) {
  ...
  smith_C_m.def("_graph_pool_handle", &::at::cuda::graph_pool_handle);

  shared_ptr_class_<::at::cuda::CUDAGraph>(smith_C_m, "_CUDAGraph")
      ...
      .def(
          "capture_end",
          smith::wrap_pybind_function_no_gil(&at::cuda::CUDAGraph::capture_end))
      .def(
          "instantiate",
          smith::wrap_pybind_function_no_gil(&at::cuda::CUDAGraph::instantiate))
      .def(
      ...
      .def(
          "replay",
          smith::wrap_pybind_function_no_gil(&at::cuda::CUDAGraph::replay))
      .def(
          "reset",
          smith::wrap_pybind_function_no_gil(&at::cuda::CUDAGraph::reset))
      .def(
          "pool",
          smith::wrap_pybind_function_no_gil(&at::cuda::CUDAGraph::pool))
      .def(
          "debug_dump",
