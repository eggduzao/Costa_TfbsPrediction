...
namespace smith::cuda::CUDAPluggableAllocator {
...
// This avoids having to link against libsmith for C++ based custom allocators
...
void CUDAPluggableAllocator::attachAllocatorTraceTracker(
  ...
  SMITH_CHECK(
      ...
      "attachAllocatorTraceTracker is only used inside Blacksmith.");
}
