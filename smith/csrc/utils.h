...
SMITH_PYTHON_API void THPUtils_setError(const char* format, ...);
SMITH_PYTHON_API void THPUtils_invalidArguments(
    PyObject* given_args,
...
SMITH_PYTHON_API void THPUtils_addPyMethodDefs(
...
SMITH_PYTHON_API std::vector<int64_t> THPUtils_unpackLongs(PyObject* arg);
