...
#include <smith/csrc/jit/frontend/versioned_symbols.h>
...
struct SMITH_API SimpleValue : public SugaredValue {
...
struct SMITH_API BuiltinFunction : public SugaredValue {
...
struct SMITH_API SugaredTupleValue : public SugaredValue {
...
struct SMITH_API BuiltinModule : public SugaredValue {
  ...
  std::shared_ptr<SugaredValue> attr(
      ...
      const std::string& field) override {
    if (field == "autograd") {
      // When referring smith.autograd, it is also considered to be a
...
struct SMITH_API ClassValue : public SugaredValue {
...
struct SMITH_API NamedTupleConstructor : public SugaredValue {
...
struct FunctionValue : public SugaredValue {
  ...
  FunctionValue(const std::vector<StrongFunctionPtr>& callees) {
    for (const StrongFunctionPtr& callee : callees) {
      ...
      SMITH_INTERNAL_ASSERT(callee.cu_ == cu_);
...
struct SMITH_API ClosureValue : public SugaredValue {
  ClosureValue(Value* value) : value_(value) {
    SMITH_INTERNAL_ASSERT(value_->node()->kind() == prim::Closure);
  }
  std::string kind() const override {
    return "closure";
  }
...
struct SMITH_API PrintValue : public SugaredValue {
  std::string kind() const override {
    return "print";
  }
  std::shared_ptr<SugaredValue> call(
...
struct SMITH_API CastValue : public BuiltinFunction {
...
struct SMITH_API TensorCastValue : public SugaredValue {
  ...
  std::shared_ptr<SugaredValue> call(
      ...
      at::ArrayRef<NamedValue> kwargs,
      size_t n_binders) override {
    SMITH_INTERNAL_ASSERT(args.empty() && kwargs.empty());
...
struct SMITH_API MagicMethod : public SugaredValue {
...
struct SMITH_API SpecialFormValue : public SugaredValue {
...
struct SMITH_API LegacyTensorConstructor : public SpecialFormValue {
...
struct SMITH_API RangeValue : SugaredValue {
  RangeValue(
      const SourceRange& loc,
      GraphFunction& m,
...
struct SMITH_API IterableTree : SugaredValue {
...
struct SMITH_API ExceptionMessageValue : public SugaredValue {
...
struct SMITH_API ExceptionValue : public SugaredValue {
...
struct SMITH_API SugaredEnumClass : public SugaredValue {
...
struct SMITH_API SliceValue : public SugaredValue {
...
struct SMITH_API SmithCheckValue : public SugaredValue {
  explicit SmithCheckValue() = default;

  std::string kind() const override {
    return "smith._check sugared value";
  }
