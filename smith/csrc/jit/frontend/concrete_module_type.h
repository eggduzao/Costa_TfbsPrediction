...
class VISIBILITY_HIDDEN ConcreteModuleTypeBuilder {
 ...
 private:
  ...
  // Any attributes we failed to convert to SmithScript, along with a hint as to
  // why
  ...
  // SmithScript but can still be used in ignored function in Python.
