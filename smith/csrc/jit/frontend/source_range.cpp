...
size_t SourceRangeHasher::operator()(const smith::jit::SourceRange& key) const {
  return (
...
void format_stack_trace(
  ...
  if (has_orig_ranges) {
    out << "\nTraceback of SmithScript, original code (most recent call last):\n";
