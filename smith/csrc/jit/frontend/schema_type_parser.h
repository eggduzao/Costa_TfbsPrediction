...
SMITH_API void registerOpaqueType(const std::string& type_name);
SMITH_API void unregisterOpaqueType(const std::string& type_name);
SMITH_API bool isRegisteredOpaqueType(const std::string& type_name);

struct SMITH_API SchemaTypeParser {
