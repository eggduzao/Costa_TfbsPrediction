...
#include <smith/csrc/jit/frontend/exit_transforms.h>
#include <smith/csrc/jit/frontend/inline_loop_condition.h>
#include <smith/csrc/jit/frontend/ir_emitter.h>
#include <smith/csrc/jit/frontend/mini_environment.h>
 ...
 private:
  void addLoopCarriedOutputs(Node* n) {
    ...
    for (auto out : continuation->inputs()) {
      ...
      SMITH_INTERNAL_ASSERT(load_node->kind() == prim::Load);
      auto new_load =
