...
#include <smith/csrc/jit/mobile/debug_info.h>
...
// that appear in the original Blacksmith Model. These method correspond to Python
...
// A Smith Mobile Module is a representation of the model (trained in case
...
SMITH_API ModuleInfo get_module_info(const mobile::Module& module);
