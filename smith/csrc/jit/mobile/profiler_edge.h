...
#ifdef USE_KINETO
class SMITH_API KinetoEdgeCPUProfiler {
 public:
   ...
   *        which can profile blacksmith runtime in arbitrary scope.
 ...
 private:
  ...
  std::unique_ptr<smith::autograd::profiler::ProfilerResult> profiler_result_;
};

SMITH_API KinetoEdgeCPUProfiler* getCurrentEdgeProfiler();
