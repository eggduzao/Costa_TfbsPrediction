...
struct SMITH_API ExecutionState {
...
struct SMITH_API SymbolicShapePosition {
...
// `Method` (e.g. `forward`). It's similar as smith::jit::mobile::Function.
class SMITH_API Function {
 public:
...
// It's similar as smith::jit::mobile::CompilationUnit.
class SMITH_API CompilationUnit {
 public:
  ...
  // into the compiled SmithScript model file ahead-of-time on the host, and
