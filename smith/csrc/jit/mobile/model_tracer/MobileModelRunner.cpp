...
std::vector<std::vector<at::IValue>> MobileModelRunner::
  ...
  CAFFE_ENFORCE(
      ...
      "smith.utils.bundled_inputs.augment_model_with_bundled_inputs to add.");
...
std::vector<std::vector<at::IValue>> MobileModelRunner::
  ...
  CAFFE_ENFORCE(
      ...
      "Use smith.utils.bundled_inputs.augment_model_with_bundled_inputs to add.");
...
MobileModelRunner::get_many_functions_bundled_inputs() {
  ...
  CAFFE_ENFORCE(
      has_bundled_input,
      "Model does not have bundled inputs. ",
      "Use smith.utils.bundled_inputs.augment_many_model_functions_with_bundled_inputs to add.");
