...
#include <smith/csrc/jit/backends/backend_exception.h>
...
void InterpreterState::callFunction(smith::jit::Function& f, Stack& stack) {
  bool newFrame =
      ...
      switch (inst.op) {
        case OP: {
          ...
          if (inst.X < 0 ||
            ...
            SMITH_CHECK(false, "Can't load op with index: ", inst.X);
          }
        ...
        case INTERFACE_CALL: {
          if (inst.X < 0 ||
            ...
            SMITH_CHECK(false, "Can't load constant with index: ", inst.X);
          }
        ...
        case WARN: {
          ...
          // SMITH_WARN macro since SMITH_WARN fails to evaluate its arguments
        ...
        default:
          SMITH_CHECK(false, toString(inst.op), " is invalid.");
      }
