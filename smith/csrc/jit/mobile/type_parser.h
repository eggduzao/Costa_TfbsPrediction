...
class SMITH_API TypeParser {
 ...
 private:
  ...
  TypePtr parseSmithbindClassType();
...
SMITH_API TypePtr parseType(const std::string& pythonStr);

SMITH_API std::vector<TypePtr> parseType(std::vector<std::string>& pythonStr);
