...
class SMITH_API Function : public smith::jit::Function {
 public:
  ...
  smith::jit::Function& setSchema(c10::FunctionSchema schema) override;
...
SMITH_API std::string operator_str(const c10::OperatorName& opname);
