...
SMITH_API void PropagateShapesOnGraph(std::shared_ptr<Graph>& graph);
...
SMITH_API std::optional<ShapeComputeGraphMapping>
...
// information.
SMITH_API bool setSymbolicShapeAnalysisTestMode(bool value);
SMITH_API bool symbolicShapeAnalysisTestModeEnabled();
