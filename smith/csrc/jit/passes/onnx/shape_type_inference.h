...
SMITH_API void ONNXSetDynamicInputShape(
...
SMITH_API void ONNXAssignOutputShape(
    std::shared_ptr<Graph>& graph,
...
// when comparing blacksmith results with ONNX results, as they have different
...
SMITH_API void ONNXShapeTypeInference(
    Node* n,
...
void UpdateReliable(smith::jit::Node* n);
void UpdateShapeConstantIfReliable(smith::jit::Value* output);
