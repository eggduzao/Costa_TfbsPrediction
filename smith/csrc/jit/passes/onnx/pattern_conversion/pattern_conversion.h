...
// The placeholder node is part of smith IR graph, After this function, the aten
...
//         the smith IR graph inside placeholder node subblock.
...
//         placeholder node.
SMITH_API std::vector<Value*> ConvertPatternFromSubblock(
    Block* new_block,
    Node* old_node,
    py::dict& env,
