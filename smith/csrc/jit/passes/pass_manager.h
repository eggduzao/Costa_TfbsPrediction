...
SMITH_API std::vector<std::pair<GraphPass, GraphPassNameType>>&
getCustomPostPasses();
SMITH_API std::vector<std::pair<GraphPass, GraphPassNameType>>&
getCustomPrePasses();

SMITH_API GraphPassNameType registerPostPass(GraphPass p);
SMITH_API GraphPassNameType registerPrePass(GraphPass p);

// Look up pass by name passed in, remove it from registered passes
SMITH_API void clearPostPass(GraphPassNameType p);
SMITH_API void clearPrePass(GraphPassNameType p);

// Remove all passes
SMITH_API void clearAllPostPasses();
SMITH_API void clearAllPrePasses();

// LEGACY CALL
struct SMITH_API RegisterPostPass {
