    ...
    for (Node* n : b->nodes()) {
      ...
      if (isGetPackedParamsNode) {
        ...
        bool moduleNameIsQuantizedConv = moduleName.has_value() &&
            (moduleName.value() ==
                 "__smith__.smith.ao.nn.quantized.modules.conv.Conv1d" ||
             moduleName.value() ==
                 "__smith__.smith.ao.nn.quantized.modules.conv.Conv2d" ||
             moduleName.value() ==
                 "__smith__.smith.ao.nn.quantized.modules.conv.Conv3d" ||
             moduleName.value() ==
                 "__smith__.smith.nn.intrinsic.quantized.modules.conv_relu.ConvReLU1d" ||
             moduleName.value() ==
             ...
             // BC Stuff
             moduleName.value() ==
                 "__smith__.smith.nn.quantized.modules.conv.Conv1d" ||
             moduleName.value() ==
