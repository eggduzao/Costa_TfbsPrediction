 ...
 */
SMITH_API void InsertPrepackUnpack(std::shared_ptr<Graph>& graph);
 ...
 */
SMITH_API void InsertPrepackUnpack(Module& module);

SMITH_API script::Module Finalize(
    script::Module& module,
    QuantType quant_type = QuantType::STATIC,
    const std::vector<std::string>& preserved_attrs =
        std::vector<std::string>());

SMITH_API void FoldQuantizedPrepackingOps(Module& module);

SMITH_API Module FinalizeOnDevicePTQ(
    Module& module,
