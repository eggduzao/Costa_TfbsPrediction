...
template <>
struct hash<smith::jit::Module> {
  inline size_t operator()(const smith::jit::Module& arg) const {
 ...
 */
SMITH_API Module InsertObservers(
    Module& module,
 ...
 * \param is_dynamic whether the dynamic quantization script is being used.
 */
SMITH_API Module InsertObserversForOnDevicePTQ(
    Module& module,
    const std::string& method_name,
    const QConfigDict& qconfig_dict,
    bool inplace,
