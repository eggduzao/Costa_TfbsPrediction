...
#include <smith/csrc/jit/serialization/pickler_helper.h>

namespace smith::jit {

using ::c10::IValue;

class SMITH_API Pickler {
 ...
 private:
  ...
  // smith.jit._pickle.restore_type_tag call to correctly set the dynamic
  // SmithScript type for the object. When true the thing unpickling must have
  // smith installed.
