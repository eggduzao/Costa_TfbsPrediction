...
#ifndef FLATBUFFERS_GENERATED_MOBILEBYTECODE_SMITH_JIT_MOBILE_SERIALIZATION_H_
#define FLATBUFFERS_GENERATED_MOBILEBYTECODE_SMITH_JIT_MOBILE_SERIALIZATION_H_
...
template<> struct IValueUnionTraits<smith::jit::mobile::serialization::Int> {
  static const IValueUnion enum_value = IValueUnion::Int;
};

template<> struct IValueUnionTraits<smith::jit::mobile::serialization::Bool> {
  static const IValueUnion enum_value = IValueUnion::Bool;
};

template<> struct IValueUnionTraits<smith::jit::mobile::serialization::Double> {
  static const IValueUnion enum_value = IValueUnion::Double;
};

template<> struct IValueUnionTraits<smith::jit::mobile::serialization::ComplexDouble> {
  static const IValueUnion enum_value = IValueUnion::ComplexDouble;
};

template<> struct IValueUnionTraits<smith::jit::mobile::serialization::TensorMetadata> {
  static const IValueUnion enum_value = IValueUnion::TensorMetadata;
};

template<> struct IValueUnionTraits<smith::jit::mobile::serialization::String> {
  static const IValueUnion enum_value = IValueUnion::String;
};

template<> struct IValueUnionTraits<smith::jit::mobile::serialization::List> {
  static const IValueUnion enum_value = IValueUnion::List;
};

template<> struct IValueUnionTraits<smith::jit::mobile::serialization::Tuple> {
  static const IValueUnion enum_value = IValueUnion::Tuple;
};

template<> struct IValueUnionTraits<smith::jit::mobile::serialization::Dict> {
  static const IValueUnion enum_value = IValueUnion::Dict;
};

template<> struct IValueUnionTraits<smith::jit::mobile::serialization::Object> {
  static const IValueUnion enum_value = IValueUnion::Object;
};

template<> struct IValueUnionTraits<smith::jit::mobile::serialization::IntList> {
  static const IValueUnion enum_value = IValueUnion::IntList;
};

template<> struct IValueUnionTraits<smith::jit::mobile::serialization::DoubleList> {
  static const IValueUnion enum_value = IValueUnion::DoubleList;
};

template<> struct IValueUnionTraits<smith::jit::mobile::serialization::BoolList> {
  static const IValueUnion enum_value = IValueUnion::BoolList;
};

template<> struct IValueUnionTraits<smith::jit::mobile::serialization::Device> {
  static const IValueUnion enum_value = IValueUnion::Device;
};

template<> struct IValueUnionTraits<smith::jit::mobile::serialization::EnumValue> {
  static const IValueUnion enum_value = IValueUnion::EnumValue;
};

template<> struct IValueUnionTraits<smith::jit::mobile::serialization::Function> {
...
struct QuantizedSchema FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const smith::jit::mobile::serialization::TensorMetadata *scales() const {
    return GetPointer<const smith::jit::mobile::serialization::TensorMetadata *>(VT_SCALES);
  }
  smith::jit::mobile::serialization::TensorMetadata *mutable_scales() {
    return GetPointer<smith::jit::mobile::serialization::TensorMetadata *>(VT_SCALES);
  }
  const smith::jit::mobile::serialization::TensorMetadata *zero_points() const {
    return GetPointer<const smith::jit::mobile::serialization::TensorMetadata *>(VT_ZERO_POINTS);
  }
  smith::jit::mobile::serialization::TensorMetadata *mutable_zero_points() {
    return GetPointer<smith::jit::mobile::serialization::TensorMetadata *>(VT_ZERO_POINTS);
  }
  int32_t axis() const {
...
struct QuantizedSchemaBuilder {
  ...
  void add_scales(::flatbuffers::Offset<smith::jit::mobile::serialization::TensorMetadata> scales) {
    fbb_.AddOffset(QuantizedSchema::VT_SCALES, scales);
  }
  void add_zero_points(::flatbuffers::Offset<smith::jit::mobile::serialization::TensorMetadata> zero_points) {
...
inline ::flatbuffers::Offset<QuantizedSchema> CreateQuantizedSchema(
    ...
    ::flatbuffers::Offset<smith::jit::mobile::serialization::TensorMetadata> scales = 0,
    ::flatbuffers::Offset<smith::jit::mobile::serialization::TensorMetadata> zero_points = 0,
    int32_t axis = 0) {
...
struct TensorMetadata FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const smith::jit::mobile::serialization::QuantizedSchema *quantized_schema() const {
    return GetPointer<const smith::jit::mobile::serialization::QuantizedSchema *>(VT_QUANTIZED_SCHEMA);
  }
  smith::jit::mobile::serialization::QuantizedSchema *mutable_quantized_schema() {
    return GetPointer<smith::jit::mobile::serialization::QuantizedSchema *>(VT_QUANTIZED_SCHEMA);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct TensorMetadataBuilder {
  ...
  void add_quantized_schema(::flatbuffers::Offset<smith::jit::mobile::serialization::QuantizedSchema> quantized_schema) {
...
inline ::flatbuffers::Offset<TensorMetadata> CreateTensorMetadata(
    ...
    ::flatbuffers::Offset<smith::jit::mobile::serialization::QuantizedSchema> quantized_schema = 0) {
...
inline ::flatbuffers::Offset<TensorMetadata> CreateTensorMetadataDirect(
  ...
  return smith::jit::mobile::serialization::CreateTensorMetadata(
      _fbb,
...
inline ::flatbuffers::Offset<String> CreateStringDirect(
  ...
  return smith::jit::mobile::serialization::CreateString(
      _fbb,
      data__);
}
...
inline ::flatbuffers::Offset<Device> CreateDeviceDirect(
  ...
  return smith::jit::mobile::serialization::CreateDevice(
      _fbb,
      str__);
}
...
inline ::flatbuffers::Offset<List> CreateListDirect(
  ...
  return smith::jit::mobile::serialization::CreateList(
      _fbb,
      items__,
      annotation_str__);
}
...
inline ::flatbuffers::Offset<IntList> CreateIntListDirect(
  ...
  return smith::jit::mobile::serialization::CreateIntList(
      _fbb,
      items__);
}
...
inline ::flatbuffers::Offset<DoubleList> CreateDoubleListDirect(
  ...
  return smith::jit::mobile::serialization::CreateDoubleList(
      _fbb,
      items__);
}
...
inline ::flatbuffers::Offset<BoolList> CreateBoolListDirect(
  ...
  return smith::jit::mobile::serialization::CreateBoolList(
      _fbb,
      items__);
}
...
inline ::flatbuffers::Offset<Tuple> CreateTupleDirect(
    ...
    const std::vector<uint32_t> *items = nullptr) {
  auto items__ = items ? _fbb.CreateVector<uint32_t>(*items) : 0;
  return smith::jit::mobile::serialization::CreateTuple(
      _fbb,
      items__);
}
...
inline ::flatbuffers::Offset<Dict> CreateDictDirect(
  ...
  auto annotation_str__ = annotation_str ? _fbb.CreateString(annotation_str) : 0;
  return smith::jit::mobile::serialization::CreateDict(
      _fbb,
      keys__,
      values__,
      annotation_str__);
...
struct ObjectType FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  smith::jit::mobile::serialization::TypeType type() const {
    return static_cast<smith::jit::mobile::serialization::TypeType>(GetField<uint8_t>(VT_TYPE, 0));
  }
  bool mutate_type(smith::jit::mobile::serialization::TypeType _type = static_cast<smith::jit::mobile::serialization::TypeType>(0)) {
...
struct ObjectTypeBuilder {
  ...
  void add_type(smith::jit::mobile::serialization::TypeType type) {
...
inline ::flatbuffers::Offset<ObjectType> CreateObjectType(
    ...
    smith::jit::mobile::serialization::TypeType type = smith::jit::mobile::serialization::TypeType::UNSET,
...
inline ::flatbuffers::Offset<ObjectType> CreateObjectTypeDirect(
  ...
  return smith::jit::mobile::serialization::CreateObjectType(
      _fbb,
      type_name__,
      type,
      attr_names__);
...
inline ::flatbuffers::Offset<Object> CreateObjectDirect(
  ...
  return smith::jit::mobile::serialization::CreateObject(
      _fbb,
      type_index,
      state,
      attrs__,
...
inline ::flatbuffers::Offset<EnumValue> CreateEnumValueDirect(
    ...
    uint32_t value = 0) {
  auto type_name__ = type_name ? _fbb.CreateString(type_name) : 0;
  return smith::jit::mobile::serialization::CreateEnumValue(
      _fbb,
      type_name__,
      value);
}
...
inline ::flatbuffers::Offset<Operator> CreateOperatorDirect(
  ...
  return smith::jit::mobile::serialization::CreateOperator(
      _fbb,
      name__,
      overload_name__,
      num_args_serialized);
...
inline ::flatbuffers::Offset<Arg> CreateArgDirect(
  ...
  return smith::jit::mobile::serialization::CreateArg(
      _fbb,
      name__,
      type__,
      default_value);
...
struct Schema FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::Arg>> *arguments() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::Arg>> *>(VT_ARGUMENTS);
  }
  ::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::Arg>> *mutable_arguments() {
    return GetPointer<::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::Arg>> *>(VT_ARGUMENTS);
  }
  const ::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::Arg>> *returns() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::Arg>> *>(VT_RETURNS);
  }
  ::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::Arg>> *mutable_returns() {
    return GetPointer<::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::Arg>> *>(VT_RETURNS);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct SchemaBuilder {
  ...
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_arguments(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::Arg>>> arguments) {
    fbb_.AddOffset(Schema::VT_ARGUMENTS, arguments);
  }
  void add_returns(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::Arg>>> returns) {
...
inline ::flatbuffers::Offset<Schema> CreateSchema(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::Arg>>> arguments = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::Arg>>> returns = 0) {
...
inline ::flatbuffers::Offset<Schema> CreateSchemaDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    const std::vector<::flatbuffers::Offset<smith::jit::mobile::serialization::Arg>> *arguments = nullptr,
    const std::vector<::flatbuffers::Offset<smith::jit::mobile::serialization::Arg>> *returns = nullptr) {
  auto arguments__ = arguments ? _fbb.CreateVector<::flatbuffers::Offset<smith::jit::mobile::serialization::Arg>>(*arguments) : 0;
  auto returns__ = returns ? _fbb.CreateVector<::flatbuffers::Offset<smith::jit::mobile::serialization::Arg>>(*returns) : 0;
  return smith::jit::mobile::serialization::CreateSchema(
      _fbb,
      arguments__,
      returns__);
}
...
inline ::flatbuffers::Offset<DebugInfo> CreateDebugInfoDirect(
  ...
  return smith::jit::mobile::serialization::CreateDebugInfo(
      _fbb,
      debug_handle__);
}
...
struct Function FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::Vector<const smith::jit::mobile::serialization::Instruction *> *instructions() const {
    return GetPointer<const ::flatbuffers::Vector<const smith::jit::mobile::serialization::Instruction *> *>(VT_INSTRUCTIONS);
  }
  ::flatbuffers::Vector<const smith::jit::mobile::serialization::Instruction *> *mutable_instructions() {
    return GetPointer<::flatbuffers::Vector<const smith::jit::mobile::serialization::Instruction *> *>(VT_INSTRUCTIONS);
  }
  const ::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::Operator>> *operators() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::Operator>> *>(VT_OPERATORS);
  }
  ::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::Operator>> *mutable_operators() {
    return GetPointer<::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::Operator>> *>(VT_OPERATORS);
  }
  ...
  const smith::jit::mobile::serialization::Schema *schema() const {
    return GetPointer<const smith::jit::mobile::serialization::Schema *>(VT_SCHEMA);
  }
  smith::jit::mobile::serialization::Schema *mutable_schema() {
    return GetPointer<smith::jit::mobile::serialization::Schema *>(VT_SCHEMA);
  }
  const smith::jit::mobile::serialization::DebugInfo *debug_info() const {
    return GetPointer<const smith::jit::mobile::serialization::DebugInfo *>(VT_DEBUG_INFO);
  }
  smith::jit::mobile::serialization::DebugInfo *mutable_debug_info() {
    return GetPointer<smith::jit::mobile::serialization::DebugInfo *>(VT_DEBUG_INFO);
  }
...
struct FunctionBuilder {
  ...
  void add_instructions(::flatbuffers::Offset<::flatbuffers::Vector<const smith::jit::mobile::serialization::Instruction *>> instructions) {
    fbb_.AddOffset(Function::VT_INSTRUCTIONS, instructions);
  }
  void add_operators(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::Operator>>> operators) {
  ...
  void add_schema(::flatbuffers::Offset<smith::jit::mobile::serialization::Schema> schema) {
    fbb_.AddOffset(Function::VT_SCHEMA, schema);
  }
  void add_debug_info(::flatbuffers::Offset<smith::jit::mobile::serialization::DebugInfo> debug_info) {
...
inline ::flatbuffers::Offset<Function> CreateFunction(
    ...
    ::flatbuffers::Offset<::flatbuffers::Vector<const smith::jit::mobile::serialization::Instruction *>> instructions = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::Operator>>> operators = 0,
    ...
    ::flatbuffers::Offset<smith::jit::mobile::serialization::Schema> schema = 0,
    ::flatbuffers::Offset<smith::jit::mobile::serialization::DebugInfo> debug_info = 0,
...
inline ::flatbuffers::Offset<Function> CreateFunctionDirect(
    ...
    const std::vector<smith::jit::mobile::serialization::Instruction> *instructions = nullptr,
    const std::vector<::flatbuffers::Offset<smith::jit::mobile::serialization::Operator>> *operators = nullptr,
  ...
  auto instructions__ = instructions ? _fbb.CreateVectorOfStructs<smith::jit::mobile::serialization::Instruction>(*instructions) : 0;
  auto operators__ = operators ? _fbb.CreateVector<::flatbuffers::Offset<smith::jit::mobile::serialization::Operator>>(*operators) : 0;
  ...
  return smith::jit::mobile::serialization::CreateFunction(
      _fbb,
      qn__,
      instructions__,
      operators__,
...
inline ::flatbuffers::Offset<StorageData> CreateStorageDataDirect(
  ...
  return smith::jit::mobile::serialization::CreateStorageData(
      _fbb,
      data__);
}
...
struct IValue FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  smith::jit::mobile::serialization::IValueUnion val_type() const {
    return static_cast<smith::jit::mobile::serialization::IValueUnion>(GetField<uint8_t>(VT_VAL_TYPE, 0));
  }
  const void *val() const {
    return GetPointer<const void *>(VT_VAL);
  }
  template<typename T> const T *val_as() const;
  const smith::jit::mobile::serialization::Int *val_as_Int() const {
    return val_type() == smith::jit::mobile::serialization::IValueUnion::Int ? static_cast<const smith::jit::mobile::serialization::Int *>(val()) : nullptr;
  }
  const smith::jit::mobile::serialization::Bool *val_as_Bool() const {
    return val_type() == smith::jit::mobile::serialization::IValueUnion::Bool ? static_cast<const smith::jit::mobile::serialization::Bool *>(val()) : nullptr;
  }
  const smith::jit::mobile::serialization::Double *val_as_Double() const {
    return val_type() == smith::jit::mobile::serialization::IValueUnion::Double ? static_cast<const smith::jit::mobile::serialization::Double *>(val()) : nullptr;
  }
  const smith::jit::mobile::serialization::ComplexDouble *val_as_ComplexDouble() const {
    return val_type() == smith::jit::mobile::serialization::IValueUnion::ComplexDouble ? static_cast<const smith::jit::mobile::serialization::ComplexDouble *>(val()) : nullptr;
  }
  const smith::jit::mobile::serialization::TensorMetadata *val_as_TensorMetadata() const {
    return val_type() == smith::jit::mobile::serialization::IValueUnion::TensorMetadata ? static_cast<const smith::jit::mobile::serialization::TensorMetadata *>(val()) : nullptr;
  }
  const smith::jit::mobile::serialization::String *val_as_String() const {
    return val_type() == smith::jit::mobile::serialization::IValueUnion::String ? static_cast<const smith::jit::mobile::serialization::String *>(val()) : nullptr;
  }
  const smith::jit::mobile::serialization::List *val_as_List() const {
    return val_type() == smith::jit::mobile::serialization::IValueUnion::List ? static_cast<const smith::jit::mobile::serialization::List *>(val()) : nullptr;
  }
  const smith::jit::mobile::serialization::Tuple *val_as_Tuple() const {
    return val_type() == smith::jit::mobile::serialization::IValueUnion::Tuple ? static_cast<const smith::jit::mobile::serialization::Tuple *>(val()) : nullptr;
  }
  const smith::jit::mobile::serialization::Dict *val_as_Dict() const {
    return val_type() == smith::jit::mobile::serialization::IValueUnion::Dict ? static_cast<const smith::jit::mobile::serialization::Dict *>(val()) : nullptr;
  }
  const smith::jit::mobile::serialization::Object *val_as_Object() const {
    return val_type() == smith::jit::mobile::serialization::IValueUnion::Object ? static_cast<const smith::jit::mobile::serialization::Object *>(val()) : nullptr;
  }
  const smith::jit::mobile::serialization::IntList *val_as_IntList() const {
    return val_type() == smith::jit::mobile::serialization::IValueUnion::IntList ? static_cast<const smith::jit::mobile::serialization::IntList *>(val()) : nullptr;
  }
  const smith::jit::mobile::serialization::DoubleList *val_as_DoubleList() const {
    return val_type() == smith::jit::mobile::serialization::IValueUnion::DoubleList ? static_cast<const smith::jit::mobile::serialization::DoubleList *>(val()) : nullptr;
  }
  const smith::jit::mobile::serialization::BoolList *val_as_BoolList() const {
    return val_type() == smith::jit::mobile::serialization::IValueUnion::BoolList ? static_cast<const smith::jit::mobile::serialization::BoolList *>(val()) : nullptr;
  }
  const smith::jit::mobile::serialization::Device *val_as_Device() const {
    return val_type() == smith::jit::mobile::serialization::IValueUnion::Device ? static_cast<const smith::jit::mobile::serialization::Device *>(val()) : nullptr;
  }
  const smith::jit::mobile::serialization::EnumValue *val_as_EnumValue() const {
    return val_type() == smith::jit::mobile::serialization::IValueUnion::EnumValue ? static_cast<const smith::jit::mobile::serialization::EnumValue *>(val()) : nullptr;
  }
  const smith::jit::mobile::serialization::Function *val_as_Function() const {
    return val_type() == smith::jit::mobile::serialization::IValueUnion::Function ? static_cast<const smith::jit::mobile::serialization::Function *>(val()) : nullptr;
  }
  void *mutable_val() {
...
template<> inline const smith::jit::mobile::serialization::Int *IValue::val_as<smith::jit::mobile::serialization::Int>() const {
  return val_as_Int();
}

template<> inline const smith::jit::mobile::serialization::Bool *IValue::val_as<smith::jit::mobile::serialization::Bool>() const {
  return val_as_Bool();
}

template<> inline const smith::jit::mobile::serialization::Double *IValue::val_as<smith::jit::mobile::serialization::Double>() const {
  return val_as_Double();
}

template<> inline const smith::jit::mobile::serialization::ComplexDouble *IValue::val_as<smith::jit::mobile::serialization::ComplexDouble>() const {
  return val_as_ComplexDouble();
}

template<> inline const smith::jit::mobile::serialization::TensorMetadata *IValue::val_as<smith::jit::mobile::serialization::TensorMetadata>() const {
  return val_as_TensorMetadata();
}

template<> inline const smith::jit::mobile::serialization::String *IValue::val_as<smith::jit::mobile::serialization::String>() const {
  return val_as_String();
}

template<> inline const smith::jit::mobile::serialization::List *IValue::val_as<smith::jit::mobile::serialization::List>() const {
  return val_as_List();
}

template<> inline const smith::jit::mobile::serialization::Tuple *IValue::val_as<smith::jit::mobile::serialization::Tuple>() const {
  return val_as_Tuple();
}

template<> inline const smith::jit::mobile::serialization::Dict *IValue::val_as<smith::jit::mobile::serialization::Dict>() const {
  return val_as_Dict();
}

template<> inline const smith::jit::mobile::serialization::Object *IValue::val_as<smith::jit::mobile::serialization::Object>() const {
  return val_as_Object();
}

template<> inline const smith::jit::mobile::serialization::IntList *IValue::val_as<smith::jit::mobile::serialization::IntList>() const {
  return val_as_IntList();
}

template<> inline const smith::jit::mobile::serialization::DoubleList *IValue::val_as<smith::jit::mobile::serialization::DoubleList>() const {
  return val_as_DoubleList();
}

template<> inline const smith::jit::mobile::serialization::BoolList *IValue::val_as<smith::jit::mobile::serialization::BoolList>() const {
  return val_as_BoolList();
}

template<> inline const smith::jit::mobile::serialization::Device *IValue::val_as<smith::jit::mobile::serialization::Device>() const {
  return val_as_Device();
}

template<> inline const smith::jit::mobile::serialization::EnumValue *IValue::val_as<smith::jit::mobile::serialization::EnumValue>() const {
  return val_as_EnumValue();
}

template<> inline const smith::jit::mobile::serialization::Function *IValue::val_as<smith::jit::mobile::serialization::Function>() const {
...
struct IValueBuilder {
  ...
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_val_type(smith::jit::mobile::serialization::IValueUnion val_type) {
...
inline ::flatbuffers::Offset<IValue> CreateIValue(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    smith::jit::mobile::serialization::IValueUnion val_type = smith::jit::mobile::serialization::IValueUnion::NONE,
...
inline ::flatbuffers::Offset<ExtraFile> CreateExtraFileDirect(
  ...
  return smith::jit::mobile::serialization::CreateExtraFile(
      _fbb,
      name__,
      content__);
}
...
struct Module FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::ExtraFile>> *extra_files() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::ExtraFile>> *>(VT_EXTRA_FILES);
  }
  ::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::ExtraFile>> *mutable_extra_files() {
    return GetPointer<::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::ExtraFile>> *>(VT_EXTRA_FILES);
  }
  ...
  const ::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::IValue>> *ivalues() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::IValue>> *>(VT_IVALUES);
  }
  ::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::IValue>> *mutable_ivalues() {
    return GetPointer<::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::IValue>> *>(VT_IVALUES);
  }
  ...
  const ::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::StorageData>> *storage_data() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::StorageData>> *>(VT_STORAGE_DATA);
  }
  ::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::StorageData>> *mutable_storage_data() {
    return GetPointer<::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::StorageData>> *>(VT_STORAGE_DATA);
  }
  const ::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::ObjectType>> *object_types() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::ObjectType>> *>(VT_OBJECT_TYPES);
  }
  ::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::ObjectType>> *mutable_object_types() {
    return GetPointer<::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::ObjectType>> *>(VT_OBJECT_TYPES);
  }
  const ::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::ExtraFile>> *jit_sources() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::ExtraFile>> *>(VT_JIT_SOURCES);
  }
  ::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::ExtraFile>> *mutable_jit_sources() {
    return GetPointer<::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::ExtraFile>> *>(VT_JIT_SOURCES);
  }
...
struct ModuleBuilder {
  ...
  void add_extra_files(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::ExtraFile>>> extra_files) {
  ...
  void add_ivalues(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::IValue>>> ivalues) {
  ...
  void add_storage_data(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::StorageData>>> storage_data) {
    fbb_.AddOffset(Module::VT_STORAGE_DATA, storage_data);
  }
  void add_object_types(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::ObjectType>>> object_types) {
    fbb_.AddOffset(Module::VT_OBJECT_TYPES, object_types);
  }
  void add_jit_sources(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::ExtraFile>>> jit_sources) {
...
inline ::flatbuffers::Offset<Module> CreateModule(
    ...
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::ExtraFile>>> extra_files = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<uint32_t>> methods = 0,
    uint32_t state_obj = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::IValue>>> ivalues = 0,
    int32_t storage_data_size = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::StorageData>>> storage_data = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::ObjectType>>> object_types = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<smith::jit::mobile::serialization::ExtraFile>>> jit_sources = 0,
...
inline ::flatbuffers::Offset<Module> CreateModuleDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    uint32_t bytecode_version = 0,
    const std::vector<::flatbuffers::Offset<smith::jit::mobile::serialization::ExtraFile>> *extra_files = nullptr,
    const std::vector<uint32_t> *methods = nullptr,
    uint32_t state_obj = 0,
    const std::vector<::flatbuffers::Offset<smith::jit::mobile::serialization::IValue>> *ivalues = nullptr,
    int32_t storage_data_size = 0,
    const std::vector<::flatbuffers::Offset<smith::jit::mobile::serialization::StorageData>> *storage_data = nullptr,
    const std::vector<::flatbuffers::Offset<smith::jit::mobile::serialization::ObjectType>> *object_types = nullptr,
    const std::vector<::flatbuffers::Offset<smith::jit::mobile::serialization::ExtraFile>> *jit_sources = nullptr,
    const std::vector<uint32_t> *jit_constants = nullptr,
    uint32_t operator_version = 0,
    uint32_t mobile_ivalue_size = 0) {
  auto extra_files__ = extra_files ? _fbb.CreateVector<::flatbuffers::Offset<smith::jit::mobile::serialization::ExtraFile>>(*extra_files) : 0;
  auto methods__ = methods ? _fbb.CreateVector<uint32_t>(*methods) : 0;
  auto ivalues__ = ivalues ? _fbb.CreateVector<::flatbuffers::Offset<smith::jit::mobile::serialization::IValue>>(*ivalues) : 0;
  auto storage_data__ = storage_data ? _fbb.CreateVector<::flatbuffers::Offset<smith::jit::mobile::serialization::StorageData>>(*storage_data) : 0;
  auto object_types__ = object_types ? _fbb.CreateVector<::flatbuffers::Offset<smith::jit::mobile::serialization::ObjectType>>(*object_types) : 0;
  auto jit_sources__ = jit_sources ? _fbb.CreateVector<::flatbuffers::Offset<smith::jit::mobile::serialization::ExtraFile>>(*jit_sources) : 0;
  auto jit_constants__ = jit_constants ? _fbb.CreateVector<uint32_t>(*jit_constants) : 0;
  return smith::jit::mobile::serialization::CreateModule(
      _fbb,
      bytecode_version,
      extra_files__,
      methods__,
...
inline bool VerifyIValueUnion(::flatbuffers::Verifier &verifier, const void *obj, IValueUnion type) {
  switch (type) {
    ...
    case IValueUnion::Int: {
      return verifier.VerifyField<smith::jit::mobile::serialization::Int>(static_cast<const uint8_t *>(obj), 0, 8);
    }
    case IValueUnion::Bool: {
      return verifier.VerifyField<smith::jit::mobile::serialization::Bool>(static_cast<const uint8_t *>(obj), 0, 1);
    }
    case IValueUnion::Double: {
      return verifier.VerifyField<smith::jit::mobile::serialization::Double>(static_cast<const uint8_t *>(obj), 0, 8);
    }
    case IValueUnion::ComplexDouble: {
      return verifier.VerifyField<smith::jit::mobile::serialization::ComplexDouble>(static_cast<const uint8_t *>(obj), 0, 8);
    }
    case IValueUnion::TensorMetadata: {
      auto ptr = reinterpret_cast<const smith::jit::mobile::serialization::TensorMetadata *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case IValueUnion::String: {
      auto ptr = reinterpret_cast<const smith::jit::mobile::serialization::String *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case IValueUnion::List: {
      auto ptr = reinterpret_cast<const smith::jit::mobile::serialization::List *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case IValueUnion::Tuple: {
      auto ptr = reinterpret_cast<const smith::jit::mobile::serialization::Tuple *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case IValueUnion::Dict: {
      auto ptr = reinterpret_cast<const smith::jit::mobile::serialization::Dict *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case IValueUnion::Object: {
      auto ptr = reinterpret_cast<const smith::jit::mobile::serialization::Object *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case IValueUnion::IntList: {
      auto ptr = reinterpret_cast<const smith::jit::mobile::serialization::IntList *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case IValueUnion::DoubleList: {
      auto ptr = reinterpret_cast<const smith::jit::mobile::serialization::DoubleList *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case IValueUnion::BoolList: {
      auto ptr = reinterpret_cast<const smith::jit::mobile::serialization::BoolList *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case IValueUnion::Device: {
      auto ptr = reinterpret_cast<const smith::jit::mobile::serialization::Device *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case IValueUnion::EnumValue: {
      auto ptr = reinterpret_cast<const smith::jit::mobile::serialization::EnumValue *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case IValueUnion::Function: {
      auto ptr = reinterpret_cast<const smith::jit::mobile::serialization::Function *>(obj);
      return verifier.VerifyTable(ptr);
    }
    default: return true;
  }
...
inline const smith::jit::mobile::serialization::Module *GetModule(const void *buf) {
  return ::flatbuffers::GetRoot<smith::jit::mobile::serialization::Module>(buf);
}

inline const smith::jit::mobile::serialization::Module *GetSizePrefixedModule(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<smith::jit::mobile::serialization::Module>(buf);
}
...
inline smith::jit::mobile::serialization::Module *GetMutableSizePrefixedModule(void *buf) {
  return ::flatbuffers::GetMutableSizePrefixedRoot<smith::jit::mobile::serialization::Module>(buf);
}
...
inline bool VerifyModuleBuffer(
  ...
  return verifier.VerifyBuffer<smith::jit::mobile::serialization::Module>(ModuleIdentifier());
}

inline bool VerifySizePrefixedModuleBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<smith::jit::mobile::serialization::Module>(ModuleIdentifier());
}

inline void FinishModuleBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<smith::jit::mobile::serialization::Module> root) {
...
#endif  // FLATBUFFERS_GENERATED_MOBILEBYTECODE_SMITH_JIT_MOBILE_SERIALIZATION_H_
// @generated
