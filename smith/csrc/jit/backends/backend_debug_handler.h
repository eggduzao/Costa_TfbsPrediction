 ...
 *  mobile_debug info for blacksmith lite models. It will be used for raising
...
using BackendDebugInfoMapType =
    std::unordered_map<smith::jit::DebugHandleType, DebugInfoTuple>;
 ...
 */
class SMITH_API BackendDebugInfoRecorder {
 public:
