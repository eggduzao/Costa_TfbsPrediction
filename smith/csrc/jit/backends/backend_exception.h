...
namespace c10 {
class SMITH_API BackendRuntimeException : public c10::Error {
 public:
...
#define SMITH_DELEGATED_BACKEND_THROW(cond, msg, debug_handle) \
...
#define SMITH_DELEGATED_BACKEND_RETHROW(e, debug_handle) \
  do {                                                   \
