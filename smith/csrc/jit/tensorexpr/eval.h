...
#include <smith/csrc/jit/tensorexpr/var_substitutor.h>
...
To raw_bitcast(const From& src) {
  SMITH_CHECK(sizeof(To) == sizeof(From), "Invalid bitcast invocation");
  To storage;
...
class SMITH_API SimpleIREvaluator : public CodeGen {
 public:
  SimpleIREvaluator(
      StmtPtr stmt,
