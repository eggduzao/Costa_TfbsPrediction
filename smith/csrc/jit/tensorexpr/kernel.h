...
#include <smith/csrc/jit/tensorexpr/lowerings.h>
...
class SMITH_API TensorExprKernel {
 ...
 private:
  ...
  std::vector<ExprHandle> sizesForValue(const smith::jit::Value* v);
  ...
  ArgValue toArg(const smith::jit::Value* v) const;
  ExprHandle constant(const smith::jit::Value* v);

  Tensor computeValue(const smith::jit::Value* v);

  void bindConstant(const smith::jit::Value* v);
  ...
  Tensor bindInput(const smith::jit::Value* input);
  ...
  Tensor convertSymbolicOutputToCorrectStrides(smith::jit::Value* v);
  Tensor convertStaticShapeOutputToCorrectStrides(smith::jit::Value* v);
  ...
  std::vector<smith::jit::StrideInput>& getSymbolicStrideDesc(
  ...
  std::vector<smith::jit::StrideInput> tensorOutputStrideDesc_;
  ...
  std::unordered_map<const smith::jit::Value*, BufPtr> bufs_;
  std::unordered_map<const smith::jit::Value*, VarHandle> scalars_;
  std::unordered_map<const smith::jit::Value*, std::string> input_name_map_;
  ...
  std::unordered_map<const smith::jit::Value*, std::vector<ExprHandle>>
      known_sizes_;
  ...
  std::unordered_map<
      const smith::jit::Value*,
      std::vector<smith::jit::StrideInput>>
      symbolic_strides_;
...
SMITH_API int& getTECudaPointwiseLoopLevels();
SMITH_API int& getTECudaPointwiseBlockCount();
SMITH_API int& getTECudaPointwiseBlockSize();
SMITH_API bool& getTEGenerateBlockCode();
SMITH_API bool& getTEMustUseLLVMOnCPU();
SMITH_API bool fallbackAllowed();
SMITH_API bool setFallbackAllowed(bool value);
SMITH_API bool& getCatWoConditionals();
SMITH_API bool& getOptConditionals();

SMITH_API std::optional<at::Device> pickDeviceType(
