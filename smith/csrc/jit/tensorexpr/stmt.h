...
class SMITH_API Stmt : public std::enable_shared_from_this<Stmt> {
 public:
  Stmt() = default;
...
class SMITH_API Block : public StmtNode<Block> {
 public:
...
class SMITH_API Store : public StmtNode<Store> {
 public:
...
class SMITH_API Allocate : public StmtNode<Allocate> {
 public:
...
// buffer.
class SMITH_API PlacementAllocate : public StmtNode<PlacementAllocate> {
 public:
...
class SMITH_API Free : public StmtNode<Free> {
 public:
...
class SMITH_API FreeExt : public StmtNode<FreeExt> {
 public:
...
class SMITH_API Let : public StmtNode<Let> {
 public:
...
class SMITH_API Cond : public StmtNode<Cond> {
 public:
  static CondPtr make(
...
class SMITH_API For : public StmtNode<For> {
 public:
  VarPtr var() const {
    return var_;
  }
...
class SMITH_API AtomicAdd : public StmtNode<AtomicAdd> {
 public:
...
class SMITH_API SyncThreads : public StmtNode<SyncThreads> {
 public:
  SyncThreads() = default;
};
 ...
 */
class SMITH_API ExternalCall : public StmtNode<ExternalCall> {
 public:
...
class SMITH_API ExternalCallWithAlloc : public StmtNode<ExternalCallWithAlloc> {
 public:
