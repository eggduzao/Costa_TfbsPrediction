...
#include <smith/csrc/jit/tensorexpr/ir_mutator.h>
#include <smith/csrc/jit/tensorexpr/ir_visitor.h>
#include <smith/csrc/jit/tensorexpr/types.h>
#include <optional>
...
class SMITH_API Expr : public std::enable_shared_from_this<Expr> {
 public:
...
class SMITH_API Var : public ExprNode<Var> {
 public:
...
SMITH_API std::vector<ExprPtr> make_contiguous_strides(
    const std::vector<ExprHandle>& dims);
SMITH_API std::vector<ExprPtr> make_channels_last_strides(
    const std::vector<ExprHandle>& dims);

class SMITH_API Buf : public ExprNode<Buf> {
 public:
...
class SMITH_API BufHandle : public ExprHandle {
 public:
  BufHandle(
      const std::string& name_hint,
      const std::vector<ExprHandle>& dims,
...
class SMITH_API VarHandle : public ExprHandle {
 public:
...
SMITH_API ExprHandle sin(const ExprHandle& v);
SMITH_API ExprHandle cos(const ExprHandle& v);
SMITH_API ExprHandle tan(const ExprHandle& v);
SMITH_API ExprHandle asin(const ExprHandle& v);
SMITH_API ExprHandle acos(const ExprHandle& v);
SMITH_API ExprHandle atan(const ExprHandle& v);
SMITH_API ExprHandle sinh(const ExprHandle& v);
SMITH_API ExprHandle cosh(const ExprHandle& v);
SMITH_API ExprHandle tanh(const ExprHandle& v);
SMITH_API ExprHandle sigmoid(const ExprHandle& v);
SMITH_API ExprHandle exp(const ExprHandle& v);
SMITH_API ExprHandle expm1(const ExprHandle& v);
SMITH_API ExprHandle abs(const ExprHandle& v);
SMITH_API ExprHandle log(const ExprHandle& v);
SMITH_API ExprHandle fast_tanh(const ExprHandle& v);
SMITH_API ExprHandle fast_sigmoid(const ExprHandle& v);
SMITH_API ExprHandle fast_log(const ExprHandle& v);
SMITH_API ExprHandle log_vml(const ExprHandle& v);
SMITH_API ExprHandle log2(const ExprHandle& v);
SMITH_API ExprHandle log10(const ExprHandle& v);
SMITH_API ExprHandle log1p(const ExprHandle& v);
SMITH_API ExprHandle erf(const ExprHandle& v);
SMITH_API ExprHandle erfc(const ExprHandle& v);
SMITH_API ExprHandle sqrt(const ExprHandle& v);
SMITH_API ExprHandle rsqrt(const ExprHandle& v);
SMITH_API ExprHandle ceil(const ExprHandle& v);
SMITH_API ExprHandle floor(const ExprHandle& v);
SMITH_API ExprHandle round(const ExprHandle& v);
SMITH_API ExprHandle trunc(const ExprHandle& v);
SMITH_API ExprHandle frac(const ExprHandle& v);
SMITH_API ExprHandle lgamma(const ExprHandle& v);
SMITH_API ExprHandle atan2(const ExprHandle& v1, const ExprHandle& v2);
SMITH_API ExprHandle pow(const ExprHandle& v1, const ExprHandle& v2);
SMITH_API ExprHandle fmod(const ExprHandle& v1, const ExprHandle& v2);
SMITH_API ExprHandle remainder(const ExprHandle& v1, const ExprHandle& v2);
SMITH_API ExprHandle isnan(const ExprHandle& v1);
SMITH_API ExprHandle Relu(const ExprHandle& v1);

SMITH_API ExprHandle
ifThenElse(const ExprHandle& c, const ExprHandle& t, const ExprHandle& f);

SMITH_API ExprHandle expr_to_vec(const ExprHandle& v, int lanes);
