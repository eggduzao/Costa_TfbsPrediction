...
#include <smith/csrc/jit/tensorexpr/bounds_overlap.h>
#include <smith/csrc/jit/tensorexpr/eval.h>
#include <smith/csrc/jit/tensorexpr/hash_provider.h>
...
class SMITH_API SimplifierUnderContext : public IRMutator {
 public:
...
class SMITH_API PolynomialBase : public IRMutator {
 public:
...
class SMITH_API PolynomialTransformer : public PolynomialBase {
 public:
...
class SMITH_API TermExpander : public PolynomialBase {
...
SMITH_API bool exprEquals(const ExprPtr& A, const ExprPtr& B);
