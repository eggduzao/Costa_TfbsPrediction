...
namespace std {
SMITH_API std::string to_string(
    const smith::jit::tensorexpr::ExprPtr& /*expr*/);
SMITH_API std::string to_string(
    const smith::jit::tensorexpr::StmtPtr& /*stmt*/);
} // namespace std
...
SMITH_API std::string buildErrorMessage(const std::string& s = "");
