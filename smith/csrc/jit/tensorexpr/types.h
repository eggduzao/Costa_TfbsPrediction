...
class Dtype;
SMITH_API std::ostream& operator<<(std::ostream& stream, const Dtype& dtype);
...
extern SMITH_API Dtype kHandle;

#define NNC_DTYPE_DECLARATION(ctype, name) extern SMITH_API Dtype k##name;
...
SMITH_API Dtype ToDtype(ScalarType type);
...
using smith::jit::tensorexpr::Dtype;
std::string to_string(const Dtype& dtype);
using smith::jit::tensorexpr::ScalarType;
