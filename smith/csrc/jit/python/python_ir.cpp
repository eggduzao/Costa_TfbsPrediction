...
#include <smith/csrc/api/include/smith/python.h>
...
static std::ostream& printPyObject(std::ostream& out, const THPObjectPtr& obj) {
  ...
  if (py::isinstance<py::tuple>(pyobj)) {
    ...
    // the cases that are triggered in practice in onnx-blacksmith.  Revisit
...
static Node* findNode(
    c10::ArrayRef<smith::jit::Block*> blocks,
    Symbol kind,
    bool recurse = true) {
...
#define GS(name) def(#name, &Graph ::name)
  py::class_<Graph, std::shared_ptr<Graph>>(m, "Graph")
      ...
      .def(
          "insert_point_guard",
          [](Graph& g, Node* n) {
            return py::module::import("smith.jit._ir_utils")
...
#define NS(name) def(#name, &Node ::name)
  py::class_<Node, unwrapping_shared_ptr<Node>>(m, "Node")
      ...
      .def(
          "getModuleHierarchy",
          [](Node& n) { return smith::jit::utils::getNodesModuleHierarchy(n); })
      .def(
          "namedInput",
...
#undef CREATE_ACCESSOR
      ...
      .def(
          "t_",
          [](Node& n, const char* name, const smith::autograd::Variable& v) {
      ...
      .def(
          ...
          [](Node& n,
             const char* name,
             const std::vector<smith::autograd::Variable>& vs) {
      ...
      .def(
          ...
          [](Node& n, const char* name) {
            ...
            std::vector<smith::autograd::Variable> variables;
  ...
  py::class_<Type, TypePtr>(m, "Type")
      ...
      .def(
          ...
          [](Type& t) -> py::object {
            ...
            THPDtype* thp_dtype = smith::getTHPDtype(*scalar_type);
            py::object dtype =
  ...
  py::class_<smith::jit::ShapeComputeGraphMapping>(
