...
class unwrapping_shared_ptr {
  static_assert(
      std::is_same_v<T, smith::jit::Value> ||
          std::is_same_v<T, smith::jit::Node> ||
          std::is_same_v<T, smith::jit::Block>,
      "unwrapping type only defined for Graph object types");

 private:
  std::shared_ptr<smith::jit::Wrap<T>> impl;
...
PYBIND11_DECLARE_HOLDER_TYPE(T, smith::jit::unwrapping_shared_ptr<T>, true)
...
#define CREATE_UNWRAPPING_CASTER(Class)                                                   \
  ...
  struct type_caster<Class> : public type_caster_base<Class> {                            \
   public:                                                                                \
    using type = Class;                                                                   \
    using holder_type = smith::jit::unwrapping_shared_ptr<Class>;                         \
                                                                                          \
...
CREATE_UNWRAPPING_CASTER(smith::jit::Node);
CREATE_UNWRAPPING_CASTER(smith::jit::Value);
CREATE_UNWRAPPING_CASTER(smith::jit::Block);

#undef CREATE_UNWRAPPING_CASTER

template <>
struct type_caster<smith::jit::IValue> {
 public:
  // NOLINTNEXTLINE(cppcoreguidelines-non-private-member-variables-in-classes)
  PYBIND11_TYPE_CASTER(smith::jit::IValue, _("IValue"));

  bool load(handle src, bool /*unused*/) {
    try {
      value = smith::jit::toTypeInferredIValue(src);
      return true;
    } catch (std::exception&) {
      return false;
    }
  ...
  static handle cast(
      smith::jit::IValue src,
      return_value_policy /* policy */,
      handle /* parent */) {
    return smith::jit::toPyObject(std::move(src)).release();
  }
};

template <>
struct type_caster<smith::jit::Symbol> {
 public:
  // NOLINTNEXTLINE(cppcoreguidelines-non-private-member-variables-in-classes)
  PYBIND11_TYPE_CASTER(smith::jit::Symbol, _("Symbol"));
  ...
  bool load(handle src, bool /*unused*/) {
    ...
    value = smith::jit::Symbol::fromQualString(src_str);
    return true;
  }

  static handle cast(
      smith::jit::Symbol src,
      return_value_policy /* policy */,
      handle /* parent */) {
...
template <>
struct type_caster<smith::jit::AttributeKind> {
 public:
  // NOLINTNEXTLINE(cppcoreguidelines-non-private-member-variables-in-classes)
  PYBIND11_TYPE_CASTER(smith::jit::AttributeKind, _("AttributeKind"));
  ...
  static handle cast(
      smith::jit::AttributeKind src,
      return_value_policy /* policy */,
      handle /* parent */) {
    return py::cast(
               std::string(smith::jit::toString(src)),
...
using ListCasterBase = pybind11::detail::
    list_caster<std::vector<smith::jit::Node*>, smith::jit::Node*>;
template <>
struct type_caster<std::vector<smith::jit::Node*>> : ListCasterBase {
  static handle cast(
      const std::vector<smith::jit::Node*>& src,
