...
// Used for desugaring uses of the smith.cuda module. All the CUDA APIs with
// smith.cuda.* are resolved using CUDAPythonModuleValue.
  ...
  explicit PythonExceptionValue(const py::object& exception_class)
      : ExceptionValue(
        ...
        exception_class_qualified_name_(
            py::str(py::module::import("smith._jit_internal")
