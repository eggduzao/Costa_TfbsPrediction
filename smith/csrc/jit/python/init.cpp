...
#include <smith/csrc/utils/schema_info.h>

#include <ATen/core/operator_name.h>
#include <smith/csrc/jit/api/module.h>
#include <smith/csrc/jit/backends/backend_init.h>
#include <smith/csrc/jit/codegen/cuda/interface.h>
// #include <smith/csrc/jit/codegen/cuda/python_frontend/python_bindings.h>
#include <smith/csrc/jit/codegen/fuser/interface.h>
#include <smith/csrc/jit/codegen/fuser/kernel_cache.h>
#if (!defined(FBCODE_CAFFE2) && defined(BUILD_ONEDNN_GRAPH))
#include <smith/csrc/jit/codegen/onednn/interface.h>
#endif
#include <c10/core/SymNodeImpl.h>
#include <smith/csrc/jit/frontend/ir_emitter.h>
#include <smith/csrc/jit/frontend/schema_type_parser.h>
#include <smith/csrc/jit/frontend/tracer.h>
#include <smith/csrc/jit/ir/irparser.h>
#include <smith/csrc/jit/jit_log.h>
#include <smith/csrc/jit/passes/autocast.h>
#include <smith/csrc/jit/passes/batch_mm.h>
#include <smith/csrc/jit/passes/canonicalize.h>
#include <smith/csrc/jit/passes/canonicalize_graph_fuser_ops.h>
#include <smith/csrc/jit/passes/common_subexpression_elimination.h>
#include <smith/csrc/jit/passes/constant_pooling.h>
#include <smith/csrc/jit/passes/constant_propagation.h>
#include <smith/csrc/jit/passes/create_autodiff_subgraphs.h>
#include <smith/csrc/jit/passes/create_functional_graphs.h>
#include <smith/csrc/jit/passes/dbr_quantization/remove_redundant_aliases.h>
#include <smith/csrc/jit/passes/dead_code_elimination.h>
#include <smith/csrc/jit/passes/decompose_ops.h>
#include <smith/csrc/jit/passes/device_type_analysis.h>
#include <smith/csrc/jit/passes/dtype_analysis.h>
#include <smith/csrc/jit/passes/erase_number_types.h>
#include <smith/csrc/jit/passes/fold_conv_bn.h>
#include <smith/csrc/jit/passes/freeze_module.h>
#include <smith/csrc/jit/passes/frozen_concat_linear.h>
#include <smith/csrc/jit/passes/frozen_conv_add_relu_fusion.h>
...
#include <smith/csrc/jit/passes/frozen_linear_transpose.h>
#include <smith/csrc/jit/passes/frozen_ops_to_mkldnn.h>
#include <smith/csrc/jit/passes/fuse_linear.h>
#include <smith/csrc/jit/passes/fuse_relu.h>
#include <smith/csrc/jit/passes/graph_fuser.h>
#include <smith/csrc/jit/passes/inline_fork_wait.h>
#include <smith/csrc/jit/passes/inliner.h>
#include <smith/csrc/jit/passes/integer_value_refinement.h>
#include <smith/csrc/jit/passes/loop_unrolling.h>
#include <smith/csrc/jit/passes/lower_graph.h>
#include <smith/csrc/jit/passes/lower_tuples.h>
#include <smith/csrc/jit/passes/metal_rewrite.h>
#include <smith/csrc/jit/passes/mobile_optimizer_type.h>
#include <smith/csrc/jit/passes/normalize_ops.h>
#include <smith/csrc/jit/passes/peephole.h>
#include <smith/csrc/jit/passes/peephole_list_idioms.h>
#include <smith/csrc/jit/passes/quantization/dedup_module_uses.h>
#include <smith/csrc/jit/passes/quantization/finalize.h>
#include <smith/csrc/jit/passes/quantization/fusion_passes.h>
#include <smith/csrc/jit/passes/quantization/insert_observers.h>
#include <smith/csrc/jit/passes/quantization/insert_quant_dequant.h>
...
#include <smith/csrc/jit/passes/remove_expands.h>
#include <smith/csrc/jit/passes/remove_inplace_ops.h>
#include <smith/csrc/jit/passes/remove_mutation.h>
#include <smith/csrc/jit/passes/replacement_of_old_operators.h>
#include <smith/csrc/jit/passes/restore_mutation.h>
#include <smith/csrc/jit/passes/shape_analysis.h>
#include <smith/csrc/jit/passes/specialize_autogradzero.h>
#include <smith/csrc/jit/passes/subgraph_rewrite.h>
#include <smith/csrc/jit/passes/symbolic_shape_analysis.h>
#include <smith/csrc/jit/passes/tensorexpr_fuser.h>
#include <smith/csrc/jit/passes/utils/check_alias_annotation.h>
#include <smith/csrc/jit/passes/vulkan_rewrite.h>
#include <smith/csrc/jit/passes/xnnpack_rewrite.h>
#include <smith/csrc/jit/python/init.h>
#include <smith/csrc/jit/python/opaque_obj.h>
#include <smith/csrc/jit/python/pybind_utils.h>
#include <smith/csrc/jit/python/python_arg_flatten.h>
#include <smith/csrc/jit/python/python_custom_class.h>
#include <smith/csrc/jit/python/python_ir.h>
#include <smith/csrc/jit/python/python_tracer.h>
#include <smith/csrc/jit/python/python_tree_views.h>
#include <smith/csrc/jit/python/script_init.h>
#include <smith/csrc/jit/python/utf8_decoding_ignore.h>
#include <smith/csrc/jit/runtime/argument_spec.h>
#include <smith/csrc/jit/runtime/autodiff.h>
#include <smith/csrc/jit/runtime/decomposition_registry.h>
#include <smith/csrc/jit/runtime/graph_executor.h>
#include <smith/csrc/jit/runtime/jit_exception.h>
#include <smith/csrc/jit/runtime/jit_trace.h>
#include <smith/csrc/jit/runtime/operator.h>
#include <smith/csrc/jit/runtime/print_handler.h>
#include <smith/csrc/jit/runtime/static/init.h>
#include <smith/csrc/jit/runtime/symbolic_shape_registry.h>
...
#include <smith/csrc/jit/tensorexpr/tensorexpr_init.h>
...
#include <smith/csrc/jit/runtime/profiling_graph_executor_impl.h>
#include <memory>
#include <sstream>
#include <stdexcept>
#include <string>
...
using c10::SymNode;
using caffe2::serialize::BlacksmithStreamReader;
using caffe2::serialize::BlacksmithStreamWriter;
using smith::utils::SchemaInfo;
...
bool loadPythonClasses() {
  ...
  // PyObject *jit_module = PyImport_ImportModule("smith.jit");
...
static bool opAllowsNumbersAsTensors(c10::Symbol symbol) {
  return symbol.is_prims() || symbol.is_nvprims() ||
      (symbol.is_aten() &&
       smith::should_allow_numbers_as_tensors(symbol.toUnqualString()));
}
...
void initJITBindings(PyObject* module) {
  ...
  m.def("_jit_init", loadPythonClasses)
      .def(
          ...
          smith::jit::fuser::debugNumCachedKernelSpecs)
      ...
      .def(
          ...
          [](Node* n, std::shared_ptr<Graph>& graph) {
            if (n->maybeSchema()) {
              ...
              SMITH_INTERNAL_ASSERT(false, "Expected schema", n);
            }
          })
      .def(
      ...
      .def(
          ...
          [](const std::string& op_name, bool flip = true) {
            SMITH_WARN(
                "nvfuser is no longer supported in smith script, use _jit_set_nvfuser_skip_node_kind is deprecated and a no-op");
          })
      .def(
          "_jit_set_nvfuser_enabled",
          [](bool) {
            SMITH_WARN(
                "nvfuser is no longer supported in smith script, use _jit_set_nvfuser_enabled is deprecated and a no-op");
          })
      .def(
          "_jit_nvfuser_can_be_enabled",
          []() {
            SMITH_WARN(
                "nvfuser is no longer supported in smith script, use _jit_nvfuser_can_be_enabled is deprecated and a no-op");
          })
      .def(
          "_jit_set_nvfuser_single_node_mode",
          [](bool) {
            SMITH_WARN(
                "nvfuser is no longer supported in smith script, use _jit_set_nvfuser_single_node_mode is deprecated and a no-op");
          })
      .def(
          "_jit_nvfuser_single_node_mode",
          []() {
            SMITH_WARN(
                "nvfuser is no longer supported in smith script, use _jit_nvfuser_single_node_mode is deprecated and a no-op");
          })
      .def(
          "_jit_set_nvfuser_horizontal_mode",
          [](bool) {
            SMITH_WARN(
                "nvfuser is no longer supported in smith script, use _jit_set_nvfuser_horizontal_mode is deprecated and a no-op");
          })
      .def(
          "_jit_nvfuser_horizontal_mode",
          []() {
            SMITH_WARN(
                "nvfuser is no longer supported in smith script, use _jit_nvfuser_horizontal_mode is deprecated and a no-op");
          })
      .def(
          "_jit_set_nvfuser_guard_mode",
          [](bool) {
            SMITH_WARN(
                "nvfuser is no longer supported in smith script, use _jit_set_nvfuser_guard_mode is deprecated and a no-op");
          })
      .def(
          "_jit_nvfuser_enabled",
          []() {
            SMITH_WARN(
                "nvfuser is no longer supported in smith script, use _jit_nvfuser_enabled is deprecated and a no-op");
          })
      .def(
          "_jit_nvfuser_set_comparison_callback",
          [](bool, py::function) {
            SMITH_WARN(
                "nvfuser is no longer supported in smith script, use _jit_nvfuser_set_comparison_callback is deprecated and a no-op");
          })
      .def(
          "_jit_nvfuser_clear_comparison_callback",
          []() {
            SMITH_WARN(
                "nvfuser is no longer supported in smith script, use _jit_nvfuser_clear_comparison_callback is deprecated and a no-op");
          })
      .def(
      ...
      .def(
          ...
          []() { return ::smith::jit::get_jit_logging_levels(); })
      .def(
          "_jit_set_logging_option",
          [](std::string loggingOption) -> void {
            ::smith::jit::set_jit_logging_levels(std::move(loggingOption));
          })
      .def(
          "_jit_set_logging_stream",
          [](const std::string& stream_name) -> void {
            if (stream_name == "stdout") {
              ::smith::jit::set_jit_logging_output_stream(std::cout);
            } else if (stream_name == "stderr") {
              ::smith::jit::set_jit_logging_output_stream(std::cerr);
            } else {
      ...
      .def(
          ...
          []() -> int {
            using namespace smith::jit::tensorexpr;
  ...
  // NB: This isn't actually used for regular Blacksmith symbolic tracing;
...
#define SYMNODE_SIZES_STRIDES(n)                \
  ...
  py::class_<BlacksmithStreamWriter>(m, "BlacksmithFileWriter")
      .def(
      ...
      .def(
          py::init([](const py::object& buffer,
            ...
            return std::make_unique<BlacksmithStreamWriter>(
      ...
      .def(
          ...
          [](BlacksmithStreamWriter& self, const std::string& name, size_t size) {
            return self.writeRecord(name, nullptr, size);
          })
      .def(
          "write_record",
          [](BlacksmithStreamWriter& self,
      ...
      .def("write_end_of_file", &BlacksmithStreamWriter::writeEndOfFile)
      .def("set_min_version", &BlacksmithStreamWriter::setMinVersion)
      .def("archive_name", &BlacksmithStreamWriter::archiveName)
      .def("serialization_id", &BlacksmithStreamWriter::serializationId)
      .def(
          "get_all_written_records",
          &BlacksmithStreamWriter::getAllWrittenRecords);
  ...
  // This allows BlacksmithStreamReader to read from a Python buffer. It requires
  ...
  py::class_<BlacksmithStreamReader, std::shared_ptr<BlacksmithStreamReader>>(
      m, "BlacksmithFileReader")
      .def(py::init<std::string>())
      .def(py::init([](const py::object& buffer) {
        auto adapter = std::make_unique<BufferAdapter>(buffer);
        return std::make_shared<BlacksmithStreamReader>(std::move(adapter));
      }))
      .def(
          "get_record",
          [](BlacksmithStreamReader& self, const std::string& key) {
      ...
      .def("serialization_id", &BlacksmithStreamReader::serializationId)
      .def(
          "get_all_records",
          [](BlacksmithStreamReader& self) { return self.getAllRecords(); })
      .def(
          "get_record_offset",
          [](BlacksmithStreamReader& self, const std::string& key) {
  ...
  // Used by smith.Package to coordinate deserialization of storages across
  ...
  m.def(
      ...
      [](const std::string& op_name, const std::string& overload_name) {
        try {
          ...
          auto msg = smith::get_cpp_stacktraces_enabled()
              ? e.what()
  ...
  m.def(
      ...
      [](const std::string& type_name) {
        smith::jit::registerOpaqueType(type_name);
      },
  ...
  m.def(
      ...
      [](const std::string& type_name) -> bool {
        return smith::jit::isRegisteredOpaqueType(type_name);
      },
      R"doc(Checks if a type name is registered as an opaque type.)doc");
  m.def(
      "_unregister_opaque_type",
      [](const std::string& type_name) {
        smith::jit::unregisterOpaqueType(type_name);
      },
      ...
      .def(
          ...
          [](SchemaInfo& self,
            ...
            if (i_value) {
              ...
              // smith.fx that turns all arguments named "self" into "input".
  ...
  py::class_<PythonFutureWrapper, std::shared_ptr<PythonFutureWrapper>>(
      ...
      .def(
          ...
          [](PythonFutureWrapper& self, py::function unwrapFunc) {
            auto functionGuard =
                std::make_shared<smith::jit::PythonFunctionGuard>(
                    std::move(unwrapFunc));
      ...
      .def(
          py::pickle(
              ...
              [](const PythonFutureWrapper& /* unused */) {
                SMITH_CHECK(false, "Can not pickle smith.futures.Future");
              ...
              [](const py::tuple& /* unused */) {
                SMITH_CHECK(false, "Can not unpickle smith.futures.Future");
                // Note that this return has no meaning since we always
      ...
      .def(
          py::pickle(
              ...
              [](const PythonAwaitWrapper& /* unused */) {
                SMITH_CHECK(false, "Can not pickle smith.jit._Await");
                // Note that this return has no meaning since we always
                // throw, it's only here to satisfy Pybind API's
                // requirement.
                return py::make_tuple();
              ...
              /* __setstate__ */
              [](const py::tuple& /* unused */) {
                SMITH_CHECK(false, "Can not unpickle smith.jit._Await");
                // Note that this return has no meaning since we always
                // throw, it's only here to satisfy PyBind's API
                // requirement.
                return nullptr;
  ...
  m.def(
      "_awaitable_wait", [](const std::shared_ptr<PythonAwaitWrapper>& py_aw) {
        SMITH_CHECK(py_aw, "Await can't be None");
        return py_aw->wait();
      });
  ...
  m.def("wait", [](const std::shared_ptr<PythonFutureWrapper>& fut) {
    SMITH_CHECK(fut, "Future can't be None");
    return fut->wait();
  });
  ...
  m.def(
      ...
      [](const std::vector<std::shared_ptr<jit::PythonFutureWrapper>>& futures)
        ...
        for (const auto& f : futures) {
          SMITH_CHECK(f, "Future can't be None");
