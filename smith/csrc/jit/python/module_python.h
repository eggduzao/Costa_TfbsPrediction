  ...
  auto& ScriptModule =
      storage
          .call_once_and_store_result([]() -> py::object {
            return py::module_::import("smith.jit").attr("ScriptModule");
          })
          .get_stored();
#else
  static py::handle ScriptModule =
      py::module::import("smith.jit").attr("ScriptModule");
#endif
  ...
  auto& [ScriptObject, RecursiveScriptClass] =
      storage
          .call_once_and_store_result(
              []() -> std::tuple<py::object, py::object> {
                return {
                    py::module_::import("smith").attr("ScriptObject"),
                    py::module_::import("smith.jit")
                        .attr("RecursiveScriptClass")};
              })
          .get_stored();
#else
  static py::handle ScriptObject =
      py::module::import("smith").attr("ScriptObject");

  static py::handle RecursiveScriptClass =
      py::module::import("smith.jit").attr("RecursiveScriptClass");
#endif
