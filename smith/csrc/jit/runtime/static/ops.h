...
SMITH_DECLARE_REGISTRY(SROperatorRegistry, SROperatorFunctor);
...
SMITH_DECLARE_REGISTRY(SRNativeOperatorRegistry, SROperatorFunctor);
...
inline void fastResizeToZero(at::Tensor& t) {
  ...
  SMITH_INTERNAL_ASSERT_DEBUG_ONLY(checkResizedDataPtr(t));
}
...
inline bool sr_schema_check(smith::jit::Node* /*unused*/) {
  return true;
}
