...
// This number is a heuristic determined with blacksmith/benchmark
...
void initStaticModuleBindings(PyObject* module) {
      ...
      .def(
          ...
          [](StaticModule& self,
            ...
            for (const auto& arg : args) {
              auto ivalue = smith::jit::toIValue(arg, c10::AnyType::get());
              arg_ivalues.push_back(std::move(ivalue));
            }
            for (const auto& kv : kwargs) {
              kwarg_ivalues[py::cast<std::string>(kv.first)] =
                  smith::jit::toIValue(kv.second, c10::AnyType::get());
            }
          ...
          [](StaticModule& self,
            ...
            for (const auto& elem : args) {
              arg_ivalues.push_back(
                  smith::jit::toIValue(elem, c10::AnyType::get()));
            }
            std::unordered_map<std::string, c10::IValue> kwarg_ivalues;
            kwarg_ivalues.reserve(kwargs.size());
            for (const auto& kv : kwargs) {
  ...
  m.def(
      ...
      .def(
          "_jit_to_static_module",
          [](const smith::jit::Module& module) { return StaticModule(module); })
      .def(
          "_fuse_to_static_module",
          [](smith::jit::Module& module, size_t min_size) {
            module.eval();
      ...
      .def(
          "_fuse_to_static_module",
          [](std::shared_ptr<smith::jit::Graph> g, size_t min_size) {
