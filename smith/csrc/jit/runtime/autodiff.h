...
SMITH_API Gradient differentiate(std::shared_ptr<Graph>& graph);

// can we take a derivative of this node symbolically?
SMITH_API bool isDifferentiable(const Node* n);
SMITH_API bool isDifferentiable(Graph& g);
SMITH_API bool isZero(Value* v);
