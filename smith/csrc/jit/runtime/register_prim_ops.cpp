...
#include <smith/csrc/jit/mobile/promoted_prim_ops.h>
#include <smith/csrc/jit/runtime/custom_operator.h>
#include <smith/csrc/jit/runtime/operator.h>
#include <smith/csrc/jit/runtime/register_ops_utils.h>
#include <smith/csrc/jit/runtime/slice_indices_adjust.h>
...
static const std::vector<OperatorGeneratorArgs> opGenArgs{
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::str(t elem) -> str"),
        [](Stack& stack) {
          std::stringstream ss;
          ss << pop(stack);
          push(stack, ss.str());
    ...
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::list(str t) -> str[]"),
        [](Stack& stack) {
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::cpu(Tensor(a) self) -> Tensor(a|b)"),
        [](Stack& stack) {
          at::Tensor a;
          pop(stack, a);
          push(stack, a.cpu());
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::numpy_T.a(Tensor(a) self) -> Tensor(a)"),
        [](Stack& stack) {
          at::Tensor a;
          pop(stack, a);
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::matrix_H.a(Tensor(a) self) -> Tensor(a)"),
        [](Stack& stack) {
          at::Tensor a;
          pop(stack, a);
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::mT.a(Tensor(a) self) -> Tensor(a)"),
        [](Stack& stack) {
          at::Tensor a;
          pop(stack, a);
          push(stack, a.mT());
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::mH.a(Tensor(a) self) -> Tensor(a)"),
        [](Stack& stack) {
          at::Tensor a;
          pop(stack, a);
          push(stack, a.mH());
    ...
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA(
            "aten::__range_length(int lo, int hi, int step) -> int"),
        [](Stack& stack) {
          int64_t lo = 0, hi = 0, step = 0;
          pop(stack, lo, hi, step);
          // error handling when step_val = 0 during runtime
          SMITH_CHECK(step != 0, "range() arg 3 must not be zero");
          if (step > 0 && lo < hi) {
    ...
    OperatorGeneratorArgs(
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::TupleUnpack(Any tup) -> ..."),
        [](Stack& stack) { tupleUnpack(stack); },
        aliasAnalysisSpecialCase()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::unchecked_cast(t x) -> t"),
        noop,
        aliasAnalysisSpecialCase()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::IntImplicit(Tensor a) -> int"),
        [](Stack& stack) {
          at::Tensor a;
          pop(stack, a);
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::ComplexImplicit(Tensor a) -> complex"),
        [](Stack& stack) {
          at::Tensor a;
          pop(stack, a);
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::FloatImplicit(Tensor a) -> float"),
        [](Stack& stack) {
          at::Tensor a;
          pop(stack, a);
          checkImplicitTensorToNum(a, /*to int*/ false);
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::ScalarImplicit(Tensor a) -> Scalar"),
        [](Stack& stack) {
          at::Tensor a;
          pop(stack, a);
          checkImplicitTensorToNum(a, /*to int*/ false);
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::Bool.Tensor(Tensor a) -> bool"),
        boolTensor,
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::Bool.int(int a) -> bool"),
        [](Stack& stack) {
          int64_t i = 0;
          pop(stack, i);
          push(stack, (bool)i);
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::Bool.float(float a) -> bool"),
        [](Stack& stack) {
          double d = 0;
          pop(stack, d);
          push(stack, (bool)d);
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::Int.Tensor(Tensor a) -> int"),
        [](Stack& stack) {
          at::Tensor a;
          pop(stack, a);
          push(stack, a.item<int64_t>());
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::Int.bool(bool a) -> int"),
        [](Stack& stack) {
          bool b = false;
          pop(stack, b);
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::Int.float(float a) -> int"),
        [](Stack& stack) {
          double d = 0;
          pop(stack, d);
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::Int.Scalar(Scalar a) -> int"),
        [](Stack& stack) {
          IValue scalar;
          pop(stack, scalar);
          if (scalar.isInt()) {
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::Int.str(str a) -> int"),
        [](Stack& stack) {
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::Float.Tensor(Tensor a) -> float"),
        [](Stack& stack) {
          at::Tensor a;
          pop(stack, a);
          push(stack, a.item<double>());
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::Float.Scalar(Scalar a) -> float"),
        [](Stack& stack) {
          IValue scalar;
          pop(stack, scalar);
          if (scalar.isDouble()) {
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::Float.int(int a) -> float"),
        [](Stack& stack) {
          int64_t i = 0;
          pop(stack, i);
          push(stack, (float)i);
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::Float.bool(bool a) -> float"),
        [](Stack& stack) {
          bool b = false;
          pop(stack, b);
          push(stack, (float)b);
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::Float.str(str a) -> float"),
        [](Stack& stack) {
          auto s = pop(stack).toString();
          std::string::size_type sz = 0;
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::Complex.Scalar(Scalar a) -> complex"),
        [](Stack& stack) {
          IValue scalar;
          pop(stack, scalar);
    ...
    OperatorGeneratorArgs(
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::format(str self, ...) -> str"),
        [](Stack& stack) { aten_format(stack); },
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::einsum.sublist(Tensor a, ...) -> Tensor"),
        [](Stack& stack) {
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::NumToTensor.Scalar(Scalar a) -> Tensor"),
        numToTensorScalar,
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA(
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::Size(int[] sizes) -> int[]"),
        [](Stack& stack) {},
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::size(Tensor self) -> int[]"),
        size,
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::sym_size(Tensor self) -> SymInt[]"),
        sym_size,
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::stride(Tensor self) -> int[]"),
        [](Stack& stack) {
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::sym_stride(Tensor self) -> SymInt[]"),
        sym_stride,
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::EnumName(AnyEnumType enum) -> str"),
        [](Stack& stack) {
          IValue e = pop(stack);
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::EnumValue.int(AnyEnumType enum) -> int"),
        [](Stack& stack) {
          IValue e = pop(stack);
    ...
    OperatorGeneratorArgs(
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::EnumValue.str(AnyEnumType enum) -> str"),
        [](Stack& stack) {
          IValue e = pop(stack);
          push(stack, e.toEnumHolder()->value());
        },
    ...
    OperatorGeneratorArgs(
        ...
        // is listed here.
        SMITH_SELECTIVE_SCHEMA("prim::TupleIndex(Any tup, int i) -> Any"),
        tupleIndex,
        aliasAnalysisSpecialCase()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::ne.int_list(int[] a, int[] b) -> bool"),
        listNe<int64_t>,
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA(
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::device(Tensor a) -> Device"),
        device,
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::dtype(Tensor a) -> int"),
        dtype,
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::layout(Tensor a) -> Layout"),
        layout,
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::__not__(bool self) -> bool"),
        _not,
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::__is__(t1 self, t2 obj) -> bool"),
        is,
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::__isnot__(t1 self, t2 obj) -> bool"),
        isNot,
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::element_size(Tensor self) -> int"),
        [](Stack& stack) {
          at::Tensor arg = pop(stack).toTensor();
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::numel(Tensor self) -> int"),
        [](Stack& stack) {
          at::Tensor arg = pop(stack).toTensor();
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::dim(Tensor self) -> int"),
        dim,
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::get_device(Tensor self) -> int"),
        [](Stack& stack) {
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::storage_offset(Tensor self) -> int"),
        [](Stack& stack) {
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::is_contiguous(Tensor self) -> bool"),
        [](Stack& stack) {
    ...
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::select.t(t[](a) list, int idx) -> t(*)"),
        listSelect,
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA(
    ...
    OperatorGeneratorArgs(
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::reverse.t(t[](a!) self) -> ()"),
        listReverse,
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::extend.t(t[](a!) self, t[] other) -> ()"),
        listExtend,
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::copy.t(t[](a) self) -> t[]"),
        listCopy,
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA(
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::clear.t(t[](a!) self) -> ()"),
        listClear,
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::Delete.t(t[](a!) self, int idx) -> ()"),
        listDelete,
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA(
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::pop.t(t[](a!) self, int idx=-1) -> t(*)"),
        listPop,
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::add.t(t[] a, t[] b) -> t[]"),
        listAdd,
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::add_.t(t[](a!) self, t[] b) -> t[]"),
        listInplaceAdd,
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA(
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::list.t(t[] l) -> t[]"),
        listList,
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::mul.left_t(t[] l, int n) -> t[]"),
        listMulIntLeft,
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::mul.right_(int n, t[] l) -> t[]"),
        listMulIntRight,
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::mul_.t(t[](a!) l, int n) -> t[](a!)"),
        listMulIntLeftInPlace,
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::len.t(t[] a) -> int"),
        listLen,
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::eq.int_list(int[] a, int[] b) -> bool"),
        listEq<int64_t>,
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::eq.device(Device a, Device b) -> bool"),
        [](Stack& stack) {
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::ne.device(Device a, Device b) -> bool"),
        [](Stack& stack) {
          auto a = pop(stack).toDevice();
          auto b = pop(stack).toDevice();
          push(stack, a != b);
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::eq.bool(bool a, bool b) -> bool"),
        [](Stack& stack) {
          auto a = pop(stack);
          auto b = pop(stack);
          push(stack, a == b);
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::ne.bool(bool a, bool b) -> bool"),
        [](Stack& stack) {
          auto a = pop(stack);
          auto b = pop(stack);
          push(stack, a != b);
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::is_autocast_enabled() -> bool"),
        [](Stack& stack) {
    ...
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::is_autocast_cpu_enabled() -> bool"),
        [](Stack& stack) {
#if defined BUILD_LITE_INTERPRETER || defined C10_MOBILE
          bool enabled = false;
#else
    ...
    OperatorGeneratorArgs(
        ...
        aliasAnalysisConservative()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::Uninitialized() -> Any"),
        unInitialized,
        aliasAnalysisSpecialCase()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::Print(...) -> ()"),
        [](Stack& stack) {
    ...
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::VarConcat(...) -> Tensor"),
        [](Stack& stack) {
          auto num_inputs = pop(stack).toInt();
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::VarStack(...) -> Tensor"),
        [](Stack& stack) {
          auto num_inputs = pop(stack).toInt();
          auto dim = pop(stack).toInt();
          std::vector<at::Tensor> inputs(num_inputs - 1);
    ...
    OperatorGeneratorArgs(
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::dequantize.any(Any tensors) -> Any"),
    ...
    DEFINE_SCALAR_BINARY_OP_AVOID_COLLISION(
        ...
        float),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::pow.int_to_int(int a, int b) -> int"),
        [](Stack& stack) {
          int64_t a = 0, b = 0;
          pop(stack, a, b);
    ...
    // the python builtin 'min' and 'smith.min'
    DEFINE_BINARY_OP(prim::min, a < b ? a : b),
    DEFINE_BINARY_OP(prim::max, a > b ? a : b),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::type(Device self) -> str"),
        [](Stack& stack) {
          auto d = pop(stack);
          push(
    ...
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::len.Tensor(Tensor t) -> int"),
        [](Stack& stack) {
          at::Tensor t = pop(stack).toTensor();
          if (t.dim() == 0) {
            SMITH_CHECK(false, "len() of a 0-d tensor");
          }
          push(stack, t.sizes()[0]);
        },
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::ord(str string) -> int"),
        [](Stack& stack) {
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::lower(str self) -> str"),
        [](Stack& stack) {
          auto string = pop(stack).toStringRef();
          std::stringstream ss;
          for (char c : string) {
    ...
    OperatorGeneratorArgs(
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::len.str(str s) -> int"),
        [](Stack& stack) {
          auto string = pop(stack).toStringRef();
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::dict() -> Dict(str, Tensor)"),
        [](Stack& stack) {
          auto dict =
...
#define CREATE_COPY_OP(other_type, c_type)                               \
  OperatorGeneratorArgs(                                                 \
      SMITH_SELECTIVE_SCHEMA("aten::copy_." #other_type                  \
...
#undef CREATE_COPY_OP
    ...
    OperatorGeneratorArgs(
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::is_cuda(Tensor a) -> bool"),
        isCuda,
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::is_cpu(Tensor a) -> bool"),
        [](Stack& stack) {
          at::Tensor a;
          pop(stack, a);
          push(stack, a.is_cpu());
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::is_xla(Tensor a) -> bool"),
        [](Stack& stack) {
          at::Tensor a;
          pop(stack, a);
          push(stack, a.is_xla());
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::is_mtia(Tensor a) -> bool"),
        [](Stack& stack) {
          at::Tensor a;
          pop(stack, a);
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::is_xpu(Tensor a) -> bool"),
        [](Stack& stack) {
          at::Tensor a;
          pop(stack, a);
          push(stack, a.is_xpu());
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::data(Tensor(a) a) -> Tensor(a)"),
        [](Stack& stack) {
          at::Tensor a;
          pop(stack, a);
...
#define CREATE_COMPARATOR_LIST_OPS_SPECIALIZED(decl_type, value_type)        \
  OperatorGeneratorArgs(                                                     \
      SMITH_SELECTIVE_SCHEMA("prim::min." decl_type "_list(" decl_type       \
                             "[] l, " decl_type "[] r) -> " decl_type "[]"), \
      minList<value_type>,                                                   \
      aliasAnalysisFromSchema()),                                            \
      OperatorGeneratorArgs(                                                 \
          SMITH_SELECTIVE_SCHEMA("prim::max." decl_type "_list(" decl_type   \
                                 "[] l, " decl_type "[] r) -> " decl_type    \
                                 "[]"),                                      \
          maxList<value_type>,                                               \
          aliasAnalysisFromSchema()),                                        \
      OperatorGeneratorArgs(                                                 \
          SMITH_SELECTIVE_SCHEMA("prim::min.self_" decl_type "(" decl_type   \
                                 "[] self) -> " decl_type),                  \
          listMin<value_type>,                                               \
          aliasAnalysisFromSchema()),                                        \
      OperatorGeneratorArgs(                                                 \
          SMITH_SELECTIVE_SCHEMA("prim::max.self_" decl_type "(" decl_type   \
                                 "[] self) -> " decl_type),                  \
          listMax<value_type>,                                               \
          aliasAnalysisFromSchema()),
...
#define DEFINE_STRING_IS_OP(op_name, char_op)                          \
  OperatorGeneratorArgs(                                               \
      SMITH_SELECTIVE_SCHEMA(#op_name "(str self) -> bool"),           \
      [](Stack& stack) {                                               \
        auto string = pop(stack).toStringRef();                        \
        push(                                                          \
            stack,                                                     \
...
#define DEFINE_STRING_CHAR_MAP_OP(op_name, char_op)         \
  OperatorGeneratorArgs(                                    \
      SMITH_SELECTIVE_SCHEMA(#op_name "(str self) -> str"), \
      [](Stack& stack) {                                    \
        auto string = pop(stack).toStringRef();             \
        std::stringstream ss;                               \
        for (char c : string) {                             \
...
RegisterOperators reg(([]() {
  ...
  v.emplace_back(Operator(
      ...
      // implementation in smith/csrc/utils/tensor_list.cpp as possible.
...
void dictPop(Stack& stack) {
  ...
  if (iter == dict.end()) {
    if (has_default) {
      ...
      SMITH_CHECK(false, "KeyError: ", key);
    }
  } else {
    // note: before erase
...
void dictPopItem(Stack& stack) {
  auto dict = pop(stack).toGenericDict();
  if (dict.empty()) {
    SMITH_CHECK(false, "popitem(): dictionary is empty");
  }
...
#define CREATE_DICT_OPS(key_type)                                              \
  OperatorGeneratorArgs(                                                       \
      SMITH_SELECTIVE_SCHEMA("aten::len.Dict_" key_type "(Dict(" key_type      \
                             ", t) self) -> int"),                             \
      dictLen,                                                                 \
      aliasAnalysisFromSchema()),                                              \
      OperatorGeneratorArgs(                                                   \
          SMITH_SELECTIVE_SCHEMA("aten::keys." key_type "(Dict(" key_type      \
                                 ", t) self) -> " key_type "[](*)"),           \
          dictKeys,                                                            \
          aliasAnalysisFromSchema()),                                          \
      OperatorGeneratorArgs(                                                   \
          SMITH_SELECTIVE_SCHEMA("aten::values." key_type "(Dict(" key_type    \
                                 ", t) self) -> t[](*)"),                      \
          dictValues,                                                          \
          aliasAnalysisFromSchema()),                                          \
      OperatorGeneratorArgs(                                                   \
          SMITH_SELECTIVE_SCHEMA("aten::__getitem__.Dict_" key_type            \
                                 "(Dict(" key_type ", t) self, " key_type      \
                                 " key) -> t(*)"),                             \
          dictIndex,                                                           \
          aliasAnalysisFromSchema()),                                          \
      OperatorGeneratorArgs(                                                   \
          SMITH_SELECTIVE_SCHEMA("aten::get." key_type "(Dict(" key_type       \
                                 ", t) self, " key_type " key) -> t(*)?"),     \
          dictGet<false>,                                                      \
          aliasAnalysisFromSchema()),                                          \
      OperatorGeneratorArgs(                                                   \
          SMITH_SELECTIVE_SCHEMA("aten::get.default_" key_type                 \
                                 "(Dict(" key_type ", t) self, " key_type      \
      ...
      OperatorGeneratorArgs(                                                   \
          ...
          aliasAnalysisFromSchema()),                                          \
      OperatorGeneratorArgs(                                                   \
          SMITH_SELECTIVE_SCHEMA("aten::Delete.Dict_" key_type                 \
                                 "(Dict(" key_type ", t)(a!) self, " key_type  \
                                 " key) -> ()"),                               \
          dictDelete,                                                          \
          aliasAnalysisFromSchema()),                                          \
      OperatorGeneratorArgs(                                                   \
          SMITH_SELECTIVE_SCHEMA("aten::pop.Dict_" key_type "(Dict(" key_type  \
                                 ", t)(a!) self, " key_type " key) -> t(*)"),  \
          dictPop<false>,                                                      \
          aliasAnalysisFromSchema()),                                          \
      OperatorGeneratorArgs(                                                   \
          SMITH_SELECTIVE_SCHEMA("aten::pop.Dict_default_" key_type            \
                                 "(Dict(" key_type ", t)(a!) self, " key_type  \
                                 " key, t default_value) -> t(*)"),            \
          dictPop<true>,                                                       \
          aliasAnalysisFromSchema()),                                          \
      OperatorGeneratorArgs(                                                   \
          SMITH_SELECTIVE_SCHEMA("aten::popitem." key_type "(Dict(" key_type   \
                                 ", t)(a!) self) -> ((" key_type ", t))"),     \
          dictPopItem,                                                         \
          aliasAnalysisFromSchema()),                                          \
      OperatorGeneratorArgs(                                                   \
          SMITH_SELECTIVE_SCHEMA("aten::clear." key_type "(Dict(" key_type     \
                                 ", t)(a!) self) -> ()"),                      \
          dictClear,                                                           \
          aliasAnalysisFromSchema()),                                          \
      OperatorGeneratorArgs(                                                   \
          SMITH_SELECTIVE_SCHEMA("aten::update." key_type "(Dict(" key_type    \
                                 ", t)(a!) self, Dict(" key_type               \
                                 ", t)(a!) to_add) -> ()"),                    \
          dictUpdate,                                                          \
          aliasAnalysisFromSchema()),                                          \
      OperatorGeneratorArgs(                                                   \
          SMITH_SELECTIVE_SCHEMA("aten::items." key_type "(Dict(" key_type     \
                                 ", t) self) -> ((" key_type ", t)[])"),       \
          dictItems,                                                           \
          aliasAnalysisFromSchema()),                                          \
      OperatorGeneratorArgs(                                                   \
          SMITH_SELECTIVE_SCHEMA("aten::copy.Dict_" key_type "(Dict(" key_type \
                                 ", t)(a) self) -> Dict(" key_type ", t)"),    \
          dictCopy,                                                            \
          aliasAnalysisFromSchema()),                                          \
      OperatorGeneratorArgs(                                                   \
          SMITH_SELECTIVE_SCHEMA("aten::__contains__." key_type                \
                                 "(Dict(" key_type ", t) dict, " key_type      \
                                 " key) -> bool"),                             \
          dictContains,                                                        \
          aliasAnalysisFromSchema()),                                          \
      OperatorGeneratorArgs(                                                   \
          SMITH_SELECTIVE_SCHEMA("aten::_set_item." key_type "(Dict(" key_type \
                                 ", t)(a!) l, " key_type                       \
                                 "(b -> *) idx, t(c -> *) v) -> ()"),          \
          dictSetItem,                                                         \
          aliasAnalysisFromSchema()),                                          \
      OperatorGeneratorArgs(                                                   \
          SMITH_SELECTIVE_SCHEMA("aten::dict." key_type "((" key_type          \
                                 ", tVal)[] inputs) -> Dict(" key_type         \
                                 ", tVal)"),                                   \
          dictConstructFromList,                                               \
          aliasAnalysisFromSchema()),                                          \
      OperatorGeneratorArgs(                                                   \
          SMITH_SELECTIVE_SCHEMA("aten::dict.Dict_" key_type "(Dict(" key_type \
                                 ", t)(a) self) -> Dict(" key_type ", t)"),    \
          dictCopy,                                                            \
          aliasAnalysisFromSchema())
...
// String Ops
// Implementations located in smith/csrc/jit/runtime/register_prim_ops.cpp
static const std::vector<OperatorGeneratorArgs> stringOpGenArgs{
    ...
    OperatorGeneratorArgs(
        ...
        [](Stack& stack) {
          ...
          SMITH_CHECK(!separator.empty(), "ValueError: empty separator");
    ...
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::isupper(str self) -> bool"),
        [](Stack& stack) {
          std::string string = pop(stack).toStringRef();
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::islower(str self) -> bool"),
        [](Stack& stack) {
          std::string string = pop(stack).toStringRef();
          bool found_alpha = false;
          bool is_lower = true;
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::capitalize(str self) -> str"),
        [](Stack& stack) {
          std::string string = pop(stack).toStringRef();
          std::stringstream ss;
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::title(str self) -> str"),
        [](Stack& stack) {
          std::string string = pop(stack).toStringRef();
          std::stringstream ss;
    ...
    OperatorGeneratorArgs(
        ...
        [](Stack& stack) {
          ...
          SMITH_CHECK(result >= 0, "ValueError: substring not found");
          push(stack, result);
        },
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::isidentifier(str self) -> bool"),
        [](Stack& stack) {
          std::string string = pop(stack).toStringRef();
          LOG(WARNING)
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::istitle(str self) -> bool"),
        [](Stack& stack) {
          std::string string = pop(stack).toStringRef();
          auto result = false;
    ...
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::isprintable(str self) -> bool"),
        [](Stack& stack) {
          std::string string = pop(stack).toStringRef();
          auto result = std::all_of(string.begin(), string.end(), [](char c) {
    ...
    OperatorGeneratorArgs(
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::zfill(str self, int width) -> str"),
        [](Stack& stack) {
          int64_t width = pop(stack).toInt();
          std::string string = pop(stack).toStringRef();
          auto to_append =
    ...
    OperatorGeneratorArgs(
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::join(str self, str[] values) -> str"),
        [](Stack& stack) {
          IValue ivalue = pop(stack);
...
static const std::vector<OperatorGeneratorArgs> opGenArgs1{
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::rangelist(int n) -> int[]"),
        [](Stack& stack) {
          int64_t n = 0;
          pop(stack, n);
    ...
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::NumToTensor.bool(bool a) -> Tensor"),
        numToTensorBool,
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::device(str a) -> Device"),
        [](Stack& stack) {
    ...
    OperatorGeneratorArgs(
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::percentFormat(str self, ...) -> str"),
        [](Stack& stack) {
          size_t num_inputs = pop(stack).toInt();
    ...
    OperatorGeneratorArgs(
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::requires_grad(Tensor a) -> bool"),
        [](Stack& stack) {
          at::Tensor a;
          pop(stack, a);
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::grad(Tensor a) -> Tensor(*)"),
        [](Stack& stack) {
          at::Tensor a;
          pop(stack, a);
          push(stack, a.grad());
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::is_sparse(Tensor a) -> bool"),
        [](Stack& stack) {
          at::Tensor a;
          pop(stack, a);
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::is_sparse_csr(Tensor a) -> bool"),
        [](Stack& stack) {
          at::Tensor a;
          pop(stack, a);
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::is_mkldnn(Tensor a) -> bool"),
        [](Stack& stack) {
          at::Tensor a;
          pop(stack, a);
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::is_mps(Tensor a) -> bool"),
        [](Stack& stack) {
          at::Tensor a;
          pop(stack, a);
          push(stack, a.is_mps());
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::is_vulkan(Tensor a) -> bool"),
        [](Stack& stack) {
          at::Tensor a;
          pop(stack, a);
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::is_ipu(Tensor a) -> bool"),
        [](Stack& stack) {
          at::Tensor a;
          pop(stack, a);
          push(stack, a.is_ipu());
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::is_quantized(Tensor a) -> bool"),
        [](Stack& stack) {
          at::Tensor a;
          pop(stack, a);
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::is_meta(Tensor a) -> bool"),
        [](Stack& stack) {
          at::Tensor a;
          pop(stack, a);
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::is_maia(Tensor a) -> bool"),
        [](Stack& stack) {
          at::Tensor a;
          pop(stack, a);
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::is_nested(Tensor a) -> bool"),
        [](Stack& stack) {
          at::Tensor a;
          pop(stack, a);
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::name(Tensor a) -> str?"),
        [](Stack& stack) {
          at::Tensor a;
          pop(stack, a);
          if (a.name().empty()) {
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::nbytes(Tensor a) -> int"),
        [](Stack& stack) {
          at::Tensor a;
          pop(stack, a);
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::itemsize(Tensor a) -> int"),
        [](Stack& stack) {
          at::Tensor a;
          pop(stack, a);
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::index(Device self) -> int?"),
        [](Stack& stack) {
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        // TODO return generator object when smithscript supports RNG
        // first-class
        SMITH_SELECTIVE_SCHEMA("aten::manual_seed(int seed) -> ()"),
    ...
    OperatorGeneratorArgs(
        ...
        [](Stack& stack) {
          ...
          push(
              stack,
              smith::jit::make_generator_for_device(
                  device.value_or(c10::Device("cpu")), seed));
        },
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::initial_seed(Generator self) -> int"),
        [](Stack& stack) {
    ...
    OperatorGeneratorArgs(
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::seed(Generator(a!) self) -> int"),
        [](Stack& stack) {
          auto generator = pop(stack);
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::cuda(Tensor(a) self) -> Tensor(a|b)"),
        [](Stack& stack) {
          at::Tensor a;
          pop(stack, a);
          push(stack, a.cuda());
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::AutogradZero() -> Tensor"),
    ...
    OperatorGeneratorArgs(
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::BroadcastSizes(...) -> int[]"),
        [](Stack& stack) {
          auto num_inputs = pop(stack).toInt();
    ...
    OperatorGeneratorArgs(
        ...
        [](Stack& stack) {
          SMITH_CHECK(false, "warn is implemented directly in the interpreter");
        },
        aliasAnalysisFromSchema()),
    ...
    OperatorGeneratorArgs(
        ...
        aliasAnalysisSpecialCase()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("onnx::Shape(Tensor t) -> Tensor"),
        [](Stack& stack) {
          auto t = pop(stack).toTensor();
          at::IntArrayRef sizes = t.sizes();
          auto sizes_tensor = smith::empty(
        ...
        aliasAnalysisSpecialCase()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::AutogradAnyNonZero(...) -> bool"),
        [](Stack& stack) {
          auto num_inputs = pop(stack).toInt();
          bool result = false;
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::AutogradAllZero(...) -> bool"),
        [](Stack& stack) {
          auto num_inputs = pop(stack).toInt();
          bool result = true;
          for (const IValue& v : last(stack, num_inputs)) {
            SMITH_INTERNAL_ASSERT(v.isTensor());
            if (v.toTensor().defined()) {
              result = false;
              break;
            }
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::AutogradAllNonZero(...) -> bool"),
        [](Stack& stack) {
          auto num_inputs = pop(stack).toInt();
          bool result = true;
          for (const IValue& v : last(stack, num_inputs)) {
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::AutogradAdd(Any a, Any b) -> Any"),
        [](Stack& stack) {
    ...
    OperatorGeneratorArgs(
        ...
        [](Stack& stack) {
          auto val = pop(stack);
          SMITH_CHECK(!val.isNone(), "Unwrapping null optional");
...
static const std::vector<OperatorGeneratorArgs> opGenArgs2{
    ...
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::len.any(Any[] a) -> int"),
        listLen,
        aliasAnalysisFromSchema()),
...
#undef CREATE_SPECIALIZED_LIST_OPS
    ...
    OperatorGeneratorArgs(
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::sorted.int(int[](a) input) -> (int[])"),
    ...
    OperatorGeneratorArgs(
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::sorted.str(str[](a) input) -> (str[])"),
    ...
    OperatorGeneratorArgs(
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::eq.str_list(str[] a, str[] b) -> bool"),
        listEq<std::string>,
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA(
    ...
    OperatorGeneratorArgs(
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::ne.str_list(str[] a, str[] b) -> bool"),
        listNe<std::string>,
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::sorted.any(t[](a) self) -> (t[])"),
...
#define DEFINE_CONVERT_BASE_OP(op_name, prefix, char_op) \
  OperatorGeneratorArgs(                                 \
      SMITH_SELECTIVE_SCHEMA(#op_name "(int i) -> str"), \
      [](Stack& stack) {                                 \
    ...
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::bin(int i) -> str"),
        [](Stack& stack) {
          auto i = pop(stack).toInt();
          std::stringstream ss;
          if (i == 0) {
    ...
    OperatorGeneratorArgs(
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::chr(int i) -> str"),
        [](Stack& stack) {
          auto i = pop(stack).toInt();
          std::stringstream ss;
          SMITH_CHECK(
    ...
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::modf(float a) -> (float, float)"),
        [](Stack& stack) {
          double a = 0;
          pop(stack, a);
          double c = 0;
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::frexp(float a) -> (float, int)"),
        [](Stack& stack) {
          double a = 0;
          pop(stack, a);
          double m = 0;
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::ldexp(float x, int i) -> float"),
        [](Stack& stack) {
          double a = 0;
          int64_t b = 0;
          pop(stack, a, b);
    ...
    DEFINE_UNARY_OP_WITH_COMPLEX_CAST(
        ...
        float),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::abs(Tensor x) -> Tensor"),
        [](Stack& stack) {
          at::Tensor x;
          pop(stack, x);
          push(stack, x.abs());
    ...
    DEFINE_SCALAR_BINARY_OP(
        ...
        float),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::_tensor_to_list(Tensor self) -> int[]"),
        [](Stack& stack) {
          at::Tensor t;
          pop(stack, t);
          c10::List<int64_t> elems;
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::_list_to_tensor(int[] self) -> Tensor"),
        [](Stack& stack) {
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::sum.int(int[] self) -> int"),
        [](Stack& stack) {
          c10::List<int64_t> l = pop(stack).toIntList();
          auto sum = 0;
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::sum.float(float[] self) -> float"),
        [](Stack& stack) {
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::sum.complex(complex[] self) -> complex"),
        [](Stack& stack) {
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::sum.bool(bool[] self) -> int"),
        [](Stack& stack) {
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::any.str(str[] self) -> bool"),
        [](Stack& stack) {
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::any.int(int[] self) -> bool"),
        [](Stack& stack) {
          c10::List<int64_t> l = pop(stack).toIntList();
          for (const auto& elem : l) {
            if (elem) {
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::any.float(float[] self) -> bool"),
        [](Stack& stack) {
          c10::List<double> l = pop(stack).toDoubleList();
          for (const auto& elem : l) {
            if (elem) {
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::any.bool(bool[] self) -> bool"),
        [](Stack& stack) {
          c10::List<bool> l = pop(stack).toBoolList();
          for (const auto& elem : l) {
            if (elem) {
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::all.int(int[] self) -> bool"),
        [](Stack& stack) {
          c10::List<int64_t> l = pop(stack).toIntList();
          for (const auto& elem : l) {
            if (!elem) {
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::all.float(float[] self) -> bool"),
        [](Stack& stack) {
          c10::List<double> l = pop(stack).toDoubleList();
          for (const auto& elem : l) {
            if (!elem) {
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::all.bool(bool[] self) -> bool"),
        [](Stack& stack) {
          c10::List<bool> l = pop(stack).toBoolList();
          for (const auto& elem : l) {
            if (!elem) {
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::divmod.int(int x, int y) -> (int, int)"),
        [](Stack& stack) {
          int64_t a = 0, b = 0;
          lldiv_t divresult = {};
          pop(stack, a, b);
    ...
    OperatorGeneratorArgs(
        ...
        [](Stack& stack) {
          double a = 0, b = 0;
          pop(stack, a, b);
          SMITH_CHECK(b != 0, "ZeroDivisionError: float divmod()");
          double rem = fmod(a, b);
        ...
        aliasAnalysisFromSchema()),
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("prim::id(AnyClassType? x) -> int"),
        [](Stack& stack) {
          IValue a;
          pop(stack, a);
          if (a.isNone()) {
    ...
    OperatorGeneratorArgs(
        ...
        [](Stack& stack) {
          ...
          ss << ind.toInt();
          push(
              stack, smith::jit::Object(module_dict.toObject()).attr(ss.str()));
        },
        aliasAnalysisFromSchema()),

#define DEFINE_DIVMOD_MIXED_OP(type_a, type_b)                               \
  OperatorGeneratorArgs(                                                     \
      SMITH_SELECTIVE_SCHEMA("aten::divmod." #type_a "_" #type_b "(" #type_a \
...
#undef DEFINE_DIVMOD_MIXED_OP
    OperatorGeneratorArgs(
        SMITH_SELECTIVE_SCHEMA("aten::hash.generic(t value) -> int"),
        hashValue,
        aliasAnalysisFromSchema()),

#define DEFINE_COMPLEX_OP(type_a, type_b, actual_type_a, actual_type_b)       \
  OperatorGeneratorArgs(                                                      \
      SMITH_SELECTIVE_SCHEMA("aten::Complex." #type_a "_" #type_b "(" #type_a \
                             " x," #type_b " y) -> complex"),                 \
      [](Stack& stack) {                                                      \
        actual_type_a a;                                                      \
        actual_type_b b;                                                      \
...
#define DEFINE_COMPLEX_OP_WITH_TENSOR_ARG(                                    \
  ...
  OperatorGeneratorArgs(                                                      \
      ...
      aliasAnalysisFromSchema()),                                             \
      OperatorGeneratorArgs(                                                  \
          SMITH_SELECTIVE_SCHEMA("aten::Complex." #type_b "_" #type_a         \
