...
#include <smith/csrc/jit/frontend/source_ref.h>
...
class SMITH_API InstructionSpan {
 public:
...
bool SMITH_API isProfilingOngoing();

} // namespace profiling

struct SMITH_API InstructionStats : public CustomClassHolder {
  int64_t count{0};
  std::chrono::nanoseconds duration{0};
};

class SMITH_API SourceStats : public CustomClassHolder {
 public:
...
/**
 * ScriptProfile is an underlying C++ implementation for SmithScript profiling.
 ...
 * number.
 */
class SMITH_API ScriptProfile : public CustomClassHolder {
