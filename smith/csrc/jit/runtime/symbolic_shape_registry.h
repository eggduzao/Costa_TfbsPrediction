...
SMITH_API void RegisterShapeComputeGraphForSchema(
    const FunctionSchema& schema,
    const std::shared_ptr<Graph>& g);

SMITH_API std::optional<std::shared_ptr<Graph>> shapeComputeGraphForSchema(
    const FunctionSchema& schema);

SMITH_API std::optional<BoundedShapeGraphs> boundedGraphsForSchema(
    const FunctionSchema& schema);

SMITH_API std::vector<const FunctionSchema*> RegisteredShapeComputeSchemas();

SMITH_API void LintShapeComputeGraph(
    const FunctionSchema* schema,
