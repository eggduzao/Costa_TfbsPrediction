...
RegisterOperators reg({
    ...
    Operator(
        ...
        [](const Node* /* node */) -> Operation {
          return [](Stack& /* stack */) {
            SMITH_CHECK(false, "prim::TypeCheck not yet implemented"); // NOLINT
          };
        },
        aliasAnalysisSpecialCase()),
    Operator(
    ...
    Operator(
        ...
        [](Stack& stack) {
          SMITH_CHECK(false, "Should be replaced by prim::BailOut");
        },
        aliasAnalysisFromSchema()),
    Operator(
        "prim::BailOut(...) -> Tensor(a)",
        [](Stack& /* stack */) {
          SMITH_CHECK(false, "prim::BailOut not yet implemented"); // NOLINT
        },
        aliasAnalysisFromSchema()),
    Operator(
    ...
    Operator(
        ...
        [](Stack& stack) {
          ...
          std::vector<smith::autograd::Variable> output_vars(
              outputs.begin(), outputs.end());
          std::vector<smith::autograd::Variable> gradients;
    ...
    Operator(
        ...
        [](Stack& stack) {
          SMITH_CHECK(false, "wait is implemented directly in the interpreter");
        },
        aliasAnalysisSpecialCase()),
    Operator(
...
RegisterOperators logging_operators(
    {Operator(
         ...
         [](Stack& stack) {
           ...
           smith::jit::logging::getLogger()->addStatValue(*key, val);
         },
         aliasAnalysisFromSchema()),
     Operator(
         "prim::TimePoint() -> int",
...
// reference: _output_size in smith/nn/functional.py
...
// reference: interpolate in smith/nn/functional.py
// size can be none, int or intlist
// scale_factors can be none, float, or floatlist
