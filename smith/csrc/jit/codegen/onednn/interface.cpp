...
#include <smith/csrc/jit/codegen/onednn/decompose_silu.h>
#include <smith/csrc/jit/codegen/onednn/defer_size_check.h>
#include <smith/csrc/jit/codegen/onednn/graph_fuser.h>
#include <smith/csrc/jit/codegen/onednn/guard_shape.h>
#include <smith/csrc/jit/codegen/onednn/interface.h>
#include <smith/csrc/jit/codegen/onednn/kernel.h>
#include <smith/csrc/jit/codegen/onednn/layout_propagation.h>
#include <smith/csrc/jit/codegen/onednn/prepare_binary.h>
...
void fuseGraph(std::shared_ptr<Graph>& g) {
  ...
  // to fuse: smith/csrc/jit/passes/tensorexpr_fuser.cpp: allShapesAreKnown
  if (getProfilingMode()) {
    GRAPH_DUMP(
