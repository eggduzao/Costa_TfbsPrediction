...
#include <smith/csrc/jit/frontend/name_mangler.h>
...
struct SMITH_API CompilationUnit {
  ...
  Function& get_function(const c10::QualifiedName& name) const {
    ...
    SMITH_CHECK(false, "attempted to get undefined function ", name.name());
  }
  ...
  /// @endcode
  ///
  /// To get a compile a module from a source string, see smith::jit::compile
  ///
...
using CompilationUnit = ::smith::jit::CompilationUnit;
} // namespace script
} // namespace smith::jit
