...
struct SMITH_API GraphFunction : public Function {
  GraphFunction(
...
SMITH_API GraphFunction* tryToGraphFunction(Function& /*function*/) noexcept;
SMITH_API GraphFunction& toGraphFunction(Function& /*function*/);
SMITH_API const GraphFunction& toGraphFunction(const Function& /*function*/);
} // namespace smith::jit
C10_DECLARE_bool(smith_jit_do_not_store_optimized_graph);
