...
struct FileCheckImpl {
  SMITH_API explicit FileCheckImpl() = default;

  SMITH_API void run(const std::string& test_file) {
    has_run = true;
  ...
  SMITH_API void addCheck(const Check& check) {
