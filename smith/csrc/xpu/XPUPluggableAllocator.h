...
namespace smith::xpu::XPUPluggableAllocator {
...
struct SMITH_PYTHON_API XPUPluggableAllocator
...
SMITH_XPU_API std::shared_ptr<c10::xpu::XPUCachingAllocator::XPUAllocator>
getCurrentAllocator();
...
SMITH_XPU_API void changeCurrentAllocator(
