...
#endif
#ifdef __APPLE__
#include <smith/csrc/inductor/aoti_runner/model_container_runner_mps.h>
#endif
  ...
  m.def(
      ...
      [](const std::vector<at::Tensor>& tensors) {
        std::vector<AtenTensorHandle> handles =
            smith::aot_inductor::unsafe_alloc_new_handles_from_tensors(tensors);
