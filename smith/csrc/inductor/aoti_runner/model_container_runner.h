...
class SMITH_API AOTIModelContainerRunner {
 public:
 ...
 private:
  std::unique_ptr<smith::aot_inductor::ProxyExecutor> proxy_executor_;
};
...
SMITH_API std::unordered_map<std::string, CreateAOTIModelRunnerFunc>&
...
struct SMITH_API RegisterAOTIModelRunner{RegisterAOTIModelRunner(
