...
#include <smith/csrc/inductor/aoti_smith/c/shim_xpu.h>
...
AOTISmithError aoti_smith_create_xpu_guard(
...
AOTISmithError aoti_smith_delete_xpu_guard(XPUGuardHandle guard) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE(
      { delete reinterpret_cast<at::DeviceGuard*>(guard); });
}

AOTISmithError aoti_smith_xpu_guard_set_index(
...
AOTISmithError aoti_smith_create_xpu_stream_guard(
    void* stream,
    int32_t device_index,
...
AOTISmithError aoti_smith_delete_xpu_stream_guard(XPUStreamGuardHandle guard) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE(
      { delete reinterpret_cast<at::StreamGuard*>(guard); });
}

AOTISmithError aoti_smith_get_current_xpu_stream(
    int32_t device_index,
    void** ret_stream) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE(
...
AOTISmithError aoti_smith_get_current_xpu_device(int32_t* device_index) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE({
    *device_index =
...
AOTISmithError aoti_smith_set_current_xpu_device(const int32_t& device_index) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE(
      { c10::xpu::set_device(static_cast<int8_t>(device_index)); });
}

AOTISmithError aoti_smith_get_current_sycl_queue(void** ret) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE({
    int32_t device_index =
        static_cast<int32_t>(static_cast<uint16_t>(c10::xpu::current_device()));
...
AOTISmithError aoti_smith_xpu_mkldnn__convolution_pointwise_binary(
    AtenTensorHandle X,
...
AOTISmithError aoti_smith_xpu_mkldnn__convolution_pointwise_binary_(
    AtenTensorHandle other,
    AtenTensorHandle X,
    AtenTensorHandle W,
    AtenTensorHandle* B,
...
AOTISmithError aoti_smith_xpu_mkldnn__convolution_pointwise(
    AtenTensorHandle X,
    AtenTensorHandle W,
    AtenTensorHandle* B,
    const int64_t* padding,
...
AOTISmithError aoti_smith_xpu__qlinear_pointwise_tensor(
    AtenTensorHandle X,
...
AOTISmithError aoti_smith_xpu__qlinear_pointwise_binary_tensor(
    AtenTensorHandle X,
    AtenTensorHandle act_scale,
    AtenTensorHandle act_zero_point,
    AtenTensorHandle onednn_weight,
...
AOTISmithError aoti_smith_xpu__qconv_pointwise_tensor(
    AtenTensorHandle X,
    AtenTensorHandle act_scale,
    AtenTensorHandle act_zero_point,
    AtenTensorHandle onednn_weight,
...
AOTISmithError aoti_smith_xpu__qconv2d_pointwise_binary_tensor(
    AtenTensorHandle X,
    AtenTensorHandle act_scale,
    AtenTensorHandle act_zero_point,
    AtenTensorHandle onednn_weight,
