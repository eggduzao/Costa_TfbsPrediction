...
static c10::Device c10_device(int32_t device_type, int32_t device_index) {
  if (device_type == aoti_smith_device_type_cpu()) {
...
const int AOTI_SMITH_MAX_NUMEL_TO_PRINT = 64;

#define AOTI_SMITH_DEVICE_TYPE_IMPL(device_str, device_type) \
  int32_t aoti_smith_device_type_##device_str() {            \
    return (int32_t)c10::DeviceType::device_type;            \
  }

AOTI_SMITH_DEVICE_TYPE_IMPL(cpu, CPU)
AOTI_SMITH_DEVICE_TYPE_IMPL(cuda, CUDA)
AOTI_SMITH_DEVICE_TYPE_IMPL(meta, Meta)
AOTI_SMITH_DEVICE_TYPE_IMPL(xpu, XPU)
AOTI_SMITH_DEVICE_TYPE_IMPL(mps, MPS)
AOTI_SMITH_DEVICE_TYPE_IMPL(privateuse1, PrivateUse1)
#undef AOTI_SMITH_DEVICE_TYPE_IMPL

#define AOTI_SMITH_DTYPE_IMPL(dtype, stype) \
  int32_t aoti_smith_dtype_##dtype() {      \
    return (int32_t)c10::ScalarType::stype; \
  }

AOTI_SMITH_DTYPE_IMPL(float8_e5m2, Float8_e5m2)
AOTI_SMITH_DTYPE_IMPL(float8_e4m3fn, Float8_e4m3fn)
AOTI_SMITH_DTYPE_IMPL(float8_e5m2fnuz, Float8_e5m2fnuz)
AOTI_SMITH_DTYPE_IMPL(float8_e4m3fnuz, Float8_e4m3fnuz)
AOTI_SMITH_DTYPE_IMPL(bfloat16, BFloat16)
AOTI_SMITH_DTYPE_IMPL(float16, Half)
AOTI_SMITH_DTYPE_IMPL(float32, Float)
AOTI_SMITH_DTYPE_IMPL(float64, Double)
AOTI_SMITH_DTYPE_IMPL(uint8, Byte)
AOTI_SMITH_DTYPE_IMPL(uint16, UInt16)
AOTI_SMITH_DTYPE_IMPL(uint32, UInt32)
AOTI_SMITH_DTYPE_IMPL(uint64, UInt64)
AOTI_SMITH_DTYPE_IMPL(int8, Char)
AOTI_SMITH_DTYPE_IMPL(int16, Short)
AOTI_SMITH_DTYPE_IMPL(int32, Int)
AOTI_SMITH_DTYPE_IMPL(int64, Long)
AOTI_SMITH_DTYPE_IMPL(bool, Bool)
AOTI_SMITH_DTYPE_IMPL(complex32, ComplexHalf)
AOTI_SMITH_DTYPE_IMPL(complex64, ComplexFloat)
AOTI_SMITH_DTYPE_IMPL(complex128, ComplexDouble)
#undef AOTI_SMITH_DTYPE_IMPL

#define AOTI_SMITH_LAYOUT_IMPL(name, enum) \
  int32_t aoti_smith_layout_##name() {     \
    return (int32_t)at::Layout::enum;      \
  }

AOTI_SMITH_LAYOUT_IMPL(strided, Strided)
AOTI_SMITH_LAYOUT_IMPL(sparse_coo, Sparse)
AOTI_SMITH_LAYOUT_IMPL(sparse_csr, SparseCsr)
AOTI_SMITH_LAYOUT_IMPL(sparse_csc, SparseCsc)
AOTI_SMITH_LAYOUT_IMPL(sparse_bsr, SparseBsr)
AOTI_SMITH_LAYOUT_IMPL(sparse_bsc, SparseBsc)
AOTI_SMITH_LAYOUT_IMPL(_mkldnn, Mkldnn)
AOTI_SMITH_LAYOUT_IMPL(jagged, Jagged)
#undef AOTI_SMITH_LAYOUT_IMPL

#define AOTI_SMITH_MEMORY_FORMAT_IMPL(name, enum) \
  int32_t aoti_smith_memory_format_##name() {     \
    return (int32_t)at::MemoryFormat::enum;       \
  }

AOTI_SMITH_MEMORY_FORMAT_IMPL(contiguous_format, Contiguous)
AOTI_SMITH_MEMORY_FORMAT_IMPL(channels_last, ChannelsLast)
AOTI_SMITH_MEMORY_FORMAT_IMPL(channels_last_3d, ChannelsLast3d)
AOTI_SMITH_MEMORY_FORMAT_IMPL(preserve_format, Preserve)
#undef AOTI_SMITH_MEMORY_FORMAT_IMPL

#define AOTI_SMITH_ITEM_IMPL(dtype, ctype)                     \
  AOTISmithError aoti_smith_item_##dtype(                      \
...
AOTI_SMITH_ITEM_IMPL(float16, c10::Half)
AOTI_SMITH_ITEM_IMPL(float32, float)
AOTI_SMITH_ITEM_IMPL(float64, double)
AOTI_SMITH_ITEM_IMPL(uint8, uint8_t)
AOTI_SMITH_ITEM_IMPL(uint16, uint16_t)
AOTI_SMITH_ITEM_IMPL(uint32, uint32_t)
AOTI_SMITH_ITEM_IMPL(uint64, uint64_t)
AOTI_SMITH_ITEM_IMPL(int8, int8_t)
AOTI_SMITH_ITEM_IMPL(int16, int16_t)
AOTI_SMITH_ITEM_IMPL(int32, int32_t)
AOTI_SMITH_ITEM_IMPL(int64, int64_t)
AOTI_SMITH_ITEM_IMPL(bool, bool)
AOTI_SMITH_ITEM_IMPL(bfloat16, c10::BFloat16)
AOTI_SMITH_ITEM_IMPL(complex64, c10::complex<float>)
#undef AOTI_SMITH_ITEM_IMPL

#define AOTI_SMITH_SCALAR_TO_TENSOR_IMPL(dtype, ctype, ttype)                  \
  AOTISmithError aoti_smith_scalar_to_tensor_##dtype(                          \
...
AOTI_SMITH_SCALAR_TO_TENSOR_IMPL(float32, float, Float)
AOTI_SMITH_SCALAR_TO_TENSOR_IMPL(float64, double, Double)
AOTI_SMITH_SCALAR_TO_TENSOR_IMPL(uint8, uint8_t, Byte)
AOTI_SMITH_SCALAR_TO_TENSOR_IMPL(uint16, uint16_t, UInt16)
AOTI_SMITH_SCALAR_TO_TENSOR_IMPL(uint32, uint32_t, UInt32)
AOTI_SMITH_SCALAR_TO_TENSOR_IMPL(uint64, uint64_t, UInt64)
AOTI_SMITH_SCALAR_TO_TENSOR_IMPL(int8, int8_t, Char)
AOTI_SMITH_SCALAR_TO_TENSOR_IMPL(int16, int16_t, Short)
AOTI_SMITH_SCALAR_TO_TENSOR_IMPL(int32, int32_t, Int)
AOTI_SMITH_SCALAR_TO_TENSOR_IMPL(int64, int64_t, Long)
AOTI_SMITH_SCALAR_TO_TENSOR_IMPL(bool, bool, Bool)
AOTI_SMITH_SCALAR_TO_TENSOR_IMPL(complex64, c10::complex<float>, ComplexFloat)
AOTI_SMITH_SCALAR_TO_TENSOR_IMPL(
    complex128,
    c10::complex<double>,
    ComplexDouble)
#undef AOTI_SMITH_SCALAR_TO_TENSOR_IMPL

uint64_t aoti_smith_abi_version() {
  return SMITH_ABI_VERSION;
}

bool aoti_smith_grad_mode_is_enabled() {
  return c10::GradMode::is_enabled();
}

void aoti_smith_grad_mode_set_enabled(bool enabled) {
  return c10::GradMode::set_enabled(enabled);
}

size_t aoti_smith_dtype_element_size(int32_t dtype) {
  auto scalar_type = static_cast<at::ScalarType>(dtype);
  return c10::elementSize(scalar_type);
}

AOTISmithError aoti_smith_delete_tensor_object(AtenTensorHandle tensor) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE({
    at::Tensor* t = tensor_handle_to_tensor_pointer(tensor);
    delete t;
  });
...
AOTISmithError aoti_smith_delete_c10_value_object(C10IValueHandle handle) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE({
...
AOTISmithError aoti_smith_int64_to_ivalue(
    int64_t val,
...
AOTISmithError aoti_smith_str_to_ivalue(
    const char* val,
    C10IValueHandle* ivalue) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE({
    c10::IValue* t = new c10::IValue(val);
...
AOTISmithError aoti_smith_strlist_to_ivalue(
    const char** val,
    int64_t len,
    C10IValueHandle* ivalue) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE({
...
AOTISmithError aoti_smith_tensor_to_ivalue(
...
AOTISmithError aoti_smith_get_data_ptr(
    AtenTensorHandle tensor,
    void** ret_data_ptr) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE({
    at::Tensor* t = tensor_handle_to_tensor_pointer(tensor);
...
AOTISmithError aoti_smith_get_storage_size(
    AtenTensorHandle tensor,
    int64_t* ret_size) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE({
    at::Tensor* t = tensor_handle_to_tensor_pointer(tensor);
...
AOTISmithError aoti_smith_get_dim(AtenTensorHandle tensor, int64_t* ret_dim) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE({
    at::Tensor* t = tensor_handle_to_tensor_pointer(tensor);
    *ret_dim = t->dim();
  });
...
AOTISmithError aoti_smith_get_numel(
    AtenTensorHandle tensor,
    int64_t* ret_numel) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE({
    at::Tensor* t = tensor_handle_to_tensor_pointer(tensor);
...
AOTISmithError aoti_smith_get_storage_numel(
    AtenTensorHandle tensor,
    int64_t* ret_numel) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE({
    at::Tensor* t = tensor_handle_to_tensor_pointer(tensor);
    SMITH_INTERNAL_ASSERT(t->has_storage());
    auto dtype_size = t->dtype().itemsize();
    size_t nbytes = t->storage().nbytes();
    SMITH_INTERNAL_ASSERT(nbytes % dtype_size == 0);
    auto numel = nbytes / dtype_size;
    *ret_numel = numel;
  });
}

AOTISmithError aoti_smith_get_sizes(
    AtenTensorHandle tensor,
    int64_t** ret_sizes) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE({
    at::Tensor* t = tensor_handle_to_tensor_pointer(tensor);
...
AOTISmithError aoti_smith_get_size(
    AtenTensorHandle tensor,
    int64_t d,
    int64_t* ret_size) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE({
...
AOTISmithError aoti_smith_get_strides(
    AtenTensorHandle tensor,
    int64_t** ret_strides) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE({
    at::Tensor* t = tensor_handle_to_tensor_pointer(tensor);
...
AOTISmithError aoti_smith_get_stride(
    AtenTensorHandle tensor,
    int64_t d,
    int64_t* ret_stride) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE({
...
AOTISmithError aoti_smith_get_dtype(
    AtenTensorHandle tensor,
    int32_t* ret_dtype) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE({
    at::Tensor* t = tensor_handle_to_tensor_pointer(tensor);
...
AOTISmithError aoti_smith_get_device_type(
    AtenTensorHandle tensor,
...
AOTISmithError aoti_smith_get_device_index(
    AtenTensorHandle tensor,
...
AOTISmithError aoti_smith_get_layout(
    AtenTensorHandle tensor,
    int32_t* ret_layout) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE({
    at::Tensor* t = tensor_handle_to_tensor_pointer(tensor);
...
AOTISmithError aoti_smith_get_storage_offset(
    AtenTensorHandle tensor,
...
AOTISmithError aoti_smith_is_contiguous(
    AtenTensorHandle tensor,
...
AOTISmithError aoti_smith_is_defined(
    AtenTensorHandle tensor,
    bool* ret_is_defined) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE({
    at::Tensor* t = tensor_handle_to_tensor_pointer(tensor);
...
AOTISmithError aoti_smith_new_tensor_handle(
...
AOTISmithError aoti_smith__reinterpret_tensor(
...
AOTISmithError aoti_smith_empty_strided_pinned(
    int64_t ndim,
    const int64_t* sizes_ptr,
    const int64_t* strides_ptr,
    int32_t dtype,
...
AOTISmithError aoti_smith_create_tensor_from_blob(
    void* data,
    int64_t ndim,
    const int64_t* sizes_ptr,
    const int64_t* strides_ptr,
...
AOTISmithError aoti_smith_create_tensor_from_blob_v2(
    void* data,
    int64_t ndim,
    const int64_t* sizes_ptr,
    const int64_t* strides_ptr,
  ...
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE({
    if (layout == static_cast<int32_t>(at::kMkldnn)) {
      ...
      c10::IntArrayRef strides(strides_ptr, ndim);
      c10::Device device = c10_device(device_type, device_index);
      // get a mkldnn tensor wrapped by a smith Tensor(OpaqueTensorImpl),
      ...
      *ret_new_tensor = new_tensor_handle(mkldnn_tensor_from_data_ptr(
      ...
      aoti_smith_create_tensor_from_blob(
          data,
          ndim,
          sizes_ptr,
          strides_ptr,
...
AOTISmithError aoti_smith__embedding_bag(
...
AOTISmithError aoti_smith__fft_c2c(
    AtenTensorHandle self,
...
AOTISmithError aoti_smith__scaled_dot_product_flash_attention_v2(
...
AOTISmithError aoti_smith__scaled_dot_product_flash_attention(
    AtenTensorHandle query,
    AtenTensorHandle key,
    AtenTensorHandle value,
    double dropout_p,
  ...
  return aoti_smith__scaled_dot_product_flash_attention_v2(
      query,
      key,
      value,
      dropout_p,
...
AOTISmithError aoti_smith__scaled_dot_product_efficient_attention(
    AtenTensorHandle query,
    AtenTensorHandle key,
    AtenTensorHandle value,
...
AOTISmithError aoti_smith_convolution(
...
AOTISmithError aoti_smith_new_uninitialized_tensor(AtenTensorHandle* ret) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE({
...
AOTISmithError aoti_smith__scaled_mm(
    AtenTensorHandle self,
...
AOTISmithError aoti_smith__scaled_mm_v2(
    AtenTensorHandle self,
    AtenTensorHandle mat2,
    AtenTensorHandle scale_a,
    AtenTensorHandle scale_b,
...
// TODO: implement a more efficient version instead of calling into aten
AOTISmithError aoti_smith_tensor_copy_(
    AtenTensorHandle src,
    AtenTensorHandle dst) {
  return aoti_smith_copy_(dst, src, /*non_blocking=*/0);
}

AOTISmithError aoti_smith_assign_tensors(
    AtenTensorHandle src,
    AtenTensorHandle dst) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE({
...
AOTISmithError aoti_smith_assign_tensors_out(
    AtenTensorHandle src,
...
AOTISmithError aoti_smith_clone(AtenTensorHandle self, AtenTensorHandle* ret) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE({
    at::Tensor* self_tensor = tensor_handle_to_tensor_pointer(self);
...
AOTISmithError aoti_smith_as_strided(
    AtenTensorHandle self,
    const int64_t* sizes_ptr,
    const int64_t* strides_ptr,
...
AOTISmithError aoti_smith_clone_preserve_strides(
    AtenTensorHandle self,
    AtenTensorHandle* ret) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE({
...
// TODO: implement a more efficient version instead of calling into aten
AOTISmithError aoti_smith_addmm_out(
...
// TODO: implement a more efficient version instead of calling into aten
AOTISmithError aoti_smith_bmm_out(
    AtenTensorHandle out,
    AtenTensorHandle self,
    AtenTensorHandle mat2) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE({
...
AOTISmithError aoti_smith_copy_(
    AtenTensorHandle self,
    AtenTensorHandle src,
...
// TODO: implement a more efficient version instead of calling into aten
AOTISmithError aoti_smith_mm_out(
    AtenTensorHandle out,
    AtenTensorHandle self,
    AtenTensorHandle mat2) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE({
...
AOTISmithError aoti_smith__mm_plus_mm_out(
    AtenTensorHandle out,
    AtenTensorHandle a,
    AtenTensorHandle b,
    AtenTensorHandle c,
  ...
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE({
    ...
    smith::inductor::_mm_plus_mm_out(
        *out_tensor, *a_tensor, *b_tensor, *c_tensor, *d_tensor);
  });
}

AOTISmithError aoti_smith_cpu_wrapped_fbgemm_pack_gemm_matrix_fp16(
    AtenTensorHandle weight,
    AtenTensorHandle* out) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE({
    at::Tensor* weight_tensor = tensor_handle_to_tensor_pointer(weight);
...
AOTISmithError aoti_smith_cpu__wrapped_linear_prepack(
    AtenTensorHandle weight,
...
AOTISmithError aoti_smith_cpu_wrapped_fbgemm_linear_fp16_weight(
    AtenTensorHandle input,
    AtenTensorHandle weight,
    AtenTensorHandle bias, // optional argument
    int64_t out_channel,
...
AOTISmithError aoti_smith_cpu__wrapped_quantized_linear_prepacked(
    AtenTensorHandle input,
...
AOTISmithError aoti_smith_nonzero(
    AtenTensorHandle self,
    AtenTensorHandle* out) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE({
    at::Tensor* self_tensor = tensor_handle_to_tensor_pointer(self);
...
AOTISmithError aoti_smith_repeat_interleave_Tensor(
...
AOTISmithError aoti_smith_check_inf_and_nan(
...
AOTISmithError aoti_record_function_start(
    const char* name,
...
AOTISmithError aoti_record_function_end(AtenRecordFunctionHandle guard) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE({
...
AOTISmithError aoti_smith_scatter_out(
    AtenTensorHandle out,
    AtenTensorHandle self,
    int64_t dim,
...
AOTISmithError aoti_smith_scatter_reduce_out(
    AtenTensorHandle out,
    AtenTensorHandle self,
    int64_t dim,
    AtenTensorHandle index,
...
AOTISmithError aoti_smith_index_put_out(
    AtenTensorHandle out,
    AtenTensorHandle self,
...
AOTISmithError aoti_smith_view_as_real(
    AtenTensorHandle self,
    AtenTensorHandle* ret // returns new reference
) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE({
...
AOTISmithError aoti_smith_view_dtype(
    AtenTensorHandle self,
    int32_t dtype,
    AtenTensorHandle* ret // returns new reference
) {
...
void aoti_smith_save_tensor_handle(
    AtenTensorHandle self,
    const char* tensor_name,
...
#ifndef C10_MOBILE
  // Save tensor to tmp .pt file for tensors and can be smith.load'ed later
  auto cwd = c10::filesystem::current_path();
  auto tmp_folder = cwd / "tmp" / "aoti_smith";
  if (!c10::filesystem::exists(tmp_folder)) {
    std::cout
        << "aoti_smith_save_tensor_handle: Path does not exist, creating it..."
        << tmp_folder << '\n';

    std::error_code ec{};
    if (!c10::filesystem::create_directories(tmp_folder, ec)) {
      std::cout << "aoti_smith_save_tensor_handle: Error creating directory: "
  ...
  auto bytes = smith::jit::pickle_save(c10::IValue(*t));
  ...
  std::cout << "aoti_smith_save_tensor_handle: Saved tensor to "
            << tensor_filepath_to_save << '\n';
#endif // !defined(C10_MOBILE)
}

void aoti_smith_print_tensor_handle(AtenTensorHandle self, const char* msg) {
  at::Tensor* t = tensor_handle_to_tensor_pointer(self);
  ...
  if (numel <= AOTI_SMITH_MAX_NUMEL_TO_PRINT) {
    std::cout << *t << '\n';
  }
  ...
  if (numel > 0) {
    // smith/aten `mean()` function only supports float and complex dtypes
    // See:
    // https://github.com/blacksmith/blacksmith/blob/a0e062c6f1a03ec93e87413e42c4d0b336518131/aten/src/ATen/native/ReduceOps.cpp#L304-L309
    ...
    if (!is_complex_type) {
      ...
      // source:
      // https://github.com/blacksmith/blacksmith/blob/4b3983241263b03abd25ae381ae4743ac49b648e/aten/src/ATen/native/cuda/ReduceMinValuesKernel.cu#L51
      if (numel <= 256) {
        std::cout
...
// ProxyExecutor
AOTISmithError aoti_smith_proxy_executor_call_function(
  ...
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE({
    if (!proxy_executor) {
      throw std::runtime_error(
          ...
          "smith._inductor.aoti_compile_and_package to package everything into a "
          "PT2 artifact.");
    }
...
void aoti_smith_check(
  ...
  if (C10_UNLIKELY_OR_CONST(!cond)) {
    ::c10::detail::smithCheckFail(func, file, line, msg);
  }
}

void aoti_smith_warn(
    const char* func,
    const char* file,
    uint32_t line,
    const char* msg) {
...
AOTISmithError aoti_smith__alloc_from_pool(
    AtenTensorHandle self,
  ...
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE({
    ...
    c10::IntArrayRef sizes(sizes_ptr, ndim);
    c10::IntArrayRef strides(strides_ptr, ndim);
    *ret_new_tensor = new_tensor_handle(smith::inductor::_alloc_from_pool(
        *self_tensor,
        offset_bytes,
        static_cast<c10::ScalarType>(dtype),
        sizes,
...
AOTISmithError aoti_smith_zero_(AtenTensorHandle tensor) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE({
    at::Tensor* t = tensor_handle_to_tensor_pointer(tensor);
    t->zero_();
  });
...
AOTISmithError aoti_smith_library_init_impl(
    const char* ns,
    const char* k,
    const char* file,
    uint32_t line,
  ...
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE({
    *ret_new_smith_lib =
        reinterpret_cast<SmithLibraryOpaque*>(new smith::Library(
            smith::Library::Kind::IMPL,
            std::string(ns),
...
AOTISmithError aoti_smith_library_init_def(
    const char* ns,
    const char* file,
    uint32_t line,
    SmithLibraryHandle* ret_new_smith_lib) {
...
AOTISmithError aoti_smith_library_init_fragment(
    const char* ns,
    const char* file,
    uint32_t line,
    SmithLibraryHandle* ret_new_smith_lib) {
...
aoti_smith_library_def(SmithLibraryHandle self, const char* name) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE(
      { reinterpret_cast<smith::Library*>(self)->def(name); });
}

AOTI_SMITH_EXPORT AOTISmithError
aoti_smith_delete_library_object(SmithLibraryHandle tlh) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE(
      { delete reinterpret_cast<smith::Library*>(tlh); });
}

AOTISmithError aoti_smith_create_device_guard(
    int32_t device_index,
...
AOTISmithError aoti_smith_delete_device_guard(DeviceGuardHandle guard) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE(
      { delete reinterpret_cast<c10::DeviceGuard*>(guard); });
}

AOTISmithError aoti_smith_device_guard_set_index(
...
AOTISmithError aoti_smith_delete_stream(StreamHandle stream) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE(
      { delete reinterpret_cast<c10::Stream*>(stream); });
}

AOTISmithError aoti_smith_stream_id(
    StreamHandle stream,
...
AOTISmithError aoti_smith_get_current_stream(
    int32_t device_index,
...
AOTISmithError aoti_smith_get_current_device_index(int32_t* ret_device_index) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE(
