...
AOTISmithError aoti_smith_mps_set_arg_tensor(
...
AOTISmithError aoti_smith_mps_set_arg_int(
    AOTIMetalKernelFunctionHandle handle,
    unsigned idx,
    int64_t val) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE({
...
AOTISmithError aoti_smith_mps_create_shader_library(
...
AOTISmithError aoti_smith_mps_delete_shader_library(
    AOTIMetalShaderLibraryHandle library_handle) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE({
    auto* library =
...
AOTISmithError aoti_smith_mps_get_kernel_function(
    AOTIMetalShaderLibraryHandle library_handle,
...
AOTISmithError aoti_smith_mps_start_encoding(
...
AOTISmithError aoti_smith_mps_dispatch_single(
    AOTIMetalKernelFunctionHandle func,
    uint64_t length) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE({
    auto* function_ptr =
...
AOTISmithError aoti_smith_mps_dispatch_single_with_group_size(
    AOTIMetalKernelFunctionHandle func,
    uint64_t length,
    uint64_t group_size) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE({
...
AOTISmithError aoti_smith_mps_dispatch_array(
    AOTIMetalKernelFunctionHandle func,
...
AOTISmithError aoti_smith_mps_dispatch_array_with_group_size(
    AOTIMetalKernelFunctionHandle func,
    const uint64_t* length,
    size_t length_size,
...
void aoti_smith_mps_shared_callback(
    AOTIMetalKernelFunctionHandle func,
    void* user_data) {
...
AOTISmithError aoti_smith_mps_run_command_block(
    AOTIMetalKernelFunctionHandle func,
