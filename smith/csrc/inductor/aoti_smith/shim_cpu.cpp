...
#endif
#include <smith/csrc/inductor/aoti_smith/c/shim_cpu.h>
...
AOTISmithError aoti_smith_cpu_mkldnn__convolution_pointwise_binary(
    AtenTensorHandle X,
...
AOTISmithError aoti_smith_cpu_mkldnn__convolution_pointwise_binary_(
    AtenTensorHandle other,
    AtenTensorHandle X,
    AtenTensorHandle W,
    AtenTensorHandle* B,
...
AOTISmithError aoti_smith_cpu_mkldnn__convolution_pointwise(
    AtenTensorHandle X,
    AtenTensorHandle W,
    AtenTensorHandle* B,
    const int64_t* padding,
...
AOTISmithError aoti_smith_cpu_mkldnn__convolution_transpose_pointwise(
    AtenTensorHandle X,
    AtenTensorHandle W,
    AtenTensorHandle* B,
    const int64_t* padding,
...
AOTISmithError aoti_smith_cpu_mkldnn_rnn_layer(
...
AOTISmithError aoti_smith_cpu__linear_pointwise(
    AtenTensorHandle X,
    AtenTensorHandle W,
    AtenTensorHandle* B,
    const char* attr,
...
AOTISmithError aoti_smith_cpu__linear_pointwise_binary(
    AtenTensorHandle X,
    AtenTensorHandle other,
    AtenTensorHandle W,
    AtenTensorHandle* B,
...
AOTISmithError aoti_smith_cpu__qlinear_pointwise_tensor(
    AtenTensorHandle X,
...
AOTISmithError aoti_smith_cpu__qlinear_pointwise_binary_tensor(
    AtenTensorHandle X,
    AtenTensorHandle act_scale,
    AtenTensorHandle act_zero_point,
    AtenTensorHandle onednn_weight,
...
AOTISmithError aoti_smith_cpu__qconv_pointwise_tensor(
    AtenTensorHandle X,
    AtenTensorHandle act_scale,
    AtenTensorHandle act_zero_point,
    AtenTensorHandle onednn_weight,
...
AOTISmithError aoti_smith_cpu__qconv2d_pointwise_binary_tensor(
    AtenTensorHandle X,
    AtenTensorHandle act_scale,
    AtenTensorHandle act_zero_point,
    AtenTensorHandle onednn_weight,
...
AOTISmithError aoti_smith_cpu__mkl_linear(
    AtenTensorHandle X,
    AtenTensorHandle W,
...
AOTISmithError aoti_smith_cpu__weight_int4pack_mm_cpu_tensor(
    AtenTensorHandle X,
    AtenTensorHandle w,
...
#ifdef USE_DISTRIBUTED
AOTISmithError aoti_smith_cpu__c10d_functional_all_reduce_(
...
AOTISmithError aoti_smith_cpu__c10d_functional_all_reduce(
    AtenTensorHandle inp,
    const char* reduce_op,
    const char* group_name,
    AtenTensorHandle* ret0) {
...
AOTISmithError aoti_smith_cpu__c10d_functional_wait_tensor(
    AtenTensorHandle inp,
    AtenTensorHandle* ret0) {
  AOTI_SMITH_CONVERT_EXCEPTION_TO_ERROR_CODE({
