#ifndef AOTI_SMITH_MACRO_H
#define AOTI_SMITH_MACRO_H

#include <stddef.h>
#include <stdint.h>
#ifdef __GNUC__
#define AOTI_SMITH_EXPORT __attribute__((__visibility__("default")))
#else // !__GNUC__
#ifdef _WIN32
// Blacksmith2 doesn't currently work on Windows. Exporting these APIs can lead
// to symbol clashes at link time if libsmith is included in a DLL and binary
...
#define AOTI_SMITH_EXPORT
#else /* OVRSOURCE */
#ifdef EXPORT_AOTI_FUNCTIONS
#define AOTI_SMITH_EXPORT __declspec(dllexport)
#else
#define AOTI_SMITH_EXPORT __declspec(dllimport)
#endif
#endif /* OVRSOURCE */
#else // !_WIN32
#define AOTI_SMITH_EXPORT
...
// between model.so and libsmith.so.  The contents of the structure itself
...
// in model.so, you are obligated to aoti_smith_delete_tensor_object when you
...
using AOTISmithError = int32_t;
#define AOTI_SMITH_SUCCESS 0
#define AOTI_SMITH_FAILURE 1

#ifdef __cplusplus
} // extern "C"
#endif

#endif // AOTI_SMITH_MACRO_H
