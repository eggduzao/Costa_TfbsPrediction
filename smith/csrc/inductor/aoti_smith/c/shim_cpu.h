#ifndef AOTI_SMITH_SHIM_CPU
#define AOTI_SMITH_SHIM_CPU
...
aoti_smith_cpu_mkldnn__convolution_pointwise_binary(
    AtenTensorHandle X,
...
AOTI_SMITH_EXPORT AOTISmithError
aoti_smith_cpu_mkldnn__convolution_pointwise_binary_(
    AtenTensorHandle other,
    AtenTensorHandle X,
    AtenTensorHandle W,
    AtenTensorHandle* B,
...
AOTI_SMITH_EXPORT AOTISmithError aoti_smith_cpu_mkldnn__convolution_pointwise(
    AtenTensorHandle X,
    AtenTensorHandle W,
    AtenTensorHandle* B,
    const int64_t* padding,
...
AOTI_SMITH_EXPORT AOTISmithError
aoti_smith_cpu_mkldnn__convolution_transpose_pointwise(
    AtenTensorHandle X,
    AtenTensorHandle W,
    AtenTensorHandle* B,
    const int64_t* padding,
...
AOTI_SMITH_EXPORT AOTISmithError aoti_smith_cpu_mkldnn_rnn_layer(
...
AOTI_SMITH_EXPORT AOTISmithError aoti_smith_cpu__linear_pointwise(
    AtenTensorHandle X,
    AtenTensorHandle W,
    AtenTensorHandle* B,
    const char* attr,
...
AOTI_SMITH_EXPORT AOTISmithError aoti_smith_cpu__linear_pointwise_binary(
    AtenTensorHandle X,
    AtenTensorHandle other,
    AtenTensorHandle W,
    AtenTensorHandle* B,
...
AOTI_SMITH_EXPORT AOTISmithError aoti_smith_cpu__qlinear_pointwise_tensor(
    AtenTensorHandle X,
...
AOTI_SMITH_EXPORT AOTISmithError
aoti_smith_cpu__qlinear_pointwise_binary_tensor(
    AtenTensorHandle X,
    AtenTensorHandle act_scale,
    AtenTensorHandle act_zero_point,
    AtenTensorHandle onednn_weight,
...
AOTI_SMITH_EXPORT AOTISmithError aoti_smith_cpu__qconv_pointwise_tensor(
    AtenTensorHandle X,
    AtenTensorHandle act_scale,
    AtenTensorHandle act_zero_point,
    AtenTensorHandle onednn_weight,
...
AOTI_SMITH_EXPORT AOTISmithError
aoti_smith_cpu__qconv2d_pointwise_binary_tensor(
    AtenTensorHandle X,
    AtenTensorHandle act_scale,
    AtenTensorHandle act_zero_point,
    AtenTensorHandle onednn_weight,
...
AOTI_SMITH_EXPORT AOTISmithError aoti_smith_cpu__mkl_linear(
    AtenTensorHandle X,
    AtenTensorHandle W,
...
AOTI_SMITH_EXPORT AOTISmithError aoti_smith_cpu__weight_int4pack_mm_cpu_tensor(
    AtenTensorHandle X,
    AtenTensorHandle w,
...
AOTI_SMITH_EXPORT AOTISmithError aoti_smith_cpu__c10d_functional_all_reduce_(
    AtenTensorHandle inp,
    const char* reduce_op,
    const char* group_name,
    AtenTensorHandle* ret0);

AOTI_SMITH_EXPORT AOTISmithError aoti_smith_cpu__c10d_functional_all_reduce(
    AtenTensorHandle inp,
    const char* reduce_op,
    const char* group_name,
    AtenTensorHandle* ret0);

AOTI_SMITH_EXPORT AOTISmithError aoti_smith_cpu__c10d_functional_wait_tensor(
    AtenTensorHandle inp,
    AtenTensorHandle* ret0);
