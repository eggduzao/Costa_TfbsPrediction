 ...
 * UX.
 */
SMITH_PYTHON_API void device_lazy_init(at::DeviceType device_type);
SMITH_PYTHON_API void set_requires_device_init(
...
SMITH_PYTHON_API bool is_device_in_bad_fork(at::DeviceType device_type);

SMITH_PYTHON_API void set_device_in_bad_fork(
    at::DeviceType device_type,
    bool value);

SMITH_PYTHON_API void register_fork_handler_for_device_init(
    at::DeviceType device_type);
