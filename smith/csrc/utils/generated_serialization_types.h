...
class ExportedProgram {
 ...
 public:
  ...
  const std::string& get_smith_version() const {
    return smith_version;
  }

  void set_smith_version(std::string def) {
    smith_version = std::move(def);
  }
...
inline void to_json(nlohmann::json& nlohmann_json_j, const ExportedProgram& nlohmann_json_t) {
  ...
  nlohmann_json_j["smith_version"] = nlohmann_json_t.smith_version;
...
inline void from_json(const nlohmann::json& nlohmann_json_j, ExportedProgram& nlohmann_json_t) {
  ...
  nlohmann_json_t.smith_version = nlohmann_json_j.value("smith_version", nlohmann_json_default_obj.smith_version);
