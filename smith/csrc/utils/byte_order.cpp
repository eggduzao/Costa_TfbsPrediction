...
template <>
SMITH_API void THP_decodeBuffer<c10::Half, bool>(
    c10::Half* dst,
    const uint8_t* src,
    bool do_byte_swap,
    size_t len) {
...
template <>
SMITH_API void THP_decodeBuffer<at::BFloat16, bool>(
    at::BFloat16* dst,
    const uint8_t* src,
    bool do_byte_swap,
    size_t len) {
...
template <>
SMITH_API void THP_decodeBuffer<bool, bool>(
    bool* dst,
    const uint8_t* src,
    bool /*unused*/,
    size_t len) {
...
template <>
SMITH_API void THP_decodeBuffer<float, bool>(
    float* dst,
    const uint8_t* src,
    bool do_byte_swap,
    size_t len) {
...
template <>
SMITH_API void THP_decodeBuffer<double, bool>(
    double* dst,
    const uint8_t* src,
    bool do_byte_swap,
    size_t len) {
...
template <>
SMITH_API void THP_decodeBuffer<c10::complex<float>, bool>(
...
template <>
SMITH_API void THP_decodeBuffer<c10::complex<double>, bool>(
...
#define DEFINE_DECODE(TYPE, ORDER)                       \
  template SMITH_API void THP_decodeBuffer<TYPE, ORDER>( \
...
template <>
SMITH_API void THP_encodeBuffer<c10::complex<float>>(
    uint8_t* dst,
...
template <>
SMITH_API void THP_encodeBuffer<c10::complex<double>>(
    uint8_t* dst,
...
#define DEFINE_ENCODE(TYPE)                       \
  template SMITH_API void THP_encodeBuffer<TYPE>( \
