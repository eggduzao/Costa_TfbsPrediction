...
// NOTE: [smith.tensor, lift_fresh, and device movement]
//
// The `only_lift_cpu_tensors` flag controls what happens on smith.tensor([1, 2,
...
SMITH_API bool only_lift_cpu_tensors();
SMITH_API void set_only_lift_cpu_tensors(bool value);

at::Tensor base_tensor_ctor(PyObject* args, PyObject* kwargs);
SMITH_PYTHON_API at::Tensor legacy_tensor_ctor(
