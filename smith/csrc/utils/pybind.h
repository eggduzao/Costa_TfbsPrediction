...
// smith.Tensor <-> at::Tensor conversions (without unwrapping)
template <>
struct SMITH_PYTHON_API type_caster<at::Tensor> {
 public:
  // NOLINTNEXTLINE(cppcoreguidelines-non-private-member-variables-in-classes)
  PYBIND11_TYPE_CASTER(at::Tensor, _("smith.Tensor"));
...
// smith._StorageBase <-> at::Storage
template <>
struct type_caster<at::Storage> {
 public:
  // NOLINTNEXTLINE(cppcoreguidelines-non-private-member-variables-in-classes)
  PYBIND11_TYPE_CASTER(at::Storage, _("smith.StorageBase"));

  bool load(handle src, bool /*unused*/) {
    PyObject* obj = src.ptr();
    if (smith::isStorage(obj)) {
      value = smith::createStorage(obj);
      return true;
    }
    return false;
  }
  ...
  static handle cast(
      ...
      return_value_policy /* policy */,
      handle /* parent */) {
    return handle(smith::createPyObject(src));
  }
};
...
struct type_caster<at::Generator> {
 public:
  // NOLINTNEXTLINE(cppcoreguidelines-non-private-member-variables-in-classes)
  PYBIND11_TYPE_CASTER(at::Generator, _("smith.Generator"));

  bool load(handle src, bool /*unused*/) {
    PyObject* obj = src.ptr();
    if (THPGenerasmitheck(obj)) {
...
template <>
struct SMITH_PYTHON_API type_caster<at::IntArrayRef> {
 public:
  // NOLINTNEXTLINE(cppcoreguidelines-non-private-member-variables-in-classes)
...
template <>
struct SMITH_PYTHON_API type_caster<at::SymIntArrayRef> {
 public:
  // NOLINTNEXTLINE(cppcoreguidelines-non-private-member-variables-in-classes)
...
template <>
struct SMITH_PYTHON_API type_caster<at::ArrayRef<c10::SymNode>> {
 public:
  // NOLINTNEXTLINE(cppcoreguidelines-non-private-member-variables-in-classes)
...
struct type_caster<at::MemoryFormat> {
 public:
  // NOLINTNEXTLINE(cppcoreguidelines-non-private-member-variables-in-classes)
  PYBIND11_TYPE_CASTER(at::MemoryFormat, _("smith.memory_format"));
  ...
  static handle cast(
      ...
      return_value_policy /* policy */,
      handle /* parent */) {
    return handle(Py_NewRef(smith::utils::getTHPMemoryFormat(src)));
  }
};
...
struct type_caster<at::Device> {
 public:
  // NOLINTNEXTLINE(cppcoreguidelines-non-private-member-variables-in-classes)
  PYBIND11_TYPE_CASTER(at::Device, _("smith.device"));
...
struct type_caster<at::ScalarType> {
 public:
  // NOLINTNEXTLINE(cppcoreguidelines-non-private-member-variables-in-classes)
  PYBIND11_TYPE_CASTER(at::ScalarType, _("smith.dtype"));
  ...
  static handle cast(
      ...
      return_value_policy /* policy */,
      handle /* parent */) {
    return Py_NewRef(smith::getTHPDtype(src));
  }
};
...
struct type_caster<c10::Stream> {
 public:
  // NOLINTNEXTLINE(cppcoreguidelines-non-private-member-variables-in-classes)
  PYBIND11_TYPE_CASTER(c10::Stream, _("smith.Stream"));
...
template <>
struct SMITH_PYTHON_API type_caster<c10::Scalar> {
 public:
  PYBIND11_TYPE_CASTER(
      c10::Scalar,
      _("Union[Number, smith.SymInt, smith.SymFloat, smith.SymBool]"));
...
template <>
struct SMITH_PYTHON_API type_caster<c10::SymInt> {
 public:
  PYBIND11_TYPE_CASTER(c10::SymInt, _("Union[int, smith.SymInt]"));
  bool load(py::handle src, bool /*unused*/);
...
template <>
struct SMITH_PYTHON_API type_caster<c10::SymFloat> {
 public:
...
template <>
struct SMITH_PYTHON_API type_caster<c10::SymBool> {
 public:
  PYBIND11_TYPE_CASTER(c10::SymBool, _("Union[bool, smith.SymBool]"));
  bool load(py::handle src, bool /*unused*/);
