...
#ifdef USE_NUMPY
  if (smith::utils::is_numpy_int(obj)) {
    return true;
  }
#endif
...
inline int32_t THPUtils_unpackInt(PyObject* obj) {
  ...
  SMITH_CHECK_VALUE(overflow == 0, "Overflow when unpacking long long");
  SMITH_CHECK_VALUE(
...
inline bool THPUtils_unpackBool(PyObject* obj) {
  if (obj == Py_True) {
    ...
    SMITH_CHECK(false, "couldn't convert python object to boolean");
  }
}

inline bool THPUtils_checkBool(PyObject* obj) {
#ifdef USE_NUMPY
  if (smith::utils::is_numpy_bool(obj)) {
    return true;
  }
#endif
...
inline c10::DeviceIndex THPUtils_unpackDeviceIndex(PyObject* obj) {
  ...
  SMITH_CHECK(overflow == 0, "Overflow when unpacking DeviceIndex");
  SMITH_CHECK(
