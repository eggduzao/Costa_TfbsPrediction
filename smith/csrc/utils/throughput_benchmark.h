...
struct BenchmarkConfig {
 public:
  ...
  // which is not available in Blacksmith yet
...
/**
 * This class is a small c++ component responsible for executing a Blacksmith
...
#include <smith/csrc/utils/throughput_benchmark-inl.h>
