...
SMITH_PYTHON_API py::handle get_symint_class();
SMITH_PYTHON_API py::handle get_symfloat_class();
SMITH_PYTHON_API py::handle get_symbool_class();
SMITH_PYTHON_API py::handle get_dynint_class();

// NB: These functions must not be called too early, otherwise smith not setup.
// Alternate design is to have smith "register" the object to us
...
#define SMITH_SYMNODE_SIZES_STRIDES(n)                                        \
  c10::SymNode n(                                                             \
  ...
  // clang-format off
    SMITH_SYMNODE_SIZES_STRIDES(is_contiguous)
    SMITH_SYMNODE_SIZES_STRIDES(is_channels_last_contiguous_2d)
    SMITH_SYMNODE_SIZES_STRIDES(is_channels_last_contiguous_3d)
    SMITH_SYMNODE_SIZES_STRIDES(is_channels_last_strides_2d)
    SMITH_SYMNODE_SIZES_STRIDES(is_channels_last_strides_3d)
    SMITH_SYMNODE_SIZES_STRIDES(is_non_overlapping_and_dense)
  // clang-format on

#undef SMITH_SYMNODE_SIZES_STRIDES
