...
// #define SMITHDYNAMO_DEBUG 1
#ifdef SMITHDYNAMO_DEBUG
...
// smith._dynamo.utils._breakpoint_for_c_dynamo, reset eval frame callback.
#define INSPECT(...)                                                  \
  {                                                                   \
    PyThreadState* cur_tstate = PyThreadState_Get();                  \
    _PyFrameEvalFunction prev_eval_frame =                            \
        _debug_set_eval_frame(cur_tstate, &_PyEval_EvalFrameDefault); \
    PyObject* smith__dynamo_utils_module =                            \
        PyImport_ImportModule("smith._dynamo.utils");                 \
    NULL_CHECK(smith__dynamo_utils_module);                           \
    PyObject* breakpoint_for_c_dynamo_fn = PyObject_GetAttrString(    \
        smith__dynamo_utils_module, "_breakpoint_for_c_dynamo");      \
    ...
    Py_DECREF(smith__dynamo_utils_module);                            \
  }
