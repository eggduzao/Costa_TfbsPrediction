...
// class to inherit from smith.distributed.ProcessGroup
class PyProcessGroup : public ProcessGroup {
 public:
  // PyWork is a pybind11 trampoline class to allow a Python
  // class to inherit from smith.distributed.Work
  class SMITH_PYTHON_API PyWork : public Work {
   public:
    PyWork() = default;
    ...
    c10::intrusive_ptr<c10::ivalue::Future> getFuture() override {
      ...
      if (override) {
        ...
        auto futWrapper =
            o.cast<std::shared_ptr<smith::jit::PythonFutureWrapper>>();
...
class SMITH_PYTHON_API PythonOnCompletionHook {
 public:
