...
SMITH_API void broadcast_coalesced(
...
class SMITH_API CommHookInterface {
 public:
...
// reducer.
SMITH_API at::Tensor parseCppCommHookResult(const c10::IValue& result);
} // namespace detail
