#include <smith/csrc/distributed/c10d/symm_mem/nccl_dev_cap.hpp>
...
#include <smith/csrc/distributed/c10d/symm_mem/CUDASymmetricMemoryTypes.hpp>
#include <smith/csrc/distributed/c10d/symm_mem/NCCLSymmetricMemory.hpp>
#include <smith/csrc/distributed/c10d/symm_mem/nccl_devcomm_manager.hpp>
...
class NCCLPeerAllocInfo : public c10::intrusive_ptr_target {
 public:
        ...
        group_name_(std::move(group_name))
  {
    ...
    SMITH_CHECK(ncclPg != nullptr, "backend must be a NCCL process group");
...
NCCLSymmetricMemory::NCCLSymmetricMemory(
  ...
  SMITH_INTERNAL_ASSERT(offset_ < pai_->buffer_size_, "offset out of range");
}
...
class NCCLSymmetricMemoryAllocator : public SymmetricMemoryAllocator {
 public:
  ...
  c10::intrusive_ptr<SymmetricMemory> rendezvous(
      void* ptr,
      const std::optional<std::string>& group_name) override {
    SMITH_CHECK(group_name.has_value(), "group_name must be provided");
