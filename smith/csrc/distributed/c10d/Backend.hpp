...
class SMITH_API Backend : public smith::CustomClassHolder {
 public:
  ...
  struct SMITH_API Options : smith::CustomClassHolder {
    explicit Options(
        std::string backend,
  ...
  virtual const std::string getBackendName() const {
    SMITH_INTERNAL_ASSERT(false, "getBackendName is not implemented.");
  }
