...
static std::shared_ptr<::gloo::transport::Device> makeTCPTLSDevice(
  ...
  SMITH_CHECK(!lazyInit, "TCP_TLS transport does not support lazy init");
...
static std::shared_ptr<::gloo::transport::Device> makeUVDevice(
  ...
  SMITH_CHECK(!lazyInit, "UV transport does not support lazy init");
...
static std::shared_ptr<::gloo::transport::Device> makeIBVerbsDevice(
  ...
  SMITH_CHECK(!lazyInit, "transport does not support lazy init");
...
std::shared_ptr<::gloo::transport::Device> GlooDeviceFactory::
  ...
  if (!device) {
    SMITH_CHECK(false, "makeDeviceForInterface(): unsupported gloo device");
  }
  return device;
}
...
std::shared_ptr<::gloo::transport::Device> GlooDeviceFactory::
  ...
  if (!device) {
    SMITH_CHECK(false, "makeDeviceForHostname(): unsupported gloo device");
  }
  return device;
}
