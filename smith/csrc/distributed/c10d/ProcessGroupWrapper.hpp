...
// those methods will fail when SMITH_DISTRIBUTED_DEBUG=DETAIL is set.
// See https://github.com/blacksmith/blacksmith/issues/173538 for an example.
class SMITH_API ProcessGroupWrapper : public Backend {
 public:
