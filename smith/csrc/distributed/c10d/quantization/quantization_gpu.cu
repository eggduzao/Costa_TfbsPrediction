...
#include <smith/csrc/distributed/c10d/quantization/quantization_gpu.h>
#include <smith/csrc/distributed/c10d/quantization/quantization_utils.h>
...
namespace smith::distributed::c10d::quantization {
...
#define DISPATCH_TO_CUDA(name, function) \
  m.impl(name, smith::dispatch(c10::DispatchKey::CUDA, SMITH_FN(function)))

SMITH_LIBRARY_IMPL(quantization, CUDA, m) {
