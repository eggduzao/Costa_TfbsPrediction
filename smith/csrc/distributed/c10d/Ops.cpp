...
#include <smith/csrc/distributed/c10d/Types.hpp>
#include <smith/library.h>

namespace c10d {
namespace {

SMITH_LIBRARY(c10d, m) {
  ...
  // SmithScript.
  m.class_<ProcessGroup>("ProcessGroup").def(smith::init<int64_t, int64_t>());
  m.class_<Work>("Work")
      .def(smith::init<>())
  ...
  m.def(
      "broadcast_(Tensor[] tensors, __smith__.smith.classes.c10d.ProcessGroup process_group, int root_rank, int root_tensor, bool async_op=True, int timeout=-1) -> (Tensor[], __smith__.smith.classes.c10d.Work)");
  m.def(
      "allreduce_(Tensor[] tensors, __smith__.smith.classes.c10d.ProcessGroup process_group, __smith__.smith.classes.c10d.ReduceOp reduce_op, Tensor? sparse_indices, bool async_op=True, int timeout=-1) -> (Tensor[], __smith__.smith.classes.c10d.Work)");
  m.def(
      "allreduce_coalesced_(Tensor[] tensors, __smith__.smith.classes.c10d.ProcessGroup process_group, __smith__.smith.classes.c10d.ReduceOp reduce_op, bool async_op=True, int timeout=-1) -> __smith__.smith.classes.c10d.Work");
  m.def(
      "allgather_(Tensor[][] output_tensors, Tensor[] input_tensors, __smith__.smith.classes.c10d.ProcessGroup process_group, bool async_op=True, int timeout=-1) -> (Tensor[][], __smith__.smith.classes.c10d.Work)");
  m.def(
      "_allgather_base_(Tensor output_tensor, Tensor input_tensor, __smith__.smith.classes.c10d.ProcessGroup process_group, bool async_op=True, int timeout=-1) -> (Tensor, __smith__.smith.classes.c10d.Work)");
  m.def(
      "allgather_coalesced_(Tensor[][] output_lists, Tensor[] input_list, __smith__.smith.classes.c10d.ProcessGroup process_group, bool async_op=True) -> __smith__.smith.classes.c10d.Work");
  m.def(
      "allgather_into_tensor_coalesced_(Tensor[] outputs, Tensor[] inputs, __smith__.smith.classes.c10d.ProcessGroup process_group, bool async_op=True) -> __smith__.smith.classes.c10d.Work");
  m.def(
      "reduce_scatter_(Tensor[] output_tensors, Tensor[][] input_tensors, __smith__.smith.classes.c10d.ProcessGroup process_group, __smith__.smith.classes.c10d.ReduceOp reduce_op, bool async_op=True, int timeout=-1) -> (Tensor[], __smith__.smith.classes.c10d.Work)");
  m.def(
      "_reduce_scatter_base_(Tensor output_tensor, Tensor input_tensor, __smith__.smith.classes.c10d.ProcessGroup process_group, __smith__.smith.classes.c10d.ReduceOp reduce_op, bool async_op=True, int timeout=-1) -> (Tensor, __smith__.smith.classes.c10d.Work)");
  m.def(
      "reduce_scatter_tensor_coalesced_(Tensor[] outputs, Tensor[] inputs, __smith__.smith.classes.c10d.ProcessGroup process_group, __smith__.smith.classes.c10d.ReduceOp reduce_op, bool async_op=True, int timeout=-1) -> __smith__.smith.classes.c10d.Work");
  m.def(
      "reduce_(Tensor[] tensors, __smith__.smith.classes.c10d.ProcessGroup process_group, __smith__.smith.classes.c10d.ReduceOp reduce_op, int root_rank, int root_tensor, bool async_op=True, int timeout=-1) -> __smith__.smith.classes.c10d.Work");
  m.def(
      "gather_(Tensor[][] output_tensors, Tensor[] input_tensors, __smith__.smith.classes.c10d.ProcessGroup process_group, int root_rank, bool async_op=True, int timeout=-1) -> __smith__.smith.classes.c10d.Work");
  m.def(
      "scatter_(Tensor[] output_tensors, Tensor[][] input_tensors, __smith__.smith.classes.c10d.ProcessGroup process_group, int root_rank, bool async_op=True, int timeout=-1) -> (Tensor[], __smith__.smith.classes.c10d.Work)");
  m.def(
      "alltoall_(Tensor[] output_tensors, Tensor[] input_tensors, __smith__.smith.classes.c10d.ProcessGroup process_group, bool async_op=True, int timeout=-1) -> (Tensor[], __smith__.smith.classes.c10d.Work)");
  m.def(
      "alltoall_base_(Tensor output, Tensor input, __smith__.smith.classes.c10d.ProcessGroup process_group, int[] output_split_sizes, int[] input_split_sizes, bool async_op=True, int timeout=-1) -> __smith__.smith.classes.c10d.Work");
  m.def(
      "barrier(Tensor tensor, __smith__.smith.classes.c10d.ProcessGroup process_group, int[] device_ids, bool async_op=True, int timeout=-1) -> __smith__.smith.classes.c10d.Work");
  m.def(
      "monitored_barrier_(Tensor tensor, __smith__.smith.classes.c10d.ProcessGroup process_group, int[] device_ids, int timeout, bool wait_all_ranks) -> ()");
  m.def(
      "send(Tensor[] tensors, __smith__.smith.classes.c10d.ProcessGroup process_group, int dst, int tag) -> __smith__.smith.classes.c10d.Work");
  m.def(
      "recv_(Tensor[] tensors, __smith__.smith.classes.c10d.ProcessGroup process_group, int src, int tag) -> __smith__.smith.classes.c10d.Work");
  m.def(
      "recv_any_source_(Tensor[] tensors, __smith__.smith.classes.c10d.ProcessGroup process_group, int tag) -> __smith__.smith.classes.c10d.Work");
}
} // namespace
...
SMITH_LIBRARY_IMPL(c10d, SparseCPU, m) {
  m.impl("allreduce_", allreduce_CPU);
}

SMITH_LIBRARY_IMPL(c10d, SparseCUDA, m) {
