...
class SMITH_API RRefMessageBase : public RpcCommandBase {
 public:
...
class SMITH_API ForkMessageBase : public RRefMessageBase {
 public:
...
class SMITH_API ScriptRRefFetchCall final : public RRefMessageBase {
 public:
...
class SMITH_API PythonRRefFetchCall final : public RRefMessageBase {
 public:
...
class SMITH_API RRefFetchRet : public RpcCommandBase {
 public:
...
class SMITH_API ScriptRRefFetchRet final : public RRefFetchRet {
 public:
...
class SMITH_API PythonRRefFetchRet final : public RRefFetchRet {
 public:
...
// OwnerRRef on delete.
class SMITH_API RRefUserDelete final : public ForkMessageBase {
 public:
...
class SMITH_API RemoteRet final : public ForkMessageBase {
 public:
...
class SMITH_API RRefChildAccept final : public RpcCommandBase {
 public:
...
class SMITH_API RRefForkRequest final : public ForkMessageBase {
 public:
...
class SMITH_API RRefAck final : public RpcCommandBase {
 public:
  RRefAck() = default;
