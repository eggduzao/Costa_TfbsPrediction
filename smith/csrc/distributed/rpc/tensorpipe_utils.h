...
SMITH_API const c10::Stream& getStreamForDevice(
...
#define C10_REGISTER_TENSORPIPE_DEVICE_TYPE_CONVERTER(                     \
  ...
  static ::smith::distributed::rpc::TensorpipeDeviceTypeConverterRegistrar \
...
struct TensorpipeWriteBuffers {
  ...
  // memory, e.g., the ones created from smith::from_blob() with no deleter.
...
SMITH_API std::tuple<tensorpipe::Message, TensorpipeWriteBuffers>
tensorpipeSerialize(
...
SMITH_API std::pair<tensorpipe::Allocation, TensorpipeReadBuffers>
tensorpipeAllocate(
...
SMITH_API c10::intrusive_ptr<Message> tensorpipeDeserialize(
    const tensorpipe::Descriptor& tpDescriptor,
