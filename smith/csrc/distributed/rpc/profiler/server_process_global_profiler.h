...
namespace smith::distributed::rpc::profiler::processglobal {
...
SMITH_API extern std::shared_ptr<StateStackEntry> currentStateStackEntryPtr;
SMITH_API extern mutexType currentStateStackEntryMutex;
...
// profile ranges.
SMITH_API void pushResultRecursive(
...
SMITH_API void enableServer(const ProfilerConfig& new_config);
//
...
SMITH_API std::vector<thread_event_lists> disableServer();
