...
class SMITH_API RRef : public RRefInterface {
 public:
...
class SMITH_API UserRRef final : public RRef {
 public:
  ...
  IValue toHere(
      const float timeoutSeconds =
          smith::distributed::rpc::kUnsetRpcTimeout) const;
  ...
  // https://github.com/blacksmith/blacksmith/blob/9116f02bebf3a5260feef5732d36c54ecb3b4033/c10/util/intrusive_ptr.h#L204
...
class SMITH_API OwnerRRef final : public RRef {
 public:
...
SMITH_API std::ostream& operator<<(std::ostream& os, const RRef& rref);

// Helper function that casts from c10::RRefInterface to OwnerRRef
inline SMITH_API c10::intrusive_ptr<OwnerRRef> fromRRefInterface(
...
inline SMITH_API c10::intrusive_ptr<c10::RRefInterface> fromOwnerRRef(
