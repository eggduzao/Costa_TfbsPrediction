...
SMITH_API void enableJitRRefPickle();
SMITH_API void disableJitRRefPickle();

struct SMITH_API JitRRefPickleGuard {
  JitRRefPickleGuard();
...
struct SMITH_API GloballyUniqueId final {
...
struct SMITH_API SerializedPyObj final {
