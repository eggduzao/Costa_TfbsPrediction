...
#include <smith/csrc/distributed/rpc/testing/faulty_tensorpipe_agent.h>
...
namespace smith::distributed::rpc::testing {
...
PyObject* faulty_agent_init(PyObject* _unused, PyObject* noargs) {
  ...
  // to the python module smith._C._distributed_rpc_testing
