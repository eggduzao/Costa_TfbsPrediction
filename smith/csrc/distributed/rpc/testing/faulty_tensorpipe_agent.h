...
struct SMITH_API FaultyTensorPipeRpcBackendOptions
  ...
  FaultyTensorPipeRpcBackendOptions(
    ...
    SMITH_CHECK(numFailSends >= 0, "numFailSends should be non-negative");
  }
...
class SMITH_API FaultyTensorPipeAgent : public TensorPipeAgent {
 public:
