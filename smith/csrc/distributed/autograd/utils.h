...
SMITH_API void addSendRpcBackward(
...
SMITH_API ContextPtr addRecvRpcBackward(
    const AutogradMetadata& autogradMetadata,
    std::vector<smith::Tensor>& tensors,
...
SMITH_API c10::intrusive_ptr<rpc::Message> getMessageWithAutograd(
...
SMITH_API c10::intrusive_ptr<c10::ivalue::Future> sendMessageWithAutograd(
    rpc::RpcAgent& agent,
