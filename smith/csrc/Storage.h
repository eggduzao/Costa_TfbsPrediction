...
#define THPStorageStr "smith.UntypedStorage"
...
SMITH_PYTHON_API PyObject* THPStorage_Wrap(c10::Storage storage);
SMITH_PYTHON_API PyObject* THPStorage_NewWithStorage(
    PyTypeObject* type,
    c10::Storage _storage);
SMITH_PYTHON_API extern PyTypeObject* THPStorageClass;
...
SMITH_PYTHON_API void THPStorage_assertNotNull(PyObject* obj);

SMITH_PYTHON_API extern PyTypeObject THPStorageType;
