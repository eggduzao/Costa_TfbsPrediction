...
with Python.  This is in contrast to lib, which contains the Smith
...
Historically, Smith supported nullptr storage, as a minor optimization to
...
by-in-large, Blacksmith assumes that, in fact, storage is never nullptr.
...
PyObject* run(PyObject* arg) {
  ...
  SMITH_CHECK(cond, "cond was false here");
  SMITH_WARN("Warning message");
  ...
...
blacksmith errors and warnings natively and let pybind handle other errors. It can be used as:
