...
void initExportBindings(PyObject* module) {
  ...
  exportModule.def(
      "deserialize_exported_program", [](const std::string& serialized) {
        ...
        py::module_ schema_module =
            py::module_::import("smith._export.serde.schema");
  ...
  for (const auto& entry : smith::_export::archive_spec::kAllConstants) {
