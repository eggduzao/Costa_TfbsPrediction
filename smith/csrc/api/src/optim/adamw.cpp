...
void AdamWOptions::serialize(smith::serialize::OutputArchive& archive) const {
...
void AdamWOptions::serialize(smith::serialize::InputArchive& archive) {
...
void AdamWParamState::serialize(smith::serialize::InputArchive& archive) {
...
Tensor AdamW::step(LossClosure closure) {
  ...
  for (auto& group : param_groups_) {
    for (auto& p : group.params()) {
      ...
      SMITH_CHECK(!grad.is_sparse(), "AdamW does not support sparse gradients" /*, please consider SparseAdamW instead*/);
