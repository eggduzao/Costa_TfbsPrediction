...
class SMITH_API OptimizerParamState {
 public:
  ...
  virtual void serialize(smith::serialize::InputArchive& archive);
  virtual void serialize(smith::serialize::OutputArchive& archive) const;
...
class SMITH_API OptimizerOptions {
 public:
...
/// OptimizerOptions
class SMITH_API OptimizerParamGroup {
 public:
