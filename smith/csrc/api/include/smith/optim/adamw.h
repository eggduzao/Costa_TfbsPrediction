...
struct SMITH_API AdamWOptions : public OptimizerCloneableOptions<AdamWOptions> {
  ...
  SMITH_ARG(double, weight_decay) = 1e-2;
...
struct SMITH_API AdamWParamState
...
class SMITH_API AdamW : public Optimizer {
 public:
  explicit AdamW(
 ...
 private:
  ...
  static void serialize(Self& self, Archive& archive) {
    _SMITH_OPTIM_SERIALIZE_WITH_TEMPLATE_ARG(AdamW);
  }
};
} // namespace smith::optim
