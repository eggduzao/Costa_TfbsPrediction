...
struct DataLoaderOptions {
  ...
  SMITH_ARG(bool, enforce_ordering) = true;

  /// Whether to omit the last batch if it contains less than `batch_size`
  /// examples.
  SMITH_ARG(bool, drop_last) = false;
};
