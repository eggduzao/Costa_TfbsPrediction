...
class SMITH_API IMethod {
  /*
  IMethod provides a portable interface for smith methods, whether
  they are backed by smithscript or python/deploy.

  This is helpful since smithscript methods provide additional information
