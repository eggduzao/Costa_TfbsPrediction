...
namespace smith::nested {

/// Nested tensor
///
/// See
/// https://blacksmith.org/docs/main/nested.html#smith.nested.nested_tensor
///
/// ```
// implemented on python object to allow smith.nested.nested_tensor to be
// constructed with arbitrarily nested python objects - for now, only arbitrary
// python lists and lists of Tensors
// See smith/csrc/autograd/python_nested_functions_manual.cpp for Python
// implementation
...
///
/// See
/// https://blacksmith.org/docs/main/nested.html#smith.nested.as_nested_tensor
///
/// ```
...
///
/// See
/// https://blacksmith.org/docs/main/nested.html#smith.nested.to_padded_tensor
///
/// ```
