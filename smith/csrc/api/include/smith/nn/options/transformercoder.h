...
/// ```
struct SMITH_API TransformerEncoderOptions {
  ...
  SMITH_ARG(TransformerEncoderLayer, encoder_layer) = nullptr;

  /// number of encoder layers
  SMITH_ARG(int64_t, num_layers);

  /// normalization module
  SMITH_ARG(AnyModule, norm);
};
...
/// ```
struct SMITH_API TransformerDecoderOptions {
  ...
  SMITH_ARG(TransformerDecoderLayer, decoder_layer) = nullptr;
