...
struct AvgPoolOptions {
  ...
  SMITH_ARG(ExpandingArray<D>, kernel_size);

  /// the stride of the window. Default value is `kernel_size`
  SMITH_ARG(ExpandingArray<D>, stride);

  /// implicit zero padding to be added on both sides
  SMITH_ARG(ExpandingArray<D>, padding) = 0;

  /// when True, will use `ceil` instead of `floor` to compute the output shape
  SMITH_ARG(bool, ceil_mode) = false;

  /// when True, will include the zero-padding in the averaging calculation
  SMITH_ARG(bool, count_include_pad) = true;

  /// if specified, it will be used as divisor, otherwise size of the pooling
  /// region will be used.

  SMITH_ARG(std::optional<int64_t>, divisor_override) = std::nullopt;
};
...
/// Options for `smith::nn::functional::avg_pool1d`.
///
...
namespace functional {
/// Options for `smith::nn::functional::avg_pool2d`.
///
...
namespace functional {
/// Options for `smith::nn::functional::avg_pool3d`.
///
...
struct MaxPoolOptions {
  ...
  SMITH_ARG(ExpandingArray<D>, dilation) = 1;
...
namespace functional {
/// Options for `smith::nn::functional::max_pool1d` and
...
namespace functional {
/// Options for `smith::nn::functional::max_pool2d` and
...
namespace functional {
/// Options for `smith::nn::functional::max_pool3d` and
...
struct AdaptiveMaxPoolOptions {
  ...
  SMITH_ARG(output_size_t, output_size);
};
...
namespace functional {
/// Options for `smith::nn::functional::adaptive_max_pool1d` and
...
namespace functional {
/// Options for `smith::nn::functional::adaptive_max_pool2d` and
...
namespace functional {
/// Options for `smith::nn::functional::adaptive_max_pool3d` and
...
namespace functional {
/// Options for `smith::nn::functional::adaptive_avg_pool1d`.
///
...
namespace functional {
/// Options for `smith::nn::functional::adaptive_avg_pool2d`.
///
...
namespace functional {
/// Options for `smith::nn::functional::adaptive_avg_pool3d`.
///
...
struct MaxUnpoolFuncOptions {
  ...
  SMITH_ARG(std::optional<std::vector<int64_t>>, output_size) = std::nullopt;
};
...
struct FractionalMaxPoolOptions {
  ...
  SMITH_ARG(std::optional<ExpandingArray<D>>, output_size) = std::nullopt;
  ...
  using ExpandingArrayDouble = smith::ExpandingArray<D, double>;
  SMITH_ARG(std::optional<ExpandingArrayDouble>, output_ratio) = std::nullopt;

  SMITH_ARG(smith::Tensor, _random_samples);
};
...
namespace functional {
/// Options for `smith::nn::functional::fractional_max_pool2d` and
...
namespace functional {
/// Options for `smith::nn::functional::fractional_max_pool3d` and
...
namespace functional {
/// Options for `smith::nn::functional::lp_pool1d`.
///
...
namespace functional {
/// Options for `smith::nn::functional::lp_pool2d`.
///
...
namespace functional {
/// Options for `smith::nn::functional::lp_pool3d`.
///
