...
template <size_t D>
struct SMITH_API ReflectionPadOptions {
  ...
  SMITH_ARG(ExpandingArray<D * 2>, padding);
};
...
template <size_t D>
struct SMITH_API ReplicationPadOptions {
...
template <size_t D>
struct SMITH_API ZeroPadOptions {
...
template <size_t D>
struct SMITH_API ConstantPadOptions {
...
/// Options for `smith::nn::functional::pad`.
///
/// Example:
/// ```
...
/// ```
struct SMITH_API PadFuncOptions {
  typedef std::variant<
      enumtype::kConstant,
      enumtype::kReflect,
      enumtype::kReplicate,
  ...
  SMITH_ARG(std::vector<int64_t>, pad);

  /// "constant", "reflect", "replicate" or "circular". Default: "constant"
  SMITH_ARG(mode_t, mode) = smith::kConstant;

  /// fill value for "constant" padding. Default: 0
  SMITH_ARG(double, value) = 0;
};
