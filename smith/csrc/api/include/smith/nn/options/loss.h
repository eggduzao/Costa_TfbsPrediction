...
/// ```
struct SMITH_API L1LossOptions {
  typedef std::variant<enumtype::kNone, enumtype::kMean, enumtype::kSum>
      reduction_t;

  SMITH_OPTIONS_CTOR_VARIANT_ARG3(L1LossOptions, reduction, kNone, kMean, kSum)

  /// Specifies the reduction to apply to the output.
  SMITH_ARG(reduction_t, reduction) = smith::kMean;
};

namespace functional {
/// Options for `smith::nn::functional::l1_loss`.
///
...
/// ```
/// KLDivLoss
/// model(KLDivLossOptions().reduction(smith::kNone).log_target(false));
/// ```
struct SMITH_API KLDivLossOptions {
  typedef std::variant<
      enumtype::kNone,
      enumtype::kBatchMean,
      enumtype::kSum,
  ...
  SMITH_OPTIONS_CTOR_VARIANT_ARG4(
      KLDivLossOptions,
      reduction,
      kNone,
      kBatchMean,
  ...
  SMITH_ARG(bool, log_target) = false;
};

namespace functional {
/// Options for `smith::nn::functional::kl_div`.
///
...
/// ```
struct SMITH_API MSELossOptions {
  typedef std::variant<enumtype::kNone, enumtype::kMean, enumtype::kSum>
      reduction_t;

  SMITH_OPTIONS_CTOR_VARIANT_ARG3(MSELossOptions, reduction, kNone, kMean, kSum)
...
namespace functional {
/// Options for `smith::nn::functional::mse_loss`.
///
...
/// ```
struct SMITH_API BCELossOptions {
  typedef std::variant<enumtype::kNone, enumtype::kMean, enumtype::kSum>
      reduction_t;
...
namespace functional {
/// Options for `smith::nn::functional::binary_cross_entropy`.
///
...
/// ```
struct SMITH_API MultiMarginLossOptions {
  typedef std::variant<enumtype::kNone, enumtype::kMean, enumtype::kSum>
      reduction_t;

  /// Has a default value of :math:`1`. :math:`1` and :math:`2`
  /// are the only supported values.
  SMITH_ARG(int64_t, p) = 1;
...
namespace functional {
/// Options for `smith::nn::functional::multi_margin_loss`.
///
...
/// ```
struct SMITH_API CosineEmbeddingLossOptions {
  typedef std::variant<enumtype::kNone, enumtype::kMean, enumtype::kSum>
      reduction_t;
  ...
  SMITH_ARG(double, margin) = 0.0;
  /// Specifies the reduction to apply to the output. Default: Mean
  SMITH_ARG(reduction_t, reduction) = smith::kMean;
};

namespace functional {
/// Options for `smith::nn::functional::cosine_embedding_loss`.
///
...
/// ```
struct SMITH_API MultiLabelMarginLossOptions {
  typedef std::variant<enumtype::kNone, enumtype::kMean, enumtype::kSum>
      reduction_t;

  SMITH_OPTIONS_CTOR_VARIANT_ARG3(
...
namespace functional {
/// Options for `smith::nn::functional::multilabel_margin_loss`.
///
...
/// ```
struct SMITH_API SoftMarginLossOptions {
  typedef std::variant<enumtype::kNone, enumtype::kMean, enumtype::kSum>
      reduction_t;
...
namespace functional {
/// Options for `smith::nn::functional::soft_margin_loss`.
///
...
/// ```
struct SMITH_API MultiLabelSoftMarginLossOptions {
  typedef std::variant<enumtype::kNone, enumtype::kMean, enumtype::kSum>
      reduction_t;
...
namespace functional {
/// Options for `smith::nn::functional::multilabel_soft_margin_loss`.
///
...
/// ```
struct SMITH_API TripletMarginLossOptions {
  typedef std::variant<enumtype::kNone, enumtype::kMean, enumtype::kSum>
      reduction_t;
  ...
  SMITH_ARG(bool, swap) = false;
  /// Specifies the reduction to apply to the output. Default: Mean
  SMITH_ARG(reduction_t, reduction) = smith::kMean;
};

namespace functional {
/// Options for `smith::nn::functional::triplet_margin_loss`.
///
...
/// ```
struct SMITH_API TripletMarginWithDistanceLossOptions {
  typedef std::variant<enumtype::kNone, enumtype::kMean, enumtype::kSum>
      reduction_t;
  ...
  SMITH_ARG(std::optional<distance_function_t>, distance_function) =
      std::nullopt;
...
namespace functional {
/// Options for `smith::nn::functional::triplet_margin_with_distance_loss`.
///
...
/// ```
struct SMITH_API SmoothL1LossOptions {
  typedef std::variant<enumtype::kNone, enumtype::kMean, enumtype::kSum>
      reduction_t;
  ...
  /// Default: nullopt
  SMITH_ARG(std::optional<double>, beta) = std::nullopt;
};

namespace functional {
/// Options for `smith::nn::functional::smooth_l1_loss`.
///
...
/// ```
struct SMITH_API HuberLossOptions {
  typedef std::variant<enumtype::kNone, enumtype::kMean, enumtype::kSum>
      reduction_t;
  ...
  /// Specifies the threshold at which to change between L1 and L2 loss.
  /// Default: 1.0
  SMITH_ARG(double, delta) = 1.0;
};

namespace functional {
/// Options for `smith::nn::functional::huber_loss`.
///
...
/// ```
/// namespace F = smith::nn::functional;
/// F::huber_loss(input, target, F::HuberLossFuncOptions(smith::kNone));
/// ```
...
namespace functional {
/// Options for `smith::nn::functional::poisson_nll_loss`.
///
...
/// ```
struct SMITH_API MarginRankingLossOptions {
  typedef std::variant<enumtype::kNone, enumtype::kMean, enumtype::kSum>
      reduction_t;

  /// Has a default value of `0`.
  SMITH_ARG(double, margin) = 0;
  /// Specifies the reduction to apply to the output. Default: Mean
  SMITH_ARG(reduction_t, reduction) = smith::kMean;
};

namespace functional {
/// Options for `smith::nn::functional::margin_ranking_loss`.
///
...
/// ```
struct SMITH_API NLLLossOptions {
  typedef std::variant<enumtype::kNone, enumtype::kMean, enumtype::kSum>
      reduction_t;
  ...
  SMITH_ARG(int64_t, ignore_index) = -100;
  /// Specifies the reduction to apply to the output. Default: Mean
  SMITH_ARG(reduction_t, reduction) = smith::kMean;
};

namespace functional {
/// Options for `smith::nn::functional::nll_loss`.
///
...
/// ```
struct SMITH_API CrossEntropyLossOptions {
  typedef std::variant<enumtype::kNone, enumtype::kMean, enumtype::kSum>
      reduction_t;
  ...
  SMITH_ARG(double, label_smoothing) = 0.0;
};

namespace functional {
/// Options for `smith::nn::functional::cross_entropy`.
///
...
/// ```
struct SMITH_API BCEWithLogitsLossOptions {
  typedef std::variant<enumtype::kNone, enumtype::kMean, enumtype::kSum>
      reduction_t;
  /// A manual rescaling weight given to the loss of each batch element.
  ...
  SMITH_ARG(Tensor, pos_weight);
};

namespace functional {
/// Options for `smith::nn::functional::binary_cross_entropy_with_logits`.
///
