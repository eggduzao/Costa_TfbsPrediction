...
/// No gradient will be recorded for this operation.
SMITH_API Tensor orthogonal_(Tensor tensor, double gain = 1.0);
...
/// to be set to zero.
/// No gradient will be recorded for this operation.
SMITH_API Tensor sparse_(Tensor tensor, double sparsity, double std = 0.01);

/// Fills the given 2-dimensional `matrix` with values drawn from a uniform
/// distribution parameterized by `low` and `high`.
/// No gradient will be recorded for this operation.
SMITH_API Tensor uniform_(Tensor tensor, double low = 0, double high = 1);
...
/// No gradient will be recorded for this operation.
SMITH_API Tensor kaiming_normal_(
    Tensor tensor,
    double a = 0,
    FanModeType mode = smith::kFanIn,
    NonlinearityType nonlinearity = smith::kLeakyReLU);
...
/// No gradient will be recorded for this operation.
SMITH_API Tensor kaiming_uniform_(
    Tensor tensor,
    double a = 0,
    FanModeType mode = smith::kFanIn,
    NonlinearityType nonlinearity = smith::kLeakyReLU);
...
SMITH_API Tensor xavier_normal_(Tensor tensor, double gain = 1.0);
...
/// No gradient will be recorded for this operation.
SMITH_API Tensor xavier_uniform_(Tensor tensor, double gain = 1.0);

/// Fills the given `tensor` with zeros.
/// No gradient will be recorded for this operation.
SMITH_API Tensor zeros_(Tensor tensor);

SMITH_API std::tuple<int64_t, int64_t> _calculate_fan_in_and_fan_out(
    const Tensor& tensor);
