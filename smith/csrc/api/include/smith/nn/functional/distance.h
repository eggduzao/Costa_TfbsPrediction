...
inline Tensor cosine_similarity(
    ...
    int64_t dim,
    double eps) {
  return smith::cosine_similarity(x1, x2, dim, eps);
}
} // namespace detail
#endif /* DOXYGEN_SHOULD_SKIP_THIS */

/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.cosine_similarity
/// about the exact behavior of this functional.
///
/// See the documentation for
/// `smith::nn::functional::CosineSimilarityFuncOptions` class to learn what
...
inline Tensor pairwise_distance(
    ...
    double eps,
    bool keepdim) {
  return smith::pairwise_distance(x1, x2, p, eps, keepdim);
}
} // namespace detail
#endif /* DOXYGEN_SHOULD_SKIP_THIS */

/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.pairwise_distance
/// about the exact behavior of this functional.
///
/// See the documentation for
/// `smith::nn::functional::PairwiseDistanceFuncOptions` class to learn what
/// optional arguments are supported for this functional.
///
/// Example:
/// ```
