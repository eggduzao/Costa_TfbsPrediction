...
inline Tensor normalize(
  ...
  if (out == std::nullopt) {
    ...
    auto denom = input.norm(p, dim, true).clamp_min(eps).expand_as(input);
    return smith::div_out(*out, input, denom);
  }
}
} // namespace detail
...
/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.normalize
/// about the exact behavior of this functional.
///
/// See the documentation for `smith::nn::functional::NormalizeFuncOptions`
...
inline Tensor layer_norm(
    ...
    const Tensor& bias,
    double eps) {
  return smith::layer_norm(input, normalized_shape, weight, bias, eps);
}
} // namespace detail
#endif /* DOXYGEN_SHOULD_SKIP_THIS */

/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.layer_norm
/// about the exact behavior of this functional.
///
/// See the documentation for `smith::nn::functional::LayerNormFuncOptions`
/// class to learn what optional arguments are supported for this functional.
///
/// Example:
/// ```
...
/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.local_response_norm
/// about the exact behavior of this functional.
///
/// See the documentation for
/// `smith::nn::functional::LocalResponseNormFuncOptions` class to learn what
...
/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.group_norm
/// about the exact behavior of this functional.
///
/// See the documentation for `smith::nn::functional::GroupNormFuncOptions`
/// class to learn what optional arguments are supported for this functional.
///
/// Example:
/// ```
