...
inline Tensor dropout(Tensor input, double p, bool training, bool inplace) {
  SMITH_CHECK(
      ...
      p);
  if (inplace) {
    return smith::dropout_(input, p, training);
  } else {
    return smith::dropout(input, p, training);
  }
}
...
/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.dropout
/// about the exact behavior of this functional.
///
/// See the documentation for `smith::nn::functional::DropoutFuncOptions` class
...
inline Tensor _dropoutNd_helper(
  ...
  Tensor result;
  if (inplace) {
    result = smith::feature_dropout_(input, p, training);
  } else {
    result = smith::feature_dropout(input, p, training);
  }
...
/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.dropout2d
/// about the exact behavior of this functional.
///
/// See the documentation for `smith::nn::functional::Dropout2dFuncOptions`
...
/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.dropout3d
/// about the exact behavior of this functional.
///
/// See the documentation for `smith::nn::functional::Dropout3dFuncOptions`
/// class to learn what optional arguments are supported for this functional.
///
/// Example:
/// ```
...
inline Tensor alpha_dropout(
  ...
  return inplace ? smith::alpha_dropout_(input, p, training)
                 : smith::alpha_dropout(input, p, training);
}
...
/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.alpha_dropout
/// about the exact behavior of this functional.
///
/// See the documentation for `smith::nn::functional::AlphaDropoutFuncOptions`
/// class to learn what optional arguments are supported for this functional.
///
/// Example:
/// ```
...
inline Tensor feature_alpha_dropout(
  ...
  return inplace ? smith::feature_alpha_dropout_(input, p, training)
                 : smith::feature_alpha_dropout(input, p, training);
}
...
/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.feature_alpha_dropout
/// about the exact behavior of this functional.
///
/// See the documentation for
/// `smith::nn::functional::FeatureAlphaDropoutFuncOptions` class to learn what
