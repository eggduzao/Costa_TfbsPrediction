...
inline Tensor elu(Tensor input, double alpha, bool inplace) {
  if (inplace) {
    return smith::elu_(input, alpha);
  } else {
    return smith::elu(input, alpha);
  }
}
} // namespace detail
...
/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.elu
/// about the exact behavior of this functional.
///
/// See the documentation for `smith::nn::functional::ELUFuncOptions` class to
...
inline Tensor selu(Tensor input, bool inplace) {
  if (inplace) {
    return smith::selu_(input);
  } else {
    return smith::selu(input);
  }
}
} // namespace detail
#endif /* DOXYGEN_SHOULD_SKIP_THIS */
...
/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.selu
/// about the exact behavior of this functional.
///
/// See the documentation for `smith::nn::functional::SELUFuncOptions` class to
/// learn what optional arguments are supported for this functional.
///
/// Example:
/// ```
...
inline Tensor hardshrink(const Tensor& input, double lambda) {
  return smith::hardshrink(input, lambda);
}
} // namespace detail
#endif /* DOXYGEN_SHOULD_SKIP_THIS */

/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.hardshrink
/// about the exact behavior of this functional.
///
/// See the documentation for `smith::nn::functional::HardshrinkFuncOptions`
...
inline Tensor hardtanh(
    ...
    bool inplace) {
  if (inplace) {
    return smith::hardtanh_(input, min_val, max_val);
  } else {
    return smith::hardtanh(input, min_val, max_val);
  }
}
} // namespace detail
#endif /* DOXYGEN_SHOULD_SKIP_THIS */
...
/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.hardtanh
/// about the exact behavior of this functional.
///
/// See the documentation for `smith::nn::functional::HardtanhFuncOptions` class
...
inline Tensor leaky_relu(Tensor input, double negative_slope, bool inplace) {
  if (inplace) {
    return smith::leaky_relu_(input, negative_slope);
  } else {
    return smith::leaky_relu(input, negative_slope);
  }
}
} // namespace detail
#endif /* DOXYGEN_SHOULD_SKIP_THIS */
...
/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.leaky_relu
/// about the exact behavior of this functional.
///
/// See the documentation for `smith::nn::functional::LeakyReLUFuncOptions`
/// class to learn what optional arguments are supported for this functional.
///
/// Example:
/// ```
...
inline Tensor logsigmoid(const Tensor& input) {
  return smith::log_sigmoid(input);
}
...
inline Tensor gumbel_softmax(
    ...
    int dim) {
  auto gumbels =
      -smith::empty_like(logits).exponential_().log(); // ~Gumbel(0,1)
  ...
  if (hard) {
    ...
    auto y_hard = smith::zeros_like(logits).scatter_(dim, index, 1.0);
...
/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.gumbel_softmax
/// about the exact behavior of this functional.
///
/// See the documentation for `smith::nn::functional::GumbelSoftmaxFuncOptions`
/// class to learn what optional arguments are supported for this functional.
///
/// Example:
/// ```
...
inline Tensor softmax(
    const Tensor& input,
    int64_t dim,
    std::optional<smith::Dtype> dtype) {
  Tensor ret;
...
/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.softmax
/// about the exact behavior of this functional.
///
/// See the documentation for `smith::nn::functional::SoftmaxFuncOptions` class
/// to learn what optional arguments are supported for this functional.
///
/// Example:
/// ```
...
/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.softmin
/// about the exact behavior of this functional.
///
/// See the documentation for `smith::nn::functional::SoftminFuncOptions` class
/// to learn what optional arguments are supported for this functional.
///
/// Example:
/// ```
...
/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.log_softmax
/// about the exact behavior of this functional.
///
/// See the documentation for `smith::nn::functional::LogSoftmaxFuncOptions`
/// class to learn what optional arguments are supported for this functional.
///
/// Example:
/// ```
...
inline Tensor glu(const Tensor& input, int64_t dim) {
  ...
  return smith::glu(input, dim);
}
} // namespace detail
#endif /* DOXYGEN_SHOULD_SKIP_THIS */

/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.glu
/// about the exact behavior of this functional.
///
/// See the documentation for `smith::nn::functional::GLUFuncOptions` class to
/// learn what optional arguments are supported for this functional.
///
/// Example:
/// ```
...
inline Tensor gelu(const Tensor& input, const std::string& approximate) {
  return smith::gelu(input, approximate);
}
} // namespace detail
#endif /* DOXYGEN_SHOULD_SKIP_THIS */
...
inline Tensor relu(Tensor input, bool inplace) {
  if (inplace) {
    return smith::relu_(input);
  } else {
    return smith::relu(input);
  }
}
} // namespace detail
#endif /* DOXYGEN_SHOULD_SKIP_THIS */
...
/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.relu
/// about the exact behavior of this functional.
///
/// See the documentation for `smith::nn::functional::ReLUFuncOptions` class to
/// learn what optional arguments are supported for this functional.
///
/// Example:
/// ```
...
inline Tensor relu6(Tensor input, bool inplace) {
  if (inplace) {
    return smith::relu6_(input);
  } else {
    return smith::relu6(input);
  }
}
} // namespace detail
#endif /* DOXYGEN_SHOULD_SKIP_THIS */
...
/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.relu6
/// about the exact behavior of this functional.
///
/// See the documentation for `smith::nn::functional::ReLU6FuncOptions` class to
/// learn what optional arguments are supported for this functional.
///
/// Example:
/// ```
...
inline Tensor rrelu(
    ...
    bool inplace) {
  if (inplace) {
    return smith::rrelu_(input, lower, upper, training);
  } else {
    return smith::rrelu(input, lower, upper, training);
  }
}
} // namespace detail
#endif /* DOXYGEN_SHOULD_SKIP_THIS */
...
/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.rrelu
/// about the exact behavior of this functional.
///
/// See the documentation for `smith::nn::functional::RReLUFuncOptions` class to
/// learn what optional arguments are supported for this functional.
///
/// Example:
/// ```
...
inline Tensor celu(Tensor input, double alpha, bool inplace) {
  if (inplace) {
    return smith::celu_(input, alpha);
  } else {
    return smith::celu(input, alpha);
  }
}
} // namespace detail
#endif /* DOXYGEN_SHOULD_SKIP_THIS */
...
/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.celu
/// about the exact behavior of this functional.
///
/// See the documentation for `smith::nn::functional::CELUFuncOptions` class to
/// learn what optional arguments are supported for this functional.
///
/// Example:
/// ```
...
inline Tensor softplus(const Tensor& input, double beta, double threshold) {
  return smith::softplus(input, beta, threshold);
}
} // namespace detail
#endif /* DOXYGEN_SHOULD_SKIP_THIS */

/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.softplus
/// about the exact behavior of this functional.
///
/// See the documentation for `smith::nn::functional::SoftplusFuncOptions` class
/// to learn what optional arguments are supported for this functional.
///
/// Example:
/// ```
...
inline Tensor softshrink(const Tensor& input, double lambda) {
  return smith::softshrink(input, lambda);
}
} // namespace detail
#endif /* DOXYGEN_SHOULD_SKIP_THIS */

/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.softshrink
/// about the exact behavior of this functional.
///
/// See the documentation for `smith::nn::functional::SoftshrinkFuncOptions`
/// class to learn what optional arguments are supported for this functional.
///
/// Example:
/// ```
...
inline Tensor threshold(
    ...
    bool inplace) {
  if (inplace) {
    return smith::threshold_(input, threshold, value);
  } else {
    return smith::threshold(input, threshold, value);
  }
}
} // namespace detail
#endif /* DOXYGEN_SHOULD_SKIP_THIS */
...
/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.threshold
/// about the exact behavior of this functional.
///
/// See the documentation for `smith::nn::functional::ThresholdFuncOptions`
/// class to learn what optional arguments are supported for this functional.
///
/// Example:
/// ```
...
inline std::tuple<Tensor, Tensor> multi_head_attention_forward(
  ...
  SMITH_INTERNAL_ASSERT(embed_dim == embed_dim_to_check);
  SMITH_INTERNAL_ASSERT(key.sizes() == value.sizes());
  ...
  if (!use_separate_proj_weight) {
    if (smith::equal(query, key) && smith::equal(key, value)) {
      // self-attention
      const auto chunks =
      ...
      if (!key.defined()) {
        SMITH_INTERNAL_ASSERT(!value.defined());
        k.reset();
        v.reset();
      } else {
        // This is inline in_proj function with in_proj_weight and in_proj_bias
    ...
    const auto& q_proj_weight_non_opt = q_proj_weight;
    {
      ...
      SMITH_CHECK(len1 == embed_dim && len2 == query.size(-1));
    }
    ...
    const auto& k_proj_weight_non_opt = k_proj_weight;
    {
      ...
      const auto len1 = sizes[0];
      const auto len2 = sizes[1];
      SMITH_CHECK(len1 == embed_dim && len2 == key.size(-1));
    }
    ...
    const auto& v_proj_weight_non_opt = v_proj_weight;
    {
      ...
      const auto len1 = sizes[0];
      const auto len2 = sizes[1];
      SMITH_CHECK(len1 == embed_dim && len2 == value.size(-1));
    }
  ...
  if (bias_k.defined() && bias_v.defined()) {
    if (!static_k.defined() && !static_v.defined()) {
      ...
      SMITH_CHECK(!static_k.defined(), "bias cannot be added to static key.");
      SMITH_CHECK(!static_v.defined(), "bias cannot be added to static value.");
    }
  } else {
    SMITH_CHECK(!bias_k.defined());
    SMITH_CHECK(!bias_v.defined());
  }
  ...
  if (static_k.defined()) {
    SMITH_CHECK(static_k.size(0) == bsz * num_heads);
    SMITH_CHECK(static_k.size(2) == head_dim);
    k = static_k;
  }
  if (static_v.defined()) {
    SMITH_CHECK(static_v.size(0) == bsz * num_heads);
    SMITH_CHECK(static_v.size(2) == head_dim);
    v = static_v;
  }
  auto src_len = k.size(1);
  if (key_padding_mask_.defined()) {
    SMITH_CHECK(key_padding_mask_.size(0) == bsz);
    SMITH_CHECK(key_padding_mask_.size(1) == src_len);
  }
  if (add_zero_attn) {
    src_len += 1;
  ...
  auto attn_output_weights = smith::bmm(q, k.transpose(1, 2));
  SMITH_CHECK(
  ...
  auto attn_output = smith::bmm(attn_output_weights, v);
  SMITH_CHECK(
