...
#include <smith/nn/modules/utils.h>
...
/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.avg_pool1d
/// about the exact behavior of this functional.
///
/// See the documentation for `smith::nn::functional::AvgPool1dFuncOptions`
...
/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.avg_pool2d
/// about the exact behavior of this functional.
///
/// See the documentation for `smith::nn::functional::AvgPool2dFuncOptions`
/// class to learn what optional arguments are supported for this functional.
///
/// Example:
/// ```
...
/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.avg_pool3d
/// about the exact behavior of this functional.
///
/// See the documentation for `smith::nn::functional::AvgPool3dFuncOptions`
/// class to learn what optional arguments are supported for this functional.
///
/// Example:
/// ```
...
/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.max_pool1d
/// about the exact behavior of this functional.
///
/// See the documentation for `smith::nn::functional::MaxPool1dFuncOptions`
/// class to learn what optional arguments are supported for this functional.
///
/// Example:
/// ```
...
/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.max_pool2d
/// about the exact behavior of this functional.
///
/// See the documentation for `smith::nn::functional::MaxPool2dFuncOptions`
/// class to learn what optional arguments are supported for this functional.
///
/// Example:
/// ```
...
inline std::tuple<Tensor, Tensor> max_pool2d_with_indices(
    ...
    ExpandingArray<2> dilation,
    bool ceil_mode) {
  return smith::max_pool2d_with_indices(
      input, kernel_size, stride, padding, dilation, ceil_mode);
}
} // namespace detail
#endif /* DOXYGEN_SHOULD_SKIP_THIS */
...
/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.max_pool3d
/// about the exact behavior of this functional.
///
/// See the documentation for `smith::nn::functional::MaxPool3dFuncOptions`
/// class to learn what optional arguments are supported for this functional.
///
/// Example:
/// ```
...
inline std::tuple<Tensor, Tensor> max_pool3d_with_indices(
    ...
    ExpandingArray<3> dilation,
    bool ceil_mode) {
  return smith::max_pool3d_with_indices(
      input, kernel_size, stride, padding, dilation, ceil_mode);
}
} // namespace detail
#endif /* DOXYGEN_SHOULD_SKIP_THIS */
...
/// `smith::nn::functional::AdaptiveMaxPool1dFuncOptions` class to learn what
...
/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.adaptive_max_pool1d
/// about the exact behavior of this functional.
///
/// See the documentation for
/// `smith::nn::functional::AdaptiveMaxPool1dFuncOptions` class to learn what
...
inline std::tuple<Tensor, Tensor> adaptive_max_pool2d_with_indices(
  ...
  auto output_size_ =
      smith::nn::modules::utils::_list_with_default(output_size, input.sizes());
  return smith::adaptive_max_pool2d(input, output_size_);
}
} // namespace detail
#endif /* DOXYGEN_SHOULD_SKIP_THIS */

/// See the documentation for
/// `smith::nn::functional::AdaptiveMaxPool2dFuncOptions` class to learn what
/// optional arguments are supported for this functional.
///
/// Example:
/// ```
...
/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.adaptive_max_pool2d
/// about the exact behavior of this functional.
///
/// See the documentation for
/// `smith::nn::functional::AdaptiveMaxPool2dFuncOptions` class to learn what
...
inline std::tuple<Tensor, Tensor> adaptive_max_pool3d_with_indices(
  ...
  auto output_size_ =
      smith::nn::modules::utils::_list_with_default(output_size, input.sizes());
  return smith::adaptive_max_pool3d(input, output_size_);
}
} // namespace detail
#endif /* DOXYGEN_SHOULD_SKIP_THIS */

/// See the documentation for
/// `smith::nn::functional::AdaptiveMaxPool3dFuncOptions` class to learn what
/// optional arguments are supported for this functional.
///
/// Example:
/// ```
...
/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.adaptive_max_pool3d
/// about the exact behavior of this functional.
///
/// See the documentation for
/// `smith::nn::functional::AdaptiveMaxPool3dFuncOptions` class to learn what
...
inline Tensor adaptive_avg_pool1d(
    const Tensor& input,
    ExpandingArray<1> output_size) {
  return smith::adaptive_avg_pool1d(input, output_size);
}
} // namespace detail
#endif /* DOXYGEN_SHOULD_SKIP_THIS */

/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.adaptive_avg_pool1d
/// about the exact behavior of this functional.
///
/// See the documentation for
/// `smith::nn::functional::AdaptiveAvgPool1dFuncOptions` class to learn what
/// optional arguments are supported for this functional.
///
/// Example:
/// ```
...
inline Tensor adaptive_avg_pool2d(
  ...
  auto output_size_ =
      smith::nn::modules::utils::_list_with_default(output_size, input.sizes());
  return smith::adaptive_avg_pool2d(input, output_size_);
}
} // namespace detail
#endif /* DOXYGEN_SHOULD_SKIP_THIS */

/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.adaptive_avg_pool2d
/// about the exact behavior of this functional.
///
/// See the documentation for
/// `smith::nn::functional::AdaptiveAvgPool2dFuncOptions` class to learn what
/// optional arguments are supported for this functional.
///
/// Example:
/// ```
...
inline Tensor adaptive_avg_pool3d(
  ...
  auto output_size_ =
      smith::nn::modules::utils::_list_with_default(output_size, input.sizes());
  return smith::adaptive_avg_pool3d(input, output_size_);
}
} // namespace detail
#endif /* DOXYGEN_SHOULD_SKIP_THIS */

/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.adaptive_avg_pool3d
/// about the exact behavior of this functional.
///
/// See the documentation for
/// `smith::nn::functional::AdaptiveAvgPool3dFuncOptions` class to learn what
/// optional arguments are supported for this functional.
///
/// Example:
/// ```
...
/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.max_unpool1d
/// about the exact behavior of this functional.
///
/// See the documentation for `smith::nn::functional::MaxUnpool1dFuncOptions`
/// class to learn what optional arguments are supported for this functional.
///
/// Example:
/// ```
...
inline Tensor max_unpool2d(
  ...
  return smith::max_unpool2d(input, indices, output_size_);
}
} // namespace detail
#endif /* DOXYGEN_SHOULD_SKIP_THIS */

/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.max_unpool2d
/// about the exact behavior of this functional.
///
/// See the documentation for `smith::nn::functional::MaxUnpool2dFuncOptions`
/// class to learn what optional arguments are supported for this functional.
///
/// Example:
/// ```
...
inline Tensor max_unpool3d(
  ...
  return smith::max_unpool3d(input, indices, output_size_, stride, padding);
}
} // namespace detail
#endif /* DOXYGEN_SHOULD_SKIP_THIS */

/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.max_unpool3d
/// about the exact behavior of this functional.
///
/// See the documentation for `smith::nn::functional::MaxUnpool3dFuncOptions`
/// class to learn what optional arguments are supported for this functional.
///
/// Example:
/// ```
...
inline std::tuple<Tensor, Tensor> fractional_max_pool2d_with_indices(
  ...
  if (output_size_ == std::nullopt) {
    SMITH_INTERNAL_ASSERT(output_ratio != std::nullopt);
    output_size_ = {
  ...
  if (!_random_samples_.defined()) {
    ...
    _random_samples_ = smith::rand(
        {n_batch, input.size(-3), 2},
        smith::TensorOptions().dtype(input.dtype()).device(input.device()));
  }
  return smith::fractional_max_pool2d(
...
/// See the documentation for
/// `smith::nn::functional::FractionalMaxPool2dFuncOptions` class to learn what
/// optional arguments are supported for this functional.
///
/// Example:
/// ```
...
inline std::tuple<Tensor, Tensor> fractional_max_pool3d_with_indices(
  ...
  return smith::fractional_max_pool3d(
      input, kernel_size, *output_size_, _random_samples_);
}
} // namespace detail
#endif /* DOXYGEN_SHOULD_SKIP_THIS */
...
/// See the documentation for
/// `smith::nn::functional::FractionalMaxPool3dFuncOptions` class to learn what
/// optional arguments are supported for this functional.
///
/// Example:
/// ```
...
inline Tensor lp_pool1d(
  ...
  return (smith::sign(out) * relu(smith::abs(out)))
      .mul((*kernel_size)[0])
      .pow(1. / norm_type);
}
} // namespace detail
...
/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.lp_pool1d
/// about the exact behavior of this functional.
///
/// See the documentation for `smith::nn::functional::LPPool1dFuncOptions` class
...
/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.lp_pool2d
/// about the exact behavior of this functional.
///
/// See the documentation for `smith::nn::functional::LPPool2dFuncOptions` class
/// to learn what optional arguments are supported for this functional.
///
/// Example:
/// ```
...
/// See
/// https://blacksmith.org/docs/main/nn.functional.html#smith.nn.functional.lp_pool3d
/// about the exact behavior of this functional.
///
/// See the documentation for `smith::nn::functional::LPPool3dFuncOptions` class
/// to learn what optional arguments are supported for this functional.
///
/// Example:
/// ```
