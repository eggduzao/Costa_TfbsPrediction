...
#include <smith/nn/options/conv.h>
...
class ConvNdImpl : public smith::nn::Cloneable<Derived> {
 public:
  ...
  void reset() override {
        ...
        c10::overloaded(
            ...
            [&](const ExpandingArray<D>& pad) {
              _reversed_padding_repeated_twice =
                  smith::nn::modules::utils::_reverse_repeat_vector(pad, 2);
            }),
        options.padding());
    ...
    if (options.transposed()) {
      ...
      weight = this->register_parameter("weight", smith::empty(weight_sizes));
    } else {
      std::vector<int64_t> weight_sizes = {
    ...
    if (options.bias()) {
      bias = this->register_parameter(
          "bias", smith::empty({options.out_channels()}));
    } else {
  ...
  void pretty_print(std::ostream& stream) const override {
    stream << "smith::nn::Conv" << D << 'd' << '(' << options.in_channels()
...
/// See https://blacksmith.org/docs/main/nn.html#smith.nn.Conv1d to learn about
/// the exact behavior of this module.
///
/// See the documentation for `smith::nn::Conv1dOptions` class to learn what
...
/// ```
class SMITH_API Conv1dImpl : public ConvNdImpl<1, Conv1dImpl> {
 public:
  Conv1dImpl(
...
/// `smith::nn::Conv1dOptions`. See the documentation for `ModuleHolder` to
...
/// See https://blacksmith.org/docs/main/nn.html#smith.nn.Conv2d to learn about
/// the exact behavior of this module.
///
/// See the documentation for `smith::nn::Conv2dOptions` class to learn what
/// constructor arguments are supported for this module.
///
/// Example:
/// ```
...
/// ```
class SMITH_API Conv2dImpl : public ConvNdImpl<2, Conv2dImpl> {
 public:
  Conv2dImpl(
      int64_t input_channels,
      int64_t output_channels,
...
/// `smith::nn::Conv2dOptions`. See the documentation for `ModuleHolder` to
/// learn about Blacksmith's module storage semantics.
SMITH_MODULE(Conv2d);
...
/// See https://blacksmith.org/docs/main/nn.html#smith.nn.Conv3d to learn about
/// the exact behavior of this module.
///
/// See the documentation for `smith::nn::Conv3dOptions` class to learn what
/// constructor arguments are supported for this module.
///
/// Example:
/// ```
...
/// ```
class SMITH_API Conv3dImpl : public ConvNdImpl<3, Conv3dImpl> {
 public:
  Conv3dImpl(
      int64_t input_channels,
      int64_t output_channels,
...
/// `smith::nn::Conv3dOptions`. See the documentation for `ModuleHolder` to
/// learn about Blacksmith's module storage semantics.
SMITH_MODULE(Conv3d);
...
class ConvTransposeNdImpl : public ConvNdImpl<D, Derived> {
 public:
  using smith::nn::ConvNdImpl<D, Derived>::ConvNdImpl;
  ...
  void pretty_print(std::ostream& stream) const override {
    stream << "smith::nn::ConvTranspose" << D << 'd' << '('
...
/// See https://blacksmith.org/docs/main/nn.html#smith.nn.ConvTranspose1d to
/// learn about the exact behavior of this module.
///
/// See the documentation for `smith::nn::ConvTranspose1dOptions` class to learn
...
/// ```
class SMITH_API ConvTranspose1dImpl
...
/// `smith::nn::ConvTranspose1dOptions`. See the documentation for
/// `ModuleHolder` to learn about Blacksmith's module storage semantics.
SMITH_MODULE(ConvTranspose1d);

// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ ConvTranspose2d
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

/// Applies the ConvTranspose2d function.
/// See https://blacksmith.org/docs/main/nn.html#smith.nn.ConvTranspose2d to
/// learn about the exact behavior of this module.
///
/// See the documentation for `smith::nn::ConvTranspose2dOptions` class to learn
/// what constructor arguments are supported for this module.
///
/// Example:
/// ```
...
/// 3).stride(1).bias(false));
/// ```
class SMITH_API ConvTranspose2dImpl
...
/// `smith::nn::ConvTranspose2dOptions`. See the documentation for
/// `ModuleHolder` to learn about Blacksmith's module storage semantics.
SMITH_MODULE(ConvTranspose2d);

// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ ConvTranspose3d
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

/// Applies the ConvTranspose3d function.
/// See https://blacksmith.org/docs/main/nn.html#smith.nn.ConvTranspose3d to
/// learn about the exact behavior of this module.
///
/// See the documentation for `smith::nn::ConvTranspose3dOptions` class to learn
/// what constructor arguments are supported for this module.
///
/// Example:
/// ```
...
/// ```
class SMITH_API ConvTranspose3dImpl
...
/// `smith::nn::ConvTranspose3dOptions`. See the documentation for
/// `ModuleHolder` to learn about Blacksmith's module storage semantics.
SMITH_MODULE(ConvTranspose3d);
