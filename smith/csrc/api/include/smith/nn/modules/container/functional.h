...
///     Linear(3, 4),
///     Functional(smith::relu),
///     BatchNorm1d(3),
///     Functional(smith::elu, /*alpha=*/1));
/// \endrst
///
...
/// you want to wrap `smith::leaky_relu`, which accepts a `slope` scalar as its
...
/// .. code-block:: cpp
///
///   Functional(smith::leaky_relu, /*slope=*/0.5)
/// \endrst
///
...
class SMITH_API FunctionalImpl : public smith::nn::Cloneable<FunctionalImpl> {
 public:
