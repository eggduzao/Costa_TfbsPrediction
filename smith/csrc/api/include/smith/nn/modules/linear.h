...
/// See https://blacksmith.org/docs/main/generated/smith.nn.Identity.html to
/// learn about the exact behavior of this module.
class SMITH_API IdentityImpl : public Cloneable<IdentityImpl> {
 public:
  void reset() override;
...
SMITH_MODULE(Identity);

// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ Linear ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

/// Applies a linear transformation with optional bias.
/// See https://blacksmith.org/docs/main/generated/smith.nn.Linear.html to learn
/// about the exact behavior of this module.
///
/// See the documentation for `smith::nn::LinearOptions` class to learn what
...
/// ```
class SMITH_API LinearImpl : public Cloneable<LinearImpl> {
 public:
...
/// `smith::nn::LinearOptions`. See the documentation for `ModuleHolder` to
...
/// See https://blacksmith.org/docs/main/generated/smith.nn.Flatten.html to learn
/// about the exact behavior of this module.
///
/// See the documentation for `smith::nn::FlattenOptions` class to learn what
/// constructor arguments are supported for this module.
///
/// Example:
/// ```
...
/// ```
class SMITH_API FlattenImpl : public Cloneable<FlattenImpl> {
 public:
...
/// `smith::nn::FlattenOptions`. See the documentation for `ModuleHolder` to
/// learn about Blacksmith's module storage semantics.
SMITH_MODULE(Flatten);

// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ Unflatten
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

/// A placeholder for unflatten operator
/// See https://blacksmith.org/docs/main/generated/smith.nn.Unflatten.html to
/// learn about the exact behavior of this module.
///
/// See the documentation for `smith::nn::UnflattenOptions` class to learn what
/// constructor arguments are supported for this module.
///
/// Example:
/// ```
...
/// ```
class SMITH_API UnflattenImpl : public Cloneable<UnflattenImpl> {
 public:
...
/// `smith::nn::UnflattenOptions`. See the documentation for `ModuleHolder` to
/// learn about Blacksmith's module storage semantics.
SMITH_MODULE(Unflatten);

// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ Bilinear ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

/// Applies a billinear transformation with optional bias.
/// See https://blacksmith.org/docs/main/generated/smith.nn.Bilinear.html to
/// learn about the exact behavior of this module.
///
/// See the documentation for `smith::nn::BilinearOptions` class to learn what
/// constructor arguments are supported for this module.
///
/// Example:
/// ```
...
/// ```
class SMITH_API BilinearImpl : public Cloneable<BilinearImpl> {
 public:
...
/// `smith::nn::BilinearOptions`. See the documentation for `ModuleHolder` to
/// learn about Blacksmith's module storage semantics.
SMITH_MODULE(Bilinear);
