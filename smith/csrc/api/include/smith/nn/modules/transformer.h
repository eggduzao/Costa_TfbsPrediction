...
#include <smith/nn/options/transformer.h>
...
///
/// See https://blacksmith.org/docs/stable/generated/smith.nn.Transformer.html to
/// learn about the exact behavior of this transformer model
///
/// See the documentation for `smith::nn::Transformer` class to learn what
...
/// ```
class SMITH_API TransformerImpl : public Cloneable<TransformerImpl> {
 public:
