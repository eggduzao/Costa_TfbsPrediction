...
/// See
/// https://blacksmith.org/docs/main/generated/smith.nn.TransformerEncoderLayer.html
/// to learn abouut the exact behavior of this encoder layer model
///
/// See the documentation for `smith::nn::TransformerEncoderLayer` class to
...
/// 8).dropout(0.1));
/// ```
class SMITH_API TransformerEncoderLayerImpl
...
/// with `smith::nn::TransformerEncoderLayerOptions`. See the documentation for
/// `ModuleHolder` to learn about Blacksmith's module storage semantics.
SMITH_MODULE(TransformerEncoderLayer);
...
/// https://blacksmith.org/docs/main/nn.html#transformer-layers to learn about
/// the exact behavior of this module.
///
/// See the documentation for `smith::nn::TransformerDecoderLayerOptions` class
...
/// 8).dropout(0.2));
/// ```
class SMITH_API TransformerDecoderLayerImpl
...
/// with `smith::nn::TransformerDecoderLayerOptions`. See the documentation for
/// `ModuleHolder` to learn about Blacksmith's module storage semantics.
SMITH_MODULE(TransformerDecoderLayer);
