...
#include <smith/nn/modules/batchnorm.h>
#include <smith/nn/options/instancenorm.h>
...
class InstanceNormImpl
    : public smith::nn::NormImplBase<D, Derived, InstanceNormOptions> {
 private:
  inline Tensor apply_instance_norm(const Tensor& input) {
    return smith::nn::functional::detail::instance_norm(
        input,
        this->running_mean,
        this->running_var,
        this->weight,
 ...
 public:
  using smith::nn::NormImplBase<D, Derived, InstanceNormOptions>::NormImplBase;
  ...
  void pretty_print(std::ostream& stream) const override {
    stream << std::boolalpha << "smith::nn::InstanceNorm" << D << "d("
...
/// See https://blacksmith.org/docs/main/nn.html#smith.nn.InstanceNorm1d to learn
/// about the exact behavior of this module.
///
/// See the documentation for `smith::nn::InstanceNorm1dOptions` class to learn
...
/// ```
class SMITH_API InstanceNorm1dImpl
...
/// `smith::nn::InstanceNorm1dOptions`. See the documentation for `ModuleHolder`
/// to learn about Blacksmith's module storage semantics.
SMITH_MODULE(InstanceNorm1d);

// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ InstanceNorm2d
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

/// Applies the InstanceNorm2d function.
/// See https://blacksmith.org/docs/main/nn.html#smith.nn.InstanceNorm2d to learn
/// about the exact behavior of this module.
///
/// See the documentation for `smith::nn::InstanceNorm2dOptions` class to learn
/// what constructor arguments are supported for this module.
///
/// Example:
/// ```
...
/// ```
class SMITH_API InstanceNorm2dImpl
...
/// `smith::nn::InstanceNorm2dOptions`. See the documentation for `ModuleHolder`
/// to learn about Blacksmith's module storage semantics.
SMITH_MODULE(InstanceNorm2d);

// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ InstanceNorm3d
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

/// Applies the InstanceNorm3d function.
/// See https://blacksmith.org/docs/main/nn.html#smith.nn.InstanceNorm3d to learn
/// about the exact behavior of this module.
///
/// See the documentation for `smith::nn::InstanceNorm3dOptions` class to learn
/// what constructor arguments are supported for this module.
///
/// Example:
/// ```
...
/// ```
class SMITH_API InstanceNorm3dImpl
...
/// `smith::nn::InstanceNorm3dOptions`. See the documentation for `ModuleHolder`
/// to learn about Blacksmith's module storage semantics.
SMITH_MODULE(InstanceNorm3d);
