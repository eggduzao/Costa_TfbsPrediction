...
#include <smith/nn/options/transformercoder.h>
...
/// See
/// https://blacksmith.org/docs/main/generated/smith.nn.TransformerEncoder.html
/// to learn abouut the exact behavior of this encoder layer module.
///
/// See the documentation for `smith::nn::TransformerEncoder` class to learn
...
/// ```
class SMITH_API TransformerEncoderImpl
...
/// See
/// https://blacksmith.org/docs/main/generated/smith.nn.TransformerDecoder.html
/// to learn abouut the exact behavior of this decoder module
///
/// See the documentation for `smith::nn::TransformerDecoderOptions` class to
...
/// smith::rand({10, 32, 512}); const auto tgt = smith::rand({20, 32, 512});
/// auto out = transformer_decoder(tgt, memory);
/// ```
class SMITH_API TransformerDecoderImpl
...
/// `smith::nn::TransformerDecoderOptions`.
/// See the documentation for `ModuleHolder` to learn about Blacksmith's
/// module storage semantics.
SMITH_MODULE(TransformerDecoder);
