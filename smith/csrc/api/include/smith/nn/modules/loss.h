...
#include <smith/nn/functional/loss.h>
...
/// See https://blacksmith.org/docs/main/nn.html#smith.nn.L1Loss to learn
/// about the exact behavior of this module.
///
/// See the documentation for `smith::nn::L1LossOptions` class to learn what
/// constructor arguments are supported for this module.
///
/// Example:
/// ```
/// L1Loss model(L1LossOptions(smith::kNone));
/// ```
struct SMITH_API L1LossImpl : Cloneable<L1LossImpl> {
...
/// `smith::nn::L1LossOptions`. See the documentation for `ModuleHolder` to
...
/// See https://blacksmith.org/docs/main/nn.html#smith.nn.KLDivLoss to learn
/// about the exact behavior of this module.
///
/// See the documentation for `smith::nn::KLDivLossOptions` class to learn what
/// constructor arguments are supported for this module.
///
/// Example:
/// ```
/// KLDivLoss model(KLDivLossOptions().reduction(smith::kNone));
/// ```
struct SMITH_API KLDivLossImpl : Cloneable<KLDivLossImpl> {
...
/// `smith::nn::KLDivLossOptions`. See the documentation for `ModuleHolder` to
/// learn about Blacksmith's module storage semantics.
SMITH_MODULE(KLDivLoss);

// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ MSELoss ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

/// Creates a criterion that measures the mean squared error (squared L2 norm)
/// between each element in the input :math:`x` and target :math:`y`.
/// See https://blacksmith.org/docs/main/nn.html#smith.nn.MSELoss to learn
/// about the exact behavior of this module.
///
/// See the documentation for `smith::nn::MSELossOptions` class to learn what
/// constructor arguments are supported for this module.
///
/// Example:
/// ```
/// MSELoss model(MSELossOptions(smith::kNone));
/// ```
struct SMITH_API MSELossImpl : Cloneable<MSELossImpl> {
...
/// `smith::nn::MSELossOptions`. See the documentation for `ModuleHolder` to
/// learn about Blacksmith's module storage semantics.
SMITH_MODULE(MSELoss);

// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ BCELoss ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

/// Creates a criterion that measures the Binary Cross Entropy
/// between the target and the output.
/// See https://blacksmith.org/docs/main/nn.html#smith.nn.BCELoss to learn
/// about the exact behavior of this module.
///
/// See the documentation for `smith::nn::BCELossOptions` class to learn what
/// constructor arguments are supported for this module.
///
/// Example:
/// ```
/// BCELoss model(BCELossOptions().reduction(smith::kNone).weight(weight));
/// ```
struct SMITH_API BCELossImpl : Cloneable<BCELossImpl> {
...
/// `smith::nn::BCELossOptions`. See the documentation for `ModuleHolder` to
/// learn about Blacksmith's module storage semantics.
SMITH_MODULE(BCELoss);
...
/// See https://blacksmith.org/docs/main/nn.html#smith.nn.HingeEmbeddingLoss to
/// learn about the exact behavior of this module.
///
/// See the documentation for `smith::nn::HingeEmbeddingLossOptions` class to
/// learn what constructor arguments are supported for this module.
///
/// Example:
/// ```
/// HingeEmbeddingLoss
/// model(HingeEmbeddingLossOptions().margin(4).reduction(smith::kNone));
/// ```
struct SMITH_API HingeEmbeddingLossImpl : Cloneable<HingeEmbeddingLossImpl> {
...
/// `smith::nn::HingeEmbeddingLossOptions`. See the documentation for
/// `ModuleHolder` to learn about Blacksmith's module storage semantics.
SMITH_MODULE(HingeEmbeddingLoss);
...
/// https://blacksmith.org/docs/main/nn.html#smith.nn.MultiMarginLoss to learn
/// about the exact behavior of this module.
///
/// See the documentation for `smith::nn::MultiMarginLossOptions` class to learn
...
/// ```
struct SMITH_API MultiMarginLossImpl : public Cloneable<MultiMarginLossImpl> {
...
/// `smith::nn::MultiMarginLossOptions`. See the documentation for
/// `ModuleHolder` to learn about Blacksmith's module storage semantics.
SMITH_MODULE(MultiMarginLoss);
...
/// See https://blacksmith.org/docs/main/nn.html#smith.nn.CosineEmbeddingLoss to
/// learn about the exact behavior of this module.
///
/// See the documentation for `smith::nn::CosineEmbeddingLossOptions` class to
/// learn what constructor arguments are supported for this module.
///
/// Example:
/// ```
...
/// ```
struct SMITH_API CosineEmbeddingLossImpl
...
/// `smith::nn::CosineEmbeddingLossOptions`. See the documentation for
/// `ModuleHolder` to learn about Blacksmith's module storage semantics.
SMITH_MODULE(CosineEmbeddingLoss);
...
/// Girshick). See https://blacksmith.org/docs/main/nn.html#smith.nn.SmoothL1Loss
/// to learn about the exact behavior of this module.
///
/// See the documentation for `smith::nn::SmoothL1LossOptions` class to learn
/// what constructor arguments are supported for this module.
///
/// Example:
/// ```
/// SmoothL1Loss model(SmoothL1LossOptions().reduction(smith::kNone).beta(0.5));
/// ```
struct SMITH_API SmoothL1LossImpl : public Cloneable<SmoothL1LossImpl> {
...
/// `smith::nn::SmoothL1LossOptions`. See the documentation for `ModuleHolder`
/// to learn about Blacksmith's module storage semantics.
SMITH_MODULE(SmoothL1Loss);
...
/// See https://blacksmith.org/docs/main/nn.html#smith.nn.HuberLoss to learn
/// about the exact behavior of this module.
///
/// See the documentation for `smith::nn::HuberLossOptions` class to learn what
/// constructor arguments are supported for this module.
///
/// Example:
/// ```
/// HuberLoss model(HuberLossOptions().reduction(smith::kNone).delta(0.5));
/// ```
struct SMITH_API HuberLossImpl : public Cloneable<HuberLossImpl> {
...
/// `smith::nn::HuberLossOptions`. See the documentation for `ModuleHolder` to
/// learn about Blacksmith's module storage semantics.
SMITH_MODULE(HuberLoss);
...
/// indices). See
/// https://blacksmith.org/docs/main/nn.html#smith.nn.MultiLabelMarginLoss to
/// learn about the exact behavior of this module.
///
/// See the documentation for `smith::nn::MultiLabelMarginLossOptions` class to
/// learn what constructor arguments are supported for this module.
///
/// Example:
/// ```
/// MultiLabelMarginLoss model(MultiLabelMarginLossOptions(smith::kNone));
/// ```
struct SMITH_API MultiLabelMarginLossImpl
...
/// `smith::nn::MultiLabelMarginLossOptions`. See the documentation for
/// `ModuleHolder` to learn about Blacksmith's module storage semantics.
SMITH_MODULE(MultiLabelMarginLoss);
...
/// (containing 1 or -1).
/// See https://blacksmith.org/docs/main/nn.html#smith.nn.SoftMarginLoss to learn
/// about the exact behavior of this module.
///
/// See the documentation for `smith::nn::SoftMarginLossOptions` class to learn
/// what constructor arguments are supported for this module.
///
/// Example:
/// ```
/// SoftMarginLoss model(SoftMarginLossOptions(smith::kNone));
/// ```
struct SMITH_API SoftMarginLossImpl : public Cloneable<SoftMarginLossImpl> {
...
/// `smith::nn::SoftMarginLossOptions`. See the documentation for `ModuleHolder`
/// to learn about Blacksmith's module storage semantics.
SMITH_MODULE(SoftMarginLoss);
...
/// size :math:`(N, C)`. See
/// https://blacksmith.org/docs/main/nn.html#smith.nn.MultiLabelSoftMarginLoss to
/// learn about the exact behavior of this module.
///
/// See the documentation for `smith::nn::MultiLabelSoftMarginLossOptions` class
/// to learn what constructor arguments are supported for this module.
///
/// Example:
/// ```
/// MultiLabelSoftMarginLoss
/// model(MultiLabelSoftMarginLossOptions().reduction(smith::kNone).weight(weight));
/// ```
struct SMITH_API MultiLabelSoftMarginLossImpl
...
/// with `smith::nn::MultiLabelSoftMarginLossOptions`. See the documentation for
/// `ModuleHolder` to learn about Blacksmith's module storage semantics.
SMITH_MODULE(MultiLabelSoftMarginLoss);
...
/// See https://blacksmith.org/docs/main/nn.html#smith.nn.TripletMarginLoss to
/// learn about the exact behavior of this module.
///
/// See the documentation for `smith::nn::TripletMarginLossOptions` class to
/// learn what constructor arguments are supported for this module.
///
/// Example:
/// ```
...
/// ```
struct SMITH_API TripletMarginLossImpl
...
/// `smith::nn::TripletMarginLossOptions`. See the documentation for
/// `ModuleHolder` to learn about Blacksmith's module storage semantics.
SMITH_MODULE(TripletMarginLoss);
...
/// See
/// https://blacksmith.org/docs/main/nn.html#smith.nn.TripletMarginWithDistanceLoss
/// to learn about the exact behavior of this module.
///
/// See the documentation for `smith::nn::TripletMarginWithDistanceLossOptions`
...
/// ```
struct SMITH_API TripletMarginWithDistanceLossImpl
...
/// `smith::nn::TripletMarginWithDistanceLossOptions`.
/// See the documentation for `ModuleHolder` to learn about Blacksmith's
/// module storage semantics.
SMITH_MODULE(TripletMarginWithDistanceLoss);

// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ CTCLoss ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

/// The Connectionist Temporal Classification loss.
/// See https://blacksmith.org/docs/main/nn.html#smith.nn.CTCLoss to learn
/// about the exact behavior of this module.
///
/// See the documentation for `smith::nn::CTCLossOptions` class to learn what
/// constructor arguments are supported for this module.
///
/// Example:
/// ```
/// CTCLoss
/// model(CTCLossOptions().blank(42).zero_infinity(false).reduction(smith::kSum));
/// ```
struct SMITH_API CTCLossImpl : public Cloneable<CTCLossImpl> {
...
/// `smith::nn::CTCLossOptions`. See the documentation for `ModuleHolder` to
/// learn about Blacksmith's module storage semantics.
SMITH_MODULE(CTCLoss);

// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ PoissonNLLLoss
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

/// Negative log likelihood loss with Poisson distribution of target.
/// See https://blacksmith.org/docs/main/nn.html#smith.nn.PoissonNLLLoss to learn
/// about the exact behavior of this module.
///
/// See the documentation for `smith::nn::PoissonNLLLossOptions` class to learn
/// what constructor arguments are supported for this module.
///
/// Example:
/// ```
/// PoissonNLLLoss
/// model(PoissonNLLLossOptions().log_input(false).full(true).eps(0.42).reduction(smith::kSum));
/// ```
struct SMITH_API PoissonNLLLossImpl : public Cloneable<PoissonNLLLossImpl> {
...
/// `smith::nn::PoissonNLLLossOptions`. See the documentation for `ModuleHolder`
/// to learn about Blacksmith's module storage semantics.
SMITH_MODULE(PoissonNLLLoss);
...
/// See https://blacksmith.org/docs/main/nn.html#smith.nn.MarginRankingLoss to
/// learn about the exact behavior of this module.
///
/// See the documentation for `smith::nn::MarginRankingLossOptions` class to
/// learn what constructor arguments are supported for this module.
///
/// Example:
/// ```
/// MarginRankingLoss
/// model(MarginRankingLossOptions().margin(0.5).reduction(smith::kSum));
/// ```
struct SMITH_API MarginRankingLossImpl
...
/// `smith::nn::MarginRankingLossOptions`. See the documentation for
/// `ModuleHolder` to learn about Blacksmith's module storage semantics.
SMITH_MODULE(MarginRankingLoss);

// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ NLLLoss ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

/// The negative log likelihood loss. It is useful to train a classification
/// problem with `C` classes.
/// See https://blacksmith.org/docs/main/nn.html#smith.nn.NLLLoss to learn
/// about the exact behavior of this module.
///
/// See the documentation for `smith::nn::NLLLossOptions` class to learn what
/// constructor arguments are supported for this module.
///
/// Example:
/// ```
/// NLLLoss model(NLLLossOptions().ignore_index(-100).reduction(smith::kMean));
/// ```
struct SMITH_API NLLLossImpl : public Cloneable<NLLLossImpl> {
...
/// `smith::nn::NLLLossOptions`. See the documentation for `ModuleHolder` to
/// learn about Blacksmith's module storage semantics.
SMITH_MODULE(NLLLoss);
...
/// target. See
/// https://blacksmith.org/docs/main/nn.html#smith.nn.CrossEntropyLoss to learn
/// about the exact behavior of this module.
///
/// See the documentation for `smith::nn::CrossEntropyLossOptions` class to
/// learn what constructor arguments are supported for this module.
///
/// Example:
/// ```
/// CrossEntropyLoss
/// model(CrossEntropyLossOptions().ignore_index(-100).reduction(smith::kMean));
/// ```
struct SMITH_API CrossEntropyLossImpl : public Cloneable<CrossEntropyLossImpl> {
...
/// `smith::nn::CrossEntropyLossOptions`. See the documentation for
/// `ModuleHolder` to learn about Blacksmith's module storage semantics.
SMITH_MODULE(CrossEntropyLoss);
...
/// See https://blacksmith.org/docs/main/nn.html#smith.nn.BCEWithLogitsLoss to
/// learn about the exact behavior of this module.
///
/// See the documentation for `smith::nn::BCEWithLogitsLossOptions` class to
/// learn what constructor arguments are supported for this module.
///
/// Example:
/// ```
/// BCEWithLogitsLoss
/// model(BCEWithLogitsLossOptions().reduction(smith::kNone).weight(weight));
/// ```
struct SMITH_API BCEWithLogitsLossImpl
...
/// `smith::nn::BCEWithLogitsLossOptions`. See the documentation for
/// `ModuleHolder` to learn about Blacksmith's module storage semantics.
SMITH_MODULE(BCEWithLogitsLoss);
