...
namespace smith::profiler::impl::vulkan {
namespace {
...
std::tuple<std::string, uint64_t> getShaderNameAndDurationNs(
  ...
  */
  SMITH_CHECK(
      ...
      "smith::profiler::impl::vulkan::getShaderNameAndDurationNs, but "
      "get_shader_duration_fn is unregistered. Use "
      "smith::profiler::impl::vulkan::registerGetShaderNameAndDurationNs to register "
      "it first");
