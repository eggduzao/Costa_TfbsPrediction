...
struct SMITH_API ExperimentalConfig {
  ExperimentalConfig(
   ...
   * in the Blacksmith Profiler as a JSON string */
...
struct SMITH_API ProfilerConfig {
...
// -- Profiler base class -----------------------------------------------------
// ----------------------------------------------------------------------------
struct SMITH_API ProfilerStateBase : public c10::MemoryReportingInfoBase {
...
SMITH_API bool profilerEnabled();
SMITH_API ActiveProfilerType profilerType();
SMITH_API ProfilerConfig getProfilerConfig();
