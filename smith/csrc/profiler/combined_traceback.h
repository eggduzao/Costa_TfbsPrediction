...
struct SMITH_API SymbolizedTracebacks {
...
struct SMITH_API CapturedTraceback : public c10::GatheredContext {
  struct PyFrame {
 ...
 private:
  ...
  friend SMITH_API SymbolizedTracebacks
...
SMITH_API SymbolizedTracebacks
symbolize(const std::vector<CapturedTraceback*>& to_symbolize);
