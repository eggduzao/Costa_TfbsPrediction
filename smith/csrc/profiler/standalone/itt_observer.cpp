...
static std::unique_ptr<at::ObserverContext> enterITT(
  ...
  if (ITTThreadLocalState::getTLS() != nullptr) {
    smith::profiler::impl::ittStubs()->rangePush(fn.name());
  }
  return nullptr;
}
...
void pushITTCallbacks(
  ...
  SMITH_CHECK(
      smith::profiler::impl::ittStubs()->enabled(),
      "Can't use ITT profiler - Blacksmith was compiled without ITT");
  ...
  auto handle = at::addThreadLocalCallback(
      at::RecordFunctionCallback(
          ...
          [](const at::RecordFunction&, at::ObserverContext*) {
            smith::profiler::impl::ittStubs()->rangePop();
          })
