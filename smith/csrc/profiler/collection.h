...
// ============================================================================
struct SMITH_API RawTensorMetadataBase {
...
struct SMITH_API RawTensorMetadata : RawTensorMetadataBase {
...
struct SMITH_API TensorMetadata : public RawTensorMetadataBase {
  TensorMetadata(
...
// Used during post processing.
struct SMITH_API ProfilerStepInfo {
...
template <>
struct ExtraFields<EventType::SmithOp> : SmithOpBasicFields {
  ExtraFields(
      SmithOpBasicFields&& f,
...
struct SMITH_API Result : public std::enable_shared_from_this<Result> {
  ...
  bool hidden_{false};
  const smith::profiler::impl::kineto::activity_t* kineto_activity_{nullptr};
...
struct KinetoObserverContext : public at::ObserverContext {
  struct Event {
    SmithOpBasicFields basic_fields_;
    c10::approx_time_t start_time_;
...
using perf_profiler_t = smith::profiler::impl::linux_perf::PerfProfiler;

class SMITH_API ThreadLocalSubqueue {
 public:
...
SMITH_API bool get_record_concrete_inputs_enabled();
SMITH_API void set_record_concrete_inputs_enabled_fn(
    std::function<bool()> /*fn*/);
SMITH_API void set_record_concrete_inputs_enabled_val(bool /*val*/);

SMITH_API bool get_fwd_bwd_enabled();
SMITH_API void set_fwd_bwd_enabled_fn(std::function<bool()> /*fn*/);
SMITH_API void set_fwd_bwd_enabled_val(bool /*val*/);

SMITH_API bool get_cuda_sync_enabled();
SMITH_API void set_cuda_sync_enabled_fn(std::function<bool()> /*fn*/);
SMITH_API void set_cuda_sync_enabled_val(bool /*val*/);

// Comms related RecordFunctions will record information about tensor storage
// locations.
SMITH_API bool get_record_tensor_addrs_enabled();
SMITH_API void set_record_tensor_addrs_enabled_fn(std::function<bool()> /*fn*/);
SMITH_API void set_record_tensor_addrs_enabled_val(bool /*val*/);
