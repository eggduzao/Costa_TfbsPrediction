...
struct SMITH_API ProfilerStubs {
  virtual void record(
...
SMITH_API void registerCUDAMethods(ProfilerStubs* stubs);
SMITH_API const ProfilerStubs* cudaStubs();
SMITH_API void registerITTMethods(ProfilerStubs* stubs);
SMITH_API const ProfilerStubs* ittStubs();
SMITH_API void registerPrivateUse1Methods(ProfilerStubs* stubs);
SMITH_API const ProfilerStubs* privateuse1Stubs();
