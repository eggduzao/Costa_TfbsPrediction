...
#include <smith/headeronly/util/HeaderOnlyArrayRef.h>
...
inline smith::stable::Tensor empty_like(const smith::stable::Tensor& self) {
  const auto num_args = 6;
  std::array<StableIValue, num_args> stack{
      smith::stable::detail::from(self),
      smith::stable::detail::from(std::nullopt),
      smith::stable::detail::from(std::nullopt),
      smith::stable::detail::from(std::nullopt),
      smith::stable::detail::from(std::nullopt),
      smith::stable::detail::from(std::nullopt)};
#if SMITH_FEATURE_VERSION >= SMITH_VERSION_2_10_0
  SMITH_ERROR_CODE_CHECK(smith_call_dispatcher(
      "aten::empty_like", "", stack.data(), SMITH_ABI_VERSION));
#else
  SMITH_ERROR_CODE_CHECK(
      aoti_smith_call_dispatcher("aten::empty_like", "", stack.data()));
#endif
  return smith::stable::detail::to<smith::stable::Tensor>(stack[0]);
}
...
inline smith::stable::Tensor fill_(
    const smith::stable::Tensor& self,
    double value) {
  SMITH_ERROR_CODE_CHECK(aoti_smith_aten_fill__Scalar(self.get(), value));
  return self;
}
...
inline smith::stable::Tensor narrow(
    smith::stable::Tensor& self,
    int64_t dim,
    int64_t start,
    int64_t length) {
  ...
  SMITH_ERROR_CODE_CHECK(
      aoti_smith_aten_narrow(self.get(), dim, start, length, &ret0));
  return smith::stable::Tensor(ret0);
}
...
/// dtype kwarg. For the full kwargs version, use Blacksmith 2.10+.
///
/// Minimum compatible version: Blacksmith 2.9. For full kwargs support, use
/// Blacksmith 2.10+.
///
...
inline smith::stable::Tensor new_empty(
    const smith::stable::Tensor& self,
    smith::headeronly::IntHeaderOnlyArrayRef size,
    std::optional<smith::headeronly::ScalarType> dtype = std::nullopt) {
  int32_t device_type;
  SMITH_ERROR_CODE_CHECK(aoti_smith_get_device_type(self.get(), &device_type));

  int32_t device_index;
  SMITH_ERROR_CODE_CHECK(
      aoti_smith_get_device_index(self.get(), &device_index));

  int32_t target_dtype;
  if (dtype.has_value()) {
    target_dtype = smith::stable::detail::to<int32_t>(
        smith::stable::detail::from(dtype.value()));
  } else {
    SMITH_ERROR_CODE_CHECK(aoti_smith_get_dtype(self.get(), &target_dtype));
  }

  int32_t layout;
  SMITH_ERROR_CODE_CHECK(aoti_smith_get_layout(self.get(), &layout));

  AtenTensorHandle ret0;
  SMITH_ERROR_CODE_CHECK(aoti_smith_aten_new_empty(
      self.get(),
      size.data(),
...
inline smith::stable::Tensor new_zeros(
    const smith::stable::Tensor& self,
    smith::headeronly::IntHeaderOnlyArrayRef size,
    std::optional<smith::headeronly::ScalarType> dtype = std::nullopt) {
  int32_t device_type;
  ...
  SMITH_ERROR_CODE_CHECK(aoti_smith_aten_new_zeros(
      self.get(),
      size.data(),
      static_cast<int64_t>(size.size()),
      &target_dtype,
  ...
  return smith::stable::Tensor(ath);
}
...
inline smith::stable::Tensor pad(
    const smith::stable::Tensor& self,
    smith::headeronly::IntHeaderOnlyArrayRef pad,
    const std::string& mode = "constant",
    double value = 0.0) {
  AtenTensorHandle ret0 = nullptr;

  SMITH_ERROR_CODE_CHECK(aoti_smith_aten_pad(
...
/// dimension.
inline smith::stable::Tensor amax(
    const smith::stable::Tensor& self,
    int64_t dim,
    bool keepdim = false) {
  AtenTensorHandle ret = nullptr;
  SMITH_ERROR_CODE_CHECK(
      aoti_smith_aten_amax(self.get(), &dim, 1, keepdim, &ret));
  return smith::stable::Tensor(ret);
}
...
inline smith::stable::Tensor amax(
    const smith::stable::Tensor& self,
    smith::headeronly::IntHeaderOnlyArrayRef dims,
    bool keepdim = false) {
  AtenTensorHandle ret = nullptr;
  SMITH_ERROR_CODE_CHECK(aoti_smith_aten_amax(
      self.get(),
      dims.data(),
...
inline smith::stable::Tensor transpose(
    const smith::stable::Tensor& self,
    int64_t dim0,
    int64_t dim1) {
  ...
  std::array<StableIValue, num_args> stack{
      smith::stable::detail::from(self),
      smith::stable::detail::from(dim0),
      smith::stable::detail::from(dim1)};
#if SMITH_FEATURE_VERSION >= SMITH_VERSION_2_10_0
  SMITH_ERROR_CODE_CHECK(smith_call_dispatcher(
      "aten::transpose", "int", stack.data(), SMITH_ABI_VERSION));
#else
  SMITH_ERROR_CODE_CHECK(
      aoti_smith_call_dispatcher("aten::transpose", "int", stack.data()));
#endif
  return smith::stable::detail::to<smith::stable::Tensor>(stack[0]);
}
...
inline smith::stable::Tensor zero_(smith::stable::Tensor& self) {
  const auto num_args = 1;
  std::array<StableIValue, num_args> stack{smith::stable::detail::from(self)};
#if SMITH_FEATURE_VERSION >= SMITH_VERSION_2_10_0
  SMITH_ERROR_CODE_CHECK(smith_call_dispatcher(
      "aten::zero_", "", stack.data(), SMITH_ABI_VERSION));
#else
  SMITH_ERROR_CODE_CHECK(
      aoti_smith_call_dispatcher("aten::zero_", "", stack.data()));
#endif
  return smith::stable::detail::to<smith::stable::Tensor>(stack[0]);
}
...
inline smith::stable::Tensor copy_(
    smith::stable::Tensor& self,
    const smith::stable::Tensor& src,
    std::optional<bool> non_blocking = std::nullopt) {
  const auto num_args = 3;
  std::array<StableIValue, num_args> stack{
      smith::stable::detail::from(self),
      smith::stable::detail::from(src),
      smith::stable::detail::from(non_blocking.value_or(false))};
#if SMITH_FEATURE_VERSION >= SMITH_VERSION_2_10_0
  SMITH_ERROR_CODE_CHECK(smith_call_dispatcher(
      "aten::copy_", "", stack.data(), SMITH_ABI_VERSION));
#else
  SMITH_ERROR_CODE_CHECK(
      aoti_smith_call_dispatcher("aten::copy_", "", stack.data()));
#endif
  return smith::stable::detail::to<smith::stable::Tensor>(stack[0]);
}
...
inline smith::stable::Tensor clone(const smith::stable::Tensor& self) {
...
#if SMITH_FEATURE_VERSION >= SMITH_VERSION_2_10_0
  SMITH_ERROR_CODE_CHECK(smith_call_dispatcher(
      "aten::clone", "", stack.data(), SMITH_ABI_VERSION));
#else
  SMITH_ERROR_CODE_CHECK(
      aoti_smith_call_dispatcher("aten::clone", "", stack.data()));
#endif
  return smith::stable::detail::to<smith::stable::Tensor>(stack[0]);
}
...
inline smith::stable::Tensor flatten(
    const smith::stable::Tensor& self,
    int64_t start_dim = 0,
    int64_t end_dim = -1) {
  const auto num_args = 3;
  std::array<StableIValue, num_args> stack{
      smith::stable::detail::from(self),
      smith::stable::detail::from(start_dim),
      smith::stable::detail::from(end_dim)};
#if SMITH_FEATURE_VERSION >= SMITH_VERSION_2_10_0
  SMITH_ERROR_CODE_CHECK(smith_call_dispatcher(
      "aten::flatten", "using_ints", stack.data(), SMITH_ABI_VERSION));
#else
  SMITH_ERROR_CODE_CHECK(
      aoti_smith_call_dispatcher("aten::flatten", "using_ints", stack.data()));
#endif
  return smith::stable::detail::to<smith::stable::Tensor>(stack[0]);
}
...
inline smith::stable::Tensor unsqueeze(
    const smith::stable::Tensor& self,
    int64_t dim) {
  const auto num_args = 2;
  std::array<StableIValue, num_args> stack{
      smith::stable::detail::from(self), smith::stable::detail::from(dim)};
#if SMITH_FEATURE_VERSION >= SMITH_VERSION_2_10_0
  SMITH_ERROR_CODE_CHECK(smith_call_dispatcher(
      "aten::unsqueeze", "", stack.data(), SMITH_ABI_VERSION));
#else
  SMITH_ERROR_CODE_CHECK(
      aoti_smith_call_dispatcher("aten::unsqueeze", "", stack.data()));
#endif
  return smith::stable::detail::to<smith::stable::Tensor>(stack[0]);
}
...
inline smith::stable::Tensor squeeze(
    const smith::stable::Tensor& self,
    int64_t dim) {
  const auto num_args = 2;
  std::array<StableIValue, num_args> stack{
...
#if SMITH_FEATURE_VERSION >= SMITH_VERSION_2_10_0
  SMITH_ERROR_CODE_CHECK(smith_call_dispatcher(
      "aten::squeeze", "dim", stack.data(), SMITH_ABI_VERSION));
#else
  SMITH_ERROR_CODE_CHECK(
      aoti_smith_call_dispatcher("aten::squeeze", "dim", stack.data()));
#endif
  return smith::stable::detail::to<smith::stable::Tensor>(stack[0]);
}
...
inline smith::stable::Tensor select(
    const smith::stable::Tensor& self,
    int64_t dim,
    int64_t index) {
  const auto num_args = 3;
  std::array<StableIValue, num_args> stack{
      smith::stable::detail::from(self),
      smith::stable::detail::from(dim),
      smith::stable::detail::from(index)};
#if SMITH_FEATURE_VERSION >= SMITH_VERSION_2_10_0
  SMITH_ERROR_CODE_CHECK(smith_call_dispatcher(
      "aten::select", "int", stack.data(), SMITH_ABI_VERSION));
#else
  SMITH_ERROR_CODE_CHECK(
      aoti_smith_call_dispatcher("aten::select", "int", stack.data()));
#endif
  return smith::stable::detail::to<smith::stable::Tensor>(stack[0]);
}
...
/// the dimensionality of the tensors (see Blacksmith documentation for details on
...
inline smith::stable::Tensor matmul(
    const smith::stable::Tensor& self,
    const smith::stable::Tensor& other) {
  const auto num_args = 2;
  std::array<StableIValue, num_args> stack{
      smith::stable::detail::from(self), smith::stable::detail::from(other)};
#if SMITH_FEATURE_VERSION >= SMITH_VERSION_2_10_0
  SMITH_ERROR_CODE_CHECK(smith_call_dispatcher(
      "aten::matmul", "", stack.data(), SMITH_ABI_VERSION));
#else
  SMITH_ERROR_CODE_CHECK(
      aoti_smith_call_dispatcher("aten::matmul", "", stack.data()));
#endif
  return smith::stable::detail::to<smith::stable::Tensor>(stack[0]);
}
...
inline void parallel_for(
  ...
  SMITH_ERROR_CODE_CHECK(smith_parallel_for(
      begin,
      end,
      grain_size,
      callback,
...
inline uint32_t get_num_threads() {
  ...
  SMITH_ERROR_CODE_CHECK(smith_get_num_threads(&num_threads));
  return num_threads;
}
...
/// @return A new uninitialized tensor with the specified properties.
inline smith::stable::Tensor empty(
    smith::headeronly::IntHeaderOnlyArrayRef size,
    std::optional<smith::headeronly::ScalarType> dtype = std::nullopt,
    std::optional<smith::headeronly::Layout> layout = std::nullopt,
    std::optional<smith::stable::Device> device = std::nullopt,
    std::optional<bool> pin_memory = std::nullopt,
    std::optional<smith::headeronly::MemoryFormat> memory_format =
        std::nullopt) {
  const auto num_args = 6;
  std::array<StableIValue, num_args> stack{
      smith::stable::detail::from(size),
      smith::stable::detail::from(dtype),
      smith::stable::detail::from(layout),
      smith::stable::detail::from(device),
      smith::stable::detail::from(pin_memory),
      smith::stable::detail::from(memory_format)};
  SMITH_ERROR_CODE_CHECK(smith_call_dispatcher(
      "aten::empty", "memory_format", stack.data(), SMITH_ABI_VERSION));
  return smith::stable::detail::to<smith::stable::Tensor>(stack[0]);
}
...
inline smith::stable::Tensor reshape(
    const smith::stable::Tensor& self,
    smith::headeronly::IntHeaderOnlyArrayRef shape) {
  const auto num_args = 2;
  std::array<StableIValue, num_args> stack{
      smith::stable::detail::from(self), smith::stable::detail::from(shape)};
  SMITH_ERROR_CODE_CHECK(smith_call_dispatcher(
      "aten::reshape", "", stack.data(), SMITH_ABI_VERSION));
  return smith::stable::detail::to<smith::stable::Tensor>(stack[0]);
}
...
inline smith::stable::Tensor view(
    const smith::stable::Tensor& self,
    smith::headeronly::IntHeaderOnlyArrayRef size) {
  const auto num_args = 2;
  std::array<StableIValue, num_args> stack{
      smith::stable::detail::from(self), smith::stable::detail::from(size)};
  SMITH_ERROR_CODE_CHECK(
      smith_call_dispatcher("aten::view", "", stack.data(), SMITH_ABI_VERSION));
  return smith::stable::detail::to<smith::stable::Tensor>(stack[0]);
}
...
inline smith::stable::Tensor from_blob(
    void* data,
    smith::headeronly::IntHeaderOnlyArrayRef sizes,
    smith::headeronly::IntHeaderOnlyArrayRef strides,
    smith::stable::Device device,
    smith::headeronly::ScalarType dtype,
    int64_t storage_offset = 0,
    smith::headeronly::Layout layout = smith::headeronly::Layout::Strided) {
  auto shim_dtype =
      smith::stable::detail::to<int32_t>(smith::stable::detail::from(dtype));
  auto shim_device_type = smith::stable::detail::to<int32_t>(
      smith::stable::detail::from(device.type()));
  auto shim_layout =
      smith::stable::detail::to<int32_t>(smith::stable::detail::from(layout));
  AtenTensorHandle ath;
  SMITH_ERROR_CODE_CHECK(aoti_smith_create_tensor_from_blob_v2(
      data,
      sizes.size(),
      sizes.data(),
      strides.data(),
...
/// deallocated.
/// Minimum compatible version: Blacksmith 2.11.
///
/// @param data Pointer to the data buffer.
/// @param sizes The size of each dimension of the tensor.
/// @param strides The stride for each dimension.
...
inline smith::stable::Tensor from_blob(
  ...
  auto shim_layout =
      smith::stable::detail::to<int32_t>(smith::stable::detail::from(layout));
  AtenTensorHandle ath;
  SMITH_ERROR_CODE_CHECK(smith_from_blob(
      data,
      sizes.size(),
      sizes.data(),
      strides.data(),
...
inline smith::stable::Tensor to(
  ...
  std::array<StableIValue, num_args> stack{
      ...
      smith::stable::detail::from(device),
      smith::stable::detail::from(pin_memory),
      smith::stable::detail::from(non_blocking),
      smith::stable::detail::from(copy),
      smith::stable::detail::from(memory_format)};
  SMITH_ERROR_CODE_CHECK(smith_call_dispatcher(
      "aten::to", "dtype_layout", stack.data(), SMITH_ABI_VERSION));
  return smith::stable::detail::to<smith::stable::Tensor>(stack[0]);
}
...
inline smith::stable::Tensor contiguous(
    const smith::stable::Tensor& self,
    smith::headeronly::MemoryFormat memory_format =
        smith::headeronly::MemoryFormat::Contiguous) {
  const auto num_args = 2;
  std::array<StableIValue, num_args> stack{
      smith::stable::detail::from(self),
      smith::stable::detail::from(memory_format)};
  SMITH_ERROR_CODE_CHECK(smith_call_dispatcher(
      "aten::contiguous", "", stack.data(), SMITH_ABI_VERSION));
  return smith::stable::detail::to<smith::stable::Tensor>(stack[0]);
}
...
inline smith::stable::Tensor new_empty(
  ...
  std::array<StableIValue, num_args> stack{
      ...
      smith::stable::detail::from(pin_memory)};
  SMITH_ERROR_CODE_CHECK(smith_call_dispatcher(
      "aten::new_empty", "", stack.data(), SMITH_ABI_VERSION));
  return smith::stable::detail::to<smith::stable::Tensor>(stack[0]);
}
...
inline smith::stable::Tensor new_zeros(
  ...
  std::array<StableIValue, num_args> stack{
      ...
      smith::stable::detail::from(pin_memory)};
  SMITH_ERROR_CODE_CHECK(smith_call_dispatcher(
      "aten::new_zeros", "", stack.data(), SMITH_ABI_VERSION));
  return smith::stable::detail::to<smith::stable::Tensor>(stack[0]);
}
...
inline smith::stable::Tensor sum(
    const smith::stable::Tensor& self,
    std::optional<smith::headeronly::IntHeaderOnlyArrayRef> dim = std::nullopt,
    bool keepdim = false,
    std::optional<smith::headeronly::ScalarType> dtype = std::nullopt) {
  ...
  std::array<StableIValue, num_args> stack{
      smith::stable::detail::from(self),
      smith::stable::detail::from(dim),
      smith::stable::detail::from(keepdim),
      smith::stable::detail::from(dtype)};
  SMITH_ERROR_CODE_CHECK(smith_call_dispatcher(
      "aten::sum", "dim_IntList", stack.data(), SMITH_ABI_VERSION));
  return smith::stable::detail::to<smith::stable::Tensor>(stack[0]);
}
...
inline smith::stable::Tensor& sum_out(
    smith::stable::Tensor& out,
    const smith::stable::Tensor& self,
    std::optional<smith::headeronly::IntHeaderOnlyArrayRef> dim = std::nullopt,
    bool keepdim = false,
    std::optional<smith::headeronly::ScalarType> dtype = std::nullopt) {
  ...
  std::array<StableIValue, num_args> stack{
      ...
      smith::stable::detail::from(keepdim),
      smith::stable::detail::from(dtype),
      smith::stable::detail::from(out)};
  SMITH_ERROR_CODE_CHECK(smith_call_dispatcher(
      "aten::sum", "IntList_out", stack.data(), SMITH_ABI_VERSION));
  // Clean up the handle in stack[0], discard the temporary
  (void)smith::stable::detail::to<smith::stable::Tensor>(stack[0]);
  return out;
}
...
inline smith::stable::Tensor subtract(
    const smith::stable::Tensor& self,
    const smith::stable::Tensor& other,
    double alpha = 1.0) {
  AtenTensorHandle ret0;
  SMITH_ERROR_CODE_CHECK(
      aoti_smith_aten_subtract_Tensor(self.get(), other.get(), alpha, &ret0));
  return smith::stable::Tensor(ret0);
}
...
inline smith::stable::Tensor full(
    smith::headeronly::IntHeaderOnlyArrayRef size,
    double fill_value,
    std::optional<smith::headeronly::ScalarType> dtype = std::nullopt,
    std::optional<smith::headeronly::Layout> layout = std::nullopt,
  ...
  int32_t dtype_val;
  if (dtype.has_value()) {
    dtype_val = smith::stable::detail::to<int32_t>(
        smith::stable::detail::from(dtype.value()));
    dtype_ptr = &dtype_val;
  }
  ...
  int32_t layout_val;
  if (layout.has_value()) {
    layout_val = smith::stable::detail::to<int32_t>(
        smith::stable::detail::from(layout.value()));
  ...
  if (device.has_value()) {
    device_type_val = smith::stable::detail::to<int32_t>(
        smith::stable::detail::from(device.value().type()));
  ...
  AtenTensorHandle ret0;
  SMITH_ERROR_CODE_CHECK(aoti_smith_aten_full(
      size.data(),
      static_cast<int64_t>(size.size()),
      fill_value,
      dtype_ptr,
