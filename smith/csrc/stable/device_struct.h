...
// The smith::stable::Device class is an approximate copy of c10::Device.
// It has some slight modifications:
// 1. SMITH_INTERNAL_ASSERT_DEBUG_ONLY -> STD_SMITH_CHECK
...
//
// StableIValue conversions handle conversion between c10::Device (in libsmith)
// and smith::stable::Device (in stable user extensions)
