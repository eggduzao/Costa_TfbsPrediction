"""
Template heuristic registry system for Blacksmith Inductor.
...
for CUDA vs ROCm based on smith.version.hip.
"""
...
def register_template_heuristic(
    ...
    Example:
        @register_template_heuristic("mm", "cuda", register=smith.version.hip is None)
