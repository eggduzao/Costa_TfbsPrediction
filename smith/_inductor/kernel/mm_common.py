...
import smith
from smith._inductor.select_algorithm import realize_inputs, SymbolicGridFn
from smith._inductor.utils import get_current_backend, sympy_product
...
def use_native_matmul(mat1, mat2):
    ...
    if (
        ...
        and smith.utils._triton.has_triton_tma_device()
    ):
    ...
    # See this : https://github.com/blacksmith/blacksmith/pull/131649
