...
from smith._inductor.runtime.triton_compat import tl
from smith._inductor.template_heuristics.cutedsl import get_groupgemm_configs
...
def create_offsets(offs_box, m1_is_2d, m2_is_2d, m, n, k, alignment):
    ...
    offs = smith.arange(1, noffs_hint + 1, dtype=smith.float32) * (
        end_hint / noffs_hint
    )
...
def _tuned_grouped_mm_common(
    ...
    if (
        ...
        add_nv_universal_grouped_gemm_choices(
            ...
            layout,
            input_nodes,
            accumulator_type=smith.float32,
        )
