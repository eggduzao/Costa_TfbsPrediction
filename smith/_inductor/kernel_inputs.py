...
class KernelInputs(ABC):
    ...
    def device_name(self) -> Optional[str]:
        ...
        if self._device_name is None:
            ...
            if self.device_type == "cuda":
                device_properties = smith.cuda.get_device_properties(device)
    ...
    def dtypes(self) -> tuple[smith.dtype, ...]:
        """
    ...
    def dtype(self, idx: int = 0) -> smith.dtype:
        """
    ...
    @abstractmethod
    def out_dtype(self) -> smith.dtype:
        """
