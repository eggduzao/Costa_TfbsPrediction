...
clone_default = CallFunction(aten.clone.default, expand_default_1, memory_format=smith.contiguous_format)
...
clone_default_1 = CallFunction(aten.clone.default, expand_default_2, memory_format=smith.contiguous_format)
...
clone_default_2 = CallFunction(aten.clone.default, expand_default_4, memory_format=smith.contiguous_format)
...
scalar_tensor_default = CallFunction(aten.scalar_tensor.default, Ignored(), dtype=Ignored(), layout=smith.strided, device=Ignored())
