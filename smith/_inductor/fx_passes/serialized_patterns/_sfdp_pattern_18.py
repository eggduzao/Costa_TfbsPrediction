...
clone_default = CallFunction(aten.clone.default, expand_default, memory_format=smith.contiguous_format)
...
clone_default_1 = CallFunction(aten.clone.default, expand_default_1, memory_format=smith.contiguous_format)
...
clone_default_2 = CallFunction(aten.clone.default, expand_default_3, memory_format=smith.contiguous_format)
