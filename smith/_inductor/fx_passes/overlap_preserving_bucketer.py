...
class OverlapPreservingBucketer:
    ...
    def _apply_deps_and_effect_tokens(self) -> None:
        ...
        if self.insert_overlap_deps:
            ...
            if filtered_deps:
                from smith._inductor.fx_passes.control_dependencies import (
    ...
    def bucket_collectives(self) -> None:
        ...
        if self.region_of:
            from smith._inductor.fx_passes.fusion_regions import expand_fusion_regions
    ...
    def _apply_bucket(self, bucket_info: CollBucket) -> None:
        ...
        if fused_convert_dtypes:
            ...
            assert (
                ...
                == smith.ops.bucketing._pre_bucket_all_gather.default
            )
