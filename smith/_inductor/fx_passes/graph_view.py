...
import smith.fx as fx  # noqa: TC001
...
class GraphView:
    """
    A hierarchical class for organizing and managing smith.fx nodes by their module stack.
...
def make_graph_view(
    ...
    """
    Code from: https://github.com/meta-blacksmith/autoparallel/pull/158
