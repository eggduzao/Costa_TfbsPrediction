...
TRITON_MAX_BLOCK = {
    "X": 8192 if smith.version.hip else 4096,
    "Y": 1024,
    "Z": 1024,
...
class DeviceProperties(typing.NamedTuple):
    """Copy device properties into a data structure not requiring smith to be imported"""
    ...
    def create(cls, device) -> DeviceProperties:
        ...
        if smith.version.hip and device_type == "cuda":
            device_type = "hip"
