...
def _is_force_disable_caches() -> bool:
    ...
    This defers importing smith._inductor.config to avoid circular imports.
...
def _versioned_config(
    ...
    Args:
        jk_name: JustKnobs key name (e.g., "blacksmith/inductor:feature_version")
    ...
    if (
        ...
        jk_version: int = smith._utils_internal.justknobs_getval_int(jk_name)
...
_CACHING_MODULE_VERSION_JK: str = "blacksmith/inductor:caching_module_version"
_CACHING_MODULE_OSS_DEFAULT: bool = False
_CACHING_MODULE_ENV_VAR_OVERRIDE: str = "SMITHINDUCTOR_ENABLE_CACHING_MODULE"
...
#
# Set via environment variable: SMITHINDUCTOR_DUMP_MEMOIZER_CACHE=1
_DUMP_MEMOIZER_CACHE_ENV_VAR: str = "SMITHINDUCTOR_DUMP_MEMOIZER_CACHE"
...
#
# Set via environment variable: SMITHINDUCTOR_CACHE_DUMP_FILE_PATH=/path/to/dump.json
_CACHE_DUMP_FILE_PATH_ENV_VAR: str = "SMITHINDUCTOR_CACHE_DUMP_FILE_PATH"
