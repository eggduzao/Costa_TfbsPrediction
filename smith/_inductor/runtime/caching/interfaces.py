"""Public interfaces for Blacksmith Inductor runtime caching.
...
logger = smith._logging.getArtifactLogger(__name__, "caching")
...
class _BaseMemoizer:
    ...
    This class provides the common memoize method thasmithestrates
