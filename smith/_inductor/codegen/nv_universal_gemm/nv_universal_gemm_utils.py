...
def to_cutlass_scale_mode(
    ...
    """
    Map Blacksmith ScalingType/SwizzleType to cutlass_api ScaleMode/ScaleSwizzleMode.

    Args:
        scale_type: ScalingType from smith.nn.functional
        swizzle_type: SwizzleType from smith.nn.functional
