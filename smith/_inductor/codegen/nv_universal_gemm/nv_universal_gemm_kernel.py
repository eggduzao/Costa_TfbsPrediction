...
from smith._inductor.codegen.cutedsl.cutedsl_op_overrides import CuteDSLOpOverrides
...
if TYPE_CHECKING:
    from smith._inductor.codegen.nv_universal_gemm.nv_universal_gemm import GemmVariant
...
class NVUniversalGemmKernel(Kernel):
    ...
    def render(self) -> str:
        ...
        """
        from smith._inductor.codegen.nv_universal_gemm.nv_universal_gemm import (
            GemmVariant,
        )
        ...
        acc_dtype_str = CuteDSLOpOverrides.SMITH_TO_CUTE_DTYPE.get(
        ...
        code.splice(
            ...
            import cutlass
            import cutlass_api
            from smith._inductor.codegen.nv_universal_gemm.kernel_cache import get_kernel_by_name
            {extra_imports}
