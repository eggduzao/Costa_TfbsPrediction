...
#include <smith/csrc/inductor/aoti_runtime/interface.h>
#include <smith/csrc/inductor/aoti_runtime/model_container.h>
...
AOTIRuntimeError AOTInductorModelContainerCreateWithDevice(
  ...
  CONVERT_EXCEPTION_TO_ERROR_CODE({
    ...
    auto* container = new smith::aot_inductor::AOTInductorModelContainer(
...
AOTIRuntimeError AOTInductorModelContainerDelete(
  ...
  CONVERT_EXCEPTION_TO_ERROR_CODE({
    auto* container =
        reinterpret_cast<smith::aot_inductor::AOTInductorModelContainer*>(
            container_handle);
    delete container;
  });
}
...
AOTIRuntimeError AOTInductorModelContainerRun(
  ...
  auto stream =
      reinterpret_cast<smith::aot_inductor::DeviceStreamType>(stream_handle);
  CONVERT_EXCEPTION_TO_ERROR_CODE({
...
AOTIRuntimeError AOTInductorModelContainerGetConstantFromFolded(
    ...
    bool* from_folded) {
  auto* container =
      reinterpret_cast<smith::aot_inductor::AOTInductorModelContainer*>(container_handle);
...
AOTIRuntimeError AOTInductorModelCreate(
    ...
    AOTInductorConstantMapHandle constant_map_handle){
    CONVERT_EXCEPTION_TO_ERROR_CODE({
      auto constant_map = std::make_shared<smith::aot_inductor::ConstantMap>();
      auto constant_array = std::make_shared<std::vector<smith::aot_inductor::ConstantHandle>>();
      auto input_map = reinterpret_cast<std::unordered_map<std::string, AtenTensorHandle>*>(constant_map_handle);

      auto model = new smith::aot_inductor::AOTInductorModel(
          constant_map,
          constant_array,
...
AOTIRuntimeError AOTInductorModelRun(
  ...
  auto model =
      reinterpret_cast<smith::aot_inductor::AOTInductorModel*>(model_handle);
  CONVERT_EXCEPTION_TO_ERROR_CODE({
    AOTINoGradGuard guard;
    model->run_impl(
        input_handles,
...
AOTIRuntimeError AOTInductorModelDelete(AOTInductorModelHandle model_handle){
    CONVERT_EXCEPTION_TO_ERROR_CODE({
      auto model = reinterpret_cast<smith::aot_inductor::AOTInductorModel*>(
          model_handle);
      delete model;
    })}
