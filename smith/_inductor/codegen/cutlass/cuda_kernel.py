...
from smith._inductor.codegen.cpp_wrapper_cpu import CppWrapperCpu
from smith._inductor.scheduler import BaseSchedulerNode
from smith._inductor.utils import do_bench_using_profiling, OrderedSet, Placeholder
...
if TYPE_CHECKING:
    from smith._inductor.codegen.cutlass.cuda_template import CUDATemplate
...
class CUDATemplateKernel(CUDAKernel):
 ...
 {runtime_arg_decls}{self._EXTRA_CPP_ARGS})"
    ...
    def call_kernel(
        ...
        used from within smith._inductor.wrapper.PythonWrapperCodegen
        ...
        for i in range(len(call_args)):
            ...
            elif isinstance(arg_types[i], smith_dtype):
                call_args[i] = (
                    call_args[i]
                    if V.graph.cpp_wrapper
    ...
    def cutlass_dtype(self, node: IRNode, default_dtype="void") -> Optional[str]:
        ...
        from smith._inductor.codegen.cutlass.cuda_template import CUTLASSTemplate
