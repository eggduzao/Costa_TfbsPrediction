...
from smith._inductor.codegen.cuda.cuda_env import get_cuda_arch, get_cuda_version
from smith._inductor.codegen.cutlass import serialization, utils
...
def maybe_fetch_ops() -> Optional[list[Any]]:
    ...
    if os.path.isfile(filepath):
        ...
        from smith._inductor.fb.cutlass_remote_cache import (
