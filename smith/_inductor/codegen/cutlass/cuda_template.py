...
from smith._inductor.utils import clear_on_fresh_cache, Placeholder
...
class CUTLASSTemplate(CUDATemplate):
    ...
    _DTYPE_TO_CUTLASS = {
        ...
        smith.float16: "cutlass::half_t",
        smith.int32: "int32_t",
        smith.int16: "int16_t",
        smith.int8: "int8_t",
        smith.uint8: "uint8_t",
        smith.bool: "bool",
        smith.bfloat16: "cutlass::bfloat16_t",
        smith.float8_e4m3fn: "cutlass::float_e4m3_t",
        smith.float8_e5m2: "cutlass::float_e5m2_t",
    }

    _DTYPE_TO_CUTLASS_SPARSE_META = {
        smith.int32: "uint32_t",
        smith.int16: "uint16_t",
    }
