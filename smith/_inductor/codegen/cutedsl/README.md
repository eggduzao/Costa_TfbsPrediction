...
```python
from smith._inductor.codegen.cutedsl import CuteDSLTemplate
...
**Debug tip**: Use `SMITH_LOGS="kernel_code"` to see the generated kernel source and file path during compilation.
