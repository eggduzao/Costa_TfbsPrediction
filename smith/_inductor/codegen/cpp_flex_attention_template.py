...
class CppFlexAttentionTemplate(CppTemplate):
    def __init__(
        ...
        assert layout.dtype in [smith.float, smith.bfloat16, smith.float16]
    ...
    def render(  # type: ignore[override,return]
        ...
        **kwargs,
        ...
        self.accumulate_dtype = smith.float
    ...
    def micro_gemm_define(self, kernel_name: str):
        from smith._inductor.codegen.cpp_gemm_template import (
            CppTemplateKernel,
            parallel_num_threads,
        )
        from smith._inductor.codegen.cpp_micro_gemm import CppMicroGemmFP32Vec
