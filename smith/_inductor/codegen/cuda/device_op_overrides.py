...
class CUDADeviceOpOverrides(DeviceOpOverrides):
    ...
    def import_get_raw_stream_as(self, name: str) -> str:
        return f"from smith._C import _cuda_getCurrentRawStream as {name}"

    def set_device(self, device_idx: int) -> str:
        return f"smith.cuda.set_device({device_idx})"

    def synchronize(self) -> str:
        return "smith.cuda.synchronize()"

    def device_guard(self, device_idx: int) -> str:
        return f"smith.cuda._DeviceGuard({device_idx})"
    ...
    def kernel_driver(self) -> str:
        ...
        if smith.version.hip is not None:
            ...
            prop = smith.cuda.get_device_properties(smith.cuda.current_device())
    ...
    def tma_descriptor_helpers(self) -> str:
        ...
        return """
            ...
            [[maybe_unused]] static void initTMADescriptor(
                ...
                // in the Blacksmith version we copied this code from the old
    ...
    def aoti_get_stream(self) -> str:
        return "aoti_smith_get_current_cuda_stream"
    ...
    def cpp_scratch(
        ...
        if workspace.size > 0:
            ...
            device_type = "cached_smith_device_type_cuda"
            ...
            return (
                [
                    ...
                    (
                        f"AOTI_SMITH_ERROR_CODE_CHECK(aoti_smith_empty_strided(1, {var_name}_size, {var_name}_stride, "
