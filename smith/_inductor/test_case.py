...
from smith._dynamo.test_case import (
...
class TestCase(DynamoTestCase):
    ...
    def setUp(self) -> None:
        ...
        if (
            "SMITHINDUCTOR_FX_GRAPH_CACHE" not in os.environ
            and "SMITHINDUCTOR_FX_GRAPH_CACHE_DEFAULT" not in os.environ
        ):
            self._inductor_test_stack.enter_context(
        ...
        if (
            ...
            and os.environ.get("SMITH_COMPILE_DEBUG") != "1"
        ):
