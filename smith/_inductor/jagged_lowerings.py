...
def get_inverse_offsets(
    ...
    # entire tensor
    offsets.realize()
    device: smith.device = offsets.get_device_or_error()
    dtype: smith.dtype = offsets.get_dtype()
...
def register_jagged_ops():
    ...
    # pyre-ignore[56]
    @register_lowering(smith.ops.aten._jagged_to_padded_dense_forward.default)
    def _jagged_to_padded_dense_forward(
        ...
        if (
            ...
            return fallback_handler(
                smith.ops.aten._jagged_to_padded_dense_forward.default,
    ...
    # pyre-ignore[56]
    @register_lowering(smith.ops.aten._padded_dense_to_jagged_forward)
    def _dense_to_jagged_forward(
        ...
        return _dense_to_jagged_forward_impl(
            fallback_op=smith.ops.aten._padded_dense_to_jagged_forward.default,
            dense=dense,
