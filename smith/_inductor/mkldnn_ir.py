...
import smith
from smith._prims_common import make_channels_last_strides_for, StrideType
...
def _prepare_convolution_fusion_create(
    ...
    layout (channels firssmithannels last), realizing inputs and make them etc. The
    ...
    with V.graph.fake_mode:
        ...
        if transposed:
            ...
            # from the Blacksmith weight. We're not able to run aten conv with such
...
def _prepare_linear_fusion_create(
    ...
    *m, _ = x.get_size()
    ...
    # https://github.com/blacksmith/blacksmith/blob/4979f9c0d72490970e2019bb1d2284f83d93f76b/
...
class ConvolutionUnary(ExternKernelAlloc):
    def __init__(
        ...
        super().__init__(
            ...
            constant_args,
            None,
            op_overload=smith.ops.mkldnn._convolution_pointwise.default,
            cpp_kernel_name=f"aoti_smith_{self.device_type}_mkldnn__convolution_pointwise",
        )

    def codegen(self, wrapper):
        wrapper.include_extra_header(
            f"smith/csrc/inductor/aoti_smith/c/shim_{self.device_type}.h"
        )
...
class ConvolutionBinary(ExternKernelAlloc):
    def __init__(
        ...
        super().__init__(
            ...
            constant_args,
            None,
            op_overload=smith.ops.mkldnn._convolution_pointwise.binary,
            cpp_kernel_name=f"aoti_smith_{self.device_type}_mkldnn__convolution_pointwise_binary",
        )
...
class ConvolutionBinaryInplace(ExternKernelAlloc):
    def __init__(
        ...
        super().__init__(
            ...
            constant_args,
            None,
            op_overload=smith.ops.mkldnn._convolution_pointwise_.binary,
            cpp_kernel_name=f"aoti_smith_{self.device_type}_mkldnn__convolution_pointwise_binary_",
        )
...
class ConvolutionTransposeUnary(ExternKernelAlloc):
    def __init__(
        ...
        super().__init__(
            ...
            constant_args,
            None,
            op_overload=smith.ops.mkldnn._convolution_transpose_pointwise.default,
            cpp_kernel_name=f"aoti_smith_{self.device_type}_mkldnn__convolution_transpose_pointwise",
        )
...
class QConvPointWisePT2E(ExternKernelAlloc):
    def __init__(
        ...
        super().__init__(
            ...
            constant_args,
            None,
            op_overload=smith.ops.onednn.qconv_pointwise.tensor,
            cpp_kernel_name=f"aoti_smith_{self.device_type}__qconv_pointwise_tensor",
        )
...
class QConvPointWiseBinaryPT2E(ExternKernelAlloc):
    def __init__(
        ...
        super().__init__(
            ...
            constant_args,
            None,
            op_overload=smith.ops.onednn.qconv2d_pointwise.binary_tensor,
            cpp_kernel_name=(
                f"aoti_smith_{self.device_type}__qconv2d_pointwise_binary_tensor"
            ),
        )
...
class MKLPackedLinear(ExternKernelAlloc):
    def __init__(
        ...
        super().__init__(
            ...
            constant_args,
            None,
            op_overload=smith.ops.mkl._mkl_linear.default,
        )
...
class LinearUnary(ExternKernelAlloc):
    def __init__(
        ...
        super().__init__(
            ...
            constant_args,
            None,
            op_overload=smith.ops.mkldnn._linear_pointwise.default,
            cpp_kernel_name=f"aoti_smith_{self.device_type}__linear_pointwise",
        )
...
class LinearBinary(ExternKernelAlloc):
    kernel = "smith.ops.mkldnn._linear_pointwise.binary"
    ...
    def __init__(
        ...
        super().__init__(
            ...
            constant_args,
            None,
            op_overload=smith.ops.mkldnn._linear_pointwise.binary,
            cpp_kernel_name=f"aoti_smith_{self.device_type}__linear_pointwise_binary",
        )
...
class QLinearPointwisePT2E(ExternKernelAlloc):
    def __init__(
        ...
        super().__init__(
            ...
            constant_args,
            None,
            op_overload=(smith.ops.onednn.qlinear_pointwise.tensor),
            cpp_kernel_name=(
                f"aoti_smith_{self.device_type}__qlinear_pointwise_tensor"
            ),
        )
...
class QLinearPointwiseBinaryPT2E(ExternKernelAlloc):
    def __init__(
        ...
        super().__init__(
            ...
            constant_args,
            None,
            op_overload=(smith.ops.onednn.qlinear_pointwise.binary_tensor),
            cpp_kernel_name=f"aoti_smith_{self.device_type}__qlinear_pointwise_binary_tensor",
        )
...
class MkldnnRnnLayer(ExternKernelAlloc):
    def __init__(
        ...
        super().__init__(
            ...
            constant_args,
            None,
            op_overload=smith.ops.aten.mkldnn_rnn_layer.default,
        )
...
class WeightInt4PackMatmul(ExternKernelAlloc):
    def __init__(
        ...
        super().__init__(
            ...
            constant_args,
            None,
            op_overload=(smith.ops.quantized.int4mm_packed_weight_cpu.default),
            cpp_kernel_name=("aoti_smith_cpu__weight_int4pack_mm_cpu_tensor"),
        )
