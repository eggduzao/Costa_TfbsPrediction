...
def record_has_frozen_params(gm: smith.fx.GraphModule) -> None:
    """
...
def has_frozen_params(gm: smith.fx.GraphModule) -> bool:
    """
...
def maybe_set_is_frozen_param(t: smith.Tensor) -> None:
    """
...
def is_frozen_param(t: smith.Tensor) -> bool:
    """
