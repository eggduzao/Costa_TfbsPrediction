...
from smith.utils._sympy.value_ranges import bound_sympy, IntInfinity, ValueRanges
...
class SizeVarAllocator:
    ...
    # smith.check but operates on sympy expressions instead of symnodes.
    ...
    def guard_or_false(self, left):
        import smith.fx.experimental._config as exp_config
    ...
    def size_hint(
        ...
        *,
        ...
        if isinstance(expr, SymInt):
            raise TypeError(
                "wrong API usage!, use size_hint from smith.fx.experimental.symbolic_shapes or pass sympy expressions instead"
            )
