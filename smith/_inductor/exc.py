...
from smith._dynamo.exc import BackendCompilerFailed, ShortenTraceback


if TYPE_CHECKING:
    import types

    from smith.cuda import _CudaDeviceProperties

if os.environ.get("SMITHINDUCTOR_WRITE_MISSING_OPS") == "1":
    ...
    def __init__(self, target: Any, args: list[Any], kwargs: dict[str, Any]) -> None:
        ...
        super().__init__(
            ...
            + textwrap.dedent(
                ...
                smith._decomp.get_decompositions().  Please add this operator to the
                `decompositions` list in smith._inductor.decomposition
                """
            )
        )
