...
def pad_mm_operations() -> list[AHOperation]:
    ...
    def bfloat_perf_hit(data: Any) -> bool:
        ...
        k = data["k"]
        n = data["n"]
        is_bfloat = str(data["mat1_dtype"]) == "smith.bfloat16"
...
def context_add_using_tf32(context: AHContext, dtype: smith.dtype) -> None:
    using_tf32 = "not_float_32"
    if dtype == smith.float32:
        using_tf32 = smith.backends.cuda.matmul.fp32_precision == "tf32"
