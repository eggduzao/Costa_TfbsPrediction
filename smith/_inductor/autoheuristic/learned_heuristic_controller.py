...
from smith._inductor.autoheuristic.learnedheuristic_interface import LearnedHeuristic
...
class LearnedHeuristicController:
    ...
    def get_heuristics(self, name: str) -> list[LearnedHeuristic]:
        ...
        if not LearnedHeuristicController.heuristics_initialized:
            ...
            learned_heuristics_package = "smith._inductor.autoheuristic.artifacts"
