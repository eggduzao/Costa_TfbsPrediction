...
class BoundVars:
    ...
    def __init__(self, loop_body: LoopBody) -> None:
        ...
        self._bounds: dict[smith.fx.Node, ValueRanges[Expr]] = {}
    ...
    @cache_on_self
    def get_bounds(self) -> dict[smith.fx.Node, ValueRanges[Expr]]:
    ...
    def masked_subblock(
        self,
        subblock: LoopBodyBlock,
        env: dict[smith.fx.Node, ValueRanges[Expr]],
        mask: Any,
        value: Any,
...
class ValueRangeAnalysis(SymPyValueRangeAnalysis, DefaultHandler):
    ...
    @classmethod
    def index_expr(cls, index: Any, dtype: smith.dtype) -> ValueRanges[Any]:
    ...
    def to_dtype(
        ...
        def cast(x: Any, dtype: smith.dtype) -> sympy.Expr:
