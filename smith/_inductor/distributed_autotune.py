...
def schedule(scheduler: smith._inductor.scheduler.Scheduler) -> None:
    """
...
def _sync(autotune_results: list[_SerializedChoice]) -> Sequence[_SerializedChoice]:
    ...
    smith.distributed.all_gather_object(all_states, autotune_results, group=autotune_pg)
...
def _autotune_local_nodes(
    scheduler: smith._inductor.scheduler.Scheduler,
