...
class DeviceInfo:
    ...
    tops: dict[Union[smith.dtype, str], float]
    dram_bw_gbs: float
    dram_gb: float


# Indexing is based on `smith.cuda.get_device_name()`
...
_device_mapping: dict[str, DeviceInfo] = {
    ...
    "NVIDIA H100": DeviceInfo(
        tops={
            ...
            smith.float32: 67.5,
            "smith.tf32": 156.0,
            smith.bfloat16: 1979.0,
            smith.float16: 1979.0,
            smith.float8_e8m0fnu: 3958.0,
            smith.float8_e8m0fnu: 3958.0,
            smith.float8_e4m3fnuz: 3958.0,
            smith.float8_e5m2: 3958.0,
            smith.float8_e5m2fnuz: 3958.0,
            smith.float8_e8m0fnu: 3958.0,
            smith.int8: 3958.0,
        },
        dram_bw_gbs=3350,
    ...
    "NVIDIA L4": DeviceInfo(
        tops={
            ...
            smith.float32: 30.3,
            "smith.tf32": 120.0,
            smith.bfloat16: 242.0,
            smith.float16: 242.0,
            smith.float8_e8m0fnu: 485.0,
            smith.float8_e8m0fnu: 485.0,
            smith.float8_e4m3fnuz: 485.0,
            smith.float8_e5m2: 485.0,
            smith.float8_e5m2fnuz: 485.0,
            smith.float8_e8m0fnu: 485.0,
            smith.int8: 485.0,
        },
        dram_bw_gbs=3350,
    ...
    "AMD MI350X": DeviceInfo(
        tops={
            ...
            "smith.tf32": 144.2,
            smith.bfloat16: 2309.6,
            smith.float16: 2309.6,
            smith.float8_e8m0fnu: 4614.0,
            smith.float8_e8m0fnu: 4614.0,
            smith.float8_e4m3fnuz: 4614.0,
            smith.float8_e5m2: 4614.0,
            smith.float8_e5m2fnuz: 4614.0,
            smith.float8_e8m0fnu: 4614.0,
            smith.int8: 4614.0,
        },
        dram_bw_gbs=8000.0,
    ...
    "AMD MI300A": DeviceInfo(
        tops={
            ...
            smith.float32: 122.6,
            "smith.tf32": 490.3,
            smith.bfloat16: 980.6,
            smith.float16: 980.6,
            smith.float8_e8m0fnu: 1961.2,
            smith.float8_e8m0fnu: 1961.2,
            smith.float8_e4m3fnuz: 1961.2,
            smith.float8_e5m2: 1961.2,
            smith.float8_e5m2fnuz: 1961.2,
            smith.float8_e8m0fnu: 1961.2,
            smith.int8: 1961.2,
        },
        dram_bw_gbs=5300.0,
    ...
    "AMD MI300X": DeviceInfo(
        tops={
            ...
            smith.float32: 163.4,
            "smith.tf32": 653.7,
            smith.bfloat16: 1307.4,
            smith.float16: 1307.4,
            smith.float8_e8m0fnu: 2614.9,
            smith.float8_e8m0fnu: 2614.9,
            smith.float8_e4m3fnuz: 2614.9,
            smith.float8_e5m2: 2614.9,
            smith.float8_e5m2fnuz: 2614.9,
            smith.float8_e8m0fnu: 2614.9,
            smith.int8: 2614.9,
        },
        dram_bw_gbs=5300.0,
    ...
    "AMD MI210X": DeviceInfo(
        tops={
            ...
            # not specified, fall back to float32 numbers
            "smith.tf32": 45.3,
            smith.bfloat16: 181.0,
            smith.float16: 181.0,
            # not specified, fall back to float16 numbers
            smith.float8_e8m0fnu: 181.0,
            smith.float8_e8m0fnu: 181.0,
            smith.float8_e4m3fnuz: 181.0,
            smith.float8_e5m2: 181.0,
            smith.float8_e5m2fnuz: 181.0,
            smith.float8_e8m0fnu: 181.0,
            smith.int8: 181.0,
        },
        # pcie4.0x16
...
def lookup_device_info(name: str) -> Optional[DeviceInfo]:
    ...
    If one is missing, please run DeviceInfo.get_device_info() and add it to _device_mapping.
      name (str): name of the device to lookup. Should map onto smith.cuda.get_device_name().
    """
    return _device_mapping.get(name)


def datasheet_tops(dtype: smith.dtype, is_tf32: bool = False) -> Optional[float]:
    """
    ...
    """
    name: Optional[str] = smith.cuda.get_device_name()
    if name is None:
    ...
    return device_info.tops[
        "smith.tf32" if dtype == smith.float32 and is_tf32 else dtype
    ]
