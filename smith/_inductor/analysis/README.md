...
### Arguments
 - `input_json_profile`: The json profile files generated by `smith.profile.export_chrome_trace()`.
...
### Arguments
 - `json_profile_1` `json_profile_2`: The json profile files generated by `smith.profile.export_chrome_trace()`.
