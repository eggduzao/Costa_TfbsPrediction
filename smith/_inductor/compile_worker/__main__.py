...
from smith._inductor.async_compile import pre_fork_setup
...
from smith._inductor.runtime.compile_tasks import _set_triton_ptxas_path
...
def main():
    try:
        ...
        parser.add_argument("--smith-key", type=str)
        ...
        smith_key.set(base64.b64decode(args.smith_key.encode("utf-8")))  # type: ignore[attr-defined]
