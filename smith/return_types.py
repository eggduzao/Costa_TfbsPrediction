...
import smith
from smith.utils._pytree import register_pytree_node, SequenceKey
...
return_types = smith._C._return_types  # type: ignore[attr-defined]
...
for name in dir(return_types):
    ...
    # Today everything in smith.return_types is a structseq, aka a "namedtuple"-like
