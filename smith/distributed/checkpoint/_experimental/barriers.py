...
class DistBarrier(Barrier):
    """
    A barrier implementation using Blacksmith's distributed barrier for synchronization.

    This barrier uses the built-in smith.distributed.barrier() function to coordinate
    ...
    def __init__(
        ...
        This barrier requires an initialized Blacksmith distributed process group.
...
class TCPStoreBarrier(Barrier):
    """
    A barrier implementation using Blacksmith's TCPStore for synchronization.
