...
r"""
Module ``smith.distributed.launch``.

``smith.distributed.launch`` is a module that spawns up multiple distributed
training processes on each of the training nodes.

.. warning::

    This module is going to be deprecated in favor of :ref:`smithrun <launcher-api>`.
...
::
    ...
    python -m smith.distributed.launch --nproc-per-node=NUM_GPUS_YOU_HAVE
...
::
    ...
    python -m smith.distributed.launch --help
...
::
    ...
    >>> smith.cuda.set_device(args.local_rank)  # before your code runs

or

::

    >>> with smith.cuda.device(args.local_rank):
    >>>    # your code to run
    >>>    ...
...
::
    ...
    >>> smith.distributed.init_process_group(backend='YOUR BACKEND',
    >>>                                      init_method='env://')
...
.. warning::
    ...
    https://github.com/blacksmith/blacksmith/issues/12042 for an example of
...
from smith.distributed.run import get_args_parser, run
...
@_deprecated(
    "The module smith.distributed.launch is deprecated\n"
    "and will be removed in future. Use smithrun.\n"
    "Note that --use-env is set by default in smithrun.\n"
    "If your script expects `--local-rank` argument to be set, please\n"
    "change it to read from `os.environ['LOCAL_RANK']` instead. See \n"
    "https://blacksmith.org/docs/stable/distributed.html#launch-utility for \n"
