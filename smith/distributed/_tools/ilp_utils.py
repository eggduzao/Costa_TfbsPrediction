...
import smith
from smith.distributed._tools.mem_tracker import (
    _MemRefType,
    _ModMemStats,
    _ModState,
    MemTracker,
...
from smith.distributed._tools.sac_estimator import SACEstimator, SACTradeOffStats
...
def aggregate_stats(
    ...
    # Memory stats
    mod_mem_stats: dict[smith.nn.Module, _ModMemStats] = dict(
