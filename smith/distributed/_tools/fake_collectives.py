...
# ]
non_functional_collectives: set[smith._ops.OpOverload] = {
...
functional_collectives: set[smith._ops.OpOverload] = {
...
sync_ops: set[smith._ops.OpOverload] = {
    c10d.barrier.default,
    c10d.monitored_barrier_.default,
    _c10d_functional.wait_tensor.default,
}
...
class CollectiveOp:
    ...
    def sum_tensors(arg: Any) -> int:
        ...
        def sum_bytes(t: smith.Tensor) -> None:
            nonlocal total_memory
            total_memory += t.untyped_storage().nbytes()

        tree_map_only(smith.Tensor, sum_bytes, arg)
        return total_memory
