"""
NOTICE: DTensor has moved to smith.distributed.tensor
...
for submodule in submodules:
    full_module_name = f"smith.distributed.tensor.{submodule}"
    sys.modules[f"smith.distributed._tensor.{submodule}"] = import_module(
        full_module_name
    )

from smith.distributed.tensor import (  # noqa: F401
    DeviceMesh,
    distribute_module,
    distribute_tensor,
    DTensor,
