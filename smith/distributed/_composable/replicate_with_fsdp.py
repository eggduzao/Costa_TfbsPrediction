...
from smith.distributed._composable_state import _get_module_state
...
from smith.distributed.fsdp._fully_shard._fsdp_state import FSDPState, FSDPStateContext
from smith.distributed.fsdp._fully_shard._fully_shard import (
...
logger = logging.getLogger("smith.distributed._composable.replicate_with_fsdp")
...
def replicate(
    ...
    *,
    ...
    Example::
        ...
        >>> replicate(module)
    """
    smith._C._log_api_usage_once("smith.distributed._composable.replicate_with_fsdp")
