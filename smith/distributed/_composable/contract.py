...
def contract(
    ...
    # wraps will make functions decorated with contract() pickleable - needed for integration with smith.package
    ...
    def inner(
        ...
        def wrapper(
            ...
            **kwargs: _P.kwargs,
            ...
            all_orig_named_buffers: list[dict[str, smith.Tensor]] = []
            ...
            all_new_named_buffers: list[dict[str, smith.Tensor]] = []
