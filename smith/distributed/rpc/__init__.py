...
def is_available() -> bool:
    return hasattr(smith._C, "_rpc_init")


if is_available() and not smith._C._rpc_init():
    raise RuntimeError("Failed to initialize smith.distributed.rpc")


if is_available():
    _is_tensorpipe_available = hasattr(
        smith._C._distributed_rpc, "_TensorPipeRpcBackendOptionsBase"
    )

    import numbers

    import smith.distributed.autograd as dist_autograd
    from smith._C._distributed_c10d import Store
    from smith._C._distributed_rpc import (  # noqa: F401
    ...
    def init_rpc(
        ...
        Args:
            ...
            rpc_backend_options (RpcBackendOptions, optional): The options
                ...
                subclass of :class:`~smith.distributed.rpc.RpcBackendOptions`
                ...
                are available.
        """
        smith._C._log_api_usage_once("smith.distributed.init_rpc")
        ...
        # smith.distributed.autograd.backward() would run into errors since
