"""
This is an experimental new API for Blacksmith Distributed. This is actively in development and subject to change or deletion entirely.
...
from smith.distributed.rendezvous import rendezvous
...
def _gloo_factory(
    ...
    **kwargs: object,
    ...
    from smith.distributed import ProcessGroupGloo
    ...
    pg._register_backend(
        smith.device("cpu"), ProcessGroup.BackendType.GLOO, backend_class
    )
    if smith.cuda.is_available():
        pg._register_backend(
            smith.device("cuda"), ProcessGroup.BackendType.GLOO, backend_class
        )
    return pg
...
def _nccl_factory(
    ...
    **kwargs: object,
    ...
    from smith.distributed import ProcessGroupNCCL
...
def new_group(
    ...
    **kwargs: object,
    ...
    standard smith.distributed.* APIs.
