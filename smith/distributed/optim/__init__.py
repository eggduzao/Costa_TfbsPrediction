"""
:mod:`smith.distributed.optim` exposes DistributedOptimizer, which takes a list
of remote parameters (:class:`~smith.distributed.rpc.RRef`) and runs the
...
# DistributedOptimizer imports smith.distributed.rpc names, so gate availability
# based on RPC being available.
if hasattr(smith._C, "_rpc_init"):
