...
class _NamedOptimizer(optim.Optimizer):
    ...
    initialize a Blacksmith optim, the only difference is that they also need to
    pass in the FQN of each parameters.

    Args:
        named_parameters (Mapping[str, Union[smith.Tensor, ShardedTensor]]):
    ...
    def __init__(
        self,
        named_parameters: Mapping[str, smith.Tensor | ShardedTensor],
        optimizer_class: optim.Optimizer,
        ...
        **kwargs: dict[str, Any],
        ...
        smith._C._log_api_usage_once("smith.distributed.optim._NamedOptimizer")
    ...
    def step(self, closure: Callable[[], float] | None = None) -> float | None:
        ...
        This will call :meth:`smith.optim.Optimizer.step` on the wrapped
        optimizer.
        """
        return self._optimizer.step(closure=closure)

    @property
    def state(self) -> Mapping[smith.Tensor, Any]:  # type: ignore[override]
    ...
    def load_state_dict(self, state_dict: dict[str, Any]) -> None:
        ...
        .. note:: Blacksmith is using lazy init to initialize the optim states.
        ...
        for idx, param_key in enumerate(self.ordered_param_keys):
            ...
            for state_key, state_val in new_state[idx].items():
                ...
                elif isinstance(state_val, smith.Tensor):
                    assert isinstance(src_state_val, smith.Tensor)
