...
import smith
from smith.distributed.algorithms.join import Joinable, JoinHook
...
class ZeroRedundancyOptimizer(Optimizer, Joinable):
    ...
    optim: Any = ...
    _device_to_device_index: dict[smith.device, int] = ...
    _overlap_with_ddp: bool = ...
    _overlap_info: _OverlapInfo = ...
    _buckets: list[list[smith.Tensor]] = ...
