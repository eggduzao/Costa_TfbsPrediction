...
from smith._C._distributed_c10d import _DEFAULT_PG_TIMEOUT
...
# (only if SMITH_NCCL_BLOCKING_WAIT or SMITH_NCCL_ASYNC_ERROR_HANDLING is set to 1).

try:
    from smith._C._distributed_c10d import _DEFAULT_PG_NCCL_TIMEOUT
