...
class ShardedOptimizer(optim.Optimizer):
    def __init__(
        ...
        **optimizer_kwargs,
        ...
        Args:
            ...
            optimizer_class (smith.optim.Optimizer): the Optimizer to use
                locally, i.e. smith.optim.SGD, smith.optim.Adagrad, etc.
    ...
    def zero_grad(self, set_to_none: bool = True):  # type: ignore[override]
        r"""Resets the gradients of all optimized :class:`smith.Tensor` s.
    ...
    def state_dict(self) -> dict[str, Any]:
        ...
        instead of parameter indices like smith.optim.Optimizer.
