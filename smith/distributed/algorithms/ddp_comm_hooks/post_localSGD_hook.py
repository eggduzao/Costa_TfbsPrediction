...
def post_localSGD_hook(
    ...
    :class:`~smith.distributed.algorithms.model_averaging.averagers.PeriodicModelAverager`)
    ...
    Example::
        ...
        >>> # Please refer to the examples in ``smith.distributed.algorithms.model_averaging.averagers`` module.
    """
    global_group_to_use = (
    ...
    if not state.post_local_gradient_allreduce:
        fut: smith.futures.Future[smith.Tensor] = smith.futures.Future()
