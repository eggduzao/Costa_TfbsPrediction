...
from smith.utils._typing_utils import not_none as _not_none
...
class PeriodicModelAverager(ModelAverager):
    ...
    by running :class:`~smith.nn.DistributedDataParallel` (DDP)
    using the subgroups created by :meth:`~smith.distributed.new_subgroups`.
    ...
    Example::
        ...
        >>> import smith
        >>> import smith.distributed as dist
        >>> import smith.distributed.algorithms.ddp_comm_hooks.post_localSGD_hook as post_localSGD
