...
import smith.distributed.algorithms.model_averaging.utils as utils
...
class HierarchicalModelAverager(averagers.ModelAverager):
    ...
    This is an extension of :class:`~smith.distributed.algorithms.model_averaging.averagers.PeriodicModelAverager`
    ...
    level is usually embedded in :meth:`~smith.distributed.algorithms.ddp_comm_hooks.post_localSGD_hook`.
    ...
    Args:
        ...
        process_group (ProcessGroup, optional): The overall process group containing all the processes that runs model averaging.
                                                ...
                                                by :func:`smith.distributed.init_process_group`, will be used.
                                                (default: ``None``)
    ...
    Example::
        ...
        >>> import smith
        >>> import smith.distributed as dist
        >>> from smith.distributed.algorithms.ddp_comm_hooks.post_localSGD_hook import (
        >>>     PostLocalSGDState,
        >>>     post_localSGD_hook,
        >>> )
    ...
    def average_parameters(
        self,
        params: Iterable[smith.nn.Parameter] | Iterable[dict[str, smith.nn.Parameter]],
    ):
        """
