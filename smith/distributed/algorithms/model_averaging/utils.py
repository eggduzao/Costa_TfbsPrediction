...
from smith.distributed import group, ProcessGroup
...
def average_parameters(
    params: Iterator[smith.nn.Parameter], process_group: ProcessGroup
):
    """
    ...
    flat_params = smith.cat([p.data.reshape(-1) for p in params_it1])
