...
class _remote_device:
    ...
    Args:
        remote_device (str or smith.device): Represents a device on a remote worker.
            The string format should be one of the following:

                1. "<workername>/<device>", where the device field can be parsed as smith.device type.
                   E.g., "trainer0/cpu", "trainer0", "ps0/cuda:0".
                   In addition, the device field can be optional and the default value is "cpu".
                2. "rank:<rank>/<device>", where <rank> is the rank of the
                   process and device can be parsed as smith.device type.
    ...
    def __init__(self, remote_device: str | smith.device):
        PARSE_ERROR = (
        ...
        self._rank = None
        self._device: str | int | smith.device | None = None

        if isinstance(remote_device, smith.device):
        ...
        # Validate the device.
        self._device = smith.device(self._device)
