...
from smith.distributed import FileStore, Store, TCPStore
from smith.distributed.elastic.events import construct_and_record_rdzv_event, NodeState
...
class C10dRendezvousBackend(RendezvousBackend):
    ...
    Args:
        store:
            The :py:class:`smith.distributed.Store` instance to use to
    ...
    def __init__(self, store: Store, run_id: str) -> None:
        ...
        self._key = "smith.rendezvous." + run_id
...
def create_backend(params: RendezvousParameters) -> tuple[C10dRendezvousBackend, Store]:
    ...
    |              | :py:class:`smith.distributed.TCPStore` and                |
    |              | :py:class:`smith.distributed.FileStore`, respectively.    |
    |              | Defaults to "tcp".                                        |
    +--------------+-----------------------------------------------------------+
    ...
    |              | :py:class:`smith.distributed.TCPStore`. It is not relevant|
    |              | to :py:class:`smith.distributed.FileStore` which does not |
    ...
    |              | :py:class:`smith.distributed.TCPStore`. In normal         |
