...
def _register_out_of_tree_handlers() -> None:
    discovered_handler_generators = entry_points(group="smithrun.handlers")
...
def get_rendezvous_handler(params: RendezvousParameters) -> RendezvousHandler:
    ...
    ::
      ...
      from smith.distributed.elastic.rendezvous import rendezvous_handler_registry
      from smith.distributed.elastic.rendezvous.registry import get_rendezvous_handler
