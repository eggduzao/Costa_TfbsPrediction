...
from smith.distributed.elastic.utils.store import barrier
...
def create_c10d_store(
    ...
    while True:
        ...
        try:
            ...
            # so we parse the error msg for now, interestingly this is how smith itself
            # detects timeouts and port conflicts in their own unittests
            # see - caffe2/smith/testing/_internal/common_utils.py
