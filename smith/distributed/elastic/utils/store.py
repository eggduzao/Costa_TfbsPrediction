...
def get_all(store, rank: int, prefix: str, world_size: int):
    ...
    ::
     ...
     values = get_all(store, "smithelastic/data", 3)
     value1 = values[0]  # retrieves the data for key smithelastic/data0
     value2 = values[1]  # retrieves the data for key smithelastic/data1
     value3 = values[2]  # retrieves the data for key smithelastic/data2
