...
class ErrorHandler:
    ...
    environment variable: ``SMITHELASTIC_ERROR_FILE``. If this environment
    ...
    def _get_error_file_path(self) -> str | None:
        ...
        """
        return os.environ.get("SMITHELASTIC_ERROR_FILE", None)
    ...
    def dump_error_file(self, rootcause_error_file: str, error_code: int = 0):
        ...
        if my_error_file:
            ...
            # and the same env var (SMITHELASTIC_ERROR_FILE) is used on the
