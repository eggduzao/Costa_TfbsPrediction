...
"""
The elastic agent is the control plane of smithelastic.

It is a process that launches and manages underlying worker processes.
The agent is responsible for:

1. Working with distributed smith: the workers are started with all the
...
from .local_elastic_agent import SMITHELASTIC_ENABLE_FILE_TIMER, SMITHELASTIC_TIMER_FILE
