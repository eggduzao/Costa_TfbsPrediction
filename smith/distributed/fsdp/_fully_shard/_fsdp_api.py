...
class MixedPrecisionPolicy:
    ...
    Attributes:
        param_dtype (Optional[smith.dtype]): This specifies the dtype for
        ...
        reduce_dtype (Optional[smith.dtype]): This specifies the dtype for
            ...
            (Default: ``None``)
        output_dtype (Optional[smith.dtype]): This specifies the dtype for
...
class Comm(ABC):
    ...
    def allocate(
        ...
        *,
        ...
        Args:
            size (Sequence[Union[int, smith.SymInt]]): size of the tensor buffer
            dtype (smith.dtype): dtype of the tensor buffer
            device (smith.device): which device to allocate the tensor onto
        """
        ...
