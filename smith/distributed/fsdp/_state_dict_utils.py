...
import smith.distributed.algorithms._checkpoint.checkpoint_wrapper as checkpoint_wrapper
...
from smith.distributed.utils import _replace_by_prefix
...
def _local_pre_state_dict_hook(
    ...
    **kwargs,
    ...
    hook is not supported by the Blacksmith core. So this API is called from
...
def _local_post_state_dict_hook(
    ...
    if valid_data_size > 0:
        ...
        # pickling issue (can be smith.save but not smith.load). Since there
...
def _sharded_pre_load_state_dict_hook(
    ...
    for fqn, _, _ in _param_name_infos(module, fsdp_state):
        ...
        try:
            ...
            # cases: https://github.com/blacksmith/blacksmith/issues/109134
    ...
    *args: Any,
    ...
    if fsdp_state._is_root:
        ...
        for key, tensor in sorted(processed_state_dict.items()):
            if key.startswith(prefix) and isinstance(tensor, smith.Tensor):
