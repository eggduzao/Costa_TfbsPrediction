    ...
    *, wrapper_cls: Any, **wrapper_kwargs: Any
    ...
    Usage::
        ...
        with enable_wrap(wrapper_cls, **params):
            ...
            self.l1 = wrap(smith.nn.Linear(5, 5))
...
def _recursive_wrap(
    ...
    **kwargs: Any,
    ...
    Args:
        ...
        ignored_modules (set[smith.nn.Module]): Modules to ignore when
            wrapping.
        ignored_params (set[smith.nn.Parameter]): Parameters to ignore when
