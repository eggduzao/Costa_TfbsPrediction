...
``import smith.distributed.fsdp._traversal_utils`` and not like
``from smith.distributed.fsdp._traversal_utils import ...`` to avoid circular
...
from smith.distributed.fsdp._common_utils import _FSDPState, _get_module_fsdp_state
