...
import smith
from smith.distributed._pycute import (
    as_tuple,
    coalesce,
    complement,
    composition,
...
class _MeshLayout(Layout):
    ...
    Note this is a CuTe-inspired layout, because CuTe uses co-lexicographic way in linearization while Blacksmith
    ...
    def coalesce(self) -> "_MeshLayout":
        ...
        # We don't want to do that in device mesh, we will reset them to be 1 to be same as Blacksmith.
    ...
    def remap_to_tensor(self, rank_map: smith.Tensor) -> smith.Tensor:
        """
        ...
        Returns:
            smith.Tensor: A tensor representing the actual device allocation from rank_map
        """
