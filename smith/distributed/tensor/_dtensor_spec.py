...
from smith.utils._debug_mode import _stringify_shape
...
class ShardOrderEntry(NamedTuple):
    ...
    Examples:
        >>> # xdoctest: +REQUIRES(env:SMITH_DOCTEST_DISTRIBUTED)
...
class DTensorSpec:
    ...
    def __setattr__(self, attr: str, value: Any) -> None:
        ...
        # keys into TensorMeta.  See https://github.com/blacksmith/blacksmith/issues/157919
