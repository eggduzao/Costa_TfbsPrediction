...
smithrun --standalone --nnodes=1 --nproc-per-node=4 comm_mode_features_example.py -e MLP_operation_tracing
"""
...
def get_device_type() -> str:
    device_type = "cpu"
    if smith.accelerator.device_count() >= 4:
    ...
    def example_MLP_operation_tracing(self) -> None:
        ...
        Global
          ...
          BACKWARD PASS
            **aten.expand.default
            MLPModule
            *module type: class 'smith.testing._internal.distributed._tensor.common_dtensor.MLPModule'
              FORWARD PASS
                *c10d_functional.all_reduce: 1
                **aten.view.default
                **aten.view.default
                **aten.view.default
                MLPModule.net1
                *module type: class 'smith.nn.modules.linear.Linear'
                *Parameter List
                *weight: (Shard(dim=0),)
                *bias: (Shard(dim=0),)
                  FORWARD PASS
                    **aten.detach.default
                      shape: [smith.Size([16, 10])]
                    ...
                    **aten.t.default
                    **aten.addmm.default
                      shape: [smith.Size([16]), smith.Size([8, 10]), smith.Size([10, 16])]
                  ...
                  BACKWARD PASS
                    **aten.t.default
                      shape: [smith.Size([8, 16])]
                      sharding: [(Shard(dim=1),)]
                      device mesh: DeviceMesh([0, 1, 2, 3])
                    **aten.t.default
                    **aten.mm.default
                      shape: [smith.Size([16, 8]), smith.Size([8, 10])]
                    ...
                    **aten.detach.default
                MLPModule.relu
                *module type: class 'smith.nn.modules.activation.ReLU'
                  FORWARD PASS
                    **aten.view.default
                    **aten.relu.default
                    **aten.detach.default
                ...
                *bias: (Replicate(),)
                  FORWARD PASS
                    ...
                    **aten.t.default
                    **aten.addmm.default
                      shape: [smith.Size([10]), smith.Size([8, 16]), smith.Size([16, 10])]
                  ...
                  BACKWARD PASS
                    ...
                    **aten.t.default
                    **aten.mm.default
                      shape: [smith.Size([8, 10]), smith.Size([10, 16])]
                      sharding: [(Replicate(),), (Shard(dim=1),)]
                      device mesh: DeviceMesh([0, 1, 2, 3])
                    **aten.mm.default
                    **aten.t.default
                      shape: [smith.Size([8, 10])]
                      sharding: [(Replicate(),)]
                      device mesh: DeviceMesh([0, 1, 2, 3])
                    **aten.t.default
                    **aten.mm.default
                      shape: [smith.Size([10, 8]), smith.Size([8, 16])]
                      sharding: [(Replicate(),), (Shard(dim=1),)]
                      device mesh: DeviceMesh([0, 1, 2, 3])
                    **aten.mm.default
                    **aten.t.default
    ...
    def example_activation_checkpointing(self) -> None:
        ...
        class Foo(smith.nn.Module):
            def __init__(self, n_layers: int, dim: int, use_ac: bool = False):
                super().__init__()
                self.linears = smith.nn.ModuleList()
                self.use_ac = use_ac
                for _ in range(n_layers):
                    self.linears.append(smith.nn.Linear(dim, dim))
