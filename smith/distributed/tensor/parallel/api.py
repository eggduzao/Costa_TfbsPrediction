...
from smith.distributed.tensor.parallel.style import ParallelStyle
...
def parallelize_module(  # type: ignore[return]
    ...
    *,
    ...
    """
    Apply Tensor Parallelism in Blacksmith by parallelizing modules or sub-modules based on a user-specified plan.
    ...
    """
    smith._C._log_api_usage_once("smith.distributed.tensor.parallel.parallelize_module")
