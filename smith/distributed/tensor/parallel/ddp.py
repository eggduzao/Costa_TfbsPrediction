...
def _pre_dp_module_transform(module: nn.Module):
    ...
    Parallelism(DP) in Blacksmith when using DDP. We need to convert Parameters which
    ...
    Example::
        ...
        >>> from smith.distributed.tensor.parallel import parallelize_module, PairwiseParallel
        >>> from smith.nn.parallel import DistributedDataParallel as DDP
        >>> from smith.distributed.tensor.parallel.ddp import pre_dp_module_transform
        >>>
        >>> # Define the module.
        >>> m = module(...)
