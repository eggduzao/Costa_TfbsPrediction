...
from smith.distributed.tensor._collective_utils import one_step_redistribute_cost
...
from smith.distributed.tensor._utils import assert_no_mixed_partial_types
...
def redistribute_local_tensor(
    ...
    *,
    ...
    """
    This redistribute the local tensor (smith.Tensor) from the current DTensorSpec to
...
class Redistribute(smith.autograd.Function):
    @staticmethod
