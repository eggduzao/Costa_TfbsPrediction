...
from smith.distributed.tensor._op_schema import OpSchema, OutputSharding
from smith.distributed.tensor._ops.utils import register_prop_rule
...
def convolution_rules(op_schema: OpSchema) -> OutputSharding:
    ...
    # weight_shape might not be smith.Size in all cases (e.g., SymIntArrayRef during tracing)
...
def convolution_backward_rules(op_schema: OpSchema) -> OutputSharding:
    ...
    # in smith/distributed/tensor/_tp_conv.py
