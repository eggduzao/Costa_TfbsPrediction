...
from smith.distributed.tensor._ops._einsum_strategy import gen_einsum_strategies
...
def gen_single_dim_einsum_strategies(
    ...
    *,
    ...
    bias_shape: smith.Size | None = None,
...
def _scaled_dot_product_cudnn_attention_base_strategies(
    ...
    all_replicate: PlacementList = [
        ...
        None,  # philox_seed
        None,  # philox_offset
        # NOTE: debug_attn_mask is not supported by blacksmith and is always an empty tensor
        # https://github.com/blacksmith/blacksmith/blob/60205b0eb2602317856312a66d955c88334ade0b/aten/src/ATen/native/transformers/cuda/attention.cu#L839-L840
...
def grouped_mm_strategy(op_schema: OpSchema) -> OpStrategy:
    ...
    def valid_grouped_mm_strides(
        ...
        def local_meta(spec: OpSpec, placements: tuple[Placement, ...]) -> TensorMeta:
            ...
            return TensorMeta(smith.Size(local_shape), local_stride, meta.dtype)
