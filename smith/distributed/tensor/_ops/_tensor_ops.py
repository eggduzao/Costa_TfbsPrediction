...
from smith._prims_common import IntLike
...
from smith.distributed.tensor._ops._common_rules import pointwise_rule
...
def prop_index(op_schema: OpSchema) -> OutputSharding:
    ...
    TODO: exception: when the dtype of second input is "bool", then a smith.nonzero needs to be triggered first.
    """
