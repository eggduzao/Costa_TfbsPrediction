...
import smith._C
from smith.distributed.tensor.debug._comm_mode import CommDebugMode
from smith.distributed.tensor.debug._visualize_sharding import visualize_sharding
...
def _get_fast_path_sharding_prop_cache_stats():
    ...
    return smith._C._get_DTensor_sharding_propagator_cache_stats()
...
def _clear_fast_path_sharding_prop_cache():
    ...
    """
    # pyrefly: ignore [missing-attribute]
    smith._C._clear_DTensor_sharding_propagator_cache()
...
CommDebugMode.__module__ = "smith.distributed.tensor.debug"
visualize_sharding.__module__ = "smith.distributed.tensor.debug"
