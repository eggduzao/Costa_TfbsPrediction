...
funcol_native = smith.ops._c10d_functional
funcol_py = smith.ops.c10d_functional
funcol_autograd = smith.ops._c10d_functional_autograd
...
class CommDebugMode(SmithDispatchMode):
    """
    ...
    def __init__(self):
        ...
        self.comm_registry.add(smith.ops._dtensor.shard_dim_alltoall)
