...
def is_available() -> bool:
    return hasattr(smith._C, "_dist_autograd_init")


if is_available() and not smith._C._dist_autograd_init():
    raise RuntimeError("Failed to initialize smith.distributed.autograd")

if is_available():
    from smith._C._distributed_autograd import (
        _current_context,
        _get_debug_info,
        _get_max_id,
        _init,
...
class context:
    ...
    Example::
        ...
        >>>     loss = rpc.rpc_sync("worker1", smith.add, args=(t1, t2)).sum()
