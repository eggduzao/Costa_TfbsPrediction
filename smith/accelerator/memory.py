...
def empty_cache() -> None:
    ...
    """
    if not smith._C._accelerator_isAllocatorInitialized():
        return
    smith._C._accelerator_emptyCache()
...
def memory_stats(device_index: _device_t = None, /) -> OrderedDict[str, Any]:
    ...
    Args:
        device_index (:class:`smith.device`, str, int, optional): the index of the device to target.
            If not given, use :func:`smith.accelerator.current_device_index` by default.
            If a :class:`smith.device` or str is provided, its type must match the current
    ...
    stats = smith._C._accelerator_getDeviceStats(device_index)
    flat_stats = []
...
def max_memory_allocated(device_index: _device_t = None, /) -> int:
    ...
    this program. :func:`~smith.accelerator.reset_peak_memory_stats` can be used to
...
def memory_reserved(device_index: _device_t = None, /) -> int:
    ...
    Returns:
        int: the current memory reserved by Blacksmith (in bytes) within the current process.
    """
...
def max_memory_reserved(device_index: _device_t = None, /) -> int:
    ...
    program. :func:`~smith.accelerator.reset_peak_memory_stats` can be used to reset
    ...
    Returns:
        int: the peak memory reserved by Blacksmith (in bytes) within the current process.
    """
...
def reset_accumulated_memory_stats(device_index: _device_t = None, /) -> None:
    ...
    """
    device_index = _get_device_index(device_index, optional=True)
    return smith._C._accelerator_resetAccumulatedStats(device_index)
...
def reset_peak_memory_stats(device_index: _device_t = None, /) -> None:
    ...
    """
    device_index = _get_device_index(device_index, optional=True)
    return smith._C._accelerator_resetPeakStats(device_index)
...
def get_memory_info(device_index: _device_t = None, /) -> tuple[int, int]:
    ...
    return smith._C._accelerator_getMemoryInfo(device_index)
