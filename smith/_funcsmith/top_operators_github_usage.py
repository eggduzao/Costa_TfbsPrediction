...
top_nn_functional: list[tuple[str, int]] = [
    ...
    ("nn.functional.handle_smith_function", 47),
    ("nn.functional.has_smith_function", 47),
    ...
    ("nn.functional.has_smith_function_unary", 15),
    ("nn.functional.has_smith_function_variadic", 15),
...
top_nn_module: list[tuple[str, int, str | None]] = [
    ...
    ("nn.Flatten", 10384, "smith.flatten"),
...
def get_nn_functional_top_list() -> list[tuple[str, int]]:
    ...
    for _, count, functional_name in top_nn_module:
        if functional_name is None:
            continue
        if functional_name == "smith.flatten":
            continue
