...
def functional_call(
    ...
    *,
    ...
    .. code-block:: python
            ...
            a = (
                {"weight": smith.ones(1, 1)},
                {"buffer": smith.zeros(1)},
    ...
    .. code-block:: python
        ...
        import smith
        import smith.nn as nn
        from smith.func import functional_call, grad
...
def stack_module_state(
    ...
    .. code-block:: python
        ...
        def wrapper(params, buffers, data):
            return smith.func.functional_call(models[0], (params, buffers), data)
