...
ENV_VAR_PARALLEL_START = "SMITH_MP_PARALLEL_START"
...
def start_processes(
    ...
    # To speed up performance in certain cases (see https://github.com/blacksmith/blacksmith/issues/133010),
    # this func will start processes in parallel if start_method is 'forkserver'.
    # Please opt in to this perf optimization by setting env var (SMITH_MP_PARALLEL_START) to 1.
    ...
    if (
        ...
        # Set env var SMITH_MP_PARALLEL_START to 0 to disable parallel start
    ...
    def start_process(i):
        ...
        tf = tempfile.NamedTemporaryFile(  # noqa: SIM115
            prefix="blacksmith-errorfile-", suffix=".pickle", delete=False
        )
        tf.close()
        os.unlink(tf.name)
...
def spawn(fn, args=(), nprocs=1, join=True, daemon=False, start_method="spawn"):
    ...
    if start_method != "spawn":
        msg = (
            ...
            " smith.multiprocessing.start_processes(...)"
        )
