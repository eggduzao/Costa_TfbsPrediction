# Defined in smith/csrc/export/pt2_archive_constants.h
from smith._C._export import pt2_archive_constants
...
EXECUSMITH_DIR: str = pt2_archive_constants.EXECUSMITH_DIR
