...
PRESERVED_ATEN_CIA_OPS = {
    ...
    smith.ops.aten.mish_backward.default,
    smith.ops.aten._fused_rms_norm.default,
}


class CustomDecompTable(dict[smith._ops.OperatorBase, Callable]):
    """
    ...
    def __init__(self):
        super().__init__()
        from smith._decomp import _core_aten_decompositions_post_autograd
    ...
    def materialize(self) -> dict[smith._ops.OperatorBase, Callable]:
