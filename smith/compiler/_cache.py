...
from smith.utils._appending_byte_serializer import (
...
class CacheArtifactManager:
    ...
    Intended Lifecycle:
    - Execute code via smith.compile, this will call
    ...
    def _ensure_cache_artifacts_registered(cls) -> None:
        ...
        """
        from smith._dynamo.package import PrecompileCacheArtifact  # noqa: F401
        from smith._dynamo.pgo import PGOCacheArtifact  # noqa: F401
        from smith._funcsmith._aot_autograd.autograd_cache import (  # noqa: F401
            AOTAutogradCacheArtifact,
        )
        from smith._inductor.codecache import InductorCacheArtifact  # noqa: F401
        from smith._inductor.runtime.autotune_cache import (  # noqa: F401
