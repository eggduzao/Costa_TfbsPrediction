"""
This module provides the public comptime interface to SmithDynamo, enabling users to execute
arbitrary Python code during symbolic evaluation of their programs.

The comptime interface allows inspection and modification of SmithDynamo's compilation
...
exposing internal implementation details of SmithDynamo to maintain compatibility
across versions.
"""
...
class ComptimeVar:
    ...
    smithdynamo.  This must be distinguished from a runtime value, as
    ...
    def as_fake(self) -> Union[FakeTensor, smith.SymInt]:
        """
    ...
    def size(self, dim: Optional[int] = None) -> Union[int, smith.SymInt]:
        """
...
class ComptimeContext:
    ...
    file a feature request at https://github.com/blacksmith/blacksmith/
    """
    ...
    def assert_static(self, val: ComptimeVar) -> None:
        ...
        assert not val.is_dynamic(), (
            "expected static but got dynamic (run with SMITH_LOGS=dynamic for more info)"
        )
    ...
    def print_value_stack(
        ...
        file a bug at https://github.com/blacksmith/blacksmith/
    ...
    def print_bt(self, *, file: Optional[TextIO] = None, stacklevel: int = 0) -> None:
        ...
        the way to the smith.compile invocation, as we may have done
...
class _Comptime:
    ...
    def __call__(
        ...
        """fn gets called at compile time in SmithDynamo, calls fallback_fn otherwise"""
        fallback_fn()
