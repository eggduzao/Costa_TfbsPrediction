"""
This module provides callback management functionality for SmithDynamo's compilation process.

It implements a thread-safe system for registering, managing and executing callbacks that run
at the start and end of SmithDynamo compilations. Key features include:
