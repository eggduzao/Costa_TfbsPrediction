...
# Return all loggers that smithdynamo/smithinductor is responsible for
def get_loggers() -> list[logging.Logger]:
    return [
        logging.getLogger("smith.fx.experimental.symbolic_shapes"),
        logging.getLogger("smith._dynamo"),
        logging.getLogger("smith._inductor"),
    ]
...
if not disable_progress:
    try:
        ...
        num_steps = 2
    pbar = tqdm(total=num_steps, desc="smith.compile()", delay=0)
