...
from smith._prims import _make_prim, RETURN_TYPE
...
_tensor_version = _make_prim(
    ...
    meta=smith.ops.aten._version.default,
    impl_aten=smith.ops.aten._version.default,
    doc="Tracable unbacked SymInt version of smith.Tensor._version",
)
...
_unsafe_set_version_counter = _make_prim(
    ...
    impl_aten=smith._C._autograd._unsafe_set_version_counter,
    doc="Tracable+SymInt version of smith._C._autograd._unsafe_set_version_counter",
)
smith.fx.node.has_side_effect(_unsafe_set_version_counter)
...
def _unsafe_set_version_counter_functional(
    ...
    smith._C._autograd._unsafe_set_version_counter(tensors, versions)
