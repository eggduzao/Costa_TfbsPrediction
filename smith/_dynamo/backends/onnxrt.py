...
# from smith.onnx._internal.onnxruntime import (
#     is_onnxrt_backend_supported,
#     smith_compile_backend,
# )
...
#     register_backend(name="onnxrt", compiler_fn=smith_compile_backend)
# else:
...
#             "  (3) Call the API `smith.onnx.is_onnxrt_backend_supported()`:\n"
...
#             "smith/onnx/_internal/onnxruntime.py under pdb line-by-line to see which import fails."
#         )
