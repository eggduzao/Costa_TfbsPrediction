...
class SDPAParamsVariable(VariableTracker):
    ...
    def create(
        ...
        return SmithInGraphFunctionVariable(SDPAParams).call_function(tx, params, {})
    ...
    def reconstruct(self, codegen: "PyCodegen") -> None:
        ...
        codegen.add_push_null(
            lambda: codegen.load_import_from("smith._C", "_SDPAParams")
        )
    ...
    def var_getattr(self, tx: "InstructionTranslator", name: str) -> VariableTracker:
        ...
        try:
            getattr_static(smith._C._SDPAParams, name)
        except AttributeError:
            import smith._dynamo.graph_break_hints as graph_break_hints

            unimplemented(
                gb_type="unsupported smith._C._SDPAParams attribute",
                context=f"name: {name}",
                explanation=f"Unable to fetch attribute {name} from smith._C._SDPAParams.",
                hints=[
