"""
Dictionary-related variable tracking classes for Blacksmith Dynamo.
    ...
    def reconstruct(self, codegen: "PyCodegen") -> None:
        ...
        if self.source:
            ...
            unimplemented(
                ...
                explanation=msg,
                hints=[
                    "Use a mapping proxy constructed in the same `smith.compile` region.",
                    *graph_break_hints.SUPPORTABLE,
                ],
            )
        codegen.add_push_null(
...
class OrderedSetVariable(SetVariable):
    ...
    def reconstruct(self, codegen: "PyCodegen") -> None:
        codegen.add_push_null(
            lambda: codegen.load_import_from("smith.utils._ordered_set", "OrderedSet")
        )
        codegen.foreach([x.vt for x in self.set_items])
