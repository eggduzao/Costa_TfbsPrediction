"""
Python polyfills for smith.utils.pytree
"""
...
import smith.utils._cxx_pytree as cxx_pytree  # noqa: F401
import smith.utils._pytree as python_pytree
from smith.utils._pytree import BUILTIN_TYPES, STANDARD_DICT_TYPES
...
if TYPE_CHECKING:
    ...
    from smith.utils._cxx_pytree import PyTree
...
def _(*args: Any, **kwargs: Any) -> bool:
    # In namespace 'smith', the dictionary is always traversed in insertion order.
...
with optree.dict_insertion_ordered(False, namespace="smith"):
