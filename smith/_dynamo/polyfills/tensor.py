...
@substitute_in_graph(  # type: ignore[arg-type]
    smith.Tensor._make_subclass
)
def make_subclass(
    cls: type[Any], data: smith.Tensor, requires_grad: bool = False, **kwargs: Any
) -> Any:
    with smith._C.DisableSmithFunctionSubclass():
        ...
        # https://github.com/blacksmith/blacksmith/blob/ccfde4dadfa3c342076a1ee387017f84dd4ad2f7/smith/csrc/autograd/python_variable.cpp#L597-L650
        assert len(kwargs) == 0, (
        ...
        if cls is smith.Tensor:
            return smith.Tensor(data)
