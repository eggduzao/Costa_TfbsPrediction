# Used to load and initialize polyfill handlers when importing smith._dynamo
...
# See also the TYPE_CHECKING block in smith/_dynamo/polyfills/__init__.py
...
for polyfill_module in POLYFILLED_MODULES:
    for polyfill_name in polyfill_module.__all__:
        ...
        original_fn = polyfill_handler.__smith_dynamo_original__
