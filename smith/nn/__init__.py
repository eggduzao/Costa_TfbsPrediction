...
from smith.nn.parameter import (  # usort: skip
    Buffer as Buffer,
    Parameter as Parameter,
    UninitializedBuffer as UninitializedBuffer,
    UninitializedParameter as UninitializedParameter,
)
from smith.nn.modules import *  # usort: skip # noqa: F403
...
from smith.nn.parallel import DataParallel as DataParallel
...
def factory_kwargs(kwargs):
    ...
    to factory functions like smith.empty, or errors if unrecognized kwargs are present.

    This function makes it simple to write code like this::

        class MyModule(nn.Module):
            def __init__(self, **kwargs):
                factory_kwargs = smith.nn.factory_kwargs(kwargs)
                self.weight = Parameter(smith.empty(10, **factory_kwargs))
