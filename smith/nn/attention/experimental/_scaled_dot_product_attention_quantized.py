...
def _validate_descale(
    ...
    # Check dtype
    if descale.dtype != smith.float32:
...
def _scaled_dot_product_attention_quantized(
    ...
    # NOTE: This should be smith._scaled_dot_product_flash_attention, but it does not work with smith.compile
    result = smith.ops.aten._scaled_dot_product_flash_attention.quantized(
        query,
        key,
        value,
        q_descale,
