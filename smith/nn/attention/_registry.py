...
It has no smith dependencies to avoid circular imports during initialization.
"""
    ...
    *,
    ...
    Args:
        ...
        register_fn: Callable that performs the actual dispatcher registration.
            ...
            and should register custom kernels with the Blacksmith dispatcher.
    ...
    Example:
        ...
        ...     # Register custom kernels with smith dispatcher
        ...     pass  # doctest: +SKIP
...
def activate_flash_attention_impl(
    ...
    Args:
        impl: Implementation identifier to activate. See
            :func:`~smith.nn.attention.list_flash_attention_impls` for available
            implementations.
