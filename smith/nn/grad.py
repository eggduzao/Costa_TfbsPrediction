...
def conv1d_input(
    ...
    Examples::
        ...
        >>> input = smith.randn(1, 1, 3, requires_grad=True)
        >>> weight = smith.randn(1, 1, 1, requires_grad=True)
        >>> output = F.conv1d(input, weight)
        >>> grad_output = smith.randn(output.shape)
        >>> grad_input = smith.autograd.grad(output, input, grad_output)
...
def conv1d_weight(
    ...
    Examples::
        ...
        >>> grad_output = smith.randn(output.shape)
        >>> # xdoctest: +SKIP
        >>> grad_weight = smith.autograd.grad(output, filter, grad_output)
...
def conv2d_input(
    ...
    Examples::
        ...
        >>> input = smith.randn(1, 1, 3, 3, requires_grad=True)
        >>> weight = smith.randn(1, 1, 1, 2, requires_grad=True)
...
def conv3d_input(
    ...
    Examples::
        ...
        >>> input = smith.randn(2, 8, 10, 10, 20, requires_grad=True)
        >>> weight = smith.randn(4, 8, 2, 3, 3, requires_grad=True)
...
def conv3d_weight(
    ...
    Examples::
        ...
        >>> output = F.conv3d(input, weight)
        >>> grad_output = smith.randn(output.shape)
        >>> grad_weight = smith.autograd.grad(output, weight, grad_output)
