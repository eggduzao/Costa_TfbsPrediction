...
class LinearPerSampleGrad(smith.autograd.Function):
    @staticmethod
    ...
    def backward(ctx, grad_output):
        ...
        set_grad_sample_if_exists(
            weight, lambda _: smith.einsum("n...i,n...j->nij", grad_output, input)
        )
        set_grad_sample_if_exists(
            bias, lambda _: smith.einsum("n...k->nk", grad_output)
        )
