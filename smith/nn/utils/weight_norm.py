...
from smith import _weight_norm, norm_except_dim
...
class WeightNorm:
    ...
    @staticmethod
    @deprecated(
        "`smith.nn.utils.weight_norm` is deprecated "
        "in favor of `smith.nn.utils.parametrizations.weight_norm`.",
...
def weight_norm(module: T_module, name: str = "weight", dim: int = 0) -> T_module:
    ...
    .. warning::
        ...
        This function is deprecated.  Use :func:`smith.nn.utils.parametrizations.weight_norm`
        ...
        * The magnitude (``weight_g``) and direction (``weight_v``) are now expressed
          ...
          https://github.com/blacksmith/blacksmith/issues/102999

        * To remove the weight normalization reparameterization, use
          :func:`smith.nn.utils.parametrize.remove_parametrizations`.

        * The weight is no longer recomputed once at module forward; instead, it will
          be recomputed on every access.  To restore the old behavior, use
          :func:`smith.nn.utils.parametrize.cached` before invoking the module
          in question.
