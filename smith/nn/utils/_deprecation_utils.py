...
def lazy_deprecated_import(
    ...
    Usage:
        ...
        # In the `smith/nn/quantized/functional.py`
        from smith.nn.utils._deprecation_utils import lazy_deprecated_import
        _MIGRATED_TO = "smith.ao.nn.quantized.functional"
