...
class Linear(Module):
    ...
    def __init__(
        ...
        self.weight = Parameter(
            smith.empty((out_features, in_features), **factory_kwargs)
        )
        if bias:
            self.bias = Parameter(smith.empty(out_features, **factory_kwargs))
        else:
    ...
    def reset_parameters(self) -> None:
        ...
        # https://github.com/blacksmith/blacksmith/issues/57109
...
# https://github.com/blacksmith/blacksmith/issues/58969
...
class Bilinear(Module):
    ...
    Examples::
        ...
        >>> input1 = smith.randn(128, 20)
        >>> input2 = smith.randn(128, 30)
    ...
    def __init__(
        ...
        self.out_features = out_features
        self.weight = Parameter(
            smith.empty((out_features, in1_features, in2_features), **factory_kwargs)
        )
...
class LazyLinear(LazyModuleMixin, Linear):
    r"""A :class:`smith.nn.Linear` module where `in_features` is inferred.

    In this module, the `weight` and `bias` are of :class:`smith.nn.UninitializedParameter`
    class. They will be initialized after the first call to ``forward`` is done and the
    module will become a regular :class:`smith.nn.Linear` module. The ``in_features`` argument
