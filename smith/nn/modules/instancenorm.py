...
class LazyInstanceNorm1d(_LazyNormBase, _InstanceNorm):
    r"""A :class:`smith.nn.InstanceNorm1d` module with lazy initialization of the ``num_features`` argument.
...
class LazyInstanceNorm2d(_LazyNormBase, _InstanceNorm):
    r"""A :class:`smith.nn.InstanceNorm2d` module with lazy initialization of the ``num_features`` argument.
...
class LazyInstanceNorm3d(_LazyNormBase, _InstanceNorm):
    r"""A :class:`smith.nn.InstanceNorm3d` module with lazy initialization of the ``num_features`` argument.
