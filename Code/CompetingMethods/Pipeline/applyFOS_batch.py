...
for cell in cellList:
  ...
  for tfFile in tfList:
    ...
    outputLocation = "/hpcwork/izkf/projects/TfbsPrediction/Results/Footprints/Predictions/"+cell+"/FOS_batch/"
    ...
    clusterCommand += "-W 100:00 -M 12000 -S 100 -P izkf -R \"select[hpcwork]\" ./applyFOS_pipeline.zsh "
