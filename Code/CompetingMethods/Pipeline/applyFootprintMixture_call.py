...
for i in range(0,len(labList)):
  ...
  for cell in cellList:
    ...
    for factor in factorList:
      ...
      peakFileName = "/hpcwork/izkf/projects/TfbsPrediction/Data/"+labLoc+"/"+cell+"/DNasePeaks.bed"
      ...
      outLoc = "/hpcwork/izkf/projects/TfbsPrediction/Results/Footprints/Results_TC/"+cell+"/FootprintMixture_"+lab+"/"
      outputFileName = outLoc+factor+".bed"
      os.system("mkdir -p "+outLoc)

      # Execution
      myL = "_".join([lab,cell,factor,"AFM"])
      clusterCommand = "bsub "
      clusterCommand += "-J "+myL+" -o "+myL+"_out.txt -e "+myL+"_err.txt "
      clusterCommand += "-W 100:00 -M 48000 -S 100 -P izkf -R \"select[hpcwork]\" ./applyFootprintMixture_pipeline.zsh "
