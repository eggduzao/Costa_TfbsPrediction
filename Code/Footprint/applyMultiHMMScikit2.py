...
params.append("###")
params.append("Input: ")
params.append("    1. hmmType = Can be '4' for four-state or '8' for eight-state.")
params.append("    2. coordFileName = Coordinates to apply the HMM.")
params.append("    3. hmmFileName = The location + name of the hmm file.")
params.append("    4. signalList = The locations of the signals files.")
params.append("    5. outputFileName = Output file name.")
params.append("###")
...
# Reading input
hmmType = sys.argv[1] # Necessary to initialize stateNameDict and colorDict
coordFileName = sys.argv[2]
hmmFileName = sys.argv[3]
signalList = sys.argv[4].split(",")
