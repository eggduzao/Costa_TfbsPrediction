...
do
  ...
  do
    ...
    do
      ...
      # Execution
      bsub -J $cell"_"$pred"_EIMB" -o $cell"_"$pred"_EIMB_out.txt" -e $cell"_"$pred"_EIMB_err.txt" -W 5:00 -M 12000 -S 100 -R "select[hpcwork]" ./extendAndIntersectMaxScore_pipeline.zsh $ext $ext $mpbsFileName $predFileName $outputFileName
      # -P izkf
