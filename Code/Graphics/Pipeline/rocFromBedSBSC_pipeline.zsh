...
export PYTHONPATH=/home/eg474423/Installation/scikit-learn-0.17.1/lib/python2.7/site-packages:$PYTHONPATH # scikit-learn-0.17.1
...
export CPATH=/hpcwork/izkf/lib:$CPATH
export LD_LIBRARY_PATH=/hpcwork/izkf/include:$LD_LIBRARY_PATH
