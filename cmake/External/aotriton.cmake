if(NOT __AOTRITON_INCLUDED)
  ...
  set(__AOTRITON_INSTALL_DIR "${PROJECT_SOURCE_DIR}/smith")
  ...
  function(aotriton_build_from_source noimage project)
    ...
    message(STATUS "BLACKSMITH_ROCM_ARCH ${BLACKSMITH_ROCM_ARCH}")
    ...
    ExternalProject_Add(${project}
      ...
      CMAKE_CACHE_ARGS
      -DAOTRITON_TARGET_ARCH:STRING=${BLACKSMITH_ROCM_ARCH}
  ...
  elseif(DEFINED ENV{AOTRITON_INSTALL_FROM_SOURCE})
    ...
    foreach(image ${__AOTRITON_IMAGE_LIST})
      ...
      foreach(target ${BLACKSMITH_ROCM_ARCH})
