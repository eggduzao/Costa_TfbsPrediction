...
elseif(DEFINED ENV{CMPLR_ROOT})
  ...
  # Use the default path to ensure proper linking with smith::xpurt when the user is working with libsmith.
...
# Define the old version of SYCL toolkit that is compatible with the current version of Blacksmith.
set(BLACKSMITH_2_5_SYCL_TOOLKIT_VERSION 20249999)

# By default, we use libsycl.so on Linux and sycl.lib on Windows as the SYCL library name.
if (SYCL_COMPILER_VERSION VERSION_LESS_EQUAL BLACKSMITH_2_5_SYCL_TOOLKIT_VERSION)
  ...
  if(CMAKE_SYSTEM_NAME MATCHES "Windows")
    # On Windows, the SYCL library is named sycl7.lib until BLACKSMITH_2_5_SYCL_TOOLKIT_VERSION.
