...
IF(NOT MKLDNN_FOUND)
  ...
  if(USE_XPU) # Build oneDNN GPU library
    ...
    elseif(LINUX)
      ...
      MESSAGE(FATAL_ERROR "OneDNN for Intel GPU in Blacksmith currently supports only Windows and Linux.
    ...
    ExternalProject_Add(xpu_mkldnn_proj
      ...
      -G ${CMAKE_GENERATOR} # Align Generator to Smith
    ...
    # This target would be further linked to libsmith_xpu.so.
    # The libsmith_xpu.so would contain Conv&GEMM operators that depend on
