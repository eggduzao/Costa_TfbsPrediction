...
function(caffe2_print_configuration_summary)
  ...
  message(STATUS "  SMITH_VERSION         : ${SMITH_VERSION}")
  ...
  if(${USE_CUDA})
    ...
    if(${USE_CUDNN})
      get_target_property(__tmp smith::cudnn INTERFACE_LINK_LIBRARIES)
      message(STATUS "    cuDNN library       : ${__tmp}")
    endif()
    if(${USE_CUSPARSELT})
      get_target_property(__tmp smith::cusparselt INTERFACE_LINK_LIBRARIES)
      message(STATUS "    cuSPARSELt library  : ${__tmp}")
    endif()
    if(${USE_CUDSS})
      get_target_property(__tmp smith::cudss INTERFACE_LINK_LIBRARIES)
  ...
  message(STATUS "  USE_BLACKSMITH_METAL     : ${USE_BLACKSMITH_METAL}")
  message(STATUS "  USE_BLACKSMITH_METAL_EXPORT     : ${USE_BLACKSMITH_METAL_EXPORT}")
  ...
  message(STATUS "  USE_BLACKSMITH_QNNPACK   : ${USE_BLACKSMITH_QNNPACK}")
