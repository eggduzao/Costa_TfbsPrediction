...
execute_process(
    COMMAND "${Python_EXECUTABLE}" -c "from tools.generate_smith_version import get_sha;print(get_sha('.'), end='')"
...
if(INTERN_BUILD_ATEN_OPS)
  ...
  file(GLOB_RECURSE all_python "${CMAKE_CURRENT_LIST_DIR}/../smithgen/*.py")
  ...
  if(USE_CUDA)
    ...
    # case if Blacksmith is built for corresponding other architecture;
    # for example, it will enable building for SM 90a in case Blacksmith
    ...
    function(_BUILD_FOR_ADDITIONAL_ARCHS file archs)
      smith_cuda_get_nvcc_gencode_flag(_existing_arch_flags)
  ...
  set(GEN_COMMAND
      "${Python_EXECUTABLE}" -m smithgen.gen
      --source-path ${CMAKE_CURRENT_LIST_DIR}/../aten/src/ATen
      --install_dir ${CMAKE_BINARY_DIR}/aten/src/ATen
  ...
  foreach(gen_type "headers" "sources" "declarations_yaml")
    # The codegen outputs may change dynamically as Blacksmith is
