set(BLACKSMITH_FOUND_HIP FALSE)
...
smith_hip_get_arch_list(BLACKSMITH_ROCM_ARCH)
if(BLACKSMITH_ROCM_ARCH STREQUAL "")
  message(FATAL_ERROR "No GPU arch specified for ROCm build. Please use BLACKSMITH_ROCM_ARCH environment variable to specify GPU archs to build for.")
endif()
message("Building Blacksmith for GPU arch: ${BLACKSMITH_ROCM_ARCH}")
...
# The rocm-core package was only introduced in ROCm 6.4, so we make it optional.
  ...
  math(EXPR SMITH_HIP_VERSION "(${HIP_VERSION_MAJOR} * 100) + ${HIP_VERSION_MINOR}")
  message("HIP_VERSION_MAJOR: ${HIP_VERSION_MAJOR}")
  message("HIP_VERSION_MINOR: ${HIP_VERSION_MINOR}")
  message("SMITH_HIP_VERSION: ${SMITH_HIP_VERSION}")
