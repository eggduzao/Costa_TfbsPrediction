...
/**
 * Java representation of a SmithScript value, which is implemented as tagged union that can be one
 * of the supported types: https://blacksmith.org/docs/stable/jit.html#types .
 *
