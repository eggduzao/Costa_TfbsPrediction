...
/**
 * Representation of a Tensor. Behavior is similar to Blacksmith's tensor objects.
 *
...
public abstract class Tensor {
  ...
  /**
   * Creates a new Tensor instance with dtype smith.uint8 with specified shape and data as array of
   * bytes.
   *
  ...
  /**
   * Creates a new Tensor instance with dtype smith.int8 with specified shape and data as array of
   * bytes.
   *
   * @param data Tensor elements
   * @param shape Tensor shape
  ...
  /**
   * Creates a new Tensor instance with dtype smith.int32 with specified shape and data as array of
   * ints.
   *
   * @param data Tensor elements
   * @param shape Tensor shape
  ...
  /**
   * Creates a new Tensor instance with dtype smith.float32 with specified shape and data as array
   * of floats.
   *
   * @param data Tensor elements
   * @param shape Tensor shape
  ...
  /**
   * Creates a new Tensor instance with dtype smith.int64 with specified shape and data as array of
   * longs.
   *
   * @param data Tensor elements
   * @param shape Tensor shape
  ...
  /**
   * Creates a new Tensor instance with dtype smith.float64 with specified shape and data as array
   * of doubles.
   *
   * @param shape Tensor shape
   * @param data Tensor elements
  ...
  /**
   * Creates a new Tensor instance with dtype smith.uint8 with specified shape and data.
   *
  ...
  /**
   * Creates a new Tensor instance with dtype smith.int8 with specified shape and data.
   *
   * @param data Direct buffer with native byte order that contains {@code Tensor.numel(shape)}
   *     elements. The buffer is used directly without copying, and changes to its content will
   *     change the tensor.
  ...
  /**
   * Creates a new Tensor instance with dtype smith.int32 with specified shape and data.
   *
   * @param data Direct buffer with native byte order that contains {@code Tensor.numel(shape)}
   *     elements. The buffer is used directly without copying, and changes to its content will
   *     change the tensor.
  ...
  /**
   * Creates a new Tensor instance with dtype smith.float32 with specified shape and data.
   *
   * @param data Direct buffer with native byte order that contains {@code Tensor.numel(shape)}
   *     elements. The buffer is used directly without copying, and changes to its content will
   *     change the tensor.
  ...
  /**
   * Creates a new Tensor instance with dtype smith.int64 with specified shape and data.
   *
   * @param data Direct buffer with native byte order that contains {@code Tensor.numel(shape)}
   *     elements. The buffer is used directly without copying, and changes to its content will
   *     change the tensor.
  ...
  /**
   * Creates a new Tensor instance with dtype smith.float64 with specified shape and data.
   *
   * @param data Direct buffer with native byte order that contains {@code Tensor.numel(shape)}
   *     elements. The buffer is used directly without copying, and changes to its content will
   *     change the tensor.
  ...
  static class Tensor_uint8 extends Tensor {
    ...
    public String toString() {
      return String.format("Tensor(%s, dtype=smith.uint8)", Arrays.toString(shape));
    }
  }
  ...
  static class Tensor_int8 extends Tensor {
    ...
    @Override
    public String toString() {
      return String.format("Tensor(%s, dtype=smith.int8)", Arrays.toString(shape));
    }
  }
  ...
  static class Tensor_int32 extends Tensor {
    ...
    @Override
    public String toString() {
      return String.format("Tensor(%s, dtype=smith.int32)", Arrays.toString(shape));
    }
  }
  ...
  static class Tensor_float32 extends Tensor {
    ...
    @Override
    public String toString() {
      return String.format("Tensor(%s, dtype=smith.float32)", Arrays.toString(shape));
    }
  }
  ...
  static class Tensor_int64 extends Tensor {
    ...
    @Override
    public String toString() {
      return String.format("Tensor(%s, dtype=smith.int64)", Arrays.toString(shape));
    }
  }
  ...
  static class Tensor_float64 extends Tensor {
    ...
    @Override
    public String toString() {
      return String.format("Tensor(%s, dtype=smith.float64)", Arrays.toString(shape));
    }
  }
