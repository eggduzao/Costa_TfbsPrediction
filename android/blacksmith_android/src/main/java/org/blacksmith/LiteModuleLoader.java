...
public class LiteModuleLoader {
   ...
   * @return new {@link org.blacksmith.Module} object which owns smith::jit::mobile::Module.
   */
  ...
  /**
   * Loads a serialized SmithScript module from the specified path on the disk to run on CPU. The
   ...
   * org.blacksmith.Module#load(String)}.
   *
