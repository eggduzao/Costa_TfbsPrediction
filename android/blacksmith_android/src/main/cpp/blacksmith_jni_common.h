...
#define ALOGI(...) \
  __android_log_print(ANDROID_LOG_INFO, "blacksmith-jni", __VA_ARGS__)
#define ALOGE(...) \
  __android_log_print(ANDROID_LOG_ERROR, "blacksmith-jni", __VA_ARGS__)
#endif
...
class JIValue : public facebook::jni::JavaClass<JIValue> {
 ...
 public:
  constexpr static const char* kJavaDescriptor = "Lorg/blacksmith/IValue;";
