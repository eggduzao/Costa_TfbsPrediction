...
public abstract class BlacksmithTestBase {
  ...
  @Test
  public void testSmithScriptBuiltinQuantOps() throws IOException {
    runModel("smithscript_builtin_ops");
  }

  @Test
  public void testSmithScriptCollectionQuantOps() throws IOException {
    runModel("smithscript_collection_ops");
  }
