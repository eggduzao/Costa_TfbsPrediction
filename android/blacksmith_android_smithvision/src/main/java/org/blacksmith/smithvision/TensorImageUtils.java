...
import org.blacksmith.MemoryFormat;
import org.blacksmith.Tensor;

/**
 * Contains utility functions for {@link org.blacksmith.Tensor} creation from {@link
 * android.graphics.Bitmap} or {@link android.media.Image} source.
 */
public final class TensorImageUtils {

  public static float[] SMITHVISION_NORM_MEAN_RGB = new float[] {0.485f, 0.456f, 0.406f};
  public static float[] SMITHVISION_NORM_STD_RGB = new float[] {0.229f, 0.224f, 0.225f};

  /**
   * Creates new {@link org.blacksmith.Tensor} from full {@link android.graphics.Bitmap}, normalized
  ...
  /**
   * Creates new {@link org.blacksmith.Tensor} from specified area of {@link android.graphics.Bitmap},
  ...
  /**
   * Creates new {@link org.blacksmith.Tensor} from specified area of {@link android.media.Image},
  ...
  private static class NativePeer {
    static {
      ...
      NativeLoader.loadLibrary("blacksmith_vision_jni");
    }
