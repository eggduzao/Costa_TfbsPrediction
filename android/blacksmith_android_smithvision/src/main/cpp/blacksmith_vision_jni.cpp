...
namespace blacksmith_vision_jni {
...
JNIEXPORT jint JNI_OnLoad(JavaVM* vm, void*) {
  ...
  jclass c =
      env->FindClass("org/blacksmith/smithvision/TensorImageUtils$NativePeer");
  if (c == nullptr) {
    return JNI_ERR;
  }
  ...
  static const JNINativeMethod methods[] = {
      {"imageYUV420CenterCropToFloatBuffer",
       ...
       (void*)blacksmith_vision_jni::imageYUV420CenterCropToFloatBuffer},
  };
