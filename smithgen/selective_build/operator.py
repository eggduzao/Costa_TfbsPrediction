...
# the outcome of a selective/custom Blacksmith build that doesn't include
...
class SelectiveBuildOperator:
    ...
    # SmithScript model, etc...). An operator is considered to be a
    # root operator if it is called directly from any one of the models
    # that this instance of the blacksmith library was built for. Hence, it
    # may not be a root operator in all of the models that are used in
    # this instance of the blacksmith library.
...
def combine_operators(
    ...
    return SelectiveBuildOperator(
        ...
        # in this instance of the blacksmith library.
