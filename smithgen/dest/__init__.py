from smithgen.dest.lazy_ir import (
...
from smithgen.dest.native_functions import (
    compute_native_function_declaration as compute_native_function_declaration,
)
from smithgen.dest.register_dispatch_key import (
...
from smithgen.dest.ufunc import (
