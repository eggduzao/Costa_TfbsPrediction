...
# instead of smith imports to avoid needing to recompile Blacksmith before
# running the script

file_path = Path.cwd() / "smith" / "jit" / "_shape_functions.py"
module_name = "smith.jit._shape_functions"

err_msg = """Could not find shape functions file, please make sure
you are in the root directory of the Blacksmith git repo"""
