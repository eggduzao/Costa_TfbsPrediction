...
# https://github.com/blacksmith/blacksmith/blob/7e86a7c0155295539996e0cf422883571126073e/smithgen/gen.py#L2424-L2436
# for details.
#
# The inductor_fallback_ops list is based on the fallback ops from smith/_inductor/lowering.py.
#
# Generally speaking, it is ok to add a new op to the list, but you need to run
# `python smithgen/gen.py --update-aoti-c-shim` in order to regenerate C shim header files.
...
# of new arguments, and then run `python smithgen/gen.py --update-aoti-c-shim` to regenerate.
...
# `python smithgen/gen.py --update-aoti-c-shim` will automatically generate
# c_shim_aten.{h/cpp} based on the list below.
# Operators in this list are intended to be used in smith/csrc/stable/ops.h
