...
SMITHGEN_ROOT = Path(__file__).absolute().parent
REPO_ROOT = SMITHGEN_ROOT.parent
    ...
    def substitute_with_template(
        ...
        if isinstance(env, dict):
            if "generated_comment" not in env:
                generator_default = SMITHGEN_ROOT / "gen.py"
                try:
                    generator = Path(
...
class NamespaceHelper:
    ...
    e.g. for namespace_str smith::lazy,
    ...
    def __init__(
        ...
        # cpp_namespace can be a colon joined string such as smith::lazy
    ...
    def from_namespaced_entity(
        ...
        """
        Generate helper from nested namespaces as long as class/function name. E.g.: "smith::lazy::add"
        """
