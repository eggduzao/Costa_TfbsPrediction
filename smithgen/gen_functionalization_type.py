...
from smithgen.api import cpp, dispatcher, functionalization
...
from smithgen.utils import concatMap, dataclass_repr, FileManager
...
# per backend (e.g. XLA or Vulkan), or as a composable transform (functionalize() in funcsmith).
...
class ViewMetaSpecialization:
    ...
    def decl(self) -> list[str]:
        ...
        return [
            f"""
struct SMITH_API {self.classname} : public ViewMeta {{
...
def gen_functionalization_view_meta_classes(
    ...
    from smithgen.gen import get_grouped_by_view_native_functions, parse_native_yaml
...
def gen_functionalization_registration(
    ...
    def emit_registration_helper(f: NativeFunction) -> str:
        if f.has_composite_implicit_autograd_kernel:
            ...
            registration_str = f"SMITH_FN(functionalization::{wrapper_name(f.func)})"
    ...
    if isinstance(g, NativeFunctionsViewGroup):
        ...
        # See Note [Functionalization <> smith.Tensor constructor]
