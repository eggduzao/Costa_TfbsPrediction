...
import smithgen.dest as dest
from smithgen.api.lazy import setValueT
from smithgen.api.types import BaseCppType
from smithgen.dest.lazy_ir import GenLazyIR, GenLazyNativeFuncDefinition, GenTSLazyIR
from smithgen.gen import get_grouped_native_functions, parse_native_yaml
from smithgen.gen_backend_stubs import (
    error_on_missing_kernels,
    gen_dispatcher_registrations,
    gen_dispatchkey_nativefunc_headers,
    parse_backend_yaml,
)
from smithgen.model import NativeFunction, NativeFunctionsGroup, OperatorName
from smithgen.selective_build.selector import SelectiveBuilder
from smithgen.utils import FileManager, NamespaceHelper
...
# - opt-in: also generate 'lowering' methods for the SmithScript backend only
...
#   implementations in smith/csrc/lazy/core/shape_inference.*
...
class default_args:
    ...
    shape_inference_hdr: str = "smith/csrc/lazy/core/shape_inference.h"
    tensor_class: str = "smith::lazy::LazyTensor"
    tensor_class_hdr: str = "smith/csrc/lazy/core/tensor.h"
    lazy_ir_generator: type[GenLazyIR] = GenLazyIR
    native_func_definition_generator: type[GenLazyNativeFuncDefinition] = (
        GenLazyNativeFuncDefinition
    )
    backend_name: str = "SmithScript"
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        "--gen_ts_lowerings",
        action="store_true",
        help="Generate SmithScript lowerings in addition to Lazy IR and NativeFunctions",
    )
    parser.add_argument(
        "--node-base",
        "--node_base",
    ...
    # Assumes that this file lives at BLACKSMITH_ROOT/smithgen/gen_backend_stubs.blacksmith_root = Path(__file__).absolute().parents[2]
    aten_path = str(smith_root / "aten" / "src" / "ATen")
...
def run_gen_lazy_tensor(
    ...
    backend_namespace: str = "smith::lazy",
    ...
    metrics_counter: str = 'SMITH_LAZY_FN_COUNTER("lazy::")',
    create_tensor: str = "LazyTensor::Create",
    create_from_first_tensor: bool = False,
    create_aten_from_ltc_tensor: str = "smith::lazy::CreateAtenFromLtcTensor",
    tuple_aten_from_ltc_tensors: str = "smith::lazy::TupleAtenFromLtcTensors",
    lazy_value_class: str = "smith::lazy::Value",
    lazy_tensor_ptr: str = "LazyTensorPtr",
    get_device_fn: str = "smith::lazy::GetBackendDevice",
) -> None:
    ...
    See smith/csrc/lazy/core/shape_inference.cpp #READ THIS! for more information.
    """
        ...
        lambda: {
            "includes": [
                ...
                for path in [
                    ...
                    "smith/csrc/lazy/core/ir_builder.h",
                    "smith/csrc/lazy/core/lazy_graph_executor.h",
                    "smith/csrc/lazy/core/metrics.h",
                    "smith/csrc/lazy/core/shape.h",
                    f"{output_dir}/{backend_key}NativeFunctions.h",
                    f"{output_dir}/LazyIr.h",
                ]
                + (
                    ["smith/csrc/lazy/ts_backend/ts_eager_fallback.h"]
        ...
        lambda: {
            "lazy_ir_sysinc": [
                ...
                for path in [
                    ...
                    "smith/csrc/lazy/core/hash.h",
                    "smith/csrc/lazy/core/ir.h",
                    "smith/csrc/lazy/core/shape.h",
                    "optional",
                    "vector",
                ]
        ...
        lambda: {
            "lazy_non_native_ir_inc": [
                ...
                for path in [
                    "smith/csrc/lazy/core/ir.h",
                    "smith/csrc/lazy/core/ir_builder.h",
                    "smith/csrc/lazy/core/internal_ops/ltc_ops.h",
                    "smith/csrc/lazy/core/shape_inference.h",
                ]
