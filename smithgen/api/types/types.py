...
This file defines data model classes for smithgen typing system, as well as some base types such as int32_t.
...
from smithgen.api.types.types_base import (
    BaseCppType,
    BaseCType,
    boolT,
    byteT,
...
from smithgen.model import BaseTy, ScalarType
...
typeAndSizeT = BaseCppType("smith::autograd::generated", "TypeAndSize")
