...
# words, a Blacksmith user will do operations on lazy tensors, and each output lazy
...
tensorListValueT = BaseCppType("smith::lazy", "Value")
...
#
# TODO: This is not idiomatic with how other smithgen APIs transform on schema.
class LazyIrSchema:
