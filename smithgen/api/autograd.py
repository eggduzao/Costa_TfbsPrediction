...
from smithgen import local
from smithgen.api import cpp
from smithgen.api.types import BaseCType, Binding, NamedCType, tensorListT
...
from smithgen.utils import IDENT_REGEX
...
# note(crcrpar): Most foreach functions can reference an out-place `smith` function whose schema kind
...
def match_differentiability_info(
    ...
    def find_info(
        ...
        if "generated" in f.tags and f_sig in non_functional_info_by_signature:
            ...
            # See https://github.com/blacksmith/blacksmith/pull/76320/files#r874816389
            if any(
