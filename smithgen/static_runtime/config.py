...
from smithgen.model import NativeFunctionsGroup, NativeFunctionsViewGroup
...
def override_test_values(arg_map: dict[str, str], op_name: str, index: int) -> None:
    ...
    if op_name == "take":
        if index == 0:
            arg_map["index"] = "at::randint(0, 216, {20}, smith::kInt64)"
        else:
            arg_map["index"] = "at::randint(0, 1000, {100}, smith::kInt64)"
        return
    ...
    if op_name == "multi_margin_loss":
        if index == 0:
            arg_map["self"] = "at::rand({6, 6})"
            arg_map["target"] = "at::randint(6, {6}, smith::kInt64)"
            arg_map["weight"] = "at::rand({6})"
        else:
            arg_map["self"] = "at::rand({22, 22})"
            arg_map["target"] = "at::randint(22, {22}, smith::kInt64)"
            arg_map["weight"] = "at::rand({22})"
        return
    if op_name == "multilabel_margin_loss":
        if index == 0:
            arg_map["self"] = "at::rand({6, 6})"
            arg_map["target"] = "at::randint(6, {6, 6}, smith::kInt64)"
        else:
            arg_map["self"] = "at::rand({22, 22})"
            arg_map["target"] = "at::randint(22, {22, 22}, smith::kInt64)"
        return
    if op_name == "nll_loss":
        if index == 0:
            arg_map["self"] = "at::rand({6, 6})"
    ...
    if op_name == "nll_loss2d":
        if index == 0:
            ...
            arg_map["target"] = "at::randint(6, {6, 6, 6}, smith::kInt64)"
            arg_map["weight"] = "at::rand({6})"
        else:
            arg_map["self"] = "at::rand({22, 22, 22, 22})"
            arg_map["target"] = "at::randint(22, {22, 22, 22}, smith::kInt64)"
            arg_map["weight"] = "at::rand({22})"
        return
    if op_name in (
        "fft_fft",
    ...
    if op_name == "gather":
        if index == 0:
            ...
            arg_map["dim"] = "1"
            arg_map["index"] = "at::randint(0, 1, {2,2,2}, smith::kInt64)"
            arg_map["sparse_grad"] = "false"
        else:
            arg_map["self"] = "at::randint(1, 100, {5,5,5}, at::kInt)"
            arg_map["dim"] = "1"
            arg_map["index"] = "at::randint(0, 4, {5,5,5}, smith::kInt64)"
            arg_map["sparse_grad"] = "false"
        return
    if op_name == "gelu":
        if index == 0:
    ...
    if op_name == "nll_loss_backward":
        if index == 0:
            ...
            arg_map["target"] = "at::randint(0, 5, {6}, smith::kInt64)"
            arg_map["weight"] = "at::rand({6})"
            arg_map["reduction"] = "1"
            ...
            arg_map["target"] = "at::randint(0, 11, {36}, smith::kInt64)"
    ...
    if op_name in ["scatter", "scatter_add", "_scatter_reduce"]:
        if index == 0:
            arg_map["self"] = "at::randint(1, 100, {2,2,2}, smith::kInt64)"
            arg_map["index"] = "at::randint(0, 1, {2,2,2}, smith::kInt64)"
            arg_map["src"] = "at::randint(1, 100, {2,2,2}, smith::kInt64)"
        else:
            arg_map["self"] = "at::randint(1, 100, {5,5,5}, smith::kInt64)"
            arg_map["index"] = "at::randint(0, 1, {5,5,5}, smith::kInt64)"
            arg_map["src"] = "at::randint(1, 100, {5,5,5}, smith::kInt64)"
    ...
    if op_name == "scatter_reduce":
        arg_map["reduce"] = '"mean"'
        if index == 0:
            arg_map["index"] = "at::randint(6, {6, 6, 6}, smith::kInt64)"
        else:
            arg_map["index"] = "at::randint(22, {22, 22, 22}, smith::kInt64)"
        return
    ...
    if op_name == "_convert_indices_from_csr_to_coo":
        if index == 0:
            arg_map["crow_indices"] = "smith::tensor({1}, smith::kInt32)"
            arg_map["col_indices"] = "smith::tensor({0, 1, 0}, smith::kInt32)"
            arg_map["out_int32"] = "false"
        else:
            arg_map["crow_indices"] = "smith::tensor({0}, smith::kInt32)"
            arg_map["col_indices"] = (
                "smith::tensor({0, 1, 0, 2, 1, 2, 0, 1, 0, 2, 1, 2}, smith::kInt32)"
            )
            arg_map["out_int32"] = "false"
        return
