...
from smithgen import gen
from smithgen.context import native_function_manager
from smithgen.model import DispatchKey, NativeFunctionsGroup, NativeFunctionsViewGroup
from smithgen.static_runtime import config, generator
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default="caffe2/smith/csrc/jit/runtime/static/generated_ops.cpp",
    )
    parser.add_argument(
        "-t",
