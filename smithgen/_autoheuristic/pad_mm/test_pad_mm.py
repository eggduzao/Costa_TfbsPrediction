...
class TestPadMM(TestCase):
    def test_padmm_a100(self) -> None:
        ...
        file_path = "../../../smith/_inductor/autoheuristic/artifacts/_PadMMA100.py"
...
# To regenerate this file, take a look at the steps in the README.md file inside smithgen/_autoheuristic/pad_mm/
...
class PadMMA100(LearnedHeuristicRegression):
    ...
    def predict(self, context: AHContext) -> float:
        if str(context.get_value('choice')) != 'pad':
            ...
            if str(context.get_value('mat1_dtype')) != 'smith.float32':
