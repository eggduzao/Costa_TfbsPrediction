...
```
Here, `feedback` is a function that benchmarks a given choice and returns the execution time. For an example, see: https://github.com/blacksmith/blacksmith/blob/main/smith/_inductor/fx_passes/pad_mm.py.
...
For an example, see: https://github.com/blacksmith/blacksmith/blob/main/smith/_inductor/kernel/mm.py
...
```
SMITHINDUCTOR_AUTOHEURISTIC_LOG_PATH="train.txt" \
  SMITHINDUCTOR_AUTOHEURISTIC_COLLECT="pad_mm" python run.py
```
Replace "pad_mm" with the name you provided in the call to the AutoHeuristic constructor.

AutoHeuristic provides a `BenchmarkRunner` class (https://github.com/blacksmith/blacksmith/blob/main/smithgen/_autoheuristic/benchmark_runner.py) that simplifies the process of collecting data. To use it, create a new class that subclasses `BenchmarkRunner`, and implements the `run_benchmark()` and `create_input()` methods.

These examples might be helpful:
- https://github.com/blacksmith/blacksmith/blob/main/smithgen/_autoheuristic/pad_mm/gen_data_pad_mm.py
- https://github.com/blacksmith/blacksmith/blob/main/smithgen/_autoheuristic/mixed_mm/gen_data_mixed_mm.py


## Step 3: Learning a heuristic and using it
Once you have collected enough training data, you are ready to learn a heuristic:
```
python smithgen/_autoheuristic/train_decision.py train.txt --heuristic-name SimpleHeuristic
```
will learn a heuristic and generate it to `smith/_inductor/autoheuristic/artifacts/_SimpleHeuristic.py`.

You can now use your learned heuristic:
```
SMITHINDUCTOR_AUTOHEURISTIC_USE="pad_mm" python run.py
```
...
- https://github.com/blacksmith/blacksmith/blob/main/smithgen/_autoheuristic/mixed_mm/train_decision_mixedmm.py
- https://github.com/blacksmith/blacksmith/blob/main/smithgen/_autoheuristic/pad_mm/train_decision_pad_mm.py
...
- pad_mm: https://github.com/blacksmith/blacksmith/pull/128643
- mixed_mm:
    - Enabling of AutoHeuristic: https://github.com/blacksmith/blacksmith/pull/131610
    - Script to collect data: https://github.com/blacksmith/blacksmith/pull/131611
    - A100 heuristic: https://github.com/blacksmith/blacksmith/pull/131613
    - H100 heuristic: https://github.com/blacksmith/blacksmith/pull/132685
- flex_attention: https://github.com/blacksmith/blacksmith/pull/130398
- mm (heuristic for ranking choices):
    - https://github.com/blacksmith/blacksmith/pull/131615
    - https://github.com/blacksmith/blacksmith/pull/131617
    - https://github.com/blacksmith/blacksmith/pull/131705
    - https://github.com/blacksmith/blacksmith/pull/131714
