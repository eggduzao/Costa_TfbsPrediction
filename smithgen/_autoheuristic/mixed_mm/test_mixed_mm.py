...
class TestMixedMM(TestCase):
    def test_mixedmm_a100(self) -> None:
        ...
        file_path = "../../../smith/_inductor/autoheuristic/artifacts/_MixedMMA100.py"
...
# To regenerate this file, take a look at the steps in the README.md file inside smithgen/_autoheuristic/mixed_mm/
        ...
        if str(context.get_value('1LEQmLEQ16')) != 'True':
            ...
            if context.get_value('n') <= 3520.0:
                if context.get_value('arith_intensity') <= 3.994754433631897:
                    if str(context.get_value('mat2_dtype')) != 'smith.uint8':
...
""",
    ...
    def test_mixedmm_h100(self) -> None:
        ...
        file_path = "../../../smith/_inductor/autoheuristic/artifacts/_MixedMMH100.py"
            ...
            if context.get_value('n') <= 25280.0:
                if context.get_value('n') <= 1344.0:
                    ...
                    if context.get_value('n') <= 8512.0:
                        if str(context.get_value('mat2_dtype')) != 'smith.int8':
                            return [(0.763, 6), (0.237, 7)]
                        else:
                            return [(0.725, 7), (0.275, 6)]
                    else:
                        if str(context.get_value('mat1_dtype')) != 'smith.bfloat16':
