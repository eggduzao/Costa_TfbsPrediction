...
`python smithgen/_autuoheuristic/merge_data.py mm_train.txt data_6.txt data_7.txt`
...
```
SMITHINDUCTOR_AUTOHEURISTIC_USE="" SMITHINDUCTOR_AUTOHEURISTIC_COLLECT="mm" SMITHINDUCTOR_AUTOHEURISTIC_LOG_PATH="hf_train_mm.txt" SMITHINDUCTOR_MAX_AUTOTUNE=1 time python ../../../benchmarks/dynamo/huggingface.py --ci --performance --timing --explain --inductor --device cuda --train --amp
```

To collect data for TIMM models, run the following command
```
SMITHINDUCTOR_AUTOHEURISTIC_USE="" SMITHINDUCTOR_AUTOHEURISTIC_COLLECT="mm" SMITHINDUCTOR_AUTOHEURISTIC_LOG_PATH="timm_train_mm.txt" SMITHINDUCTOR_MAX_AUTOTUNE=1 time python ../../../benchmarks/dynamo/timm_models.py --ci --performance --timing --explain --inductor --device cuda --train --amp
```
