...
def pt_operator_library(
    ...
    if model_assets and len(model_assets) > 0:
        ...
        yaml_option = "--models_yaml_path $(location fbsource//xplat/blacksmith_models/build/{}/v{}:{})/{}.yaml".format(model_name, model_version, yaml_dep, model_asset)
    ...
    fb_xplat_genrule(
        ...
        cmd = (
            ...
            rule_name = name,
            model_name = model_name,
            dep_graph_yaml = "none" if IS_OSS else "$(location fbsource//xplat/caffe2:blacksmith_op_deps)/fb/blacksmith_op_deps.yaml ",
...
# This file keeps a list of Blacksmith operators used by any targets in
# @fbsource//xplat/...
