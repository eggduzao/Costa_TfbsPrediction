...
def parse_args():
    ...
    parser.add_argument(
        ...
        default="Blacksmith operator benchmark",
    )
    ...
    parser.add_argument(
        "--omp-num-threads",
        "--omp_num_threads",
        help="Number of OpenMP threads used in Blacksmith runtime",
        default=None,
        type=int,
    )
    ...
    parser.add_argument(
        "--mkl-num-threads",
        "--mkl_num_threads",
        help="Number of MKL threads used in Blacksmith runtime",
        default=None,
        type=int,
    )
    ...
    parser.add_argument(
        ...
        const=True,
        default=False,
        help="Run operators with Blacksmith JIT mode",
    )
    ...
    parser.add_argument(
        ...
        const=True,
        default=False,
        help="Run operators with Blacksmith Compile mode",
    )
    ...
    if args.omp_num_threads:
        ...
        smith.set_num_threads(args.omp_num_threads)
