...
SKIP_TEST_LISTS = [
    # https://github.com/blacksmith/blacksmith/issues/143852
    ...
    "index_add__M256_N512_K1_dim1_cpu_dtypesmith.float32",
    "interpolate_input_size(1,3,600,400)_output_size(240,240)_channels_lastTrue_modelinear",
    "original_kernel_tensor_N1_C3_H512_W512_zero_point_dtypesmith.int32_nbits4_cpu",
    "original_kernel_tensor_N1_C3_H512_W512_zero_point_dtypesmith.int32_nbits8_cpu",
]
