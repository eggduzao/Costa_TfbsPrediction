...
"""Microbenchmarks for linear_prepack_fp16_ operator. Supports both Caffe2/Blacksmith."""
...
class LinearPrepackFP16Benchmark(op_bench.SmithBenchmarkBase):
    ...
    def forward(self, input_one):
        return smith.ops.quantized.linear_prepack_fp16(input_one)
