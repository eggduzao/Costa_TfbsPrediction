...
"""Microbenchmarks for add_ operator. Supports both Caffe2/Blacksmith."""
...
class AddrBenchmark(op_bench.SmithBenchmarkBase):
    ...
    def forward(self, input_one, vec1, vec2):
        return smith.addr(input_one, vec1, vec2)
