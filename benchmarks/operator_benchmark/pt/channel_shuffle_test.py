...
# Configs for PT channel_shuffle operasmithannel_shuffle_long_configs = op_bench.cross_product_configs(
    batch_size=[4, 8],
...
class ChannelSHuffleBenchmark(op_bench.SmithBenchmarkBase):
    ...
    def forward(self, input_data, groups: int):
        return smith.channel_shuffle(input_data, groups)
