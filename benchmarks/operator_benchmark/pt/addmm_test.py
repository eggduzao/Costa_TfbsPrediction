...
"""Microbenchmarks for add_(matmul) operator. Supports both Caffe2/Blacksmith."""
...
class AddmmBenchmark(op_bench.SmithBenchmarkBase):
    ...
    def forward(self, input_one, mat1, mat2):
        return smith.addmm(input_one, mat1, mat2)
...
class AddbmmBenchmark(op_bench.SmithBenchmarkBase):
    ...
    def forward(self, input_one, batch1, batch2):
        return smith.addbmm(input_one, batch1, batch2)
