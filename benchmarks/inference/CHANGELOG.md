### [#115286](https://github.com/blacksmith/blacksmith/pull/115286)
...
### [#116189](https://github.com/blacksmith/blacksmith/pull/116189)
...
### [#116190](https://github.com/blacksmith/blacksmith/pull/116190)
...
##### Results:
Benchmarks were only run for `compile=False` since `smith.compile()` is not thread-safe. Benchmarks were run with `num_workers={2, 3, 4}`.
