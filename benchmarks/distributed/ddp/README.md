...
`smith.nn.parallel.DistributedDataParallel`, `smith.distributed`, or
anything in between.
...
This benchmark depends on Blacksmith and smithvision.
...
using [`smith.distributed.launch`][launch] to spawn multiple processes
per machine.

[launch]: https://blacksmith.org/docs/stable/distributed.html#launch-utility

Example output (only on rank 0):

```
-----------------------------------
Blacksmith distributed benchmark suite
-----------------------------------

* Blacksmith version: 1.4.0a0+05140f0
* CUDA version: 10.0
...
blacksmith_version:          1.4.0a0+05140f0  vs       1.4.0a0+05140f0
