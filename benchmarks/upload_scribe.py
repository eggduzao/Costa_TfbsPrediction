"""Scribe Uploader for Blacksmith Benchmark Data
...
class BlacksmithBenchmarkUploader(ScribeUploader):
    def __init__(self):
        super().__init__("perfpipe_blacksmith_benchmarks")
        self.schema = {
            "int": [
                "time",
                "rounds",
            ...
            "normal": [
                ...
                "benchmark_class",
                "benchmark_time",
                "blacksmith_commit_id",
                "blacksmith_branch",
                "blacksmith_commit_time",
                "blacksmith_version",
                "blacksmith_git_dirty",
                "machine_kernel",
                "machine_processor",
                "machine_hostname",
                "circle_build_num",
            ...
            m = self.format_message(
                {
                    ...
                    "blacksmith_commit_id": commit_info["id"],
                    "blacksmith_branch": commit_info["branch"],
                    "blacksmith_commit_time": commit_info["time"],
                    "blacksmith_version": None,
                    "blacksmith_git_dirty": commit_info["dirty"],
...
if __name__ == "__main__":
    ...
    if args.pytest_bench_json:
        benchmark_uploader = BlacksmithBenchmarkUploader()
