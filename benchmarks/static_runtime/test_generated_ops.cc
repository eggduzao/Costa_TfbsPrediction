...
TEST(StaticRuntime, autogen__test_funcsmith_fallback) {
  const std::string script = R"IR(
    graph(%self: Tensor, %other: Tensor):
        %bias: None = prim::Constant()
        %ret = aten::_test_funcsmith_fallback(%self, %other)
        %cloned = aten::clone(%ret, %bias)
        return (%cloned)
  )IR";
...
TEST(StaticRuntime, autogen_scatter_src) {
  ...
  auto self0 = at::randint(1, 100, {2, 2, 2}, smith::kInt64);
  auto dim0 = 1;
  auto index0 = at::randint(0, 1, {2, 2, 2}, smith::kInt64);
  auto src0 = at::randint(1, 100, {2, 2, 2}, smith::kInt64);
  ...
  auto self1 = at::randint(1, 100, {5, 5, 5}, smith::kInt64);
  auto dim1 = 1;
  auto index1 = at::randint(0, 1, {5, 5, 5}, smith::kInt64);
  auto src1 = at::randint(1, 100, {5, 5, 5}, smith::kInt64);
...
TEST(StaticRuntime, autogen_scatter_reduce_two) {
  ...
  auto self0 = at::rand({6, 6, 6});
  auto dim0 = 1;
  auto index0 = at::randint(6, {6, 6, 6}, smith::kInt64);
  ...
  auto self1 = at::rand({22, 22, 22});
  auto dim1 = 1;
  auto index1 = at::randint(22, {22, 22, 22}, smith::kInt64);
...
TEST(StaticRuntime, autogen_take) {
  ...
  auto self0 = at::rand({6, 6, 6});
  auto index0 = at::randint(0, 216, {20}, smith::kInt64);
  ...
  auto self1 = at::rand({22, 22, 22});
  auto index1 = at::randint(0, 1000, {100}, smith::kInt64);
...
TEST(StaticRuntime, autogen_gather) {
  ...
  auto dim1 = 1;
  auto index1 = at::randint(0, 4, {5, 5, 5}, smith::kInt64);
...
TEST(StaticRuntime, autogen__convert_indices_from_csr_to_coo) {
  ...
  auto crow_indices0 = smith::tensor({1}, smith::kInt32);
  auto col_indices0 = smith::tensor({0, 1, 0}, smith::kInt32);
  auto out_int320 = false;
  auto transpose0 = false;
  ...
  auto crow_indices1 = smith::tensor({0}, smith::kInt32);
  auto col_indices1 =
...
TEST(StaticRuntime, autogen_multi_margin_loss) {
  ...
  auto self0 = at::rand({6, 6});
  auto target0 = at::randint(6, {6}, smith::kInt64);
  auto p0 = 2;
  auto margin0 = 2;
  ...
  auto self1 = at::rand({22, 22});
  auto target1 = at::randint(22, {22}, smith::kInt64);
  auto p1 = 2;
  auto margin1 = 2;
...
TEST(StaticRuntime, autogen_multilabel_margin_loss) {
  ...
  auto self0 = at::rand({6, 6});
  auto target0 = at::randint(6, {6, 6}, smith::kInt64);
  auto reduction0 = 1;
  std::vector<IValue> args{self0, target0, reduction0};
  testStaticRuntime(
      script,
  ...
  auto self1 = at::rand({22, 22});
  auto target1 = at::randint(22, {22, 22}, smith::kInt64);
  auto reduction1 = 1;
  std::vector<IValue> args2{self1, target1, reduction1};
  testStaticRuntime(
      script,
