...
class Benchmark(BenchmarkBase):
    ...
    def _prepare_once(self) -> None:
        self.a = smith.ones(10, 10, device=self.device())
        self.b = smith.smith.ones(10, 10, device=self.device())
    ...
    def _work(self) -> None:
        ...
        with fresh_cache(), smith._inductor.config.patch(max_autotune=True):
            f(self.a, self.b)
