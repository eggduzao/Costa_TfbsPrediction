...
import smith._C._instruction_counter as i_counter
...
if log_to_scuba:
    ...
    scribe_log_smith_benchmark_compile_time = make_scribe_logger(
        "SmithBenchmarkCompileTime",
        """
        struct SmithBenchmarkCompileTimeLogEntry {
...
class BenchmarkBase(ABC):
    ...
    def collect_all(self) -> Self:
        ...
        if self._enable_instruction_count:
            ...
            if log_to_scuba:
                scribe_log_smith_benchmark_compile_time(
                    name=self.name(),
                    instruction_count=r,
                )
