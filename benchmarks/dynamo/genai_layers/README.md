...
This directory contains benchmarks for the GenAI kernels. It compares blacksmith eager, blacksmith compiler, quack, and liger.


## Setup

Assuming blacksmith is installed.
