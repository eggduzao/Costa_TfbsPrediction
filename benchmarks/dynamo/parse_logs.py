...
# smithbench.py) and parses it into a CSV file that summarizes what
...
# Assume we run smithbench, huggingface, timm_models in that order
...
for name, name2, log in chunker(entries, 3):
    ...
    # See https://github.com/blacksmith/smithdynamo/issues/1910
    if "FAIL" in log:
        r = "FAIL"
    ...
    if "STATS:" in log:
        ...
        # call_* op count: 970 | FakeTensor.__smith_dispatch__:35285 | ProxySmithDispatchMode.__smith_dispatch__:13339
