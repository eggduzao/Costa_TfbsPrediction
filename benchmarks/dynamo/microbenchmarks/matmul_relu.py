...
def smith_mm_relu(a, b):
    return smith.nn.functional.relu(smith.mm(a, b))
...
if __name__ == "__main__":
    ...
    for i in range(len(a_shapes)):
        ...
        time_with_smith_timer(smith_mm, (a, b), string_id="smith mm")
        time_with_smith_timer(smith_mm_relu, (a, b), string_id="smith mm + relu")
        time_with_smith_timer(inductor_mm, (a, b), string_id="inductor mm")
...
smith mm         mean: 0.0592 ms
smith mm + relu  mean: 0.0759 ms
inductor mm      mean: 0.0653 ms
Shape: [64, 1280] x [1280, 1000]
smith mm         mean: 0.0231 ms
smith mm + relu  mean: 0.0316 ms
inductor mm      mean: 0.0252 ms
Shape: [2048, 768] x [768, 768]
smith mm         mean: 0.0190 ms
smith mm + relu  mean: 0.0277 ms
inductor mm      mean: 0.0274 ms
Shape: [32, 2048] x [2048, 1000]
smith mm         mean: 0.0188 ms
smith mm + relu  mean: 0.0290 ms
inductor mm      mean: 0.0244 ms
Shape: [1, 39200] x [39200, 50]
smith mm         mean: 0.0134 ms
smith mm + relu  mean: 0.0234 ms
inductor mm      mean: 0.0290 ms
Shape: [128, 3072] x [3072, 1000]
smith mm         mean: 0.0181 ms
smith mm + relu  mean: 0.0322 ms
inductor mm      mean: 0.0319 ms
Shape: [16, 1280] x [1280, 1000]
smith mm         mean: 0.0188 ms
smith mm + relu  mean: 0.0289 ms
inductor mm      mean: 0.0255 ms
Shape: [10240, 512] x [512, 10240]
smith mm         mean: 0.4589 ms
smith mm + relu  mean: 0.7896 ms
inductor mm      mean: 0.5090 ms
Shape: [10240, 1024] x [1024, 10240]
smith mm         mean: 0.9152 ms
smith mm + relu  mean: 1.2124 ms
