...
flaky_models = {
    ...
    "XGLMForCausalLM",  # discovered in https://github.com/blacksmith/blacksmith/pull/128148
    "moondream",  # discovered in https://github.com/blacksmith/blacksmith/pull/159291
    # discovered in https://github.com/blacksmith/blacksmith/issues/161419. Its not flaky but really hard to repro, so skipping it
    "mobilenetv3_large_100",
    # https://github.com/blacksmith/blacksmith/issues/163670
    "vision_maskrcnn",
}
...
def check_accuracy(actual_csv, expected_csv, expected_filename):
    ...
    if failed or improved:
        ...
        from blacksmith/blacksmith root, run
