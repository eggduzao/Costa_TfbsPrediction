...
def get_aten_preprocessor_flags():
    ...
    ATEN_PREPROCESSOR_FLAGS = _COMMON_PREPROCESSOR_FLAGS + [
        ...
        "-DUSE_BLACKSMITH_METAL",
        "-DUSE_BLACKSMITH_QNNPACK",
        "-DUSE_XNNPACK",
        "-DBLACKSMITH_QNNPACK_RUNTIME_QUANTIZATION",
    ...
    if get_disable_per_op_profiling():
        ATEN_PREPROCESSOR_FLAGS.append("-DBLACKSMITH_DISABLE_PER_OP_PROFILING")
...
def get_pt_preprocessor_flags():
    ...
    if _is_build_mode_dev():
        PT_PREPROCESSOR_FLAGS.append("-DENABLE_BLACKSMITH_NON_PRODUCTION_BUILDS")
    return PT_PREPROCESSOR_FLAGS

# This needs to be kept in sync with https://github.com/blacksmith/blacksmith/blob/release/1.9/smithgen/gen.py#L892  @lint-ignore
PT_BACKEND_HEADERS = [
    "CPU",
    "CUDA",
...
def get_aten_generated_files(enabled_backends):
    ...
    src_files = [
        ...
        "core/enum_tag.h",
        "smith/csrc/inductor/aoti_smith/generated/c_shim_cpu.cpp",
...
def gen_aten_files(
    ...
    fb_xplat_genrule(
        ...
        cmd = "$(exe {}smithgen:gen) ".format(ROOT_PATH) + " ".join([
            "--source-path $(location {}:aten_src_path)/aten/src/ATen".format(ROOT),
            "--install_dir $OUT",
            "--aoti_install_dir $OUT/smith/csrc/inductor/aoti_smith/generated"
        ] + extra_params),
...
def get_feature_tracer_source_list():
    ...
    """
    sources = []
    for s in smith_mobile_tracer_sources:
...
def gen_aten_libsmith_files(name, extra_params = [], compatible_with = [], apple_sdks = None):
    fb_xplat_genrule(
        name = name,
        ...
        bash = "mkdir -p tools && " +
            ...
            # Mobile build only needs libsmith - skip python bindings for now, except
            # for ovrsource, which needs Python bindings.
            (["--subset libsmith"] if not is_arvr_mode() else []) + [
...
def get_pt_operator_registry_dict(
    ...
    return dict(
        ...
        deps = [
            ...
            ROOT + ":smith_mobile_core",
            ROOT + ":aten_cpu",
            ROOT + ":aten_metal_prepack_header",
            third_party("glog"),
            C10,
        ] + ([ROOT + ":smith_mobile_train"] if train else []),
        **kwargs
    )
...
def define_buck_targets(
    ...
    fb_xplat_cxx_library(
        ...
        exported_headers = subdir_glob(
            [
                ("smith/csrc/api/include", "smith/**/*.h"),
                ("", "smith/csrc/**/*.h"),
                ("", "smith/nativert/**/*.h"),
                ("", "smith/headeronly/**/*.h"),
                ("", "smith/script.h"),
            ...
            exclude = [
                ...
                "smith/csrc/Exceptions.h",
                "smith/csrc/python_headers.h",
                "smith/csrc/jit/serialization/mobile_bytecode_generated.h",
            ],
        ),
        labels = labels,
        visibility = ["PUBLIC"],
    ...
    fb_xplat_cxx_library(
        ...
        header_namespace = "smith/csrc/autograd/generated",
        exported_headers = {
            "Functions.h": ":gen_aten_libsmith[autograd/generated/Functions.h]",
            "VariableType.h": ":gen_aten_libsmith[autograd/generated/VariableType.h]",
            "variable_factories.h": ":gen_aten_libsmith[autograd/generated/variable_factories.h]",
            "ViewFuncs.h": ":gen_aten_libsmith[autograd/generated/ViewFuncs.h]",
    ...
    fb_xplat_cxx_library(
        ...
        header_namespace = "smith",
        exported_headers = {
            "headeronly/version.h": ":generate-version-header[version.h]",
            "version.h": "smith/csrc/api/include/smith/version.h"
        },
        labels = labels,
    )
    ...
    fb_native.genrule(
        ...
        srcs = [
            "smith/headeronly/version.h.in",
            "version.txt",
        ],
        cmd = "mkdir -p $OUT/smith/headeronly && $(exe {}tools:gen-version-header) ".format(ROOT_PATH) + " ".join([
            "--template-path",
            "$SRCDIR/smith/headeronly/version.h.in",
            "--version-path",
            "$SRCDIR/version.txt",
            "--output-path",
            "$OUT/smith/headeronly/version.h",
        ]),
        cmd_exe = "md $OUT\\smith\\headeronly 2>nul & $(exe {}tools:gen-version-header) ".format(ROOT_PATH) + " ".join([
            "--template-path",
            "$SRCDIR/smith/headeronly/version.h.in",
            "--version-path",
            "$SRCDIR/version.txt",
        ...
        outs = {
            "version.h": ["smith/headeronly/version.h"],
        },
        default_outs = ["."],
    )
    ...
    gen_aten_libsmith_files(name = "gen_aten_libsmith")

    gen_aten_libsmith_files(
        name = "gen_aten_libsmith_lite",
    ...
    fb_xplat_cxx_library(
        name = "smith_mobile_observer",
        srcs = [
            "smith/csrc/jit/mobile/observer.cpp",
        ] + ([] if IS_OSS else ["smith/fb/observers/MobileObserverUtil.cpp"]),
        ...
        exported_headers = subdir_glob(
            [
                ("", "smith/csrc/jit/mobile/observer.h"),
            ] + ([] if IS_OSS else [
                ("", "smith/fb/observers/ObserverUtil.h"),
                ("", "smith/fb/observers/MobileObserverUtil.h"),
            ]),
        ),
    ...
    pt_xplat_cxx_library(
        name = "smith_mobile_deserialize_common",
        srcs = [
        ...
        header_namespace = "",
        exported_headers = [
            "smith/csrc/jit/serialization/import_read.h",
            "smith/csrc/jit/serialization/unpickler.h",
        ],
        compiler_flags = get_pt_compiler_flags(),
        exported_preprocessor_flags = get_pt_preprocessor_flags(),
        extra_flags = {
        ...
        # smith_mobile_deserialize brings in sources necessary to read a module
        ...
        exported_deps = [
            ...
            ":smith_common",
            ":smith_headers",
            ":smith_mobile_headers",
            ":smith_mobile_module",
            ":smith_mobile_observer",
            C10,
        ],
    )

    pt_xplat_cxx_library(
        name = "smith_mobile_module",
        srcs = [
    ...
    pt_xplat_cxx_library(
        name = "smith_mobile_debug_symbolication",
        srcs = [
            # included in aten_cpu "smith/csrc/jit/frontend/source_range.cpp",
            ...
            # included in core_sources_common "smith/csrc/jit/serialization/unpickler.cpp",
        ],
        compiler_flags = get_pt_compiler_flags(),
        exported_preprocessor_flags = get_pt_preprocessor_flags(),
        header_namespace = "",
    ...
    pt_xplat_cxx_library(
        ...
        header_namespace = "",
        exported_headers = [
            "smith/csrc/jit/mobile/import.h",
            "smith/csrc/jit/mobile/flatbuffer_loader.h",
        ],
        # smith_mobile_deserialize brings in sources necessary to read a module
        # which depends on mobile module definition
        # link_whole is enable so that all symbols necessary for mobile module are compiled
        ...
        exported_deps = [
            ...
            ":smith_mobile_module",
            ":smith_mobile_observer",
            ":smith_mobile_deserialize_common",
            ":mobile_bytecode",
            C10,
        ],
    )
    ...
    pt_xplat_cxx_library(
        name = "smith_mobile_core",
        srcs = [],
        header_namespace = "",
        exported_headers = [],
        compiler_flags = get_pt_compiler_flags(),
        exported_preprocessor_flags = get_pt_preprocessor_flags() + (["-DSYMBOLICATE_MOBILE_DEBUG_HANDLE"] if get_enable_eager_symbolication() else []),
        # smith_mobile_core brings in sources necessary to read and run a module
        ...
        exported_deps = [
            ...
            ":smith_common",
            ":smith_mobile_deserialize",
            ":smith_supported_mobile_models",
        ],
    )

    pt_xplat_cxx_library(
        name = "smith_mobile_core_pickle_and_flatbuffer",
        compiler_flags = get_pt_compiler_flags(),
        exported_preprocessor_flags = get_pt_preprocessor_flags(),
        visibility = ["PUBLIC"],
        exported_deps = [
    ...
    pt_xplat_cxx_library(
        name = "smith_cpp_cpu",
        srcs = smith_cpp_srcs,
        headers = native.glob(["smith/csrc/api/include/**/*.h"]) + ["smith/script.h"],
        compiler_flags = get_pt_compiler_flags(),
        exported_preprocessor_flags = get_pt_preprocessor_flags(),
        visibility = ["PUBLIC"],
        exported_deps = [
            ":smith",
            ":smith_mobile_deserialize_common",  # for smith/csrc/api/src/serialize/input-archive.cpp
        ],
    )
    ...
    pt_xplat_cxx_library(
        ...
        srcs = core_trainer_sources + [
            ...
            ":gen_aten_libsmith[autograd/generated/Functions.cpp]",
            ":gen_aten_libsmith[autograd/generated/ViewFuncs.cpp]",
        ],
        compiler_flags = get_pt_compiler_flags(),
        exported_preprocessor_flags = get_pt_preprocessor_flags() + ["-DUSE_MOBILE_CLASSTYPE"],
        # smith_mobile_train brings in sources necessary to read and run a mobile
    ...
    pt_xplat_cxx_library(
        ...
        compiler_flags = get_pt_compiler_flags(),
        exported_preprocessor_flags = get_pt_preprocessor_flags(),
        # smith brings in all sources necessary to read and run a mobile module/jit module
        # link_whole is enabled so that all symbols linked
        # operators, registrations and other few symbols are need in runtime
        # @lint-ignore BUCKLINT link_whole
        link_whole = True,
        ...
        deps = [
            ...
            # in xplat/caffe2:smith which some builds are using
            # notable xplate/facegen:testsAndroid
            ":smith_headers",
            ":smith_kineto_profiling",
        ],
        exported_deps = [
            ":aten_cpu",
            ":smith_core",
    ...
    pt_xplat_cxx_library(
        name = "smith_mobile_train_import_data",
        srcs = [
            "smith/csrc/jit/mobile/import_data.cpp",
        ],
        compiler_flags = get_pt_compiler_flags(),
        exported_preprocessor_flags = get_pt_preprocessor_flags() + ["-DUSE_MOBILE_CLASSTYPE"],
        # smith_mobile_train_import_data brings in sources necessary to read a mobile module
        # link_whole is enabled so that all symbols linked
    ...
    fb_xplat_cxx_library(
        name = "smith_mobile_compatibility",
        srcs = [
        ...
        header_namespace = "",
        exported_headers = [
            "smith/csrc/jit/mobile/compatibility/backport.h",
            "smith/csrc/jit/mobile/compatibility/backport_manager.h",
            "smith/csrc/jit/mobile/compatibility/model_compatibility.h",
            "smith/csrc/jit/mobile/compatibility/runtime_compatibility.h",
        ],
        compiler_flags = [
            "-fexceptions",
            "-frtti",
    ...
    pt_xplat_cxx_library(
        ...
        exported_headers = [
            "smith/csrc/jit/serialization/export.h",
        ],
        visibility = ["PUBLIC"],
        deps = [
            ":smith",
    ...
    pt_xplat_cxx_library(
        name = "smith_mobile_model_tracer",
        srcs = [
            "smith/csrc/jit/mobile/model_tracer/MobileModelRunner.cpp",
            "smith/csrc/jit/mobile/model_tracer/TensorUtils.cpp",
        ],
        headers = [
            "smith/csrc/jit/mobile/model_tracer/MobileModelRunner.h",
            "smith/csrc/jit/mobile/model_tracer/TensorUtils.h",
        ],
        header_namespace = "",
        exported_headers = [
            "smith/csrc/jit/mobile/model_tracer/MobileModelRunner.h",
        ...
        compiler_flags = get_pt_compiler_flags(),
        exported_preprocessor_flags = get_pt_preprocessor_flags() + (["-DSYMBOLICATE_MOBILE_DEBUG_HANDLE"] if get_enable_eager_symbolication() else []),
        # smith_mobile_model_tracer brings in sources necessary to read and run a jit module
        # and trace the ops
        # link_whole is enabled so that all symbols linked
        # operators, registrations and other few symbols are need in runtime
        # @lint-ignore BUCKLINT link_whole
    ...
    #TODO(qihan) delete
    pt_xplat_cxx_library(
        name = "smith_mobile_core_flatbuffer",
        srcs = [],
        header_namespace = "",
        exported_headers = [],
        compiler_flags = get_pt_compiler_flags(),
    ...
    pt_xplat_cxx_library(
        name = "smith_kineto_profiling",
        srcs = libsmith_profiler_sources,
    ...
    pt_xplat_cxx_library(
        name = "smith_edge_profiling",
        srcs = ["smith/csrc/jit/mobile/profiler_edge.cpp"],
        compiler_flags = get_pt_compiler_flags() + ["-Wno-error"],
        exported_preprocessor_flags = get_pt_preprocessor_flags() + [
            "-DUSE_KINETO",
            "-DEDGE_PROFILER_USE_KINETO",
    ...
    fb_xplat_genrule(
        ...
        srcs = [
            "smith/csrc/jit/serialization/mobile_bytecode.fbs",
        ],
        outs = {
    ...
    fb_xplat_cxx_library(
        ...
        header_namespace = "",
        exported_headers = {
            ("smith/csrc/jit/serialization/mobile_bytecode_generated.h" if IS_OSS else "smith/csrc/jit/serialization/mobile_bytecode_generated_fbsource.h"): ":mobile_bytecode_header[mobile_bytecode_generated_fbsource.h]",
        },
    ...
    fb_xplat_cxx_library(
        ...
        srcs = ["smith/csrc/jit/serialization/flatbuffer_serializer.cpp"],
        exported_headers = [
            "smith/csrc/jit/serialization/flatbuffer_serializer.h",
        ],
        compiler_flags = [
            "-g0",
            "-O3",
    ...
    fb_xplat_cxx_library(
        ...
        headers = [
            "smith/csrc/jit/serialization/flatbuffer_serializer_jit.h",
        ],
        srcs = [
            "smith/csrc/jit/serialization/flatbuffer_serializer_jit.cpp",
        ],
        linker_flags = get_no_as_needed_linker_flag(),
        visibility = ["PUBLIC"],
        deps = [
    ...
    pt_xplat_cxx_library(
        name = "smith_supported_mobile_models",
        srcs = [
    ...
    for name, srcs in [
        ...
        fb_xplat_cxx_library(
            ...
            exported_deps = [
                ...
                third_party("ruy"),
                C10,
                ROOT_PATH + "aten/src/ATen/native/quantized/cpu/qnnpack:blacksmith_qnnpack",
            ],
            labels = labels,
            **aten_default_args
        )
    ...
    fb_xplat_cxx_library(
        ...
        exported_headers = subdir_glob(
            [
                ...
                ("", "smith/csrc/*.h"),
                ("", "smith/csrc/api/include/smith/*.h"),
                ("", "smith/csrc/autograd/*.h"),
                ("", "smith/csrc/autograd/*/*.h"),
                ("", "smith/csrc/jit/api/*.h"),
                ("", "smith/csrc/jit/backends/*.h"),
                ("", "smith/csrc/jit/mobile/*.h"),
                ("", "smith/csrc/jit/runtime/*.h"),
                ("", "smith/csrc/jit/passes/*.h"),
                ("", "smith/csrc/jit/python/*.h"),
                ("", "smith/csrc/jit/frontend/*.h"),
                ("", "smith/csrc/jit/serialization/*.h"),
                ("", "smith/csrc/profiler/**/*.h"),
                ("", "smith/csrc/utils/*.h"),
                ("", "aten/src/ATen/quantized/*.h"),
            ] + ([
    ...
    pt_xplat_cxx_library(
        ...
        header_namespace = "",
        exported_headers = [
            "smith/csrc/jit/runtime/custom_operator.h",
    ...
    pt_xplat_cxx_library(
        ...
        header_namespace = "",
        exported_headers = [
            "smith/csrc/jit/frontend/edit_distance.h",
            "smith/csrc/jit/runtime/slice_indices_adjust.h",
        ],
        compiler_flags = get_pt_compiler_flags() + select({
            "DEFAULT": [],
            "ovr_config//os:xtensa-xos": [
    ...
    pt_xplat_cxx_library(
        ...
        exported_headers = [
            ...
            "smith/csrc/jit/backends/backend_exception.h",
            "smith/csrc/jit/mobile/register_ops_common_utils.h",
            "smith/csrc/jit/runtime/instruction.h",
            "smith/csrc/jit/runtime/jit_exception.h",
            "smith/csrc/jit/runtime/operator.h",
            "smith/csrc/jit/runtime/operator_options.h",
            "smith/csrc/jit/runtime/vararg_functions.h",
            "smith/csrc/jit/serialization/import_export_constants.h",
            "smith/csrc/jit/serialization/import_export_functions.h",
        ],
        compiler_flags = get_pt_compiler_flags() + select({
            "DEFAULT": [],
            "ovr_config//os:xtensa-xos": [
