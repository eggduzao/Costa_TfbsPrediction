...
class C10_API intrusive_ptr_target {
  ...
  friend class smith::utils::PyObjectPreservation;
...
//      intrusive_ptr_target.");
 ...
 public:
  ...
  bool is_uniquely_owned() const noexcept {
    SMITH_INTERNAL_ASSERT_DEBUG_ONLY(target_ != NullType::singleton());
   ...
   *
   * TODO: https://github.com/blacksmith/blacksmith/issues/56482
   */
...
#else
    SMITH_INTERNAL_ASSERT_DEBUG_ONLY(!detail::has_pyobject(combined));
#endif
  }
}
