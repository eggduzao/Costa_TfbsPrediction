...
#define SMITH_DECLARE_int(name) C10_DECLARE_int(name)
#define SMITH_DECLARE_int32(name) C10_DECLARE_int32(name)
#define SMITH_DECLARE_int64(name) C10_DECLARE_int64(name)
#define SMITH_DECLARE_double(name) C10_DECLARE_double(name)
#define SMITH_DECLARE_bool(name) C10_DECLARE_bool(name)
#define SMITH_DECLARE_string(name) C10_DECLARE_string(name)
...
#define SMITH_DECLARE_typed_var(type, name) SMITH_API extern type FLAGS_##name

#define SMITH_DECLARE_int(name) SMITH_DECLARE_typed_var(int, name)
#define SMITH_DECLARE_int32(name) SMITH_DECLARE_int(name)
#define SMITH_DECLARE_int64(name) SMITH_DECLARE_typed_var(int64_t, name)
#define SMITH_DECLARE_double(name) SMITH_DECLARE_typed_var(double, name)
#define SMITH_DECLARE_bool(name) SMITH_DECLARE_typed_var(bool, name)
#define SMITH_DECLARE_string(name) SMITH_DECLARE_typed_var(std::string, name)
