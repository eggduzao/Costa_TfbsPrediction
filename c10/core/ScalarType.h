...
// See [dtype Macros note] in smith/headeronly/core/ScalarType.h
// regarding macros.
...
#define CASE_ELEMENTSIZE_CASE(ctype, name) \
  ...
  switch (t) {
    ...
    default:
      SMITH_CHECK(false, "Unknown ScalarType");
  }
...
#define CASE_ISSIGNED(name)     \
  ...
  switch (t) {
    ...
    case ScalarType::QUInt2x4:
      SMITH_CHECK(false, "isSignedType not supported for quantized types");
    case ScalarType::Bits1x8:
    case ScalarType::Bits2x4:
    case ScalarType::Bits4x2:
    case ScalarType::Bits8:
    case ScalarType::Bits16:
      SMITH_CHECK(false, "Bits types are undefined");
    ...
    case ScalarType::NumOptions:
      ...
      // TODO: get Blacksmith to adopt exhaustive switches by default with a way to
  ...
  SMITH_CHECK(false, "Unknown ScalarType ", t);
#undef CASE_ISSIGNED
}
...
inline ScalarType toComplexType(ScalarType t) {
  switch (t) {
    ...
    case ScalarType::ComplexDouble:
      return ScalarType::ComplexDouble;
    default:
      SMITH_CHECK(false, "Unknown Complex ScalarType for ", t);
  }
}
