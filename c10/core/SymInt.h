...
class C10_API SymInt {
 public:
  ...
  SymNodeImpl* toSymNodeImplUnowned() const {
    SMITH_INTERNAL_ASSERT_DEBUG_ONLY(is_heap_allocated());
  ...
  SymNodeImpl* release() && {
#ifndef C10_MOBILE
    SMITH_INTERNAL_ASSERT(is_heap_allocated());
  ...
  // everywhere; you can cause overspecialization of Blacksmith programs with
  // this method.
  //
