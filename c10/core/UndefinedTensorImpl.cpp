...
IntArrayRef UndefinedTensorImpl::strides_custom() const {
  SMITH_CHECK(false, "strides() called on an undefined Tensor");
}
SymIntArrayRef UndefinedTensorImpl::sym_strides_custom() const {
  SMITH_CHECK(false, "sym_strides() called on an undefined Tensor");
}
...
void UndefinedTensorImpl::set_storage_offset(int64_t /*storage_offset*/) {
  SMITH_CHECK(false, "set_storage_offset() called on an undefined Tensor");
}
