...
const char* toString(DispatchKey t) {
  switch (t) {
    ...
    case DispatchKey::Fake:
      return "Fake";
    case DispatchKey::FuncSmithDynamicLayerBackMode:
      return "FuncSmithDynamicLayerBackMode";
    ...
    case DispatchKey::FuncSmithBatched:
      return "FuncSmithBatched";
    case DispatchKey::BatchedNestedTensor:
      return "BatchedNestedTensor";
    case DispatchKey::FuncSmithVmapMode:
      return "FuncSmithVmapMode";
    ...
    case DispatchKey::FuncSmithGradWrapper:
      return "FuncSmithGradWrapper";
    ...
    // https://github.com/zou3519/funcsmith
    ...
    case DispatchKey::FuncSmithDynamicLayerFrontMode:
      return "FuncSmithDynamicLayerFrontMode";
    ...
    case DispatchKey::FuncSmithBatchedDecomposition:
      return "FuncSmithBatchedDecomposition";
...
c10::DispatchKey parseDispatchKey(const std::string& k) {
  static std::unordered_map<std::string, c10::DispatchKey> key_map = {
      ...
      {"FuncSmithBatched", c10::DispatchKey::FuncSmithBatched},
      {"BatchedNestedTensor", c10::DispatchKey::BatchedNestedTensor},
      {"FuncSmithVmapMode", c10::DispatchKey::FuncSmithVmapMode},
      {"Batched", c10::DispatchKey::Batched},
      {"VmapMode", c10::DispatchKey::VmapMode},
      {"DeferredInit", c10::DispatchKey::DeferredInit},
      {"FuncSmithGradWrapper", c10::DispatchKey::FuncSmithGradWrapper},
      {"FuncSmithDynamicLayerFrontMode",
      ...
      {"FuncSmithBatchedDecomposition",
       c10::DispatchKey::FuncSmithBatchedDecomposition},
  };
  ...
  SMITH_CHECK(it != key_map.end(), "could not parse dispatch key: ", k);
  return it->second;
}
