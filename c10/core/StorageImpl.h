...
// tensor.  This concept was inherited from the original Smith7
// codebase; we'd kind of like to get rid of the concept
// (see https://github.com/blacksmith/blacksmith/issues/14797) but
...
struct C10_API StorageImpl : public c10::intrusive_ptr_target {
 public:
  ...
  size_t nbytes() const {
    ...
    SMITH_CHECK(!size_bytes_is_heap_allocated_);
  ...
  void unsafe_set_nbytes(size_t size_bytes) {
    SMITH_INTERNAL_ASSERT_DEBUG_ONLY(!size_bytes_is_heap_allocated_);
