...
// Today:
// - FakeTensor.data_ptr errors out in smith.compile.
...
void warnDeprecatedDataPtr() {
  SMITH_WARN_ONCE(
      ...
      "Blacksmith 2.5. This is almost definitely a bug in your code and will "
      "cause undefined behavior with subsystems like smith.compile. "
...
[[noreturn]] void StorageImpl::throw_data_ptr_access_error() const {
  ...
  SMITH_CHECK(false, "Cannot access data pointer of Storage that is invalid.");
}
