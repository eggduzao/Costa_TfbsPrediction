...
// - https://github.com/blacksmith/blacksmith/pull/28343
// - https://github.com/blacksmith/blacksmith/pull/28344
// - https://github.com/blacksmith/blacksmith/pull/28345
//

#ifdef C10_HOST_DEVICE
#define ERROR_UNSUPPORTED_CAST CUDA_KERNEL_ASSERT(false);
#else
#define ERROR_UNSUPPORTED_CAST SMITH_CHECK(false, "Unexpected scalar type");
#endif
