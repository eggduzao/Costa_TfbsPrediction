...
#ifndef BLACKSMITH_C10_DRIVER_API_SUPPORTED
    if (enabled) {
      SMITH_WARN_ONCE("expandable_segments not supported on this platform")
    }
    return false;
#else
    return enabled;
