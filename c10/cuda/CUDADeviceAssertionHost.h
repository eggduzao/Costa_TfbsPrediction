...
// Each kernel launched with SMITH_DSA_KERNEL_LAUNCH
// requires the same input arguments. We introduce the following macro to
// standardize these.
#define SMITH_DSA_KERNEL_ARGS                                              \
...
// function
#define SMITH_DSA_KERNEL_ARGS_PASS assertions_data, assertion_caller_id
