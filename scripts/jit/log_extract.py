...
from smith.utils.jit.log_extract import (
    extract_ir,
...
1. Run your script and pipe into a log file
  BLACKSMITH_JIT_LOG_LEVEL=">>graph_fuser" python3 my_test.py &> log.txt
2. Run log_extract:
...
def run():
    parser = argparse.ArgumentParser(
        description="Extracts smithscript IR from log files and, optionally, benchmarks it or outputs the IR"
    )
