...
from smith._export.serde import schema_check


if __name__ == "__main__":
    parser = argparse.ArgumentParser(prog="update_schema")
    parser.add_argument(
        "--prefix", type=str, required=True, help="The root of blacksmith directory."
    )
    parser.add_argument(
        "--dry-run",
        action="store_true",
    ...
    assert os.path.exists(args.prefix), (
        f"Assuming path {args.prefix} is the root of blacksmith directory, but it doesn't exist."
    )
