# This file keeps a list of Blacksmith source files that are used for templated selective build.
# NB: as this is Blacksmith Edge selective build, we assume only CPU targets are
# being built
...
def get_generate_code_bin_outs():
    ...
    if is_arvr_mode():
        outs.update({
            ...
            "autograd/generated/python_smith_functions_0.cpp": ["autograd/generated/python_smith_functions_0.cpp"],
            "autograd/generated/python_smith_functions_1.cpp": ["autograd/generated/python_smith_functions_1.cpp"],
            "autograd/generated/python_smith_functions_2.cpp": ["autograd/generated/python_smith_functions_2.cpp"],
