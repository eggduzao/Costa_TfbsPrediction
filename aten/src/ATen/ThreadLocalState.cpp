...
ThreadLocalState::ThreadLocalState()
    : dispatch_key_(c10::impl::tls_local_dispatch_key_set()),
      ...
      rf_tls_(at::get_record_function_tls_()), funcsmith_tls_(funcsmith::getCopyOfFuncSmithTLS()),
      autograd_tls_(c10::AutogradState::get_tls_state()),
      smith_dispatch_mode_state_(c10::impl::SmithDispatchModeTLS::get_state()), python_dispatcher_state_(c10::impl::PythonDispatcherTLS::get_state()),
      python_smith_function_state_(at::impl::PythonSmithFunctionTLS::get_state()),
...
void ThreadLocalState::setThreadLocalState(
  ...
  c10::impl::SmithDispatchModeTLS::set_state(state.smith_dispatch_mode_state_);

  at::impl::PythonSmithFunctionTLS::set_state(state.python_smith_function_state_);
  ...
  funcsmith::setFuncSmithTLS(state.funcsmith_tls_);
