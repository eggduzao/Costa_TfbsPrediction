...
struct SMITH_API PrivateUse1HooksInterface : AcceleratorHooksInterface {
...
struct SMITH_API PrivateUse1HooksArgs {};

SMITH_API void RegisterPrivateUse1HooksInterface(
