...
// tensor. The `values_` tensor can be of any blacksmith-supported data type
// and has shape `(nnz())`.
//
...
// Since the MKL interface for blacksmith currently uses indexing with int32
...
// for indexing.
struct SMITH_API SparseCsrTensorImpl : public TensorImpl {
 ...
 public:
  ...
  void set_layout(Layout layout) {
    switch (layout) {
      ...
      case kSparseBsc:
        ...
        break;
      default:
        SMITH_CHECK(false, "unsupported layout ", layout);
    }
  }
  ...
  c10::intrusive_ptr<TensorImpl> shallow_copy_and_detach_core(
    ...
    if (mode_stack_len > 0 &&
      ...
      interpreter = cur_smith_dispatch_mode_state->pyinterpreter();
    } else if (
