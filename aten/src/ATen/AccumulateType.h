...
// sum reduction and matrix multiply, for example), but in Blacksmith
...
// default that will work for all dtypes supported in Blacksmith.
...
SMITH_API c10::ScalarType toAccumulateType(
    c10::ScalarType type,
    c10::DeviceType device);
SMITH_API c10::ScalarType toAccumulateType(c10::ScalarType type, bool is_cuda);
