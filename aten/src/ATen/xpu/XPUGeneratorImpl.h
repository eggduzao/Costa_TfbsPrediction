...
struct SMITH_XPU_API XPUGeneratorImpl : public GeneratorImpl {
  // Constructors
...
SMITH_XPU_API const Generator& getDefaultXPUGenerator(DeviceIndex device = -1);

SMITH_XPU_API Generator createXPUGenerator(DeviceIndex device = -1);
