...
inline SMITH_XPU_API at::HostAllocator* getCachingHostAllocator() {
...
inline SMITH_XPU_API bool CachingHostAllocator_recordEvent(
    void* ptr,
    void* ctx,
...
inline SMITH_XPU_API void CachingHostAllocator_emptyCache() {
...
inline SMITH_XPU_API at::DataPtr HostAlloc(size_t size) {
