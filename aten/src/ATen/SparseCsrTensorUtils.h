...
inline std::string layoutToString(
  ...
  switch (layout) {
    ...
    default:
      SMITH_CHECK(false, "Not a sparse compressed layout:", layout);
      return "";
  }
}
...
inline bool only_sparse_compressed_binary_op_trivial_cases(
  ...
  SMITH_INTERNAL_ASSERT(at::sparse_csr::is_sparse_compressed(self));
  SMITH_INTERNAL_ASSERT(at::sparse_csr::is_sparse_compressed(other));
  SMITH_INTERNAL_ASSERT(at::sparse_csr::is_sparse_compressed(out));
