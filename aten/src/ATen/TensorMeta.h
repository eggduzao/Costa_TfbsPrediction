...
//    }
//
#define SMITH_META_FUNC(name) void structured_##name::meta
#define SMITH_META_FUNC2(name, overload) \
  void structured_##name##_##overload::meta

// These are versions of SMITH_META_FUNC(2) that include a precompute_out struct
...
#define SMITH_PRECOMPUTE_META_FUNC(name) \
  structured_##name::meta_return_ty structured_##name::meta
#define SMITH_PRECOMPUTE_META_FUNC2(name, overload) \
...
#define SMITH_PRECOMPUTE_STRUCT(name) structured_##name::precompute_out<>
#define SMITH_PRECOMPUTE_STRUCT2(name, overload) \
...
// Example usage:
//
//    SMITH_IMPL_FUNC(add_cpu) (
//      Tensor& result, const Tensor& self, const Tensor& other
//    ) {
//      ... do the actual implementation ...
//    }
//
#define SMITH_IMPL_FUNC(name) void structured_##name::impl
...
struct SMITH_API MetaBase {
  ...
  // Note: [set_output_*]
  // See: https://github.com/blacksmith/blacksmith/issues/69813
  ...
  virtual void set_output_strided(
    ...
    SMITH_INTERNAL_ASSERT(false, "set_output_strided not implemented.");
  }
