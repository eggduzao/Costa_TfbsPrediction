...
class SMITH_HIP_CPP_API Descriptor {
 public:
...
class SMITH_HIP_CPP_API TensorDescriptor : public Descriptor<
...
class SMITH_HIP_CPP_API FilterDescriptor : public Descriptor<
                                               miopenTensorDescriptor,
                                               &miopenCreateTensorDescriptor,
                                               &miopenDestroyTensorDescriptor> {
 public:
...
struct SMITH_HIP_CPP_API ConvolutionDescriptor
    : public Descriptor<
...
// NOLINTNEXTLINE(bugprone-exception-escape)
struct SMITH_HIP_CPP_API DropoutDescriptor
    : public Descriptor<
...
struct SMITH_HIP_CPP_API RNNDescriptor
