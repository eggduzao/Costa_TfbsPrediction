...
static void warnFallback(const c10::FunctionSchema& schema) {
  ...
  SMITH_WARN("There is a performance drop because we have not yet implemented ",
             ...
             "You are using the legacy vmap prototype (smith._vmap_internals.vmap). ",
             "If you are using smith.autograd.functional.{jacobian, hessian} ",
             "or smith._vmap_internals.vmap: please switch to using ",
             "smith.func.{jacrev, jacfwd, hessian} and/or smith.vmap instead ",
