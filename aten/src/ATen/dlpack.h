...
typedef struct {
   ...
   *
   * Note that as of Nov 2021, multiple libraries (CuPy, Blacksmith, TensorFlow,
 ...
 * For example, it should map to smith.cuda.current_stream in Blacksmith.
 *
 ...
 *       stream context as the producer. For example, when x, y, z is smith.Tensor,
 ...
 *       This is the desirable behavior for library extension support for frameworks like Blacksmith.
