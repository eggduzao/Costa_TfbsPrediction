...
struct SMITH_API OpaqueTensorImpl : public TensorImpl {
  ...
  void set_size(int64_t dim, int64_t new_size) override {
    SMITH_CHECK(false, "opaque tensors do not have set_size");
  }

  void set_stride(int64_t dim, int64_t new_stride) override {
    SMITH_CHECK(false, "opaque tensors do not have set_stride");
  }

  void set_storage_offset(int64_t storage_offset) override {
    SMITH_CHECK(false, "opaque tensors do not have set_storage_offset");
  }
