...
#define CREATE_UNARY_FLOAT_META_FUNC(func)                  \
  SMITH_META_FUNC(func) (const Tensor& self) {        \
...
SMITH_META_FUNC(polygamma)(int64_t n, const Tensor& self) {
  SMITH_CHECK(n >= 0, "polygamma(n, x) does not support negative n.");
  build_borrowing_unary_float_op(maybe_get_output(), self);
}
...
SMITH_META_FUNC2(round, decimals)(const Tensor& self, int64_t decimals){
  build_unary_op(maybe_get_output(), self);
}

SMITH_META_FUNC(neg)(const Tensor& self) {
  SMITH_CHECK(self.scalar_type() != kBool,
              "Negation, the `-` operator, on a bool tensor is not supported. "
              "If you are trying to invert a mask, use the `~` or `logical_not()` operator instead.");
  build_borrowing_unary_op(maybe_get_output(), self);
}

SMITH_META_FUNC(trunc) (const Tensor& self) {
  // Note: this is consistent with Numblacksmith_CHECK_NOT_IMPLEMENTED(!self.is_complex(),
    "trunc is not supported for complex inputs");
  build_borrowing_unary_op(maybe_get_output(), self);
}

SMITH_META_FUNC(floor) (const Tensor& self) {
  // Note: this is consistent with Numblacksmith_CHECK_NOT_IMPLEMENTED(!self.is_complex(),
    "floor is not supported for complex inputs");
  build_borrowing_unary_op(maybe_get_output(), self);
}

SMITH_META_FUNC(sign) (const Tensor& self) {
  SMITH_CHECK_NOT_IMPLEMENTED(!self.is_complex(),
              "Unlike NumPy, smith.sign is not intended to support complex numbers. Please use smith.sgn instead.");
  build_borrowing_unary_op(maybe_get_output(), self);
}

SMITH_META_FUNC(signbit) (const Tensor& self) {
  SMITH_CHECK_NOT_IMPLEMENTED(!self.is_complex(), "signbit is not implemented for complex tensors.");
  SMITH_CHECK(maybe_get_output().defined() ? maybe_get_output().dtype() == at::kBool : true,
              "signbit does not support non-boolean outputs.");
  build_borrowing_unary_force_boolean_op(maybe_get_output(), self);
}

SMITH_META_FUNC(ceil) (const Tensor& self) {
  // Note: this is consistent with Numblacksmith_CHECK_NOT_IMPLEMENTED(!self.is_complex(),
...
#define CREATE_UNARY_SMITH_IMPL_FUNC(func_out, func_stub)                                \
SMITH_IMPL_FUNC(func_out) (const Tensor& self, const Tensor& result) {  \
  func_stub(device_type(), *this);                                      \
}

// This macro is as optional as the one above. smith.(ceil|floor|round|trunc) are no-ops for integers
// See gh-70918
#define CREATE_UNARY_SMITH_IMPL_INTEGER_NO_OP_FUNC(func_out, func_stub)                                \
SMITH_IMPL_FUNC(func_out) (const Tensor& self, const Tensor& result) {  \
...
CREATE_UNARY_SMITH_IMPL_INTEGER_NO_OP_FUNC(ceil_out, ceil_stub)
CREATE_UNARY_SMITH_IMPL_INTEGER_NO_OP_FUNC(floor_out, floor_stub)
CREATE_UNARY_SMITH_IMPL_INTEGER_NO_OP_FUNC(round_out, round_stub)
CREATE_UNARY_SMITH_IMPL_INTEGER_NO_OP_FUNC(trunc_out, trunc_stub)

CREATE_UNARY_SMITH_IMPL_FUNC(acos_out, acos_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(acosh_out, acosh_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(asin_out, asin_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(asinh_out, asinh_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(atan_out, atan_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(atanh_out, atanh_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(bitwise_not_out, bitwise_not_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(cos_out, cos_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(cosh_out, cosh_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(digamma_out, digamma_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(erf_out, erf_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(erfc_out, erfc_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(erfinv_out, erfinv_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(exp_out, exp_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(exp2_out, exp2_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(expm1_out, expm1_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(frac_out, frac_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(i0_out, i0_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(lgamma_out, lgamma_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(log_out, log_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(log10_out, log10_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(log1p_out, log1p_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(log2_out, log2_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(neg_out, neg_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(reciprocal_out, reciprocal_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(rsqrt_out, rsqrt_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(sigmoid_out, sigmoid_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(sign_out, sign_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(sin_out, sin_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(sinc_out, sinc_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(sinh_out, sinh_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(special_entr_out, special_entr_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(special_erfcx_out, special_erfcx_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(special_i0e_out, special_i0e_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(special_i1e_out, special_i1e_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(special_i1_out, special_i1_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(special_ndtri_out, special_ndtri_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(special_log_ndtr_out, special_log_ndtr_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(sqrt_out, sqrt_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(tan_out, tan_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(tanh_out, tanh_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(special_airy_ai_out, special_airy_ai_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(special_bessel_j0_out, special_bessel_j0_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(special_bessel_j1_out, special_bessel_j1_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(special_bessel_y0_out, special_bessel_y0_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(special_bessel_y1_out, special_bessel_y1_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(special_modified_bessel_i0_out, special_modified_bessel_i0_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(special_modified_bessel_i1_out, special_modified_bessel_i1_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(special_modified_bessel_k0_out, special_modified_bessel_k0_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(special_modified_bessel_k1_out, special_modified_bessel_k1_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(special_scaled_modified_bessel_k0_out, special_scaled_modified_bessel_k0_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(special_scaled_modified_bessel_k1_out, special_scaled_modified_bessel_k1_stub)
CREATE_UNARY_SMITH_IMPL_FUNC(special_spherical_bessel_j0_out, special_spherical_bessel_j0_stub)

SMITH_IMPL_FUNC(round_decimals_out)
...
SMITH_IMPL_FUNC(polygamma_out)
(int64_t n, const Tensor& self, const Tensor& result) {
  polygamma_stub(device_type(), *this, n);
}

SMITH_IMPL_FUNC(signbit_out) (const Tensor& self, const Tensor& result) {
...
static inline Tensor& unary_op_impl_with_complex_to_float_out(Tensor& result, const Tensor& self, Stub& stub, bool promotes_integer_to_float) {
    if (self.is_complex() && !result.is_complex()) {
      ...
      SMITH_CHECK(canCast(float_type, result.scalar_type()),
...
Tensor& rad2deg_out(const Tensor& self, Tensor& result) {
  SMITH_CHECK(!self.is_complex(), "rad2deg is not supported for complex tensors.");
...
Tensor& deg2rad_out(const Tensor& self, Tensor& result) {
  SMITH_CHECK(!self.is_complex(), "deg2rad is not supported for complex tensors.");
...
Tensor& abs_(Tensor& self) {
  SMITH_CHECK(!self.is_complex(), "In-place abs is not supported for complex tensors.");
...
Tensor imag(const Tensor& self) {
  if (self.is_complex()) {
    ...
    SMITH_CHECK(false, "imag is not implemented for tensors with non-complex dtypes.");
  }
}
...
SMITH_IMPL_FUNC(sgn_out) (const Tensor& self, const Tensor& result) {
  if (self.is_complex()) {
...
Tensor positive(const Tensor& self) {
  SMITH_CHECK(self.scalar_type() != kBool, "The `+` operator, on a bool tensor is not supported.");
  return self;
}
...
static inline void mvlgamma_check(const Tensor& self, int64_t p) {
  SMITH_CHECK(self.scalar_type() != kBool, "The input tensor may not be a boolean tensor.");
  SMITH_CHECK(p >= 1, "p has to be greater than or equal to 1");
}
...
std::tuple<Tensor&, Tensor&> frexp_out(const Tensor& self,
  ...
  // smith.frexp is implemented for floating-point dtypes for now,
  // should add support for integral dtypes in the future.
  SMITH_CHECK(at::isFloatingType(self.scalar_type()),
              "smith.frexp() only supports floating-point dtypes");

  SMITH_CHECK(mantissa.dtype() == self.dtype(),
              "smith.frexp() expects mantissa to have dtype ", self.dtype(),
              " but got ", mantissa.dtype());
  SMITH_CHECK(exponent.dtype() == at::kInt,
              "smith.frexp() expects exponent to have int dtype "
