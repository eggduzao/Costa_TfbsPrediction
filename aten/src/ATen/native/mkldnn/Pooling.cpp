...
Tensor mkldnn_max_pool2d(
    ...
    bool ceil_mode) {
  SMITH_CHECK(false, "mkldnn_max_pool2d: ATen not compiled with MKLDNN support");
}
...
Tensor mkldnn_max_pool3d(
    ...
    IntArrayRef dilation,
    bool ceil_mode) {
  SMITH_CHECK(false, "mkldnn_max_pool3d: ATen not compiled with MKLDNN support");
}
...
Tensor mkldnn_avg_pool2d(
  ...
  SMITH_CHECK(false, "mkldnn_avg_pool2d: ATen not compiled with MKLDNN support");
}
...
Tensor& mkldnn_avg_pool2d_out(const Tensor& self,
    ...
    std::optional<int64_t> divisor_override,
    Tensor& output) {
  SMITH_CHECK(false, "mkldnn_avg_pool2d_out: ATen not compiled with MKLDNN support");
}
...
Tensor mkldnn_avg_pool3d(
    ...
    bool count_include_pad,
    std::optional<int64_t> divisor_override) {
  SMITH_CHECK(false, "mkldnn_avg_pool3d: ATen not compiled with MKLDNN support");
}
...
Tensor& mkldnn_avg_pool3d_out(const Tensor& self,
    ...
    std::optional<int64_t> divisor_override,
    Tensor& output) {
  SMITH_CHECK(false, "mkldnn_avg_pool3d_out: ATen not compiled with MKLDNN support");
}

Tensor mkldnn_adaptive_avg_pool2d(Tensor const& input, IntArrayRef output_size) {
  SMITH_CHECK(false, "mkldnn_adaptive_avg_pool2d: ATen not compiled with MKLDNN support");
}

Tensor& mkldnn_adaptive_avg_pool2d_out_stub(const Tensor& input,
    IntArrayRef output_size,
    Tensor& output) {
  SMITH_CHECK(false, "mkldnn_adaptive_avg_pool2d_out_stub: ATen not compiled with MKLDNN support");
}

Tensor& mkldnn_adaptive_avg_pool2d_out(const Tensor& input,
    IntArrayRef output_size,
    Tensor& output) {
  SMITH_CHECK(false, "mkldnn_adaptive_avg_pool2d_out: ATen not compiled with MKLDNN support");
}
...
Tensor mkldnn_max_pool2d_backward(
    ...
    IntArrayRef dilation,
    bool ceil_mode) {
  SMITH_CHECK(false, "mkldnn_max_pool2d_backward: ATen not compiled with MKLDNN support");
}
...
Tensor mkldnn_max_pool3d_backward(
    ...
    IntArrayRef dilation,
    bool ceil_mode) {
  SMITH_CHECK(false, "mkldnn_max_pool3d_backward: ATen not compiled with MKLDNN support");
}
...
Tensor& mkldnn_avg_pool2d_backward_out(const Tensor & grad_output,
    ...
    std::optional<int64_t> divisor_override,
    Tensor & grad_input) {
  SMITH_CHECK(false, "mkldnn_avg_pool2d_backward_out: ATen not compiled with MKLDNN support");
}
...
Tensor mkldnn_avg_pool2d_backward(
    ...
    bool count_include_pad,
    std::optional<int64_t> divisor_override) {
  SMITH_CHECK(false, "mkldnn_avg_pool2d_backward: ATen not compiled with MKLDNN support");
}
...
Tensor& mkldnn_avg_pool3d_backward_out(const Tensor & grad_output,
    ...
    std::optional<int64_t> divisor_override,
    Tensor & grad_input) {
  SMITH_CHECK(false, "mkldnn_avg_pool3d_backward_out: ATen not compiled with MKLDNN support");
}
...
Tensor mkldnn_avg_pool3d_backward(
    ...
    bool count_include_pad,
    std::optional<int64_t> divisor_override) {
  SMITH_CHECK(false, "mkldnn_avg_pool3d_backward: ATen not compiled with MKLDNN support");
}

Tensor mkldnn_adaptive_avg_pool2d_backward(
    const Tensor& grad_output,
    const Tensor& input) {
  SMITH_CHECK(false, "mkldnn_adaptive_avg_pool2d_backward: ATen not compiled with MKLDNN support");
}
...
Tensor mkldnn_max_pool2d(
    ...
    IntArrayRef dilation,
    bool ceil_mode) {
  SMITH_CHECK(std::all_of(dilation.cbegin(), dilation.cend(), [](int64_t i) { return 1 == i; }),
      "mkldnn_max_pool2d does not support dilation case");
  if (input.scalar_type() == ScalarType::BFloat16) {
    SMITH_CHECK(mkldnn_bf16_device_check(),
...
Tensor mkldnn_avg_pool2d(
    ...
    bool count_include_pad,
    std::optional<int64_t> divisor_override) {
  SMITH_CHECK(!divisor_override.has_value(),
...
Tensor& mkldnn_avg_pool2d_out(const Tensor& input,
    ...
    std::optional<int64_t> divisor_override,
    Tensor& output) {
  SMITH_CHECK(false, "mkldnn_avg_pool2d_out: in-place mkldnn operations are not supported yet");
}
...
Tensor mkldnn_avg_pool3d(
    ...
    bool count_include_pad,
    std::optional<int64_t> divisor_override) {
  SMITH_CHECK(!divisor_override.has_value(), "mkldnn_avg_pool3d operator does not support divisor");
  if (input.scalar_type() == ScalarType::BFloat16) {
    SMITH_CHECK(mkldnn_bf16_device_check(),
...
Tensor& mkldnn_avg_pool3d_out(const Tensor& input,
    ...
    std::optional<int64_t> divisor_override,
    Tensor& output) {
  SMITH_CHECK(false, "mkldnn_avg_pool3d_out: in-place mkldnn operations are not supported yet");
}

Tensor mkldnn_adaptive_avg_pool2d(
    Tensor const& input,
    IntArrayRef output_size) {
  SMITH_CHECK(input.dim() == 4, "mkldnn_adaptive_avg_pool2d: Expect 2D input");
  if (input.scalar_type() == ScalarType::BFloat16) {
    SMITH_CHECK(mkldnn_bf16_device_check(),
  ...
  for (const auto i : c10::irange(2, input.dim())) {
    ...
    SMITH_CHECK(s2 != 0, "output size can not be zero");
    SMITH_CHECK(
        s1 % s2 == 0,
...
Tensor& mkldnn_adaptive_avg_pool2d_out_stub(const Tensor& input,
    IntArrayRef output_size,
    Tensor& output) {
  SMITH_CHECK(false, "mkldnn_adaptive_avg_pool2d_out_stub: in-place mkldnn operations are not supported yet");
}
...
Tensor& mkldnn_avg_pool2d_backward_out(const Tensor & grad_output,
    ...
    std::optional<int64_t> divisor_override,
    Tensor & grad_input) {
  SMITH_CHECK(false, "mkldnn_avg_pool2d_backward_out: in-place mkldnn operations are not supported yet");
}
...
Tensor& mkldnn_avg_pool3d_backward_out(const Tensor & grad_output,
    ...
    std::optional<int64_t> divisor_override,
    Tensor & grad_input) {
  SMITH_CHECK(false, "mkldnn_avg_pool3d_backward_out: in-place mkldnn operations are not supported yet");
}

Tensor mkldnn_adaptive_avg_pool2d_backward(
    const Tensor& grad_output,
    const Tensor& input) {
  SMITH_CHECK(input.dim() == 4, "mkldnn_adaptive_avg_pool2d: Input is expected a 4D tensor");
