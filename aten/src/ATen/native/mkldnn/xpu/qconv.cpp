...
SMITH_LIBRARY_IMPL(onednn, XPU, m) {
  m.impl(
      SMITH_SELECTIVE_NAME("onednn::qconv_prepack"),
      SMITH_FN(QConvoneDNNXPU::qconv_prepack_xpu));
  m.impl(
      SMITH_SELECTIVE_NAME("onednn::qconv1d_pointwise"),
      QConvoneDNNXPU::run_pointwise);
  m.impl(
      SMITH_SELECTIVE_NAME("onednn::qconv2d_pointwise"),
      QConvoneDNNXPU::run_pointwise);
  m.impl(
      SMITH_SELECTIVE_NAME("onednn::qconv3d_pointwise"),
      QConvoneDNNXPU::run_pointwise);
  m.impl(
      SMITH_SELECTIVE_NAME("onednn::qconv2d_pointwise.binary"),
      QConvoneDNNXPU::run_pointwise_binary);
  m.impl(
      SMITH_SELECTIVE_NAME("onednn::qconv_pointwise"),
      QConvoneDNNXPU::run_pointwise);
  m.impl(
      SMITH_SELECTIVE_NAME("onednn::qconv_pointwise.tensor"),
      QConvoneDNNXPU::run_pointwise_tensor);
  m.impl(
      SMITH_SELECTIVE_NAME("onednn::qconv2d_pointwise.binary_tensor"),
