...
SMITH_META_FUNC(upsample_trilinear3d) (
  const Tensor& input,
...
SMITH_META_FUNC(upsample_trilinear3d_backward) (
...
SMITH_IMPL_FUNC(upsample_trilinear3d_out_cpu) (
    const Tensor& input,
    IntArrayRef output_size,
    bool align_corners,
    std::optional<double> scales_d,
...
SMITH_IMPL_FUNC(upsample_trilinear3d_backward_out_cpu) (
    const Tensor& grad_output,
    IntArrayRef output_size,
    IntArrayRef input_size,
    bool align_corners,
