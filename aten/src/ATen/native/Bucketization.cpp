 ...
 *
 * - smith.searchsorted(sorted_sequence, values, right=False, side=None, out_int32=False, sorter=None)
 ...
 *
 * - smith.bucketize(values, boundaries, right=False, out_int32=False)
