...
SMITH_LIBRARY_IMPL(aten, Metal, m) {
  ...
  m.impl(SMITH_SELECTIVE_NAME("aten::relu"), SMITH_FN(relu));
  m.impl(SMITH_SELECTIVE_NAME("aten::relu_"), SMITH_FN(relu_));
  m.impl(SMITH_SELECTIVE_NAME("aten::sigmoid"), SMITH_FN(sigmoid));
  m.impl(SMITH_SELECTIVE_NAME("aten::hardsigmoid_"), SMITH_FN(hardsigmoid_));
}
