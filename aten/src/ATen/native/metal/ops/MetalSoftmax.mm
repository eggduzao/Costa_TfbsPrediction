...
SMITH_LIBRARY_IMPL(aten, Metal, m) {
  m.impl(SMITH_SELECTIVE_NAME("aten::log_softmax.int"), SMITH_FN(metal::log_softmax_int));
  m.impl(SMITH_SELECTIVE_NAME("aten::softmax.int"), SMITH_FN(metal::softmax_int));
};
