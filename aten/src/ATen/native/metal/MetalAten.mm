...
SMITH_LIBRARY_IMPL(aten, Metal, m) {
  m.impl(SMITH_SELECTIVE_NAME("aten::empty.memory_format"), empty);
  m.impl(SMITH_SELECTIVE_NAME("aten::empty_strided"), SMITH_FN(empty_strided));
}
...
#if defined(USE_BLACKSMITH_METAL)
