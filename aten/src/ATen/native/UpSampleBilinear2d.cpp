...
SMITH_META_FUNC(upsample_bilinear2d) (
...
SMITH_META_FUNC(upsample_bilinear2d_backward) (
...
SMITH_META_FUNC(_upsample_bilinear2d_aa) (
  const Tensor& input, IntArrayRef output_size, bool align_corners, std::optional<double> scales_h, std::optional<double> scales_w
) {
  auto full_output_size = native::upsample_2d_common_check(input.sizes(), output_size);
...
SMITH_META_FUNC(_upsample_bilinear2d_aa_backward) (
  const Tensor& grad_output,
  IntArrayRef output_size,
  IntArrayRef input_size,
  bool align_corners,
...
SMITH_IMPL_FUNC(upsample_bilinear2d_out_cpu) (
    const Tensor& input,
    IntArrayRef output_size,
    bool align_corners,
    std::optional<double> scales_h,
...
SMITH_IMPL_FUNC(upsample_bilinear2d_backward_out_cpu) (
    const Tensor& grad_output,
    IntArrayRef output_size,
    IntArrayRef input_size,
    bool align_corners,
...
SMITH_IMPL_FUNC(_upsample_bilinear2d_aa_out_cpu) (
    const Tensor& input,
    IntArrayRef output_size,
    bool align_corners,
    std::optional<double> scales_h,
...
SMITH_IMPL_FUNC(_upsample_bilinear2d_aa_backward_out_cpu) (
    const Tensor& grad_output,
    IntArrayRef output_size,
    IntArrayRef input_size,
    bool align_corners,
