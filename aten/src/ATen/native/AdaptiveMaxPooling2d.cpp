...
namespace at::meta {
SMITH_META_FUNC(adaptive_max_pool2d) (const Tensor& input, IntArrayRef output_size) {
  int ndim = input.ndimension();
  SMITH_CHECK(ndim == 3 || ndim == 4,
  ...
  SMITH_CHECK(output_size.size() == 2,
...
SMITH_META_FUNC(adaptive_max_pool2d_backward)
...
SMITH_IMPL_FUNC(adaptive_max_pool2d_out_cpu)
...
SMITH_IMPL_FUNC(adaptive_max_pool2d_backward_out_cpu)
