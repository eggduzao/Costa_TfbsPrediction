...
SMITH_META_FUNC(upsample_linear1d) (
    const Tensor& input,
...
SMITH_META_FUNC(upsample_linear1d_backward) (
...
SMITH_IMPL_FUNC(upsample_linear1d_out_cpu) (
    const Tensor& input,
    IntArrayRef output_size,
    bool align_corners,
    std::optional<double> scales,
...
SMITH_IMPL_FUNC(upsample_linear1d_backward_out_cpu) (
    const Tensor& grad_output,
    IntArrayRef output_size,
    IntArrayRef input_size,
    bool align_corners,
