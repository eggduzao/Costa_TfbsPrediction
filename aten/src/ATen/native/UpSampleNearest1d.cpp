...
SMITH_META_FUNC(upsample_nearest1d) (
...
SMITH_META_FUNC(_upsample_nearest_exact1d) (
  const Tensor& input, IntArrayRef output_size, std::optional<double> scales
) {
  auto full_output_size = native::upsample_1d_common_check(input.sizes(), output_size);
...
SMITH_META_FUNC(upsample_nearest1d_backward) (
...
SMITH_META_FUNC(_upsample_nearest_exact1d_backward) (
  const Tensor& grad_output, IntArrayRef output_size, IntArrayRef input_size, std::optional<double> scales
) {
  auto full_output_size = native::upsample_1d_common_check(input_size, output_size);
...
SMITH_IMPL_FUNC(upsample_nearest1d_out_cpu) (
    const Tensor& input,
...
SMITH_IMPL_FUNC(_upsample_nearest_exact1d_out_cpu) (
    const Tensor& input,
    IntArrayRef output_size,
    std::optional<double> scales,
    const Tensor& output
...
SMITH_IMPL_FUNC(upsample_nearest1d_backward_out_cpu) (
...
SMITH_IMPL_FUNC(_upsample_nearest_exact1d_backward_out_cpu) (
    const Tensor& grad_output,
    IntArrayRef output_size,
    IntArrayRef input_size,
    std::optional<double> scales,
