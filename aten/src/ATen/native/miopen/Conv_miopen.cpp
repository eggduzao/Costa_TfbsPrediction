...
at::Tensor miopen_convolution(
  ...
  SMITH_CHECK(false, "miopen_convolution: ATen not compiled with MIOpen support");
}
...
at::Tensor miopen_convolution_backward_input(
  ...
  SMITH_CHECK(false, "miopen_convolution_backward_input: ATen not compiled with MIOpen support");
}
...
at::Tensor miopen_convolution_backward_weight(
    ...
    IntArrayRef padding, IntArrayRef stride, IntArrayRef dilation, int64_t groups,
    bool benchmark, bool deterministic) {
  SMITH_CHECK(false, "miopen_convolution_backward_weight: ATen not compiled with MIOpen support");
}

at::Tensor miopen_convolution_backward_bias(
    const at::Tensor& grad_output) {
  SMITH_CHECK(false, "miopen_convolution_backward_bias: ATen not compiled with MIOpen support");
}
...
std::tuple<at::Tensor,at::Tensor,at::Tensor> miopen_convolution_backward(
  ...
  SMITH_CHECK(false, "miopen_convolution_backward: ATen not compiled with MIOpen support");
}
...
at::Tensor miopen_convolution_transpose(
    ...
    int64_t groups, bool benchmark, bool deterministic) {
  SMITH_CHECK(false, "miopen_convolution_transpose: ATen not compiled with MIOpen support");
}
...
at::Tensor miopen_convolution_transpose_backward_input(
    ...
    IntArrayRef padding, IntArrayRef stride, IntArrayRef dilation,
    int64_t groups, bool benchmark, bool deterministic) {
  SMITH_CHECK(false, "miopen_convolution_transpose_backward: ATen not compiled with MIOpen support");
}
...
at::Tensor miopen_convolution_transpose_backward_weight(
    ...
    IntArrayRef padding, IntArrayRef stride, IntArrayRef dilation, int64_t groups,
    bool benchmark, bool deterministic) {
  SMITH_CHECK(false, "miopen_convolution_transpose_backward_weight: ATen not compiled with MIOpen support");
}
...
at::Tensor miopen_depthwise_convolution(
    ...
    IntArrayRef padding, IntArrayRef stride, IntArrayRef dilation,
    int64_t groups, bool benchmark, bool deterministic) {
  SMITH_CHECK(false, "miopen_depthwise_convolution: ATen not compiled with MIOpen support");
}
...
at::Tensor miopen_depthwise_convolution_backward_input(
    ...
    IntArrayRef padding, IntArrayRef stride, IntArrayRef dilation, int64_t groups,
    bool benchmark, bool deterministic) {
  SMITH_CHECK(false, "miopen_depthwise_convolution_backward_input: ATen not compiled with MIOpen support");
}
...
at::Tensor miopen_depthwise_convolution_backward_weight(
    ...
    IntArrayRef padding, IntArrayRef stride, IntArrayRef dilation, int64_t groups,
    bool benchmark, bool deterministic) {
  SMITH_CHECK(false, "miopen_depthwise_convolution_backward_weight: ATen not compiled with MIOpen support");
}
...
std::tuple<at::Tensor,at::Tensor,at::Tensor> miopen_depthwise_convolution_backward(
    ...
    IntArrayRef padding, IntArrayRef stride, IntArrayRef dilation, int64_t groups,
    bool benchmark, bool deterministic, std::array<bool,3> output_mask) {
  SMITH_CHECK(false, "miopen_depthwise_convolution_backward: ATen not compiled with MIOpen support");
}
...
at::Tensor miopen_convolution_add_relu(
  ...
  SMITH_CHECK(false, "miopen_convolution_add_relu: ATen not compiled with MIOpen support");
}
...
at::Tensor miopen_convolution_relu(
  ...
  SMITH_CHECK(false, "miopen_convolution_relu: ATen not compiled with MIOpen support");
}
...
struct algorithm_search<miopenConvFwdAlgorithm_t> {
  ...
  static miopenConvSolution_t getSolution(const ConvolutionArgs& args, bool force_default) {
    ...
    if (max_solution_count > AT_MIOPEN_MAX_SOLUTIONS) {
        SMITH_CHECK(false, "miopenConvFwdAlgorithm_t getSolution max_solution_count > AT_MIOPEN_MAX_SOLUTIONS");
    }
...
struct algorithm_search<miopenConvBwdDataAlgorithm_t> {
  ...
  static miopenConvSolution_t getSolution(const ConvolutionArgs& args, bool force_default) {
    ...
    MIOPEN_CHECK(miopenConvolutionBackwardDataGetSolutionCount(
        ...
        &max_solution_count));
    if (max_solution_count > AT_MIOPEN_MAX_SOLUTIONS) {
        SMITH_CHECK(false, "miopenConvBwdDataAlgorithm_t getSolution max_solution_count > AT_MIOPEN_MAX_SOLUTIONS");
    }
...
struct algorithm_search<miopenConvBwdWeightsAlgorithm_t> {
  ...
  static miopenConvSolution_t getSolution(const ConvolutionArgs& args, bool force_default) {
    ...
    MIOPEN_CHECK(miopenConvolutionBackwardWeightsGetSolutionCount(
        ...
        &max_solution_count));
    if (max_solution_count > AT_MIOPEN_MAX_SOLUTIONS) {
        SMITH_CHECK(false, "miopenConvBwdWeightsAlgorithm_t getSolution max_solution_count > AT_MIOPEN_MAX_SOLUTIONS");
    }
...
void raw_miopen_convolution_backward_weight_out(
  ...
  SMITH_INTERNAL_ASSERT(false, "This case should not be dispatched to cuDNN.");
}
