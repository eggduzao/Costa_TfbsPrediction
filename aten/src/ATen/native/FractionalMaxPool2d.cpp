...
namespace meta {
SMITH_META_FUNC(fractional_max_pool2d) (
  ...
  SMITH_CHECK(outputH + poolSizeH - 1 <= inputH,
    "fractional_max_pool2d(): pool height ", poolSizeH,
    " too large relative to input height ", inputH);
  SMITH_CHECK(outputW + poolSizeW - 1 <= inputW,
...
SMITH_META_FUNC(fractional_max_pool2d_backward)(
  ...
  SMITH_CHECK(gradOutput.sizes().equals(expectedOutputShape),
    "fractional_max_pool2d_backward(): gradOutput sizes unexpected");
  SMITH_CHECK(indices.sizes().equals(expectedOutputShape),
...
SMITH_IMPL_FUNC(fractional_max_pool2d_out_cpu) (
...
SMITH_IMPL_FUNC(fractional_max_pool2d_backward_cpu) (
  const at::Tensor& gradOutput_,
  const at::Tensor& input,
  IntArrayRef pool_size,
  IntArrayRef output_size,
