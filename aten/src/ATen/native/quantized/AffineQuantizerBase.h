...
template <typename T>
SMITH_API T quantize_val(double scale, int64_t zero_point, float value);
...
template <typename T>
SMITH_API float dequantize_vec(
    double scale,
    int64_t zero_point,
    const T* src,
    float* dst,
...
SMITH_API DST_T requantize_val(double /*src_scale*/, int64_t /*src_zero_point*/, double /*dst_scale*/, int64_t /*dst_zero_point*/, SRC_T src);
