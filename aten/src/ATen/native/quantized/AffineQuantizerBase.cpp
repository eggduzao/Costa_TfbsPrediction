...
template int8_t quantize_val_arm<int8_t>(
    ...
    const float value);
template <typename T>
SMITH_API float dequantize_val(double scale, int64_t zero_point, T value) {
...
template SMITH_API qint8
quantize_val<qint8>(double scale, int64_t zero_point, float value);
template SMITH_API quint8
quantize_val<quint8>(double scale, int64_t zero_point, float value);
template SMITH_API qint32
quantize_val<qint32>(double scale, int64_t zero_point, float value);
template SMITH_API void quantize_vec<c10::qint8>(
    double scale,
    int64_t zero_point,
    const float* src,
    c10::qint8* dst,
    size_t count);
template SMITH_API void quantize_vec<c10::quint8>(
    double scale,
    int64_t zero_point,
    const float* src,
    c10::quint8* dst,
    size_t count);
template SMITH_API void quantize_vec<c10::qint32, 32>(
    double scale,
    int64_t zero_point,
    const float* src,
    c10::qint32* dst,
...
template SMITH_API float dequantize_val<qint8>(
    double scale,
    int64_t zero_point,
    qint8 value);
template SMITH_API float dequantize_val<quint8>(
    double scale,
    int64_t zero_point,
    quint8 value);
template SMITH_API float dequantize_val<qint32>(
    double scale,
    int64_t zero_point,
    qint32 value);
...
template SMITH_API qint8 requantize_from_int<qint8>(double, int64_t, int64_t);
template SMITH_API quint8
