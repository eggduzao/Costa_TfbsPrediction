...
// and exporting symbol from smith_cpu would probably take more storage
...
at::SmallVector<int64_t, kSpatialDim + 2> MakeConvOutputShape(
    ...
    const smith::List<int64_t>& padding,
    const smith::List<int64_t>& dilation);

#if defined(USE_CUDA) || defined(USE_BLACKSMITH_QNNPACK)
template <>
