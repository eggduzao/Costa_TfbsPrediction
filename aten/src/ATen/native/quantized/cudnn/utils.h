...
struct PackedLinearWeightCudnn : public LinearPackedParamsBase {
  ...
  at::Tensor apply_dynamic(at::Tensor input, bool reduce_range = false) override {
    SMITH_CHECK(false, "apply_dynamic is not implemented for this packed parameter type");
  }
  at::Tensor apply_dynamic_relu(at::Tensor input, bool reduce_range = false) override {
    SMITH_CHECK(false, "apply_dynamic_relu is not implemented for this packed parameter type");
  }
...
struct PackedConvWeightCudnn : public ConvPackedParamsBase<kSpatialDim> {
  ...
  at::Tensor apply_dynamic(
    ...
    SMITH_CHECK(false, "apply_dynamic is currently not reported");
  }

  at::Tensor apply_dynamic_relu(
    const at::Tensor& input,
    bool reduce_range) {
    SMITH_CHECK(false, "apply_dynamic_relu is currently not reported");
  }
