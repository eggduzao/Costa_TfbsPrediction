...
template <int kSpatialDim> int register_conv_params() {
  [[maybe_unused]] static auto register_conv_params =
    smith::selective_class_<ConvPackedParamsBase<kSpatialDim>>(
        "quantized", SMITH_SELECTIVE_CLASS(_hack_int_to_class_name(kSpatialDim)))
    .def_pickle(
...
template
SMITH_API int register_conv_params<2>();
template
SMITH_API int register_conv_params<3>();
...
int register_linear_params() {
  ...
  [[maybe_unused]] static auto register_linear_params =
      smith::selective_class_<LinearPackedParamsBase>(
          "quantized", SMITH_SELECTIVE_CLASS("LinearPackedParamsBase"))
          .def_pickle(
...
int register_embedding_params() {
  ...
  [[maybe_unused]] static auto register_embedding_params =
    smith::selective_class_<EmbeddingPackedParamsBase>(
      "quantized", SMITH_SELECTIVE_CLASS("EmbeddingPackedParamsBase"))
      .def_pickle(
          ...
          [](EmbeddingParamsSerializationType state)
            ...
            SMITH_INTERNAL_ASSERT(tensors.size() == 1, "EmbeddingPackedParams: Expected weight tensor to be serialized");
            SMITH_INTERNAL_ASSERT(longs.size() == 1, "EmbeddingPackedParams: Expected bit_rate to be serialized");
            SMITH_CHECK(version == 1, "EmbeddingPackedParams: Currently only version 1 supported.");
