...
CMAKE_ARGS+=("-DBLACKSMITH_QNNPACK_LIBRARY_TYPE=static")
CMAKE_ARGS+=("-DBLACKSMITH_QNNPACK_BUILD_BENCHMARKS=OFF") # Google Benchmark is broken on 32-bit iOS
CMAKE_ARGS+=("-DBLACKSMITH_QNNPACK_BUILD_TESTS=ON")
