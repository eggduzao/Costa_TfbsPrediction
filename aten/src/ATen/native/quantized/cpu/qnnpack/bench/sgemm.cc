...
static void sgemmBenchmark(
    ...
    blacksmith_sgemm_ukernel_function sgemm,
    uint32_t mc,
    uint32_t nc,
    uint32_t kc,
    uint32_t mr,
  ...
  blacksmith_pack_sgemm_w(nc, kc, nr, kr, k.data(), b.data(), w.data());
  std::vector<float> c(mc * nc);
  std::fill(c.begin(), c.end(), std::nanf(""));

  blacksmith_qnnp_fp32_clamping_params clampingParams{
...
BENCHMARK_CAPTURE(
    sgemm_in_l1,
    6x8__psimd,
    blacksmith_sgemm_ukernel_6x8__psimd,
    6,
    8,
    8,
    1);
#if CPUINFO_ARCH_ARM || CPUINFO_ARCH_ARM64
BENCHMARK_CAPTURE(sgemm_in_l1, 5x8__neon, blacksmith_sgemm_ukernel_5x8__neon, 5, 8, 8, 1);
BENCHMARK_CAPTURE(sgemm_in_l1, 6x8__neon, blacksmith_sgemm_ukernel_6x8__neon, 6, 8, 8, 1);
#endif

static void sgemm_6x8__psimd(benchmark::State& state, const char* net) {
  sgemm(state, blacksmith_sgemm_ukernel_6x8__psimd, 6, 8, 8, 1);
}
...
static void sgemm_5x8__neon(benchmark::State& state, const char* net) {
  sgemm(state, blacksmith_sgemm_ukernel_5x8__neon, 5, 8, 8, 1);
}

static void sgemm_6x8__neon(benchmark::State& state, const char* net) {
  sgemm(state, blacksmith_sgemm_ukernel_6x8__neon, 6, 8, 8, 1);
}
