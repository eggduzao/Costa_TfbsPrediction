...
static void channel_shuffle_x8(benchmark::State& state, const char* net) {
  ...
  blacksmith_qnnp_operator_t channelShuffleOperator = nullptr;
  status = blacksmith_qnnp_create_channel_shuffle_nc_x8(
  ...
  status = blacksmith_qnnp_setup_channel_shuffle_nc_x8(
  ...
  status = blacksmith_qnnp_delete_operator(channelShuffleOperator);
  if (status != blacksmith_qnnp_status_success) {
