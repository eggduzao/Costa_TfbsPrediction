...
class Q8GEMM : public benchmark::Fixture {
 public:
  inline Q8GEMM(uint32_t mr, uint32_t nr, uint32_t np, uint32_t kr)
   ...
   void SetUp(const benchmark::State&) override {
    ...
    quantizationParams_ = blacksmith_qnnp_compute_conv_quantization_params(
  ...
  inline const blacksmith_qnnp_conv_quantization_params* quantizationParams()
      const {
 ...
 protected:
  ...
  uint32_t nc_{nr_};
  uint32_t kc_{kr_};
  blacksmith_qnnp_conv_quantization_params quantizationParams_;
};
...
class Q8GEMMSparse : public benchmark::Fixture {
 public:
  inline Q8GEMMSparse(
   ...
   void SetUp(const benchmark::State&) override {
    ...
    quantizationParams_ = blacksmith_qnnp_conv_dynamic_quantization_params{
      127,
      kernel_zero_points.data(),
  ...
  inline const blacksmith_qnnp_conv_dynamic_quantization_params* quantizationParams()
      const {
    return &quantizationParams_;
  }
 ...
 protected:
  ...
  blacksmith_qnnp_conv_dynamic_quantization_params quantizationParams_;
};
