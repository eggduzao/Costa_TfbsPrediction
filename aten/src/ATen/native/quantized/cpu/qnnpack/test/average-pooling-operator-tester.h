 ...
 public:
  ...
  void testQ8() const {
    ...
    for (size_t iteration = 0; iteration < iterations(); iteration++) {
      ...
      blacksmith_qnnp_operator_t averagePoolingOp = nullptr;

      ASSERT_EQ(
          blacksmith_qnnp_status_success,
          blacksmith_qnnp_create_average_pooling2d_nhwc_q8(
              paddingHeight(),
              paddingWidth(),
              poolingHeight(),
              poolingWidth(),
      ...
      ASSERT_EQ(
          blacksmith_qnnp_status_success,
          blacksmith_qnnp_setup_average_pooling2d_nhwc_q8(
              averagePoolingOp,
              batchSize(),
              inputHeight(),
              inputWidth(),
      ...
      ASSERT_EQ(
          blacksmith_qnnp_status_success,
          blacksmith_qnnp_delete_operator(averagePoolingOp));
