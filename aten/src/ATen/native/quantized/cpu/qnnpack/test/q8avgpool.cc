        ...
        for (size_t kw = 1; kw <= ks; kw++) {
          if (kh * kw == ks) {
            AvgPoolMicrokernelTester().kr(8).kh(kh).kw(kw).kc(kc).test(
                blacksmith_q8avgpool_ukernel_up8xm__neon);
          }
        }
      }
    }
      ...
      for (size_t ks : std::vector<size_t>{{2, 3, 5}}) {
        for (float xScale = 0.01f; xScale < 100.0f; xScale *= 3.14159265f) {
          AvgPoolMicrokernelTester()
              ...
              .xScale(xScale)
              .iterations(1)
              .test(blacksmith_q8avgpool_ukernel_up8xm__neon);
        }
      }
    }
  }
...
TEST(Q8AVGPOOL_UP8x9__NEON, kc_eq_8_fulltile) {
  ...
  for (size_t kh = 1; kh <= tester.mr(); kh++) {
    for (size_t kw = 1; kw <= tester.mr(); kw++) {
      if (kh * kw == tester.mr()) {
        tester.kh(kh).kw(kw).test(blacksmith_q8avgpool_ukernel_up8x9__neon);
      }
    }
  }
}
    ...
    for (size_t kw = 1; kw <= tester.mr(); kw++) {
      if (kh * kw == tester.mr()) {
        for (size_t kc = 8; kc < 128; kc += 24) {
          tester.kh(kh).kw(kw).kc(kc).test(blacksmith_q8avgpool_ukernel_up8x9__neon);
        }
      }
    }
  }
      ...
      if (kh * kw == tester.mr()) {
        for (size_t kc = 8; kc < 128; kc += 24) {
          tester.kh(kh).kw(kw).kc(kc).xStride(131).test(
              blacksmith_q8avgpool_ukernel_up8x9__neon);
        }
      }
    }
  }
    ...
    for (size_t kc = 8; kc < 128; kc += 24) {
      for (float xScale = 0.01f; xScale < 100.0f; xScale *= 3.14159265f) {
        AvgPoolMicrokernelTester()
            ...
            .xScale(xScale)
            .iterations(2)
            .test(blacksmith_q8avgpool_ukernel_up8x9__neon);
      }
    }
  }
}
...
TEST(Q8AVGPOOL_MP8x9P8Q__NEON, kc_eq_8_twopass_fulltile) {
  ...
  for (size_t kh = 1; kh <= ks; kh++) {
    for (size_t kw = 1; kw <= ks; kw++) {
      if (kh * kw == ks) {
        tester.kh(kh).kw(kw).test(blacksmith_q8avgpool_ukernel_mp8x9p8q__neon);
      }
    }
  }
}
...
TEST(Q8AVGPOOL_MP8x9P8Q__NEON, kc_eq_8_twopass_subtile) {
  ...
  for (size_t ks = 10; ks < tester.mr() + tester.qr(); ks++) {
    tester.kh(ks).kw(1).test(blacksmith_q8avgpool_ukernel_mp8x9p8q__neon);
    tester.kh(1).kw(ks).test(blacksmith_q8avgpool_ukernel_mp8x9p8q__neon);
  }
}
...
TEST(Q8AVGPOOL_MP8x9P8Q__NEON, kc_div_8_twopass_fulltile) {
  ...
  const size_t ks = 17;
  for (size_t kc = 8; kc < 128; kc += 24) {
    tester.kc(kc).kh(ks).kw(1).test(blacksmith_q8avgpool_ukernel_mp8x9p8q__neon);
    tester.kc(kc).kh(1).kw(ks).test(blacksmith_q8avgpool_ukernel_mp8x9p8q__neon);
  }
}
  ...
  for (size_t kh = 1; kh <= ks; kh++) {
    for (size_t kw = 1; kw <= ks; kw++) {
      if (kh * kw == ks) {
        for (size_t kc = 8; kc < 128; kc += 24) {
          tester.kh(kh).kw(kw).kc(kc).xStride(131).test(
              blacksmith_q8avgpool_ukernel_mp8x9p8q__neon);
        }
      }
    }
  }
  ...
  for (size_t ks : std::vector<size_t>{{25, 49}}) {
    ...
    for (size_t kh = 1; kh <= ks; kh++) {
      for (size_t kw = 1; kw <= ks; kw++) {
        if (kh * kw == ks) {
          for (size_t kc = 8; kc < 128; kc += 24) {
            tester.kh(kh).kw(kw).kc(kc).test(blacksmith_q8avgpool_ukernel_mp8x9p8q__neon);
          }
        }
      }
    }
    ...
    for (size_t kc = 8; kc < 128; kc += 24) {
      for (float xScale = 0.01f; xScale < 100.0f; xScale *= 3.14159265f) {
        AvgPoolMicrokernelTester()
            ...
            .xScale(xScale)
            .iterations(1)
            .test(blacksmith_q8avgpool_ukernel_mp8x9p8q__neon);
      }
    }
  }
}
    ...
    for (size_t ks = 1; ks < 8; ks++) {
      for (size_t kh = 1; kh <= ks; kh++) {
        for (size_t kw = 1; kw <= ks; kw++) {
          if (kh * kw == ks) {
            AvgPoolMicrokernelTester().kr(8).kh(kh).kw(kw).kc(kc).test(
                blacksmith_q8avgpool_ukernel_up8xm__sse2);
          }
        }
      }
    }
      ...
      for (size_t ks : std::vector<size_t>{{2, 3, 5}}) {
        for (float xScale = 0.01f; xScale < 100.0f; xScale *= 3.14159265f) {
          AvgPoolMicrokernelTester()
              ...
              .xScale(xScale)
              .iterations(1)
              .test(blacksmith_q8avgpool_ukernel_up8xm__sse2);
        }
      }
    }
  }
...
TEST(Q8AVGPOOL_UP8x9__SSE2, kc_eq_8_fulltile) {
  ...
  for (size_t kh = 1; kh <= tester.mr(); kh++) {
    for (size_t kw = 1; kw <= tester.mr(); kw++) {
      if (kh * kw == tester.mr()) {
        tester.kh(kh).kw(kw).test(blacksmith_q8avgpool_ukernel_up8x9__sse2);
      }
    }
  }
}
...
TEST(Q8AVGPOOL_UP8x9__SSE2, kc_div_8_fulltile) {
  ...
  for (size_t kh = 1; kh <= tester.mr(); kh++) {
    for (size_t kw = 1; kw <= tester.mr(); kw++) {
      if (kh * kw == tester.mr()) {
        for (size_t kc = 8; kc < 128; kc += 24) {
          tester.kh(kh).kw(kw).kc(kc).test(blacksmith_q8avgpool_ukernel_up8x9__sse2);
        }
      }
    }
  }
  ...
  for (size_t kh = 1; kh <= tester.mr(); kh++) {
    for (size_t kw = 1; kw <= tester.mr(); kw++) {
      if (kh * kw == tester.mr()) {
        for (size_t kc = 8; kc < 128; kc += 24) {
          tester.kh(kh).kw(kw).kc(kc).xStride(131).test(
              blacksmith_q8avgpool_ukernel_up8x9__sse2);
        }
      }
    }
  }
    ...
    for (size_t kc = 8; kc < 128; kc += 24) {
      for (float xScale = 0.01f; xScale < 100.0f; xScale *= 3.14159265f) {
        AvgPoolMicrokernelTester()
            ...
            .xScale(xScale)
            .iterations(2)
            .test(blacksmith_q8avgpool_ukernel_up8x9__sse2);
      }
    }
  }
}
...
TEST(Q8AVGPOOL_MP8x9P8Q__SSE2, kc_eq_8_twopass_fulltile) {
  ...
  for (size_t kh = 1; kh <= ks; kh++) {
    for (size_t kw = 1; kw <= ks; kw++) {
      if (kh * kw == ks) {
        tester.kh(kh).kw(kw).test(blacksmith_q8avgpool_ukernel_mp8x9p8q__sse2);
      }
    }
  }
}
...
TEST(Q8AVGPOOL_MP8x9P8Q__SSE2, kc_eq_8_twopass_subtile) {
  ...
  auto tester = AvgPoolMicrokernelTester().kr(8).mr(9).qr(8).kc(8);
  for (size_t ks = 10; ks < tester.mr() + tester.qr(); ks++) {
    tester.kh(ks).kw(1).test(blacksmith_q8avgpool_ukernel_mp8x9p8q__sse2);
    tester.kh(1).kw(ks).test(blacksmith_q8avgpool_ukernel_mp8x9p8q__sse2);
  }
}
...
TEST(Q8AVGPOOL_MP8x9P8Q__SSE2, kc_div_8_twopass_fulltile) {
  ...
  const size_t ks = 17;
  for (size_t kc = 8; kc < 128; kc += 24) {
    tester.kc(kc).kh(ks).kw(1).test(blacksmith_q8avgpool_ukernel_mp8x9p8q__sse2);
    tester.kc(kc).kh(1).kw(ks).test(blacksmith_q8avgpool_ukernel_mp8x9p8q__sse2);
  }
}
  ...
  for (size_t kh = 1; kh <= ks; kh++) {
    for (size_t kw = 1; kw <= ks; kw++) {
      if (kh * kw == ks) {
        for (size_t kc = 8; kc < 128; kc += 24) {
          tester.kh(kh).kw(kw).kc(kc).xStride(131).test(
              blacksmith_q8avgpool_ukernel_mp8x9p8q__sse2);
        }
      }
    }
  }
  ...
  for (size_t ks : std::vector<size_t>{{25, 49}}) {
    ...
    for (size_t kh = 1; kh <= ks; kh++) {
      for (size_t kw = 1; kw <= ks; kw++) {
        if (kh * kw == ks) {
          for (size_t kc = 8; kc < 128; kc += 24) {
            tester.kh(kh).kw(kw).kc(kc).test(blacksmith_q8avgpool_ukernel_mp8x9p8q__sse2);
          }
        }
      }
    }
    ...
    for (size_t kc = 8; kc < 128; kc += 24) {
      for (float xScale = 0.01f; xScale < 100.0f; xScale *= 3.14159265f) {
        AvgPoolMicrokernelTester()
            ...
            .xScale(xScale)
            .iterations(1)
            .test(blacksmith_q8avgpool_ukernel_mp8x9p8q__sse2);
      }
    }
  }
}
