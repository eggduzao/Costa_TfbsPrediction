...
TEST(Q8DWCONV_UP8x9__NEON, single_output_channels_eq_8) {
  ...
  DWConvMicrokernelTester()
      ...
      .channels(8)
      .width(1)
      .test(blacksmith_q8dwconv_ukernel_up8x9__neon);
}
...
TEST(Q8DWCONV_MP8x25__NEON, single_output_channels_eq_8) {
  ...
  DWConvMicrokernelTester()
      ...
      .channels(8)
      .width(1)
      .test(blacksmith_q8dwconv_ukernel_mp8x25__neon);
}
...
TEST(Q8DWCONV_UP8x9__NEON, single_output_channels_eq_8_per_channel) {
  ...
  DWConvMicrokernelTester()
      ...
      .channels(8)
      .width(1)
      .test(blacksmith_q8dwconv_ukernel_up8x9_per_channel__neon, true);
}
...
TEST(Q8DWCONV_MP8x25__NEON, single_output_channels_eq_8_per_channel) {
  ...
  DWConvMicrokernelTester()
      ...
      .channels(8)
      .width(1)
      .test(blacksmith_q8dwconv_ukernel_mp8x25_per_channel__neon, true);
}
...
TEST(Q8DWCONV_UP8x9__AARCH32_NEON, single_output_channels_eq_8) {
  ...
  DWConvMicrokernelTester()
      ...
      .channels(8)
      .width(1)
      .test(blacksmith_q8dwconv_ukernel_up8x9__aarch32_neon);
}
...
TEST(Q8DWCONV_UP8x9__AARCH32_NEON, single_output_channels_eq_8_per_channel) {
  ...
  DWConvMicrokernelTester()
      ...
      .channels(8)
      .width(1)
      .test(blacksmith_q8dwconv_ukernel_up8x9_per_channel__aarch32_neon, true);
}
...
TEST(Q8DWCONV_UP8x9__SSE2, single_output_channels_eq_8) {
  ...
  DWConvMicrokernelTester()
      ...
      .channels(8)
      .width(1)
      .test(blacksmith_q8dwconv_ukernel_up8x9__sse2);
}
...
TEST(Q8DWCONV_MP8x25__SSE2, single_output_channels_eq_8) {
  ...
  DWConvMicrokernelTester()
      ...
      .channels(8)
      .width(1)
      .test(blacksmith_q8dwconv_ukernel_mp8x25__sse2);
}
...
TEST(Q8DWCONV_UP8x9__SSE2, single_output_channels_eq_8_per_channel) {
  ...
  DWConvMicrokernelTester()
      ...
      .channels(8)
      .width(1)
      .test(blacksmith_q8dwconv_ukernel_up8x9_per_channel__sse2, true);
}
...
TEST(Q8DWCONV_MP8x25__SSE2, single_output_channels_eq_8_per_channel) {
  ...
  DWConvMicrokernelTester()
      ...
      .channels(8)
      .width(1)
      .test(blacksmith_q8dwconv_ukernel_mp8x25_per_channel__sse2, true);
}
