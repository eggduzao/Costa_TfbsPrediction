...
TEST(Q8VADD__SSE2, n_eq_8) {
  ...
  VAddMicrokernelTester().n(8).test(blacksmith_q8vadd_ukernel__sse2);
}

TEST(Q8VADD__SSE2, n_div_8) {
  TEST_REQUIRES_X86_SSE2;
  for (size_t n = 8; n < 128; n += 24) {
    VAddMicrokernelTester().n(n).test(blacksmith_q8vadd_ukernel__sse2);
  }
}
...
TEST(Q8VADD__SSE2, inplace_a) {
  ...
  for (size_t n = 1; n < 128; n += 11) {
    VAddMicrokernelTester().iterations(1).n(n).inplaceA(true).test(
        blacksmith_q8vadd_ukernel__sse2);
  }
}
...
TEST(Q8VADD__SSE2, inplace_a_and_b) {
  ...
  for (size_t n = 1; n < 128; n += 11) {
    VAddMicrokernelTester()
        ...
        .inplaceA(true)
        .inplaceB(true)
        .test(blacksmith_q8vadd_ukernel__sse2);
  }
}
...
TEST(Q8VADD__NEON, n_eq_8) {
  ...
  VAddMicrokernelTester().n(8).test(blacksmith_q8vadd_ukernel__neon);
}

TEST(Q8VADD__NEON, n_div_8) {
  TEST_REQUIRES_ARM_NEON;
  for (size_t n = 8; n < 128; n += 24) {
    VAddMicrokernelTester().n(n).test(blacksmith_q8vadd_ukernel__neon);
  }
}
...
TEST(Q8VADD__NEON, inplace_a) {
  ...
  for (size_t n = 1; n < 128; n += 11) {
    VAddMicrokernelTester().iterations(1).n(n).inplaceA(true).test(
        blacksmith_q8vadd_ukernel__neon);
  }
}
...
TEST(Q8VADD__NEON, inplace_a_and_b) {
  ...
  for (size_t n = 1; n < 128; n += 11) {
    VAddMicrokernelTester()
        ...
        .inplaceA(true)
        .inplaceB(true)
        .test(blacksmith_q8vadd_ukernel__neon);
  }
}
