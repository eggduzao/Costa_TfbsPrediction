...
class MaxPoolMicrokernelTester {
 public:
  ...
  void test(blacksmith_u8maxpool_ukernel_function u8maxpool) const {
    ...
    for (size_t iteration = 0; iteration < iterations(); iteration++) {
      ...
      const union blacksmith_qnnp_u8_clamping_params clampingParams =
          blacksmith_qnnp_compute_u8_clamping_params(qmin(), qmax());
