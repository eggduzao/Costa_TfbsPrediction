  ...
  for (size_t kc = 1; kc < 16; kc++) {
    for (size_t ks = 2; ks < 16; ks++) {
      MaxPoolMicrokernelTester().kr(16).kh(ks).kw(1).kc(kc).test(
          blacksmith_u8maxpool_ukernel_sub16__neon);
    }
  }
}
    ...
    for (size_t ks : std::vector<size_t>{{2, 3, 5}}) {
      for (size_t kc = 1; kc < 16; kc++) {
        MaxPoolMicrokernelTester()
            ...
            .kc(kc)
            .iterations(3)
            .test(blacksmith_u8maxpool_ukernel_sub16__neon);
      }
    }
  }
}
...
TEST(U8MAXPOOL_16x9P8Q__NEON, kc_eq_16_unipass_fulltile) {
  ...
  for (size_t kh = 1; kh <= tester.mr(); kh++) {
    for (size_t kw = 1; kw <= tester.mr(); kw++) {
      if (kh * kw == tester.mr()) {
        tester.kh(kh).kw(kw).test(blacksmith_u8maxpool_ukernel_16x9p8q__neon);
      }
    }
  }
}
...
TEST(U8MAXPOOL_16x9P8Q__NEON, kc_eq_16_unipass_fulltile_with_qmin) {
  ...
  for (size_t kh = 1; kh <= tester.mr(); kh++) {
    for (size_t kw = 1; kw <= tester.mr(); kw++) {
      if (kh * kw == tester.mr()) {
        tester.kh(kh).kw(kw).qmin(192).test(blacksmith_u8maxpool_ukernel_16x9p8q__neon);
      }
    }
  }
}
...
TEST(U8MAXPOOL_16x9P8Q__NEON, kc_eq_16_unipass_fulltile_with_qmax) {
  ...
  for (size_t kh = 1; kh <= tester.mr(); kh++) {
    for (size_t kw = 1; kw <= tester.mr(); kw++) {
      if (kh * kw == tester.mr()) {
        tester.kh(kh).kw(kw).qmax(192).test(blacksmith_u8maxpool_ukernel_16x9p8q__neon);
      }
    }
  }
}
...
TEST(U8MAXPOOL_16x9P8Q__NEON, kc_eq_16_unipass_subtile) {
  ...
  for (size_t ks = 2; ks < tester.mr(); ks++) {
    tester.kh(ks).kw(1).test(blacksmith_u8maxpool_ukernel_16x9p8q__neon);
    tester.kh(1).kw(ks).test(blacksmith_u8maxpool_ukernel_16x9p8q__neon);
  }
}
    ...
    for (size_t kw = 1; kw <= tester.mr(); kw++) {
      if (kh * kw == tester.mr()) {
        for (size_t kc = 16; kc < 256; kc += 48) {
          tester.kh(kh).kw(kw).kc(kc).test(blacksmith_u8maxpool_ukernel_16x9p8q__neon);
        }
      }
    }
  }
      ...
      if (kh * kw == tester.mr()) {
        for (size_t kc = 16; kc < 256; kc += 48) {
          tester.kh(kh).kw(kw).kc(kc).qmin(192).test(
              blacksmith_u8maxpool_ukernel_16x9p8q__neon);
        }
      }
    }
  }
...
TEST(U8MAXPOOL_16x9P8Q__NEON, kc_div_16_unipass_subtile) {
  ...
  for (size_t ks = 2; ks < tester.mr(); ks++) {
    for (size_t kc = 16; kc < 256; kc += 48) {
      tester.kh(ks).kw(1).kc(kc).test(blacksmith_u8maxpool_ukernel_16x9p8q__neon);
      tester.kh(1).kw(ks).kc(kc).test(blacksmith_u8maxpool_ukernel_16x9p8q__neon);
    }
  }
}
...
TEST(U8MAXPOOL_16x9P8Q__NEON, kc_eq_16_multipass_with_qmin) {
  ...
  for (size_t ks = tester.mr() + tester.qr() + 1;
       ks < tester.mr() + 3 * tester.qr();
       ks += 3) {
    tester.kh(ks).kw(1).qmin(192).test(blacksmith_u8maxpool_ukernel_16x9p8q__neon);
    tester.kh(1).kw(ks).qmin(192).test(blacksmith_u8maxpool_ukernel_16x9p8q__neon);
  }
}
...
TEST(U8MAXPOOL_16x9P8Q__NEON, kc_eq_16_multipass_with_qmax) {
  ...
  for (size_t ks = tester.mr() + tester.qr() + 1;
       ks < tester.mr() + 3 * tester.qr();
       ks += 3) {
    tester.kh(ks).kw(1).qmax(192).test(blacksmith_u8maxpool_ukernel_16x9p8q__neon);
    tester.kh(1).kw(ks).qmax(192).test(blacksmith_u8maxpool_ukernel_16x9p8q__neon);
  }
}
    ...
    for (size_t ks : std::vector<size_t>{{2, 3, 5, 10}}) {
      for (size_t kc = 16; kc < 51; kc += 5) {
        MaxPoolMicrokernelTester()
            ...
            .kc(kc)
            .iterations(3)
            .test(blacksmith_u8maxpool_ukernel_16x9p8q__neon);
      }
    }
  }
}
...
TEST(U8MAXPOOL_SUB16__SSE2, kc_lt_16_mx1_pool) {
  ...
  for (size_t kc = 1; kc < 16; kc++) {
    for (size_t ks = 2; ks < 16; ks++) {
      MaxPoolMicrokernelTester().kr(16).kh(ks).kw(1).kc(kc).test(
          blacksmith_u8maxpool_ukernel_sub16__sse2);
    }
  }
}
    ...
    for (size_t ks : std::vector<size_t>{{2, 3, 5}}) {
      for (size_t kc = 1; kc < 16; kc++) {
        MaxPoolMicrokernelTester()
            ...
            .kc(kc)
            .iterations(3)
            .test(blacksmith_u8maxpool_ukernel_sub16__sse2);
      }
    }
  }
}
...
TEST(U8MAXPOOL_16x9P8Q__SSE2, kc_eq_16_unipass_fulltile) {
  ...
  for (size_t kh = 1; kh <= tester.mr(); kh++) {
    for (size_t kw = 1; kw <= tester.mr(); kw++) {
      if (kh * kw == tester.mr()) {
        tester.kh(kh).kw(kw).test(blacksmith_u8maxpool_ukernel_16x9p8q__sse2);
      }
    }
  }
}
...
TEST(U8MAXPOOL_16x9P8Q__SSE2, kc_eq_16_unipass_fulltile_with_qmin) {
  ...
  for (size_t kh = 1; kh <= tester.mr(); kh++) {
    for (size_t kw = 1; kw <= tester.mr(); kw++) {
      if (kh * kw == tester.mr()) {
        tester.kh(kh).kw(kw).qmin(192).test(blacksmith_u8maxpool_ukernel_16x9p8q__sse2);
      }
    }
  }
}
...
TEST(U8MAXPOOL_16x9P8Q__SSE2, kc_eq_16_unipass_fulltile_with_qmax) {
  ...
  for (size_t kh = 1; kh <= tester.mr(); kh++) {
    for (size_t kw = 1; kw <= tester.mr(); kw++) {
      if (kh * kw == tester.mr()) {
        tester.kh(kh).kw(kw).qmax(192).test(blacksmith_u8maxpool_ukernel_16x9p8q__sse2);
      }
    }
  }
}
...
TEST(U8MAXPOOL_16x9P8Q__SSE2, kc_eq_16_unipass_subtile) {
  ...
  auto tester = MaxPoolMicrokernelTester().kr(16).mr(9).kc(16);
  for (size_t ks = 2; ks < tester.mr(); ks++) {
    tester.kh(ks).kw(1).test(blacksmith_u8maxpool_ukernel_16x9p8q__sse2);
    tester.kh(1).kw(ks).test(blacksmith_u8maxpool_ukernel_16x9p8q__sse2);
  }
}
...
TEST(U8MAXPOOL_16x9P8Q__SSE2, kc_div_16_unipass_fulltile) {
  ...
  for (size_t kh = 1; kh <= tester.mr(); kh++) {
    for (size_t kw = 1; kw <= tester.mr(); kw++) {
      if (kh * kw == tester.mr()) {
        for (size_t kc = 16; kc < 256; kc += 48) {
          tester.kh(kh).kw(kw).kc(kc).test(blacksmith_u8maxpool_ukernel_16x9p8q__sse2);
        }
      }
    }
  }
  ...
  for (size_t kh = 1; kh <= tester.mr(); kh++) {
    for (size_t kw = 1; kw <= tester.mr(); kw++) {
      if (kh * kw == tester.mr()) {
        for (size_t kc = 16; kc < 256; kc += 48) {
          tester.kh(kh).kw(kw).kc(kc).qmin(192).test(
              blacksmith_u8maxpool_ukernel_16x9p8q__sse2);
        }
      }
    }
  }
...
TEST(U8MAXPOOL_16x9P8Q__SSE2, kc_div_16_unipass_subtile) {
  ...
  for (size_t ks = 2; ks < tester.mr(); ks++) {
    for (size_t kc = 16; kc < 256; kc += 48) {
      tester.kh(ks).kw(1).kc(kc).test(blacksmith_u8maxpool_ukernel_16x9p8q__sse2);
      tester.kh(1).kw(ks).kc(kc).test(blacksmith_u8maxpool_ukernel_16x9p8q__sse2);
    }
  }
}
...
TEST(U8MAXPOOL_16x9P8Q__SSE2, kc_eq_16_multipass_with_qmin) {
  ...
  for (size_t ks = tester.mr() + tester.qr() + 1;
       ks < tester.mr() + 3 * tester.qr();
       ks += 3) {
    tester.kh(ks).kw(1).qmin(192).test(blacksmith_u8maxpool_ukernel_16x9p8q__sse2);
    tester.kh(1).kw(ks).qmin(192).test(blacksmith_u8maxpool_ukernel_16x9p8q__sse2);
  }
}
...
TEST(U8MAXPOOL_16x9P8Q__SSE2, kc_eq_16_multipass_with_qmax) {
  ...
  for (size_t ks = tester.mr() + tester.qr() + 1;
       ks < tester.mr() + 3 * tester.qr();
       ks += 3) {
    tester.kh(ks).kw(1).qmax(192).test(blacksmith_u8maxpool_ukernel_16x9p8q__sse2);
    tester.kh(1).kw(ks).qmax(192).test(blacksmith_u8maxpool_ukernel_16x9p8q__sse2);
  }
}
    ...
    for (size_t ks : std::vector<size_t>{{2, 3, 5, 10}}) {
      for (size_t kc = 16; kc < 51; kc += 5) {
        MaxPoolMicrokernelTester()
            ...
            .kc(kc)
            .iterations(3)
            .test(blacksmith_u8maxpool_ukernel_16x9p8q__sse2);
      }
    }
  }
}
