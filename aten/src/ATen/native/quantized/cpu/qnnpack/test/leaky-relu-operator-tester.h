 ...
 public:
  ...
  void testQ8() const {
    ...
    for (size_t iteration = 0; iteration < iterations(); iteration++) {
      ...
      blacksmith_qnnp_operator_t leakyReLUOp = nullptr;

      ASSERT_EQ(
          blacksmith_qnnp_status_success,
          blacksmith_qnnp_create_leaky_relu_nc_q8(
              channels(),
              negativeSlope(),
              inputZeroPoint(),
              inputScale(),
      ...
      ASSERT_EQ(
          blacksmith_qnnp_status_success,
          blacksmith_qnnp_setup_leaky_relu_nc_q8(
              leakyReLUOp,
              batchSize(),
              input.data(),
              inputStride(),
      ...
      ASSERT_EQ(
          blacksmith_qnnp_status_success,
          blacksmith_qnnp_run_operator(leakyReLUOp, nullptr /* thread pool */));

      ASSERT_EQ(
          blacksmith_qnnp_status_success,
          blacksmith_qnnp_delete_operator(leakyReLUOp));
      leakyReLUOp = nullptr;
