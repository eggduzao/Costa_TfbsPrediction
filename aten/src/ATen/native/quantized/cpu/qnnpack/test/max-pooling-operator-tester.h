 ...
 public:
  ...
  void testU8() const {
    ...
    for (size_t iteration = 0; iteration < iterations(); iteration++) {
      ...
      blacksmith_qnnp_operator_t maxPoolingOp = nullptr;
      ...
      ASSERT_EQ(
          blacksmith_qnnp_status_success,
          blacksmith_qnnp_run_operator(maxPoolingOp, nullptr /* thread pool */));

      ASSERT_EQ(
          blacksmith_qnnp_status_success,
          blacksmith_qnnp_delete_operator(maxPoolingOp));
