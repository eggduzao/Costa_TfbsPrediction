...
TEST(CONVOLUTION_OP, xzp_1x1) {
  ...
  if (blacksmith_qnnp_params.q8conv_xzp.kthreshold != SIZE_MAX) {
    ConvolutionOperatorTester()
        .inputSize(27, 29)
        .kernelSize(1, 1)
        .groupInputChannels(blacksmith_qnnp_params.q8conv_xzp.kthreshold + 1)
        .groupOutputChannels(19)
        .iterations(3)
        .testQ8();
  }
...
TEST(CONVOLUTION_OP, xzp_1x1_with_input_stride) {
  ...
  if (blacksmith_qnnp_params.q8conv_xzp.kthreshold != SIZE_MAX) {
    ConvolutionOperatorTester()
        .inputSize(27, 29)
        .kernelSize(1, 1)
        .inputPixelStride(blacksmith_qnnp_params.q8conv_xzp.kthreshold + 5)
        .groupInputChannels(blacksmith_qnnp_params.q8conv_xzp.kthreshold + 1)
        .groupOutputChannels(19)
        .iterations(3)
        .testQ8();
