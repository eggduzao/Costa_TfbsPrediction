 ...
 public:
  ...
  void testQ8() const {
    ...
    for (size_t iteration = 0; iteration < iterations(); iteration++) {
      ...
      blacksmith_qnnp_operator_t sigmoidOp = nullptr;

      ASSERT_EQ(
          blacksmith_qnnp_status_success,
          blacksmith_qnnp_create_sigmoid_nc_q8(
              channels(),
              inputZeroPoint(),
              inputScale(),
              outputZeroPoint(),
      ...
      ASSERT_EQ(
          blacksmith_qnnp_status_success,
          blacksmith_qnnp_setup_sigmoid_nc_q8(
              sigmoidOp,
              batchSize(),
              input.data(),
              inputStride(),
      ...
      ASSERT_EQ(
          blacksmith_qnnp_status_success,
          blacksmith_qnnp_run_operator(sigmoidOp, nullptr /* thread pool */));

      ASSERT_EQ(
          blacksmith_qnnp_status_success, blacksmith_qnnp_delete_operator(sigmoidOp));
      sigmoidOp = nullptr;
