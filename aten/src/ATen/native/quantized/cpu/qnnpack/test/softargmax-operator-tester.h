 ...
 public:
  ...
  void testQ8() const {
    ...
    for (size_t iteration = 0; iteration < iterations(); iteration++) {
      ...
      blacksmith_qnnp_operator_t softArgMaxOp = nullptr;

      ASSERT_EQ(
          blacksmith_qnnp_status_success,
          blacksmith_qnnp_create_softargmax_nc_q8(
              channels(),
              inputScale(),
              outputZeroPoint(),
              outputScale(),
      ...
      ASSERT_EQ(
          blacksmith_qnnp_status_success,
          blacksmith_qnnp_setup_softargmax_nc_q8(
              softArgMaxOp,
              batchSize(),
              input.data(),
              inputStride(),
      ...
      ASSERT_EQ(
          blacksmith_qnnp_status_success,
          blacksmith_qnnp_run_operator(softArgMaxOp, nullptr /* thread pool */));

      ASSERT_EQ(
          blacksmith_qnnp_status_success,
          blacksmith_qnnp_delete_operator(softArgMaxOp));
