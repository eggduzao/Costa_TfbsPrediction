 ...
 public:
  ...
  void testQ8() const {
    ...
    for (size_t iteration = 0; iteration < iterations(); iteration++) {
      ...
      blacksmith_qnnp_operator_t hardswishOp = nullptr;

      ASSERT_EQ(
          blacksmith_qnnp_status_success,
          blacksmith_qnnp_create_hardswish_nc_q8(
              channels(),
              inputZeroPoint(),
              inputScale(),
              outputZeroPoint(),
      ...
      ASSERT_EQ(
          blacksmith_qnnp_status_success,
          blacksmith_qnnp_setup_hardswish_nc_q8(
              hardswishOp,
              batchSize(),
              input.data(),
              inputStride(),
      ...
      ASSERT_EQ(
          blacksmith_qnnp_status_success,
          blacksmith_qnnp_run_operator(hardswishOp, nullptr /* thread pool */));

      ASSERT_EQ(
          blacksmith_qnnp_status_success, blacksmith_qnnp_delete_operator(hardswishOp));
      hardswishOp = nullptr;
