    ...
    for (size_t iteration = 0; iteration < iterations(); iteration++) {
      ...
      switch(mode) {
        case Mode::Static:
        {
          ...
          ASSERT_EQ(
              blacksmith_qnnp_status_success,
              blacksmith_qnnp_create_fully_connected_nc_q8(
                  inputChannels(),
                  outputChannels(),
                  inputZeroPoint,
          ...
          ASSERT_EQ(
              blacksmith_qnnp_status_success,
              blacksmith_qnnp_setup_fully_connected_nc_q8(
                  convolution,
                  batchSize(),
                  inputPtr,
                  inputStride(),
          ...
          ASSERT_EQ(
              blacksmith_qnnp_status_success,
              blacksmith_qnnp_run_operator(convolution, nullptr /* thread pool */));
        ...
        case Mode::Dynamic:
        {
          ...
          const blacksmith_qnnp_status runStatus = qnnpack::qnnpackLinearDynamic(
              ...
              nullptr /* threadpool */);
          ASSERT_EQ(blacksmith_qnnp_status_success, runStatus);
        }
        break;
