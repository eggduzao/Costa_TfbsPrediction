...
class VAddMicrokernelTester {
 public:
  ...
  void test(blacksmith_q8vadd_ukernel_function q8vadd) const {
    ...
    for (size_t iteration = 0; iteration < iterations(); iteration++) {
      ...
      const union blacksmith_qnnp_add_quantization_params quantizationParams =
          blacksmith_qnnp_compute_add_quantization_params(
              ...
              qmin(),
              qmax());
      const union blacksmith_qnnp_add_quantization_params
      ...
      for (size_t i = 0; i < n(); i++) {
        ...
        yRef[i] = blacksmith_qnnp_add_quantize(
