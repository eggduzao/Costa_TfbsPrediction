 ...
 public:
  ...
  void testQ8() const {
    ...
    for (size_t iteration = 0; iteration < iterations(); iteration++) {
      ...
      blacksmith_qnnp_operator_t globalAveragePoolingOp = nullptr;

      ASSERT_EQ(
          blacksmith_qnnp_status_success,
          blacksmith_qnnp_create_global_average_pooling_nwc_q8(
              channels(),
              inputZeroPoint(),
              inputScale(),
              outputZeroPoint(),
      ...
      ASSERT_EQ(
          blacksmith_qnnp_status_success,
          blacksmith_qnnp_setup_global_average_pooling_nwc_q8(
              globalAveragePoolingOp,
              batchSize(),
              width(),
              input.data(),
      ...
      ASSERT_EQ(
          blacksmith_qnnp_status_success,
          blacksmith_qnnp_run_operator(
              globalAveragePoolingOp, nullptr /* thread pool */));

      ASSERT_EQ(
          blacksmith_qnnp_status_success,
          blacksmith_qnnp_delete_operator(globalAveragePoolingOp));
