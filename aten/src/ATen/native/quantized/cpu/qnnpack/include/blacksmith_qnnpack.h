 ...
 */
enum blacksmith_qnnp_status {
  /** The call succeeded, and all output arguments now contain valid data. */
  blacksmith_qnnp_status_success = 0,
  blacksmith_qnnp_status_uninitialized = 1,
  blacksmith_qnnp_status_invalid_parameter = 2,
  blacksmith_qnnp_status_unsupported_parameter = 3,
  blacksmith_qnnp_status_unsupported_hardware = 4,
  blacksmith_qnnp_status_out_of_memory = 5,
};

enum blacksmith_qnnp_sparse_matrix_indices_dtype {
  blacksmith_qnnp_sparse_matrix_indices_dtype_invalid = 0,
  blacksmith_qnnp_sparse_matrix_indices_dtype_uint8_t = 8,
  blacksmith_qnnp_sparse_matrix_indices_dtype_uint16_t = 16,
  blacksmith_qnnp_sparse_matrix_indices_dtype_uint32_t = 32,
};
...
typedef struct blacksmith_qnnp_operator* blacksmith_qnnp_operator_t;

enum blacksmith_qnnp_status blacksmith_qnnp_create_convolution2d_nhwc_q8(
    ...
    bool per_channel,
    blacksmith_qnnp_operator_t* convolution);

enum blacksmith_qnnp_status blacksmith_qnnp_create_convolution3d_ndhwc_q8(
...
enum blacksmith_qnnp_status blacksmith_qnnp_setup_convolution2d_nhwc_q8(
    blacksmith_qnnp_operator_t convolution,
    size_t batch_size,
    size_t input_height,
    size_t input_width,
...
enum blacksmith_qnnp_status blacksmith_qnnp_setup_convolution_ndhwc_q8(
    blacksmith_qnnp_operator_t convolution,
    size_t batch_size,
    size_t input_depth,
    size_t input_height,
...
enum blacksmith_qnnp_status blacksmith_qnnp_create_deconvolution2d_nhwc_q8(
    uint32_t input_padding_height,
    uint32_t input_padding_width,
    ...
    uint32_t flags,
    const float* requantization_scales,
    blacksmith_qnnp_operator_t* deconvolution);

enum blacksmith_qnnp_status blacksmith_qnnp_setup_deconvolution2d_nhwc_q8(
    blacksmith_qnnp_operator_t deconvolution,
    size_t batch_size,
    size_t input_height,
    size_t input_width,
...
enum blacksmith_qnnp_status blacksmith_qnnp_create_global_average_pooling_nwc_q8(
    size_t channels,
    uint8_t input_zero_point,
    float input_scale,
    uint8_t output_zero_point,
    ...
    uint8_t output_max,
    uint32_t flags,
    blacksmith_qnnp_operator_t* global_average_pooling);

enum blacksmith_qnnp_status blacksmith_qnnp_setup_global_average_pooling_nwc_q8(
    blacksmith_qnnp_operator_t global_average_pooling,
    size_t batch_size,
    size_t width,
    const uint8_t* input,
...
enum blacksmith_qnnp_status blacksmith_qnnp_create_average_pooling2d_nhwc_q8(
    uint32_t input_padding_height,
    uint32_t input_padding_width,
    ...
    uint8_t output_max,
    uint32_t flags,
    blacksmith_qnnp_operator_t* average_pooling);

enum blacksmith_qnnp_status blacksmith_qnnp_setup_average_pooling2d_nhwc_q8(
    blacksmith_qnnp_operator_t average_pooling,
    size_t batch_size,
    size_t input_height,
    size_t input_width,
...
enum blacksmith_qnnp_status blacksmith_qnnp_create_max_pooling2d_nhwc_u8(
    uint32_t input_padding_height,
    uint32_t input_padding_width,
    uint32_t pooling_height,
    uint32_t pooling_width,
    ...
    uint8_t output_max,
    uint32_t flags,
    blacksmith_qnnp_operator_t* max_pooling);

enum blacksmith_qnnp_status blacksmith_qnnp_setup_max_pooling2d_nhwc_u8(
    blacksmith_qnnp_operator_t max_pooling,
    size_t batch_size,
    size_t input_height,
    size_t input_width,
...
enum blacksmith_qnnp_status blacksmith_qnnp_create_channel_shuffle_nc_x8(
    ...
    uint32_t flags,
    blacksmith_qnnp_operator_t* channel_shuffle);
...
enum blacksmith_qnnp_status blacksmith_qnnp_create_add_nc_q8(
    ...
    uint8_t sum_max,
    uint32_t flags,
    blacksmith_qnnp_operator_t* add);
...
enum blacksmith_qnnp_status blacksmith_qnnp_create_leaky_relu_nc_q8(
    size_t channels,
    ...
    uint8_t output_max,
    uint32_t flags,
    blacksmith_qnnp_operator_t* leaky_relu);

enum blacksmith_qnnp_status blacksmith_qnnp_setup_leaky_relu_nc_q8(
    blacksmith_qnnp_operator_t leaky_relu,
    size_t batch_size,
    const uint8_t* input,
    size_t input_stride,
...
enum blacksmith_qnnp_status blacksmith_qnnp_create_hardswish_nc_q8(
    size_t channels,
    uint8_t input_zero_point,
    float input_scale,
    uint8_t output_zero_point,
    ...
    uint8_t output_max,
    uint32_t flags,
    blacksmith_qnnp_operator_t* hardswish);

enum blacksmith_qnnp_status blacksmith_qnnp_setup_hardswish_nc_q8(
    blacksmith_qnnp_operator_t hardswish,
    size_t batch_size,
    const uint8_t* input,
    size_t input_stride,
