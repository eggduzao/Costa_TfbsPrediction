...
void blacksmith_qnnp_indirection_init_conv3d(
 ...
 * this function.
 */
void blacksmith_qnnp_indirection_init_dwconv(
    blacksmith_qnnp_operator_t op,
    size_t batch_start) {
  const void** indirection_buffer = op->indirection_buffer;
  const void* input = op->input;
...
void blacksmith_qnnp_indirection_init_deconv2d(
    blacksmith_qnnp_operator_t op,
    size_t output_tile_size,
    size_t tiled_output_size) {
  const void** indirection_buffer = op->indirection_buffer;
...
void blacksmith_qnnp_indirection_init_maxpool2d(
    blacksmith_qnnp_operator_t op,
    size_t batch_start) {
  const void** indirection_buffer = op->indirection_buffer;
  const void* input = op->input;
...
void blacksmith_qnnp_indirection_set_step_dimensions(blacksmith_qnnp_operator_t op) {
