...
static inline union blacksmith_qnnp_q31_requantization_params
blacksmith_qnnp_compute_scalar_requantization_params(
  ...
  union blacksmith_qnnp_q31_requantization_params params;
...
static inline union blacksmith_qnnp_fp32_requantization_params
blacksmith_qnnp_compute_scalar_fp32_requantization_params(
  ...
  union blacksmith_qnnp_fp32_requantization_params params;
...
static inline union blacksmith_qnnp_conv_quantization_params
blacksmith_qnnp_compute_conv_quantization_params(
  ...
  union blacksmith_qnnp_conv_quantization_params params;
#if CPUINFO_ARCH_X86 || CPUINFO_ARCH_X86_64
...
static inline union blacksmith_qnnp_avgpool_quantization_params
blacksmith_qnnp_compute_avgpool_quantization_params(
    int32_t bias,
    float scale,
    uint8_t output_zero_point,
    uint8_t output_min,
  ...
  union blacksmith_qnnp_avgpool_quantization_params params;
#if CPUINFO_ARCH_X86 || CPUINFO_ARCH_X86_64
...
static inline union blacksmith_qnnp_avgpool_quantization_params
blacksmith_qnnp_compute_scalar_avgpool_quantization_params(
    int32_t bias,
    float scale,
    uint8_t output_zero_point,
    uint8_t output_min,
...
static inline union blacksmith_qnnp_u8_clamping_params
blacksmith_qnnp_compute_u8_clamping_params(
    uint8_t output_min,
    uint8_t output_max) {
...
static inline union blacksmith_qnnp_add_quantization_params
blacksmith_qnnp_compute_add_quantization_params(
  ...
  union blacksmith_qnnp_add_quantization_params params;
#if CPUINFO_ARCH_X86 || CPUINFO_ARCH_X86_64
  const uint32_t remainder_mask = (UINT32_C(1) << shift) - UINT32_C(1);
  const uint32_t remainder_threshold = remainder_mask >> 1;
...
static inline union blacksmith_qnnp_add_quantization_params
blacksmith_qnnp_compute_scalar_add_quantization_params(
    uint8_t a_zero_point,
    uint8_t b_zero_point,
    uint8_t output_zero_point,
    float a_output_scale,
...
static inline uint8_t blacksmith_qnnp_q31_requantize(
    int32_t n,
    union blacksmith_qnnp_q31_requantization_params params) {
...
static inline uint8_t blacksmith_qnnp_fp32_requantize(
    int32_t n,
    union blacksmith_qnnp_fp32_requantization_params params,
...
static inline uint8_t blacksmith_qnnp_fp32_requantize_magic(
    int32_t n,
    union blacksmith_qnnp_fp32_requantization_params params,
    int32_t output_channel_index) {
...
static inline uint8_t blacksmith_qnnp_avgpool_quantize(
    int32_t n,
    union blacksmith_qnnp_avgpool_quantization_params params) {
...
static inline uint8_t blacksmith_qnnp_add_quantize(
    uint8_t a,
    uint8_t b,
    union blacksmith_qnnp_add_quantization_params params) {
