...
#define BLACKSMITH_QNNP_IGNORE_SHIFT_BASE_UB \
...
#define BLACKSMITH_QNNP_IGNORE_SHIFT_BASE_UB
#ifndef BLACKSMITH_QNNP_USE_SHIFT_BASE_UB_WORKAROUND
#define BLACKSMITH_QNNP_USE_SHIFT_BASE_UB_WORKAROUND 1
#endif
#else
#define BLACKSMITH_QNNP_IGNORE_SHIFT_BASE_UB
#endif
...
BLACKSMITH_QNNP_IGNORE_SHIFT_BASE_UB
inline static int32_t asr_s32(int32_t x, uint32_t n) {
#ifdef BLACKSMITH_QNNP_USE_SHIFT_BASE_UB_WORKAROUND
...
inline static uint8_t blacksmith_scalar_requantize_precise(
    int32_t value,
    float scale,
    uint8_t zero_point,
    uint8_t qmin,
