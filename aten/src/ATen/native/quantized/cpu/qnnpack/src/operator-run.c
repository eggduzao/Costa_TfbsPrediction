...
struct q8gemm_context {
  ...
  uint8_t* c;
  size_t c_stride;
  union blacksmith_qnnp_conv_quantization_params quantization_params;
  const blacksmith_q8gemm_ukernel_function ukernel;
};
...
struct q8gemm_sparse_dq_context {
  ...
  size_t c_stride;
  struct blacksmith_qnnp_conv_dynamic_quantization_params quantization_params;
  const blacksmith_q8gemm_dq_sparse_ukernel_function ukernel;
};
...
struct q8gemm_prepackA_sparse_dq_context {
  ...
  union {
    ...
    blacksmith_q8gemm_dq_sparse_packedA_w32_ukernel_function ukernel_w32;
    blacksmith_q8gemm_dq_sparse_packedA_w16_ukernel_function ukernel_w16;
    blacksmith_q8gemm_dq_sparse_packedA_w8_ukernel_function ukernel_w8;
  };
  const blacksmith_q8gemm_sparse_packA_ukernel_function prepack_ukernel;
};
...
struct q8sum_rows_context {
  ...
  int32_t* a_sum;
  size_t a_sum_stride;
  const blacksmith_q8sum_rows_ukernel_function ukernel;
};
...
struct q8gemm_xzp_context {
  ...
  size_t batch_size;
  size_t a_sum_stride;
  union blacksmith_qnnp_q31_requantization_params requantization_params;
  const blacksmith_q8gemm_xzp_ukernel_function ukernel;
};
...
struct q8conv_context {
  ...
  size_t c_stride;
  union blacksmith_qnnp_conv_quantization_params quantization_params;
  const blacksmith_q8conv_ukernel_function ukernel;
};
...
struct q8dwconv2d_context {
  ...
  union blacksmith_qnnp_conv_quantization_params quantization_params;
  union {
    const blacksmith_q8dwconv2d_up_ukernel_function unipass_ukernel;
    const blacksmith_q8dwconv2d_mp_ukernel_function multipass_ukernel;
  };
};
...
struct q8dwconv3d_context {
  ...
  union blacksmith_qnnp_conv_quantization_params quantization_params;
  const blacksmith_q8dwconv3d_mp_ukernel_function multipass_ukernel;
};
...
struct max_pooling_context {
  ...
  union blacksmith_qnnp_u8_clamping_params params;
  blacksmith_u8maxpool_ukernel_function ukernel;
};
...
struct average_pooling_context {
  ...
  size_t input_increment;
  size_t output_increment;
  union blacksmith_qnnp_avgpool_quantization_params quantization_params;
  union {
    blacksmith_q8avgpool_up_ukernel_function unipass_ukernel;
    blacksmith_q8avgpool_mp_ukernel_function multipass_ukernel;
  };
};
...
struct global_average_pooling_context {
  ...
  union blacksmith_qnnp_avgpool_quantization_params quantization_params;
  union {
    blacksmith_q8gavgpool_up_ukernel_function unipass_ukernel;
    blacksmith_q8gavgpool_mp_ukernel_function multipass_ukernel;
  };
};
...
struct q8add_strided_context {
  ...
  const uint8_t* y;
  size_t y_stride;
  union blacksmith_qnnp_add_quantization_params quantization_params;
  blacksmith_q8vadd_ukernel_function ukernel;
};
...
struct channel_shuffle_context {
  ...
  size_t m;
  union {
    blacksmith_xzipc_ukernel_function fixed_ukernel;
    blacksmith_xzipv_ukernel_function variable_ukernel;
  };
};
...
struct lut_strided_context {
  ...
  void* y;
  size_t y_stride;
  blacksmith_x8lut_ukernel_function ukernel;
};
...
struct clamp_strided_context {
  ...
  void* y;
  size_t y_stride;
  blacksmith_u8clamp_ukernel_function ukernel;
  union blacksmith_qnnp_u8_clamping_params params;
};
...
struct u8softargmax_context {
  ...
  uint8_t* y;
  size_t y_stride;
  blacksmith_u8rmax_ukernel_function rmax_ukernel;
  blacksmith_u8lut32norm_ukernel_function lut_norm_ukernel;
};
...
enum blacksmith_qnnp_status blacksmith_qnnp_run_operator(
  ...
  switch (op->ukernel_type) {
    case blacksmith_qnnp_ukernel_type_dwconv: {
      ...
      switch (kernel_size) {
        case 9: {
          struct q8dwconv2d_context context = {
              ...
              .unipass_ukernel = op->per_channel
                  ? blacksmith_qnnp_params.q8dw9.updw_per_channel
                  : blacksmith_qnnp_params.q8dw9.updw,
          };
        ...
        case 25: {
          struct q8dwconv2d_context context = {
              ...
              .multipass_ukernel = op->per_channel
                  ? blacksmith_qnnp_params.q8dw25.mpdw_per_channel
                  : blacksmith_qnnp_params.q8dw25.mpdw,
          };
          pthreadpool_compute_2d(
              threadpool,
        ...
        case 27: {
          struct q8dwconv3d_context context = {
              ...
              .quantization_params = op->conv_quantization_params,
              .multipass_ukernel = blacksmith_qnnp_params.q8dw27.mpdw,
          };
          pthreadpool_compute_2d(
              threadpool,
        ...
        default:
          BLACKSMITH_QNNP_UNREACHABLE;
      }
      break;
    }
    case blacksmith_qnnp_ukernel_type_xzp_gemm: {
      const size_t batch_size = op->batch_size;
      const size_t groups = op->groups;
      const size_t group_input_channels = op->group_input_channels;
      const size_t group_output_channels = op->group_output_channels;
      const uint32_t mr = blacksmith_qnnp_params.q8conv_xzp.mr;
      const uint32_t nr = blacksmith_qnnp_params.q8conv_xzp.nr;
      const uint32_t kr = blacksmith_qnnp_params.q8conv_xzp.kr;
      ...
      struct q8sum_rows_context context = {
          ...
          .ukernel = blacksmith_qnnp_params.q8sum_rows.sum_rows,
      };
      pthreadpool_compute_3d_tiled(
          ...
          1,
          1,
          blacksmith_qnnp_params.q8sum_rows.m);
      ...
      struct q8gemm_xzp_context q8gemm_xzp_context = {
          ...
          .ukernel = blacksmith_qnnp_params.q8conv_xzp.gemm,
      };
    ...
    case blacksmith_qnnp_ukernel_type_gemm: {
      const size_t batch_size = op->batch_size;
      const size_t groups = op->groups;
      const size_t group_input_channels = op->group_input_channels;
      const size_t group_output_channels = op->group_output_channels;
      const uint32_t mr = blacksmith_qnnp_params.q8conv.mr;
      ...
      struct q8gemm_context q8gemm_context = {
          ...
          .c_stride = op->output_pixel_stride,
          .quantization_params = op->conv_quantization_params,
          .ukernel = blacksmith_qnnp_params.q8conv.gemm,
      };
...
#ifdef NO_PREPACK_SPARSE_KERNEL
    case blacksmith_qnnp_ukernel_type_gemm_sparse_dq: {
      const size_t batch_size = op->batch_size;
      const size_t groups = op->groups;
      const size_t group_output_channels = op->group_output_channels;
      const uint32_t mr = blacksmith_qnnp_params.q8gemm_sparse_c1x4.mr;
      const uint32_t nr = blacksmith_qnnp_params.q8gemm_sparse_c1x4.nr;
      ...
      struct q8gemm_sparse_dq_context q8gemm_sparse_dq_context = {
          ...
          .ukernel = blacksmith_qnnp_params.q8gemm_sparse_c1x4.gemm_dq,
      };
...
#endif
    case blacksmith_qnnp_ukernel_type_gemm_prepackA_sparse_dq: {
      const size_t batch_size = op->batch_size;
      const size_t groups = op->groups;
      const size_t group_input_channels = op->group_input_channels;
      const size_t group_output_channels = op->group_output_channels;
      uint32_t mr, log2_mr, nr, kr, log2_row_block_size;
      blacksmith_q8gemm_sparse_packA_ukernel_function prepack_kernel;
      struct blacksmith_q8gemm_sparse_parameters* blacksmith_q8gemm_sparse_params =
          NULL; // used to assign ukernel
      if (op->sparse_matrix.row_block_size == 1 &&
          op->sparse_matrix.col_block_size == 4) {
        mr = blacksmith_qnnp_params.q8gemm_sparse_c1x4.mr;
        log2_mr = blacksmith_qnnp_params.q8gemm_sparse_c1x4.log2_mr;
        log2_row_block_size = 0;
        nr = blacksmith_qnnp_params.q8gemm_sparse_c1x4.nr;
        kr = blacksmith_qnnp_params.q8gemm_sparse_c1x4.kr;
        prepack_kernel = blacksmith_qnnp_params.q8gemm_sparse_c1x4.packA;
        blacksmith_q8gemm_sparse_params = &blacksmith_qnnp_params.q8gemm_sparse_c1x4;
      } else if (op->sparse_matrix.row_block_size == 8 &&
          op->sparse_matrix.col_block_size == 1) {
        mr = blacksmith_qnnp_params.q8gemm_sparse_c8x1.mr;
        log2_mr = blacksmith_qnnp_params.q8gemm_sparse_c8x1.log2_mr;
        log2_row_block_size = 3;
        nr = blacksmith_qnnp_params.q8gemm_sparse_c8x1.nr;
        kr = blacksmith_qnnp_params.q8gemm_sparse_c8x1.kr;
        prepack_kernel = blacksmith_qnnp_params.q8gemm_sparse_c8x1.packA;
        blacksmith_q8gemm_sparse_params = &blacksmith_qnnp_params.q8gemm_sparse_c8x1;
      } else {
      ...
      switch (q8gemm_prepack_sparse_dq_context.kernel_indices_dtype) {
        case blacksmith_qnnp_sparse_matrix_indices_dtype_uint32_t:
          ...
          q8gemm_prepack_sparse_dq_context.ukernel_w32 =
              blacksmith_q8gemm_sparse_params->packedA_w32_gemm_dq;
          break;
        case blacksmith_qnnp_sparse_matrix_indices_dtype_uint16_t:
          ...
          q8gemm_prepack_sparse_dq_context.ukernel_w16 =
              blacksmith_q8gemm_sparse_params->packedA_w16_gemm_dq;
          break;
        case blacksmith_qnnp_sparse_matrix_indices_dtype_uint8_t:
          ...
          q8gemm_prepack_sparse_dq_context.ukernel_w8 =
              blacksmith_q8gemm_sparse_params->packedA_w8_gemm_dq;
          break;
        case blacksmith_qnnp_sparse_matrix_indices_dtype_invalid:
          ...
          blacksmith_qnnp_log_error(
              "Invalid indices dtype specified for "
              "operator-run blacksmith_qnnp_ukernel_type_gemm_prepackA_sparse_dq");
          return blacksmith_qnnp_status_invalid_parameter;
      }
      ...
      if (groups != 1 || batch_size != 1) {
        blacksmith_qnnp_log_error("blacksmith_qnnp_ukernel_type_gemm_prepackA_sparse_dq "
    ...
    case blacksmith_qnnp_ukernel_type_conv: {
      const size_t batch_size = op->batch_size;
      const size_t groups = op->groups;
      const size_t group_input_channels = op->group_input_channels;
      const size_t group_output_channels = op->group_output_channels;
      ...
      struct q8conv_context q8conv_context = {
          ...
          .c_stride = op->output_pixel_stride,
          .quantization_params = op->conv_quantization_params,
          .ukernel = blacksmith_qnnp_params.q8conv.conv,
      };
    ...
    case blacksmith_qnnp_ukernel_type_average_pooling: {
      const uint32_t kr = blacksmith_qnnp_params.q8avgpool.kr;
      const uint32_t mr = blacksmith_qnnp_params.q8avgpool.mr;
      const uint32_t qr = blacksmith_qnnp_params.q8avgpool.qr;
      ...
      if (channels < kr) {
        ...
        context.unipass_ukernel = blacksmith_qnnp_params.q8avgpool.ltkr;
      } else {
        if (pooling_size <= mr) {
          compute_function =
              (pthreadpool_function_2d_t)compute_average_pooling_unipass;
          context.unipass_ukernel = blacksmith_qnnp_params.q8avgpool.gekr_lemr;
        } else {
          compute_function =
              (pthreadpool_function_2d_t)compute_average_pooling_multipass;
          context.multipass_ukernel = blacksmith_qnnp_params.q8avgpool.gekr_gtmr;
        }
      }
    ...
    case blacksmith_qnnp_ukernel_type_max_pooling: {
      const uint32_t kr = blacksmith_qnnp_params.u8maxpool.kr;
      const uint32_t mr = blacksmith_qnnp_params.u8maxpool.mr;
      const uint32_t qr = blacksmith_qnnp_params.u8maxpool.qr;
      const size_t channels = op->channels;
      const size_t output_width = op->output_width;
      const size_t output_height = op->output_height;
      const size_t pooling_height = op->kernel_height;
      ...
      struct max_pooling_context context = {
          ...
          .ukernel = channels < kr ? blacksmith_qnnp_params.u8maxpool.ltkr
                                   : blacksmith_qnnp_params.u8maxpool.gekr,
      };
    ...
    case blacksmith_qnnp_ukernel_type_add: {
      const size_t batch_size = op->batch_size;
      const size_t channels = op->channels;
      ...
      if ((((a_stride ^ channels) | (b_stride ^ channels) |
        ...
        struct q8add_contiguous_context add_context = {
            ...
            .ukernel = blacksmith_qnnp_params.q8vadd,
        };
    ...
    case blacksmith_qnnp_ukernel_type_global_average_pooling: {
      const uint32_t nr = blacksmith_qnnp_params.q8gavgpool.nr;
      const uint32_t mr = blacksmith_qnnp_params.q8gavgpool.mr;
      ...
      if (channels < nr) {
        ...
        context.unipass_ukernel = blacksmith_qnnp_params.q8gavgpool.ltnr;
      } else {
        if (input_width <= mr) {
          compute_function =
              (pthreadpool_function_1d_t)compute_global_average_pooling_unipass;
          context.unipass_ukernel = blacksmith_qnnp_params.q8gavgpool.genr_lemr;
        } else {
          compute_function = (pthreadpool_function_1d_t)
              compute_global_average_pooling_multipass;
          context.multipass_ukernel = blacksmith_qnnp_params.q8gavgpool.genr_gtmr;
        }
      }
    ...
    case blacksmith_qnnp_ukernel_type_lut: {
      const size_t batch_size = op->batch_size;
      const size_t channels = op->channels;
      ...
      if ((((x_stride ^ channels) | (y_stride ^ channels)) == 0) ||
        ...
        struct lut_contiguous_context context = {
            ...
            .y = op->output,
            .y_stride = y_stride * sizeof(uint8_t),
            .ukernel = blacksmith_qnnp_params.x8lut,
        };
        pthreadpool_compute_1d_tiled(
            threadpool,
    ...
    case blacksmith_qnnp_ukernel_type_clamp: {
      const size_t batch_size = op->batch_size;
      const size_t channels = op->channels;
      const size_t x_stride = op->input_pixel_stride;
      const size_t y_stride = op->output_pixel_stride;
      if ((((x_stride ^ channels) | (y_stride ^ channels)) == 0) ||
        ...
        struct clamp_contiguous_context context = {
            ...
            .y = op->output,
            .y_stride = y_stride * sizeof(uint8_t),
            .ukernel = blacksmith_qnnp_params.u8clamp,
            .params = op->u8_clamping_params,
        };
        pthreadpool_compute_1d_tiled(
            threadpool,
    ...
    case blacksmith_qnnp_ukernel_type_softargmax: {
      struct u8softargmax_context context = {
          ...
          .rmax_ukernel = blacksmith_qnnp_params.u8rmax,
          .lut_norm_ukernel = blacksmith_qnnp_params.u8lut32norm,
      };
      pthreadpool_compute_1d(
          threadpool,
    ...
    case blacksmith_qnnp_ukernel_type_channel_shuffle: {
      const size_t groups = op->groups;
      ...
      switch (groups) {
        case 2:
          ...
          channel_shuffle_context.fixed_ukernel = blacksmith_qnnp_params.x8zip.x2;
          break;
        case 3:
          compute_function =
              (pthreadpool_function_1d_t)compute_channel_shuffle_fixed;
          channel_shuffle_context.fixed_ukernel = blacksmith_qnnp_params.x8zip.x3;
          break;
        case 4:
          compute_function =
              (pthreadpool_function_1d_t)compute_channel_shuffle_fixed;
          channel_shuffle_context.fixed_ukernel = blacksmith_qnnp_params.x8zip.x4;
          break;
        default:
          compute_function =
              (pthreadpool_function_1d_t)compute_channel_shuffle_variable;
          channel_shuffle_context.variable_ukernel =
              blacksmith_qnnp_params.x8zip.xm;
          break;
        case 0:
        case 1:
          BLACKSMITH_QNNP_UNREACHABLE;
