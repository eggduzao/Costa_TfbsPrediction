...
static inline void blacksmith_pack_q8gemm_wdq(
    size_t nc,
    size_t kc,
    uint32_t nr,
    uint32_t np,
...
static inline void blacksmith_pack_q8gemm_wrq(
    const size_t nc,
    const size_t kc,
    const uint32_t nr,
    const uint32_t np,
...
static inline void blacksmith_pack_q8conv_wdq(
    size_t n,
    size_t ks,
    size_t kc,
    uint32_t nr,
...
static inline void blacksmith_pack_q8conv_wrq(
    const size_t n,
    const size_t ks,
    const size_t kc,
    const uint32_t nr,
...
static inline void blacksmith_pack_q8deconv_wdq(
    size_t n,
    size_t ks,
    size_t kc,
    uint32_t nr,
...
static inline void blacksmith_pack_q8deconv_wrq(
    const size_t n,
    const size_t ks,
    const size_t kc,
    const uint32_t nr,
...
static inline void blacksmith_pack_q8dw_wdq(
    size_t h,
    size_t w,
    size_t c,
    size_t cr,
...
static inline void blacksmith_pack_q8dw_wrq(
    const size_t h,
    const size_t w,
    const size_t c,
    const size_t cr,
...
static inline void blacksmith_pack_q8dw_3d_w_dilation(
    size_t d,
    size_t h,
    size_t w,
    size_t c,
    ...
    const int32_t* b,
    void* packed_w,
    bool blacksmith_pack_b) {
  for (size_t cr_block_start = 0; cr_block_start < c; cr_block_start += cr) {
    const size_t cr_block_size = min(c - cr_block_start, cr);
    if (blacksmith_pack_b) {
      for (size_t cr_block_offset = 0; cr_block_offset < cr_block_size;
           cr_block_offset++) {
...
static inline void blacksmith_pack_q8dw_2d_w_dilation(
    size_t h,
    size_t w,
    size_t c,
    size_t cr,
...
static inline void blacksmith_pack_swizzle_q8gemm_bdq(
    size_t n,
    size_t kc,
    uint32_t nr,
    uint32_t kr,
...
static inline void blacksmith_pack_swizzle_q8gemm_brq(
    const size_t n,
    const size_t kc,
    const uint32_t nr,
    const uint32_t kr,
...
static inline void blacksmith_pack_hgemm_w(
    size_t nc,
    size_t kc,
    size_t nr,
    size_t kr,
...
static inline void blacksmith_pack_sgemm_w(
    size_t nc,
    size_t kc,
    size_t nr,
    size_t kr,
...
static inline void blacksmith_pack_sconv_w(
    size_t n,
    size_t ks,
    size_t kc,
    size_t nr,
...
#define blacksmith_pack_q8gemm_w blacksmith_pack_q8gemm_wrq
#define blacksmith_pack_q8conv_w blacksmith_pack_q8conv_wrq
#define blacksmith_pack_q8deconv_w blacksmith_pack_q8deconv_wrq
#define blacksmith_pack_q8dw_w blacksmith_pack_q8dw_wrq
#define blacksmith_pack_swizzle_q8gemm_b blacksmith_pack_swizzle_q8gemm_brq

#else

#define blacksmith_pack_q8gemm_w blacksmith_pack_q8gemm_wdq
#define blacksmith_pack_q8conv_w blacksmith_pack_q8conv_wdq
#define blacksmith_pack_q8deconv_w blacksmith_pack_q8deconv_wdq
#define blacksmith_pack_q8dw_w blacksmith_pack_q8dw_wdq
#define blacksmith_pack_swizzle_q8gemm_b blacksmith_pack_swizzle_q8gemm_bdq
