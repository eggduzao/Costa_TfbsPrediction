...
enum blacksmith_qnnp_status blacksmith_qnnp_create_deconvolution2d_nhwc_q8(
    ...
    blacksmith_qnnp_operator_t* deconvolution_out) {
  blacksmith_qnnp_operator_t deconvolution = NULL;
  ...
  if (!blacksmith_qnnp_params.initialized) {
    blacksmith_qnnp_log_error(
        "blacksmith_qnnp_create_deconvolution2d_nhwc_q8 failed because QNNPACK is not properly initialized");
    goto error;
  }
  ...
  deconvolution = calloc(1, sizeof(struct blacksmith_qnnp_operator));
  ...
  deconvolution->ukernel_type = blacksmith_qnnp_ukernel_type_conv;
  deconvolution->format = blacksmith_qnnp_format_quint8;
...
error:
  blacksmith_qnnp_delete_operator(deconvolution);
  return status;
}
...
enum blacksmith_qnnp_status blacksmith_qnnp_setup_deconvolution2d_nhwc_q8(
  ...
  if (!blacksmith_qnnp_params.initialized) {
    blacksmith_qnnp_log_error(
        "blacksmith_qnnp_setup_deconvolution2d_nhwc_q8 failed because QNNPACK is not properly initialized");
  ...
  blacksmith_qnnp_indirection_init_deconv2d(
