...
enum blacksmith_qnnp_status qnnpackDeConv(
    const blacksmith_qnnp_operator_t deconvolution,
    void* packed_weights,
  ...
  if (deconvolution->input != input ||
    ...
    blacksmith_qnnp_status status = blacksmith_qnnp_setup_deconvolution2d_nhwc_q8(
        deconvolution,
        batch_size,
        input_height,
        input_width,
