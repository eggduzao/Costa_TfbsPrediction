...
static inline __m128i blacksmith_sse_reduce4_i32(
    __m128i x,
    __m128i y,
    __m128i z,
    __m128i w) {
...
void blacksmith_q8gemm_ukernel_2x4c8__sse2(
    size_t mr,
    size_t nr,
    size_t k,
    ...
    const union blacksmith_qnnp_conv_quantization_params
  ...
  __m128i vacc0x0123 = blacksmith_sse_reduce4_i32(vacc00, vacc01, vacc02, vacc03);
  __m128i vacc1x0123 = blacksmith_sse_reduce4_i32(vacc10, vacc11, vacc12, vacc13);
