...
void blacksmith_q8gemm_ukernel_4x4c2__sse2(
    size_t mr,
    size_t nr,
    size_t k,
  ...
  typedef BLACKSMITH_QNNP_UNALIGNED uint8_t unaligned_uint8_t;
  typedef BLACKSMITH_QNNP_UNALIGNED uint32_t unaligned_uint32_t;
  ...
  if (nr == 4) {
    ...
    *((unaligned_uint32_t*)c3) =
    ...
    typedef BLACKSMITH_QNNP_UNALIGNED uint16_t unaligned_uint16_t;
    if (nr >= 2) {
