...
struct SMITH_API PackedLinearWeight : public LinearPackedParamsBase {
  PackedLinearWeight(
...
struct SMITH_API PackedLinearWeightFp16 : public LinearPackedParamsBase {
...
struct SMITH_API PackedConvWeight : public ConvPackedParamsBase<kSpatialDim> {
  PackedConvWeight(
...
struct SMITH_API PackedEmbeddingBagWeight : public EmbeddingPackedParamsBase {
