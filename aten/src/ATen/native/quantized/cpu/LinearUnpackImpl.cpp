...
std::tuple<at::Tensor, std::optional<at::Tensor>> PackedLinearWeightsQnnp::
  ...
  if (orig_weight.defined()) {
    ...
    // https://github.com/blacksmith/blacksmith/blob/master/aten/src/ATen/native/quantized/cpu/QnnpackUtils.h#L469
    ...
    // https://github.com/blacksmith/blacksmith/blob/master/aten/src/ATen/native/quantized/cpu/qlinear_dynamic.cpp#L319
