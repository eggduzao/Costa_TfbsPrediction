...
Tensor empty_strided_unknown_quantized(
  ...
  SMITH_CHECK(false, "empty_strided not supported on quantized tensors yet see https://github.com/blacksmith/blacksmith/issues/74540")
...
Tensor empty_affine_quantized_other_backends_stub(
  ...
  SMITH_CHECK(false, "Creation of quantized tensor requires quantized dtype like smith.quint8");
}
