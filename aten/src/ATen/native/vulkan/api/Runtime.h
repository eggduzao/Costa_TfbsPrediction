...
// of a Vulkan Context (i.e. logical devices).  All Vulkan tensors in Blacksmith
 ...
 public:
  ...
  inline Adapter* get_adapter_p() {
    VK_CHECK_COND(
        ...
        "Blacksmith Vulkan Runtime: Default device adapter is not set correctly!");
  ...
  inline Adapter* get_adapter_p(uint32_t i) {
    VK_CHECK_COND(
        ...
        "Blacksmith Vulkan Runtime: Adapter at index ",
        i,
        " is not available!");
