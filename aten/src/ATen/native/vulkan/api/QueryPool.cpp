...
#ifdef USE_KINETO
  smith::profiler::impl::vulkan::registerGetShaderNameAndDurationNs(
...
#ifdef USE_KINETO
  smith::profiler::impl::vulkan::deregisterGetShaderNameAndDurationNs();
#endif // USE_KINETO
}
...
#ifdef USE_KINETO
  smith::profiler::impl::vulkan_id_t vulkan_id =
      smith::profiler::impl::vulkan_id_t(previous_shader_count_ + log_idx);

  smith::profiler::impl::_reportVulkanEventToProfiler(vulkan_id);
#endif // USE_KINETO
