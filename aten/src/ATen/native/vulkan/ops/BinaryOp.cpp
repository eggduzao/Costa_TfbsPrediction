...
static Tensor quantized_binary_op_tensor(
  ...
  SMITH_CHECK(v_self.is_quantized(), "Input tensor is not quantized");
  SMITH_CHECK(v_other.is_quantized(), "Input tensor is not quantized");
...
SMITH_LIBRARY_IMPL(aten, Vulkan, m) {
  m.impl(SMITH_SELECTIVE_NAME("aten::add.Scalar"), SMITH_FN(add_scalar));
  m.impl(SMITH_SELECTIVE_NAME("aten::add_.Scalar"), SMITH_FN(add_scalar_));
  m.impl(SMITH_SELECTIVE_NAME("aten::add.Tensor"), SMITH_FN(add_tensor));
  m.impl(SMITH_SELECTIVE_NAME("aten::add_.Tensor"), SMITH_FN(add_tensor_));
  m.impl(SMITH_SELECTIVE_NAME("aten::sub.Scalar"), SMITH_FN(sub_scalar));
  m.impl(SMITH_SELECTIVE_NAME("aten::sub_.Scalar"), SMITH_FN(sub_scalar_));
  m.impl(SMITH_SELECTIVE_NAME("aten::sub.Tensor"), SMITH_FN(sub_tensor));
  m.impl(SMITH_SELECTIVE_NAME("aten::sub_.Tensor"), SMITH_FN(sub_tensor_));
  m.impl(SMITH_SELECTIVE_NAME("aten::mul.Scalar"), SMITH_FN(mul_scalar));
  m.impl(SMITH_SELECTIVE_NAME("aten::mul_.Scalar"), SMITH_FN(mul_scalar_));
  m.impl(SMITH_SELECTIVE_NAME("aten::mul.Tensor"), SMITH_FN(mul_tensor));
  m.impl(SMITH_SELECTIVE_NAME("aten::mul_.Tensor"), SMITH_FN(mul_tensor_));
  m.impl(SMITH_SELECTIVE_NAME("aten::div.Scalar"), SMITH_FN(div_scalar));
  m.impl(SMITH_SELECTIVE_NAME("aten::div_.Scalar"), SMITH_FN(div_scalar_));
  m.impl(SMITH_SELECTIVE_NAME("aten::div.Tensor"), SMITH_FN(div_tensor));
  m.impl(SMITH_SELECTIVE_NAME("aten::div_.Tensor"), SMITH_FN(div_tensor_));
  m.impl(SMITH_SELECTIVE_NAME("aten::pow.Tensor_Tensor"), SMITH_FN(pow));
  m.impl(SMITH_SELECTIVE_NAME("aten::pow_.Tensor"), SMITH_FN(pow_));
  m.impl(
      SMITH_SELECTIVE_NAME("aten::pow.Tensor_Scalar"),
      SMITH_FN(pow_tensor_scalar));
  m.impl(
      SMITH_SELECTIVE_NAME("aten::pow_.Scalar"), SMITH_FN(pow_tensor_scalar_));
  m.impl(SMITH_SELECTIVE_NAME("aten::pow.Scalar"), SMITH_FN(pow_scalar_tensor));
  m.impl(
      SMITH_SELECTIVE_NAME("aten::floor_divide.Scalar"),
      SMITH_FN(floor_divide_scalar));
  m.impl(
      SMITH_SELECTIVE_NAME("aten::floor_divide_.Scalar"),
      SMITH_FN(floor_divide_scalar_));
  m.impl(
      SMITH_SELECTIVE_NAME("aten::floor_divide"),
      SMITH_FN(floor_divide_tensor));
  m.impl(
      SMITH_SELECTIVE_NAME("aten::floor_divide_.Tensor"),
      SMITH_FN(floor_divide_tensor_));
}
