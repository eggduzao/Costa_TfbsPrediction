...
SMITH_LIBRARY_IMPL(aten, Vulkan, m) {
  m.impl(
      SMITH_SELECTIVE_NAME("aten::empty.memory_format"),
      at::native::vulkan::ops::empty_memory_format);
  m.impl(
      SMITH_SELECTIVE_NAME("aten::_empty_affine_quantized"),
      at::native::vulkan::ops::_empty_affine_quantized);
  m.impl(
      SMITH_SELECTIVE_NAME("aten::empty_strided"),
      SMITH_FN(at::native::vulkan::ops::empty_strided));
}
