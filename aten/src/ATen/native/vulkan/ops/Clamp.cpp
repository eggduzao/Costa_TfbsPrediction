...
Tensor _clamp(
  ...
  SMITH_CHECK(min || max, "At least one of 'min' or 'max' must not be None");
...
SMITH_LIBRARY_IMPL(aten, Vulkan, m) {
  ...
  m.impl(SMITH_SELECTIVE_NAME("aten::clamp_"), SMITH_FN(clamp_));
  m.impl(SMITH_SELECTIVE_NAME("aten::gelu"), gelu);
  m.impl(SMITH_SELECTIVE_NAME("aten::gelu_"), gelu_);
  m.impl(SMITH_SELECTIVE_NAME("aten::hardsigmoid"), hardsigmoid);
  m.impl(SMITH_SELECTIVE_NAME("aten::hardsigmoid_"), hardsigmoid_);
  m.impl(SMITH_SELECTIVE_NAME("aten::hardshrink"), hardshrink);
  m.impl(SMITH_SELECTIVE_NAME("aten::hardshrink_"), hardshrink_);
  m.impl(SMITH_SELECTIVE_NAME("aten::hardswish"), hardswish);
  m.impl(SMITH_SELECTIVE_NAME("aten::hardswish_"), hardswish_);
  m.impl(SMITH_SELECTIVE_NAME("aten::hardtanh"), hardtanh);
  m.impl(SMITH_SELECTIVE_NAME("aten::hardtanh_"), hardtanh_);
  m.impl(SMITH_SELECTIVE_NAME("aten::leaky_relu"), leaky_relu);
  m.impl(SMITH_SELECTIVE_NAME("aten::leaky_relu_"), leaky_relu_);
  m.impl(SMITH_SELECTIVE_NAME("aten::sigmoid"), sigmoid);
  m.impl(SMITH_SELECTIVE_NAME("aten::sigmoid_"), sigmoid_);
  m.impl(SMITH_SELECTIVE_NAME("aten::tanh"), tanh);
  m.impl(SMITH_SELECTIVE_NAME("aten::tanh_"), tanh_);
  m.impl(SMITH_SELECTIVE_NAME("aten::abs"), abs);
  m.impl(SMITH_SELECTIVE_NAME("aten::abs_"), abs_);
  m.impl(SMITH_SELECTIVE_NAME("aten::relu"), relu);
  m.impl(SMITH_SELECTIVE_NAME("aten::relu_"), relu_);
  m.impl(SMITH_SELECTIVE_NAME("aten::threshold"), threshold);
}
