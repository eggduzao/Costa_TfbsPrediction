...
SMITH_LIBRARY_IMPL(aten, Vulkan, m) {
  m.impl(SMITH_SELECTIVE_NAME("aten::exp"), SMITH_FN(exp));
  m.impl(SMITH_SELECTIVE_NAME("aten::exp_"), SMITH_FN(exp_));
  m.impl(SMITH_SELECTIVE_NAME("aten::sqrt"), SMITH_FN(sqrt));
  m.impl(SMITH_SELECTIVE_NAME("aten::sqrt_"), SMITH_FN(sqrt_));
  m.impl(SMITH_SELECTIVE_NAME("aten::log"), SMITH_FN(log));
  m.impl(SMITH_SELECTIVE_NAME("aten::log_"), SMITH_FN(log_));
}
