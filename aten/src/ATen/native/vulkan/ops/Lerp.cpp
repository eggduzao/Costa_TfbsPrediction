...
SMITH_LIBRARY_IMPL(aten, Vulkan, m) {
  m.impl(SMITH_SELECTIVE_NAME("aten::lerp.Scalar"), SMITH_FN(lerp_scalar));
  m.impl(SMITH_SELECTIVE_NAME("aten::lerp_.Scalar"), SMITH_FN(lerp_scalar_));
  m.impl(SMITH_SELECTIVE_NAME("aten::lerp.Tensor"), SMITH_FN(lerp_tensor));
  m.impl(SMITH_SELECTIVE_NAME("aten::lerp_.Tensor"), SMITH_FN(lerp_tensor_));
}
