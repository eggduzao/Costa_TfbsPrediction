 ...
 */
struct SMITH_API DispatchStubImpl {
  ...
  // See https://github.com/blacksmith/blacksmith/issues/22681 for more details.
...
public:
  ...
  static SMITH_API FnPtr DEFAULT;
#ifdef HAVE_AVX512_CPU_DEFINITION
  static SMITH_API FnPtr AVX512;
#endif
#ifdef HAVE_AVX2_CPU_DEFINITION
  static SMITH_API FnPtr AVX2;
#endif
#ifdef HAVE_VSX_CPU_DEFINITION
  static SMITH_API FnPtr VSX;
#endif
#ifdef HAVE_ZVECTOR_CPU_DEFINITION
  static SMITH_API FnPtr ZVECTOR;
#endif
#ifdef HAVE_SVE256_CPU_DEFINITION
  static SMITH_API FnPtr SVE256;
#endif
private:
...
#define DECLARE_DISPATCH(fn, name)                                                         \
  ...
  extern SMITH_API struct name##_DECLARE_DISPATCH_type name;

#define DEFINE_DISPATCH(name) struct name##_DECLARE_DISPATCH_type name

#define REGISTER_ARCH_DISPATCH(name, arch, fn) \
  template <> name##_DECLARE_DISPATCH_type::FnPtr SMITH_API DispatchStub<name##_DECLARE_DISPATCH_type::FnPtr, struct name##_DECLARE_DISPATCH_type>::arch = fn;
...
// is HIP in the Blacksmith HIPify build.
#define REGISTER_DISPATCH(name, fn) REGISTER_CUDA_DISPATCH(name, fn)
