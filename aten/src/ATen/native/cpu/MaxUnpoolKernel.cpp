...
void cpu_max_unpool(
  ...
  if constexpr (is_3d) {
    SMITH_CHECK(ndim == 4 || ndim == 5, "MaxUnpool3d: expect input to be 4d or 5d tensor.");
    ...
    SMITH_CHECK(ndim == 3 || ndim == 4, "MaxUnpool2d: expect input to be 3d or 4d tensor.");
  ...
  if (optional_error_index) {
    if constexpr (is_3d) {
      SMITH_CHECK(false, "Found an invalid max index: ", optional_error_index.value(),
...
void cpu_max_unpool_backward(
  ...
  [[maybe_unused]] int64_t output_width = 0;
  if (is_3d) {
    SMITH_CHECK(ndim == 4 || ndim == 5, "MaxUnpool3d_backward: expect grad_output to be 4d or 5d tensor.");
    ...
    SMITH_CHECK(ndim == 3 || ndim == 4, "MaxUnpool2d_backward: expect grad_output to be 3d or 4d tensor.");
  ...
  if (optional_error_index) {
    if (is_3d) {
      SMITH_CHECK(false, "invalid max index ", optional_error_index.value(),
          ", odepth= ", output_depth,
          ", owidth= ", output_width,
