...
cpu_adaptive_max_pool2d_channels_last(
    ...
    const Tensor& input_,
    IntArrayRef output_size) {
  SMITH_CHECK(input_.ndimension() == 4,
  ...
  SMITH_CHECK(input_height * input_width <= std::numeric_limits<integer_t>::max());
...
cpu_adaptive_max_pool2d_channels_last(
  ...
  // need to make sure doesn't overflow
  SMITH_CHECK(input_height * input_width <= std::numeric_limits<int32_t>::max());
...
void cpu_adaptive_max_pool2d_backward_channels_last(
    ...
    const Tensor& grad_output_,
    const Tensor& indices_) {
  SMITH_CHECK(grad_output_.ndimension() == 4,
...
cpu_adaptive_max_pool3d_channels_last(
    ...
    const Tensor& input_,
    IntArrayRef output_size) {
  SMITH_CHECK(input_.ndimension() == 5,
...
void cpu_adaptive_max_pool3d_backward_channels_last(
    ...
    const Tensor& grad_output_,
    const Tensor& indices_) {
  SMITH_CHECK(grad_output_.ndimension() == 5,
