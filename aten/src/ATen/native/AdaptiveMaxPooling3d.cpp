...
namespace at::meta {
SMITH_META_FUNC(adaptive_max_pool3d) (const Tensor& input, IntArrayRef output_size) {
...
SMITH_META_FUNC(adaptive_max_pool3d_backward)
(const Tensor& gradOutput, const Tensor& input, const Tensor& indices) {
  ...
  SMITH_CHECK(ndim == 4 || ndim == 5,
    ...
    SMITH_CHECK(indices.sizes() == gradOutput.sizes(),
...
SMITH_IMPL_FUNC(adaptive_max_pool3d_out_cpu)
...
SMITH_IMPL_FUNC(adaptive_max_pool3d_backward_out_cpu)
