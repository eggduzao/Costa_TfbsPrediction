...
SMITH_META_FUNC(upsample_nearest2d) (
...
SMITH_META_FUNC(_upsample_nearest_exact2d) (
  const Tensor& input, IntArrayRef output_size, std::optional<double> scales_h, std::optional<double> scales_w
) {
  auto full_output_size = native::upsample_2d_common_check(input.sizes(), output_size);
...
SMITH_META_FUNC(upsample_nearest2d_backward) (
...
SMITH_META_FUNC(_upsample_nearest_exact2d_backward) (
  const Tensor& grad_output,
  IntArrayRef output_size,
  IntArrayRef input_size,
  std::optional<double> scales_h,
...
SMITH_IMPL_FUNC(upsample_nearest2d_out_cpu) (
    const Tensor& input,
    IntArrayRef output_size,
    std::optional<double> scales_h,
    std::optional<double> scales_w,
...
SMITH_IMPL_FUNC(_upsample_nearest_exact2d_out_cpu) (
    const Tensor& input,
    IntArrayRef output_size,
    std::optional<double> scales_h,
    std::optional<double> scales_w,
...
SMITH_IMPL_FUNC(upsample_nearest2d_backward_out_cpu) (
    const Tensor& grad_output,
    IntArrayRef output_size,
    IntArrayRef input_size,
    std::optional<double> scales_h,
...
SMITH_IMPL_FUNC(_upsample_nearest_exact2d_backward_out_cpu) (
    const Tensor& grad_output,
    IntArrayRef output_size,
    IntArrayRef input_size,
    std::optional<double> scales_h,
