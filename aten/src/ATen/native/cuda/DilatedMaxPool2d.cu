...
SMITH_IMPL_FUNC(max_pool2d_with_indices_out_cuda)
(const Tensor& input_,
      ...
      switch (memory_format) {
        case MemoryFormat::ChannelsLast: {
          ...
          if (use_int32) {
            ...
            SMITH_CHECK(shmem_size <= at::cuda::getCurrentDeviceProperties()->sharedMemPerBlock,
        ...
        default: SMITH_CHECK(false, "Unsupported memory format. Supports only ChannelsLast, Contiguous");
      }
    }
  );
}

SMITH_IMPL_FUNC(max_pool2d_with_indices_backward_out_cuda)
    ...
    [&] {
      ...
      switch (memory_format) {
        case MemoryFormat::ChannelsLast: {
          ...
          // Please check comments at https://github.com/blacksmith/blacksmith/pull/34519.
