...
void getrf<float>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnSgetrf(
...
void getrs<double>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnDgetrs(
...
void getrs<float>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnSgetrs(
    handle, trans, n, nrhs, dA, lda, ipiv, ret, ldb, info));
}
...
void getrs<c10::complex<double>>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnZgetrs(
      handle,
      trans,
      n,
      nrhs,
...
void getrs<c10::complex<float>>(
    ...
    int* info,
    cublasOperation_t trans) {
  SMITH_CUSOLVER_CHECK(cusolverDnCgetrs(
      handle,
      trans,
      n,
      nrhs,
...
void sytrf_bufferSize<double>(CUDASOLVER_SYTRF_BUFFER_ARGTYPES(double)) {
  SMITH_CUSOLVER_CHECK(cusolverDnDsytrf_bufferSize(handle, n, A, lda, lwork));
}

template <>
void sytrf_bufferSize<float>(CUDASOLVER_SYTRF_BUFFER_ARGTYPES(float)) {
  SMITH_CUSOLVER_CHECK(cusolverDnSsytrf_bufferSize(handle, n, A, lda, lwork));
}

template <>
void sytrf_bufferSize<c10::complex<double>>(
    CUDASOLVER_SYTRF_BUFFER_ARGTYPES(c10::complex<double>)) {
  SMITH_CUSOLVER_CHECK(cusolverDnZsytrf_bufferSize(
...
void sytrf_bufferSize<c10::complex<float>>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnCsytrf_bufferSize(
...
void sytrf<c10::complex<double>>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnZsytrf(
      handle,
      uplo,
      n,
...
void sytrf<c10::complex<float>>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnCsytrf(
      handle,
      uplo,
      n,
...
void gesvd_buffersize<float>(CUDASOLVER_GESVD_BUFFERSIZE_ARGTYPES()) {
  SMITH_CUSOLVER_CHECK(cusolverDnSgesvd_bufferSize(handle, m, n, lwork));
}

template<>
void gesvd_buffersize<double>(CUDASOLVER_GESVD_BUFFERSIZE_ARGTYPES()) {
  SMITH_CUSOLVER_CHECK(cusolverDnDgesvd_bufferSize(handle, m, n, lwork));
}

template<>
void gesvd_buffersize<c10::complex<float>>(CUDASOLVER_GESVD_BUFFERSIZE_ARGTYPES()) {
  SMITH_CUSOLVER_CHECK(cusolverDnCgesvd_bufferSize(handle, m, n, lwork));
}

template<>
void gesvd_buffersize<c10::complex<double>>(CUDASOLVER_GESVD_BUFFERSIZE_ARGTYPES()) {
  SMITH_CUSOLVER_CHECK(cusolverDnZgesvd_bufferSize(handle, m, n, lwork));
}


template<>
void gesvd<float>(CUDASOLVER_GESVD_ARGTYPES(float, float)) {
  SMITH_CUSOLVER_CHECK(cusolverDnSgesvd(
...
void gesvd<double>(CUDASOLVER_GESVD_ARGTYPES(double, double)) {
  SMITH_CUSOLVER_CHECK(cusolverDnDgesvd(
      handle, jobu, jobvt, m, n, A, lda, S, U, ldu, VT, ldvt, work, lwork, rwork, info));
}
...
void gesvd<c10::complex<float>>(CUDASOLVER_GESVD_ARGTYPES(c10::complex<float>, float)) {
  SMITH_CUSOLVER_CHECK(cusolverDnCgesvd(
...
void gesvd<c10::complex<double>>(CUDASOLVER_GESVD_ARGTYPES(c10::complex<double>, double)) {
  SMITH_CUSOLVER_CHECK(cusolverDnZgesvd(
      handle, jobu, jobvt, m, n,
      reinterpret_cast<cuDoubleComplex*>(A),
      lda, S,
...
void gesvdj_buffersize<float>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnSgesvdj_bufferSize(handle, jobz, econ, m, n, A, lda, S, U, ldu, V, ldv, lwork, params));
}
...
void gesvdj_buffersize<double>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnDgesvdj_bufferSize(handle, jobz, econ, m, n, A, lda, S, U, ldu, V, ldv, lwork, params));
}
...
void gesvdj_buffersize<c10::complex<float>>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnCgesvdj_bufferSize(handle, jobz, econ, m, n,
    reinterpret_cast<cuComplex*>(A),
    lda,
    S,
    reinterpret_cast<cuComplex*>(U),
...
void gesvdj_buffersize<c10::complex<double>>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnZgesvdj_bufferSize(handle, jobz, econ, m, n,
    reinterpret_cast<cuDoubleComplex*>(A),
    lda,
    S,
    reinterpret_cast<cuDoubleComplex*>(U),
...
void gesvdj<float>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnSgesvdj(handle, jobz, econ, m, n, A, lda, S, U, ldu, V, ldv, work, lwork, info, params));
}
...
void gesvdj<double>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnDgesvdj(handle, jobz, econ, m, n, A, lda, S, U, ldu, V, ldv, work, lwork, info, params));
}
...
void gesvdj<c10::complex<float>>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnCgesvdj(
...
void gesvdj<c10::complex<double>>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnZgesvdj(
    handle, jobz, econ, m, n,
    reinterpret_cast<cuDoubleComplex*>(A),
    lda, S,
    reinterpret_cast<cuDoubleComplex*>(U),
...
void gesvdjBatched<float>(
  ...
  int lwork;
  SMITH_CUSOLVER_CHECK(cusolverDnSgesvdjBatched_bufferSize(handle, jobz, m, n, A, lda, S, U, ldu, V, ldv, &lwork, params, batchSize));

  auto& allocator = *::c10::cuda::CUDACachingAllocator::get();
  auto dataPtr = allocator.allocate(sizeof(float)*lwork);

  SMITH_CUSOLVER_CHECK(cusolverDnSgesvdjBatched(
...
void gesvdjBatched<double>(
  ...
  int lwork;
  SMITH_CUSOLVER_CHECK(cusolverDnDgesvdjBatched_bufferSize(handle, jobz, m, n, A, lda, S, U, ldu, V, ldv, &lwork, params, batchSize));

  auto& allocator = *::c10::cuda::CUDACachingAllocator::get();
  auto dataPtr = allocator.allocate(sizeof(double)*lwork);

  SMITH_CUSOLVER_CHECK(cusolverDnDgesvdjBatched(
    handle, jobz, m, n, A, lda, S, U, ldu, V, ldv,
...
void gesvdjBatched<c10::complex<float>>(
  ...
  int lwork;
  SMITH_CUSOLVER_CHECK(cusolverDnCgesvdjBatched_bufferSize(
    handle, jobz, m, n,
    reinterpret_cast<cuComplex*>(A),
    lda, S,
    reinterpret_cast<cuComplex*>(U),
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnCgesvdjBatched(
    handle, jobz, m, n,
    reinterpret_cast<cuComplex*>(A),
    lda, S,
    reinterpret_cast<cuComplex*>(U),
...
void gesvdjBatched<c10::complex<double>>(
  ...
  int lwork;
  SMITH_CUSOLVER_CHECK(cusolverDnZgesvdjBatched_bufferSize(
    handle, jobz, m, n,
    reinterpret_cast<cuDoubleComplex*>(A),
    lda, S,
    reinterpret_cast<cuDoubleComplex*>(U),
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnZgesvdjBatched(
    handle, jobz, m, n,
    reinterpret_cast<cuDoubleComplex*>(A),
    lda, S,
    reinterpret_cast<cuDoubleComplex*>(U),
...
void gesvdaStridedBatched_buffersize<float>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnSgesvdaStridedBatched_bufferSize(
...
void gesvdaStridedBatched_buffersize<double>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnDgesvdaStridedBatched_bufferSize(
    handle, jobz, rank, m, n, A, lda, strideA, S, strideS, U, ldu, strideU, V, ldv, strideV, lwork, batchSize
  ));
}
...
void gesvdaStridedBatched_buffersize<c10::complex<float>>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnCgesvdaStridedBatched_bufferSize(
...
void gesvdaStridedBatched_buffersize<c10::complex<double>>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnZgesvdaStridedBatched_bufferSize(
    handle, jobz, rank, m, n,
    reinterpret_cast<cuDoubleComplex*>(A),
    lda, strideA, S, strideS,
    reinterpret_cast<cuDoubleComplex*>(U),
...
void gesvdaStridedBatched<float>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnSgesvdaStridedBatched(
...
void gesvdaStridedBatched<double>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnDgesvdaStridedBatched(
    handle, jobz, rank, m, n, A, lda, strideA, S, strideS, U, ldu, strideU, V, ldv, strideV, work, lwork, info, h_R_nrmF, batchSize
  ));
}
...
void gesvdaStridedBatched<c10::complex<float>>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnCgesvdaStridedBatched(
    handle, jobz, rank, m, n,
    reinterpret_cast<cuComplex*>(A),
    lda, strideA, S, strideS,
    reinterpret_cast<cuComplex*>(U),
...
void gesvdaStridedBatched<c10::complex<double>>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnZgesvdaStridedBatched(
    handle, jobz, rank, m, n,
    reinterpret_cast<cuDoubleComplex*>(A),
    lda, strideA, S, strideS,
    reinterpret_cast<cuDoubleComplex*>(U),
...
void potrf<float>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnSpotrf(
...
void potrf<double>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnDpotrf(
    handle, uplo, n, A, lda, work, lwork, info));
}
...
void potrf<c10::complex<float>>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnCpotrf(
    handle,
    uplo,
    n,
    reinterpret_cast<cuComplex*>(A),
...
void potrf<c10::complex<double>>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnZpotrf(
    handle,
    uplo,
    n,
    reinterpret_cast<cuDoubleComplex*>(A),
...
void potrf_buffersize<float>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnSpotrf_bufferSize(handle, uplo, n, A, lda, lwork));
}
...
void potrf_buffersize<double>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnDpotrf_bufferSize(handle, uplo, n, A, lda, lwork));
}
...
void potrf_buffersize<c10::complex<float>>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnCpotrf_bufferSize(
    handle, uplo, n,
    reinterpret_cast<cuComplex*>(A),
    lda, lwork));
}
...
void potrf_buffersize<c10::complex<double>>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnZpotrf_bufferSize(
    handle, uplo, n,
    reinterpret_cast<cuDoubleComplex*>(A),
    lda, lwork));
}
...
void potrfBatched<float>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnSpotrfBatched(handle, uplo, n, A, lda, info, batchSize));
}
...
void potrfBatched<double>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnDpotrfBatched(handle, uplo, n, A, lda, info, batchSize));
}
...
void potrfBatched<c10::complex<float>>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnCpotrfBatched(
    handle, uplo, n,
    reinterpret_cast<cuComplex**>(A),
    lda, info, batchSize));
}
...
void potrfBatched<c10::complex<double>>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnZpotrfBatched(
    handle, uplo, n,
    reinterpret_cast<cuDoubleComplex**>(A),
    lda, info, batchSize));
}
...
void geqrf_bufferSize<c10::complex<float>>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnCgeqrf_bufferSize(
...
void geqrf_bufferSize<c10::complex<double>>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnZgeqrf_bufferSize(
...
void geqrf<c10::complex<float>>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnCgeqrf(
      handle,
      m,
      n,
      reinterpret_cast<cuComplex*>(A),
...
void geqrf<c10::complex<double>>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnZgeqrf(
      handle,
      m,
      n,
      reinterpret_cast<cuDoubleComplex*>(A),
...
void potrs<float>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnSpotrs(handle, uplo, n, nrhs, A, lda, B, ldb, devInfo));
}
...
void potrs<double>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnDpotrs(handle, uplo, n, nrhs, A, lda, B, ldb, devInfo));
}
...
void potrs<c10::complex<float>>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnCpotrs(
    handle, uplo, n, nrhs,
...
void potrs<c10::complex<double>>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnZpotrs(
    handle, uplo, n, nrhs,
...
void potrsBatched<float>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnSpotrsBatched(handle, uplo, n, nrhs, Aarray, lda, Barray, ldb, info, batchSize));
}
...
void potrsBatched<double>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnDpotrsBatched(handle, uplo, n, nrhs, Aarray, lda, Barray, ldb, info, batchSize));
}
...
void potrsBatched<c10::complex<float>>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnCpotrsBatched(
    handle, uplo, n, nrhs,
...
void potrsBatched<c10::complex<double>>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnZpotrsBatched(
    handle, uplo, n, nrhs,
...
void orgqr_buffersize<c10::complex<float>>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnCungqr_bufferSize(
      handle,
      m, n, k,
...
void orgqr_buffersize<c10::complex<double>>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnZungqr_bufferSize(
      handle,
      m, n, k,
...
void orgqr<c10::complex<float>>(
    ...
    int* devInfo) {
  SMITH_CUSOLVER_CHECK(cusolverDnCungqr(
      handle,
      m, n, k,
...
void orgqr<c10::complex<double>>(
    ...
    int* devInfo) {
  SMITH_CUSOLVER_CHECK(cusolverDnZungqr(
      handle,
      m, n, k,
...
void ormqr_bufferSize<c10::complex<float>>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnCunmqr_bufferSize(
      handle, side, trans,
      m, n, k,
      reinterpret_cast<const cuComplex*>(A), lda,
      reinterpret_cast<const cuComplex*>(tau),
...
void ormqr_bufferSize<c10::complex<double>>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnZunmqr_bufferSize(
      handle, side, trans,
      m, n, k,
      reinterpret_cast<const cuDoubleComplex*>(A), lda,
      reinterpret_cast<const cuDoubleComplex*>(tau),
...
void ormqr<c10::complex<float>>(CUDASOLVER_ORMQR_ARGTYPES(c10::complex<float>)) {
  SMITH_CUSOLVER_CHECK(cusolverDnCunmqr(
      handle, side, trans,
      m, n, k,
      reinterpret_cast<const cuComplex*>(A), lda,
      reinterpret_cast<const cuComplex*>(tau),
...
void ormqr<c10::complex<double>>(CUDASOLVER_ORMQR_ARGTYPES(c10::complex<double>)) {
  SMITH_CUSOLVER_CHECK(cusolverDnZunmqr(
      handle, side, trans,
      m, n, k,
      reinterpret_cast<const cuDoubleComplex*>(A), lda,
      reinterpret_cast<const cuDoubleComplex*>(tau),
...
void xpotrf_buffersize(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnXpotrf_bufferSize(
...
void xpotrf(
    ...
    int *info) {
  SMITH_CUSOLVER_CHECK(cusolverDnXpotrf(
...
void syevd_bufferSize<c10::complex<float>, float>(
    ...
    const float* W,
    int* lwork) {
  SMITH_CUSOLVER_CHECK(cusolverDnCheevd_bufferSize(
      handle,
      jobz,
      uplo,
      n,
...
void syevd_bufferSize<c10::complex<double>, double>(
    ...
    const double* W,
    int* lwork) {
  SMITH_CUSOLVER_CHECK(cusolverDnZheevd_bufferSize(
      handle,
      jobz,
      uplo,
      n,
...
void syevd<c10::complex<float>, float>(
    ...
    int lwork,
    int* info) {
  SMITH_CUSOLVER_CHECK(cusolverDnCheevd(
      handle,
      jobz,
      uplo,
      n,
...
void syevd<c10::complex<double>, double>(
    ...
    int lwork,
    int* info) {
  SMITH_CUSOLVER_CHECK(cusolverDnZheevd(
      handle,
      jobz,
      uplo,
      n,
...
void syevj_bufferSize<float>(
    ...
    int* lwork,
    syevjInfo_t params) {
  SMITH_CUSOLVER_CHECK(cusolverDnSsyevj_bufferSize(
...
void syevj_bufferSize<double>(
    ...
    int* lwork,
    syevjInfo_t params) {
  SMITH_CUSOLVER_CHECK(cusolverDnDsyevj_bufferSize(
      handle, jobz, uplo, n, A, lda, W, lwork, params));
}
...
void syevj_bufferSize<c10::complex<float>, float>(
    ...
    int* lwork,
    syevjInfo_t params) {
  SMITH_CUSOLVER_CHECK(cusolverDnCheevj_bufferSize(
      handle,
      jobz,
      uplo,
      n,
...
void syevj_bufferSize<c10::complex<double>, double>(
    ...
    int* lwork,
    syevjInfo_t params) {
  SMITH_CUSOLVER_CHECK(cusolverDnZheevj_bufferSize(
      handle,
      jobz,
      uplo,
      n,
...
void syevj<float>(
    ...
    int* info,
    syevjInfo_t params) {
  SMITH_CUSOLVER_CHECK(cusolverDnSsyevj(
...
void syevj<double>(
    ...
    int* info,
    syevjInfo_t params) {
  SMITH_CUSOLVER_CHECK(cusolverDnDsyevj(
      handle, jobz, uplo, n, A, lda, W, work, lwork, info, params));
}
...
void syevj<c10::complex<float>, float>(
    ...
    int* info,
    syevjInfo_t params) {
  SMITH_CUSOLVER_CHECK(cusolverDnCheevj(
      handle,
      jobz,
      uplo,
      n,
...
void syevj<c10::complex<double>, double>(
    ...
    int* info,
    syevjInfo_t params) {
  SMITH_CUSOLVER_CHECK(cusolverDnZheevj(
      handle,
      jobz,
      uplo,
      n,
...
void syevjBatched_bufferSize<float>(
    ...
    syevjInfo_t params,
    int batchsize) {
  SMITH_CUSOLVER_CHECK(cusolverDnSsyevjBatched_bufferSize(
...
void syevjBatched_bufferSize<double>(
    ...
    syevjInfo_t params,
    int batchsize) {
  SMITH_CUSOLVER_CHECK(cusolverDnDsyevjBatched_bufferSize(
      handle, jobz, uplo, n, A, lda, W, lwork, params, batchsize));
}
...
void syevjBatched_bufferSize<c10::complex<float>, float>(
    ...
    syevjInfo_t params,
    int batchsize) {
  SMITH_CUSOLVER_CHECK(cusolverDnCheevjBatched_bufferSize(
      handle,
      jobz,
      uplo,
      n,
...
void syevjBatched_bufferSize<c10::complex<double>, double>(
    ...
    syevjInfo_t params,
    int batchsize) {
  SMITH_CUSOLVER_CHECK(cusolverDnZheevjBatched_bufferSize(
      handle,
      jobz,
      uplo,
      n,
...
void syevjBatched<float>(
    ...
    syevjInfo_t params,
    int batchsize) {
  SMITH_CUSOLVER_CHECK(cusolverDnSsyevjBatched(
...
void syevjBatched<double>(
    ...
    syevjInfo_t params,
    int batchsize) {
  SMITH_CUSOLVER_CHECK(cusolverDnDsyevjBatched(
      handle, jobz, uplo, n, A, lda, W, work, lwork, info, params, batchsize));
}
...
void syevjBatched<c10::complex<float>, float>(
    ...
    syevjInfo_t params,
    int batchsize) {
  SMITH_CUSOLVER_CHECK(cusolverDnCheevjBatched(
      handle,
      jobz,
      uplo,
      n,
...
void syevjBatched<c10::complex<double>, double>(
    ...
    syevjInfo_t params,
    int batchsize) {
  SMITH_CUSOLVER_CHECK(cusolverDnZheevjBatched(
      handle,
      jobz,
      uplo,
      n,
...
void xpotrs(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnXpotrs(handle, params, uplo, n, nrhs, dataTypeA, A, lda, dataTypeB, B, ldb, info));
}

template <>
void xgeqrf_bufferSize<float>(CUDASOLVER_XGEQRF_BUFFERSIZE_ARGTYPES(float)) {
  SMITH_CUSOLVER_CHECK(cusolverDnXgeqrf_bufferSize(
      handle,
      params,
      m,
      n,
...
void xgeqrf<float>(CUDASOLVER_XGEQRF_ARGTYPES(float)) {
  SMITH_CUSOLVER_CHECK(cusolverDnXgeqrf(
      handle,
      params,
      m,
      n,
...
void xsyevd_bufferSize<float>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnXsyevd_bufferSize(
      handle,
      params,
      jobz,
      uplo,
...
void xsyevd<float>(
    ...
    size_t workspaceInBytesOnHost,
    int* info) {
  SMITH_CUSOLVER_CHECK(cusolverDnXsyevd(
      handle,
      params,
      jobz,
      uplo,
...
void xgeev_bufferSize<float>(
    ...
    size_t* workspaceInBytesOnDevice,
    size_t* workspaceInBytesOnHost) {
  SMITH_CUSOLVER_CHECK(cusolverDnXgeev_bufferSize(
...
void xgeev<float>(
  ...
  SMITH_CUSOLVER_CHECK(cusolverDnXgeev(
      handle,
      params,
      jobvl,
      jobvr,
...
void xsyevBatched_bufferSize<float>(
    ...
    size_t *workspaceInBytesOnHost,
    int64_t batchSize) {
  SMITH_CUSOLVER_CHECK(cusolverDnXsyevBatched_bufferSize(
       handle,
       params,
       jobz,
       uplo,
...
void xsyevBatched<float>(
    ...
    int *info,
    int64_t batchSize) {
  SMITH_CUSOLVER_CHECK(cusolverDnXsyevBatched(
       handle,
       params,
       jobz,
       uplo,
