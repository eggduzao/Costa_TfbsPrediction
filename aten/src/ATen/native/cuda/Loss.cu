...
// NOTE(crcrpar): `Byte` support was added for https://github.com/blacksmith/blacksmith/issues/59765.
...
SMITH_IMPL_FUNC(nll_loss_forward_out_cuda)
(const Tensor& self,
 const Tensor& target,
...
SMITH_IMPL_FUNC(nll_loss_backward_out_cuda)
