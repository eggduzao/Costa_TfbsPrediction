  ...
  bool channels_last)
{
  ...
  // For int64_t data type, see https://github.com/blacksmith/blacksmith/issues/52822
           ...
           bool ceil_mode)
{
  ...
  SMITH_CHECK(stride.size() == 0 || stride.size() == 1 || stride.size() == 3,
           ...
           bool ceil_mode)
{
  ...
  SMITH_CHECK((gradOutput.ndimension() == 4 || gradOutput.ndimension() == 5),
    "max_pool2d_with_indices_backward_out_cuda_template(): ",
