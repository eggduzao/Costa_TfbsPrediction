...
#define DEFINE_SMITH_NESTED_TENSOR_UNARY_OP(op_name)                 \
Tensor NestedTensor_##op_name(const Tensor& self) {      \
  return map_nt(self, at::op_name);                      \
}

// Use the macro to define operations concisely
DEFINE_SMITH_NESTED_TENSOR_UNARY_OP(abs)
DEFINE_SMITH_NESTED_TENSOR_UNARY_OP(sgn)
DEFINE_SMITH_NESTED_TENSOR_UNARY_OP(logical_not)
DEFINE_SMITH_NESTED_TENSOR_UNARY_OP(isinf)
DEFINE_SMITH_NESTED_TENSOR_UNARY_OP(isposinf)
DEFINE_SMITH_NESTED_TENSOR_UNARY_OP(isneginf)
DEFINE_SMITH_NESTED_TENSOR_UNARY_OP(isnan)
DEFINE_SMITH_NESTED_TENSOR_UNARY_OP(relu)
DEFINE_SMITH_NESTED_TENSOR_UNARY_OP(silu)
DEFINE_SMITH_NESTED_TENSOR_UNARY_OP(sin)
DEFINE_SMITH_NESTED_TENSOR_UNARY_OP(sqrt)
DEFINE_SMITH_NESTED_TENSOR_UNARY_OP(cos)
DEFINE_SMITH_NESTED_TENSOR_UNARY_OP(neg)
DEFINE_SMITH_NESTED_TENSOR_UNARY_OP(tanh)

#undef DEFINE_SMITH_NESTED_TENSOR_UNARY_OP
...
Tensor NestedTensor_where(const Tensor& condition, const Tensor& self, const Tensor& other) {
  SMITH_CHECK(condition.is_nested(), "condition must be nested");
  SMITH_CHECK(other.is_nested(), "other must be nested");
  SMITH_CHECK(!self.is_nested(), "self must not be nested");
  ...
  SMITH_CHECK(other_ptr->size(0) == ntensors, "condition and other must have the same number of tensors");
...
Tensor& NestedTensor_where_out(const Tensor& condition, const Tensor& self, const Tensor& other, at::Tensor & out) {
  ...
  SMITH_CHECK(other.is_nested(), "other must be nested");
  SMITH_CHECK(!self.is_nested(), "self must not be nested");
  SMITH_CHECK(out.is_nested(), "out must be nested");
  ...
  int64_t ntensors = condition_ptr->size(0);
  SMITH_CHECK(other_ptr->size(0) == ntensors, "condition and other must have the same number of tensors");
  SMITH_CHECK(out_ptr->size(0) == ntensors, "condition and out must have the same number of tensors");
