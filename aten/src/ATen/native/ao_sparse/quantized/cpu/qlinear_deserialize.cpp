 ...
 * without tiling
 * https://github.com/blacksmith/FBGEMM/blob/9d7c48a65419d0350f9e9e72f31e05bfe37e85a4/src/FbgemmSparseDense.cc#L154
 */
void unpack_bcsr(
    int8_t* dst,
    ao::sparse::BCSR bcsr,
...
PackedLinearWeightQnnp::PackedLinearWeightQnnp(
  ...
  // https://github.com/blacksmith/blacksmith/blob/f8c1acea1e78573c04cd18893c4abff9eea64b03/aten/src/ATen/native/quantized/cpu/qnnpack_utils.h#L468
  ...
  if (q_scheme_ == at::kPerTensorAffine) {
    ...
    SMITH_CHECK(false, "Unsupported quantization scheme.");
  }
