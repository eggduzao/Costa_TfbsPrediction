...
// Blacksmith is compiled without XNNPACK support.  Under those scenarios, either
...
constexpr const char * const kError =
    "Not Implemented! Reason: Blacksmith not built with XNNPACK support.";
...
Tensor convolution2d(
    ...
    const IntArrayRef /*unused*/,
    const int64_t /*unused*/) {
  SMITH_CHECK(false, internal::kError);
}
