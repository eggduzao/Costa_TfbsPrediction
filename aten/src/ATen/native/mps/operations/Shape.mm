...
static void check_shape_except_dim(const Tensor& first, const Tensor& second, int dimension, int index) {
  ...
  for (int dim = 0; dim < first_dims; dim++) {
    ...
    SMITH_CHECK(first_dim_size == second_dim_size,
