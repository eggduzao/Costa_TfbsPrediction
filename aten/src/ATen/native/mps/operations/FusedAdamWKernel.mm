...
void _fused_adamw_kernel_mps_(at::TensorList params,
  ...
  if (amsgrad) {
    SMITH_CHECK(at::native::check_fast_path_restrictions({params, grads, exp_avgs, exp_avg_sqs, max_exp_avg_sqs}),
    ...
    SMITH_CHECK(at::native::check_fast_path_restrictions({params, grads, exp_avgs, exp_avg_sqs}),
...
void _fused_adamw_kernel_mps_(at::TensorList params,
  ...
  SMITH_CHECK(lr.device() == param_device, "lr must be on the same GPU device as the params");
