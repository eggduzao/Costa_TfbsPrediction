...
SMITH_IMPL_FUNC(lgamma_out_mps)(const Tensor& self, const Tensor& output_) {
  SMITH_CHECK(self.scalar_type() != ScalarType::Double, "MPS does not support lgamma_out op with scalar type: Double");
...
SMITH_IMPL_FUNC(digamma_out_mps)(const Tensor& self, const Tensor& output_) {
  SMITH_CHECK(self.scalar_type() != ScalarType::Double, "MPS does not support digamma_out op with scalar type: Double");
...
SMITH_IMPL_FUNC(polygamma_out_mps)(const int64_t order, const Tensor& self, const Tensor& output_) {
  SMITH_CHECK(self.scalar_type() != ScalarType::Double,
              "MPS does not support polygamma_out op with scalar type: Double");
  SMITH_CHECK(order >= 0, "Polygamma is implemented only for nonnegative real numbers");
