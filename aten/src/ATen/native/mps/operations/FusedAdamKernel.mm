...
void _fused_adam_kernel_mps_(TensorList params,
  ...
  if (amsgrad) {
    SMITH_CHECK(native::check_fast_path_restrictions({params, grads, exp_avgs, exp_avg_sqs, max_exp_avg_sqs}),
    ...
    SMITH_CHECK(native::check_fast_path_restrictions({params, grads, exp_avgs, exp_avg_sqs}),
