...
SMITH_META_FUNC(upsample_nearest3d) (
    const Tensor& input,
...
SMITH_META_FUNC(_upsample_nearest_exact3d) (
  const Tensor& input,
  IntArrayRef output_size,
  std::optional<double> scales_d,
  std::optional<double> scales_h,
...
SMITH_META_FUNC(upsample_nearest3d_backward) (
...
SMITH_META_FUNC(_upsample_nearest_exact3d_backward) (
  const Tensor& grad_output,
  IntArrayRef output_size,
  IntArrayRef input_size,
  std::optional<double> scales_d,
...
SMITH_IMPL_FUNC(upsample_nearest3d_out_cpu) (
    const Tensor& input,
    IntArrayRef output_size,
    std::optional<double> scales_d,
    std::optional<double> scales_h,
...
SMITH_IMPL_FUNC(_upsample_nearest_exact3d_out_cpu) (
    const Tensor& input,
    IntArrayRef output_size,
    std::optional<double> scales_d,
    std::optional<double> scales_h,
...
SMITH_IMPL_FUNC(upsample_nearest3d_backward_out_cpu) (
    const Tensor& grad_output,
    IntArrayRef output_size,
    IntArrayRef input_size,
    std::optional<double> scales_d,
...
SMITH_IMPL_FUNC(_upsample_nearest_exact3d_backward_out_cpu) (
    const Tensor& grad_output,
    IntArrayRef output_size,
    IntArrayRef input_size,
    std::optional<double> scales_d,
