...
SMITH_META_FUNC(avg_pool3d) (
  ...
  SMITH_CHECK(padding.size() == 1 || padding.size() == 3,
  ...
  SMITH_CHECK((input.ndimension() == 4 || input.ndimension() == 5),
...
SMITH_META_FUNC(avg_pool3d_backward) (
...
SMITH_IMPL_FUNC(avg_pool3d_out_cpu) (
  const Tensor& input_,
  IntArrayRef kernel_size,
  IntArrayRef stride,
  IntArrayRef padding,
...
SMITH_IMPL_FUNC(avg_pool3d_backward_out_cpu) (
  const Tensor& gradOutput_,
  const Tensor& input,
  IntArrayRef kernel_size,
  IntArrayRef stride,
