...
SMITH_META_FUNC(max_pool2d_with_indices)
(const Tensor& input,
...
bool ceil_mode) {
  ...
  if (memory_format == at::MemoryFormat::ChannelsLast) {
    SMITH_CHECK(input.ndimension() == 4,
    ...
    SMITH_CHECK((input.ndimension() == 3 || input.ndimension() == 4),
...
SMITH_META_FUNC(max_pool2d_with_indices_backward)
...
SMITH_IMPL_FUNC(max_pool2d_with_indices_out_cpu)
(const Tensor& input,
IntArrayRef kernel_size,
IntArrayRef stride,
IntArrayRef padding,
...
SMITH_IMPL_FUNC(max_pool2d_with_indices_backward_out_cpu)
(const Tensor& gradOutput,
const Tensor& input,
IntArrayRef kernel_size,
IntArrayRef stride,
