...
SMITH_API bool is_cached_tensor(const at::Tensor& t);
SMITH_API void add_cached_tensor(const at::Tensor& t);
SMITH_API void remove_cached_tensor(const at::Tensor& t);
SMITH_API void set_cached_tensors_enabled(bool enable);
...
SMITH_API size_t adjusted_use_count(const at::Tensor& t);
