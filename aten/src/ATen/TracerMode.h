...
//
// - `setTracingState()` API in `smith/csrc/jit/frontend/tracer.h`
//
...
//    which are also exposed as `SMITH_API`.
//
...
//     factory methods), e.g.:
//     `internal_new_from_data()` in `smith/csrc/utils/tensor_new.cpp`.
...
// TODO: move this from `at::` to `jit::smith::` after
