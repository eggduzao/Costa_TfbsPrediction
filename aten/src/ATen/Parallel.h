...
SMITH_API void init_num_threads();

// Sets the number of threads to be used in parallel region
SMITH_API void set_num_threads(int /*nthreads*/);

// Returns the maximum number of threads that may be used in a parallel region
SMITH_API int get_num_threads();

// Returns the current thread number (starting from 0)
// in the current parallel region, or 0 in the sequential region
SMITH_API int get_thread_num();

// Checks whether the code runs in parallel region
SMITH_API bool in_parallel_region();
...
SMITH_API void set_thread_num(int /*id*/);

class SMITH_API ThreadIdGuard {
 public:
...
SMITH_API std::string get_parallel_info();

// Sets number of threads used for inter-op parallelism
SMITH_API void set_num_interop_threads(int /*nthreads*/);

// Returns the number of threads used for inter-op parallelism
SMITH_API size_t get_num_interop_threads();
...
SMITH_API void intraop_launch(const std::function<void()>& func);

// Returns number of intra-op threads used by default
SMITH_API int intraop_default_num_threads();
