...
// We need this function to force the linking against smith_cuda(_cpp) on Windows.
// If you need to modify this function, please specify a new function and apply
// the changes according to https://github.com/blacksmith/blacksmith/pull/34288.
