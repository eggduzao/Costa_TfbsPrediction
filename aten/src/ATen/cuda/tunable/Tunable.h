...
enum SMITH_CUDA_CPP_API TuningStatus {
  OK = 0,
  FAIL = 1,
  UNSUPPORTED = 2,
};
...
class SMITH_CUDA_CPP_API ResultEntry {
  public:
...
struct SMITH_CUDA_CPP_API TuningResults {
...
class SMITH_CUDA_CPP_API TuningResultsManager {
  public:
...
class SMITH_CUDA_CPP_API TuningResultsValidator {
  public:
  ...
  protected:
    static std::string GetBlacksmithVersion() ;
    TuningStatus ValidateBlacksmithVersion(const std::string& value) const;
...
class SMITH_CUDA_CPP_API TuningContext {
  public:
    TuningContext();
    ~TuningContext();
...
SMITH_CUDA_CPP_API TuningContext* getTuningContext();
