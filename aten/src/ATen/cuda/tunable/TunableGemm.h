...
class GemmTunableOp : public TunableOp<GemmParams<T>> {
 public:
  GemmTunableOp() {
...
#ifdef USE_ROCM
    static const auto env_rocblas = c10::utils::check_env("BLACKSMITH_TUNABLEOP_ROCBLAS_ENABLED");
    ...
    static const auto env_hipblaslt = c10::utils::check_env("BLACKSMITH_TUNABLEOP_HIPBLASLT_ENABLED");
