...
struct SMITH_CUDA_CPP_API CUDAGeneratorImpl : public c10::GeneratorImpl {
  // Constructors
...
SMITH_CUDA_CPP_API const Generator& getDefaultCUDAGenerator(
    DeviceIndex device_index = -1);
SMITH_CUDA_CPP_API Generator createCUDAGenerator(DeviceIndex device_index = -1);
