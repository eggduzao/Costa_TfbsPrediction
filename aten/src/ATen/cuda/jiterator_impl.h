...
#undef DEFINE_CASE
    ...
    default: SMITH_INTERNAL_ASSERT(false, "Unrecognized ScalarType: ", type);
  }
}
...
static std::unique_ptr<OffsetCalculator<N>> make_unique_offset_calculator(
  ...
  SMITH_INTERNAL_ASSERT(N == (IS_INPUT ? iter.ninputs() : iter.noutputs()));
...
#undef DEFINE_CASE
      default:
        SMITH_CHECK(false, "OffsetCalculatorVariant is not implemented for num_tensor = ", num);
    }
  }
...
#undef DEFINE_CASE
      ...
      default:
        SMITH_CHECK(false, "ArrayVariant is not implemented for ntensors = ", ntensors);
    }
...
#undef DEFINE_CASE
      ...
      default:
        SMITH_CHECK(false, "TrivialOffsetCalculatorVariant is not implemented for num_tensors = ", num);
    }
  }
...
#undef DEFINE_CASE
      ...
      default:
        SMITH_CHECK(false, "LoadWithCastVariant is not implemented for ninputs = ", arity);
    }
  }
...
#undef DEFINE_CASE
      ...
      default:
        SMITH_CHECK(false, "StoreWithCastVariant is not implemented for noutputs = ", num);
    }
  }
