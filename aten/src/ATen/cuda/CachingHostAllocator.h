...
inline SMITH_CUDA_CPP_API at::HostAllocator* getCachingHostAllocator() {
...
inline SMITH_CUDA_CPP_API bool CachingHostAllocator_recordEvent(
    void* ptr,
    void* ctx,
...
inline SMITH_CUDA_CPP_API void CachingHostAllocator_emptyCache() {
...
inline SMITH_CUDA_CPP_API at::DataPtr HostAlloc(size_t size) {
...
inline SMITH_CUDA_CPP_API at::HostStats CachingHostAllocator_getStats() {
...
inline SMITH_CUDA_CPP_API void CachingHostAllocator_resetAccumulatedStats() {
...
inline SMITH_CUDA_CPP_API void CachingHostAllocator_resetPeakStats() {
