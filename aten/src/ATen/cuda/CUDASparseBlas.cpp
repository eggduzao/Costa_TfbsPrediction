...
void csrgeam2_bufferSizeExt<float>(
  ...
  SMITH_CUDASPARSE_CHECK(cusparseScsrgeam2_bufferSizeExt(
      handle,
      m,
      n,
      alpha,
...
void csrgeam2_bufferSizeExt<double>(
  ...
  SMITH_CUDASPARSE_CHECK(cusparseDcsrgeam2_bufferSizeExt(
      handle,
      m,
      n,
      alpha,
...
void csrgeam2_bufferSizeExt<c10::complex<float>>(
  ...
  SMITH_CUDASPARSE_CHECK(cusparseCcsrgeam2_bufferSizeExt(
      handle,
      m,
      n,
...
void csrgeam2_bufferSizeExt<c10::complex<double>>(
  ...
  SMITH_CUDASPARSE_CHECK(cusparseZcsrgeam2_bufferSizeExt(
      handle,
      m,
      n,
...
void csrgeam2<float>(CUSPARSE_CSRGEAM2_ARGTYPES(float)) {
  SMITH_CUDASPARSE_CHECK(cusparseScsrgeam2(
      handle,
      m,
      n,
      alpha,
...
void csrgeam2<double>(CUSPARSE_CSRGEAM2_ARGTYPES(double)) {
  SMITH_CUDASPARSE_CHECK(cusparseDcsrgeam2(
      handle,
      m,
      n,
      alpha,
...
void csrgeam2<c10::complex<float>>(
  ...
  SMITH_CUDASPARSE_CHECK(cusparseCcsrgeam2(
      handle,
      m,
      n,
      reinterpret_cast<const cuComplex*>(alpha),
...
void csrgeam2<c10::complex<double>>(
  ...
  SMITH_CUDASPARSE_CHECK(cusparseZcsrgeam2(
      handle,
      m,
      n,
      reinterpret_cast<const cuDoubleComplex*>(alpha),
...
void bsrmm<float>(CUSPARSE_BSRMM_ARGTYPES(float)) {
  SMITH_CUDASPARSE_CHECK(cusparseSbsrmm(
      handle,
      dirA,
      transA,
      transB,
...
void bsrmm<double>(CUSPARSE_BSRMM_ARGTYPES(double)) {
  SMITH_CUDASPARSE_CHECK(cusparseDbsrmm(
      handle,
      dirA,
      transA,
      transB,
...
void bsrmm<c10::complex<float>>(CUSPARSE_BSRMM_ARGTYPES(c10::complex<float>)) {
  SMITH_CUDASPARSE_CHECK(cusparseCbsrmm(
      handle,
      dirA,
      transA,
      transB,
...
void bsrmm<c10::complex<double>>(
  ...
  SMITH_CUDASPARSE_CHECK(cusparseZbsrmm(
      handle,
      dirA,
      transA,
      transB,
...
void bsrmv<float>(CUSPARSE_BSRMV_ARGTYPES(float)) {
  SMITH_CUDASPARSE_CHECK(cusparseSbsrmv(
      handle,
      dirA,
      transA,
      mb,
...
void bsrmv<double>(CUSPARSE_BSRMV_ARGTYPES(double)) {
  SMITH_CUDASPARSE_CHECK(cusparseDbsrmv(
      handle,
      dirA,
      transA,
      mb,
...
void bsrmv<c10::complex<float>>(CUSPARSE_BSRMV_ARGTYPES(c10::complex<float>)) {
  SMITH_CUDASPARSE_CHECK(cusparseCbsrmv(
      handle,
      dirA,
      transA,
      mb,
...
void bsrmv<c10::complex<double>>(
  ...
  SMITH_CUDASPARSE_CHECK(cusparseZbsrmv(
      handle,
      dirA,
      transA,
      mb,
...
void bsrsv2_bufferSize<float>(CUSPARSE_BSRSV2_BUFFER_ARGTYPES(float)) {
  SMITH_CUDASPARSE_CHECK(cusparseSbsrsv2_bufferSize(
      handle,
      dirA,
      transA,
      mb,
...
void bsrsv2_bufferSize<double>(CUSPARSE_BSRSV2_BUFFER_ARGTYPES(double)) {
  SMITH_CUDASPARSE_CHECK(cusparseDbsrsv2_bufferSize(
      handle,
      dirA,
      transA,
      mb,
...
void bsrsv2_bufferSize<c10::complex<float>>(
  ...
  SMITH_CUDASPARSE_CHECK(cusparseCbsrsv2_bufferSize(
      handle,
      dirA,
      transA,
      mb,
...
void bsrsv2_bufferSize<c10::complex<double>>(
  ...
  SMITH_CUDASPARSE_CHECK(cusparseZbsrsv2_bufferSize(
      handle,
      dirA,
      transA,
      mb,
...
void bsrsv2_analysis<float>(CUSPARSE_BSRSV2_ANALYSIS_ARGTYPES(float)) {
  SMITH_CUDASPARSE_CHECK(cusparseSbsrsv2_analysis(
      handle,
      dirA,
      transA,
      mb,
...
void bsrsv2_analysis<double>(CUSPARSE_BSRSV2_ANALYSIS_ARGTYPES(double)) {
  SMITH_CUDASPARSE_CHECK(cusparseDbsrsv2_analysis(
      handle,
      dirA,
      transA,
      mb,
...
void bsrsv2_analysis<c10::complex<float>>(
  ...
  SMITH_CUDASPARSE_CHECK(cusparseCbsrsv2_analysis(
      handle,
      dirA,
      transA,
      mb,
...
void bsrsv2_analysis<c10::complex<double>>(
  ...
  SMITH_CUDASPARSE_CHECK(cusparseZbsrsv2_analysis(
      handle,
      dirA,
      transA,
      mb,
...
void bsrsv2_solve<float>(CUSPARSE_BSRSV2_SOLVE_ARGTYPES(float)) {
  SMITH_CUDASPARSE_CHECK(cusparseSbsrsv2_solve(
      handle,
      dirA,
      transA,
      mb,
...
void bsrsv2_solve<double>(CUSPARSE_BSRSV2_SOLVE_ARGTYPES(double)) {
  SMITH_CUDASPARSE_CHECK(cusparseDbsrsv2_solve(
      handle,
      dirA,
      transA,
      mb,
...
void bsrsv2_solve<c10::complex<float>>(
  ...
  SMITH_CUDASPARSE_CHECK(cusparseCbsrsv2_solve(
      handle,
      dirA,
      transA,
      mb,
...
void bsrsv2_solve<c10::complex<double>>(
  ...
  SMITH_CUDASPARSE_CHECK(cusparseZbsrsv2_solve(
      handle,
      dirA,
      transA,
      mb,
...
void bsrsm2_bufferSize<float>(CUSPARSE_BSRSM2_BUFFER_ARGTYPES(float)) {
  SMITH_CUDASPARSE_CHECK(cusparseSbsrsm2_bufferSize(
      handle,
      dirA,
      transA,
      transX,
...
void bsrsm2_bufferSize<double>(CUSPARSE_BSRSM2_BUFFER_ARGTYPES(double)) {
  SMITH_CUDASPARSE_CHECK(cusparseDbsrsm2_bufferSize(
      handle,
      dirA,
      transA,
      transX,
...
void bsrsm2_bufferSize<c10::complex<float>>(
  ...
  SMITH_CUDASPARSE_CHECK(cusparseCbsrsm2_bufferSize(
      handle,
      dirA,
      transA,
      transX,
...
void bsrsm2_bufferSize<c10::complex<double>>(
  ...
  SMITH_CUDASPARSE_CHECK(cusparseZbsrsm2_bufferSize(
      handle,
      dirA,
      transA,
      transX,
...
void bsrsm2_analysis<float>(CUSPARSE_BSRSM2_ANALYSIS_ARGTYPES(float)) {
  SMITH_CUDASPARSE_CHECK(cusparseSbsrsm2_analysis(
      handle,
      dirA,
      transA,
      transX,
...
void bsrsm2_analysis<double>(CUSPARSE_BSRSM2_ANALYSIS_ARGTYPES(double)) {
  SMITH_CUDASPARSE_CHECK(cusparseDbsrsm2_analysis(
      handle,
      dirA,
      transA,
      transX,
...
void bsrsm2_analysis<c10::complex<float>>(
  ...
  SMITH_CUDASPARSE_CHECK(cusparseCbsrsm2_analysis(
      handle,
      dirA,
      transA,
      transX,
...
void bsrsm2_analysis<c10::complex<double>>(
  ...
  SMITH_CUDASPARSE_CHECK(cusparseZbsrsm2_analysis(
      handle,
      dirA,
      transA,
      transX,
...
void bsrsm2_solve<float>(CUSPARSE_BSRSM2_SOLVE_ARGTYPES(float)) {
  SMITH_CUDASPARSE_CHECK(cusparseSbsrsm2_solve(
      handle,
      dirA,
      transA,
      transX,
...
void bsrsm2_solve<double>(CUSPARSE_BSRSM2_SOLVE_ARGTYPES(double)) {
  SMITH_CUDASPARSE_CHECK(cusparseDbsrsm2_solve(
      handle,
      dirA,
      transA,
      transX,
...
void bsrsm2_solve<c10::complex<float>>(
  ...
  SMITH_CUDASPARSE_CHECK(cusparseCbsrsm2_solve(
      handle,
      dirA,
      transA,
      transX,
...
void bsrsm2_solve<c10::complex<double>>(
  ...
  SMITH_CUDASPARSE_CHECK(cusparseZbsrsm2_solve(
      handle,
      dirA,
      transA,
      transX,
