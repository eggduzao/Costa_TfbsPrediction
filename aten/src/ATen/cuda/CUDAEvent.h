...
/*
* `cudaEventExternal` is a smith-specific flag that is used to
...
*/
struct SMITH_CUDA_CPP_API CUDAEvent {
  // Constructors
  ...
  void record(const CUDAStream& stream) {
    ...
    SMITH_CHECK(device_index_ == stream.device_index(), "Event device ", device_index_,
...
#ifdef USE_ROCM
    SMITH_CHECK(!external_, "External events are disallowed in rocm");
#endif
