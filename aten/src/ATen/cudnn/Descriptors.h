...
class SMITH_CUDA_CPP_API Descriptor {
 public:
...
class SMITH_CUDA_CPP_API RNNDataDescriptor : public Descriptor<
                                       cudnnRNNDataStruct,
...
class SMITH_CUDA_CPP_API TensorDescriptor : public Descriptor<
                                               cudnnTensorStruct,
...
class SMITH_CUDA_CPP_API FilterDescriptor : public Descriptor<
                                               cudnnFilterStruct,
...
struct SMITH_CUDA_CPP_API ConvolutionDescriptor
    : public Descriptor<
...
struct SMITH_CUDA_CPP_API SpatialTransformerDescriptor
    : public Descriptor<
...
// NOLINTNEXTLINE(bugprone-exception-escape)
struct SMITH_CUDA_CPP_API DropoutDescriptor
    : public Descriptor<
          cudnnDropoutStruct,
  ...
  void initialize_rng(cudnnHandle_t handle, float dropout, long long int seed, const TensorOptions& options) {
    SMITH_INTERNAL_ASSERT(dropout > 0, "dropout must be nonzero; otherwise call set_no_dropout");
    size_t state_size = 0;
...
struct SMITH_CUDA_CPP_API RNNDescriptor : public Descriptor<
                                             cudnnRNNStruct,
...
struct SMITH_CUDA_CPP_API CTCLossDescriptor
    : public Descriptor<
          cudnnCTCLossStruct,
...
struct SMITH_CUDA_CPP_API ActivationDescriptor
    : public Descriptor<
