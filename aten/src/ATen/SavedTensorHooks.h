...
struct SMITH_API SavedTensorDefaultHooksTLS {
...
struct SMITH_API SavedTensorDefaultHooks {
  ...
  // A developer of a Blacksmith feature may choose to disable SavedTensorDefault
