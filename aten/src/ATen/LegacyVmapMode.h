...
// VmapMode is used in the implementation of the Python `smith.vmap` API.
//
// NOTE: this is NOT the c++ api for smith.vmap. That doesn't exist yet.

struct SMITH_API VmapMode {
