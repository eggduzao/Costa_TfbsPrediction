...
struct SMITH_API ClassAttribute {
  public:
...
using ::smith::jit::CompilationUnit;

// This represents a class in SmithScript.
struct SMITH_API ClassType : public NamedType {
  ...
  const std::vector<smith::jit::Function*>& methods() const;
  ...
  void addProperty(const std::string& name, smith::jit::Function* getter, smith::jit::Function* setter);
  ...
  void addForwardPreHook(smith::jit::Function* pre_hook_ptr);
  void addForwardHook(smith::jit::Function* hook_ptr);
  smith::jit::Function* findForwardPreHook(const std::string& name) const;
  smith::jit::Function* findForwardHook(const std::string& name) const;
  const std::vector<smith::jit::Function*>& getForwardHooks() const;
  const std::vector<smith::jit::Function*>& getForwardPreHooks() const;
  ...
  void addMethod(smith::jit::Function* method);
  smith::jit::Function* findMethod(const std::string& name) const;
  smith::jit::Function& getMethod(const std::string& name) const;
  smith::jit::Function* findHook(const std::string& name) const;
  smith::jit::Function& getHook(const std::string& name) const;
  bool hasMethod(const std::string& name) const;

  smith::jit::Function* findStaticMethod(const std::string& name) const;
  void addStaticMethod(smith::jit::Function* method);
 ...
 private:
  ...
  std::vector<smith::jit::Function*> methods_;
  std::vector<smith::jit::Function*> staticmethods_;

  // List of hooks to be run before/after forward.
  std::vector<smith::jit::Function*> forward_hooks_;
  std::vector<smith::jit::Function*> forward_pre_hooks_;
