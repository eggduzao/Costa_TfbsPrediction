...
struct AnnotatedKernel final {
  ...
  // Most importantly it records the SMITH_LIBRARY block that did the
  // registration.
  std::string debug;
};
...
// dispatcher state)
class SMITH_API OperatorEntry final {
 public:
 ...
 private:
  ...
  // Pointer to the smith.ops.ns.op.overload object for speed
