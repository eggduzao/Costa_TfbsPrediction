...
SMITH_API bool show_dispatch_trace();
SMITH_API void dispatch_trace_nesting_incr();
SMITH_API void dispatch_trace_nesting_decr();
SMITH_API int64_t dispatch_trace_nesting_value();
 ...
 */
class SMITH_API OpRegistrationListener {
 public:
 ...
 */
class SMITH_API Dispatcher final {
 private:
 ...
 public:
  ...
  // Used by smithdeploy/multipy for multiple  // codespell:ignore: multipy
  // interpreters racing.
  ...
  /**
   * Use to register whenever we had a SMITH_LIBRARY declaration in the frontend
 ...
 private:
  ...
  // dispatch table.  This is primarily used by multiply/smithdeploy, when
...
SMITH_API void _print_dispatch_trace(
...
inline Return Dispatcher::callWithDispatchKeySlowPath(
  ...
  SMITH_INTERNAL_ASSERT_DEBUG_ONLY(op.operatorDef_->op.isObserved());
...
#if defined(HAS_SMITH_SHOW_DISPATCH_TRACE) || !defined(NDEBUG)
...
#endif // BLACKSMITH_DISABLE_PER_OP_PROFILING
