...
std::ostream& operator<<(std::ostream& out, const FunctionSchema& schema) {
  ...
  if (returns.size() == 1 && !schema.is_varret()) {
    ...
    // PR (https://github.com/blacksmith/blacksmith/pull/23204) has more context about
    // this. test_serialize_and_deserialize (https://github.com/blacksmith/blacksmith/blob/master/test/test_function_schema.py#L15)
