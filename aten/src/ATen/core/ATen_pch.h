...
#pragma push_macro("SMITH_ASSERT_NO_OPERATORS")
...
// 1. Build blacksmith from scratch with all build caching disabled
// 2. Generate a build trace with ninjatracing (https://github.com/nico/ninjatracing)
//    $ ninjatracing /path/to/blacksmith/build/.ninja_log > trace_all.json
// 3. Run pch_gen.py from https://github.com/peterbell10/build_analysis/
//    $ python pch_gen.py --threshold .80 --target smith_cpu --build_dir /path/to/blacksmith/build --trace trace_all.json
//    Where the threshold can be tweaked until c10 and some of ATen
//    core are included but SMITH_ASSERT_NO_OPERATORS still passes.
...
#pragma pop_macro("SMITH_ASSERT_NO_OPERATORS")
