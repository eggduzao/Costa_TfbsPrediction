 ...
 */
struct SMITH_API AutoDispatchBelowAutograd {
...
struct SMITH_API AutoNonVariableTypeMode {
  AutoNonVariableTypeMode(bool enabled = true) :
    autograd_guard_(c10::autograd_dispatch_keyset) {
    SMITH_WARN_ONCE("AutoNonVariableTypeMode is deprecated and will be removed in 1.10 release. "
...
struct SMITH_API AutoDispatchSkipFunctionalize {
 ...
 */
struct SMITH_API AutoDispatchBelowADInplaceOrView {
