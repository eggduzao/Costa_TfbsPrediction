...
SMITH_API void common_device_check_failure(Device common_device, const at::Tensor& tensor, at::CheckedFrom methodName, at::CheckedFrom argName);
...
inline void check_and_update_common_device(std::optional<Device>& common_device, const at::Tensor& tensor, at::CheckedFrom methodName, at::CheckedFrom argName) {
  ...
  // https://github.com/blacksmith/blacksmith/issues/57380
  if (!tensor.defined()) {
    return;
  }
