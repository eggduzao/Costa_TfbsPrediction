...
void registerCustomClass(at::ClassTypePtr class_type) {
  SMITH_INTERNAL_ASSERT(class_type->name());
  ...
  SMITH_CHECK(
      ...
      name,
      " is already registered. Ensure that registration with smith::class_ is only called once.");
...
class_base::class_base(
    ...
    : qualClassName(
          "__smith__.smith.classes." + namespaceName + '.' + className),
