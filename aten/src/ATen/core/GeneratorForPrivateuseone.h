...
SMITH_API std::optional<GeneratorFuncType>& GetGeneratorPrivate();

class SMITH_API _GeneratorRegister {
 public:
  explicit _GeneratorRegister(const GeneratorFuncType& func);
};

SMITH_API at::Generator GetGeneratorForPrivateuse1(
    c10::DeviceIndex device_index);

/**
 * This is used to register Generator to Blacksmith for `privateuse1` key.
 *
