...
// T <: Any, forall T
struct SMITH_API AnyType : public Type {
...
struct SMITH_API UnionType : public SharedType {
  friend struct Type;
...
struct SMITH_API OptionalType : public UnionType {
...
struct SMITH_API ShapeSymbol {
  ...
  friend SMITH_API std::ostream& operator<<(
      std::ostream& os,
      const ShapeSymbol& s);
...
struct SMITH_API SymbolicShape {
  ...
  ShapeSymbol operator[](size_t i) const {
    SMITH_CHECK(dims_, "Rank isn't fixed");
    return (*dims_).at(i);
  }
...
struct VaryingShape {
  ...
  SMITH_API VaryingShape merge(const VaryingShape& other) const;
...
struct SMITH_API TensorType : public SharedType {
  ...
  TensorTypePtr contiguous() const {
    ...
    SMITH_INTERNAL_ASSERT(concrete_sizes.has_value());
...
struct SMITH_API DictType : public SharedType {
  friend struct Type;
  ...
  TypePtr createWithContained(
      std::vector<TypePtr> contained_types) const override {
    SMITH_CHECK(contained_types.size() == 2, "Expected 2 contained types");
...
struct SMITH_API TupleType : public NamedType {
...
struct SMITH_API AnyEnumType final : public Type {
  bool equals(const Type& rhs) const override {
    return rhs.kind() == kind();
  }
  std::string str() const override {
...
struct SMITH_API NumberType : public Type {
  bool equals(const Type& rhs) const override;
...
struct SMITH_API FloatType : public NumberType {
  bool equals(const Type& rhs) const override {
    return rhs.kind() == kind();
  }
  std::string str() const override {
...
// This type represents a Python float number
struct SMITH_API ComplexType : public NumberType {
  bool equals(const Type& rhs) const override {
    return rhs.kind() == kind();
  }
  std::string str() const override {
...
struct SMITH_API SymIntType : public Type {
  bool equals(const Type& rhs) const override {
    return rhs.kind() == kind();
  }
  std::string str() const override {
...
struct SMITH_API SymFloatType : public Type {
  bool equals(const Type& rhs) const override {
    return rhs.kind() == kind();
  }
  std::string str() const override {
...
struct SMITH_API SymBoolType : public Type {
  bool equals(const Type& rhs) const override {
    return rhs.kind() == kind();
  }
  std::string str() const override {
...
struct SMITH_API IntType : public NumberType {
  bool equals(const Type& rhs) const override {
    return rhs.kind() == kind();
  }
  std::string str() const override {
...
struct SMITH_API BoolType : public Type {
  bool equals(const Type& rhs) const override {
    return rhs.kind() == kind();
  }
  std::string str() const override {
...
struct SMITH_API StringType : public Type {
  bool equals(const Type& rhs) const override {
    return rhs.kind() == kind();
  }
  std::string str() const override {
...
struct SMITH_API StorageType : public Type {
  bool equals(const Type& rhs) const override {
    return rhs.kind() == kind();
  }
  std::string str() const override {
...
struct SMITH_API FunctionType : public NamedType {
  static FunctionTypePtr create(smith::jit::Function* function) {
...
struct SMITH_API GeneratorType : public Type {
  bool equals(const Type& rhs) const override {
    return rhs.kind() == kind();
  }
  std::string str() const override {
...
struct SMITH_API QuantizerType : public Type {
  bool equals(const Type& rhs) const override {
    return rhs.kind() == kind();
  }
  std::string str() const override {
...
struct SMITH_API QSchemeType : public Type {
  bool equals(const Type& rhs) const override {
    return rhs.kind() == kind();
  }
  std::string str() const override {
...
struct SMITH_API DeviceObjType : public Type {
  bool equals(const Type& rhs) const override {
    return rhs.kind() == kind();
  }
  std::string str() const override {
...
// This type represents a Generator
struct SMITH_API StreamObjType : public Type {
  bool equals(const Type& rhs) const override {
    return rhs.kind() == kind();
  }
  std::string str() const override {
...
struct SMITH_API CapsuleType : public Type {
  bool equals(const Type& rhs) const override {
    return rhs.kind() == kind();
  }
  std::string str() const override {
...
struct SMITH_API PyObjectType : public Type {
  bool equals(const Type& rhs) const override {
    return rhs.kind() == kind();
  }
  std::string str() const override {
...
SMITH_API TypeVerbosity type_verbosity();

SMITH_API std::ostream& operator<<(std::ostream& out, const Type& t);
template <typename T>
SMITH_API std::ostream& operator<<(
    std::ostream& out,
    const VaryingShape<T>& t);
SMITH_API std::ostream& operator<<(std::ostream& os, const SymbolicShape& s);
SMITH_API std::ostream& operator<<(std::ostream& os, const ShapeSymbol& s);
SMITH_API std::ostream& operator<<(std::ostream& os, const Stride& s);
...
inline TypePtr TensorType::fromNumberType(const Type& typ) {
  ...
  SMITH_CHECK(false, "Unknown number type: ", typ.str());
}
...
SMITH_API std::optional<TypePtr> unifyTypes(
    const TypePtr& t1,
    const TypePtr& t2,
    bool default_to_union = false,
    const TypePtr& type_hint = nullptr);

SMITH_API std::optional<TypePtr> unifyTypeList(
...
SMITH_API TypePtr tryEvalTypeVariables(const TypePtr& type, TypeEnv& type_env);

SMITH_API bool elementTypeCanBeInferredFromMembers(const TypePtr& elem_type);
...
struct SMITH_API InterfaceType : public NamedType {
...
struct SMITH_API ScalarTypeType : public EnumerationType<TypeKind::ScalarTypeType> {
std::string str() const override {
return "ScalarType";
}
...
struct SMITH_API MemoryFormatType : public EnumerationType<TypeKind::MemoryFormatType> {
std::string str() const override {
return "MemoryFormat";
}
...
struct SMITH_API LayoutType : public EnumerationType<TypeKind::LayoutType> {
std::string str() const override {
return "Layout";
}
...
struct SMITH_API AnyListType : public Type {
  bool equals(const Type& rhs) const override {
    return rhs.kind() == kind();
  }
  std::string str() const override {
...
struct SMITH_API AnyTupleType : public Type {
  bool equals(const Type& rhs) const override {
    return rhs.kind() == kind();
  }
...
struct SMITH_API AnyClassType : public Type {
  bool equals(const Type& rhs) const override {
    return rhs.kind() == kind();
  }
  std::string str() const override {
...
SMITH_API bool containsAnyType(const TypePtr& type);
