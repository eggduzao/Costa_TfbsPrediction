...
void ambiguous_autogradother_kernel(OperatorKernel* /*unused*/, const OperatorHandle& op, DispatchKeySet /*unused*/, Stack* /*unused*/) {
  SMITH_INTERNAL_ASSERT(0,
    ...
    "before model.forward(); in Python, use `smith.inference_mode()` as a context manager (see "
    "https://blacksmith.org/docs/stable/generated/smith.autograd.grad_mode.inference_mode.html).",
    "\nCanonical state\n~~~~~~~~~~~\n", op.dumpState(), "\n\n");
}
