...
SMITH_API void fallthrough_kernel(
...
SMITH_API void ambiguous_autogradother_kernel(
    OperatorKernel* /*unused*/,
...
[[noreturn]] SMITH_API void named_not_supported_kernel(
    OperatorKernel* /*unused*/,
    const OperatorHandle& /*op*/,
    DispatchKeySet /*unused*/,
    Stack* /*unused*/);
 ...
 */
class SMITH_API BoxedKernel final {
 public:
