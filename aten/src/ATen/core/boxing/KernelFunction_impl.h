...
inline KernelFunction KernelFunction::makeFromUnboxedFunction(
  ...
  static_assert(
      ...
      "Tried to call KernelFunction::makeFromUnboxedFunction with an invalid parameter. It must be a function pointer created with SMITH_FN.");
  static_assert(
...
inline KernelFunction KernelFunction::makeFromUnboxedRuntimeFunction(
  ...
  SMITH_INTERNAL_ASSERT(func != nullptr, "Kernel function cannot be nullptr");
