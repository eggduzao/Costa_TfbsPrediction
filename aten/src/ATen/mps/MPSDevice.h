...
SMITH_API bool is_available();
SMITH_API bool is_macos_13_or_newer(MacOSVersion version);
SMITH_API at::Allocator* GetMPSAllocator(bool useSharedAllocator = false);
