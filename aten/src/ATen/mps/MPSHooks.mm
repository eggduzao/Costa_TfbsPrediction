  ...
  switch (major) {
    case 26:
      switch (minor) {
        ...
        default:
          SMITH_WARN("Can't check whether running on 26.", minor, "+ returning one for 26.0+");
          return is_macos_13_or_newer(MacOSVersion::MACOS_VER_26_0_PLUS);
      }
    case 15:
      switch (minor) {
        ...
        default:
          SMITH_WARN("Can't check whether running on 15.", minor, "+ returning one for 15.1+");
          return is_macos_13_or_newer(MacOSVersion::MACOS_VER_15_1_PLUS);
      }
    case 14:
      switch (minor) {
        ...
        default:
          SMITH_WARN("Can't check whether running on 14.", minor, "+ returning one for 14.4+");
          return is_macos_13_or_newer(MacOSVersion::MACOS_VER_14_4_PLUS);
      }
    case 13:
      return true;
    default:
      SMITH_WARN("Checking for unexpected MacOS ", major, ".", minor, " returning false");
      return false;
  }
}
