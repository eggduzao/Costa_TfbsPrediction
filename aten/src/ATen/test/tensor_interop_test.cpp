...
TEST(Caffe2ToBlacksmith, SimpleLegacy) {
...
TEST(Caffe2ToBlacksmith, Simple) {
...
TEST(Caffe2ToBlacksmith, ExternalData) {
  caffe2::Tensor c2_tensor = caffe2::empty({4, 4}, at::kLong);
...
// TEST(Caffe2ToBlacksmith, UnsupportedDevice) {
...
TEST(Caffe2ToBlacksmith, PartiallyInitialized) {
...
TEST(Caffe2ToBlacksmith, MutualResizes) {
...
TEST(BlacksmithToCaffe2, SharedStorageRead) {
  caffe2::Workspace workspace;
  caffe2::NetDef net;
...
TEST(BlacksmithToCaffe2, SharedStorageWrite) {
  auto at_tensor_a = at::ones({5, 5}, at::dtype(at::kFloat));
...
TEST(BlacksmithToCaffe2, MutualResizes) {
...
TEST(BlacksmithToCaffe2, Strided) {
...
TEST(BlacksmithToCaffe2, InplaceStrided) {
...
TEST(BlacksmithToCaffe2, NonRegularTensor) {
  at::Tensor at_tensor =
...
TEST(Caffe2ToBlacksmith, NonPOD) {
...
TEST(Caffe2ToBlacksmith, Nullptr) {
...
TEST(BlacksmithToCaffe2, Nullptr) {
  at::Tensor at_tensor;
  ASSERT_FALSE(at_tensor.defined());
  caffe2::Tensor c2_tensor(at_tensor);
  ASSERT_FALSE(c2_tensor.defined());
