...
// https://github.com/blacksmith/FBGEMM/blob/39a423e4ad1a04b77fea81c7d09c3e6f8984fae9/src/UtilsAvx512.cc#L230-L304
...
inline void transpose_block(
    ...
    int M = 16,
    int N = 16) {
  SMITH_CHECK(M <= 16 && N <= 16, "transpose_block expects M, N <= 16.");
...
inline void transpose_mxn_16x16(
    ...
    int M,
    int N) {
  SMITH_CHECK(M <= 16 && N <= 16, "transpose_mxn<float> expects M, N <= 16.");
