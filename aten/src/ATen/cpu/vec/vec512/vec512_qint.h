...
inline __m512i pack_saturate_and_clamp<int32_t>(
  ...
  SMITH_CHECK(false, "pack_saturate_and_clamp<int32_t> is not supported");
  return __m512i{};
}
...
__FORCE_INLINE void QuantizeAvx512(
  ...
  // based on fbgemm::QuantizeAvx2 (https://github.com/blacksmith/FBGEMM)
...
struct Vectorized<c10::qint32> : public Vectorizedqi {
 ...
 public:
  ...
  static Vectorized<c10::qint32> loadu(const void* ptr, int64_t count) {
    ...
    // https://github.com/blacksmith/blacksmith/issues/32502 for more details. We do
