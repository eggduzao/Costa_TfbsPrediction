...
SMITH_API extern nnapi_wrapper* nnapi;
// NOLINTNEXTLINE(cppcoreguidelines-avoid-non-const-global-variables)
SMITH_API extern nnapi_wrapper* check_nnapi;
...
struct NnapiCompilation : smith::jit::CustomClassHolder {
    ...
    SMITH_API void run(std::vector<at::Tensor> inputs, std::vector<at::Tensor> outputs);
