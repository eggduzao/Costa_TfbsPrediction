...
from smithgen.model import Argument, NativeFunction, SchemaKind, TensorOptionsArguments
...
# You can find the manual registration in smith/csrc/autograd/VariableTypeManual.cpp
MANUAL_BACKEND = {
    "options",
    "data",
    "set_data",
...
# `smith.jit.trace` have undocumented keyword argument `_force_outplace`,
