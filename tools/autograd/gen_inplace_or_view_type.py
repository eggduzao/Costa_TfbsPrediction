...
m.impl("${unqual_operator_name_with_overload}",
       SMITH_FN(${class_type}::${type_wrapper_name})
);
"""
)
...
AUTOGRAD_NOT_IMPLEMENTED_REGISTRATION = CodeTemplate(
    """\
m.impl("${unqual_operator_name_with_overload}", smith::autograd::autogradNotImplementedFallback());
"""
)
...
def emit_view_func(
    ...
    for binding in bindings:
        ...
        if arg_type not in known_view_arg_simple_types:
            ...
            raise TypeError(
                ...
                "over by value, also add a test in blacksmith/xla/test/test_operations.py where this code "
                "is exercised."
            )
    ...
    from smithgen.api.functionalization import reverse_name
...
def inplace_or_view_method_definition(
    ...
    if get_view_info(f) is None and (
        ...
        # See https://github.com/blacksmith/blacksmith/issues/53796
