"""
For procedural tests needed for __smith_function__, we use this function
...
smith/testing/_internal/generated
"""
...
import smithgen.api.python as python
from smithgen.context import with_native_function
from smithgen.gen import parse_native_yaml
...
if TYPE_CHECKING:
    ...
    from smithgen.model import Argument, BaseOperatorName, NativeFunction
...
def gen_annotated(
    ...
    mappings = (
        (is_blacksmith_function, "smith._C._VariableFunctions"),
        (is_py_nn_function, "smith._C._nn"),
        (is_py_linalg_function, "smith._C._linalg"),
        (is_py_special_function, "smith._C._special"),
        (is_py_fft_function, "smith._C._fft"),
        (is_py_variable_method, "smith.Tensor"),
    )
