...
#ifdef USE_CUDA
#include "smith/csrc/cuda/Event.h"
#endif
...
#include "smith/csrc/utils/tensor_apply.h"
#include "smith/csrc/utils/tensor_list.h"
...
static PyObject * THPVariable__is_view(PyObject *self, PyObject* args)
{
  ...
  if (check_has_smith_function(self)) {
    return handle_smith_function(self, "_is_view", args);
  }
...
static PyObject * THPVariable_apply_(PyObject* self, PyObject* arg)
{
  ...
  if (check_has_smith_function(self)) {
    ...
    return handle_smith_function(self, "apply_", args.ptr());
  }
  auto& self_ = THPVariable_Unpack(self);
  ...
  return THPVariable_Wrap(smith::utils::apply_(self_, arg));
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_size(PyObject* self, PyObject* args, PyObject* kwargs)
{
  ...
  if(r.has_smith_function()){
    return handle_smith_function(r, self, args, kwargs, THPVariableClass, "smith.Tensor");
  }
  if (r.idx == 0) {
    ...
    if (jit::tracer::isTracing()) {
      ...
      return smith::toPyObject(self_.sym_size(r.toInt64(0)));
    }
  } else if (r.idx == 1) {
    if (jit::tracer::isTracing()) {
      SMITH_INTERNAL_ASSERT(false, "NYI: Named tensors w/ JIT");
    }
...
static PyObject * THPVariable_stride(PyObject* self, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    if (r.toInt64Optional(0).has_value()) {
      return smith::toPyObject(self_.sym_stride(r.toInt64(0)));
    }
...
{
  HANDLE_TH_ERRORS
  if (check_has_smith_function(self_)) {
    return handle_smith_function(self_, "get_device", args, nullptr);
  }
...
static PyObject * THPVariable_has_names(PyObject* self_, PyObject* args)
{
  HANDLE_TH_ERRORS
  if (check_has_smith_function(self_)) {
    return handle_smith_function(self_, "has_names", args);
  }
  auto& self = THPVariable_Unpack(self_);
...
static PyObject * THPVariable_data_ptr(PyObject* self_, PyObject* args)
{
  HANDLE_TH_ERRORS
  if (check_has_smith_function(self_)) {
    return handle_smith_function(self_, "data_ptr", args);
  }
  auto& self = THPVariable_Unpack(self_);
...
static PyObject * THPVariable_storage_offset(PyObject* self_, PyObject* args)
{
  HANDLE_TH_ERRORS
  if (check_has_smith_function(self_)) {
    return handle_smith_function(self_, "storage_offset");
  }
  auto& self = THPVariable_Unpack(self_);
...
static PyObject * THPVariable_dim(PyObject* self, PyObject* args)
{
   HANDLE_TH_ERRORS
   if (check_has_smith_function(self)) {
     return handle_smith_function(self, "dim", args);
   }
   auto& self_ = THPVariable_Unpack(self);
...
static PyObject * THPVariable_numel(PyObject* self, PyObject* args)
{
   HANDLE_TH_ERRORS
   if (check_has_smith_function(self)) {
     return handle_smith_function(self, "numel", args);
   }
   auto& self_ = THPVariable_Unpack(self);
   if (jit::tracer::isTracing()) {
...
static void maybe_warn_requires_grad(const Tensor & self) {
  if (at::GradMode::is_enabled() && self.requires_grad()) {
    SMITH_WARN_ONCE("Converting a tensor with requires_grad=True to a scalar may lead to unexpected behavior.\n"
...
static T dispatch_to(const Tensor & self) {
  pybind11::gil_scoped_release no_gil;
  OptionalDeviceGuard device_guard(device_of(self));
  SMITH_CHECK_VALUE(self.sym_numel() == 1, "only one element tensors can be converted to Python scalars");
...
static PyObject * THPVariable_float_scalar(PyObject* self, PyObject* args) {
  HANDLE_TH_ERRORS
  if (check_has_smith_function(self)) {
    return handle_smith_function(self, "__float__", args);
  }
...
static PyObject * THPVariable_complex_scalar(PyObject* self, PyObject* args) {
  HANDLE_TH_ERRORS
  if (check_has_smith_function(self)) {
    return handle_smith_function(self, "__complex__", args);
  }
...
static PyObject * THPVariable_integral_scalar(PyObject* self, PyObject* args) {
  HANDLE_TH_ERRORS
  if (check_has_smith_function(self)) {
    return handle_smith_function(self, "__int__", args);
  }
...
static PyObject * THPVariable_index_scalar(PyObject* self, PyObject* args) {
  HANDLE_TH_ERRORS
  if (check_has_smith_function(self)) {
    return handle_smith_function(self, "__index__", args);
  }
  auto& self_ = THPVariable_Unpack(self);
...
static PyObject * THPVariable_invert(PyObject* self, PyObject* args) {
  HANDLE_TH_ERRORS
  if (check_has_smith_function(self)) {
    return handle_smith_function(self, "__invert__", args);
  }
  auto& self_ = THPVariable_Unpack(self);
...
static PyObject * THPVariable_cuda(PyObject* self, PyObject* args, PyObject* kwargs)
{
  ...
  SMITH_CHECK(device.is_cuda(), "Invalid device, must be cuda device");
...
static PyObject * THPVariable_mtia(PyObject* self, PyObject* args, PyObject* kwargs)
{
  ...
  auto opt_memory_format = r.memoryformatOptional(2);
  SMITH_CHECK(device.is_mtia(), "Invalid device, must be MTIA device");
  smith::utils::device_lazy_init(at::kMTIA);
  return THPVariable_Wrap(dispatch_to(self_, device, r.toBool(1), false, opt_memory_format));
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_xpu(PyObject* self, PyObject* args, PyObject* kwargs)
{
  ...
  auto opt_memory_format = r.memoryformatOptional(2);
  SMITH_CHECK(device.is_xpu(), "Invalid device, must be xpu device");
...
static PyObject * THPVariable_ipu(PyObject* self, PyObject* args, PyObject* kwargs)
{
  ...
  auto opt_memory_format = r.memoryformatOptional(2);
  SMITH_CHECK(device.is_ipu(), "Invalid device, must be ipu device");
  return THPVariable_Wrap(dispatch_to(self_, device, r.toBool(1), false, opt_memory_format));
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_element_size(PyObject* self, PyObject* args)
{
  HANDLE_TH_ERRORS
  if (check_has_smith_function(self)) {
    return handle_smith_function(self, "element_size", args);
  }
  auto& self_ = THPVariable_Unpack(self);
...
static PyObject * THPVariable_numpy(PyObject* self, PyObject* args, PyObject* kwargs)
{
  ...
  return smith::utils::tensor_to_numpy(self_, r.toBool(0));
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_requires_grad_(PyObject* self, PyObject* args, PyObject* kwargs)
{
  ...
  // temporary hack to improve funcsmith UX.
  const auto& funcsmith_tls = at::funcsmith::funcsmithTLSAccessor();
  if (funcsmith_tls) {
    funcsmith_tls->checkSupportsInplaceRequiresGrad();
  }
...
static PyObject * THPVariable_is_contiguous(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if(r.has_smith_function()){
    return handle_smith_function(r, self_, args, kwargs, PyObject_Type(self_), "smith.Tensor");
  }
...
static PyObject * THPVariable_item(PyObject* self, PyObject* args)
{
  HANDLE_TH_ERRORS
  if (check_has_smith_function(self)) {
    return handle_smith_function(self, "item", args);
  }
...
static PyObject * THPVariable_map_(PyObject* self, PyObject* args, PyObject* kwargs)
{
  ...
  return THPVariable_Wrap(smith::utils::map_(self_, other, r.pyobject(1)));
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_map2_(PyObject* self, PyObject* args, PyObject* kwargs)
{
  ...
  return THPVariable_Wrap(smith::utils::map2_(self_, x, y, r.pyobject(2)));
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_new(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  if (check_has_smith_function(self)) {
    return handle_smith_function(self, "new", args, kwargs);
  }
  auto& self_ = THPVariable_Unpack(self);
  OptionalDeviceGuard device_guard(device_of(self_));
  return THPVariable_Wrap(smith::utils::legacy_tensor_new(legacyExtractDispatchKey(self_), self_.scalar_type(), args, kwargs));
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_new_tensor(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  if (check_has_smith_function(self)) {
    return handle_smith_function(self, "new_tensor", args, kwargs);
  }
  auto& self_ = THPVariable_Unpack(self);
  OptionalDeviceGuard device_guard(device_of(self_));
  return THPVariable_Wrap(smith::utils::new_tensor(legacyExtractDispatchKey(self_), self_.scalar_type(), args, kwargs));
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_storage(PyObject* self, PyObject* arg)
{
  HANDLE_TH_ERRORS
  if (check_has_smith_function(self)) {
    return handle_smith_function(self, "untyped_storage");
  }
  auto& self_ = THPVariable_Unpack(self);
...
static PyObject * THPVariable_to(PyObject* self, PyObject* args, PyObject* kwargs)
{
  ...
  auto& self_ = THPVariable_Unpack(self);
  smith::utils::maybe_initialize_device(device);
...
static PyObject * THPVariable_tolist(PyObject* self, PyObject* args)
{
  HANDLE_TH_ERRORS
  if (check_has_smith_function(self)) {
    return handle_smith_function(self, "tolist", args);
  }
  jit::tracer::warn("Converting a tensor to a Python list", jit::tracer::WARN_PYTHON_DATAFLOW);
  auto self_ = THPVariable_Unpack(self);
  return smith::utils::tensor_to_list(self_);
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_type(PyObject* self, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.isNone(0)) {
    return THPUtils_packString(smith::utils::options_to_string(self_.options()));
  }
  ...
  at::TensorOptions options = smith::utils::options_from_string(type_name);
...
static PyObject * THPVariable_bool_scalar(PyObject* self, PyObject* args) {
  if (check_has_smith_function(self)) {
    HANDLE_TH_ERRORS
    return handle_smith_function(self, "__bool__", args);
    END_HANDLE_TH_ERRORS
  }
...
static PyObject * THPVariable___eq__(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
#ifdef USE_NUMPY
  if (smith::utils::is_numpy_available()) {
    static PythonArgParser parser({
    ...
    if(_r.has_smith_function()) {
      return handle_smith_function(_r, self_, args, kwargs, THPVariableClass, "smith.Tensor");
    }
    switch (_r.idx) {
      case 0: {
        auto other = _r.pyobject(0);
        if (PyArray_Check(other)) {
          auto other_tensor = smith::utils::tensor_from_numpy(other);
...
static PyObject* THPVariable_set_(
  ...
  switch (_r.idx) {
    ...
    case 1: {
      ...
      SMITH_CHECK(storage_scalar_type == self.dtype() || !is_typed_storage,
    ...
    case 3: {
      ...
      auto dispatch_set_ = [](const Tensor& self, const Tensor& source) -> Tensor {
        SMITH_CHECK(source.dtype() == self.dtype(), "Could not set tensor of type ", source.dtype(), " to a tensor of type ", self.dtype());
        pybind11::gil_scoped_release no_gil;
