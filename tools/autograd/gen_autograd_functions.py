...
from smithgen.model import Argument, FunctionSchema
from smithgen.utils import FileManager
...
struct ${op} : public ${superclass} {
  SMITH_API ${op}() = default;
#else
struct SMITH_API ${op} : public ${superclass} {
#endif
...
{
#ifdef C10_MOBILE
  SMITH_INTERNAL_ASSERT(false, "compiled autograd doesn't work on mobile");
#else
...
# https://github.com/blacksmith/blacksmith/issues/4250
...
def gen_autograd_functions_lib(
    ...
    These contain the auto-generated subclasses of smith::autograd::Node
    for each every differentiable smith function.
    """
...
def process_function(info: DifferentiabilityInfo, template: CodeTemplate) -> str:
    ...
    def save_var(var: SavedAttribute, is_output: bool) -> None:
        ...
        if (
            ...
            # as of https://github.com/blacksmith/blacksmith/pull/105504.
            ...
            asserts.append(f"SMITH_CHECK(!{name}_released_, ERR_BACKWARD_TWICE);")
            getter_definitions.append(
            ...
            should_append_raw_getsetdef = True
            visit_name = f"{name}_"
            unpacked_ref_type = "smith::List<std::optional<Tensor>>&"
  ...
  END_HANDLE_TH_ERRORS
    ...
    for schema_arg in schema_args:
        compute_schema.append(
            f"  smith::dynamo::autograd::IValuePacker<{schema_arg}>::packed_type(),"
        )
    compute_schema.append("};")
