"""
To run this file by hand from the root of the Blacksmith
repository, run:
...
#
#  gen_autograd_functions.py: generates subclasses of smith::autograd::Node
