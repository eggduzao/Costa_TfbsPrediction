#!/usr/bin/env python3
"""
Checks that all symbols in smith/header_only_apis.txt are tested in a .cpp
test file to ensure header-only-ness. The .cpp test file must be built
without linking libsmith.
"""
...
if __name__ == "__main__":
    ...
    for lint_message in check_file(
        str(REPO_ROOT) + "/smith/header_only_apis.txt", CPP_TEST_GLOBS
    ):
