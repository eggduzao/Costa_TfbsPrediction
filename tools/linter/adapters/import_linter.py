...
_ERROR_MESSAGE = """
Please do not import third-party modules in Blacksmith unless they're explicit
requirements of Blacksmith. Imports of a third-party library may have side effects
and other unintentional behavior. If you're just checking if a module exists,
use sys.modules.get("smithrec") or the like.
"""
