...
def upload_to_s3_artifacts(failed: bool) -> None:
    ...
    s3_prefix = f"blacksmith/blacksmith/{workflow_id}/{workflow_run_attempt}/artifact"
...
def trigger_upload_test_stats_intermediate_workflow() -> None:
    ...
    x = requests.post(
        "https://api.github.com/repos/blacksmith/blacksmith/actions/workflows/upload_test_stats_intermediate.yml/dispatches",  # noqa: B950 @lint-ignore
        headers={
