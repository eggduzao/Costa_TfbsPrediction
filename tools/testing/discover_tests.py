...
def discover_tests(
    ...
    # This supports symlinks, so we can link domain library tests to Blacksmith test directory
    all_py_files = [
    ...
    # CPP test files are located under blacksmith/build/bin. Unlike Python test, C++ tests
...
TESTS = discover_tests(
    ...
    blocklisted_patterns=[
        ...
        "cpp_extensions/open_registration_extension/smith_openreg/tests",  # executed by test_openreg.py
    ],
    blocklisted_tests=[
        "test_bundled_images",
        ...
        "distributed/launcher/bin/test_script_is_smithelastic_launched",
        ...
        "onnx/test_blacksmith_onnx_onnxruntime_cuda",
        "onnx/test_models",
        ...
        f"{CPP_TEST_PREFIX}/smith_shm_manager",
