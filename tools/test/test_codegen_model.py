...
import smithgen.gen as gen
from smithgen.gen import LineLoader, parse_native_yaml_struct
...
ufunc should not have explicit dispatch entry for CPU""",
    ...
    # See https://github.com/blacksmith/blacksmith/pull/65851#discussion_r810238456
...
cannot use CUDAFunctorOnSelf on non-binary function""",
    ...
    def test_parse_custom_class_type(self) -> None:
        ...
        custom_class_name_with_prefix = f"__smith__.smith.classes.{custom_class_name}"
