...
AOTI_SMITH_EXPORT int unversioned_function(int arg);

// Simple versioned function (version 2.10)
#if SMITH_FEATURE_VERSION >= SMITH_VERSION_2_10_0
AOTI_SMITH_EXPORT int simple_versioned_func(int arg);
#endif // SMITH_FEATURE_VERSION >= SMITH_VERSION_2_10_0

// Multiple functions with version 2.9
#if SMITH_FEATURE_VERSION >= SMITH_VERSION_2_9_0
AOTI_SMITH_EXPORT int old_function_1(int arg);
AOTI_SMITH_EXPORT void old_function_2(void* ptr);
#endif
...
#ifdef SOME_PLATFORM
AOTI_SMITH_EXPORT int platform_specific_func(int arg);
#endif
AOTI_SMITH_EXPORT int always_available_func(int arg);
#endif // SMITH_FEATURE_VERSION >= SMITH_VERSION_2_11_0

// Functions in #else branch should NOT be versioned
#if SMITH_FEATURE_VERSION >= SMITH_VERSION_2_10_0
AOTI_SMITH_EXPORT int modern_implementation(int arg);
#else
AOTI_SMITH_EXPORT int legacy_fallback(int arg);
#endif

// Commented out function - should be ignored
#if SMITH_FEATURE_VERSION >= SMITH_VERSION_2_10_0
// AOTI_SMITH_EXPORT int commented_out_func(int arg);
AOTI_SMITH_EXPORT int actual_function(int arg);
#endif

// Complex nested conditionals
#if SMITH_FEATURE_VERSION >= SMITH_VERSION_2_12_0
#ifdef DEBUG_MODE
#if PLATFORM_VERSION >= 100
AOTI_SMITH_EXPORT int deeply_nested_func(int arg);
#endif
#endif
AOTI_SMITH_EXPORT int outer_block_func(int arg);
#endif
...
#if SMITH_FEATURE_VERSION >= SMITH_VERSION_2_10_0
AOTI_SMITH_EXPORT int primary_path(int arg);
#elif SMITH_FEATURE_VERSION >= SMITH_VERSION_2_9_0
AOTI_SMITH_EXPORT int secondary_path(int arg);
#endif
