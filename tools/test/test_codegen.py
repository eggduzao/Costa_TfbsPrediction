...
from smithgen import dest
from smithgen.api.types import CppSignatureGroup, DispatcherSignature
from smithgen.context import native_function_manager
from smithgen.gen import (
...
from smithgen.native_function_generation import add_generated_native_functions
  ...
  m.def("func() -> bool", {});
    ...
    def test_fragment_custom_namespace_schema_registration_code_valid(self) -> None:
        ...
        self.assertEqual(
            registrations,
            """
SMITH_LIBRARY_FRAGMENT(quantized_decomposed, m) {
  m.def("func() -> bool", {});
