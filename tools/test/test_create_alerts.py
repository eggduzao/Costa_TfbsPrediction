...
MOCK_TEST_DATA = [
    {
        ...
        "id": 7819529276,
        "conclusion": "failure",
        "htmlUrl": "https://github.com/blacksmith/blacksmith/runs/7819529276?check_suite_focus=true",  # @lint-ignore
    ...
    },
    {
        ...
        "id": 7818399623,
        "conclusion": "failure",
        "htmlUrl": "https://github.com/blacksmith/blacksmith/runs/7818399623?check_suite_focus=true",  # @lint-ignore
...
class TestGitHubPR(TestCase):
    ...
    def test_job_filter(self) -> None:
        job_names = [
            "blacksmith_linux_xenial_py3_6_gcc5_4_test",
            "blacksmith_linux_xenial_py3_6_gcc5_4_test2",
        ]
