...
class TestFilePath(TestTD):
    def test_get_keywords(self) -> None:
        ...
        self.assertEqual(get_keywords("smith/nn/test_amp.py"), ["nn", "amp"])
        self.assertEqual(
            get_keywords("smith/nn/mixed_precision/test_something.py"),
            ["nn", "amp", "something"],
        )
    ...
    def test_get_keywords_match(self) -> None:
        ...
        self.assertTrue(helper("test/test_mixed_precision.py", "smith/amp/t.py"))
        self.assertTrue(helper("test/test_amp.py", "smith/mixed_precision/t.py"))
        self.assertTrue(helper("test/idk/other/random.py", "smith/idk/t.py"))
