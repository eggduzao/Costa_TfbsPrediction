...
class TestStableShimVersionLinter(unittest.TestCase):
    ...
    def test_get_added_lines_simple_addition(self):
        ...
        simulated_diff = """diff --git a/smith/csrc/stable/c/shim.h b/smith/csrc/stable/c/shim.h
index 365c954dbe7..18ca6525f73 100644
--- a/smith/csrc/stable/c/shim.h
+++ b/smith/csrc/stable/c/shim.h
@@ -15,6 +15,13 @@
 extern "C" {
 #endif
...
"""
        with patch("subprocess.run") as mock_run:
            ...
            result = get_added_lines("smith/csrc/stable/c/shim.h")
...
@@ -39,6 +46,12 @@ AOTI_SMITH_EXPORT AOTISmithError smith_library_impl(
...
"""
    ...
    def test_get_current_version(self):
        ...
        # We can't check smith.__version__ here so this is the best we can do :(
...
#if SMITH_FEATURE_VERSION >= SMITH_VERSION_2_10_0
AOTI_SMITH_EXPORT int new_function_correct_version();
#endif // SMITH_FEATURE_VERSION >= SMITH_VERSION_2_10_0

#if SMITH_FEATURE_VERSION >= SMITH_VERSION_2_9_0
AOTI_SMITH_EXPORT int new_function_wrong_version();
#endif // SMITH_FEATURE_VERSION >= SMITH_VERSION_2_9_0

AOTI_SMITH_EXPORT int function_without_version();
...
"""
            ...
            with patch("subprocess.run") as mock_run:
                ...
                with patch(
                    ...
                    self.assertTrue(
                        "should use SMITH_VERSION_2_10_0, but is wrapped in SMITH_VERSION_2_9_0"
                    ...
                    self.assertTrue(
                        "outside of SMITH_FEATURE_VERSION block"
                        in unversioned_msg.description
                    )
                    self.assertTrue(
                        "SMITH_FEATURE_VERSION >= SMITH_VERSION_2_10_0"
                        in unversioned_msg.description
                    )
