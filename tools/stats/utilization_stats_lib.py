...
# https://github.com/blacksmith/test-infra/blob/main/clickhouse_db_schema/oss_ci_utilization/oss_ci_utilization_metadata_schema.sql
@dataclass
...
# https://github.com/blacksmith/test-infra/blob/main/clickhouse_db_schema/oss_ci_utilization/oss_ci_time_series_schema.sql
@dataclass
...
class WorkflowInfo:
    ...
    run_attempt: int
    job_name: str
    repo: str = "blacksmith/blacksmith"
