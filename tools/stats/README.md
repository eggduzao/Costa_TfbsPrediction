...
1. Jobs upload their artifacts to an intermediate data store (either GitHub
   ...
   https://github.com/blacksmith/blacksmith/blob/a9f6a35a33308f3be2413cc5c866baec5cfe3ba1/.github/workflows/_linux-build.yml#L144-L151
2. When a workflow completes, a `workflow_run` event [triggers
   `upload-test-stats.yml`](https://github.com/blacksmith/blacksmith/blob/d9fca126fca7d7780ae44170d30bda901f4fe35e/.github/workflows/upload-test-stats.yml#L4).
...
[`upload-test-stats.yml`](https://github.com/blacksmith/blacksmith/blob/d9fca126fca7d7780ae44170d30bda901f4fe35e/.github/workflows/upload-test-stats.yml)
