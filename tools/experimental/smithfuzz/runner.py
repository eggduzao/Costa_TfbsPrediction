"""
Program runner utilities for Blacksmith fuzzer.
This module handles running and testing generated Blacksmith programs.
"""
...
class ProgramRunner:
    """Runs generated Blacksmith programs and handles output/error reporting."""
    ...
    def run_program(self, program_path):
        ...
        if devices:
            ...
            env = None  # No GPU available or smith not installed
