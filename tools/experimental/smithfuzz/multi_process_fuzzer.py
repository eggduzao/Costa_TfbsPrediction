...
def persist_print(msg):
    ...
    try:
        ...
        os.makedirs("/tmp/smithfuzz", exist_ok=True)
        with open("/tmp/smithfuzz/crash.log", "a") as f:
...
IGNORE_PATTERNS: list[re.Pattern] = [
    re.compile(
        r"smith\._inductor\.exc\.InductorError: AssertionError: -1"
    ),  # https://github.com/blacksmith/blacksmith/issues/167937
