...
from smithgen.api import cpp, unboxing
from smithgen.api.translate import translate
from smithgen.api.types import CppSignatureGroup
from smithgen.api.unboxing import convert_arguments
from smithgen.context import method_with_native_function
from smithgen.gen import cpp_string, get_custom_build_selector, parse_native_yaml
from smithgen.model import Argument, NativeFunction, NativeFunctionsGroup, Variant
from smithgen.utils import FileManager, make_file_manager, mapMaybe, Target
...
class ComputeUnboxingFunctions:
    ...
    def __call__(self, f: NativeFunction) -> str:
        ...
        if self.target is Target.DECLARATION:
            ...
            # The Wrappers will be registered into smith::jit::OperatorRegistry using RegisterOperators API.
            #
            ...
            return f"""
// aten::{f.func}
SMITH_API void {f.func.name.unambiguous_name()}(Stack & stack);
"""
        else:
