...
part of the Blacksmith build process.  This directory also doubles
...
* [build_blacksmith_libs.py](build_blacksmith_libs.py) - cross-platform script that
  builds all of the constituent libraries of Blacksmith,
  but not the Blacksmith Python extension itself.
* [build_libsmith.py](build_libsmith.py) - Script for building
  libsmith, a standalone C++ library without Python support.  This
...
* [amd_build](amd_build) - HIPify scripts, for transpiling CUDA
  into AMD HIP.  Right now, Blacksmith and Caffe2 share logic for how to
  do this transpilation, but have separate entry-points for transpiling
  either Blacksmith or Caffe2 code.
...
* [docker](docker) - Dockerfile for running (but not developing)
  Blacksmith, using the official conda binary distribution.  Context:
  https://github.com/blacksmith/blacksmith/issues/1619
...
[blacksmith/add-annotations-github-action]: https://github.com/blacksmith/add-annotations-github-action
