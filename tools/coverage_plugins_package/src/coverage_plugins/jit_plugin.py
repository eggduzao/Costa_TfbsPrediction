...
function and method that was passed through/decorated with smith.jit.script or smith.jit.script_method should now be
    ...
    def dynamic_context(self, frame: Any) -> None:
        if frame.f_code.co_name == "should_drop":
            ...
            if (
                ...
                if filename:
                    # TODO: Because smith.jit._IgnoreContextManager relies on Python's `exec` method
                    ...
                    # implement smith.jit._IgnoreContextManager.
                    try:
